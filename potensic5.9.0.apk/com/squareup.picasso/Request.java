...
public final class Request {
    ...
    public String toString() {
        ...
        if (this.stableKey != null) {
            sb.append(" stableKey(").append(this.stableKey).append(PropertyUtils.MAPPED_DELIM2);
        }
        if (this.targetWidth > 0) {
            sb.append(" resize(").append(this.targetWidth).append(',').append(this.targetHeight).append(PropertyUtils.MAPPED_DELIM2);
        }
        if (this.centerCrop) {
    ...
    String plainId() {
        return "[R" + this.f2782id + PropertyUtils.INDEXED_DELIM2;
    }
