...
public final class ImmersionBar implements ImmersionCallback {
    ...
    public ImmersionBar addTag(String str) {
        ...
        this.mTagMap.put(str, this.mBarParams.m2614clone());
        return this;
    }
    ...
    public ImmersionBar getTag(String str) {
        ...
        if (barParams != null) {
            this.mBarParams = barParams.m2614clone();
        }
        return this;
    }
    ...
    private int hideBar(int i) {
        if (Build.VERSION.SDK_INT >= 16) {
            int i2 = C18052.$SwitchMap$com$gyf$immersionbar$BarHide[this.mBarParams.barHide.ordinal()];
            if (i2 == 1) {
                i |= 518;
            } else if (i2 == 2) {
    ...
    public static void setTitleBar(Activity activity, View... viewArr) {
        for (final View view : viewArr) {
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                ...
                final Integer num = (Integer) view.getTag(C1807R.id.immersion_fits_layout_overlap);
                if (num == null) {
                    num = 0;
                }
                    ...
                    if (layoutParams.height == -2 || layoutParams.height == -1) {
                        view.post(new Runnable() { // from class: com.gyf.immersionbar.ImmersionBar.1
                            ...
                            public void run() {
                                ...
                                view.setTag(C1807R.id.immersion_fits_layout_overlap, Integer.valueOf(statusBarHeight));
                            }
                        });
                    } else {
    ...
    public static void setTitleBarMarginTop(Activity activity, View... viewArr) {
        for (View view : viewArr) {
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                ...
                Integer num = (Integer) view.getTag(C1807R.id.immersion_fits_layout_overlap);
                if (num == null) {
                    num = 0;
                }
                if (num.intValue() != statusBarHeight) {
