...
class Constants {
    ...
    static final int IMMERSION_ID_STATUS_BAR_VIEW = C1807R.id.immersion_status_bar_view;
    static final int IMMERSION_ID_NAVIGATION_BAR_VIEW = C1807R.id.immersion_navigation_bar_view;
