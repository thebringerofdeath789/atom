...
public final class Feature implements GeoJson {
    ...
    public static Feature fromJson(String str) {
        ...
        return feature.properties() != null ? feature : new Feature(TYPE, feature.bbox(), feature.m1750id(), feature.geometry(), new JsonObject());
    }
    ...
    public String toJson() {
        return new GsonBuilder().registerTypeAdapterFactory(GeoJsonAdapterFactory.create()).registerTypeAdapterFactory(GeometryAdapterFactory.create()).create().toJson(properties().size() == 0 ? new Feature(TYPE, bbox(), m1750id(), geometry(), null) : this);
    }
    ...
    public String toString() {
        return "Feature{type=" + this.type + ", bbox=" + this.bbox + ", id=" + this.f2695id + ", geometry=" + this.geometry + ", properties=" + this.properties + StringSubstitutor.DEFAULT_VAR_END;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.type.equals(feature.type()) && ((boundingBox = this.bbox) != null ? boundingBox.equals(feature.bbox()) : feature.bbox() == null) && ((str = this.f2695id) != null ? str.equals(feature.m1750id()) : feature.m1750id() == null) && ((geometry = this.geometry) != null ? geometry.equals(feature.geometry()) : feature.geometry() == null)) {
    ...
    static final class GsonTypeAdapter extends TypeAdapter<Feature> {
        ...
        public void write(JsonWriter jsonWriter, Feature feature) throws IOException {
            ...
            if (feature.m1750id() == null) {
                ...
                typeAdapter3.write(jsonWriter, feature.m1750id());
            }
