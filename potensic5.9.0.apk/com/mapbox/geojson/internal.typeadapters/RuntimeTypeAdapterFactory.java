...
public final class RuntimeTypeAdapterFactory<T> implements TypeAdapterFactory {
    ...
    /* renamed from: of */
    public static <T> RuntimeTypeAdapterFactory<T> m1753of(Class<T> cls, String str, boolean z) {
        return new RuntimeTypeAdapterFactory<>(cls, str, z);
    }

    /* renamed from: of */
    public static <T> RuntimeTypeAdapterFactory<T> m1752of(Class<T> cls, String str) {
        return new RuntimeTypeAdapterFactory<>(cls, str, false);
    }

    /* renamed from: of */
    public static <T> RuntimeTypeAdapterFactory<T> m1751of(Class<T> cls) {
