...
final class AutoValue_RestStop extends C$AutoValue_RestStop {
    AutoValue_RestStop(final Map<String, SerializableJsonElement> map, final String str, final String str2, final List<Amenity> list, final String str3) {
        new RestStop(map, str, str2, list, str3) { // from class: com.mapbox.api.directions.v5.models.$AutoValue_RestStop
            ...
            @Override // com.mapbox.api.directions.p022v5.models.RestStop
            public String type() {
                return this.type;
            }
    ...
    static final class GsonTypeAdapter extends TypeAdapter<RestStop> {
        ...
        @Override // com.google.gson.TypeAdapter
        public RestStop read(JsonReader jsonReader) throws IOException {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    if (nextName.equals("guidemap")) {
                        ...
                        builder.guideMap(typeAdapter.read(jsonReader));
                        ...
                        builder.amenities(typeAdapter4.read(jsonReader));
                    } else {
