...
final class AutoValue_PaymentMethods extends C$AutoValue_PaymentMethods {
    AutoValue_PaymentMethods(final Map<String, SerializableJsonElement> map, final CostPerVehicleSize costPerVehicleSize, final CostPerVehicleSize costPerVehicleSize2) {
        new PaymentMethods(map, costPerVehicleSize, costPerVehicleSize2) { // from class: com.mapbox.api.directions.v5.models.$AutoValue_PaymentMethods
            ...
            @Override // com.mapbox.api.directions.p022v5.models.PaymentMethods
    ...
    static final class GsonTypeAdapter extends TypeAdapter<PaymentMethods> {
        ...
        @Override // com.google.gson.TypeAdapter
        public PaymentMethods read(JsonReader jsonReader) throws IOException {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    if ("etc".equals(nextName)) {
                        ...
                        builder.etc(typeAdapter.read(jsonReader));
                        ...
                        builder.cash(typeAdapter2.read(jsonReader));
                    } else {
