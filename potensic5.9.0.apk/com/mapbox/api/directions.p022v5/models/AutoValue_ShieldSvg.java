...
final class AutoValue_ShieldSvg extends C$AutoValue_ShieldSvg {
    AutoValue_ShieldSvg(final Map<String, SerializableJsonElement> map, final String str) {
        new ShieldSvg(map, str) { // from class: com.mapbox.api.directions.v5.models.$AutoValue_ShieldSvg
            ...
            @Override // com.mapbox.api.directions.p022v5.models.ShieldSvg
            public String svg() {
                return this.svg;
            }
    ...
    static final class GsonTypeAdapter extends TypeAdapter<ShieldSvg> {
        ...
        @Override // com.google.gson.TypeAdapter
        public ShieldSvg read(JsonReader jsonReader) throws IOException {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    if ("svg".equals(nextName)) {
                        ...
                        builder.svg(typeAdapter.read(jsonReader));
                    } else {
