...
final class AutoValue_BannerInstructions extends C$AutoValue_BannerInstructions {
    AutoValue_BannerInstructions(final Map<String, SerializableJsonElement> map, final double d, final BannerText bannerText, final BannerText bannerText2, final BannerText bannerText3, final BannerView bannerView) {
        new BannerInstructions(map, d, bannerText, bannerText2, bannerText3, bannerView) { // from class: com.mapbox.api.directions.v5.models.$AutoValue_BannerInstructions
            ...
            @Override // com.mapbox.api.directions.p022v5.models.BannerInstructions
            ...
            while (jsonReader.hasNext()) {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    if ("distanceAlongGeometry".equals(nextName)) {
                        ...
                        builder.distanceAlongGeometry(typeAdapter.read(jsonReader).doubleValue());
                        ...
                        builder.secondary(typeAdapter3.read(jsonReader));
                        ...
                        builder.sub(typeAdapter4.read(jsonReader));
                        ...
                        builder.view(typeAdapter5.read(jsonReader));
                    } else {
