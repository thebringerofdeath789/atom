...
final class AutoValue_CostPerVehicleSize extends C$AutoValue_CostPerVehicleSize {
    AutoValue_CostPerVehicleSize(final Map<String, SerializableJsonElement> map, final Double d, final Double d2, final Double d3, final Double d4, final Double d5) {
        new CostPerVehicleSize(map, d, d2, d3, d4, d5) { // from class: com.mapbox.api.directions.v5.models.$AutoValue_CostPerVehicleSize
            ...
            @Override // com.mapbox.api.directions.p022v5.models.CostPerVehicleSize
            public Double small() {
                return this.small;
            }
    ...
    static final class GsonTypeAdapter extends TypeAdapter<CostPerVehicleSize> {
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // com.google.gson.TypeAdapter
        public CostPerVehicleSize read(JsonReader jsonReader) throws IOException {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    if ("small".equals(nextName)) {
                        ...
                        builder.standard(typeAdapter2.read(jsonReader));
                        ...
                        builder.middle(typeAdapter3.read(jsonReader));
                        ...
                        builder.large(typeAdapter4.read(jsonReader));
                        ...
                        builder.jumbo(typeAdapter5.read(jsonReader));
                    } else {
