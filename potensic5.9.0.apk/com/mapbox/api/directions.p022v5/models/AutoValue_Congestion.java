...
final class AutoValue_Congestion extends C$AutoValue_Congestion {
    AutoValue_Congestion(final Map<String, SerializableJsonElement> map, final int i) {
        new Congestion(map, i) { // from class: com.mapbox.api.directions.v5.models.$AutoValue_Congestion
            ...
            @Override // com.mapbox.api.directions.p022v5.models.Congestion
            public int value() {
                return this.value;
            }
            ...
            while (jsonReader.hasNext()) {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    if ("value".equals(nextName)) {
                        ...
                        builder.value(typeAdapter.read(jsonReader).intValue());
                    } else {
