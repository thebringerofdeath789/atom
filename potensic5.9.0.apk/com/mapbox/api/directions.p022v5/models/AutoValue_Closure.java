...
final class AutoValue_Closure extends C$AutoValue_Closure {
    AutoValue_Closure(final Map<String, SerializableJsonElement> map, final Integer num, final Integer num2) {
        new Closure(map, num, num2) { // from class: com.mapbox.api.directions.v5.models.$AutoValue_Closure
            ...
            @Override // com.mapbox.api.directions.p022v5.models.Closure
    ...
    static final class GsonTypeAdapter extends TypeAdapter<Closure> {
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // com.google.gson.TypeAdapter
        public Closure read(JsonReader jsonReader) throws IOException {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    if (nextName.equals("geometry_index_start")) {
                        ...
                        builder.geometryIndexStart(typeAdapter.read(jsonReader));
                        ...
                        builder.geometryIndexEnd(typeAdapter2.read(jsonReader));
                    } else {
