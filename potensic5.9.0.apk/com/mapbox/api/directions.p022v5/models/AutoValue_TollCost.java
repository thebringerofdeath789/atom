...
final class AutoValue_TollCost extends C$AutoValue_TollCost {
    AutoValue_TollCost(final Map<String, SerializableJsonElement> map, final String str, final PaymentMethods paymentMethods) {
        new TollCost(map, str, paymentMethods) { // from class: com.mapbox.api.directions.v5.models.$AutoValue_TollCost
            ...
            @Override // com.mapbox.api.directions.p022v5.models.TollCost
    ...
    static final class GsonTypeAdapter extends TypeAdapter<TollCost> {
        ...
        @Override // com.google.gson.TypeAdapter
        public TollCost read(JsonReader jsonReader) throws IOException {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    if (nextName.equals("payment_methods")) {
                        ...
                        builder.paymentMethods(typeAdapter.read(jsonReader));
