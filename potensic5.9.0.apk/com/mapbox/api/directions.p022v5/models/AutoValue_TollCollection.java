...
final class AutoValue_TollCollection extends C$AutoValue_TollCollection {
    AutoValue_TollCollection(final Map<String, SerializableJsonElement> map, final String str, final String str2) {
        new TollCollection(map, str, str2) { // from class: com.mapbox.api.directions.v5.models.$AutoValue_TollCollection
            ...
            @Override // com.mapbox.api.directions.p022v5.models.TollCollection
            public String type() {
                return this.type;
            }
    ...
    static final class GsonTypeAdapter extends TypeAdapter<TollCollection> {
        ...
        @Override // com.google.gson.TypeAdapter
        public TollCollection read(JsonReader jsonReader) throws IOException {
