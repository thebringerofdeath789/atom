...
class SingleElementSafeListTypeAdapter<E> extends TypeAdapter<List<E>> {
    ...
    public List<E> read(JsonReader jsonReader) throws IOException {
        ...
        switch (C31522.$SwitchMap$com$google$gson$stream$JsonToken[peek.ordinal()]) {
            case 1:
    ...
    /* renamed from: com.mapbox.api.geocoding.v5.SingleElementSafeListTypeAdapter$2 */
    static /* synthetic */ class C31522 {
