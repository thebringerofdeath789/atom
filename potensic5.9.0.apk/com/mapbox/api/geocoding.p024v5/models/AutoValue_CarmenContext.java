...
final class AutoValue_CarmenContext extends C$AutoValue_CarmenContext {
    AutoValue_CarmenContext(final String str, final String str2, final String str3, final String str4, final String str5, final String str6) {
        new CarmenContext(str, str2, str3, str4, str5, str6) { // from class: com.mapbox.api.geocoding.v5.models.$AutoValue_CarmenContext
            ...
            @Override // com.mapbox.api.geocoding.p024v5.models.CarmenContext
            /* renamed from: id */
            public String mo1746id() {
                return this.f2691id;
            }
            ...
            public String toString() {
                return "CarmenContext{id=" + this.f2691id + ", text=" + this.text + ", shortCode=" + this.shortCode + ", wikidata=" + this.wikidata + ", category=" + this.category + ", maki=" + this.maki + StringSubstitutor.DEFAULT_VAR_END;
            }
            ...
            public boolean equals(Object obj) {
                ...
                String str7 = this.f2691id;
                if (str7 != null ? str7.equals(carmenContext.mo1746id()) : carmenContext.mo1746id() == null) {
            ...
            static class Builder extends CarmenContext.Builder {
                ...
                private Builder(CarmenContext carmenContext) {
                    this.f2692id = carmenContext.mo1746id();
                ...
                /* renamed from: id */
                public CarmenContext.Builder mo1747id(String str) {
                    this.f2692id = str;
                    return this;
                }
                ...
                public CarmenContext build() {
                    return new AutoValue_CarmenContext(this.f2692id, this.text, this.shortCode, this.wikidata, this.category, this.maki);
                }
            }
        };
    }
    ...
    static final class GsonTypeAdapter extends TypeAdapter<CarmenContext> {
        ...
        public void write(JsonWriter jsonWriter, CarmenContext carmenContext) throws IOException {
            ...
            if (carmenContext.mo1746id() == null) {
                jsonWriter.nullValue();
            } else {
                ...
                typeAdapter.write(jsonWriter, carmenContext.mo1746id());
            }
            ...
            while (jsonReader.hasNext()) {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    if (nextName.equals("short_code")) {
                        ...
                        builder.shortCode(typeAdapter.read(jsonReader));
                        ...
                        builder.mo1747id(typeAdapter2.read(jsonReader));
                        ...
                        builder.text(typeAdapter3.read(jsonReader));
                        ...
                        builder.wikidata(typeAdapter4.read(jsonReader));
                        ...
                        builder.category(typeAdapter5.read(jsonReader));
                        ...
                        builder.maki(typeAdapter6.read(jsonReader));
                    } else {
