...
import com.mapbox.api.directionsrefresh.p023v1.models.DirectionsRouteRefresh;
...
final class AutoValue_DirectionsRouteRefresh extends C$AutoValue_DirectionsRouteRefresh {
    AutoValue_DirectionsRouteRefresh(final Map<String, SerializableJsonElement> map, final List<RouteLegRefresh> list) {
        new DirectionsRouteRefresh(map, list) { // from class: com.mapbox.api.directionsrefresh.v1.models.$AutoValue_DirectionsRouteRefresh
            ...
            @Override // com.mapbox.api.directionsrefresh.p023v1.models.DirectionsRouteRefresh
    ...
    static final class GsonTypeAdapter extends TypeAdapter<DirectionsRouteRefresh> {
        ...
        @Override // com.google.gson.TypeAdapter
        public DirectionsRouteRefresh read(JsonReader jsonReader) throws IOException {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    if ("legs".equals(nextName)) {
                        ...
                        builder.legs(typeAdapter.read(jsonReader));
                    } else {
