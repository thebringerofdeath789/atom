...
final class AutoValue_DirectionsRefreshResponse extends C$AutoValue_DirectionsRefreshResponse {
    AutoValue_DirectionsRefreshResponse(final Map<String, SerializableJsonElement> map, final String str, final String str2, final DirectionsRouteRefresh directionsRouteRefresh) {
        new DirectionsRefreshResponse(map, str, str2, directionsRouteRefresh) { // from class: com.mapbox.api.directionsrefresh.v1.models.$AutoValue_DirectionsRefreshResponse
            ...
            @Override // com.mapbox.api.directionsrefresh.p023v1.models.DirectionsRefreshResponse
            public String code() {
                return this.code;
            }
