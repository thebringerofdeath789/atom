...
final class AutoValue_MapMatchingTracepoint extends C$AutoValue_MapMatchingTracepoint {
    AutoValue_MapMatchingTracepoint(final Integer num, final Integer num2, final Integer num3, final String str, final double[] dArr) {
        new MapMatchingTracepoint(num, num2, num3, str, dArr) { // from class: com.mapbox.api.matching.v5.models.$AutoValue_MapMatchingTracepoint
            ...
            @Override // com.mapbox.api.matching.p025v5.models.MapMatchingTracepoint
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    switch (nextName) {
                        case "matchings_index":
                            ...
                            builder.matchingsIndex(typeAdapter.read(jsonReader));
                            break;
                        case "alternatives_count":
                            ...
                            builder.alternativesCount(typeAdapter2.read(jsonReader));
                            break;
                        case "waypoint_index":
                            TypeAdapter<Integer> typeAdapter3 = this.integer_adapter;
                            if (typeAdapter3 == null) {
                            ...
                            builder.waypointIndex(typeAdapter3.read(jsonReader));
                            break;
                        case "location":
