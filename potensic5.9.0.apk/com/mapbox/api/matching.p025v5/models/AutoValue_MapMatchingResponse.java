...
final class AutoValue_MapMatchingResponse extends C$AutoValue_MapMatchingResponse {
    AutoValue_MapMatchingResponse(final String str, final String str2, final List<MapMatchingMatching> list, final List<MapMatchingTracepoint> list2) {
        new MapMatchingResponse(str, str2, list, list2) { // from class: com.mapbox.api.matching.v5.models.$AutoValue_MapMatchingResponse
            ...
            @Override // com.mapbox.api.matching.p025v5.models.MapMatchingResponse
            public String code() {
                return this.code;
            }
            ...
            while (jsonReader.hasNext()) {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    if ("code".equals(nextName)) {
                        ...
                        builder.matchings(typeAdapter3.read(jsonReader));
                        ...
                        builder.tracepoints(typeAdapter4.read(jsonReader));
                    } else {
