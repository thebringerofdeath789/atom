...
class ChinaCertificatePins {
    static final Map<String, List<String>> CERTIFICATE_PINS = new HashMap<String, List<String>>() { // from class: com.mapbox.android.telemetry.ChinaCertificatePins.1
        {
            put(MapboxTelemetryConstants.DEFAULT_CHINA_EVENTS_HOST, new ArrayList<String>() { // from class: com.mapbox.android.telemetry.ChinaCertificatePins.1.1
                {
