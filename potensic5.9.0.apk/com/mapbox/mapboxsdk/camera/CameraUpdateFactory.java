...
public final class CameraUpdateFactory {
    ...
    static final class CameraMoveUpdate implements CameraUpdate {
        ...
        /* renamed from: x */
        private float f2699x;

        /* renamed from: y */
        private float f2700y;
        ...
        public CameraPosition getCameraPosition(MapboxMap mapboxMap) {
            ...
            LatLng fromScreenLocation = projection.fromScreenLocation(new PointF((((width - padding[0]) + padding[1]) / 2.0f) + this.f2699x, (((height + padding[1]) - padding[3]) / 2.0f) + this.f2700y));
        ...
        public boolean equals(Object obj) {
            ...
            return Float.compare(cameraMoveUpdate.f2699x, this.f2699x) == 0 && Float.compare(cameraMoveUpdate.f2700y, this.f2700y) == 0;
        }

        public int hashCode() {
            float f = this.f2699x;
            int floatToIntBits = (f != 0.0f ? Float.floatToIntBits(f) : 0) * 31;
            float f2 = this.f2700y;
            return floatToIntBits + (f2 != 0.0f ? Float.floatToIntBits(f2) : 0);
        }

        public String toString() {
            return "CameraMoveUpdate{x=" + this.f2699x + ", y=" + this.f2700y + '}';
        }
    }
    ...
    static final class ZoomUpdate implements CameraUpdate {
        ...
        public boolean equals(Object obj) {
            ...
            return this.type == zoomUpdate.type && Double.compare(zoomUpdate.zoom, this.zoom) == 0 && Float.compare(zoomUpdate.f2701x, this.f2701x) == 0 && Float.compare(zoomUpdate.f2702y, this.f2702y) == 0;
        }
        ...
        public int hashCode() {
            ...
            float f2 = this.f2702y;
            return floatToIntBits + (f2 != 0.0f ? Float.floatToIntBits(f2) : 0);
        }

        public String toString() {
            return "ZoomUpdate{type=" + this.type + ", zoom=" + this.zoom + ", x=" + this.f2701x + ", y=" + this.f2702y + '}';
        }
    }
}