...
public class AttributionParser {
    ...
    private String translateImproveThisMapAnchor(String str) {
        ...
        return context != null ? context.getString(C3178R.string.mapbox_telemetryImproveMap) : str;
    }
    ...
    private void addAdditionalAttributions() {
        if (this.withTelemetryAttribution) {
            Context context = this.context.get();
            this.attributions.add(new Attribution(context != null ? context.getString(C3178R.string.mapbox_telemetrySettings) : "Telemetry Settings", "https://www.mapbox.com/telemetry/"));
        }
    }
