...
public final class UiSettings {
    ...
    private void initialiseCompass(MapboxMapOptions mapboxMapOptions, Resources resources) {
        ...
        if (compassMargins != null) {
            ...
            int dimension = (int) resources.getDimension(C3178R.dimen.mapbox_four_dp);
    ...
    private void setAttributionMargins(Context context, int[] iArr) {
        ...
        Resources resources = context.getResources();
        int dimension = (int) resources.getDimension(C3178R.dimen.mapbox_four_dp);
        setAttributionMargins((int) resources.getDimension(C3178R.dimen.mapbox_ninety_two_dp), dimension, dimension, dimension);
    }
    ...
    public int getCompassImageResource() {
        ...
        return C3178R.drawable.mapbox_compass_icon;
    }
    ...
    public void setAttributionTintColor(int i) {
        ...
        if (Color.alpha(i) == 0) {
            ImageView imageView = this.attributionsView;
            ColorUtils.setTintList(imageView, ContextCompat.getColor(imageView.getContext(), C3178R.color.mapbox_blue));
        } else {
