...
public class MapView extends FrameLayout implements NativeMapView.ViewCallback {
    ...
    protected void initialize(Context context, MapboxMapOptions mapboxMapOptions) {
        ...
        setContentDescription(context.getString(C3178R.string.mapbox_mapActionDescription));
    ...
    protected CompassView initialiseCompassView() {
        ...
        this.compassView.setContentDescription(getResources().getString(C3178R.string.mapbox_compassContentDescription));
    ...
    protected ImageView initialiseAttributionView() {
        ...
        imageView.setContentDescription(getResources().getString(C3178R.string.mapbox_attributionsIconContentDescription));
        imageView.setImageDrawable(BitmapUtils.getDrawableFromRes(getContext(), C3178R.drawable.mapbox_info_bg_selector));
    ...
    protected ImageView initialiseLogoView() {
        ...
        imageView.getLayoutParams().width = -2;
        imageView.getLayoutParams().height = -2;
        imageView.setImageDrawable(BitmapUtils.getDrawableFromRes(getContext(), C3178R.drawable.mapbox_logo_icon));
        return imageView;
    }
