...
public class AttributionDialogManager implements View.OnClickListener, DialogInterface.OnClickListener {
    ...
    protected void showAttributionDialog(String[] strArr) {
        ...
        builder.setTitle(C3178R.string.mapbox_attributionsDialogTitle);
        builder.setAdapter(new ArrayAdapter(this.context, C3178R.layout.mapbox_attribution_list_item, strArr), this);
    ...
    private void showTelemetryDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this.context);
        builder.setTitle(C3178R.string.mapbox_attributionTelemetryTitle);
        builder.setMessage(C3178R.string.mapbox_attributionTelemetryMessage);
        builder.setPositiveButton(C3178R.string.mapbox_attributionTelemetryPositive, new DialogInterface.OnClickListener() { // from class: com.mapbox.mapboxsdk.maps.AttributionDialogManager.1
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
        ...
        builder.setNeutralButton(C3178R.string.mapbox_attributionTelemetryNeutral, new DialogInterface.OnClickListener() { // from class: com.mapbox.mapboxsdk.maps.AttributionDialogManager.2
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
                AttributionDialogManager attributionDialogManager = AttributionDialogManager.this;
                attributionDialogManager.showWebPage(attributionDialogManager.context.getResources().getString(C3178R.string.mapbox_telemetryLink));
                dialogInterface.cancel();
            }
        });
        builder.setNegativeButton(C3178R.string.mapbox_attributionTelemetryNegative, new DialogInterface.OnClickListener() { // from class: com.mapbox.mapboxsdk.maps.AttributionDialogManager.3
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
                TelemetryDefinition telemetry = Mapbox.getTelemetry();
                if (telemetry != null) {
    ...
    public void showWebPage(String str) {
        try {
            ...
            Toast.makeText(this.context, C3178R.string.mapbox_attributionErrorNoBrowser, 1).show();
