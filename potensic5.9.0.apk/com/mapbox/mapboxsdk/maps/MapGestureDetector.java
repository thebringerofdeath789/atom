...
import com.mapbox.android.gestures.C3063R;
...
final class MapGestureDetector {
    ...
    private void initializeGestureListeners(Context context, boolean z) {
        if (z) {
            StandardGestureListener standardGestureListener = new StandardGestureListener(context.getResources().getDimension(C3063R.dimen.mapbox_defaultScaleSpanSinceStartThreshold));
            MoveGestureListener moveGestureListener = new MoveGestureListener();
            ScaleGestureListener scaleGestureListener = new ScaleGestureListener(context.getResources().getDimension(C3178R.dimen.mapbox_density_constant), context.getResources().getDimension(C3178R.dimen.mapbox_minimum_scale_speed), context.getResources().getDimension(C3178R.dimen.mapbox_minimum_angled_scale_speed), context.getResources().getDimension(C3178R.dimen.mapbox_minimum_scale_velocity));
            RotateGestureListener rotateGestureListener = new RotateGestureListener(context.getResources().getDimension(C3178R.dimen.mapbox_minimum_scale_span_when_rotating), context.getResources().getDimension(C3178R.dimen.mapbox_density_constant), context.getResources().getDimension(C3178R.dimen.mapbox_angular_velocity_multiplier), context.getResources().getDimension(C3178R.dimen.mapbox_minimum_angular_velocity), context.getResources().getDimension(C3063R.dimen.mapbox_defaultScaleSpanSinceStartThreshold));
