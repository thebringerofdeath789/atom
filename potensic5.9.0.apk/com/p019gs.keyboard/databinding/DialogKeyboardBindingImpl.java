...
public class DialogKeyboardBindingImpl extends DialogKeyboardBinding {
    ...
    static {
        ...
        sparseIntArray.put(C1802R.id.keyboard_view, 1);
        sparseIntArray.put(C1802R.id.keyboard_chooser, 2);
        sparseIntArray.put(C1802R.id.tv_number, 3);
        sparseIntArray.put(C1802R.id.tv_symbol, 4);
        sparseIntArray.put(C1802R.id.tv_letter, 5);
    }

    public DialogKeyboardBindingImpl(DataBindingComponent dataBindingComponent, View view) {
