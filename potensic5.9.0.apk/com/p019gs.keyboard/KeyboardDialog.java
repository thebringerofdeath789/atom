...
import com.p019gs.keyboard.databinding.DialogKeyboardBinding;
...
public class KeyboardDialog extends Dialog implements KeyboardView.OnKeyboardActionListener {
    ...
    public KeyboardDialog(Context context, SecurityEditText securityEditText) {
        super(context, C1802R.style.NoFrameDialog);
    ...
    protected void onStart() {
        ...
        if (window != null) {
            ...
            window.setWindowAnimations(C1802R.style.KeyboardDialogAnimation);
        }
    }
    ...
    private void initKeyboards() {
        ...
        if (isPortrait()) {
            this.mLetterKeyboard = new Keyboard(getContext(), C1802R.xml.gs_keyboard_english);
            this.mSymbolKeyboard = new Keyboard(getContext(), C1802R.xml.gs_keyboard_symbols_shift);
            this.mNumberKeyboard = new Keyboard(getContext(), C1802R.xml.gs_keyboard_number);
        } else {
            this.mLetterKeyboard = new Keyboard(getContext(), C1802R.xml.gs_keyboard_english_land);
            this.mSymbolKeyboard = new Keyboard(getContext(), C1802R.xml.gs_keyboard_symbols_shift_land);
            this.mNumberKeyboard = new Keyboard(getContext(), C1802R.xml.gs_keyboard_number_land);
        }
    ...
    private void onCurrentKeyboardChange() {
        ...
        if (i == 0) {
            ...
            throw new IllegalStateException(getContext().getString(C1802R.string.exception_invalid_keyboard));
        }
    }
    ...
    private boolean isNumber(String str) {
        return getContext().getString(C1802R.string.zeroToNine).contains(str.toLowerCase());
    }
        ...
        if (keyboard != null) {
            ...
            if (this.isUpper) {
                ...
                for (Keyboard.Key key : keys) {
                    ...
                    if (key.codes[0] == -1) {
                        key.icon = getContext().getResources().getDrawable(C1802R.drawable.keyboard_shift);
                    }
                }
                return;
            }
            ...
            for (Keyboard.Key key2 : keys) {
                ...
                if (key2.codes[0] == -1) {
                    key2.icon = getContext().getResources().getDrawable(C1802R.drawable.keyboard_shift_c);
                }
            }
        }
    }
    ...
    private boolean isLetter(String str) {
        return getContext().getString(C1802R.string.aToz).contains(str.toLowerCase());
    }
