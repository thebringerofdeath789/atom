...
public class Version implements Serializable {
    ...
    public String toString() {
        return "Version{flightType='" + this.flightType + "', id='" + this.f2672id + "', classname='" + this.classname + "', productclass='" + this.productclass + "', filesize='" + this.filesize + "', filename='" + this.filename + "', version='" + this.version + "', downloadurl='" + this.downloadurl + "', downloadurl_backup='" + this.downloadurl_backup + "', updatedate='" + this.updatedate + "', updatenote_en='" + this.updatenote_en + "', updatenote_cn='" + this.updatenote_cn + "', classname_en='" + this.classname_en + "', brandcode='" + this.brandcode + "', localPath='" + this.localPath + "', comparedate='" + this.comparedate + "', md5file='" + this.md5file + "', isdel=" + this.isdel + ", priority_app=" + this.priority_app + ", weight=" + this.weight + ", isforce=" + this.isforce + ", flightCode=" + ((int) this.flightCode) + ", remark='" + this.remark + "', json_link='" + this.json_link + "', language_more='" + this.language_more + "', typeList=" + this.typeList + '}';
    }
}