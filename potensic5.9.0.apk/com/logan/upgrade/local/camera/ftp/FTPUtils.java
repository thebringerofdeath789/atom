...
public class FTPUtils {
    ...
    public boolean connectFtp() {
        try {
            ...
            DDLog.m1685e("ftp", "ip = " + this.f2671ip + ", userName = " + this.userName);
            this.ftpClient.connect(this.f2671ip, this.port.intValue());
            this.ftpClient.login(this.userName, "");
            this.ftpClient.setFileType(2);
            if (!FTPReply.isPositiveCompletion(this.ftpClient.getReplyCode())) {
                this.ftpClient.abort();
                this.ftpClient.disconnect();
                DDLog.m1684e("ftp:连接服务器失败");
                return false;
            }
        } catch (Exception e) {
            DDLog.m1685e("ftp:", e.getMessage() + "");
        }
        this.ftpClient.enterLocalPassiveMode();
        this.ftpClient.setRemoteVerificationEnabled(false);
        DDLog.m1684e("ftp:连接服务器成功");
        return true;
    }
        ...
        new Thread(new Runnable() { // from class: com.logan.upgrade.local.camera.ftp.FTPUtils.1
            ...
            */
            public void run() {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: com.logan.upgrade.local.camera.ftp.FTPUtils.RunnableC30061.run():void");
            }
        }).start();
    }
}