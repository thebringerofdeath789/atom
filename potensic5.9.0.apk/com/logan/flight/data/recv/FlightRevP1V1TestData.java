...
public class FlightRevP1V1TestData extends BaseFlightRevData implements Cloneable {
    ...
    public FlightRevP1V1TestData m2621clone() throws CloneNotSupportedException {
        return (FlightRevP1V1TestData) super.clone();
    }
}