...
public class FlightRevStateData extends BaseFlightRevData implements Cloneable {
    ...
    private boolean canEmergencyStop;
    ...
    private boolean isPowerLimit;
    private boolean isPreEscBeep;
    private boolean isPressureError;
    private boolean isPropellerGuardCover;
    ...
    private boolean isSupportEmergencyStop;
    ...
    protected void parseData(byte[] bArr, int i) {
        ...
        if (FlightConfig.curFlight != null) {
            ...
            if (FlightConfig.is_Atom_Series()) {
                ...
                this.isBeidouOpen = ParseUtil.getBit(b5, 2) == 1;
                this.isPowerLimit = ParseUtil.getBit(b5, 3) == 1;
                this.canEmergencyStop = ParseUtil.getBit(b5, 4) == 1;
                this.isSupportEmergencyStop = ParseUtil.getBit(b5, 5) == 1;
            } else {
        ...
        if (bArr.length >= i8) {
            ...
            this.isPropellerGuardCover = ParseUtil.getBit(b12, 3) == 1;
        }
        int i9 = i + 15;
        if (bArr.length >= i9) {
            byte b13 = bArr[i7];
    ...
    public boolean isPropellerGuardCover() {
    ...
    public boolean isBeidouOpen() {
        return this.isBeidouOpen;
    }

    public boolean isPowerLimit() {
        return this.isPowerLimit;
    }

    public boolean canEmergencyStop() {
        return this.canEmergencyStop;
    }

    public boolean isSupportEmergencyStop() {
        return this.isSupportEmergencyStop;
    }
    ...
    public String toString() {
        ...
        if (this.isBeidouOpen) {
            sb.append("\n 北斗导航打开");
        }
        if (this.isPowerLimit) {
            sb.append("\n 飞机动力做限制");
        }
        if (this.canEmergencyStop) {
            sb.append("\n 使能紧急停桨");
        }
        if (this.isSupportEmergencyStop) {
            sb.append("\n 支持紧急停桨功能");
        }
        if (this.shortVideoPercent > 0) {
            sb.append("\n 一键短片 进度百分比:").append(this.shortVideoPercent);
        }
    ...
    public FlightRevStateData m2625clone() throws CloneNotSupportedException {
