...
public class FlightRevVersionData extends BaseFlightRevData {
    ...
    protected void parseData(byte[] bArr, int i) {
        ...
        if (bArr.length >= i + 40) {
            ...
            if (!"000000000000000000".equals(ParseUtil.byteToHexString(bArr, i18 + 12, 9))) {
                this.flightSN = new String(ParseUtil.interceptBytes(bArr, i18, 21), StandardCharsets.US_ASCII).trim();
            }
        ...
        if (bArr.length >= 60 && ((b = this.manuFactor) == -79 || b == -73)) {
            ...
            DDLog.m1684e("电池识别码:" + ((int) this.batteryCode));
        ...
        DDLog.m1684e("飞控 飞机类型:" + ParseUtil.byteToHexString(new byte[]{this.manuFactor}));
