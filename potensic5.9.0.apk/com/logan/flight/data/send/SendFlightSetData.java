...
public class SendFlightSetData extends BaseSendData implements IFlightSettingController {
    ...
    public boolean isInit() {
        DDLog.m1684e("设置是否初始化:" + this.isInit);
        return this.isInit;
    }
    ...
    public boolean isSettingChanged() {
        ...
        DDLog.m1684e("设置 setting before ：" + flightRevSettingData.toString());
        DDLog.m1684e("设置 setting new ：高度限制=" + this.limitHeight + ", 距离限制=" + this.limitDistance + ", 返航高度=" + this.returnHeight + ", 是否新手模式=" + this.isNewerModeOpen + ", 是否美国手=" + this.isAmericaRockerMode + ", 环绕半径=" + this.surroundRadius + ", 最后一次纬度=" + this.lastLatitude + ", 最后一次经度=" + this.lastLongitude + ", 是否顺时针环绕=" + this.isClockwise + ", 环绕速度=" + this.surroundSpeed + ", 速度挡=" + this.speedMode + '}');
