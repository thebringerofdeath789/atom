...
public class MediaCodecDecoder {
    ...
    private void initDecoder() {
        ...
        DDLog.m1726i("width:" + createVideoFormat.getInteger("width"));
        DDLog.m1726i("height:" + createVideoFormat.getInteger("height"));
    ...
    private boolean onFrame(byte[] bArr, int i, int i2) {
        ...
        if (dequeueOutputBuffer < 0) {
            DDLog.m1730w("outputBufferIndex:" + dequeueOutputBuffer);
        }
        return true;
    }
