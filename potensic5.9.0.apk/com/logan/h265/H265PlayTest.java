                    ...
                    while (true) {
                        if (it.hasNext()) {
                            ...
                            if (!z && bArr2 != null && bArr3 != null && bArr != null) {
                                ...
                                DDLog.m1724e("width:" + h265VideoWidthAndHeight[0]);
                                DDLog.m1724e("height:" + h265VideoWidthAndHeight[1]);
                            ...
                            if (z) {
                                if (h265Frame.getNalType() == H265Type.TYPE_IDR) {
                                    ...
                                    DDLog.m1724e("IDR解码时间:" + (System.currentTimeMillis() - currentTimeMillis2));
                                }
                                if (h265Frame.getNalType() == H265Type.TYPE_SS) {
                                    long currentTimeMillis3 = System.currentTimeMillis();
                                    H264Player.decode(h265Frame.getData(), h265Frame.getData().length);
                                    DDLog.m1724e("SS解码时间:" + (System.currentTimeMillis() - currentTimeMillis3));
                                }
                            }
                        }
                    }
        ...
        new Thread(new Runnable() { // from class: com.logan.h265.H265PlayTest.2
            ...
            */
            public void run() {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: com.logan.h265.H265PlayTest.RunnableC29902.run():void");
            }
        }).start();
    }
}