...
public class RemoteFileDownloader {
    ...
    private final Runnable unitTimeout = new Runnable() { // from class: com.logan.usb.gallery.RemoteFileDownloader.5
        ...
        public void run() {
            ...
            try {
                ...
                DDLog.m1684e("图库超时重新下载:" + filePointer);
                ...
                DDLog.m1684e("图库超时下载失败:" + e.getMessage());
            }
        }
    };
    ...
    public void onReceiveData(byte[] bArr) {
        if (this.isCancel || this.downloadFile == null || this.downloadListener == null) {
            DDLog.m1684e("图库 lrvFile:" + this.downloadFile);
            DDLog.m1684e("图库 lvrDownloadListener:" + this.downloadListener);
            return;
        }
        try {
            ...
            if (downloadData.getOffset() != filePointer) {
                ...
                DDLog.m1684e("图库下载失败 从 " + filePointer + " 位置重新下载");
                    ...
                    PhoneConfig.mainHandler.post(new Runnable() { // from class: com.logan.usb.gallery.RemoteFileDownloader.2
                        ...
                        public void run() {
                            try {
                                ...
                                DDLog.m1684e("图库LRV下载长度:" + filePointer + ",总长度:" + RemoteFileDownloader.this.totalLen);
            ...
            DDLog.m1684e("图库下载报错:" + e.getMessage());
        }
    }
    ...
    public void setCancel() {
        ...
        try {
            ...
            if (file != null) {
                DDLog.m1684e("是否删除文件:" + file.delete());
            }
        } catch (Exception unused) {
        }
    }
