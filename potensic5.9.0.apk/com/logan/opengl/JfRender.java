...
import com.logan.libffmpeg.C2992R;
...
public class JfRender implements GLSurfaceView.Renderer {
    ...
    /* renamed from: u */
    private ByteBuffer f2606u;

    /* renamed from: v */
    private ByteBuffer f2607v;
    private FloatBuffer vertexBuffer;
    private final float[] vertexData;
    private int width_yuv;

    /* renamed from: y */
    private ByteBuffer f2608y;
    ...
    public void onSurfaceChanged(GL10 gl10, int i, int i2) {
        DDLog.m1685e("JfRender", "onSurfaceChanged:");
    }
    ...
    private void initRenderYUV() {
        int createProgram = JfShaderUtil.createProgram(JfShaderUtil.readRawTxt(this.context, C2992R.raw.vertex_shader), JfShaderUtil.readRawTxt(this.context, C2992R.raw.fragment_shader));
        ...
        DDLog.m1682d("initRenderYUV");
    }

    public synchronized void setYUVRenderData(int i, int i2, byte[] bArr, byte[] bArr2, byte[] bArr3) {
        if (this.isAnimating) {
            DDLog.m1684e("动画中 不渲染");
            return;
        }
        this.width_yuv = i;
        this.height_yuv = i2;
        ByteBuffer byteBuffer = this.f2608y;
        if (byteBuffer != null) {
            byteBuffer.clear();
        }
        ByteBuffer byteBuffer2 = this.f2606u;
        if (byteBuffer2 != null) {
            byteBuffer2.clear();
        }
        ByteBuffer byteBuffer3 = this.f2607v;
        if (byteBuffer3 != null) {
            byteBuffer3.clear();
        }
        this.f2608y = ByteBuffer.wrap(bArr);
        this.f2606u = ByteBuffer.wrap(bArr2);
        this.f2607v = ByteBuffer.wrap(bArr3);
    }

    public synchronized Bitmap getBitmap() {
        ByteBuffer byteBuffer = this.f2608y;
        if (byteBuffer != null && this.f2606u != null && this.f2607v != null) {
            return YuvTransformer.nv21ToBitmap(YuvTransformer.getNv21(byteBuffer.array(), this.f2606u.array(), this.f2607v.array(), this.width_yuv, this.height_yuv), this.width_yuv, this.height_yuv);
        }
        return null;
    }
    ...
    private synchronized void renderYUV() {
        ...
        if (i2 > 0 && (i = this.height_yuv) > 0 && this.f2608y != null && this.f2606u != null && this.f2607v != null) {
            ...
            if (f != 90.0f && f != 270.0f) {
                ...
                GLES20.glTexImage2D(3553, 0, 6409, this.width_yuv, this.height_yuv, 0, 6409, 5121, this.f2608y);
                GLES20.glActiveTexture(33985);
                GLES20.glBindTexture(3553, this.textureId_yuv[1]);
                GLES20.glTexImage2D(3553, 0, 6409, this.width_yuv / 2, this.height_yuv / 2, 0, 6409, 5121, this.f2606u);
                GLES20.glActiveTexture(33986);
                GLES20.glBindTexture(3553, this.textureId_yuv[2]);
                GLES20.glTexImage2D(3553, 0, 6409, this.width_yuv / 2, this.height_yuv / 2, 0, 6409, 5121, this.f2607v);
