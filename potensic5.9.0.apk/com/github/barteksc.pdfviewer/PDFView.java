...
public class PDFView extends RelativeLayout {
    ...
    void onPageError(PageRenderingException pageRenderingException) {
        this.callbacks.callOnPageError(pageRenderingException.getPage(), pageRenderingException.getCause());
    }
    ...
    void loadError(Throwable th) {
        ...
        if (onError != null) {
            ...
            DDLog.m1685e("PDFView", "load pdf error");
        }
    }
    ...
    */
    ...
    public void fitToWidth(int i) {
        if (this.state != State.SHOWN) {
            DDLog.m1684e("Cannot fit, document not rendered yet");
        } else {
