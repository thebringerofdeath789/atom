...
public class MXParser implements XMLStreamReader, Location {
    ...
    /* renamed from: NO */
    protected static final char[] f1789NO;
    ...
    public MXParser() {
        ...
        this.f1790pc = new char[Runtime.getRuntime().freeMemory() <= 1000000 ? 64 : 8192];
                    ...
                    if (skipS != '?') {
                        ...
                        if (skipS != '?') {
                            ...
                            if (more3 == 'y') {
                                ...
                                requireInput = requireInput(more3, f1789NO);
    ...
    */
    ...
    protected void ensurePC(int i) {
        ...
        System.arraycopy(this.f1790pc, 0, cArr, 0, this.pcEnd);
        this.f1790pc = cArr;
    }
    ...
    protected void joinPC() {
        ...
        if (i2 >= this.f1790pc.length) {
            ensurePC(i2);
        }
        System.arraycopy(this.buf, this.posStart, this.f1790pc, this.pcEnd, i);
        this.pcEnd += i;
        this.usePC = true;
    }
