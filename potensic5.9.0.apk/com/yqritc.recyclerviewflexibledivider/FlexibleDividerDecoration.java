...
public abstract class FlexibleDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    protected FlexibleDividerDecoration(Builder builder) {
        ...
        if (builder.mPaintProvider != null) {
            ...
            if (builder.mDrawableProvider == null) {
                ...
                this.mDrawableProvider = new DrawableProvider() { // from class: com.yqritc.recyclerviewflexibledivider.FlexibleDividerDecoration.1
    ...
    private void setSizeProvider(Builder builder) {
        ...
        if (sizeProvider == null) {
            this.mSizeProvider = new SizeProvider() { // from class: com.yqritc.recyclerviewflexibledivider.FlexibleDividerDecoration.2
            ...
            if (childAdapterPosition >= i) {
                if ((this.mShowLastDivider || childAdapterPosition < itemCount - lastDividerOffset) && !wasDividerAlreadyDrawn(childAdapterPosition, recyclerView)) {
                    ...
                    if (!this.mVisibilityProvider.shouldHideDivider(groupIndex, recyclerView)) {
                        ...
                        int i3 = C34233.f3507x6d0b8790[this.mDividerType.ordinal()];
                        if (i3 == 1) {
    ...
    /* renamed from: com.yqritc.recyclerviewflexibledivider.FlexibleDividerDecoration$3 */
    static /* synthetic */ class C34233 {

        /* renamed from: $SwitchMap$com$yqritc$recyclerviewflexibledivider$FlexibleDividerDecoration$DividerType */
        static final /* synthetic */ int[] f3507x6d0b8790;
        ...
        static {
            ...
            try {
                f3507x6d0b8790[DividerType.PAINT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3507x6d0b8790[DividerType.COLOR.ordinal()] = 3;
    ...
    public static class Builder<T extends Builder> {
        ...
        private VisibilityProvider mVisibilityProvider = new VisibilityProvider() { // from class: com.yqritc.recyclerviewflexibledivider.FlexibleDividerDecoration.Builder.1
        ...
        public T paint(final Paint paint) {
            return paintProvider(new PaintProvider() { // from class: com.yqritc.recyclerviewflexibledivider.FlexibleDividerDecoration.Builder.2
        ...
        public T color(final int i) {
            return colorProvider(new ColorProvider() { // from class: com.yqritc.recyclerviewflexibledivider.FlexibleDividerDecoration.Builder.3
        ...
        public T drawable(final Drawable drawable) {
            return drawableProvider(new DrawableProvider() { // from class: com.yqritc.recyclerviewflexibledivider.FlexibleDividerDecoration.Builder.4
                @Override // com.yqritc.recyclerviewflexibledivider.FlexibleDividerDecoration.DrawableProvider
                public Drawable drawableProvider(int i, RecyclerView recyclerView) {
                    return drawable;
                }
        ...
        public T size(final int i) {
            return sizeProvider(new SizeProvider() { // from class: com.yqritc.recyclerviewflexibledivider.FlexibleDividerDecoration.Builder.5
                @Override // com.yqritc.recyclerviewflexibledivider.FlexibleDividerDecoration.SizeProvider
