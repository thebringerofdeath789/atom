...
public class SettingSecurityFragment extends BaseKFragment<ViewLayoutSettingSecurityBinding> implements SettingSecurityModel.OnSecurityListener {
    ...
    public int getLayoutId() {
        return C1965R.layout.view_layout_setting_security;
    }
    ...
    public void initListener() {
        ...
        ((ViewLayoutSettingSecurityBinding) this.mBind).csvBeginner.setListener(new CommonSwitchView.OnSwitchChangeListener() { // from class: com.ipotensic.kernel.fragment.SettingSecurityFragment.2
            ...
            public void onCheckedChanged(View view, boolean z) {
                if (!z || !Boolean.TRUE.equals(SettingSecurityFragment.this.kernelViewModel.isReturnOrLanding().getValue())) {
                ...
                ((ViewLayoutSettingSecurityBinding) SettingSecurityFragment.this.mBind).csvBeginner.check(false);
                SettingSecurityFragment.this.onToast(C1965R.string.returning_switch_mode_unavailable);
            }

            @Override // com.ipotensic.kernel.view.CommonSwitchView.OnSwitchChangeListener
            public void onDisableClick(View view) {
                SettingSecurityFragment.this.onToast(C1965R.string.toast_unconnected_tips);
            }
        });
        ...
        ((ViewLayoutSettingSecurityBinding) this.mBind).cswStop.setListener(new CommonSwitchView.OnSwitchChangeListener() { // from class: com.ipotensic.kernel.fragment.SettingSecurityFragment.6
            @Override // com.ipotensic.kernel.view.CommonSwitchView.OnSwitchChangeListener
            public void onDisableClick(View view) {
            }
            ...
            @Override // com.ipotensic.kernel.view.CommonSwitchView.OnSwitchChangeListener
            public void onCheckedChanged(View view, boolean z) {
                if (!FlightRevData.get().getFlightRevStateData().isSupportEmergencyStop()) {
                    ToastUtil.toast(SettingSecurityFragment.this.getActivity(), SettingSecurityFragment.this.getString(C1965R.string.toast_please_upgrade_the_drone_to_the_latest_firmware));
                    ((ViewLayoutSettingSecurityBinding) SettingSecurityFragment.this.mBind).cswStop.check(!z);
                } else if (!z) {
                    SettingSecurityFragment.this.showEmergencyStopDialog();
                } else {
                    FlightSendData.get().getSendGeneralData().setDataType(CommonMsgType.ENABLE_EMERGENCY_STOP);
    ...
    public /* synthetic */ void lambda$initListener$2$SettingSecurityFragment(int i, View view) {
        if (i == 0) {
            ...
            this.model.btnKmClick(view);
            ((ViewLayoutSettingSecurityBinding) this.mBind).csvUnit.checked(1);
        } else {
            this.model.btnFtClick(view);
            ((ViewLayoutSettingSecurityBinding) this.mBind).csvUnit.checked(2);
        }
    }
    ...
    private void showLostActionDialog(final int i) {
        String string = getString(C1965R.string.settings_safety_signal_lost_change_drone_behavior_return_tips);
        if (i == 1) {
            string = getString(C1965R.string.settings_safety_signal_lost_change_drone_behavior_landing_tips);
        } else if (i == 2) {
            string = getString(C1965R.string.settings_safety_signal_lost_change_drone_behavior_hovering_tips);
        }
        GeneralDialog generalDialog = new GeneralDialog(requireContext(), getString(C1965R.string.settings_safety_signal_lost_change_drone_behavior_title), string, getString(C1965R.string.dialog_cancel), getString(C1965R.string.dialog_confirm), new OnResultListener<Boolean>() { // from class: com.ipotensic.kernel.fragment.SettingSecurityFragment.7
    ...
    private void showReturnHeightVideo() {
        DDLog.m1682d("showReturnHeightVideo");
    ...
    public void initData() {
        ...
        this.uomViewModel = (UomViewModel) new ViewModelProvider(getActivity()).get(UomViewModel.class);
        ...
        ((ViewLayoutSettingSecurityBinding) this.mBind).crv.setItems(getString(C1965R.string.txt_speed_gently), getString(C1965R.string.txt_speed_normal), getString(C1965R.string.txt_speed_sport));
        ...
        if (SPHelper.getInstance().isFt()) {
            ((ViewLayoutSettingSecurityBinding) this.mBind).csvUnit.checked(2);
        } else if (SPHelper.getInstance().getBoolean(SPHelper.KEY_UNITS_KM, false)) {
            ((ViewLayoutSettingSecurityBinding) this.mBind).csvUnit.checked(1);
        } else {
            ((ViewLayoutSettingSecurityBinding) this.mBind).csvUnit.checked(0);
        }
        ((ViewLayoutSettingSecurityBinding) this.mBind).csvLost.setEnabled(this.model.FlightIsConnect.get());
        ((ViewLayoutSettingSecurityBinding) this.mBind).cswStop.setViewEnableWithAlpha(this.model.FlightIsConnect.get());
        ((ViewLayoutSettingSecurityBinding) this.mBind).viewFightTip.check(SPHelper.getInstance().isShowFlightTips());
        this.model.showBatteryInfo.addOnPropertyChangedCallback(new C23338());
        ((ViewLayoutSettingSecurityBinding) this.mBind).edtDistanceLimit.setInputEnable(this.model.isDistanceEnable(true));
        ViewUtils.setViewEnableWithAlpha(((ViewLayoutSettingSecurityBinding) this.mBind).seekbarDistanceLimit, this.model.isDistanceEnable(false));
    ...
    /* renamed from: com.ipotensic.kernel.fragment.SettingSecurityFragment$8 */
    class C23338 extends Observable.OnPropertyChangedCallback {
        C23338() {
        }
        ...
        public void onPropertyChanged(Observable observable, int i) {
            ...
            if (SettingSecurityFragment.this.model.showBatteryInfo.get()) {
                ((ViewLayoutSettingSecurityBinding) SettingSecurityFragment.this.mBind).tvBatteryInfo.setCompoundDrawablesRelativeWithIntrinsicBounds(0, 0, C1965R.mipmap.img_btn_function_close, 0);
                ((ViewLayoutSettingSecurityBinding) SettingSecurityFragment.this.mBind).layoutSetting.post(new Runnable() { // from class: com.ipotensic.kernel.fragment.-$$Lambda$SettingSecurityFragment$8$sSJDJIskykgmwXJeeA1JSxim1V8
                    @Override // java.lang.Runnable
                    public final void run() {
                        SettingSecurityFragment.C23338.this.lambda$onPropertyChanged$0$SettingSecurityFragment$8();
                    }
                });
            } else {
                ((ViewLayoutSettingSecurityBinding) SettingSecurityFragment.this.mBind).tvBatteryInfo.setCompoundDrawablesRelativeWithIntrinsicBounds(0, 0, C1965R.mipmap.img_btn_function_open, 0);
            }
        }

        public /* synthetic */ void lambda$onPropertyChanged$0$SettingSecurityFragment$8() {
    ...
    private void onFlightTypeDefine() {
        ...
        if (FlightConfig.is_Atom_Series() && !FlightConfig.isAtomSE()) {
            ((ViewLayoutSettingSecurityBinding) this.mBind).cswStop.setVisibility(0);
        } else {
            ((ViewLayoutSettingSecurityBinding) this.mBind).cswStop.setVisibility(8);
        }
        updateHeightLimit();
        updateDistanceLimit();
    ...
    private void updateHeightLimit() {
        ...
        if (Arrays.asList(this.EU_CODE).contains(SPHelper.getInstance().getCountryCode()) || SPHelper.getInstance().getCountryCode() == null) {
            ...
            i = 120;
        } else if (CountryCode.JP.getCode().equalsIgnoreCase(SPHelper.getInstance().getCountryCode()) || CountryCode.KR.getCode().equalsIgnoreCase(SPHelper.getInstance().getCountryCode())) {
        ...
        ((ViewLayoutSettingSecurityBinding) this.mBind).tvHeightLimit.setText(getString(C1965R.string.txt_flight_height_limit, Integer.valueOf(i2), Integer.valueOf(i), this.model.unitTips.get()));
        DDLog.m1685e(TAG, "updateHeightLimit max:" + i);
        ((ViewLayoutSettingSecurityBinding) this.mBind).tvAltitudeCarefulTips.setText(getString(C1965R.string.settings_safety_virtual_fence_altitude_limit_over_tip, FlightConfig.get_value(this.model.warnMaxHeight.get()) + "", this.model.unitTips.get()));
    ...
    private void updateDistanceLimit() {
        ...
        ((ViewLayoutSettingSecurityBinding) this.mBind).tvDistanceLimit.setText(getString(C1965R.string.txt_flight_distance_limit, Integer.valueOf(i2), Integer.valueOf(i), this.model.unitTips.get()));
    }
    ...
    /* renamed from: com.ipotensic.kernel.fragment.SettingSecurityFragment$20 */
    static /* synthetic */ class C232720 {
    ...
    public void initObserver() {
        ...
        this.model.speedModeIsShow.addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() { // from class: com.ipotensic.kernel.fragment.SettingSecurityFragment.9
            @Override // androidx.databinding.Observable.OnPropertyChangedCallback
            public void onPropertyChanged(Observable observable, int i) {
        ...
        this.model.FlightIsConnect.addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() { // from class: com.ipotensic.kernel.fragment.SettingSecurityFragment.10
            @Override // androidx.databinding.Observable.OnPropertyChangedCallback
            public void onPropertyChanged(Observable observable, int i) {
                ((ViewLayoutSettingSecurityBinding) SettingSecurityFragment.this.mBind).crv.setEnabled(SettingSecurityFragment.this.model.FlightIsConnect.get() && SettingSecurityFragment.this.model.speedModeIsShow.get());
                ...
                ((ViewLayoutSettingSecurityBinding) SettingSecurityFragment.this.mBind).cswStop.setViewEnableWithAlpha(SettingSecurityFragment.this.model.FlightIsConnect.get());
            }
        });
        this.model.unitIsFt.addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() { // from class: com.ipotensic.kernel.fragment.SettingSecurityFragment.11
            @Override // androidx.databinding.Observable.OnPropertyChangedCallback
            public void onPropertyChanged(Observable observable, int i) {
                DDLog.m1683d(SettingSecurityFragment.TAG, "unitIsFt---" + SettingSecurityFragment.this.model.unitIsFt.get());
        ...
        this.model.beginnerMode.addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() { // from class: com.ipotensic.kernel.fragment.SettingSecurityFragment.12
            @Override // androidx.databinding.Observable.OnPropertyChangedCallback
            public void onPropertyChanged(Observable observable, int i) {
                DDLog.m1683d(SettingSecurityFragment.TAG, "beginnerMode---" + SettingSecurityFragment.this.model.beginnerMode.get());
        ...
        this.model.batteryProgressValue.addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() { // from class: com.ipotensic.kernel.fragment.SettingSecurityFragment.13
            @Override // androidx.databinding.Observable.OnPropertyChangedCallback
            public void onPropertyChanged(Observable observable, int i) {
        ...
        this.model.inputLimitDistance.addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() { // from class: com.ipotensic.kernel.fragment.SettingSecurityFragment.14
            @Override // androidx.databinding.Observable.OnPropertyChangedCallback
            public void onPropertyChanged(Observable observable, int i) {
                DDLog.m1683d(SettingSecurityFragment.TAG, "inputLimitDistance---" + SettingSecurityFragment.this.model.inputLimitDistance.get());
                if (SettingSecurityFragment.this.model.isNoLimit()) {
                    return;
                }
                ((ViewLayoutSettingSecurityBinding) SettingSecurityFragment.this.mBind).edtDistanceLimit.setText(String.valueOf(FlightConfig.get_value(SettingSecurityFragment.this.model.inputLimitDistance.get())));
        ...
        this.model.enableEmergencyStop.observe(this, new Observer() { // from class: com.ipotensic.kernel.fragment.-$$Lambda$SettingSecurityFragment$JK_4Z4AroCK3gzQw-01hYMHWEIk
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                SettingSecurityFragment.this.lambda$initObserver$14$SettingSecurityFragment((Boolean) obj);
            }
        });
    }

    public /* synthetic */ void lambda$initObserver$8$SettingSecurityFragment(CtrlType ctrlType) {
        int i = C232720.$SwitchMap$com$logan$flight$enums$CtrlType[ctrlType.ordinal()];
        if (i == 1) {
            ...
            ((ViewLayoutSettingSecurityBinding) this.mBind).tvLostChild.setCompoundDrawablesRelativeWithIntrinsicBounds(C1965R.mipmap.img_btn_signal_lost_child_return_unselect, 0, 0, 0);
            controlLostActionNotice(true);
            ((ViewLayoutSettingSecurityBinding) this.mBind).csvLost.checked(0);
        } else if (i == 4) {
            ((ViewLayoutSettingSecurityBinding) this.mBind).tvLostChild.setCompoundDrawablesRelativeWithIntrinsicBounds(C1965R.mipmap.img_btn_signal_lost_child_return_select, 0, 0, 0);
            controlLostActionNotice(true);
            ((ViewLayoutSettingSecurityBinding) this.mBind).csvLost.checked(0);
        }
        scrollToLostAction();
    ...
    public /* synthetic */ void lambda$initObserver$12$SettingSecurityFragment(Boolean bool) {
        DDLog.m1683d(TAG, "isNoLimit---" + bool);
    ...
    public /* synthetic */ void lambda$initObserver$14$SettingSecurityFragment(Boolean bool) {
        ((ViewLayoutSettingSecurityBinding) this.mBind).cswStop.check(bool.booleanValue());
    }
    ...
    private void setUnitString() {
        ((ViewLayoutSettingSecurityBinding) this.mBind).csvBeginner.setContent(getString(C1965R.string.settings_safety_flight_mode_beginner_mode_tips));
        ((ViewLayoutSettingSecurityBinding) this.mBind).tvLostChild.setText(getString(C1965R.string.txt_lost_to_return));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void showCloseNewHandModeDialog() {
        GeneralOneButtonDialog confirmStr = new GeneralOneButtonDialog(getContext()).setTitleId(C1965R.string.settings_safety_exit_beginner_mode_title).setContent(getString(C1965R.string.settings_safety_exit_beginner_mode_tips)).setConfirmStr(C1965R.string.txt_guide_map_know);
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        switch (C232720.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()]) {
            case 1:
                this.model.updateFlightType();
                onFlightTypeDefine();
                setUomUIVisible();
    ...
    public void onToast(int i) {
        if (i == C1965R.string.switch_sport_mode_tip) {
            if (PhoneConfig.isFt) {
                ToastUtil.toast(getActivity(), getString(C1965R.string.switch_sport_mode_tip, "26ft"));
                return;
            } else {
                ToastUtil.toast(getActivity(), getString(C1965R.string.switch_sport_mode_tip, "8m"));
                return;
            }
        }
    ...
    public void showEmergencyStopDialog() {
        if (this.emergencyStopDialog == null) {
            this.emergencyStopDialog = new GeneralDialog(getContext(), getContext().getString(C1965R.string.f2140xa1d4299b), getContext().getString(C1965R.string.popup_confirm_to_disable_emergency_propeller_stop_midflight_tips), getContext().getString(C1965R.string.dialog_confirm), new GeneralDialog.DialogListener() { // from class: com.ipotensic.kernel.fragment.SettingSecurityFragment.16
                @Override // com.ipotensic.kernel.view.dialog.GeneralDialog.DialogListener
                public void cancel() {
                    ((ViewLayoutSettingSecurityBinding) SettingSecurityFragment.this.mBind).cswStop.check(true);
                }

                @Override // com.ipotensic.kernel.view.dialog.GeneralDialog.DialogListener
                public void confirm() {
                    FlightSendData.get().getSendGeneralData().setDataType(CommonMsgType.DISABLE_EMERGENCY_STOP);
                    DataManager.getInstance().sendGeneralData();
                }
            });
        }
    ...
    private void hideEmergencyStopDialog() {
        GeneralDialog generalDialog = this.emergencyStopDialog;
        if (generalDialog == null || !generalDialog.isShowing()) {
            return;
        }
        ((ViewLayoutSettingSecurityBinding) this.mBind).cswStop.check(false);
        this.emergencyStopDialog.dismiss();
        this.emergencyStopDialog = null;
    }
    ...
    private void setUomUIVisible() {
        ((ViewLayoutSettingSecurityBinding) this.mBind).layoutUom.setVisibility(this.kernelViewModel.isSupportUom() ? 0 : 8);
    }

    private void initUomView() {
        boolean z = false;
        ((ViewLayoutSettingSecurityBinding) this.mBind).tvFlightRouteUploadRecord.setOnClickListener(new ScaleClickListener(z) { // from class: com.ipotensic.kernel.fragment.SettingSecurityFragment.17
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view) {
                SettingSecurityFragment.this.kernelViewModel.getUomUploadRecord().setValue(true);
            }
        });
        ((ViewLayoutSettingSecurityBinding) this.mBind).tvUomExpand.setOnClickListener(new ScaleClickListener(z) { // from class: com.ipotensic.kernel.fragment.SettingSecurityFragment.18
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view) {
                if (((ViewLayoutSettingSecurityBinding) SettingSecurityFragment.this.mBind).layoutUomExpend.getVisibility() == 0) {
                    ((ViewLayoutSettingSecurityBinding) SettingSecurityFragment.this.mBind).layoutUomExpend.setVisibility(8);
                    ViewUtils.setDrawableRight(((ViewLayoutSettingSecurityBinding) SettingSecurityFragment.this.mBind).tvUomExpand, C1965R.mipmap.button_arrow_unfold);
                } else {
                    ((ViewLayoutSettingSecurityBinding) SettingSecurityFragment.this.mBind).layoutUomExpend.setVisibility(0);
                    ViewUtils.setDrawableRight(((ViewLayoutSettingSecurityBinding) SettingSecurityFragment.this.mBind).tvUomExpand, C1965R.mipmap.button_function_open);
                }
            }
        });
        SpannableString spannableString = new SpannableString(getString(C1965R.string.uom_settings_dynamic_data_transmission_tips));
        try {
            ...
            while (i < arrayList.size()) {
                ...
                spannableString.setSpan(new ClickableSpan() { // from class: com.ipotensic.kernel.fragment.SettingSecurityFragment.19
                    @Override // android.text.style.ClickableSpan
                    public void onClick(View view) {
                        try {
                            SettingSecurityFragment.this.startActivity(new Intent("android.intent.action.VIEW", Uri.parse(str2)));
                        } catch (Exception e) {
                            DDLog.m1684e("跳转报错 :" + e);
                        }
                    }
                    ...
                    public void updateDrawState(TextPaint textPaint) {
                        ...
                        textPaint.setColor(SettingSecurityFragment.this.requireActivity().getColor(C1965R.color.color_dialog_blue_bg));
                    }
        ...
        ((ViewLayoutSettingSecurityBinding) this.mBind).tvUomTips.setMovementMethod(LinkMovementMethod.getInstance());
        ((ViewLayoutSettingSecurityBinding) this.mBind).tvUomTips.setHighlightColor(0);
        ((ViewLayoutSettingSecurityBinding) this.mBind).tvUomTips.setText(spannableString);
    }

    private void initUomObserver() {
        this.uomViewModel.getUomState().observe(this, new Observer() { // from class: com.ipotensic.kernel.fragment.-$$Lambda$SettingSecurityFragment$RPHxPC04Ypn6BcDee_IfspykdDA
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                SettingSecurityFragment.this.lambda$initUomObserver$15$SettingSecurityFragment((UomState) obj);
            }
        });
    }

    public /* synthetic */ void lambda$initUomObserver$15$SettingSecurityFragment(UomState uomState) {
        ((ViewLayoutSettingSecurityBinding) this.mBind).tvUploadState.setText(getString(uomState.getStrId()));
        ((ViewLayoutSettingSecurityBinding) this.mBind).tvUploadState.setTextColor(requireContext().getColor(uomState.getColorId()));
    }
}