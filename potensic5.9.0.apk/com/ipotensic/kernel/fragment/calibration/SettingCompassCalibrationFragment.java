...
public class SettingCompassCalibrationFragment extends BaseKFragment<ViewLayoutCompassCalibrationBinding> {
    ...
    private final Handler handler = new Handler(Looper.getMainLooper()) { // from class: com.ipotensic.kernel.fragment.calibration.SettingCompassCalibrationFragment.1
        ...
        public void handleMessage(Message message) {
            int i = message.arg1;
            ((ViewLayoutCompassCalibrationBinding) SettingCompassCalibrationFragment.this.mBind).tvCountDown.setText(String.format(SettingCompassCalibrationFragment.this.getString(C1965R.string.exiting), Integer.valueOf(i)));
            if (i <= 0) {
    ...
    public int getLayoutId() {
        return C1965R.layout.view_layout_compass_calibration;
    }
    ...
    public /* synthetic */ void lambda$initListener$1$SettingCompassCalibrationFragment(View view) {
        if (this.isCalibrating) {
            ToastUtil.showImageTop(getActivity(), getString(C1965R.string.toast_calibration_close), C1965R.mipmap.icon_gyroscope_galibration);
        } else {
    ...
    /* renamed from: com.ipotensic.kernel.fragment.calibration.SettingCompassCalibrationFragment$3 */
    static /* synthetic */ class C23513 {
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        int i = C23513.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()];
        if (i == 1) {
            ...
            try {
                ...
                DDLog.m1685e("SettingCompassCalibrationFragment", "校准结果报错:" + e.getMessage());
                return;
            }
        }
        if (i == 2) {
    ...
    private void lambda$initData$0$SettingCompassCalibrationFragment() {
        if (getActivity() == null) {
            return;
        }
        ...
        if (!flightRevStateData.isOutdoor()) {
            ToastUtil.toast(getActivity(), getString(C1965R.string.f2142xa0c56cf5));
            return;
        }
        if (flightRevStateData.isGeomagneticFault()) {
            ToastUtil.toast(getActivity(), getString(C1965R.string.error_geo_fault));
            return;
        }
        if (!flightRevStateData.isUnLock() && !flightRevStateData.isFlight()) {
            ...
            if (FlightConfig.isAtomPanTilt()) {
                this.horizontalRes = C1965R.drawable.anim_geo_horizontal_atom;
                this.verticalRes = C1965R.drawable.anim_geo_vertical_atom;
            } else if (FlightConfig.isAtomLT()) {
                this.horizontalRes = C1965R.drawable.anim_geo_horizontal_atomlt;
                this.verticalRes = C1965R.drawable.anim_geo_vertical_atomlt;
            } else {
                this.horizontalRes = C1965R.drawable.anim_geo_horizontal_mini;
                this.verticalRes = C1965R.drawable.anim_geo_vertical_mini;
            }
            this.miniMagCalibrationHelper.setCalibrationResultListener(new OnCalibrationResultListener() { // from class: com.ipotensic.kernel.fragment.calibration.SettingCompassCalibrationFragment.2
                ...
                public void onHorizontalCalibration() {
                    ...
                    DDLog.m1685e("SettingCompassCalibrationFragment", "开始水平校准");
                    ...
                    ((ViewLayoutCompassCalibrationBinding) SettingCompassCalibrationFragment.this.mBind).tvCompassTitle.setText(SettingCompassCalibrationFragment.this.getString(C1965R.string.compass_level_calibrate));
                    ((ViewLayoutCompassCalibrationBinding) SettingCompassCalibrationFragment.this.mBind).tvMiniGeoStepTips.setText(SettingCompassCalibrationFragment.this.getString(C1965R.string.dialog_geo_horizontal_tips));
                    SettingCompassCalibrationFragment.this.model.setViewVisible(1);
                    SettingCompassCalibrationFragment.this.model.setImageId(C1965R.mipmap.icon_mini_geo_step_one);
                ...
                public void onVerticalCalibration() {
                    ...
                    DDLog.m1685e("SettingCompassCalibrationFragment", "开始垂直校准");
                    ...
                    ((ViewLayoutCompassCalibrationBinding) SettingCompassCalibrationFragment.this.mBind).tvCompassTitle.setText(SettingCompassCalibrationFragment.this.getString(C1965R.string.compass_vertical_calibration));
                    ((ViewLayoutCompassCalibrationBinding) SettingCompassCalibrationFragment.this.mBind).tvMiniGeoStepTips.setText(SettingCompassCalibrationFragment.this.getString(C1965R.string.dialog_geo_vertical_tips));
                    SettingCompassCalibrationFragment.this.model.setImageId(C1965R.mipmap.icon_mini_geo_step_two);
                }
        ...
        ToastUtil.toast(getActivity(), getString(C1965R.string.txt_error_flighting_unavailable));
    }
    ...
    public void calibrateEnd(int i) {
        DDLog.m1685e("SettingCompassCalibrationFragment", "校准结果：" + i);
        ...
        if (i == 0) {
            ((ViewLayoutCompassCalibrationBinding) this.mBind).tvCompassTitle.setText(getString(C1965R.string.calibration_successful));
            EventDispatcher.get().sendEvent(EventID.AUDIO_CALIBRATION_SUCCESS);
            showLoadingDialog();
        } else {
            if (i == 1) {
                ((ViewLayoutCompassCalibrationBinding) this.mBind).tvFailNotice.setText(getString(C1965R.string.f2141x7cdd925c));
            } else {
                ((ViewLayoutCompassCalibrationBinding) this.mBind).tvFailNotice.setText(getString(C1965R.string.calibration_failed_tips_remote_controller_signal_weak));
            }
            ((ViewLayoutCompassCalibrationBinding) this.mBind).tvCompassTitle.setText(getString(C1965R.string.calibration_failed));
    ...
    private void resetMiniCalibrationUI() {
        ...
        DDLog.m1685e("SettingCompassCalibrationFragment", "重置校准UI");
        ...
        ((ViewLayoutCompassCalibrationBinding) this.mBind).tvCompassTitle.setText(getString(C1965R.string.setting_compass_calibration));
        ((ViewLayoutCompassCalibrationBinding) this.mBind).imgAtom.setImageResource(C1965R.drawable.anim_geo_horizontal_mini);
        ((ViewLayoutCompassCalibrationBinding) this.mBind).tvMiniGeoStepTips.setText(getString(C1965R.string.dialog_geo_horizontal_tips));
        this.model.setImageId(C1965R.mipmap.icon_mini_geo_step_one);
    }
