...
public class SettingAboutFragment extends BaseKFragment<ViewLayoutSettingAboutBinding> implements BaseModelObservable.OnPropertyChangeListener {
    ...
    public int getLayoutId() {
        return C1965R.layout.view_layout_setting_about;
    }
    ...
    public void initObserver() {
        ...
        this.settingAboutModel.flightSN.addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() { // from class: com.ipotensic.kernel.fragment.SettingAboutFragment.1
            @Override // androidx.databinding.Observable.OnPropertyChangedCallback
            public void onPropertyChanged(Observable observable, int i) {
                SettingAboutFragment.this.setUomUIVisible();
            }
        });
    }
    ...
    /* renamed from: com.ipotensic.kernel.fragment.SettingAboutFragment$2 */
    static /* synthetic */ class C23072 {
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        switch (C23072.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()]) {
            case 1:
            case 2:
    ...
    public void setUomUIVisible() {
        int i = 8;
        if (FlightConfig.isConnectFlight()) {
            LinearLayout linearLayout = ((ViewLayoutSettingAboutBinding) this.mBind).layoutUomRegistration;
            if (this.kernelViewModel.isSupportUom() && this.settingAboutModel.flightSN.get() != null) {
                i = 0;
            }
            linearLayout.setVisibility(i);
            return;
        }
        ((ViewLayoutSettingAboutBinding) this.mBind).layoutUomRegistration.setVisibility(8);
    }
}