...
public class SettingControlFragment extends BaseKFragment<ViewLayoutSettingControlBinding> implements BaseModelObservable.OnPropertyChangeListener {
    ...
    public int getLayoutId() {
        return C1965R.layout.view_layout_setting_control;
    }
    ...
    /* renamed from: com.ipotensic.kernel.fragment.SettingControlFragment$1 */
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        int i = C23141.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()];
        if (i == 1) {
            this.model.update(FlightRevData.get().getGimbalSettingData());
            return;
        }
