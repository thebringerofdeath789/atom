...
public class SwitchButton extends View {
    ...
    public void switchStateListener(SwitchStateListener switchStateListener) {
        ...
        DDLog.m1691w("switch: setListener:" + this.stateListener);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.width == 0.0f) {
            ...
            this.f2246r = (getHeight() - (this.spaceY * 2.0f)) / 2.0f;
            this.maxOffsetX = getWidth() - ((this.spaceX + this.f2246r) * 2.0f);
        }
        paint();
    }
