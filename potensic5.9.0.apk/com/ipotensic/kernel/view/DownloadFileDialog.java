...
public class DownloadFileDialog extends BaseDialog {
    ...
    public DownloadFileDialog(Context context, int i, CancelListener cancelListener) {
        super(context, C1965R.layout.view_dialog_download_file);
        ...
        AnimationUtil.selfRotate(this.f2244iv);
    ...
    protected void initView(Context context) {
        ...
        this.f2244iv = (ImageView) findViewById(C1965R.id.iv_rotate);
        this.tvProgress = (TextView) findViewById(C1965R.id.tv_progress);
        this.progressBar = (NumberProgressBar) findViewById(C1965R.id.progress_bar);
        findViewById(C1965R.id.btn_cancel).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.view.DownloadFileDialog.1
    ...
    private class DownloadCallback implements Handler.Callback, DownloadListener {
        ...
        public boolean handleMessage(Message message) {
            ...
            if (i == 1) {
                ...
                AnimationUtil.selfRotate(DownloadFileDialog.this.f2244iv);
            } else if (i == 2) {
                int i2 = message.arg1;
                ...
                if (i == 4) {
                    ...
                    if (CameraConfig.get().sdCardState != SdCardState.SD_CARD_NOT_EXIST) {
                        ToastUtil.toast((Activity) DownloadFileDialog.this.context, DownloadFileDialog.this.getContext().getResources().getString(C1965R.string.dialog_download_failure));
                        String str = (String) message.obj;
                        DDLog.m1687i("error:" + str);
                        if (DownloadFileDialog.this.listener != null) {
                    ...
                    DownloadFileDialog.this.dismiss();
                    ToastUtil.toast((Activity) DownloadFileDialog.this.context, DownloadFileDialog.this.getContext().getResources().getString(C1965R.string.dialog_download_failure_sd_not_space));
                    if (DownloadFileDialog.this.listener != null) {
                ...
                if (DownloadFileDialog.this.isShowDownloadSuccess) {
                    ToastUtil.showImageTop((Activity) DownloadFileDialog.this.context, DownloadFileDialog.this.getContext().getResources().getString(C1965R.string.toast_download_success), C1965R.mipmap.icon_toast_successful);
                }
                if (DownloadFileDialog.this.listener != null) {
