...
public class CrossView extends View {
    ...
    private void initPaint() {
        ...
        this.paint.setColor(getContext().getColor(C1965R.color.colorSixPercent));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int color = getContext().getColor(C1965R.color.color50TransBlack);
        int color2 = getContext().getColor(C1965R.color.white);
