...
public class BatteryProgressView extends View {
    ...
    public BatteryProgressView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1965R.attr.BatteryProgressView);
    }
    ...
    private void obtainAttrs(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1965R.styleable.BatteryProgressView);
        Resources resources = getResources();
        this.lineColor = obtainStyledAttributes.getColor(C1965R.styleable.BatteryProgressView_lineColor, resources.getColor(C1965R.color.color_battery_line));
        this.bgColor = obtainStyledAttributes.getColor(C1965R.styleable.BatteryProgressView_bgColor, resources.getColor(C1965R.color.color_battery_bg));
        this.forColor = obtainStyledAttributes.getColor(C1965R.styleable.BatteryProgressView_forColor, resources.getColor(C1965R.color.color_battery_for));
        this.fontColor = obtainStyledAttributes.getColor(C1965R.styleable.BatteryProgressView_fontColor, resources.getColor(C1965R.color.colorWhite));
        this.startAngle = obtainStyledAttributes.getFloat(C1965R.styleable.BatteryProgressView_startAngle, 135.0f);
        this.sweepAngle = obtainStyledAttributes.getFloat(C1965R.styleable.BatteryProgressView_sweepAngle, 270.0f);
        this.surplusContent = resources.getString(C1965R.string.sys_surplus);
        this.electricContent = resources.getString(C1965R.string.sys_electric);
    ...
    private void init() {
        ...
        this.fontPaint.setTextSize(getResources().getDimension(C1965R.dimen.sp_20));
        ...
        this.titlePaint.setTextSize(getResources().getDimension(C1965R.dimen.sp_9));
    ...
    public void setProgress(int i) {
        ...
        if (i <= 20) {
            this.bacPaint.setColor(ContextCompat.getColor(getContext(), C1965R.color.color_battery_warn_bg));
            this.forPaint.setColor(ContextCompat.getColor(getContext(), C1965R.color.color_battery_warn_for));
            this.linePaint.setColor(ContextCompat.getColor(getContext(), C1965R.color.color_battery_warn_line));
            this.fontPaint.setColor(ContextCompat.getColor(getContext(), C1965R.color.color_battery_warn_for));
        } else {
            this.bacPaint.setColor(ContextCompat.getColor(getContext(), C1965R.color.color_battery_bg));
            this.forPaint.setColor(ContextCompat.getColor(getContext(), C1965R.color.color_battery_for));
            this.linePaint.setColor(ContextCompat.getColor(getContext(), C1965R.color.color_battery_line));
            this.fontPaint.setColor(ContextCompat.getColor(getContext(), C1965R.color.colorWhite));
        }
