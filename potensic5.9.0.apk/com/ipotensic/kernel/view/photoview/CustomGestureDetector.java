...
class CustomGestureDetector {
    ...
    CustomGestureDetector(Context context, OnGestureListener onGestureListener) {
        ...
        this.mDetector = new ScaleGestureDetector(context, new ScaleGestureDetector.OnScaleGestureListener() { // from class: com.ipotensic.kernel.view.photoview.CustomGestureDetector.1
