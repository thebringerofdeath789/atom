...
class Util {
    ...
    /* renamed from: com.ipotensic.kernel.view.photoview.Util$1 */
    static /* synthetic */ class C26321 {
    ...
    static boolean isSupportedScaleType(ImageView.ScaleType scaleType) {
        ...
        if (C26321.$SwitchMap$android$widget$ImageView$ScaleType[scaleType.ordinal()] != 1) {
            return true;
        }
