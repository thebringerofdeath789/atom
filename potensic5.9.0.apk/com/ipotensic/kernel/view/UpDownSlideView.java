...
public class UpDownSlideView extends RelativeLayout {
    ...
    private void init() {
        setBackgroundColor(getContext().getResources().getColor(C1965R.color.colorTransparent));
        addBg();
        addSlidePoint();
    ...
    private void addBg() {
        ...
        imageView.setImageResource(C1965R.mipmap.icon_slie_line);
    ...
    private void addSlidePoint() {
        ...
        imageView.setImageResource(C1965R.mipmap.icon_blue_point);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        DDLog.m1684e("slidePercent eventY:" + y);
        ...
        if (action == 0) {
            ...
            if (action == 2 && this.isSlide) {
                ...
                if (i <= y && y <= bottom2) {
                    ...
                    this.imgSlidePoint.setImageResource(C1965R.mipmap.icon_blue_point);
                    int i2 = this.viewCenter;
                    this.slidePercent = ((i2 - y) * 100) / i2;
                } else if (y <= i) {
                    this.imgSlidePoint.setY(i);
                    this.imgSlidePoint.setImageResource(C1965R.mipmap.icon_red_point);
        ...
        if (this.isSlide) {
            ...
            DDLog.m1682d("slidePercent:" + this.slidePercent);
