...
@Metadata(m2336bv = {1, 0, 3}, m2337d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\b\n\u0002\u0010\b\n\u0000\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0018\u0010\u000e\u001a\u00020\t2\u0006\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u0012H\u0016J\b\u0010\u0013\u001a\u00020\tH\u0016J\u000e\u0010\u0014\u001a\u00020\u00002\u0006\u0010\u0003\u001a\u00020\u0004J\u0010\u0010\u0015\u001a\u00020\u00002\b\u0010\u0005\u001a\u0004\u0018\u00010\u0006J\u0016\u0010\u0016\u001a\u00020\u00002\u000e\u0010\u0017\u001a\n\u0012\u0004\u0012\u00020\t\u0018\u00010\bJ\u000e\u0010\u0018\u001a\u00020\u00002\u0006\u0010\n\u001a\u00020\fJ\u000e\u0010\u0018\u001a\u00020\u00002\u0006\u0010\n\u001a\u00020\u0006J\u000e\u0010\u0019\u001a\u00020\u00002\u0006\u0010\r\u001a\u00020\u0006J\b\u0010\u001a\u001a\u00020\u001bH\u0016R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0006X\u0082\u000e¢\u0006\u0002\n\u0000R\u0016\u0010\u0007\u001a\n\u0012\u0004\u0012\u00020\t\u0018\u00010\bX\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\n\u001a\u0004\u0018\u00010\u0006X\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u000b\u001a\u0004\u0018\u00010\fX\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\r\u001a\u0004\u0018\u00010\u0006X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u001c"}, m2338d2 = {"Lcom/ipotensic/kernel/view/dialog/CommonOneButtonDialog;", "Lcom/ipotensic/kernel/view/dialog/CommonDialog;", "()V", "autoDismiss", "", "buttonStr", "", "confirmListener", "Lkotlin/Function0;", "", "content", "contentSp", "Landroid/text/SpannableString;", MessageBundle.TITLE_ENTRY, "convertView", "holder", "Lcom/ipotensic/kernel/view/dialog/BaseDialogViewHolder;", "dialog", "Lcom/ipotensic/kernel/view/dialog/BaseDialog;", "initSize", "setAutoDismiss", "setButtonStr", "setConfirmListener", "listener", "setContent", "setTitle", "setUpLayoutId", "", "Kernel_mapboxRelease"}, m2339k = 1, m2340mv = {1, 1, 15})
...
public final class CommonOneButtonDialog extends CommonDialog {
    ...
    public int setUpLayoutId() {
        return C1965R.layout.dialog_common_one_button;
    }
    ...
    public final CommonOneButtonDialog setContent(SpannableString content) {
        Intrinsics.checkParameterIsNotNull(content, "content");
    ...
    public void initSize() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(requireContext(), "requireContext()");
        setSize((int) (RangesKt.coerceAtLeast(screenHeight, companion2.getScreenWidth(r3)) * 0.45d), 0);
    }
    ...
    public void convertView(BaseDialogViewHolder holder, BaseDialog dialog) {
        ...
        holder.setText(C1965R.id.tv_dialog_title, this.title);
        String str = this.content;
        if (str != null) {
            holder.setText(C1965R.id.tv_content, str);
        }
        SpannableString spannableString = this.contentSp;
        if (spannableString != null) {
            holder.setText(C1965R.id.tv_content, spannableString);
        }
        String str2 = this.buttonStr;
        if (str2 != null) {
            holder.setText(C1965R.id.btn_ok, str2);
        }
        holder.setOnClickListener(C1965R.id.btn_ok, new View.OnClickListener() { // from class: com.ipotensic.kernel.view.dialog.CommonOneButtonDialog$convertView$4
