...
public class GeneralDialog extends BaseSyncDialog {
    ...
    public GeneralDialog(Context context, boolean z, String str) {
        super(context, C1965R.layout.view_dialog_remote);
        String string;
        this.ratio = 2.0d;
        ...
        if (FlightConfig.getLastFlight() != null && (FlightConfig.getLastFlight().getFlightByte() == Flight.Flight_ATOM_SE.getFlightByte() || FlightConfig.getLastFlight().getFlightByte() == Flight.Flight_ATOM_LT.getFlightByte() || FlightConfig.getLastFlight().getFlightByte() == Flight.Flight_ATOM.getFlightByte())) {
            string = getContext().getString(C1965R.string.dialog_remoter_upgrade_tips_mini);
        } else {
            string = getContext().getString(C1965R.string.dialog_remoter_upgrade_tips);
        }
        ((TextView) findViewById(C1965R.id.tv_content)).setText(string);
    }

    public GeneralDialog(Context context, final LandConfirmDialog.OnConfirmListener onConfirmListener) {
        super(context, C1965R.layout.view_dialog_switch_mode);
        this.ratio = 2.0d;
        setCanceledOnTouchOutside(false);
        setCancelable(false);
        findViewById(C1965R.id.btn_cancel).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.view.dialog.GeneralDialog.1
        ...
        findViewById(C1965R.id.btn_confirm).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.view.dialog.GeneralDialog.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    public GeneralDialog(Context context, boolean z, ClickConfirmListener clickConfirmListener) {
        super(context, C1965R.layout.view_guide_hexahedral_calibration);
        this.ratio = 2.0d;
        setCanceledOnTouchOutside(false);
        setCancelable(false);
    ...
    public GeneralDialog(Context context, String str, String str2) {
        super(context, C1965R.layout.view_dialog_return_count_down);
        this.ratio = 2.0d;
        setCanceledOnTouchOutside(false);
        setCancelable(false);
        Window window = getWindow();
    ...
    public GeneralDialog(Context context, int i, final ClickConfirmListener clickConfirmListener) {
        super(context, C1965R.layout.view_new_map_guide);
        this.ratio = 2.0d;
        setCanceledOnTouchOutside(false);
        setCancelable(false);
        Window window = getWindow();
        ...
        window.setWindowAnimations(C1965R.style.mapGuideStyle);
    ...
    public GeneralDialog(Context context, final int i) {
        super(context, C1965R.layout.guide_video_view);
        this.ratio = 2.0d;
        setCanceledOnTouchOutside(false);
        setCancelable(false);
        Window window = getWindow();
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            window.getDecorView().setBackground(ContextCompat.getDrawable(context, C1965R.color.colorBlack));
        }
        attributes.width = -1;
        attributes.height = -1;
        window.setAttributes(attributes);
        ...
        final Button button = (Button) findViewById(C1965R.id.btn_cancel);
        final Button button2 = (Button) findViewById(C1965R.id.btn_confirm);
        final ImageButton imageButton = (ImageButton) findViewById(C1965R.id.btn_close);
        if (i == C1965R.raw.video_rth_guide) {
    ...
    public GeneralDialog(Context context, final DialogListener dialogListener) {
        super(context, C1965R.layout.view_dialog_format_sd);
        this.ratio = 2.0d;
    ...
    public GeneralDialog(Context context, String str, String str2, String str3, final DialogListener dialogListener) {
        super(context, C1965R.layout.view_dialog_general_gray);
        this.ratio = 2.0d;
        this.dialogListener = dialogListener;
        setCanceledOnTouchOutside(false);
        ...
        if (str3 != null) {
            ...
            this.confirmBtn.setText(context.getString(C1965R.string.dialog_confirm));
        }
    ...
    public GeneralDialog(Context context, boolean z, String str, String str2, String str3, ClickConfirmListener clickConfirmListener) {
        super(context, z ? C1965R.layout.view_dialog_button_one : C1965R.layout.view_dialog_white_button_one);
        this.ratio = 2.0d;
        this.listener = clickConfirmListener;
        setCanceledOnTouchOutside(false);
        setCancelable(false);
    ...
    public GeneralDialog(Context context, String str, String str2, int i, ClickConfirmListener clickConfirmListener) {
        super(context, C1965R.layout.view_dialog_user_peron_info);
        this.ratio = 2.0d;
        this.listener = clickConfirmListener;
        TextView textView = this.titleView;
        if (textView != null) {
    ...
    public GeneralDialog(Context context, String str) {
        super(context, C1965R.layout.view_dialog_open_network);
        this.ratio = 2.0d;
        Window window = getWindow();
        if (context.getResources().getConfiguration().orientation == 2) {
        ...
        setCanceledOnTouchOutside(false);
        setCancelable(false);
        TextView textView = (TextView) findViewById(C1965R.id.tv_dialog_message);
        if (str != null) {
    ...
    public GeneralDialog(Context context, String str, String str2, int i, int i2, ClickConfirmListener clickConfirmListener) {
        super(context, C1965R.layout.view_dialog_upgrade_tips);
        this.ratio = 2.0d;
        Window window = getWindow();
        if (context.getResources().getConfiguration().orientation == 2) {
            window.setLayout((int) (ScreenUtils.getScreenWidth(context) * 0.4d), -2);
    ...
    public GeneralDialog(Context context, String... strArr) {
        super(context, C1965R.layout.view_dialog_setting_tips);
        this.ratio = 2.0d;
    ...
    public GeneralDialog(Context context, String str, String str2, String str3, String str4, boolean z, int i, ClickConfirmListener clickConfirmListener) {
        ...
        if (str3 != null) {
            ...
            this.cancelBtn.setText(context.getString(C1965R.string.dialog_cancel));
        }
        if (str4 != null) {
        ...
        if (z) {
            this.confirmBtn.setBackgroundColor(context.getResources().getColor(C1965R.color.color_dialog_red_bg));
        }
        if (i == 1) {
    ...
    public GeneralDialog(Context context, String str, String str2, ClickConfirmListener clickConfirmListener) {
        super(context, C1965R.layout.view_dialog_roll);
        this.ratio = 2.0d;
        this.listener = clickConfirmListener;
    ...
    public GeneralDialog(Context context, String str, String str2, String str3, String str4, final OnResultListener<Boolean> onResultListener) {
        ...
        setCanceledOnTouchOutside(false);
        setCancelable(false);
        Button button = (Button) findViewById(C1965R.id.btn_cancel);
        Button button2 = (Button) findViewById(C1965R.id.btn_confirm);
        button.setText(str3);
    ...
    public GeneralDialog(Context context, String str, String str2, final DialogListener dialogListener) {
        super(context, C1965R.layout.view_dialog_general_cancel_account);
        this.ratio = 2.0d;
    ...
    public GeneralDialog(Context context, String str, String str2, String str3, String str4, boolean z, boolean z2, DialogListener dialogListener) {
        super(context, C1965R.layout.view_dialog_general_while_bg);
        this.ratio = 2.0d;
        getWindow().setLayout((int) (ScreenUtils.getScreenWidth(context) * 0.8d), -2);
        setCanceledOnTouchOutside(false);
        setCancelable(false);
        ...
        if (z) {
            this.confirmBtn.setTextColor(context.getResources().getColor(C1965R.color.color_dialog_update_bg));
            this.cancelBtn.setTextColor(context.getResources().getColor(C1965R.color.color_dialog_blue_bg));
        }
        Button button = this.confirmBtn;
        if (button != null) {
    ...
    public GeneralDialog(Context context, String str, String str2, int i, boolean z, ClickConfirmListener clickConfirmListener) {
        super(context, C1965R.layout.view_dialog_general_white_top_icon);
        this.ratio = 2.0d;
        this.listener = clickConfirmListener;
        setCanceledOnTouchOutside(false);
        setCancelable(false);
        ...
        if (z) {
            this.okBtn.setTextColor(context.getResources().getColor(C1965R.color.color_dialog_blue_bg));
        }
        this.img.setImageResource(i);
    }

    public GeneralDialog(Context context, String str, String str2, boolean z, ClickConfirmListener clickConfirmListener) {
        super(context, C1965R.layout.view_dialog_general_top_icon);
        this.ratio = 2.0d;
        this.listener = clickConfirmListener;
        setCanceledOnTouchOutside(false);
        setCancelable(false);
    ...
    protected void initView(Context context) {
        ...
        this.cancelBtn = (Button) findViewById(C1965R.id.btn_cancel);
        this.confirmBtn = (Button) findViewById(C1965R.id.btn_confirm);
        this.llBtn = findViewById(C1965R.id.ll_btn);
        this.okBtn = (Button) findViewById(C1965R.id.btn_ok);
        this.img = (ImageView) findViewById(C1965R.id.iv_img);
        initListener();
    }
