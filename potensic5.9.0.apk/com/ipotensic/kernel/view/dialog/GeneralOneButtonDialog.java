...
public class GeneralOneButtonDialog extends BaseSyncDialog {
    ...
    public GeneralOneButtonDialog(Context context) {
        super(context, C1965R.layout.dialog_common_one_button);
    ...
    protected void initView(Context context) {
        this.tvTitle = (TextView) findViewById(C1965R.id.tv_dialog_title);
        this.tvContent = (TextView) findViewById(C1965R.id.tv_content);
        TextView textView = (TextView) findViewById(C1965R.id.btn_ok);
