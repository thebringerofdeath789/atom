...
public class GpsInterferenceTipDialog extends BaseSyncDialog {
    ...
    public GpsInterferenceTipDialog(Context context) {
        super(context, C1965R.layout.view_dialog_gps_interference_tip);
        setCanceledOnTouchOutside(false);
        setCancelable(false);
        setSize((int) (ScreenUtils.getScreenWidth(getContext()) * 0.48d), -2);
        findViewById(C1965R.id.tv_ok).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.view.dialog.GpsInterferenceTipDialog.1
