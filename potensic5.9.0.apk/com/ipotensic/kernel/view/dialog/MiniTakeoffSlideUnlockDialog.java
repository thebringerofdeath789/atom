...
public class MiniTakeoffSlideUnlockDialog extends BaseSyncDialog implements View.OnClickListener {
    ...
    public MiniTakeoffSlideUnlockDialog(Context context, String str, String str2, boolean z, boolean z2, SlideUnlockListener slideUnlockListener) {
        super(context, C1965R.layout.view_dialog_mini_slide_takeoff);
    ...
    protected void initView(Context context) {
        this.tvTitle = (TextView) findViewById(C1965R.id.tv_mini_takeoff_title);
        this.tvContent = (TextView) findViewById(C1965R.id.tv_mini_takeoff_content);
        findViewById(C1965R.id.btn_close_takeoff).setOnClickListener(this);
        MiniTakeoffSlideUnlockView miniTakeoffSlideUnlockView = (MiniTakeoffSlideUnlockView) findViewById(C1965R.id.btn_mini_slide_unlock_takeoff);
