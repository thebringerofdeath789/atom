...
public class MediaInfoDialog extends com.ipotensic.baselib.base.BaseDialog {
    ...
    public MediaInfoDialog(Context context) {
        super(context, C1965R.layout.view_dialog_media_info, C1965R.style.ImageDetailDialog);
        initWindow();
    }

    public MediaInfoDialog(Context context, int i) {
        super(context, C1965R.layout.view_main_dialog_media_info, C1965R.style.ImageDetailDialog);
        initWindow();
        windowDeploy(80);
    }
    ...
    public void hideResolution() {
        findViewById(C1965R.id.layout_resolution).setVisibility(8);
    }

    public void hideSize() {
        findViewById(C1965R.id.layout_size).setVisibility(8);
    }

    public void setMediaInfo(MediaInfoData mediaInfoData) {
        if (mediaInfoData != null) {
            TextView textView = (TextView) findViewById(C1965R.id.tv_date);
            TextView textView2 = (TextView) findViewById(C1965R.id.tv_resolution);
            TextView textView3 = (TextView) findViewById(C1965R.id.tv_size);
            TextView textView4 = (TextView) findViewById(C1965R.id.tv_format);
            TextView textView5 = (TextView) findViewById(C1965R.id.tv_duration);
            TextView textView6 = (TextView) findViewById(C1965R.id.tv_frame_rate);
            ...
            if (mediaInfoData.isVideo()) {
                ...
                if (mediaInfoData.getFps() == 0.0d) {
                    findViewById(C1965R.id.layout_frame_rate).setVisibility(8);
                    return;
                }
                return;
            }
            findViewById(C1965R.id.layout_duration).setVisibility(8);
            findViewById(C1965R.id.layout_frame_rate).setVisibility(8);
        }
    }
    ...
    protected void initView(Context context) {
        findViewById(C1965R.id.tv_cancel).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.view.dialog.MediaInfoDialog.1
