...
public final class AppDialogManager {
    ...
    /* compiled from: AppDialogManager.kt */
    @Metadata(m2336bv = {1, 0, 3}, m2337d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\b\u0010\u0005\u001a\u00020\u0006H\u0007R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0007"}, m2338d2 = {"Lcom/ipotensic/kernel/view/dialog/AppDialogManager$Companion;", "", "()V", "TAG", "", "getInstance", "Lcom/ipotensic/kernel/view/dialog/AppDialogManager;", "Kernel_mapboxRelease"}, m2339k = 1, m2340mv = {1, 1, 15})
    ...
    /* compiled from: AppDialogManager.kt */
    @Metadata(m2336bv = {1, 0, 3}, m2337d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\bÆ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, m2338d2 = {"Lcom/ipotensic/kernel/view/dialog/AppDialogManager$Holder;", "", "()V", "manager", "Lcom/ipotensic/kernel/view/dialog/AppDialogManager;", "getManager", "()Lcom/ipotensic/kernel/view/dialog/AppDialogManager;", "Kernel_mapboxRelease"}, m2339k = 1, m2340mv = {1, 1, 15})
    ...
    public final void showCommonOneButtonDialog(AppCompatActivity activity, String title, String content, String confirmStr, Integer level, Function0<Unit> confirm) {
        Intrinsics.checkParameterIsNotNull(activity, "activity");
        Intrinsics.checkParameterIsNotNull(title, "title");
        Intrinsics.checkParameterIsNotNull(content, "content");
        showDialog(activity, level, new CommonOneButtonDialog().setTitle(title).setContent(content).setButtonStr(confirmStr).setAutoDismiss(true).setConfirmListener(confirm));
    }
    ...
    public final CommonOneButtonDialog showCommonOneButtonWithSpanContentDialog(AppCompatActivity activity, String title, SpannableString contentSp, String confirmStr, Integer level, Function0<Unit> confirm) {
        Intrinsics.checkParameterIsNotNull(activity, "activity");
        Intrinsics.checkParameterIsNotNull(title, "title");
        Intrinsics.checkParameterIsNotNull(contentSp, "contentSp");
        CommonOneButtonDialog confirmListener = new CommonOneButtonDialog().setTitle(title).setContent(contentSp).setButtonStr(confirmStr).setAutoDismiss(true).setConfirmListener(confirm);
    ...
    public final void showCommonTwoButtonDialog(AppCompatActivity activity, String title, String content, Function0<Unit> confirm, String confirmStr, String cancelStr, Integer level, Function0<Unit> cancelListener) {
        Intrinsics.checkParameterIsNotNull(activity, "activity");
        Intrinsics.checkParameterIsNotNull(title, "title");
        Intrinsics.checkParameterIsNotNull(content, "content");
        Intrinsics.checkParameterIsNotNull(confirm, "confirm");
        showDialog(activity, level, new CommonTwoButtonDialog().setTitle(title).setContent(content).setConfirmStr(confirmStr).setCancelStr(cancelStr).setConfirmListener(confirm).setCancelListener(cancelListener));
    }

    private final void showDialog(final AppCompatActivity activity, Integer level, final BaseDialog newDialog) {
        ...
        newDialog.setDestroyListener(new BaseDialog.OnDialogDestroyListener() { // from class: com.ipotensic.kernel.view.dialog.AppDialogManager$showDialog$1
            ...
            public void onDialogDestroy() {
                ...
                BaseDialog baseDialog2 = (BaseDialog) hashMap.get(activity);
                if (baseDialog2 == null || !baseDialog2.equals(newDialog)) {
                    return;
                }
        ...
        newDialog.show(activity);
        this.dialogMap.put(activity, newDialog);
    }
}