...
public class LandConfirmDialog extends BaseSyncDialog {
    ...
    public LandConfirmDialog(Context context, OnConfirmListener onConfirmListener) {
        super(context, C1965R.layout.dialog_landing_confirm);
    ...
    protected void initView(Context context) {
        final TextView textView = (TextView) findViewById(C1965R.id.tv_upgrade_finished_count_down);
        final CountDownRunnable countDownRunnable = new CountDownRunnable(textView);
        findViewById(C1965R.id.btn_cancel).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.view.dialog.LandConfirmDialog.1
        ...
        findViewById(C1965R.id.btn_confirm).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.view.dialog.LandConfirmDialog.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                textView.removeCallbacks(countDownRunnable);
                LandConfirmDialog.this.dismiss();
