...
public class BatteryCurrentAnomalyDialog extends BaseSyncDialog implements View.OnClickListener {
    public BatteryCurrentAnomalyDialog(Context context) {
        super(context, C1965R.layout.view_dialog_battery_current_anomaly);
    }

    @Override // com.ipotensic.baselib.base.BaseDialog
    protected void initView(Context context) {
        findViewById(C1965R.id.btn_confirm).setOnClickListener(this);
        ((TextView) findViewById(C1965R.id.tv_error_code)).setText(context.getString(C1965R.string.txt_error_code, "03"));
    }
