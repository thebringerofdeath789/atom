...
public class RemoteControlGeoCalDialog extends BaseSyncDialog {
    ...
    public RemoteControlGeoCalDialog(Context context) {
        super(context, C1965R.layout.view_dialog_geo_remote_control);
    ...
    protected void initView(Context context) {
        this.context = context;
        this.tvOneStep = (TextView) findViewById(C1965R.id.tv_one);
        ...
        this.tvTipsContentOne = (TextView) findViewById(C1965R.id.tv_content_one);
    ...
    public void setUpdateData(FlightRevStateData flightRevStateData) {
        ...
        if (flightRevStateData.isMagnetometerVerticalCalibrating()) {
            ...
            this.tvTipsContentOne.setText(getContext().getString(C1965R.string.dialog_geo_vertical_tips));
    ...
    private void reset() {
        ...
        this.tvTipsContentOne.setText(getContext().getString(C1965R.string.dialog_geo_horizontal_tips));
    }
