...
public class FwUpgradeConditionDialog extends BaseSyncDialog {
    ...
    public FwUpgradeConditionDialog(Context context, int i, boolean z, boolean z2, final FwDownLoadListener fwDownLoadListener) {
        ...
        Button button = (Button) findViewById(C1965R.id.btn_download);
        Button button2 = (Button) findViewById(C1965R.id.btn_cancel);
        Button button3 = (Button) findViewById(C1965R.id.btn_ok);
        LinearLayout linearLayout = (LinearLayout) findViewById(C1965R.id.ll_btn);
        TextView textView = (TextView) findViewById(C1965R.id.tv_content);
        button3.setVisibility(z2 ? 0 : 8);
        linearLayout.setVisibility(z2 ? 8 : 0);
        textView.setText(context.getString(z2 ? C1965R.string.fw_detected_important_firmware : C1965R.string.fw_detected_new_firmware));
    ...
    public FwUpgradeConditionDialog(Context context, String str, boolean z, boolean z2, boolean z3, String str2, final boolean z4) {
        super(context, C1965R.layout.view_dialog_unable_upgrade_tip_new);
        ...
        ((TextView) findViewById(C1965R.id.tv_upgrade_firmware)).setText(String.format("%s%s", getContext().getString(C1965R.string.dialog_upgrade_firmware), str));
        TextView textView = (TextView) findViewById(C1965R.id.tv_plane_battery_low);
        TextView textView2 = (TextView) findViewById(C1965R.id.line_plane);
        ImageView imageView = (ImageView) findViewById(C1965R.id.iv_plane);
        ImageView imageView2 = (ImageView) findViewById(C1965R.id.iv_remote);
        this.tvSdState = (TextView) findViewById(C1965R.id.tv_sd_state);
        TextView textView3 = (TextView) findViewById(C1965R.id.line_sd);
        ImageView imageView3 = (ImageView) findViewById(C1965R.id.iv_sd);
        textView.setVisibility(z ? 0 : 8);
        textView2.setVisibility(z ? 0 : 8);
        imageView.setVisibility(z ? 0 : 8);
        imageView.setImageResource(z2 ? C1965R.mipmap.icon_upgrade_fail : C1965R.mipmap.icon_upgrade_success);
        imageView2.setImageResource(z3 ? C1965R.mipmap.icon_upgrade_fail : C1965R.mipmap.icon_upgrade_success);
        if (str2 == null) {
        ...
        findViewById(C1965R.id.btn_ok).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.view.dialog.-$$Lambda$FwUpgradeConditionDialog$Wi0Mlswta66BrXaySXFsz913BJo
            @Override // android.view.View.OnClickListener
    ...
    public FwUpgradeConditionDialog(Context context, final FwDownLoadListener fwDownLoadListener) {
        super(context, C1965R.layout.view_dialog_big_package_exit);
        setCanceledOnTouchOutside(false);
        setCancelable(false);
        getWindow().setLayout((int) (ScreenUtils.getScreenWidth(context) * 0.43d), -2);
        findViewById(C1965R.id.btn_cancel).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.view.dialog.-$$Lambda$FwUpgradeConditionDialog$QwK8JbK3MaGB63qzLd2G2O-lCvQ
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                FwUpgradeConditionDialog.this.lambda$new$1$FwUpgradeConditionDialog(view);
            }
        });
        findViewById(C1965R.id.btn_confirm).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.view.dialog.-$$Lambda$FwUpgradeConditionDialog$18n4KDwWPOXEfL7lpQ65flf48b0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public FwUpgradeConditionDialog(Context context, final BigPackageUpgradeListener bigPackageUpgradeListener) {
        super(context, C1965R.layout.view_dialog_big_package_upgrade_not_completed);
        setCanceledOnTouchOutside(false);
        setCancelable(false);
        getWindow().setLayout((int) (ScreenUtils.getScreenWidth(context) * 0.43d), -2);
        findViewById(C1965R.id.btn_ok).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.view.dialog.-$$Lambda$FwUpgradeConditionDialog$oMr5CMllCAds6y1nueNRVE1GKOc
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
