...
public class StrongWindDialog extends BaseSyncDialog {
    ...
    public StrongWindDialog(Context context, String str, ConfirmListener confirmListener) {
        super(context, C1965R.layout.dialog_strong_wind);
        ...
        ((TextView) findViewById(C1965R.id.tv_content)).setText(str);
    }

    @Override // com.ipotensic.baselib.base.BaseDialog
    protected void initView(Context context) {
        findViewById(C1965R.id.btn_ok).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.view.dialog.StrongWindDialog.2
