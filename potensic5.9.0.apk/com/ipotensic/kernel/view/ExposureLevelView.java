...
public class ExposureLevelView {
    ...
    public ExposureLevelView(View view) {
        ...
        initView();
        initListener();
        final ExpandableView expandableView = (ExpandableView) this.view.findViewById(C1965R.id.ev_expandable);
    ...
    private void initView() {
        this.subBtn = (ImageButton) this.view.findViewById(C1965R.id.iv_ev_sub);
        this.plusBtn = (ImageButton) this.view.findViewById(C1965R.id.iv_ev_plus);
        this.adjustView = (ImageView) this.view.findViewById(C1965R.id.iv_ev_adjust);
        this.valueText = (TextView) this.view.findViewById(C1965R.id.tv_ev_value);
    }
