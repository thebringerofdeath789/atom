...
public class SlideUnlockButton extends View implements View.OnTouchListener {
    ...
    private void initButton(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1965R.styleable.SlideUnlockButton);
        this.circleColor = obtainStyledAttributes.getColor(C1965R.styleable.SlideUnlockButton_circleColor, -1);
        this.textContent = obtainStyledAttributes.getString(C1965R.styleable.SlideUnlockButton_text);
        obtainStyledAttributes.recycle();
        this.gradientStartColor = getResources().getColor(C1965R.color.colorGradientBlueStart);
        this.gradientEndColor = getResources().getColor(C1965R.color.colorGradientBlueEnd);
    }
    ...
    private Shader getShader() {
        ...
        LinearGradient linearGradient = new LinearGradient(f, f2, f3 > f4 ? (this.f2245r * 2.0f) + f + f3 : (this.f2245r * 2.0f) + f + f4, f2 + this.f2245r, this.gradientStartColor, this.gradientEndColor, Shader.TileMode.REPEAT);
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            this.startX = x;
            if (x > this.spaceX + (this.f2245r * 4.0f)) {
                return false;
            }
        } else if (action == 1) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.width == 0.0f) {
            ...
            this.f2245r = (getHeight() - (this.spaceY * 2.0f)) / 2.0f;
            this.maxOffsetX = getWidth() - ((this.spaceX + this.f2245r) * 2.0f);
        }
        paint();
    }
    ...
    private void printBitmap() {
        ...
        this.canvas.drawBitmap(BitmapFactory.decodeResource(getResources(), C1965R.mipmap.icon_slide_right), this.centerX + paint.measureText(this.textContent) + 30.0f, this.centerY - 3.0f, paint);
    }
