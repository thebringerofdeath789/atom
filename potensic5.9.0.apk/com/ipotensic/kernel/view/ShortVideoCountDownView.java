...
public class ShortVideoCountDownView extends RelativeLayout {
    ...
    private void init() {
        ...
        this.tvCount.setTextColor(getResources().getColor(C1965R.color.white));
            ...
            public void update() {
                try {
                    if (ShortVideoCountDownView.this.num == 0) {
                        DDLog.m1684e("倒计时结束：" + ShortVideoCountDownView.this.num);
                    ...
                    DDLog.m1684e("倒计时：" + ShortVideoCountDownView.this.num);
                } catch (Exception e) {
                    DDLog.m1684e("倒计时出错:" + e);
                }
            }
        });
