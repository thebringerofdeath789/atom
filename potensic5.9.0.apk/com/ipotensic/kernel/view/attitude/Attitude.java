...
public class Attitude {
    ...
    public void draw(Canvas canvas) {
        ...
        int i = C1965R.color.color_attitude_view_gray_start;
        int i2 = C1965R.color.color_attitude_view_gray_end;
        int i3 = C1965R.color.color_attitude_view_gray_full;
        if (this.isConnect) {
            if (Math.abs(this.yawPitch) <= 30 && Math.abs(this.rotate) <= 30) {
                i = C1965R.color.color_attitude_view_green_start;
                i2 = C1965R.color.color_attitude_view_green_end;
                i3 = C1965R.color.color_attitude_view_green_full;
            } else if ((40 < Math.abs(this.yawPitch) && Math.abs(this.yawPitch) <= 180) || (40 < Math.abs(this.rotate) && Math.abs(this.rotate) <= 180)) {
                i = C1965R.color.color_attitude_view_red_start;
                i2 = C1965R.color.color_attitude_view_red_end;
                i3 = C1965R.color.color_attitude_view_red_full;
            } else {
                i = C1965R.color.color_attitude_view_yellow_start;
                i2 = C1965R.color.color_attitude_view_yellow_end;
                i3 = C1965R.color.color_attitude_view_yellow_full;
            }
        }
    ...
    private void calPosition() {
        ...
        if (yawPitchPercent > d) {
            DDLog.m1685e(this.TAG, "attitude:1");
            ...
            DDLog.m1685e(this.TAG, "attitude:2");
            ...
            DDLog.m1685e(this.TAG, "attitude:3");
            this.sweepAngel = 180;
            this.startAngel = 0;
