...
public class RightControllerModel {
        ...
        public void click(View view) {
            if (RightControllerModel.this.isAllowClick()) {
                ...
                if (RightControllerModel.this.isRecording.get()) {
                    RightControllerModel.this.rightControllerListener.onToast(C1965R.string.stop_recording_first);
                } else {
        ...
        public void click(View view) {
            if (RightControllerModel.this.isAllowClick()) {
                if (RightControllerModel.this.btnCaptureMode.get() == CaptureUIType.CAPTURE_UI_PHOTO.ordinal()) {
                    DDLog.m1684e("按键状态: 点击拍照");
                    if (!CameraConfig.get().isSdCardAvailable()) {
                        if (RightControllerModel.this.rightControllerListener != null) {
                            RightControllerModel.this.rightControllerListener.onToast(C1965R.string.no_sd_card);
                        }
    ...
    public final ScaleClickListener onShortVideoClickListener = new C242021();
    ...
    public RightControllerModel(Context context, final OnRightControllerListener onRightControllerListener) {
        ...
        this.isTrackFunctionOpen.addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() { // from class: com.ipotensic.kernel.model.RightControllerModel.6
            ...
            public void onPropertyChanged(Observable observable, int i) {
                if (RightControllerModel.this.isTrackFunctionOpen.get()) {
                    ...
                    RightControllerModel.this.setBtnCaptureMode(CaptureUIType.CAPTURE_UI_EXIT_TRACK);
                    DDLog.m1684e("设置退出1");
                    onRightControllerListener.showEffectView();
                    ...
                    onRightControllerListener.hideEffectView();
                    RightControllerModel.this.setBtnGalleryMode(GalleryUIType.UI_TYPE_GALLERY);
        ...
        this.isExecuting.addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() { // from class: com.ipotensic.kernel.model.RightControllerModel.8
            ...
            public void onPropertyChanged(Observable observable, int i) {
                if (RightControllerModel.this.isExecuting.get()) {
                    ...
                    onRightControllerListener.hideEffectView();
                    if (RightControllerModel.this.isFollowMode()) {
                        onRightControllerListener.onExecutingFollow();
                    }
        ...
        this.isDemoVideoVisible.addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() { // from class: com.ipotensic.kernel.model.RightControllerModel.11
            @Override // androidx.databinding.Observable.OnPropertyChangedCallback
            public void onPropertyChanged(Observable observable, int i) {
                DDLog.m1684e("isDemoVideoVisible 1:" + RightControllerModel.this.isDemoVideoVisible.get());
                if (RightControllerModel.this.isDemoVideoVisible.get()) {
                    if (RightControllerModel.this.isFollowMode()) {
                        if (SPHelper.getInstance().isFollowTeachVideoPlayed()) {
                            onRightControllerListener.repeatPlayTeachVideo(VisionExecuteType.TYPE_VISION_FOLLOW);
                        } else {
                            onRightControllerListener.oncePlayTeachVideo(VisionExecuteType.TYPE_VISION_FOLLOW, new MediaPlayer.OnCompletionListener() { // from class: com.ipotensic.kernel.model.RightControllerModel.11.1
                        ...
                        int i2 = C243636.$SwitchMap$com$ipotensic$baselib$enums$VisionExecuteType[((VisionExecuteType) Objects.requireNonNull(RightControllerModel.this.videoType.get())).ordinal()];
                        if (i2 != 1) {
                            if (i2 != 2) {
                                if (i2 != 3) {
                                    if (i2 != 4) {
                                        if (i2 == 5) {
                                            if (SPHelper.getInstance().isRecessTeachVideoPlayed()) {
                                                onRightControllerListener.repeatPlayTeachVideo(RightControllerModel.this.videoType.get());
                                            } else {
                                                onRightControllerListener.oncePlayTeachVideo(RightControllerModel.this.videoType.get(), new MediaPlayer.OnCompletionListener() { // from class: com.ipotensic.kernel.model.RightControllerModel.11.6
                                                    @Override // android.media.MediaPlayer.OnCompletionListener
                                                    public void onCompletion(MediaPlayer mediaPlayer) {
                                                        RightControllerModel.this.isDemoVideoVisible.set(false);
                                                    }
                                        ...
                                        onRightControllerListener.oncePlayTeachVideo(RightControllerModel.this.videoType.get(), new MediaPlayer.OnCompletionListener() { // from class: com.ipotensic.kernel.model.RightControllerModel.11.5
                                            @Override // android.media.MediaPlayer.OnCompletionListener
                                            public void onCompletion(MediaPlayer mediaPlayer) {
                                                RightControllerModel.this.isDemoVideoVisible.set(false);
                                            }
                                    ...
                                    onRightControllerListener.oncePlayTeachVideo(RightControllerModel.this.videoType.get(), new MediaPlayer.OnCompletionListener() { // from class: com.ipotensic.kernel.model.RightControllerModel.11.4
                                        @Override // android.media.MediaPlayer.OnCompletionListener
                                        public void onCompletion(MediaPlayer mediaPlayer) {
                                            RightControllerModel.this.isDemoVideoVisible.set(false);
                                        }
                                ...
                                onRightControllerListener.oncePlayTeachVideo(RightControllerModel.this.videoType.get(), new MediaPlayer.OnCompletionListener() { // from class: com.ipotensic.kernel.model.RightControllerModel.11.3
                                    @Override // android.media.MediaPlayer.OnCompletionListener
                                    public void onCompletion(MediaPlayer mediaPlayer) {
                                        RightControllerModel.this.isDemoVideoVisible.set(false);
                                    }
                            ...
                            onRightControllerListener.oncePlayTeachVideo(RightControllerModel.this.videoType.get(), new MediaPlayer.OnCompletionListener() { // from class: com.ipotensic.kernel.model.RightControllerModel.11.2
                                @Override // android.media.MediaPlayer.OnCompletionListener
                                public void onCompletion(MediaPlayer mediaPlayer) {
                                    RightControllerModel.this.isDemoVideoVisible.set(false);
                                }
                ...
                onRightControllerListener.stopPlayTeachVideo();
                if (RightControllerModel.this.isVideoTypeVisible.get()) {
                    PhoneConfig.mainHandler.removeCallbacks(RightControllerModel.this.selectModeRunnable);
                    PhoneConfig.mainHandler.postDelayed(RightControllerModel.this.selectModeRunnable, 5000L);
                }
    ...
    static /* synthetic */ class C243636 {
    ...
    public void onTrackError(VisionError visionError) {
        DDLog.m1684e("一键短片 报错:" + visionError);
        if (visionError == VisionError.ERROR_TARGET_LOSE) {
            this.rightControllerListener.onToast(C1965R.string.txt_short_video_lost_target);
        } else if (visionError == VisionError.ERROR_TARGET_TOO_CLOSE) {
            this.rightControllerListener.onToast(C1965R.string.txt_short_video_target_too_close);
        } else if (visionError == VisionError.ERROR_GIMBAL_ANGLE_TOO_BIG) {
            this.rightControllerListener.onToast(C1965R.string.txt_short_video_gimbal_angle_too_big);
        } else if (visionError == VisionError.ERROR_HEIGHT_TOO_LOW) {
            this.rightControllerListener.onToast(C1965R.string.txt_short_video_height_too_low);
        } else if (visionError == VisionError.ERROR_GIMBAL_TOO_SMOOTH) {
            this.rightControllerListener.onToast(C1965R.string.txt_short_video_gimbal_too_smooth);
        }
        onVisionError();
    }
    ...
    public void update(FlightRevStateData flightRevStateData) {
            ...
            if (flightRevStateData.isFlightExecutingShortVideo()) {
                if (!isFollowMode()) {
                    if (flightRevStateData.isShortVideoBack()) {
                        this.recordTxt.set(this.context.getString(C1965R.string.txt_short_video_back));
        ...
        if (this.isTrackFunctionOpen.get() && (flightRevStateData.isLanding() || flightRevStateData.isReturning() || flightRevStateData.getMode() != 2 || !flightRevStateData.isAllowShortVideo())) {
            ...
            if (flightRevStateData.getMode() != 2) {
                this.rightControllerListener.onToast(C1965R.string.txt_short_video_not_gps_mode);
            } else if (!flightRevStateData.isAllowShortVideo()) {
                this.rightControllerListener.onToast(C1965R.string.quickshots_poor_gps_signal_exited_tips);
            }
        }
    ...
    class C242021 extends ScaleClickListener {
        C242021() {
        }
        ...
        public void click(View view) {
            if (RightControllerModel.this.isAllowClick()) {
                if (SPHelper.getInstance().getIntelligentMode()) {
                    ...
                    new GeneralDialog(RightControllerModel.this.context, RightControllerModel.this.context.getString(C1965R.string.dialog_quit_waypoint_flight_title), RightControllerModel.this.context.getString(C1965R.string.dialog_quit_waypoint_flight_describe), new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.kernel.model.-$$Lambda$RightControllerModel$21$-G7fwnV8iWTe0Tk4Pl9yOuQTFKQ
                        @Override // com.ipotensic.kernel.view.dialog.GeneralDialog.ClickConfirmListener
                        public final void confirm() {
                            RightControllerModel.C242021.this.lambda$click$1$RightControllerModel$21();
                        }
                    }).show();
                }
            }
        ...
        public /* synthetic */ void lambda$click$1$RightControllerModel$21() {
            ...
            PhoneConfig.mainHandler.postDelayed(new Runnable() { // from class: com.ipotensic.kernel.model.-$$Lambda$RightControllerModel$21$JZ1YRSh3NmcEQ3hqryY89VLjF5I
                ...
                public final void run() {
                    RightControllerModel.C242021.this.lambda$click$0$RightControllerModel$21();
                }
            }, 200L);
        }
        ...
        public /* synthetic */ void lambda$click$0$RightControllerModel$21() {
            try {
                ...
                DDLog.m1685e("RightControllerModel", "click btnOneKeyVideo exitPointFly exception " + e.getMessage());
            }
        }
    }
    ...
    public boolean checkStateIsReady() {
        ...
        if (!flightRevStateData.isFlight()) {
            this.rightControllerListener.onToast(C1965R.string.txt_short_video_not_fly_tips);
            return false;
        }
        if (flightRevStateData.getMode() != 2) {
            this.rightControllerListener.onToast(C1965R.string.txt_short_video_not_gps_mode);
        ...
        if (flightRevStateData.isFollowing() || flightRevStateData.isPointFly() || flightRevStateData.isHotCircle() || flightRevStateData.isReturning() || flightRevStateData.isLanding()) {
            this.rightControllerListener.onToast(C1965R.string.txt_short_video_intelligent_flight);
            return false;
        }
        if (flightRevStateData.isPlaneExceedLimitDistance() || flightRevStateData.isPlaneExceedLimitHigh()) {
            this.rightControllerListener.onToast(C1965R.string.txt_short_video_flight_arrive_fence);
            return false;
        }
        if (FlightRevData.get().getFlightRevStateData().getPowerMode() == 1 || FlightRevData.get().getFlightRevStateData().getPowerMode() == 2) {
            this.rightControllerListener.onToast(C1965R.string.txt_short_video_flight_low_power);
            return false;
        }
        if (!FlightRevData.get().getFlightRevStateData().isAllowShortVideo()) {
            this.rightControllerListener.onToast(C1965R.string.quickshots_poor_gps_signal_unable_to_activate_tips);
            return false;
        }
        SdCardState sdCardState = CameraConfig.get().sdCardState;
        if (sdCardState == SdCardState.SD_CARD_NOT_EXIST) {
            this.rightControllerListener.onToast(C1965R.string.txt_short_video_no_sd_card);
            return false;
        }
        if (sdCardState == SdCardState.SD_CARD_NEED_FORMAT) {
            this.rightControllerListener.onToast(C1965R.string.txt_short_video_pls_format_sd_card);
            return false;
        }
        if (sdCardState == SdCardState.SD_CARD_NOT_ENOUGH_SPACE) {
            this.rightControllerListener.onToast(C1965R.string.txt_short_video_sd_card_full);
            return false;
        }
        if (CameraConfig.get().isAllowCaptureInHighTemp()) {
            return true;
        }
        this.rightControllerListener.onToast(C1965R.string.txt_short_video_high_temp);
        return false;
    }
    ...
    private boolean checkGimbalStates() {
        ...
        if (error_status == 1 || error_status == 2) {
            this.rightControllerListener.onToast(C1965R.string.txt_error_gimbal_error);
            return false;
        }
        if (error_status == 4) {
            this.rightControllerListener.onToast(C1965R.string.warning_flight_interface_the_gimbal_is_stuck_detailed_tips);
            return false;
        }
        if (error_status != 5) {
            return true;
        }
        this.rightControllerListener.onToast(C1965R.string.warning_flight_interface_the_gimbal_motor_is_overloaded_tips);
        return false;
    }
    ...
    public void sendStopExecuteToFlightCtrl() {
        ...
        DDLog.m1684e("发送停止一键短片指令给飞控:" + ParseUtil.byteToHexString(FlightSendData.get().getSendCtrlData().getBytes()));
    }
    ...
    public void cancelSelectTarget(OnSuccessListener onSuccessListener) {
        ...
        if (trackTarget == null || !trackTarget.isSelected() || this.trackTarget.getBboxes().size() < 1) {
            ...
            TrackTarget.Box m2616clone = this.trackTarget.getBboxes().get(0).m2616clone();
            m2616clone.setBbox_id(-1);
            m2616clone.setClass_id(-1);
            CameraCtrlPresenter.getInstance().selectTarget(m2616clone);
