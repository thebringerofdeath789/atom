...
public final class KernelViewModel extends ViewModel {
    ...
    public static final /* synthetic */ void access$addNoFlyZoneData(KernelViewModel kernelViewModel, Context context, MapVideoController mapVideoController) {
        kernelViewModel.addNoFlyZoneData(context, mapVideoController);
    }
    ...
    public final int compassCalibration() {
        ...
        if (FlightConfig.is_Atom_Series()) {
            ...
            if (!stateData.isOutdoor()) {
                return C1965R.string.f2142xa0c56cf5;
            }
            if (stateData.isGeomagneticFault()) {
                return C1965R.string.error_geo_fault;
            }
            return (stateData.isUnLock() || stateData.isFlight()) ? C1965R.string.txt_error_flighting_unavailable : checkFlightIsReady;
        }
        DDLog.m1684e("不是atom系列");
        return checkFlightIsReady;
    }
    ...
    public final int gimbalCalibration() {
        ...
        if (error_status == 1 || error_status == 2) {
            return C1965R.string.txt_error_gimbal_error;
        }
        if (error_status == 3) {
            ...
            if (flightRevStateData.isUnLock()) {
                return C1965R.string.txt_error_flighting_unavailable;
            }
        } else {
            if (error_status == 4) {
                return C1965R.string.warning_the_gimbal_is_stuck_briefly_tips;
            }
            if (error_status == 5) {
                return C1965R.string.warning_flight_interface_the_gimbal_motor_is_overloaded_tips;
            }
        }
        ...
        return flightRevStateData2.isUnLock() ? C1965R.string.txt_error_flighting_unavailable : checkFlightIsReady;
    }

    public final int gimbalFineTuning() {
        DDLog.m1684e("云台微调校准");
        if (!FlightConfig.isConnectFlight()) {
            return C1965R.string.toast_unconnected_tips;
        }
        if (Conditions.isTrackTargetOpen()) {
            return C1965R.string.txt_pls_exit_short_video_first;
        }
        FlightRevData flightRevData = FlightRevData.get();
        Intrinsics.checkExpressionValueIsNotNull(flightRevData, "FlightRevData.get()");
        FlightRevGimbalStateData gimbalStateData = flightRevData.getGimbalStateData();
        ...
        switch (gimbalStateData.getError_status()) {
            ...
            case 2:
                return C1965R.string.txt_error_gimbal_error;
            case 3:
                return C1965R.string.txt_error_gimbal_need_calibration;
            case 4:
                return C1965R.string.warning_the_gimbal_is_stuck_briefly_tips;
            case 5:
                return C1965R.string.warning_flight_interface_the_gimbal_motor_is_overloaded_tips;
            case 6:
                return C1965R.string.txt_error_gimbal_angle_too_big;
            default:
                return -1;
        }
    }
    ...
    public final int remoteCalibration() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(flightRevStateData, "FlightRevData.get().flightRevStateData");
        return flightRevStateData.isFlight() ? C1965R.string.txt_error_flighting_unavailable : checkRemoterIsReady;
    }
    ...
    public final int pairDroneAgain() {
        ...
        int checkRemoterIsReady = checkRemoterIsReady();
        return (checkRemoterIsReady == -1 && FlightConfig.isConnectFlight()) ? C1965R.string.plane_connecting : checkRemoterIsReady;
    }
    ...
    private final int checkRemoterIsReady() {
        ...
        if (!flightRevConnectData.isRemoterConnected()) {
            return C1965R.string.txt_pls_connect_remoter;
        }
    ...
    public final void executeSwoopReturn(Context context, FlightRevStateData flightRevStateData) {
        ...
        if (flightRevStateData.getSwoopReturnCountDown() > 0) {
            ...
            DDLog.m1684e("俯冲返航swoopReturnDialog show");
            kernelViewModel.startSwoopReturnCountTimer(context, flightRevStateData.getSwoopReturnCountDown());
            GeneralDialog generalDialog = new GeneralDialog(context, context.getString(C1965R.string.enter_descending_return_title), context.getString(C1965R.string.descending_return_tips), context.getString(C1965R.string.dialog_confirm) + "(" + kernelViewModel.swoopReturnCountTime.getValue() + "s)", new GeneralDialog.DialogListener() { // from class: com.ipotensic.kernel.model.KernelViewModel$executeSwoopReturn$1$1
                @Override // com.ipotensic.kernel.view.dialog.GeneralDialog.DialogListener
                public void cancel() {
                    DDLog.m1684e("俯冲返航swoopReturnDialog onCancel");
                    if (!FlightConfig.isConnectFlight()) {
                ...
                @Override // com.ipotensic.kernel.view.dialog.GeneralDialog.DialogListener
                public void confirm() {
                    DDLog.m1684e("俯冲返航swoopReturnDialog onConfirm");
                    if (FlightConfig.isConnectFlight()) {
    ...
    private final void startSwoopReturnCountTimer(final Context context, final long time) {
        ...
        final KernelViewModel kernelViewModel = this;
        DDLog.m1684e("俯冲返航startSwoopReturnCountTime " + time);
        ...
        CountDownTimer countDownTimer = new CountDownTimer(j, j2) { // from class: com.ipotensic.kernel.model.KernelViewModel$startSwoopReturnCountTimer$$inlined$run$lambda$1
            ...
            public void onTick(long j3) {
                ...
                StringBuilder append = new StringBuilder().append(context.getString(C1965R.string.dialog_confirm)).append("(");
            ...
            public void onFinish() {
                ...
                Button button;
                MutableLiveData mutableLiveData2;
                DDLog.m1684e("俯冲返航startSwoopReturnCountTimer onFinish");
                mutableLiveData = KernelViewModel.this.swoopReturnCountTime;
    ...
    public final void enterSwoopReturn() {
        ...
        DDLog.m1684e("俯冲返航 startSendEnterSwoopData");
        Unit unit = Unit.INSTANCE;
    }
    ...
    public final void stopSendEnterSwoopData() {
        ...
        DDLog.m1684e("俯冲返航 stopSendEnterSwoopData");
    ...
    public final void exitSwoopReturn() {
        DDLog.m1684e("退出俯冲返航startSendExitSwoopData");
    ...
    public final void stopSendExitSwoopData() {
        ScheduledFuture future;
        DDLog.m1684e("俯冲返航stopSendExitSwoopData");
    ...
    public final void showUnlockDialog(Context context) {
        ...
        if (FlightConfig.isConnectFlight()) {
            if (this.unLockDialog == null) {
                this.unLockDialog = new GeneralDialog(context, true, context.getString(C1965R.string.find_my_drone_fail_to_unlock_title), context.getString(C1965R.string.find_my_drone_fail_to_unlock_tips), context.getString(C1965R.string.i_get_it), (GeneralDialog.ClickConfirmListener) new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.kernel.model.KernelViewModel$showUnlockDialog$1
