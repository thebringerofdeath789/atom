    ...
    public void onRevGpsData(FlightRevGpsTestData flightRevGpsTestData) {
        if (flightRevGpsTestData != null) {
            try {
                ...
                DDLog.m1684e("缓存失败:" + e.getMessage());
            }
        }
    }
