...
public class LeftErrorTipsManager {
    ...
    public void init(Context context, int i) {
        ...
        DDLog.m1684e("开始显示");
        View inflate = LayoutInflater.from(context).inflate(C1965R.layout.view_layout_left_error_tip_item, (ViewGroup) null);
        TextView textView = (TextView) inflate.findViewById(C1965R.id.tv_tip_msg);
        TextView textView2 = (TextView) inflate.findViewById(C1965R.id.tv_tip_title);
