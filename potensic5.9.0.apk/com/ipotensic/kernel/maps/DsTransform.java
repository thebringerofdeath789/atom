...
public class DsTransform {
    ...
    /* renamed from: PI */
    private static final double f2215PI = 3.141592653589793d;

    /* renamed from: a */
    private static final double f2216a = 6378245.0d;

    /* renamed from: ee */
    private static final double f2217ee = 0.006693421622965943d;
    ...
    public static double[] wgs84togcj02(double d, double d2) {
        ...
        double d6 = 1.0d - ((f2217ee * sin) * sin);
        double sqrt = Math.sqrt(d6);
        return new double[]{d + ((transformlon * 180.0d) / (((f2216a / sqrt) * Math.cos(d5)) * 3.141592653589793d)), d2 + ((transformlat * 180.0d) / ((6335552.717000426d / (d6 * sqrt)) * 3.141592653589793d))};
    }
    ...
    public static double[] gcj02towgs84(double d, double d2) {
        ...
        double d6 = 1.0d - ((f2217ee * sin) * sin);
        double sqrt = Math.sqrt(d6);
        return new double[]{(d * 2.0d) - (d + ((transformlon * 180.0d) / (((f2216a / sqrt) * Math.cos(d5)) * 3.141592653589793d))), (d2 * 2.0d) - (d2 + ((transformlat * 180.0d) / ((6335552.717000426d / (d6 * sqrt)) * 3.141592653589793d)))};
    }
