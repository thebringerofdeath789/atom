...
public class MapManager implements View.OnClickListener, MapInfoListener, FlightRecordAdapter.OnItemClickListener {
    ...
    public View setMap(AppCompatActivity appCompatActivity) {
        this.mapView = appCompatActivity.getLayoutInflater().inflate(C1965R.layout.view_map_box, (ViewGroup) null, false);
    ...
    private void initView() {
        ImageButton imageButton = (ImageButton) this.mapBtnView.findViewById(C1965R.id.iv_map_position);
        ImageButton imageButton2 = (ImageButton) this.mapBtnView.findViewById(C1965R.id.iv_map_type);
        this.ivLock = (ImageButton) this.mapBtnView.findViewById(C1965R.id.iv_map_lock);
        this.ivMapSetHide = (ImageButton) this.mapBtnView.findViewById(C1965R.id.iv_map_set_hide);
        this.ivMapMark = (ImageButton) this.mapBtnView.findViewById(C1965R.id.iv_map_mark);
        this.ivGo = (ImageButton) this.mapBtnView.findViewById(C1965R.id.iv_go);
        this.ivCancelFly = (ImageButton) this.mapBtnView.findViewById(C1965R.id.iv_cancel_fly);
        ImageButton imageButton3 = (ImageButton) this.mapBtnView.findViewById(C1965R.id.iv_waypoint_fly);
        this.ivWayPointFly = imageButton3;
        imageButton3.setVisibility((FlightConfig.isConnectFlight() && FlightConfig.isAtomPanTilt()) ? 0 : 8);
        this.ivWayPointCancel = (ImageButton) this.mapBtnView.findViewById(C1965R.id.iv_waypoint_cancel);
        this.ivWayPointStopFly = (ImageButton) this.mapBtnView.findViewById(C1965R.id.iv_waypoint_stop_fly);
        ImageButton imageButton4 = (ImageButton) this.mapBtnView.findViewById(C1965R.id.btn_map_clear);
        ImageButton imageButton5 = (ImageButton) this.mapBtnView.findViewById(C1965R.id.btn_map_mark);
        ImageButton imageButton6 = (ImageButton) this.mapBtnView.findViewById(C1965R.id.btn_mark_save);
        ImageButton imageButton7 = (ImageButton) this.mapBtnView.findViewById(C1965R.id.btn_map_show);
        this.viewCenterPosition = (ConstraintLayout) this.mapBtnView.findViewById(C1965R.id.view_map_position);
        this.viewMapType = (ConstraintLayout) this.mapBtnView.findViewById(C1965R.id.view_map_type);
        this.viewMapSet = (ConstraintLayout) this.mapBtnView.findViewById(C1965R.id.view_map_set);
        ImageButton imageButton8 = (ImageButton) this.viewCenterPosition.findViewById(C1965R.id.iv_fly_home_position);
        ImageButton imageButton9 = (ImageButton) this.viewCenterPosition.findViewById(C1965R.id.iv_my_position);
        ImageButton imageButton10 = (ImageButton) this.viewCenterPosition.findViewById(C1965R.id.iv_fly_position);
        this.ivStandardMode = (ImageButton) this.viewMapType.findViewById(C1965R.id.iv_map_standard);
        this.ivSatelliteMode = (ImageButton) this.viewMapType.findViewById(C1965R.id.iv_map_satellite);
        this.ivStandardNightMode = (ImageButton) this.viewMapType.findViewById(C1965R.id.iv_map_night);
    ...
    public void setMapBtnVisible(boolean z, boolean z2) {
        ...
        this.ivMapMark.setImageResource(C1965R.mipmap.icon_map_mark_bg);
    ...
    public void onClick(View view) {
        int id = view.getId();
        if (id == C1965R.id.iv_map_position) {
        ...
        if (id == C1965R.id.iv_map_type) {
            ...
            this.ivStandardMode.setBackground(mapMode.equals(Style.MAPBOX_STREETS) ? this.context.getDrawable(C1965R.mipmap.icon_map_style_select) : null);
            this.ivSatelliteMode.setBackground(mapMode.equals(Style.SATELLITE) ? this.context.getDrawable(C1965R.mipmap.icon_map_style_select) : null);
            this.ivStandardNightMode.setBackground(mapMode.equals(Style.TRAFFIC_NIGHT) ? this.context.getDrawable(C1965R.mipmap.icon_map_style_select) : null);
            return;
        }
        if (id == C1965R.id.iv_map_set_hide) {
            this.viewCenterPosition.setVisibility(8);
            this.viewMapType.setVisibility(8);
            this.ivMapSetHide.setVisibility(8);
        ...
        if (id == C1965R.id.btn_map_show) {
            this.viewMapSet.setVisibility(8);
            this.ivMapSetHide.setVisibility(0);
            return;
        }
        if (id == C1965R.id.iv_map_lock) {
            boolean z = !this.isStartRotate;
            this.isStartRotate = z;
            this.ivLock.setImageResource(z ? C1965R.mipmap.icon_compass_nor : C1965R.mipmap.icon_map_lock);
        ...
        if (id == C1965R.id.iv_map_mark) {
            boolean z2 = !this.isEnableMark;
            this.isEnableMark = z2;
            this.ivMapMark.setImageResource(z2 ? C1965R.mipmap.icon_map_check_mark : C1965R.mipmap.icon_map_mark_bg);
            return;
        }
        if (id == C1965R.id.iv_go) {
        ...
        if (id == C1965R.id.iv_cancel_fly) {
            if (BaseSyncDialog.isShow) {
                return;
            }
            Context context = this.context;
            new GeneralDialog(context, context.getString(C1965R.string.dialog_quit_cur_mode), this.context.getString(C1965R.string.dialog_quit_cur_mode_describe), (String) null, (String) null, false, 2, new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.kernel.maps.MapManager.1
        ...
        if (id == C1965R.id.iv_my_position) {
        ...
        if (id == C1965R.id.iv_fly_position) {
            this.map.showFlyLocation();
            this.viewCenterPosition.setVisibility(8);
            return;
        }
        if (id == C1965R.id.iv_fly_home_position) {
            this.map.showFlyStartLocation();
            this.viewCenterPosition.setVisibility(8);
            return;
        }
        if (id == C1965R.id.iv_map_standard) {
            this.viewMapType.setVisibility(8);
            this.map.setMapType(Style.MAPBOX_STREETS);
            return;
        }
        if (id == C1965R.id.iv_map_satellite) {
            this.viewMapType.setVisibility(8);
            this.map.setMapType(Style.SATELLITE);
            return;
        }
        if (id == C1965R.id.iv_map_night) {
            this.viewMapType.setVisibility(8);
            this.map.setMapType(Style.TRAFFIC_NIGHT);
            return;
        }
        if (id == C1965R.id.btn_map_clear) {
            this.map.clearMarkAndPoly(true);
            return;
        }
        if (id == C1965R.id.btn_map_mark) {
        ...
        if (id == C1965R.id.iv_waypoint_fly) {
            DDLog.m1685e(TAG, "新版航点模式");
            if (Conditions.isTrackTargetOpen()) {
                Context context2 = this.context;
                new GeneralDialog(context2, context2.getString(C1965R.string.dialog_quit_quickshot_mode_title), this.context.getString(C1965R.string.dialog_quit_quickshot_mode_describe), new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.kernel.maps.-$$Lambda$MapManager$q-U8QJHUfvjivrSGbg6N87p0KHg
                    @Override // com.ipotensic.kernel.view.dialog.GeneralDialog.ClickConfirmListener
        ...
        if (id == C1965R.id.iv_waypoint_cancel) {
        ...
        if (id == C1965R.id.iv_waypoint_stop_fly) {
            Context context3 = this.context;
            new GeneralDialog(context3, context3.getString(C1965R.string.dialog_quit_cur_mode), this.context.getString(C1965R.string.dialog_quit_cur_mode_describe), (String) null, (String) null, false, 2, new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.kernel.maps.MapManager.3
                @Override // com.ipotensic.kernel.view.dialog.GeneralDialog.ClickConfirmListener
                public void confirm() {
                    if (FlightRevData.get().getFlightRevStateData().isPointFly()) {
    ...
    public void onItemClick(int i) {
        try {
            ...
            TextView textView = (TextView) this.flightRecordView.findViewById(C1965R.id.tv_date);
            TextView textView2 = (TextView) this.flightRecordView.findViewById(C1965R.id.edt_speed);
            TextView textView3 = (TextView) this.flightRecordView.findViewById(C1965R.id.tv_height);
            TextView textView4 = (TextView) this.flightRecordView.findViewById(C1965R.id.tv_mileage);
            TextView textView5 = (TextView) this.flightRecordView.findViewById(C1965R.id.tv_duration);
            ...
            if (list != null && list.size() > 0) {
                ...
                if (SPHelper.getInstance().isFt()) {
                    textView2.setText(String.format(this.context.getString(C1965R.string.units_mph), Double.valueOf(Double.parseDouble(this.recordList.get(i).getSpeed().substring(0, r0.length() - 4)) * 0.6213712d)));
                    String height = this.recordList.get(i).getHeight();
                    textView3.setText(String.format(this.context.getString(C1965R.string.units_ft), Double.valueOf(Double.parseDouble(height.substring(0, height.length() - 1)) * 3.28083989501d)));
                    String mileage = this.recordList.get(i).getMileage();
                    if (mileage.endsWith("km")) {
                        textView4.setText(String.format(this.context.getString(C1965R.string.units_mi), Double.valueOf(Double.parseDouble(mileage.substring(0, mileage.length() - 2)) * 0.6213712d)));
                    } else {
                        textView4.setText(String.format(this.context.getString(C1965R.string.units_ft), Double.valueOf(Double.parseDouble(mileage.substring(0, mileage.length() - 1)) * 3.28083989501d)));
                    }
                } else {
            ...
            DDLog.m1684e("点击地图错误:" + e.getMessage());
        }
    }
    ...
    @Override // com.ipotensic.kernel.maps.MapInfoListener
    public void startFlight(final ArrayList<SendMultiPointData.LatLng> arrayList) {
        ...
        if (setIntelligentFlightConditions()) {
            ...
            Runnable runnable = new Runnable() { // from class: com.ipotensic.kernel.maps.MapManager.4
                @Override // java.lang.Runnable
                public void run() {
                    FlightSendData.get().getSendMultiPointData().setPoints(arrayList);
    ...
    private boolean setWayPointFlightConditions() {
        if (!FlightRevData.get().getFlightRevStateData().isFlight()) {
            Context context = this.context;
            ToastUtil.toast((Activity) context, context.getString(C1965R.string.waypoint_not_flight));
            return false;
        }
        if (FlightRevData.get().getFlightRevFlightInfoData().getRemainedBattery() <= 20) {
            Context context2 = this.context;
            ToastUtil.toast((Activity) context2, context2.getString(C1965R.string.waypoint_low_battery));
            return false;
        }
        if (FlightRevData.get().getFlightRevStateData().isReturning()) {
            Context context3 = this.context;
            ToastUtil.toast((Activity) context3, context3.getString(C1965R.string.returning_waypoint_flight_unavailable));
            return false;
        }
        FlightRevStateData flightRevStateData = FlightRevData.get().getFlightRevStateData();
        ...
        if (flightRevStateData.getMode() == 2) {
            if (FlightConfig.GPS.getAccuracy() > 70) {
                ...
                ToastUtil.toast((Activity) context4, context4.getString(C1965R.string.gps_accuracy_low_waypoint_flight));
                return false;
            }
            ...
            ToastUtil.toast((Activity) context5, context5.getString(C1965R.string.setting_height_low_waypoint_flight));
            return false;
        }
        Context context6 = this.context;
        ToastUtil.toast((Activity) context6, context6.getString(C1965R.string.toast_gps_tips));
        return false;
    }
    ...
    public void exitWayPointFlightConditions(FlightRevStateData flightRevStateData) {
        ...
        if (FlightConfig.GPS.getAccuracy() > 70) {
            Context context = this.context;
            ToastUtil.toast((Activity) context, context.getString(C1965R.string.gps_accuracy_low_exit_waypoint_flight));
            ...
            Context context2 = this.context;
            ToastUtil.toast((Activity) context2, context2.getString(C1965R.string.waypoint_flight_arrive_fence));
            setExitWayPointFlight(false);
        } else if (FlightRevData.get().getFlightRevFlightInfoData().getVerticalDistance() < 5.0d) {
            Context context3 = this.context;
            ToastUtil.toast((Activity) context3, context3.getString(C1965R.string.setting_height_low_waypoint_follow_fail));
            setExitWayPointFlight(false);
        }
    }
