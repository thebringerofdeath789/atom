...
public class MiniRepairActivity extends BaseActivity implements EventDispatcher.OnEventListener {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C1965R.layout.activity_repair);
        EventDispatcher.get().registerEvent(getLifecycle(), this);
        initView();
    }

    private void initView() {
        this.tvRepairTitle = (TextView) findViewById(C1965R.id.tv_repair_title);
        this.ivRepairGif = (ImageView) findViewById(C1965R.id.iv_repair_gif);
        this.tvRepairStep = (TextView) findViewById(C1965R.id.tv_code_step);
        this.tvRepairStepTwo = (TextView) findViewById(C1965R.id.tv_code_step_two);
        ImageView imageView = (ImageView) findViewById(C1965R.id.iv_close);
        ...
        this.tvRepairStep.setText(getString(FlightConfig.isAtomLT() ? C1965R.string.atom_lt_frequency_pairing_mode_tips1 : C1965R.string.mini_code_step_one));
        this.tvRepairStepTwo.setText(getString(FlightConfig.isAtomLT() ? C1965R.string.atom_lt_frequency_pairing_mode_tips2 : C1965R.string.mini_code_step_two));
    ...
    public void onEvent(EventID eventID, Event event) {
        if (eventID == EventID.FLIGHT_RECEIVE_MINI_PAIR_RESULT) {
            ...
            DDLog.m1684e("对频------结果: " + flightRevMiniPairData.isPairSuccess() + ", isGrantResult= " + this.isGrantResult);
            if (flightRevMiniPairData.isPairSuccess()) {
                ...
                this.tvRepairTitle.setText(getString(C1965R.string.repair_mode));
                this.tvRepairStep.setText(getString(C1965R.string.repair_will_complete));
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.ipotensic.kernel.activitys.MiniRepairActivity.2
                    ...
                    public void run() {
                        DDLog.m1684e("对频结束，回到kernelActivity");
                        MiniRepairActivity.this.finishActivity();
                    }
                }, 4000L);
                return;
            ...
            DDLog.m1684e("对频失败");
            this.isGrantResult = true;
            MiniPairFailDialog miniPairFailDialog = new MiniPairFailDialog(this, C1965R.layout.view_dialog_repair, new MiniPairFailDialog.OnClickListener() { // from class: com.ipotensic.kernel.activitys.-$$Lambda$MiniRepairActivity$WxG_lkC1lIFBwmTt7ocsLrrRnBo
