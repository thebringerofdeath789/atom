...
public class VideoViewerLandActivity extends BaseActivity implements EventDispatcher.OnEventListener {
    ...
    IMediaInfoCallback callback = new IMediaInfoCallback() { // from class: com.ipotensic.kernel.activitys.VideoViewerLandActivity.11
        ...
        public void onCallback(MediaInfoData mediaInfoData) {
            if (mediaInfoData != null) {
                ...
                DDLog.m1684e("mediainfo:" + mediaInfoData.toString());
            }
        }
    };
    private final VideoLoopManager.OnPageLoopListener pagerChangeListener = new VideoLoopManager.OnPageLoopListener() { // from class: com.ipotensic.kernel.activitys.VideoViewerLandActivity.12
        ...
        public void onPageChanged(int i, int i2) {
            try {
                DDLog.m1684e("curIndex:" + i);
                DDLog.m1684e("mediaInfoData:" + VideoViewerLandActivity.this.mediaInfoData);
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C1965R.layout.activity_video_viewer);
        initIntent();
        initView();
    ...
    private void initView() {
        ImageView imageView = (ImageView) findViewById(C1965R.id.btn_back);
        ...
        this.viewPager = (LooperViewPager) findViewById(C1965R.id.loop_viewpager);
        ...
        ImageButton imageButton3 = (ImageButton) findViewById(C1965R.id.btn_download);
            ...
            public void click(View view) {
                if (VideoViewerLandActivity.this.data instanceof RemoteFile) {
                    if (!((RemoteFile) VideoViewerLandActivity.this.data).isDownloaded()) {
                        ...
                        VideoViewerLandActivity videoViewerLandActivity = VideoViewerLandActivity.this;
                        ToastUtil.toast(videoViewerLandActivity, videoViewerLandActivity.getString(C1965R.string.dialog_file_is_downloaded));
                    }
                }
            }
        });
        ImageButton imageButton4 = (ImageButton) findViewById(C1965R.id.btn_delete);
        ...
        if (!this.isLandActivity) {
            ...
            this.tvCurPageNum.setTextColor(getColor(C1965R.color.colorBlack));
            this.btnBack.setImageResource(C1965R.mipmap.img_arrow_left_black);
            this.btnShare.setImageResource(C1965R.mipmap.img_btn_media_share);
            this.btnDownload.setImageResource(C1965R.mipmap.img_btn_media_info);
        ...
        this.layoutMain = (ConstraintLayout) findViewById(C1965R.id.layout_main);
        ...
        this.layoutMain.setBackgroundColor(getResources().getColor(this.isLandActivity ? C1965R.color.colorBlack : C1965R.color.colorWhite));
        this.layoutTop.setBackgroundColor(getResources().getColor(this.isLandActivity ? C1965R.color.colorSeventyPercent_gallery_tab : C1965R.color.colorWhite));
        this.layoutBottom.setBackgroundColor(getResources().getColor(this.isLandActivity ? C1965R.color.colorSeventyPercent_gallery_tab : C1965R.color.colorWhite));
        this.tvShowTips = (TextView) findViewById(C1965R.id.tvShowTips);
        this.tvTips = (TextView) findViewById(C1965R.id.tvTips);
    }
                    ...
                    public void onGrant() {
                        ...
                        VideoPlayerUtils.download(videoViewerLandActivity, (RemoteFile) videoViewerLandActivity.data, VideoViewerLandActivity.this.downloadDialog, new VideoPlayerUtils.OnDownloadListener() { // from class: com.ipotensic.kernel.activitys.VideoViewerLandActivity.7.1
                            ...
                            public void onDownloadSuccess() {
                                ...
                                ToastUtil.showImageTop(VideoViewerLandActivity.this, VideoViewerLandActivity.this.getResources().getString(C1965R.string.toast_download_success), C1965R.mipmap.icon_toast_successful);
                            }
                        });
                    }
                });
    ...
    /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$8 */
    class C20818 implements OnResultListener<Boolean> {
        @Override // com.ipotensic.baselib.okhttp.OnResultListener
        public void onFailed(Exception exc) {
        }
                ...
                if (!(VideoViewerLandActivity.this.data instanceof LocalFile)) {
                    if (VideoViewerLandActivity.this.data instanceof RemoteFile) {
                        ...
                        PhoneConfig.mainHandler.post(new Runnable() { // from class: com.ipotensic.kernel.activitys.VideoViewerLandActivity.8.2
                            @Override // java.lang.Runnable
                            public void run() {
                                ToastUtil.showImageTop(VideoViewerLandActivity.this, VideoViewerLandActivity.this.getString(C1965R.string.toast_delete_success), C1965R.mipmap.icon_toast_successful);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void delete() {
        C20818 c20818 = new C20818();
        Serializable serializable = this.data;
        if (serializable instanceof LocalFile) {
            VideoPlayerUtils.deleteLocalFile(this, (LocalFile) serializable, c20818);
        } else if (serializable instanceof RemoteFile) {
            if (((RemoteFile) serializable).isFromUsb()) {
                VideoPlayerUtils.deleteUsbRemoteFile(this, (RemoteFile) this.data, this.position, c20818);
            } else {
                VideoPlayerUtils.deleteRemoteFile(this, (RemoteFile) this.data, this.position, c20818);
            }
        }
    }

    /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$9 */
    class C20829 implements PermissionUtil.OnPermissionListener {
        @Override // com.ipotensic.baselib.permission.PermissionUtil.OnPermissionListener
        public void onDenied() {
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void share() {
        PermissionUtil.requestStoragePermissionInShareWithDialog(this, new C20829());
    }

    /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$16 */
    static /* synthetic */ class C207416 {
    ...
    public void onEvent(EventID eventID, Event event) {
        int i = C207416.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()];
        if (i == 1) {
    ...
    protected void initData() {
        Serializable serializable = this.data;
        if (serializable instanceof LocalFile) {
            DDLog.m1684e("fileTime:" + ((LocalFile) this.data).getDuration());
        ...
        DDLog.m1687i("video play path:" + this.path);
    ...
    public void toPlay(Serializable serializable) {
        ...
        overridePendingTransition(C1965R.anim.trans_in_bottom_gallery, 0);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void setFileDownloaded(RemoteFile remoteFile) {
        this.btnDownload.setImageResource(remoteFile.isDownloaded() ? C1965R.mipmap.img_mark_already_downloaded : C1965R.mipmap.icon_btn_download);
