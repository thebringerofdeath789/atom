...
public class RemoterCalActivity extends BaseActivity implements EventDispatcher.OnEventListener {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C1965R.layout.activity_remoter_calibration);
        this.leftRockerView = (CalRockerView) findViewById(C1965R.id.cal_rocker_view_left);
        this.rightRockerView = (CalRockerView) findViewById(C1965R.id.cal_rocker_view_right);
        this.tvRockerTips = (TextView) findViewById(C1965R.id.tv_rocker_tips);
        this.tvWheelTips = (TextView) findViewById(C1965R.id.tv_wheel_tips);
        this.imgWheelSegment = (ImageView) findViewById(C1965R.id.img_wheel_segment);
        this.imgLeftWheel = (ImageView) findViewById(C1965R.id.img_left_wheel);
        this.imgRightWheel = (ImageView) findViewById(C1965R.id.img_right_wheel);
        this.layoutStep1 = (ConstraintLayout) findViewById(C1965R.id.layout_cal_step1);
        this.layoutStep2 = (ConstraintLayout) findViewById(C1965R.id.layout_cal_step2);
        this.leftRockerView.setLeftRocker(true);
        this.rightRockerView.setLeftRocker(false);
        findViewById(C1965R.id.btn_start_cal).setOnClickListener(new ScaleClickListener() { // from class: com.ipotensic.kernel.activitys.RemoterCalActivity.1
        ...
        findViewById(C1965R.id.iv_close).setOnClickListener(new ScaleClickListener() { // from class: com.ipotensic.kernel.activitys.RemoterCalActivity.2
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view) {
    ...
    private void setWheelState(FlightRevRemoterCalibrationData flightRevRemoterCalibrationData) {
        this.imgLeftWheel.setImageResource(flightRevRemoterCalibrationData.isLeftTrackWheelCalSuccess() ? C1965R.mipmap.img_bg_track_wheel_left_enable : C1965R.mipmap.img_bg_track_wheel_left_disable);
        this.imgRightWheel.setImageResource(flightRevRemoterCalibrationData.isRightTrackWheelCalSuccess() ? C1965R.mipmap.img_bg_track_wheel_right_enable : C1965R.mipmap.img_bg_track_wheel_right_disable);
    }

    /* renamed from: com.ipotensic.kernel.activitys.RemoterCalActivity$5 */
    static /* synthetic */ class C20615 {
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        int i = C20615.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()];
        if (i == 1) {
            DDLog.m1684e("遥控器校准结果: 飞机断开");
            quitAndExitActivity();
            return;
        }
        if (i != 2) {
        ...
        if (flightRevRemoterCalibrationData3 != null) {
            DDLog.m1684e("遥控器校准结果:" + flightRevRemoterCalibrationData3.toString());
            ...
            if (flightRevRemoterCalibrationData3.isStep0() && flightRevRemoterCalibrationData3.isCalSuccess() && ((flightRevRemoterCalibrationData2 = this.remoterCalibrationData) == null || !flightRevRemoterCalibrationData2.isCalSuccess())) {
                ToastUtil.showImageTop(this, getString(C1965R.string.txt_remoter_calibration_success), C1965R.mipmap.icon_toast_successful);
            ...
            if (flightRevRemoterCalibrationData3.isCalFailed() && ((flightRevRemoterCalibrationData = this.remoterCalibrationData) == null || !flightRevRemoterCalibrationData.isCalFailed())) {
                DDLog.m1684e("指南针校准  失败");
                ToastUtil.showImageTop(this, getString(C1965R.string.txt_remoter_calibration_failed), C1965R.mipmap.icon_calibration_fail);
        ...
        try {
            ...
            DDLog.m1684e("赋值失败:" + e.getMessage());
        }
    }
