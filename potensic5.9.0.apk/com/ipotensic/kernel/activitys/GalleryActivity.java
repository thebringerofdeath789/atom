...
public class GalleryActivity extends BaseActivity implements EventDispatcher.OnEventListener {
        ...
        public void onSingleClick(int i) {
            ...
            if (GalleryActivity.this.curType == MediaType.TYPE_VIDEOS) {
                if (((RemoteFile) GalleryActivity.this.list.get(i)).isFromUsb()) {
                    ...
                    GalleryActivity.this.overridePendingTransition(C1965R.anim.trans_in_bottom_gallery, 0);
                    return;
                }
    ...
    private DialogInterface.OnDismissListener loadingDialogListener = new DialogInterface.OnDismissListener() { // from class: com.ipotensic.kernel.activitys.GalleryActivity.19
        ...
        public void onDismiss(DialogInterface dialogInterface) {
            if (GalleryActivity.this.deleteSuccess) {
                ...
                ToastUtil.showImageTop(galleryActivity, galleryActivity.getResources().getString(C1965R.string.toast_delete_success), C1965R.mipmap.icon_toast_successful);
    ...
    private final Runnable loadTimeoutRunnable = new Runnable() { // from class: com.ipotensic.kernel.activitys.GalleryActivity.22
        ...
        public void run() {
            try {
                ...
                GalleryActivity galleryActivity = GalleryActivity.this;
                ToastUtil.toast(galleryActivity, galleryActivity.getString(C1965R.string.txt_load_gallery_failed));
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C1965R.layout.view_layout_gallery);
        initView();
        requestData();
    ...
    private void initView() {
        ...
        this.lineVideosTabBottom = findViewById(C1965R.id.line_videos_tab_bottom);
        this.linePhotosTabBottom = findViewById(C1965R.id.line_photos_tab_bottom);
        this.imgNone = (ImageView) findViewById(C1965R.id.img_none);
        this.layoutGalleryMain = (ConstraintLayout) findViewById(C1965R.id.layout_gallery_main);
        ImageView imageView = (ImageView) findViewById(C1965R.id.btn_return);
        ...
        TextView textView = (TextView) findViewById(C1965R.id.tv_select);
        ...
        ImageButton imageButton = (ImageButton) findViewById(C1965R.id.btn_download);
        ...
        ImageButton imageButton2 = (ImageButton) findViewById(C1965R.id.btn_delete);
        ...
        TextView textView2 = (TextView) findViewById(C1965R.id.tv_videos);
        ...
        TextView textView3 = (TextView) findViewById(C1965R.id.tv_photos);
        ...
        this.recyclerView = (RecyclerView) findViewById(C1965R.id.recycler_view);
        ...
        this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.ipotensic.kernel.activitys.GalleryActivity.7
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i) {
                ...
                DDLog.m1684e("visible item downlad 1");
            ...
            public void onScrolled(RecyclerView recyclerView, int i, int i2) {
                ...
                if (GalleryActivity.this.adapter != null) {
                    DDLog.m1684e("visible item downlad 3");
                    try {
                        GalleryActivity.this.adapter.downloadThumbnail();
                    } catch (Exception e) {
                        e.printStackTrace();
        ...
        this.recyclerView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.ipotensic.kernel.activitys.GalleryActivity.8
            ...
            public void onGlobalLayout() {
                DDLog.m1684e("visible item downlad 4");
                if (GalleryActivity.this.isFirstLoadFinish) {
                    return;
                }
                GalleryActivity.this.isFirstLoadFinish = true;
                ...
                GalleryActivity.this.runOnUiThread(new Runnable() { // from class: com.ipotensic.kernel.activitys.GalleryActivity.9.1
                    ...
                    public void run() {
                        for (int i2 = 0; i2 < RemoteFileManager.getInstance().getPhotoList().size(); i2++) {
                            DDLog.m1684e("图库 photo file:" + RemoteFileManager.getInstance().getPhotoList().get(i2).toString());
                        }
                        for (int i3 = 0; i3 < RemoteFileManager.getInstance().getVideoList().size(); i3++) {
                            DDLog.m1684e("图库 video file:" + RemoteFileManager.getInstance().getVideoList().get(i3).toString());
                        }
                        GalleryActivity.this.dismissLoadingDialog();
    ...
    public void refreshList() {
        ...
        DDLog.m1684e("visible item refresh 1");
    ...
    public void checkNone() {
        ...
        if (list == null || list.size() == 0) {
            ...
            if (this.curType == MediaType.TYPE_VIDEOS) {
                this.imgNone.setImageResource(C1965R.mipmap.img_none_remote_video);
            } else {
                this.imgNone.setImageResource(C1965R.mipmap.img_none_remote_pic);
            }
            this.tvSelect.setTextColor(getResources().getColor(C1965R.color.colorWhite));
            this.tvSelect.setText(getResources().getString(C1965R.string.main_media_select));
    ...
    public void setIndicatorUI(MediaType mediaType) {
        ...
        this.tvVideos.setTextColor(getResources().getColor(mediaType == MediaType.TYPE_VIDEOS ? C1965R.color.colorWhite : C1965R.color.color_gallery_top_title));
        this.tvPhotos.setTextColor(getResources().getColor(mediaType == MediaType.TYPE_PHOTOS ? C1965R.color.colorWhite : C1965R.color.color_gallery_top_title));
    ...
    public void setSelectUI(boolean z) {
        ...
        this.tvSelect.setText(getString(z ? C1965R.string.dialog_cancel : C1965R.string.main_media_select));
        this.btnDelete.setImageResource(C1965R.mipmap.icon_btn_media_delete_disable);
        this.btnDownload.setImageResource(C1965R.mipmap.icon_btn_download_disable);
        if (z) {
    ...
    public void download() {
        ...
        if (i == i2 && i != 0) {
            ToastUtil.toast(this, getString(i2 == 1 ? C1965R.string.dialog_file_is_downloaded : C1965R.string.dialog_files_are_downloaded));
            return;
        }
                ...
                public void run() {
                    for (int i4 = 0; i4 < size && !GalleryActivity.this.isDownloadCanceled; i4++) {
                        try {
                            ...
                            DDLog.m1684e("下载文件出错：" + e.getMessage());
                            return;
                        }
                    }
                    GalleryActivity.this.isDownloadCanceled = false;
                    DDLog.m1684e("图库下载结束1");
                }
            });
        }
    }
            ...
            try {
                RemoteFileManager.getInstance().downloadMultiFileForUsb(this.localFiles, this.downloadDialog.getDownloadListener(), new OnFileDownloadListener() { // from class: com.ipotensic.kernel.activitys.GalleryActivity.16
                    ...
                    public void onRequestFailed() {
                        GalleryActivity.this.isDownloadCanceled = false;
                        DDLog.m1684e("图库下载结束2");
                    }

                    @Override // com.logan.usb.gallery.OnFileDownloadListener
                    public void onAllDone() {
                        GalleryActivity.this.isDownloadCanceled = false;
                        DDLog.m1684e("图库下载结束3");
                    }
                });
            } catch (Exception e) {
                DDLog.m1684e("下载失败:" + e.getMessage());
            }
        }
    }
    ...
    public void delete() {
        ...
        if (arrayList.size() > 0) {
            new GeneralDialog((Context) this, getString(C1965R.string.dialog_delete_these_files), getString(C1965R.string.dialog_delete_file_describe), (String) null, (String) null, false, 2, (GeneralDialog.ClickConfirmListener) new C198818(atomicBoolean, arrayList)).show();
        }
    }

    /* renamed from: com.ipotensic.kernel.activitys.GalleryActivity$18 */
    class C198818 implements GeneralDialog.ClickConfirmListener {
        final /* synthetic */ AtomicBoolean val$isUsb;
        final /* synthetic */ List val$needDeleteFiles;

        C198818(AtomicBoolean atomicBoolean, List list) {
                ...
                PhoneConfig.threadPool.execute(new Runnable() { // from class: com.ipotensic.kernel.activitys.GalleryActivity.18.2
                    ...
                    public void run() {
                        try {
                            ...
                            DDLog.m1687i("删除错误:" + e.getMessage());
                            GalleryActivity.this.deleteSuccess = false;
    ...
    public void checkDownloaded() {
        ...
        if (this.list != null) {
            for (int i3 = 0; i3 < this.list.size(); i3++) {
                DDLog.m1684e("checkdownload:" + this.list.get(i3).toString());
            }
        }
    }
    ...
    protected class BaseAdapter extends RecyclerView.Adapter<BaseViewHolder> {
        ...
        public void refresh() {
            DDLog.m1684e("visible item refresh");
        ...
        public void downloadThumbnail() throws Exception {
            ...
            DDLog.m1684e("visible item :" + visibleItems[0] + "," + visibleItems[1]);
            if (UsbConfig.isUsbConnected) {
        ...
        public BaseViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new BaseViewHolder(LayoutInflater.from(GalleryActivity.this).inflate(C1965R.layout.view_remote_file_item, viewGroup, false));
        }
        ...
        public void onBindViewHolder(BaseViewHolder baseViewHolder, final int i) {
            ...
            DDLog.m1684e("显示缩略图:" + remoteFile.toString());
            if (remoteFile.isBroken()) {
                Glide.with((FragmentActivity) GalleryActivity.this).load(Integer.valueOf(C1965R.mipmap.img_bg_thumbnail_broken_small)).error(C1965R.mipmap.img_none_remote_pic).skipMemoryCache(true).centerCrop().diskCacheStrategy(DiskCacheStrategy.NONE).thumbnail(0.2f).into(baseViewHolder.imgThumbnail);
            } else if (remoteFile.getThumbnailUrl() == null) {
                baseViewHolder.imgThumbnail.setImageResource(C1965R.mipmap.img_none_remote_pic);
            } else {
                Glide.with((FragmentActivity) GalleryActivity.this).load(remoteFile.getThumbnailUrl()).listener((RequestListener<? super String, GlideDrawable>) new RequestListener<String, GlideDrawable>() { // from class: com.ipotensic.kernel.activitys.GalleryActivity.BaseAdapter.3
                    ...
                    public boolean onException(Exception exc, String str, Target<GlideDrawable> target, boolean z) {
                        DDLog.m1684e("加载报错 glide:" + remoteFile.getThumbnailUrl() + " ,  数据长度 :" + new File(remoteFile.getThumbnailUrl()).length());
                        return false;
                    }
                }).error(C1965R.mipmap.img_none_remote_pic).skipMemoryCache(true).centerCrop().diskCacheStrategy(DiskCacheStrategy.NONE).thumbnail(0.2f).into(baseViewHolder.imgThumbnail);
            }
        ...
        public void clearSelectList() {
            if (GalleryActivity.this.selectList != null) {
                ...
                GalleryActivity.this.btnDelete.setImageResource(C1965R.mipmap.icon_btn_media_delete_disable);
                GalleryActivity.this.btnDownload.setImageResource(C1965R.mipmap.icon_btn_download_disable);
            }
        }
        ...
        public void refreshDeleteAndDownloadBtn(RemoteFile remoteFile) {
            if (GalleryActivity.this.selectList != null) {
                ...
                if (GalleryActivity.this.selectList.size() > 0) {
                    GalleryActivity.this.btnDelete.setImageResource(C1965R.mipmap.icon_btn_media_delete);
                    GalleryActivity.this.btnDownload.setImageResource(C1965R.mipmap.img_mark_already_downloaded);
                    Iterator it = GalleryActivity.this.selectList.iterator();
                    while (it.hasNext()) {
                        if (!((RemoteFile) it.next()).isDownloaded()) {
                            GalleryActivity.this.btnDownload.setImageResource(C1965R.mipmap.icon_btn_download);
                            return;
                        }
                    }
                    return;
    ...
    private class BaseViewHolder extends RecyclerView.ViewHolder {
        ...
        private BaseViewHolder(View view) {
            super(view);
            this.imgThumbnail = (ImageView) view.findViewById(C1965R.id.iv_thumbnail);
            this.selectIcon = (ImageView) view.findViewById(C1965R.id.iv_select_icon);
            this.videoIcon = (ImageView) view.findViewById(C1965R.id.iv_video_icon);
            this.imgDownloaded = (ImageView) view.findViewById(C1965R.id.img_already_downloaded);
        }
    }
        ...
        PhoneConfig.threadPool.execute(new Runnable() { // from class: com.ipotensic.kernel.activitys.GalleryActivity.20
            ...
            public void run() {
                try {
                    ...
                    DDLog.m1684e("退出 GalleryActivity出错:" + e.getMessage());
                }
            }
        });
        try {
    ...
    /* renamed from: com.ipotensic.kernel.activitys.GalleryActivity$23 */
    static /* synthetic */ class C199423 {
    ...
    public void onEvent(EventID eventID, Event event) {
        int i = C199423.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()];
        if (i == 1) {
