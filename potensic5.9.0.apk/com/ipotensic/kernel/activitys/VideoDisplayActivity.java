...
public class VideoDisplayActivity extends BaseActivity implements EventDispatcher.OnEventListener {
    ...
    VideoPlayerManager.OnVideoPlayerListener playerListener = new C20654();
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C1965R.layout.activity_test_player);
        initIntent();
        this.layoutMain = (LinearLayout) findViewById(C1965R.id.layout_main);
        if (this.isLocalVideo) {
            setRequestedOrientation(-1);
        }
        configOrientation();
        VideoView videoView = (VideoView) findViewById(C1965R.id.player);
    ...
    /* renamed from: com.ipotensic.kernel.activitys.VideoDisplayActivity$5 */
    static /* synthetic */ class C20665 {
    ...
    public void onEvent(EventID eventID, Event event) {
        int i = C20665.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()];
        if (i == 1) {
    ...
    /* renamed from: com.ipotensic.kernel.activitys.VideoDisplayActivity$4 */
    class C20654 implements VideoPlayerManager.OnVideoPlayerListener {
        C20654() {
        }
        ...
        public void onClickDelete() {
            OnResultListener onResultListener = new OnResultListener() { // from class: com.ipotensic.kernel.activitys.VideoDisplayActivity.4.2
                ...
                public void onSuccess(Object obj) {
                    ToastUtil.showPositionBottom(VideoDisplayActivity.this, VideoDisplayActivity.this.getString(C1965R.string.toast_delete_success), C1965R.mipmap.icon_toast_successful);
                }
            };
        ...
        public void onPlayError(int i) {
            if (i == -1 && VideoDisplayActivity.this.isServerVideo) {
                VideoDisplayActivity videoDisplayActivity = VideoDisplayActivity.this;
                ToastUtil.toast(videoDisplayActivity, videoDisplayActivity.getResources().getString(C1965R.string.please_check_the_network));
            }
        }
    }
