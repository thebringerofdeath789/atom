...
public class ViewLayoutGimbalCalibrationBindingImpl extends ViewLayoutGimbalCalibrationBinding {
    ...
    /* renamed from: mGimbalCalibrationModelStartCalibrationAndroidViewViewOnClickListener */
    private OnClickListenerImpl f2190x8c32d99a;
    private final ConstraintLayout mboundView0;

    static {
        SparseIntArray sparseIntArray = new SparseIntArray();
        sViewsWithIds = sparseIntArray;
        sparseIntArray.put(C1965R.id.view_video, 7);
        sparseIntArray.put(C1965R.id.tv_count_down, 8);
        sparseIntArray.put(C1965R.id.btn_close, 9);
        sparseIntArray.put(C1965R.id.pic_gimbal_calibration, 10);
        sparseIntArray.put(C1965R.id.loadingView, 11);
    }
    ...
    public boolean setVariable(int i, Object obj) {
        if (C1964BR.gimbalCalibrationModel != i) {
            return false;
        }
    ...
    public void setGimbalCalibrationModel(SettingGimbalCalibrationModel settingGimbalCalibrationModel) {
        ...
        notifyPropertyChanged(C1964BR.gimbalCalibrationModel);
        super.requestRebind();
    }
