...
public class ViewLayoutCompassCalibrationBindingImpl extends ViewLayoutCompassCalibrationBinding {
    ...
    static {
        ...
        sparseIntArray.put(C1965R.id.tv_compass_title, 10);
        sparseIntArray.put(C1965R.id.btn_close, 11);
        sparseIntArray.put(C1965R.id.iv_rotating_axis, 12);
        sparseIntArray.put(C1965R.id.img_atom, 13);
        sparseIntArray.put(C1965R.id.tv_mini_geo_step_tips, 14);
        sparseIntArray.put(C1965R.id.tv_fail_notice, 15);
        sparseIntArray.put(C1965R.id.tv_count_down, 16);
    }
    ...
    public boolean setVariable(int i, Object obj) {
        if (C1964BR.compassCalibrationModel != i) {
            return false;
        }
    ...
    public void setCompassCalibrationModel(SettingCompassCalibrationModel settingCompassCalibrationModel) {
        ...
        notifyPropertyChanged(C1964BR.compassCalibrationModel);
        super.requestRebind();
    }
