...
public class ViewLayoutSettingCameraBindingImpl extends ViewLayoutSettingCameraBinding {
    ...
    /* renamed from: mSettingCameraModelBtnFormatSDClickAndroidViewViewOnClickListener */
    private OnClickListenerImpl1 f2196xcc8bb149;
    ...
    static {
        ...
        sparseIntArray.put(C1965R.id.view_title, 8);
        sparseIntArray.put(C1965R.id.layout_setting, 9);
        sparseIntArray.put(C1965R.id.tv_general_setting, 10);
        sparseIntArray.put(C1965R.id.view_general_settings, 11);
        sparseIntArray.put(C1965R.id.tvWhiteBalanceTip, 12);
        sparseIntArray.put(C1965R.id.line1, 13);
        sparseIntArray.put(C1965R.id.tvAuxLine, 14);
        sparseIntArray.put(C1965R.id.grid_layout, 15);
        sparseIntArray.put(C1965R.id.line2, 16);
        sparseIntArray.put(C1965R.id.tvSeg, 17);
        sparseIntArray.put(C1965R.id.space_general, 18);
        sparseIntArray.put(C1965R.id.seg_rec_layout, 19);
        sparseIntArray.put(C1965R.id.tv_sd_card, 20);
        sparseIntArray.put(C1965R.id.view_sd_card, 21);
        sparseIntArray.put(C1965R.id.tvRemainTips, 22);
        sparseIntArray.put(C1965R.id.line3, 23);
        sparseIntArray.put(C1965R.id.tvSdCardOption, 24);
        sparseIntArray.put(C1965R.id.tv_others, 25);
        sparseIntArray.put(C1965R.id.view_others, 26);
        sparseIntArray.put(C1965R.id.tvWaterMark, 27);
        sparseIntArray.put(C1965R.id.line4, 28);
        sparseIntArray.put(C1965R.id.tvPhotoLocationTips, 29);
    }
    ...
    public boolean setVariable(int i, Object obj) {
        if (C1964BR.settingCameraModel != i) {
            return false;
        }
    ...
    public void setSettingCameraModel(SettingCameraModel settingCameraModel) {
        ...
        notifyPropertyChanged(C1964BR.settingCameraModel);
        super.requestRebind();
    }
