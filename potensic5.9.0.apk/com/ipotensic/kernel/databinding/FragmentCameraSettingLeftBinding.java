...
public final class FragmentCameraSettingLeftBinding implements ViewBinding {
    ...
    public static FragmentCameraSettingLeftBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.fragment_camera_setting_left, viewGroup, false);
        if (z) {
    ...
    public static FragmentCameraSettingLeftBinding bind(View view) {
        View findViewById;
        View findViewById2;
        int i = C1965R.id.br_under;
        Barrier barrier = (Barrier) view.findViewById(i);
        if (barrier != null) {
            i = C1965R.id.iv_split_line_ev;
            ImageView imageView = (ImageView) view.findViewById(i);
            if (imageView != null) {
                i = C1965R.id.iv_split_line_photo_format;
                ImageView imageView2 = (ImageView) view.findViewById(i);
                if (imageView2 != null) {
                    i = C1965R.id.iv_split_line_sdcard;
                    ImageView imageView3 = (ImageView) view.findViewById(i);
                    if (imageView3 != null) {
                        i = C1965R.id.ll_wv_fps_item_wrapper;
                        LinearLayout linearLayout = (LinearLayout) view.findViewById(i);
                        if (linearLayout != null) {
                            i = C1965R.id.ll_wv_resolution_item_wrapper;
                            LinearLayout linearLayout2 = (LinearLayout) view.findViewById(i);
                            if (linearLayout2 != null) {
                                i = C1965R.id.rb_photo_format_jpg;
                                RadioButton radioButton = (RadioButton) view.findViewById(i);
                                if (radioButton != null) {
                                    i = C1965R.id.rb_photo_format_raw;
                                    RadioButton radioButton2 = (RadioButton) view.findViewById(i);
                                    if (radioButton2 != null) {
                                        i = C1965R.id.rb_sdcard_estimate;
                                        RadioButton radioButton3 = (RadioButton) view.findViewById(i);
                                        if (radioButton3 != null) {
                                            i = C1965R.id.rb_sdcard_volume;
                                            RadioButton radioButton4 = (RadioButton) view.findViewById(i);
                                            if (radioButton4 != null) {
                                                i = C1965R.id.rg_photo_format;
                                                RadioGroup radioGroup = (RadioGroup) view.findViewById(i);
                                                if (radioGroup != null) {
                                                    i = C1965R.id.rg_sdcard_display_items;
                                                    RadioGroup radioGroup2 = (RadioGroup) view.findViewById(i);
                                                    if (radioGroup2 != null) {
                                                        i = C1965R.id.tv_photo_format;
                                                        TextView textView = (TextView) view.findViewById(i);
                                                        if (textView != null) {
                                                            i = C1965R.id.tv_sd_format;
                                                            TextView textView2 = (TextView) view.findViewById(i);
                                                            if (textView2 != null) {
                                                                i = C1965R.id.tv_sdcard_setting;
                                                                TextView textView3 = (TextView) view.findViewById(i);
                                                                if (textView3 != null && (findViewById = view.findViewById((i = C1965R.id.view_camera_set_split))) != null && (findViewById2 = view.findViewById((i = C1965R.id.view_camera_set_split_sdcard))) != null) {
                                                                    i = C1965R.id.view_resolution_fps_split;
                                                                    ImageView imageView4 = (ImageView) view.findViewById(i);
                                                                    if (imageView4 != null) {
                                                                        i = C1965R.id.wv_fps_item;
                                                                        HorizontalWheelView horizontalWheelView = (HorizontalWheelView) view.findViewById(i);
                                                                        if (horizontalWheelView != null) {
                                                                            i = C1965R.id.wv_resolution_item;
