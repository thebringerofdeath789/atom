...
public final class ViewLayoutSetting3Item1Binding implements ViewBinding {
    ...
    public static ViewLayoutSetting3Item1Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_layout_setting3_item1, viewGroup, false);
        if (z) {
    ...
    public static ViewLayoutSetting3Item1Binding bind(View view) {
        View findViewById;
        int i = C1965R.id.iv_arrow_one;
        ImageView imageView = (ImageView) view.findViewById(i);
        if (imageView != null) {
            i = C1965R.id.iv_arrow_two;
            ImageView imageView2 = (ImageView) view.findViewById(i);
            if (imageView2 != null) {
                i = C1965R.id.layout_mini_repair;
                ConstraintLayout constraintLayout = (ConstraintLayout) view.findViewById(i);
                if (constraintLayout != null) {
                    i = C1965R.id.layout_remoter_calibration;
                    ConstraintLayout constraintLayout2 = (ConstraintLayout) view.findViewById(i);
                    if (constraintLayout2 != null) {
                        LinearLayout linearLayout = (LinearLayout) view;
                        i = C1965R.id.line;
                        View findViewById2 = view.findViewById(i);
                        if (findViewById2 != null && (findViewById = view.findViewById((i = C1965R.id.line1))) != null) {
                            i = C1965R.id.tv_no_access_repairing;
                            TextView textView = (TextView) view.findViewById(i);
                            if (textView != null) {
                                i = C1965R.id.tv_remoter_calibration;
                                TextView textView2 = (TextView) view.findViewById(i);
                                if (textView2 != null) {
                                    i = C1965R.id.tv_remoter_calibration_tips;
                                    TextView textView3 = (TextView) view.findViewById(i);
                                    if (textView3 != null) {
                                        i = C1965R.id.tv_repairing_aircraft;
