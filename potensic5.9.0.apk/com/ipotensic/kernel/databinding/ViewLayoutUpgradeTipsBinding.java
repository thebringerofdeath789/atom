...
public final class ViewLayoutUpgradeTipsBinding implements ViewBinding {
    ...
    public static ViewLayoutUpgradeTipsBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_layout_upgrade_tips, viewGroup, false);
        if (z) {
    ...
    public static ViewLayoutUpgradeTipsBinding bind(View view) {
        View findViewById;
        View findViewById2;
        int i = C1965R.id.btn_double_cancel;
        TextView textView = (TextView) view.findViewById(i);
        if (textView != null) {
            i = C1965R.id.btn_double_confirm;
            TextView textView2 = (TextView) view.findViewById(i);
            if (textView2 != null) {
                i = C1965R.id.btn_single_confirm;
                TextView textView3 = (TextView) view.findViewById(i);
                if (textView3 != null && (findViewById = view.findViewById((i = C1965R.id.line_horizontal))) != null && (findViewById2 = view.findViewById((i = C1965R.id.line_vertical))) != null) {
