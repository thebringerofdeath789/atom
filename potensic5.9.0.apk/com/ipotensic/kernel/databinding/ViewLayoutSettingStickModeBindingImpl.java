...
public class ViewLayoutSettingStickModeBindingImpl extends ViewLayoutSettingStickModeBinding {
    ...
    static {
        ...
        sparseIntArray.put(C1965R.id.base_line_left, 10);
        sparseIntArray.put(C1965R.id.base_line_right, 11);
        sparseIntArray.put(C1965R.id.layout_top, 12);
        sparseIntArray.put(C1965R.id.ib_back, 13);
        sparseIntArray.put(C1965R.id.tv_title, 14);
        sparseIntArray.put(C1965R.id.tv_code_title, 15);
        sparseIntArray.put(C1965R.id.btn_exit, 16);
        sparseIntArray.put(C1965R.id.tv_left, 17);
        sparseIntArray.put(C1965R.id.tv_right, 18);
        sparseIntArray.put(C1965R.id.tv_left_stick, 19);
        sparseIntArray.put(C1965R.id.tv_left_side, 20);
        sparseIntArray.put(C1965R.id.tv_right_side, 21);
        sparseIntArray.put(C1965R.id.tv_remote_right_stick, 22);
    }
    ...
    public void setSettingStickMode(SettingStickModeModel settingStickModeModel) {
        ...
        notifyPropertyChanged(C1964BR.settingStickMode);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        if ((15 & j) != 0) {
            ...
            if (j2 != 0) {
                ...
                str = this.tvBackward.getResources().getString(z ? C1965R.string.remote_backward : C1965R.string.remote_down);
                str2 = z ? this.tvUp.getResources().getString(C1965R.string.remote_up) : this.tvUp.getResources().getString(C1965R.string.remote_forward);
                str3 = this.tvDown.getResources().getString(z ? C1965R.string.remote_down : C1965R.string.remote_backward);
                str4 = this.tvForward.getResources().getString(z ? C1965R.string.remote_forward : C1965R.string.remote_up);
            } else {
                str = null;
                str2 = null;
                str3 = null;
        ...
        int i5 = (j & PlaybackStateCompat.ACTION_SET_REPEAT_MODE) != 0 ? C1965R.drawable.bg_setting_button_select_right : 0;
        int i6 = (j & 512) != 0 ? C1965R.mipmap.icon_virtual_rocker_model1_left : 0;
        int i7 = (j & 131072) != 0 ? C1965R.mipmap.icon_virtual_rocker_model1_right : 0;
        int i8 = (256 & j) != 0 ? C1965R.mipmap.icon_virtual_rocker_model2_left : 0;
        int i9 = (j & PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE) != 0 ? C1965R.drawable.bg_setting_button_select_left : 0;
        int i10 = (j & 65536) != 0 ? C1965R.mipmap.icon_virtual_rocker_model2_right : 0;
        int i11 = (j & PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED) != 0 ? C1965R.drawable.bg_setting_model_default_left : 0;
        int i12 = (j & PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE_ENABLED) != 0 ? C1965R.drawable.bg_setting_model_default_right : 0;
        long j4 = j & 13;
        if (j4 != 0) {
            if (z) {
                i8 = i6;
