...
public final class ActivityVideoViewerBinding implements ViewBinding {
    ...
    public static ActivityVideoViewerBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.activity_video_viewer, viewGroup, false);
        if (z) {
        ...
        if (imageView != null) {
            ...
            if (imageButton != null) {
                ...
                if (imageButton2 != null) {
                    i = C1965R.id.btn_media_info;
                    ImageButton imageButton3 = (ImageButton) view.findViewById(i);
                    if (imageButton3 != null) {
                        i = C1965R.id.btn_media_share;
