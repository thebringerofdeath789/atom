...
public final class ViewLayoutRightControllerBinding implements ViewBinding {
    ...
    public static ViewLayoutRightControllerBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_layout_right_controller, viewGroup, false);
        if (z) {
    ...
    public static ViewLayoutRightControllerBinding bind(View view) {
        ...
        if (imageView != null) {
            i = C1965R.id.iv_capture;
            ImageView imageView2 = (ImageView) view.findViewById(i);
            if (imageView2 != null) {
                i = C1965R.id.iv_gallery;
                ImageView imageView3 = (ImageView) view.findViewById(i);
                if (imageView3 != null) {
                    i = C1965R.id.iv_record_red;
                    ImageView imageView4 = (ImageView) view.findViewById(i);
                    if (imageView4 != null) {
                        i = C1965R.id.iv_switch_status;
                        ImageView imageView5 = (ImageView) view.findViewById(i);
                        if (imageView5 != null) {
                            i = C1965R.id.ll_record;
                            LinearLayout linearLayout = (LinearLayout) view.findViewById(i);
                            if (linearLayout != null) {
                                i = C1965R.id.tv_record_time;
