...
public final class ViewMapBinding implements ViewBinding {
    ...
    public static ViewMapBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_map, viewGroup, false);
        if (z) {
    ...
    public static ViewMapBinding bind(View view) {
        View findViewById;
        int i = C1965R.id.iv_cancel_fly;
        ImageButton imageButton = (ImageButton) view.findViewById(i);
        if (imageButton != null) {
            i = C1965R.id.iv_go;
            ImageButton imageButton2 = (ImageButton) view.findViewById(i);
            if (imageButton2 != null) {
                i = C1965R.id.iv_map_compass_bg;
                ImageView imageView = (ImageView) view.findViewById(i);
                if (imageView != null) {
                    i = C1965R.id.iv_map_lock;
                    ImageButton imageButton3 = (ImageButton) view.findViewById(i);
                    if (imageButton3 != null) {
                        i = C1965R.id.iv_map_mark;
                        ImageButton imageButton4 = (ImageButton) view.findViewById(i);
                        if (imageButton4 != null) {
                            i = C1965R.id.iv_map_position;
                            ImageButton imageButton5 = (ImageButton) view.findViewById(i);
                            if (imageButton5 != null) {
                                i = C1965R.id.iv_map_set_hide;
