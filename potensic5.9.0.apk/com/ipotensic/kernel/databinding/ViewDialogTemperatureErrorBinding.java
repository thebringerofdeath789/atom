...
public final class ViewDialogTemperatureErrorBinding implements ViewBinding {
    ...
    public static ViewDialogTemperatureErrorBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_dialog_temperature_error, viewGroup, false);
        if (z) {
    ...
    public static ViewDialogTemperatureErrorBinding bind(View view) {
        int i = C1965R.id.iv_battery_temperature_error;
        ImageView imageView = (ImageView) view.findViewById(i);
        if (imageView != null) {
            i = C1965R.id.tv_battery_temperature;
            TextView textView = (TextView) view.findViewById(i);
            if (textView != null) {
                i = C1965R.id.tv_battery_temperature_error_notice;
