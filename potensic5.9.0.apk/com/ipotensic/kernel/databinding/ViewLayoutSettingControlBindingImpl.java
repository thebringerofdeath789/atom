...
public class ViewLayoutSettingControlBindingImpl extends ViewLayoutSettingControlBinding {
    ...
    /* renamed from: mSettingControlModelBtnAngel45ClickAndroidViewViewOnClickListener */
    private OnClickListenerImpl f2197xa5651c37;

    /* renamed from: mSettingControlModelBtnAngel90ClickAndroidViewViewOnClickListener */
    private OnClickListenerImpl1 f2198xc27023e1;

    /* renamed from: mSettingControlModelBtnFpvModeClickAndroidViewViewOnClickListener */
    private OnClickListenerImpl4 f2199xc5937aaa;

    /* renamed from: mSettingControlModelBtnModeGuideVideoAndroidViewViewOnClickListener */
    private OnClickListenerImpl2 f2200x6d36a473;

    /* renamed from: mSettingControlModelBtnResetFpvSmoothAndroidViewViewOnClickListener */
    private OnClickListenerImpl6 f2201x7adacafc;

    /* renamed from: mSettingControlModelBtnResetPitchSpeedAndroidViewViewOnClickListener */
    private OnClickListenerImpl3 f2202x226cc1ed;

    /* renamed from: mSettingControlModelBtnStableModeClickAndroidViewViewOnClickListener */
    private OnClickListenerImpl7 f2203xa014a001;
    ...
    static {
        ...
        sparseIntArray.put(C1965R.id.view_title, 20);
        sparseIntArray.put(C1965R.id.layout_setting, 21);
        sparseIntArray.put(C1965R.id.base_line_left, 22);
        sparseIntArray.put(C1965R.id.tv_controller_setting, 23);
        sparseIntArray.put(C1965R.id.tv_stick_mode, 24);
        sparseIntArray.put(C1965R.id.grout_gimbal, 25);
        sparseIntArray.put(C1965R.id.tv_gimbal_setting, 26);
        sparseIntArray.put(C1965R.id.view_gimbal_setting, 27);
        sparseIntArray.put(C1965R.id.layout_max_pitch_speed, 28);
        sparseIntArray.put(C1965R.id.tv_unit_circle_speed, 29);
        sparseIntArray.put(C1965R.id.line1, 30);
        sparseIntArray.put(C1965R.id.tv_current_angle, 31);
        sparseIntArray.put(C1965R.id.line_pitch_angle_45, 32);
        sparseIntArray.put(C1965R.id.line2, 33);
        sparseIntArray.put(C1965R.id.tv_gimbal_mode, 34);
    }
    ...
    public boolean setVariable(int i, Object obj) {
        if (C1964BR.settingControlModel != i) {
            return false;
        }
    ...
    public void setSettingControlModel(SettingControlModel settingControlModel) {
        ...
        notifyPropertyChanged(C1964BR.settingControlModel);
        super.requestRebind();
    }
