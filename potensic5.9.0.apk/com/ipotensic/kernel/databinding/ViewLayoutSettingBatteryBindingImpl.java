...
public class ViewLayoutSettingBatteryBindingImpl extends ViewLayoutSettingBatteryBinding {
    ...
    static {
        ...
        sparseIntArray.put(C1965R.id.battery_progress_view, 5);
        sparseIntArray.put(C1965R.id.line4, 6);
        sparseIntArray.put(C1965R.id.tvTemperatureTips, 7);
        sparseIntArray.put(C1965R.id.tvCurrent, 8);
        sparseIntArray.put(C1965R.id.tvVoltageTips, 9);
        sparseIntArray.put(C1965R.id.tvCycleTimeTips, 10);
    }
