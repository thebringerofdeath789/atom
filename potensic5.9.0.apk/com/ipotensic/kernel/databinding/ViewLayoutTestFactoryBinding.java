...
public final class ViewLayoutTestFactoryBinding implements ViewBinding {
    ...
    public static ViewLayoutTestFactoryBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_layout_test_factory, viewGroup, false);
        if (z) {
    ...
    public static ViewLayoutTestFactoryBinding bind(View view) {
        int i = C1965R.id.btn_cam_temp;
        Button button = (Button) view.findViewById(i);
        if (button != null) {
            i = C1965R.id.btn_loss_pkg_close;
            Button button2 = (Button) view.findViewById(i);
            if (button2 != null) {
                i = C1965R.id.btn_loss_pkg_open;
                Button button3 = (Button) view.findViewById(i);
                if (button3 != null) {
                    ConstraintLayout constraintLayout = (ConstraintLayout) view;
                    i = C1965R.id.layout_test_p1_self;
                    LinearLayout linearLayout = (LinearLayout) view.findViewById(i);
                    if (linearLayout != null) {
                        i = C1965R.id.tv_camera_test_mode;
                        Button button4 = (Button) view.findViewById(i);
                        if (button4 != null) {
                            i = C1965R.id.tv_clear_imu_data;
                            Button button5 = (Button) view.findViewById(i);
                            if (button5 != null) {
                                i = C1965R.id.tv_flight_24g_test;
                                Button button6 = (Button) view.findViewById(i);
                                if (button6 != null) {
                                    i = C1965R.id.tv_flight_always_light_mode;
                                    Button button7 = (Button) view.findViewById(i);
                                    if (button7 != null) {
                                        i = C1965R.id.tv_flight_fixed_mode;
                                        Button button8 = (Button) view.findViewById(i);
                                        if (button8 != null) {
                                            i = C1965R.id.tv_flight_fixed_speed_mode;
                                            Button button9 = (Button) view.findViewById(i);
                                            if (button9 != null) {
                                                i = C1965R.id.tv_flight_shining_mode;
                                                Button button10 = (Button) view.findViewById(i);
                                                if (button10 != null) {
                                                    i = C1965R.id.tv_flight_sweep_mode;
                                                    Button button11 = (Button) view.findViewById(i);
                                                    if (button11 != null) {
                                                        i = C1965R.id.tv_flight_test_mode;
                                                        Button button12 = (Button) view.findViewById(i);
                                                        if (button12 != null) {
                                                            i = C1965R.id.tv_flight_variable_mode;
                                                            Button button13 = (Button) view.findViewById(i);
                                                            if (button13 != null) {
                                                                i = C1965R.id.tv_restore_factory_setting;
