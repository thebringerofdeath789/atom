...
public final class ViewLayoutSetting1Item6Binding implements ViewBinding {
    ...
    public static ViewLayoutSetting1Item6Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_layout_setting1_item6, viewGroup, false);
        if (z) {
    ...
    public static ViewLayoutSetting1Item6Binding bind(View view) {
        int i = C1965R.id.layout_altitude_setting;
        LinearLayout linearLayout = (LinearLayout) view.findViewById(i);
        if (linearLayout != null) {
            i = C1965R.id.layout_distance_setting;
            LinearLayout linearLayout2 = (LinearLayout) view.findViewById(i);
            if (linearLayout2 != null) {
                ConstraintLayout constraintLayout = (ConstraintLayout) view;
                i = C1965R.id.seekBar_altitude;
                CustomSeekbar customSeekbar = (CustomSeekbar) view.findViewById(i);
                if (customSeekbar != null) {
                    i = C1965R.id.seekBar_distance;
                    CustomSeekbar customSeekbar2 = (CustomSeekbar) view.findViewById(i);
                    if (customSeekbar2 != null) {
                        i = C1965R.id.switch_btn_no_limit;
                        SwitchButton switchButton = (SwitchButton) view.findViewById(i);
                        if (switchButton != null) {
                            i = C1965R.id.tv_altitude_careful_tips;
                            TextView textView = (TextView) view.findViewById(i);
                            if (textView != null) {
                                i = C1965R.id.tv_altitude_ft1;
                                TextView textView2 = (TextView) view.findViewById(i);
                                if (textView2 != null) {
                                    i = C1965R.id.tv_distance_ft1;
                                    TextView textView3 = (TextView) view.findViewById(i);
                                    if (textView3 != null) {
                                        i = C1965R.id.tv_fly_fence_altitide;
                                        TextView textView4 = (TextView) view.findViewById(i);
                                        if (textView4 != null) {
                                            i = C1965R.id.tv_fly_fence_distance;
                                            TextView textView5 = (TextView) view.findViewById(i);
                                            if (textView5 != null) {
                                                i = C1965R.id.tv_show_altitude_value;
                                                CursorEditText cursorEditText = (CursorEditText) view.findViewById(i);
                                                if (cursorEditText != null) {
                                                    i = C1965R.id.tv_show_distance_value;
                                                    CursorEditText cursorEditText2 = (CursorEditText) view.findViewById(i);
                                                    if (cursorEditText2 != null) {
                                                        i = C1965R.id.tv_unit_distance;
                                                        TextView textView6 = (TextView) view.findViewById(i);
                                                        if (textView6 != null) {
                                                            i = C1965R.id.tv_unit_height;
