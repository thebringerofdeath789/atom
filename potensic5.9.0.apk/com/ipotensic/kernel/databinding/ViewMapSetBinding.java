...
public final class ViewMapSetBinding implements ViewBinding {
    ...
    public static ViewMapSetBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_map_set, viewGroup, false);
        if (z) {
    ...
    public static ViewMapSetBinding bind(View view) {
        int i = C1965R.id.btn_map_clear;
        ImageButton imageButton = (ImageButton) view.findViewById(i);
        if (imageButton != null) {
            i = C1965R.id.btn_map_mark;
            ImageButton imageButton2 = (ImageButton) view.findViewById(i);
            if (imageButton2 != null) {
                i = C1965R.id.btn_map_show;
                ImageButton imageButton3 = (ImageButton) view.findViewById(i);
                if (imageButton3 != null) {
                    i = C1965R.id.btn_mark_save;
                    ImageButton imageButton4 = (ImageButton) view.findViewById(i);
                    if (imageButton4 != null) {
                        i = C1965R.id.iv_map_position_bg;
