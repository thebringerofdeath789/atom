...
public final class ViewWarnBinding implements ViewBinding {
    ...
    public static ViewWarnBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_warn, viewGroup, false);
        if (z) {
    ...
    public static ViewWarnBinding bind(View view) {
        int i = C1965R.id.btn_warn_close;
        ImageButton imageButton = (ImageButton) view.findViewById(i);
        if (imageButton != null) {
            i = C1965R.id.btn_warn_view;
            ImageButton imageButton2 = (ImageButton) view.findViewById(i);
            if (imageButton2 != null) {
                i = C1965R.id.ll_top_view;
                RelativeLayout relativeLayout = (RelativeLayout) view.findViewById(i);
                if (relativeLayout != null) {
                    i = C1965R.id.rv_warn_list;
                    RecyclerView recyclerView = (RecyclerView) view.findViewById(i);
                    if (recyclerView != null) {
                        i = C1965R.id.shadow_layout;
