...
public final class ViewCameraParamTips1Binding implements ViewBinding {
    ...
    public static ViewCameraParamTips1Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_camera_param_tips1, viewGroup, false);
        if (z) {
    ...
    public static ViewCameraParamTips1Binding bind(View view) {
        View findViewById;
        int i = C1965R.id.divider1;
        ImageView imageView = (ImageView) view.findViewById(i);
        if (imageView != null) {
            i = C1965R.id.divider2;
            ImageView imageView2 = (ImageView) view.findViewById(i);
            if (imageView2 != null) {
                i = C1965R.id.iv_ev_icon;
                ImageView imageView3 = (ImageView) view.findViewById(i);
                if (imageView3 != null) {
                    i = C1965R.id.iv_high_temp;
                    ImageView imageView4 = (ImageView) view.findViewById(i);
                    if (imageView4 != null) {
                        i = C1965R.id.iv_sd;
                        ImageView imageView5 = (ImageView) view.findViewById(i);
                        if (imageView5 != null) {
                            i = C1965R.id.iv_split_iso_ss;
                            ImageView imageView6 = (ImageView) view.findViewById(i);
                            if (imageView6 != null) {
                                i = C1965R.id.iv_split_line_ev;
                                ImageView imageView7 = (ImageView) view.findViewById(i);
                                if (imageView7 != null) {
                                    i = C1965R.id.iv_split_ss_wb;
