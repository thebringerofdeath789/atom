...
public final class ViewRemoteFileItemBinding implements ViewBinding {
    ...
    public static ViewRemoteFileItemBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_remote_file_item, viewGroup, false);
        if (z) {
    ...
    public static ViewRemoteFileItemBinding bind(View view) {
        int i = C1965R.id.img_already_downloaded;
        ImageView imageView = (ImageView) view.findViewById(i);
        if (imageView != null) {
            i = C1965R.id.iv_select_icon;
            ImageView imageView2 = (ImageView) view.findViewById(i);
            if (imageView2 != null) {
                i = C1965R.id.iv_thumbnail;
                ImageView imageView3 = (ImageView) view.findViewById(i);
                if (imageView3 != null) {
                    i = C1965R.id.iv_video_icon;
