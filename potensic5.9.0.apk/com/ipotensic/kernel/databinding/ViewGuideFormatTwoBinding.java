...
public final class ViewGuideFormatTwoBinding implements ViewBinding {
    ...
    public static ViewGuideFormatTwoBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_guide_format_two, viewGroup, false);
        if (z) {
                ...
                if (constraintLayout3 != null) {
                    ...
                    if (constraintLayout4 != null) {
                        ...
                        if (constraintLayout5 != null) {
                            i = C1965R.id.cl_format_sd;
                            ConstraintLayout constraintLayout6 = (ConstraintLayout) view.findViewById(i);
                            if (constraintLayout6 != null) {
                                i = C1965R.id.guide_scrollView;
                                ScrollView scrollView = (ScrollView) view.findViewById(i);
                                if (scrollView != null) {
                                    i = C1965R.id.iv_guide_cycle_2;
                                    ImageView imageView = (ImageView) view.findViewById(i);
                                    if (imageView != null) {
                                        i = C1965R.id.iv_rect_format;
                                        ImageView imageView2 = (ImageView) view.findViewById(i);
                                        if (imageView2 != null) {
                                            i = C1965R.id.iv_set;
                                            ImageView imageView3 = (ImageView) view.findViewById(i);
                                            if (imageView3 != null && (findViewById = view.findViewById((i = C1965R.id.line1))) != null && (findViewById2 = view.findViewById((i = C1965R.id.line2))) != null && (findViewById3 = view.findViewById((i = C1965R.id.line3))) != null && (findViewById4 = view.findViewById((i = C1965R.id.line4))) != null && (findViewById5 = view.findViewById((i = C1965R.id.line5))) != null && (findViewById6 = view.findViewById((i = C1965R.id.line6))) != null) {
                                                i = C1965R.id.ll_camera_set;
                                                ConstraintLayout constraintLayout7 = (ConstraintLayout) view.findViewById(i);
                                                if (constraintLayout7 != null) {
                                                    i = C1965R.id.slideBtn;
                                                    ...
                                                    if (switchButton != null) {
                                                        ...
                                                        if (textView != null) {
                                                            ...
                                                            if (imageView4 != null) {
                                                                ...
                                                                if (textView2 != null && (findViewById7 = view.findViewById((i = C1965R.id.view_bg))) != null) {
