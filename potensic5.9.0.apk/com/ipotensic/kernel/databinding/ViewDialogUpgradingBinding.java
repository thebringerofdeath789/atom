...
public final class ViewDialogUpgradingBinding implements ViewBinding {
    ...
    public static ViewDialogUpgradingBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_dialog_upgrading, viewGroup, false);
        if (z) {
    ...
    public static ViewDialogUpgradingBinding bind(View view) {
        int i = C1965R.id.img_rotate;
        ImageView imageView = (ImageView) view.findViewById(i);
        if (imageView != null) {
            i = C1965R.id.layout_logo;
            ConstraintLayout constraintLayout = (ConstraintLayout) view.findViewById(i);
            if (constraintLayout != null) {
                RelativeLayout relativeLayout = (RelativeLayout) view;
                i = C1965R.id.progress_bar;
                ProgressBar progressBar = (ProgressBar) view.findViewById(i);
                if (progressBar != null) {
                    i = C1965R.id.tv_downloading;
                    TextView textView = (TextView) view.findViewById(i);
                    if (textView != null) {
                        i = C1965R.id.tv_progress_percent;
