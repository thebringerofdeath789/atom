...
public final class ViewCommonSwitchViewBinding implements ViewBinding {
    ...
    private ViewCommonSwitchViewBinding(RelativeLayout relativeLayout, ImageView imageView, SwitchButton switchButton, TextView textView, TextView textView2) {
    ...
    public static ViewCommonSwitchViewBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_common_switch_view, viewGroup, false);
        if (z) {
    ...
    public static ViewCommonSwitchViewBinding bind(View view) {
        int i = C1965R.id.ivInfo;
        ImageView imageView = (ImageView) view.findViewById(i);
        if (imageView != null) {
            i = C1965R.id.switch_btn;
            ...
            if (switchButton != null) {
                ...
                if (textView != null) {
                    ...
                    if (textView2 != null) {
                        return new ViewCommonSwitchViewBinding((RelativeLayout) view, imageView, switchButton, textView, textView2);
                    }
                }
            }
        }
