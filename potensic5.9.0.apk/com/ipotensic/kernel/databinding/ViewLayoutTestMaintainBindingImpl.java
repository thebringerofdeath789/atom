...
public class ViewLayoutTestMaintainBindingImpl extends ViewLayoutTestMaintainBinding {
    ...
    static {
        ...
        sparseIntArray.put(C1965R.id.z_axis, 2);
        sparseIntArray.put(C1965R.id.y_axis, 3);
        sparseIntArray.put(C1965R.id.x_axis, 4);
        sparseIntArray.put(C1965R.id.tv_result, 5);
        sparseIntArray.put(C1965R.id.tv_threshold, 6);
        sparseIntArray.put(C1965R.id.et_threshold, 7);
        sparseIntArray.put(C1965R.id.tv_test_time, 8);
        sparseIntArray.put(C1965R.id.et_test_time, 9);
        sparseIntArray.put(C1965R.id.tv_notice, 10);
        sparseIntArray.put(C1965R.id.tv_test, 11);
    }
