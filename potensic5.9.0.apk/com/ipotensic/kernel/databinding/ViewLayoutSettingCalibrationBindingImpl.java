...
public class ViewLayoutSettingCalibrationBindingImpl extends ViewLayoutSettingCalibrationBinding {
    ...
    static {
        ...
        sparseIntArray.put(C1965R.id.tv_calibration, 2);
        sparseIntArray.put(C1965R.id.view_gimbal_bg, 3);
        sparseIntArray.put(C1965R.id.view_gimbal_line, 4);
        sparseIntArray.put(C1965R.id.tv_gimbal_calibration, 5);
        sparseIntArray.put(C1965R.id.tv_gimbal_adjustment, 6);
        sparseIntArray.put(C1965R.id.tv_remoter_calibration, 7);
        sparseIntArray.put(C1965R.id.tv_pair_drone, 8);
    }
