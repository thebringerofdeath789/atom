...
public class ViewLayoutPairDroneAgainBindingImpl extends ViewLayoutPairDroneAgainBinding {
    ...
    static {
        ...
        sparseIntArray.put(C1965R.id.cl_start_pair, 1);
        sparseIntArray.put(C1965R.id.tv_repair_title, 2);
        sparseIntArray.put(C1965R.id.iv_close, 3);
        sparseIntArray.put(C1965R.id.iv_repair_gif, 4);
        sparseIntArray.put(C1965R.id.btn_bottom, 5);
        sparseIntArray.put(C1965R.id.tv_code_step, 6);
        sparseIntArray.put(C1965R.id.tv_code_step_two, 7);
        sparseIntArray.put(C1965R.id.cl_pair_result, 8);
        sparseIntArray.put(C1965R.id.tv_repair_fail_title, 9);
        sparseIntArray.put(C1965R.id.iv_close2, 10);
        sparseIntArray.put(C1965R.id.iv_pair_fail, 11);
        sparseIntArray.put(C1965R.id.tv_count_down, 12);
    }
