...
public final class ViewLeftIntelligentModeSetBinding implements ViewBinding {
    ...
    public static ViewLeftIntelligentModeSetBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_left_intelligent_mode_set, viewGroup, false);
        if (z) {
    ...
    public static ViewLeftIntelligentModeSetBinding bind(View view) {
        int i = C1965R.id.cb_directional;
                    ...
                    if (checkBox4 != null) {
                        ...
                        if (constraintLayout != null) {
                            ...
                            if (constraintLayout2 != null) {
                                i = C1965R.id.ll_remote;
                                LinearLayout linearLayout = (LinearLayout) view.findViewById(i);
                                if (linearLayout != null) {
                                    i = C1965R.id.tv_flight;
                                    TextView textView = (TextView) view.findViewById(i);
                                    if (textView != null) {
                                        i = C1965R.id.tv_follow_me;
                                        TextView textView2 = (TextView) view.findViewById(i);
                                        if (textView2 != null) {
                                            i = C1965R.id.tv_hot_circle;
                                            TextView textView3 = (TextView) view.findViewById(i);
                                            if (textView3 != null) {
                                                i = C1965R.id.tv_mode;
                                                TextView textView4 = (TextView) view.findViewById(i);
                                                if (textView4 != null) {
                                                    i = C1965R.id.tv_others;
                                                    TextView textView5 = (TextView) view.findViewById(i);
                                                    if (textView5 != null) {
                                                        i = C1965R.id.tv_waypoint_flight;
