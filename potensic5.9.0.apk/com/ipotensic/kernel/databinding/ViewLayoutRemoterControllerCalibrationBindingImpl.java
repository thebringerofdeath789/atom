...
public class ViewLayoutRemoterControllerCalibrationBindingImpl extends ViewLayoutRemoterControllerCalibrationBinding {
    ...
    static {
        ...
        sparseIntArray.put(C1965R.id.layout_cal_step1, 2);
        sparseIntArray.put(C1965R.id.tv_title, 3);
        sparseIntArray.put(C1965R.id.img_icon, 4);
        sparseIntArray.put(C1965R.id.btn_start_cal, 5);
        sparseIntArray.put(C1965R.id.layout_cal_step2, 6);
        sparseIntArray.put(C1965R.id.tv_title1, 7);
        sparseIntArray.put(C1965R.id.tv_rocker_tips, 8);
        sparseIntArray.put(C1965R.id.cal_rocker_view_left, 9);
        sparseIntArray.put(C1965R.id.cal_rocker_view_right, 10);
        sparseIntArray.put(C1965R.id.tv_wheel_tips, 11);
        sparseIntArray.put(C1965R.id.img_wheel_segment, 12);
        sparseIntArray.put(C1965R.id.layout_wheel, 13);
        sparseIntArray.put(C1965R.id.img_left_wheel, 14);
        sparseIntArray.put(C1965R.id.img_right_wheel, 15);
        sparseIntArray.put(C1965R.id.cl_calibration_result, 16);
        sparseIntArray.put(C1965R.id.tv_result_title, 17);
        sparseIntArray.put(C1965R.id.tv_count_down, 18);
        sparseIntArray.put(C1965R.id.iv_close, 19);
    }
    ...
    public boolean setVariable(int i, Object obj) {
        if (C1964BR.remoterControllerModel != i) {
            return false;
        }
    ...
    public void setRemoterControllerModel(SettingRemoterCalibrationModel settingRemoterCalibrationModel) {
        ...
        notifyPropertyChanged(C1964BR.remoterControllerModel);
        super.requestRebind();
    }
