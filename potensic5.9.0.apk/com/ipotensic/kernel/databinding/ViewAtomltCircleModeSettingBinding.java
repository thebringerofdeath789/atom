...
public final class ViewAtomltCircleModeSettingBinding implements ViewBinding {
    ...
    public static ViewAtomltCircleModeSettingBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_atomlt_circle_mode_setting, viewGroup, false);
        if (z) {
                                ...
                                if (textView != null) {
                                    ...
                                    if (textView2 != null) {
                                        ...
                                        if (linearLayout != null) {
                                            ...
                                            i = C1965R.id.layout_circle_direction;
                                            LinearLayout linearLayout2 = (LinearLayout) view.findViewById(i);
                                            if (linearLayout2 != null) {
                                                i = C1965R.id.layout_surround_speed_setting;
                                                LinearLayout linearLayout3 = (LinearLayout) view.findViewById(i);
                                                if (linearLayout3 != null) {
                                                    i = C1965R.id.start_circle_flight;
                                                    Button button = (Button) view.findViewById(i);
                                                    if (button != null) {
                                                        i = C1965R.id.tvCircleFlightSetting;
