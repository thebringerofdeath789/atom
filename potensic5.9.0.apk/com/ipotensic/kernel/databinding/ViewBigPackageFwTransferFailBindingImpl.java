...
public class ViewBigPackageFwTransferFailBindingImpl extends ViewBigPackageFwTransferFailBinding {
    ...
    static {
        ...
        sparseIntArray.put(C1965R.id.tv_upgrade_fail_title, 1);
        sparseIntArray.put(C1965R.id.tv_upgrade_fail_faqs, 2);
        sparseIntArray.put(C1965R.id.btn_upgrade_fail_close, 3);
        sparseIntArray.put(C1965R.id.layout_fw_transfer_retry, 4);
        sparseIntArray.put(C1965R.id.tv_upgrade_fail_content, 5);
        sparseIntArray.put(C1965R.id.tv_error_code, 6);
        sparseIntArray.put(C1965R.id.btn_transfer_exit, 7);
        sparseIntArray.put(C1965R.id.btn_upgrade_retry, 8);
        sparseIntArray.put(C1965R.id.btn_upgrade_exit, 9);
    }
