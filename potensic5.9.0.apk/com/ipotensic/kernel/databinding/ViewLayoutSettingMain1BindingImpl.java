...
public class ViewLayoutSettingMain1BindingImpl extends ViewLayoutSettingMain1Binding {
    ...
    static {
        ...
        sparseIntArray.put(C1965R.id.tv_setting_title, 2);
        sparseIntArray.put(C1965R.id.layout_setting, 3);
        sparseIntArray.put(C1965R.id.rg_setting, 4);
        sparseIntArray.put(C1965R.id.tv_calibration, 5);
        sparseIntArray.put(C1965R.id.tv_control, 6);
        sparseIntArray.put(C1965R.id.tv_camera, 7);
        sparseIntArray.put(C1965R.id.tv_image_trans, 8);
        sparseIntArray.put(C1965R.id.tv_about, 9);
        sparseIntArray.put(C1965R.id.fl_content, 10);
    }
    ...
    public void setSettingMainModel(SettingMainModel settingMainModel) {
        ...
        notifyPropertyChanged(C1964BR.settingMainModel);
        super.requestRebind();
    }
