...
public class ViewLayoutRightVisionControllerBindingImpl extends ViewLayoutRightVisionControllerBinding {
    ...
    static {
        ...
        sparseIntArray.put(C1965R.id.guide_right, 32);
        sparseIntArray.put(C1965R.id.iv_timed_capture_photo, 33);
        sparseIntArray.put(C1965R.id.ll_timed_info, 34);
        sparseIntArray.put(C1965R.id.tv_camera_time, 35);
        sparseIntArray.put(C1965R.id.tv_photo_count, 36);
        sparseIntArray.put(C1965R.id.tv_zoom_scale, 37);
        sparseIntArray.put(C1965R.id.tv_timer_scale, 38);
        sparseIntArray.put(C1965R.id.zoom_control_view, 39);
        sparseIntArray.put(C1965R.id.timer_control_view, 40);
        sparseIntArray.put(C1965R.id.tv_count_down, 41);
    }
    ...
    public void setModel(RightControllerModel rightControllerModel) {
        ...
        notifyPropertyChanged(C1964BR.model);
        super.requestRebind();
    }
