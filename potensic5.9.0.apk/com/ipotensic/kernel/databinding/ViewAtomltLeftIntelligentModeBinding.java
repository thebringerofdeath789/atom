...
public final class ViewAtomltLeftIntelligentModeBinding implements ViewBinding {
    ...
    public static ViewAtomltLeftIntelligentModeBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_atomlt_left_intelligent_mode, viewGroup, false);
        if (z) {
    ...
    public static ViewAtomltLeftIntelligentModeBinding bind(View view) {
        View findViewById;
        View findViewById2;
        int i = C1965R.id.atomLT_intelligent_mode;
        ConstraintLayout constraintLayout = (ConstraintLayout) view.findViewById(i);
        if (constraintLayout != null && (findViewById = view.findViewById((i = C1965R.id.atomLT_intelligent_mode_right))) != null) {
            ViewAtomltCircleModeSettingBinding bind = ViewAtomltCircleModeSettingBinding.bind(findViewById);
            i = C1965R.id.atomLT_intelligent_view_bg;
            View findViewById3 = view.findViewById(i);
            if (findViewById3 != null && (findViewById2 = view.findViewById((i = C1965R.id.atomLT_intelligent_view_blank))) != null) {
                i = C1965R.id.atomLT_intelligent_view_mode;
                ConstraintLayout constraintLayout2 = (ConstraintLayout) view.findViewById(i);
                if (constraintLayout2 != null) {
                    i = C1965R.id.atomLT_tv_follow_me;
                    TextView textView = (TextView) view.findViewById(i);
                    if (textView != null) {
                        i = C1965R.id.atomLT_tv_hot_circle;
                        TextView textView2 = (TextView) view.findViewById(i);
                        if (textView2 != null) {
                            i = C1965R.id.atomLT_tv_waypoint_flight;
