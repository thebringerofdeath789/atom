...
public final class ViewGuideFormatOneBinding implements ViewBinding {
    ...
    public static ViewGuideFormatOneBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_guide_format_one, viewGroup, false);
        if (z) {
    ...
    public static ViewGuideFormatOneBinding bind(View view) {
        View findViewById;
        int i = C1965R.id.iv_camera_set;
        ImageView imageView = (ImageView) view.findViewById(i);
        if (imageView != null) {
            i = C1965R.id.iv_guide_cycle;
            ImageView imageView2 = (ImageView) view.findViewById(i);
            if (imageView2 != null) {
                i = C1965R.id.iv_outer_circle;
                ImageView imageView3 = (ImageView) view.findViewById(i);
                if (imageView3 != null) {
                    i = C1965R.id.iv_rect_gallery;
                    ImageView imageView4 = (ImageView) view.findViewById(i);
                    if (imageView4 != null && (findViewById = view.findViewById((i = C1965R.id.view_camera_set))) != null) {
