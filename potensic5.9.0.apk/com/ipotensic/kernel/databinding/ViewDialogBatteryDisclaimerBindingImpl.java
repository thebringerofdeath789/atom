...
public class ViewDialogBatteryDisclaimerBindingImpl extends ViewDialogBatteryDisclaimerBinding {
    ...
    static {
        ...
        sparseIntArray.put(C1965R.id.tv_code_title, 1);
        sparseIntArray.put(C1965R.id.tv_detail, 2);
        sparseIntArray.put(C1965R.id.layout_bottom, 3);
        sparseIntArray.put(C1965R.id.btn_confirm, 4);
    }
