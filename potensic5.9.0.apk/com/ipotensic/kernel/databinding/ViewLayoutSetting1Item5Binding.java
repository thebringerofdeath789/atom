...
public final class ViewLayoutSetting1Item5Binding implements ViewBinding {
    ...
    public static ViewLayoutSetting1Item5Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_layout_setting1_item5, viewGroup, false);
        if (z) {
    ...
    public static ViewLayoutSetting1Item5Binding bind(View view) {
        int i = C1965R.id.layout_speed_setting;
        RelativeLayout relativeLayout = (RelativeLayout) view.findViewById(i);
        if (relativeLayout != null) {
            i = C1965R.id.tv_gear_setting;
            TextView textView = (TextView) view.findViewById(i);
            if (textView != null) {
                i = C1965R.id.tv_gently_mode;
                TextView textView2 = (TextView) view.findViewById(i);
                if (textView2 != null) {
                    i = C1965R.id.tv_normal_mode;
                    TextView textView3 = (TextView) view.findViewById(i);
                    if (textView3 != null) {
                        i = C1965R.id.tv_sport_mode;
