...
public final class ViewLayoutSetting3Binding implements ViewBinding {
    ...
    public static ViewLayoutSetting3Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_layout_setting_3, viewGroup, false);
        if (z) {
    ...
    public static ViewLayoutSetting3Binding bind(View view) {
        ...
        if (imageView != null) {
            ...
            if (imageView2 != null) {
                ...
                if (imageView3 != null) {
                    i = C1965R.id.ll_data_change;
                    LinearLayout linearLayout = (LinearLayout) view.findViewById(i);
                    if (linearLayout != null) {
                        i = C1965R.id.tv_backward;
                        ...
                        if (textView != null) {
                            ...
                            if (textView2 != null) {
                                ...
                                if (textView3 != null) {
                                    ...
                                    if (textView4 != null) {
                                        i = C1965R.id.tv_forward;
                                        TextView textView5 = (TextView) view.findViewById(i);
                                        if (textView5 != null) {
                                            i = C1965R.id.tv_left;
                                            TextView textView6 = (TextView) view.findViewById(i);
                                            if (textView6 != null) {
                                                i = C1965R.id.tv_left_side;
                                                TextView textView7 = (TextView) view.findViewById(i);
                                                if (textView7 != null) {
                                                    i = C1965R.id.tv_left_stick;
                                                    TextView textView8 = (TextView) view.findViewById(i);
                                                    if (textView8 != null) {
                                                        i = C1965R.id.tv_mode_1;
                                                        TextView textView9 = (TextView) view.findViewById(i);
                                                        if (textView9 != null) {
                                                            i = C1965R.id.tv_mode_2;
                                                            TextView textView10 = (TextView) view.findViewById(i);
                                                            if (textView10 != null) {
                                                                i = C1965R.id.tv_remote_right_stick;
                                                                TextView textView11 = (TextView) view.findViewById(i);
                                                                if (textView11 != null) {
                                                                    i = C1965R.id.tv_right;
                                                                    TextView textView12 = (TextView) view.findViewById(i);
                                                                    if (textView12 != null) {
                                                                        i = C1965R.id.tv_right_side;
