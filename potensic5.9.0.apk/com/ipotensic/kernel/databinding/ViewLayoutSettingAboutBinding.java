...
public abstract class ViewLayoutSettingAboutBinding extends ViewDataBinding {
    ...
    public final LinearLayout layoutUomRegistration;
    ...
    protected ViewLayoutSettingAboutBinding(Object obj, View view, int i, ConstraintLayout constraintLayout, ConstraintLayout constraintLayout2, LinearLayout linearLayout, LinearLayout linearLayout2, LinearLayout linearLayout3, LinearLayout linearLayout4, LinearLayout linearLayout5, LinearLayout linearLayout6, LinearLayout linearLayout7, LinearLayout linearLayout8, LinearLayout linearLayout9, LinearLayout linearLayout10, RelativeLayout relativeLayout, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3, TextView textView, TextView textView2, TextView textView3, CommonTitleView commonTitleView) {
        ...
        this.layoutUomRegistration = linearLayout;
        this.layoutVersion = linearLayout2;
        this.llBatteryVersion = linearLayout3;
        this.llCameraVersion = linearLayout4;
        this.llDroneSn = linearLayout5;
        this.llEscVersion = linearLayout6;
        this.llFlightVersion = linearLayout7;
        this.llFpvVersion = linearLayout8;
        this.llGimbalVersion = linearLayout9;
        this.llRemoteVersion = linearLayout10;
    ...
    public static ViewLayoutSettingAboutBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z, Object obj) {
        return (ViewLayoutSettingAboutBinding) ViewDataBinding.inflateInternal(layoutInflater, C1965R.layout.view_layout_setting_about, viewGroup, z, obj);
    }
    ...
    public static ViewLayoutSettingAboutBinding inflate(LayoutInflater layoutInflater, Object obj) {
        return (ViewLayoutSettingAboutBinding) ViewDataBinding.inflateInternal(layoutInflater, C1965R.layout.view_layout_setting_about, null, false, obj);
    }
    ...
    public static ViewLayoutSettingAboutBinding bind(View view, Object obj) {
        return (ViewLayoutSettingAboutBinding) bind(obj, view, C1965R.layout.view_layout_setting_about);
    }
}