...
public final class ViewMapPositionBinding implements ViewBinding {
    ...
    public static ViewMapPositionBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_map_position, viewGroup, false);
        if (z) {
    ...
    public static ViewMapPositionBinding bind(View view) {
        int i = C1965R.id.iv_fly_home_position;
        ImageButton imageButton = (ImageButton) view.findViewById(i);
        if (imageButton != null) {
            i = C1965R.id.iv_fly_position;
            ImageButton imageButton2 = (ImageButton) view.findViewById(i);
            if (imageButton2 != null) {
                i = C1965R.id.iv_map_pos_bg;
                ImageView imageView = (ImageView) view.findViewById(i);
                if (imageView != null) {
                    i = C1965R.id.iv_my_position;
