...
public class ViewLayoutSettingMainBindingImpl extends ViewLayoutSettingMainBinding {
    ...
    static {
        ...
        sparseIntArray.put(C1965R.id.tv_setting_title, 1);
        sparseIntArray.put(C1965R.id.layout_setting, 2);
        sparseIntArray.put(C1965R.id.rg_setting, 3);
        sparseIntArray.put(C1965R.id.tv_security, 4);
