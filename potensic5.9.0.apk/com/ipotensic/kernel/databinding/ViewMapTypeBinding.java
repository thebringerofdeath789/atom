...
public final class ViewMapTypeBinding implements ViewBinding {
    ...
    public static ViewMapTypeBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_map_type, viewGroup, false);
        if (z) {
    ...
    public static ViewMapTypeBinding bind(View view) {
        int i = C1965R.id.iv_map_night;
        ImageButton imageButton = (ImageButton) view.findViewById(i);
        if (imageButton != null) {
            i = C1965R.id.iv_map_satellite;
            ImageButton imageButton2 = (ImageButton) view.findViewById(i);
            if (imageButton2 != null) {
                i = C1965R.id.iv_map_standard;
                ImageButton imageButton3 = (ImageButton) view.findViewById(i);
                if (imageButton3 != null) {
                    i = C1965R.id.iv_map_type_bg;
                    ImageView imageView = (ImageView) view.findViewById(i);
                    if (imageView != null) {
                        i = C1965R.id.tv_map_night;
                        TextView textView = (TextView) view.findViewById(i);
                        if (textView != null) {
                            i = C1965R.id.tv_map_satellite;
                            TextView textView2 = (TextView) view.findViewById(i);
                            if (textView2 != null) {
                                i = C1965R.id.tv_map_standard;
