...
public final class ViewDialogUnableUpgradeTipNewBinding implements ViewBinding {
    ...
    public static ViewDialogUnableUpgradeTipNewBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_dialog_unable_upgrade_tip_new, viewGroup, false);
        if (z) {
        ...
        if (button != null) {
            ...
            if (imageView != null) {
                ...
                if (imageView2 != null) {
                    ...
                    if (imageView3 != null) {
                        i = C1965R.id.line_plane;
                        TextView textView = (TextView) view.findViewById(i);
                        if (textView != null) {
                            i = C1965R.id.line_remote;
                            ...
                            if (textView2 != null) {
                                ...
                                if (textView3 != null) {
                                    ...
                                    if (textView4 != null) {
                                        i = C1965R.id.tv_plane_battery_low;
                                        TextView textView5 = (TextView) view.findViewById(i);
                                        if (textView5 != null) {
                                            i = C1965R.id.tv_remote_battery_low;
                                            TextView textView6 = (TextView) view.findViewById(i);
                                            if (textView6 != null) {
                                                i = C1965R.id.tv_sd_state;
                                                TextView textView7 = (TextView) view.findViewById(i);
                                                if (textView7 != null) {
                                                    i = C1965R.id.tv_upgrade_firmware;
