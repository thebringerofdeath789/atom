...
public class ActivityBigPackageBindingImpl extends ActivityBigPackageBinding {
    ...
    static {
        ...
        includedLayouts.setIncludes(0, new String[]{"view_big_package_fw_transfer_fail", "view_big_package_upgrade_finished"}, new int[]{1, 2}, new int[]{C1965R.layout.view_big_package_fw_transfer_fail, C1965R.layout.view_big_package_upgrade_finished});
        SparseIntArray sparseIntArray = new SparseIntArray();
        sViewsWithIds = sparseIntArray;
        sparseIntArray.put(C1965R.id.tv_title, 3);
        sparseIntArray.put(C1965R.id.btn_close, 4);
        sparseIntArray.put(C1965R.id.view_big_package_download_upgrade, 5);
        sparseIntArray.put(C1965R.id.layout_upgrade_state, 6);
        sparseIntArray.put(C1965R.id.iv_firmware_state, 7);
        sparseIntArray.put(C1965R.id.tv_firmware_state, 8);
        sparseIntArray.put(C1965R.id.scroll_view_download_tips, 9);
        sparseIntArray.put(C1965R.id.tv_download_tips, 10);
        sparseIntArray.put(C1965R.id.layout_upgrade_considerations, 11);
        sparseIntArray.put(C1965R.id.tv_download_considerations_content, 12);
        sparseIntArray.put(C1965R.id.layout_not_conditions, 13);
        sparseIntArray.put(C1965R.id.cl_connected_state, 14);
        sparseIntArray.put(C1965R.id.tv_connected_state, 15);
        sparseIntArray.put(C1965R.id.line_connected, 16);
        sparseIntArray.put(C1965R.id.iv_connected, 17);
        sparseIntArray.put(C1965R.id.cl_remote_battery_low, 18);
        sparseIntArray.put(C1965R.id.tv_remote_battery_low, 19);
        sparseIntArray.put(C1965R.id.line_remote, 20);
        sparseIntArray.put(C1965R.id.iv_remote, 21);
        sparseIntArray.put(C1965R.id.cl_plane_battery_low, 22);
        sparseIntArray.put(C1965R.id.tv_plane_battery_low, 23);
        sparseIntArray.put(C1965R.id.line_plane, 24);
        sparseIntArray.put(C1965R.id.iv_plane, 25);
        sparseIntArray.put(C1965R.id.cl_plane_unlock, 26);
        sparseIntArray.put(C1965R.id.tv_plane_unlock, 27);
        sparseIntArray.put(C1965R.id.line_unlock, 28);
        sparseIntArray.put(C1965R.id.iv_unlock, 29);
        sparseIntArray.put(C1965R.id.cl_plane_high_temp, 30);
        sparseIntArray.put(C1965R.id.tv_plane_high_temp, 31);
        sparseIntArray.put(C1965R.id.line_high_temp, 32);
        sparseIntArray.put(C1965R.id.iv_high_temp, 33);
        sparseIntArray.put(C1965R.id.cl_sd_state, 34);
        sparseIntArray.put(C1965R.id.tv_sd_state, 35);
        sparseIntArray.put(C1965R.id.line_sd, 36);
        sparseIntArray.put(C1965R.id.iv_sd, 37);
        sparseIntArray.put(C1965R.id.tv_format_sd, 38);
        sparseIntArray.put(C1965R.id.tv_count_down, 39);
        sparseIntArray.put(C1965R.id.scroll_view_check_condition, 40);
        sparseIntArray.put(C1965R.id.tv_firmware_name, 41);
        sparseIntArray.put(C1965R.id.tv_firmware_version, 42);
        sparseIntArray.put(C1965R.id.view_single_firmware_progress, 43);
        sparseIntArray.put(C1965R.id.tv_single_fw_upgrade_progress, 44);
        sparseIntArray.put(C1965R.id.tv_upgrade_detail, 45);
        sparseIntArray.put(C1965R.id.scroll_view_upgrade_tips, 46);
        sparseIntArray.put(C1965R.id.tv_upgrade_considerations_content, 47);
        sparseIntArray.put(C1965R.id.layout_not_network, 48);
        sparseIntArray.put(C1965R.id.view_big_package_module_detection, 49);
        sparseIntArray.put(C1965R.id.tv_current_detection_module, 50);
        sparseIntArray.put(C1965R.id.fragment_upgrade_question, 51);
    }
    ...
    public boolean setVariable(int i, Object obj) {
        if (C1964BR.bigPackageViewModel != i) {
            return false;
        }
