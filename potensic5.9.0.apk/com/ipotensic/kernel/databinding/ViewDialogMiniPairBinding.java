...
public final class ViewDialogMiniPairBinding implements ViewBinding {
    ...
    public static ViewDialogMiniPairBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.view_dialog_mini_pair, viewGroup, false);
        if (z) {
    ...
    public static ViewDialogMiniPairBinding bind(View view) {
        int i = C1965R.id.btn_bottom;
        RelativeLayout relativeLayout = (RelativeLayout) view.findViewById(i);
        if (relativeLayout != null) {
            ConstraintLayout constraintLayout = (ConstraintLayout) view;
            i = C1965R.id.iv_code_close;
            ImageView imageView = (ImageView) view.findViewById(i);
            if (imageView != null) {
                i = C1965R.id.iv_mini_code_gif;
                ImageView imageView2 = (ImageView) view.findViewById(i);
                if (imageView2 != null) {
                    i = C1965R.id.tv_code_step;
                    TextView textView = (TextView) view.findViewById(i);
                    if (textView != null) {
                        i = C1965R.id.tv_code_step_two;
