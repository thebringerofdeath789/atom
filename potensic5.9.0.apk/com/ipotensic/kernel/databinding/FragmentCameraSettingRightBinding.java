...
public final class FragmentCameraSettingRightBinding implements ViewBinding {
    ...
    public static FragmentCameraSettingRightBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1965R.layout.fragment_camera_setting_right, viewGroup, false);
        if (z) {
    ...
    public static FragmentCameraSettingRightBinding bind(View view) {
        ...
        View findViewById3;
        View findViewById4;
        int i = C1965R.id.iv_split_line_ev_manual;
        ImageView imageView = (ImageView) view.findViewById(i);
        if (imageView != null) {
            i = C1965R.id.iv_split_line_iso;
            ImageView imageView2 = (ImageView) view.findViewById(i);
            if (imageView2 != null) {
                i = C1965R.id.iv_split_line_ss;
                ImageView imageView3 = (ImageView) view.findViewById(i);
                if (imageView3 != null) {
                    i = C1965R.id.iv_split_line_white_balance;
                    ImageView imageView4 = (ImageView) view.findViewById(i);
                    if (imageView4 != null) {
                        i = C1965R.id.ll_wv_et_item_wrapper;
                        LinearLayout linearLayout = (LinearLayout) view.findViewById(i);
                        if (linearLayout != null) {
                            i = C1965R.id.ll_wv_ss_item_wrapper;
                            LinearLayout linearLayout2 = (LinearLayout) view.findViewById(i);
                            if (linearLayout2 != null) {
                                i = C1965R.id.sb_white_balance;
                                SeekBar seekBar = (SeekBar) view.findViewById(i);
                                if (seekBar != null) {
                                    i = C1965R.id.sv_ev_value;
                                    ScaleView scaleView = (ScaleView) view.findViewById(i);
                                    if (scaleView != null) {
                                        i = C1965R.id.tv_auto_white_balance;
                                        TextView textView = (TextView) view.findViewById(i);
                                        if (textView != null) {
                                            i = C1965R.id.tv_color_temperature;
                                            ...
                                            if (textView2 != null) {
                                                ...
                                                if (textView3 != null) {
                                                    ...
                                                    if (textView4 != null) {
                                                        ...
                                                        if (textView5 != null) {
                                                            i = C1965R.id.tv_white_balance;
                                                            TextView textView6 = (TextView) view.findViewById(i);
                                                            if (textView6 != null && (findViewById = view.findViewById((i = C1965R.id.view_camera_set_split))) != null && (findViewById2 = view.findViewById((i = C1965R.id.view_camera_set_split_ev))) != null && (findViewById3 = view.findViewById((i = C1965R.id.view_camera_set_split_iso))) != null && (findViewById4 = view.findViewById((i = C1965R.id.view_camera_set_split_ss))) != null) {
                                                                i = C1965R.id.wv_iso_item;
                                                                HorizontalWheelView horizontalWheelView = (HorizontalWheelView) view.findViewById(i);
                                                                if (horizontalWheelView != null) {
                                                                    i = C1965R.id.wv_ss_item;
