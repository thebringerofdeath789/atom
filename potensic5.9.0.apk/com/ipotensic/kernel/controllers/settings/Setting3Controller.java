...
public class Setting3Controller extends BaseController implements View.OnClickListener {
    ...
    public void initView(View view) {
        ...
        this.tvMode1 = (TextView) view.findViewById(C1965R.id.tv_mode_1);
        this.tvMode2 = (TextView) view.findViewById(C1965R.id.tv_mode_2);
        this.tvFlightTips = (TextView) view.findViewById(C1965R.id.tv_flight_tips);
        this.ivLeft = (ImageView) view.findViewById(C1965R.id.iv_left);
        this.ivRight = (ImageView) view.findViewById(C1965R.id.iv_right);
        this.tvUp = (TextView) view.findViewById(C1965R.id.tv_up);
        this.tvDown = (TextView) view.findViewById(C1965R.id.tv_down);
        this.tvLeft = (TextView) view.findViewById(C1965R.id.tv_left);
        this.tvRight = (TextView) view.findViewById(C1965R.id.tv_right);
        this.tvForward = (TextView) view.findViewById(C1965R.id.tv_forward);
        this.tvBackward = (TextView) view.findViewById(C1965R.id.tv_backward);
        this.tvLeftSide = (TextView) view.findViewById(C1965R.id.tv_left_side);
        this.tvRightSide = (TextView) view.findViewById(C1965R.id.tv_right_side);
        this.layoutMiniRepair = (ConstraintLayout) view.findViewById(C1965R.id.layout_mini_repair);
        this.layoutRemoterSetting = (LinearLayout) view.findViewById(C1965R.id.layout_remoter_setting);
        this.layoutMiniRemoterCalibration = (ConstraintLayout) view.findViewById(C1965R.id.layout_remoter_calibration);
        this.tvNoAccessRepair = (TextView) view.findViewById(C1965R.id.tv_no_access_repairing);
        this.tvNoAccessRemoterCalibration = (TextView) view.findViewById(C1965R.id.tv_remoter_calibration_tips);
        this.ivArrowOne = (ImageView) view.findViewById(C1965R.id.iv_arrow_one);
        this.ivArrowTwo = (ImageView) view.findViewById(C1965R.id.iv_arrow_two);
        this.tvRepairingAircraft = (TextView) view.findViewById(C1965R.id.tv_repairing_aircraft);
        this.tvRemoterCalibration = (TextView) view.findViewById(C1965R.id.tv_remoter_calibration);
        setMiniPairVisible();
        initListener();
    }
        ...
        if (!FlightConfig.isOldProduct()) {
            ...
            if (flightRevConnectData.isRemoterConnected()) {
                ...
                if (FlightRevData.get().getFlightRevStateData().isUnLock()) {
                    ...
                    this.tvRemoterCalibration.setTextColor(getContext().getResources().getColor(C1965R.color.color_gray));
                    this.ivArrowTwo.setImageResource(C1965R.mipmap.icon_next_disable);
                } else {
                    this.layoutMiniRemoterCalibration.setClickable(true);
                    this.layoutMiniRemoterCalibration.setEnabled(true);
                    this.tvRemoterCalibration.setTextColor(getContext().getResources().getColor(C1965R.color.white));
                    this.ivArrowTwo.setImageResource(C1965R.mipmap.img_btn_function_open);
                }
                if (FlightConfig.isConnectFlight()) {
                    this.layoutMiniRepair.setClickable(false);
                    this.layoutMiniRepair.setEnabled(false);
                    this.tvRepairingAircraft.setTextColor(getContext().getResources().getColor(C1965R.color.color_gray));
                    this.ivArrowOne.setImageResource(C1965R.mipmap.icon_next_disable);
                    return;
                }
                this.layoutMiniRepair.setClickable(true);
                this.layoutMiniRepair.setEnabled(true);
                this.tvRepairingAircraft.setTextColor(getContext().getResources().getColor(C1965R.color.white));
                this.ivArrowOne.setImageResource(C1965R.mipmap.img_btn_function_open);
                return;
            }
            this.layoutMiniRemoterCalibration.setClickable(false);
            this.layoutMiniRemoterCalibration.setEnabled(false);
    ...
    public void updateData() {
        ...
        if (FlightRevData.get().getFlightRevSettingData().isAmericaRockerMode()) {
            this.ivLeft.setImageResource(C1965R.mipmap.icon_virtual_rocker_model1_left);
            this.ivRight.setImageResource(C1965R.mipmap.icon_virtual_rocker_model1_right);
            this.tvMode1.setBackgroundResource(C1965R.drawable.bg_setting_button_select_left);
            this.tvMode2.setBackgroundResource(C1965R.drawable.bg_setting_model_default_right);
            this.tvUp.setText(this.context.getString(C1965R.string.remote_up));
            this.tvDown.setText(this.context.getString(C1965R.string.remote_down));
            this.tvForward.setText(this.context.getString(C1965R.string.remote_forward));
            this.tvBackward.setText(this.context.getString(C1965R.string.remote_backward));
            return;
        }
        this.ivLeft.setImageResource(C1965R.mipmap.icon_virtual_rocker_model2_left);
        this.ivRight.setImageResource(C1965R.mipmap.icon_virtual_rocker_model2_right);
        this.tvMode1.setBackgroundResource(C1965R.drawable.bg_setting_model_default_left);
        this.tvMode2.setBackgroundResource(C1965R.drawable.bg_setting_button_select_right);
        this.tvUp.setText(this.context.getString(C1965R.string.remote_forward));
        this.tvDown.setText(this.context.getString(C1965R.string.remote_backward));
        this.tvForward.setText(this.context.getString(C1965R.string.remote_up));
        this.tvBackward.setText(this.context.getString(C1965R.string.remote_down));
    }
    ...
    public void onClick(View view) {
        int id = view.getId();
        if (id == C1965R.id.tv_mode_2 || id == C1965R.id.iv_right) {
            this.ivLeft.setImageResource(C1965R.mipmap.icon_virtual_rocker_model2_left);
            this.ivRight.setImageResource(C1965R.mipmap.icon_virtual_rocker_model2_right);
            this.tvMode1.setBackgroundResource(C1965R.drawable.bg_setting_model_default_left);
            this.tvMode2.setBackgroundResource(C1965R.drawable.bg_setting_button_select_right);
        ...
        if (id == C1965R.id.tv_mode_1 || id == C1965R.id.iv_left) {
            this.ivLeft.setImageResource(C1965R.mipmap.icon_virtual_rocker_model1_left);
            this.ivRight.setImageResource(C1965R.mipmap.icon_virtual_rocker_model1_right);
            this.tvMode1.setBackgroundResource(C1965R.drawable.bg_setting_button_select_left);
            this.tvMode2.setBackgroundResource(C1965R.drawable.bg_setting_model_default_right);
    ...
    /* renamed from: com.ipotensic.kernel.controllers.settings.Setting3Controller$3 */
    static /* synthetic */ class C22953 {
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        int i = C22953.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()];
        if (i == 1 || i == 2) {
            setMiniPairVisible();
        }
    }
