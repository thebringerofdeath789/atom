...
public class SettingController extends BaseController implements View.OnClickListener {
    ...
    public void initView(View view) {
        this.view = view;
        View findViewById = view.findViewById(C1965R.id.view_left_blank);
        this.viewBlank = findViewById;
        findViewById.setOnClickListener(this);
        this.settingBtn1 = (ImageButton) view.findViewById(C1965R.id.btn_indicator_1);
        this.settingBtn2 = (ImageButton) view.findViewById(C1965R.id.btn_indicator_2);
        this.settingBtn3 = (ImageButton) view.findViewById(C1965R.id.btn_indicator_3);
        this.settingBtn4 = (ImageButton) view.findViewById(C1965R.id.btn_indicator_4);
        this.settingBtn5 = (ImageButton) view.findViewById(C1965R.id.btn_indicator_5);
        this.layoutIndicator = (LinearLayout) view.findViewById(C1965R.id.layout_indicator);
        this.setting1Controller = new Setting1Controller(getContext(), (ViewStub) view.findViewById(C1965R.id.stub_setting_1));
        this.setting2Controller = new Setting2Controller(getContext(), (ViewStub) view.findViewById(C1965R.id.stub_setting_2));
        this.setting3Controller = new Setting3Controller(getContext(), (ViewStub) view.findViewById(C1965R.id.stub_setting_3));
        this.setting4Controller = new Setting4Controller(getContext(), (ViewStub) view.findViewById(C1965R.id.stub_setting_4));
        this.setting5Controller = new Setting5Controller(getContext(), (ViewStub) view.findViewById(C1965R.id.stub_setting_5));
        SettingAdapter controller = new SettingAdapter().setIndicators(C1965R.id.btn_indicator_1, C1965R.id.btn_indicator_2, C1965R.id.btn_indicator_3, C1965R.id.btn_indicator_4, C1965R.id.btn_indicator_5).setController(this.setting1Controller, this.setting2Controller, this.setting3Controller, this.setting4Controller, this.setting5Controller);
    ...
    public void startSettingGuide() {
        ...
        if (SPHelper.getInstance().getMainSetting()) {
            ...
            NewbieGuide.with(getContext()).addGuidePage(GuidePage.newInstance().addHighLight(this.layoutIndicator, new RelativeGuide(C1965R.layout.guide_setting, 3)).setEnterAnimation(AnimationUtil.enterAnimation()).setExitAnimation(AnimationUtil.exitAnimation()).setBackgroundColor(getContext().getResources().getColor(C1965R.color.color_guide_bg))).setOnGuideChangedListener(new OnGuideChangedListener() { // from class: com.ipotensic.kernel.controllers.settings.SettingController.1
    ...
    public void onClick(View view) {
        if (view.getId() == C1965R.id.view_left_blank) {
            if (FlightConfig.isSettingCalibration) {
                ToastUtil.showImageTop(getContext(), getContext().getString(C1965R.string.toast_calibration_close), C1965R.mipmap.icon_gyroscope_galibration);
            } else {
                setVisibility(8);
            }
        }
    ...
    private void transInRight(final View view) {
        Animation loadAnimation = AnimationUtils.loadAnimation(view.getContext(), C1965R.anim.trans_in_right);
    ...
    private void transOutRight(final View view) {
        Animation loadAnimation = AnimationUtils.loadAnimation(view.getContext(), C1965R.anim.trans_out_right);
        loadAnimation.setDuration(350L);
        view.startAnimation(loadAnimation);
    ...
    public class SettingAdapter implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (!FlightConfig.isSettingCalibration) {
                SettingController.this.settingBtn1.setImageResource(id == C1965R.id.btn_indicator_1 ? C1965R.mipmap.icon_bg_setting_controller_selected : C1965R.mipmap.icon_bg_setting_controller);
                SettingController.this.settingBtn2.setImageResource(id == C1965R.id.btn_indicator_2 ? C1965R.mipmap.img_btn_setting_calibration_selected : C1965R.mipmap.img_btn_setting_calibration);
                SettingController.this.settingBtn3.setImageResource(id == C1965R.id.btn_indicator_3 ? C1965R.mipmap.icon_bg_setting_remote_selected : C1965R.mipmap.icon_bg_setting_remote);
                SettingController.this.settingBtn4.setImageResource(id == C1965R.id.btn_indicator_4 ? C1965R.mipmap.icon_bg_setting_battery_selected : C1965R.mipmap.icon_bg_setting_battery);
                SettingController.this.settingBtn5.setImageResource(id == C1965R.id.btn_indicator_5 ? C1965R.mipmap.icon_bg_setting_selected : C1965R.mipmap.icon_bg_setting);
                SettingController.this.settingBtn1.setBackgroundResource(id == C1965R.id.btn_indicator_1 ? C1965R.drawable.bg_setting_main_btn_selected : C1965R.drawable.bg_setting_main_btn_unchecked);
                SettingController.this.settingBtn2.setBackgroundResource(id == C1965R.id.btn_indicator_2 ? C1965R.drawable.bg_setting_main_btn_selected : C1965R.drawable.bg_setting_main_btn_unchecked);
                SettingController.this.settingBtn3.setBackgroundResource(id == C1965R.id.btn_indicator_3 ? C1965R.drawable.bg_setting_main_btn_selected : C1965R.drawable.bg_setting_main_btn_unchecked);
                SettingController.this.settingBtn4.setBackgroundResource(id == C1965R.id.btn_indicator_4 ? C1965R.drawable.bg_setting_main_btn_selected : C1965R.drawable.bg_setting_main_btn_unchecked);
                SettingController.this.settingBtn5.setBackgroundResource(id == C1965R.id.btn_indicator_5 ? C1965R.drawable.bg_setting_main_btn_selected : C1965R.drawable.bg_setting_main_btn_unchecked);
                for (int i = 0; i < this.length; i++) {
            ...
            ToastUtil.showImageTop(SettingController.this.getContext(), SettingController.this.getContext().getString(C1965R.string.toast_calibration_close), C1965R.mipmap.icon_gyroscope_galibration);
        }
    }
