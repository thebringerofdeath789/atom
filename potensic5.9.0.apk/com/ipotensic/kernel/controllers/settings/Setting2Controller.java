...
public class Setting2Controller extends BaseController {
    ...
    public void initView(View view) {
        ...
        view.findViewById(C1965R.id.iv_back).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.controllers.settings.Setting2Controller.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                Setting2Controller.this.onBackClick();
            }
        });
        this.btnStartGeo = (TextView) view.findViewById(C1965R.id.tv_start_geo_btn);
        this.ivHorizontal = (ImageView) view.findViewById(C1965R.id.img_geo_horizontal);
        this.ivVertical = (ImageView) view.findViewById(C1965R.id.img_geo_vertical);
        this.btnStartHexahedral = (TextView) view.findViewById(C1965R.id.tv_start_hexahedral_btn);
        this.tvSixSideCalibrationTitle = (TextView) view.findViewById(C1965R.id.tv_hexahedral_title);
        this.ivSixSideCalibrationBg = (ImageView) view.findViewById(C1965R.id.img_hexahedral_bg);
        ...
        this.oldProductGeoView = (ConstraintLayout) view.findViewById(C1965R.id.view_old_product_geo);
        this.miniProductGeoView = view.findViewById(C1965R.id.view_mini_product_geo);
        this.imgMiniGeoHorizontal = (ImageView) view.findViewById(C1965R.id.img_mini_geo_horizontal);
        this.imgMiniGeoVertical = (ImageView) view.findViewById(C1965R.id.img_mini_geo_vertical);
        this.btnMiniStartGeo = (TextView) view.findViewById(C1965R.id.tv_mini_start_geo_btn);
        this.tvMiniGeoTip = (TextView) view.findViewById(C1965R.id.tv_mini_geo_tip);
        this.tvMiniGeoStepTips = (TextView) view.findViewById(C1965R.id.tv_mini_geo_step_tips);
        this.ivMiniGeoStepTips = (ImageView) view.findViewById(C1965R.id.iv_mini_geo_step_tips);
        TextView textView = (TextView) view.findViewById(C1965R.id.tv_p5_calibration_tips);
        this.tvP5CalibrationTips = textView;
        textView.setText(getContext().getString(C1965R.string.compass_calibration_tips));
        initClickListener();
        setBtnEnable();
        setFlightType();
        ...
        if (PhoneConfig.isFt) {
            context = getContext();
            i = C1965R.string.setting_mini_geo_tip1;
        } else {
            context = getContext();
            i = C1965R.string.setting_mini_geo_tip;
        }
    ...
    private void setFlightType() {
        ...
        if (lastFlight != null) {
            ...
            this.tvP5CalibrationTips.setText(getContext().getString(C1965R.string.compass_calibration_tips));
            if (lastFlight == Flight.Flight_P3SE || lastFlight == Flight.Flight_P3SE_V0) {
                ...
                this.ivSixSideCalibrationBg.setImageResource(C1965R.mipmap.img_p3se_level);
                this.horizontalDrawable = (AnimationDrawable) this.ivHorizontal.getDrawable();
                this.verticalDrawable = (AnimationDrawable) this.ivVertical.getDrawable();
                return;
            }
            if (FlightConfig.is_Atom_Series()) {
                this.imgMiniGeoHorizontal.setImageResource(C1965R.drawable.anim_geo_horizontal_mini);
                this.imgMiniGeoHorizontal.setBackgroundResource(C1965R.mipmap.img_mini_calibration_bg_setting);
                this.horizontalDrawable = (AnimationDrawable) this.imgMiniGeoHorizontal.getDrawable();
                this.imgMiniGeoVertical.setImageResource(C1965R.drawable.anim_geo_vertical_mini);
                this.imgMiniGeoVertical.setBackgroundResource(C1965R.mipmap.img_mini_calibration_bg_setting);
            ...
            if (lastFlight == Flight.Flight_P5) {
                ...
                this.horizontalDrawable = (AnimationDrawable) this.ivHorizontal.getDrawable();
                this.verticalDrawable = (AnimationDrawable) this.ivVertical.getDrawable();
                this.ivSixSideCalibrationBg.setImageResource(C1965R.mipmap.img_p5se_level);
                return;
            }
    ...
    private void initClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ((FlightConfig.isOldProduct() || Setting2Controller.this.isOutDoor()) && FlightConfig.isConnectFlight()) {
                    if (FlightRevData.get().getFlightRevStateData().isGeomagneticFault()) {
                        ToastUtil.toast(Setting2Controller.this.getContext(), Setting2Controller.this.getContext().getString(C1965R.string.error_geo_fault));
                    } else {
                        if (FlightRevData.get().getFlightRevStateData().isUnLock()) {
                            return;
                        }
                        Setting2Controller.this.generalDialog = new GeneralDialog(Setting2Controller.this.context, Setting2Controller.this.context.getString(C1965R.string.sys_calibration_start), Setting2Controller.this.context.getString(C1965R.string.dialog_geo_calibration_tips_one), Setting2Controller.this.context.getString(C1965R.string.dialog_cancel), Setting2Controller.this.context.getString(C1965R.string.dialog_ok), false, 2, new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.kernel.controllers.settings.Setting2Controller.2.2
                            @Override // com.ipotensic.kernel.view.dialog.GeneralDialog.ClickConfirmListener
                            public void confirm() {
        ...
        this.btnMiniStartGeo.setOnClickListener(new C22873(1000, flightRevStateData));
    ...
    /* renamed from: com.ipotensic.kernel.controllers.settings.Setting2Controller$3 */
    class C22873 extends ScaleClickListener {
        final /* synthetic */ FlightRevStateData val$stateData;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C22873(Integer num, FlightRevStateData flightRevStateData) {
            super(num);
        ...
        public void click(View view) {
            ...
            if (!FlightConfig.isOldProduct() && !Setting2Controller.this.isOutDoor()) {
                ToastUtil.toast(Setting2Controller.this.getContext(), Setting2Controller.this.getContext().getString(C1965R.string.f2142xa0c56cf5));
                        ...
                        if (UsbConfig.isUsbConnected) {
                            ...
                            Setting2Controller.this.miniMagCalibrationHelper.setCalibrationResultListener(new OnCalibrationResultListener() { // from class: com.ipotensic.kernel.controllers.settings.Setting2Controller.3.2.1
                                ...
                                public void onVerticalCalibration() {
                                    ...
                                    Setting2Controller.this.ivMiniGeoStepTips.setImageResource(C1965R.mipmap.icon_mini_geo_step_two);
                                    Setting2Controller.this.tvMiniGeoStepTips.setText(Setting2Controller.this.getContext().getResources().getString(C1965R.string.dialog_geo_vertical_tips));
                                }
                                ...
                                public void onResultSuccess(MagCalibrationResult magCalibrationResult) {
                                    ...
                                    ViewUtils.setViewEnableWithAlpha(Setting2Controller.this.btnMiniStartGeo, true);
                                    Setting2Controller.this.resetMiniCalibrationUI();
                                    ToastUtil.showImageTop(Setting2Controller.this.getContext(), Setting2Controller.this.context.getString(C1965R.string.toast_geo_calibration_finish), C1965R.mipmap.icon_toast_successful);
    ...
    public void onBackClick() {
        ...
        if (FlightConfig.isOldProduct()) {
            if (!FlightRevData.get().getFlightRevStateData().isGeomagneticFault() && (FlightRevData.get().getFlightRevStateData().isMagnetometerHorizontalCalibrating() || FlightRevData.get().getFlightRevStateData().isMagnetometerVerticalCalibrating())) {
                ToastUtil.showImageTop(getContext(), this.context.getString(C1965R.string.toast_calibration_close), C1965R.mipmap.icon_gyroscope_galibration);
                return;
            }
            EventDispatcher.get().sendEvent(EventID.EVENT_UI_HIDE_FLIGHT_SETTING);
            this.horizontalDrawable.stop();
        ...
        if (FlightConfig.curFlight == null || !FlightConfig.is_Atom_Series()) {
            if (FlightRevData.get().getFlightRevStateData().isGeomagneticFault()) {
                ...
                if (this.horizontalDrawable.isRunning() || this.verticalDrawable.isRunning()) {
                    ...
                    ToastUtil.toast(getContext(), getContext().getString(C1965R.string.error_geo_fault));
                    return;
                }
                return;
            }
            ...
            if (isMagnetometerHorizontalCalibrating) {
                ...
                if (z2 && isGeoCalibrationFailureFlag) {
                    ...
                    GeneralDialog generalDialog = new GeneralDialog(context, context.getString(C1965R.string.sys_calibration_start), this.context.getString(C1965R.string.toast_geo_calibration_fail), this.context.getString(C1965R.string.dialog_cancel), this.context.getString(C1965R.string.dialog_ok), false, 1, new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.kernel.controllers.settings.Setting2Controller.5
                        @Override // com.ipotensic.kernel.view.dialog.GeneralDialog.ClickConfirmListener
                        public void confirm() {
                            FlightSendData.get().getSend4AxisData().setGeoCalibration();
                        }
            ...
            if (z3 && isGeoCalibrationFailureFlag) {
                ...
                GeneralDialog generalDialog2 = new GeneralDialog(context2, context2.getString(C1965R.string.sys_calibration_start), this.context.getString(C1965R.string.toast_geo_calibration_fail), this.context.getString(C1965R.string.dialog_cancel), this.context.getString(C1965R.string.dialog_ok), false, 1, new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.kernel.controllers.settings.Setting2Controller.6
                    @Override // com.ipotensic.kernel.view.dialog.GeneralDialog.ClickConfirmListener
                    public void confirm() {
                        FlightSendData.get().getSend4AxisData().setGeoCalibration();
                    }
            ...
            if (z3) {
                ...
                this.btnStartGeo.setEnabled(true);
                this.btnStartGeo.setAlpha(1.0f);
                ToastUtil.showImageTop(getContext(), this.context.getString(C1965R.string.toast_geo_calibration_finish), C1965R.mipmap.icon_toast_successful);
                EventDispatcher.get().sendEvent(EventID.AUDIO_CALIBRATION_SUCCESS);
            }
        }
    }
    ...
    public void onCalibrateFail(int i) {
        ...
        Context context = this.context;
        GeneralDialog generalDialog = new GeneralDialog(context, context.getString(C1965R.string.sys_calibration_geomagnetic), string, this.context.getString(C1965R.string.dialog_cancel), this.context.getString(C1965R.string.dialog_ok), false, 1, new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.kernel.controllers.settings.Setting2Controller.7
            @Override // com.ipotensic.kernel.view.dialog.GeneralDialog.ClickConfirmListener
            public void confirm() {
            }
        });
    ...
    public void resetMiniCalibrationUI() {
        ...
        this.ivMiniGeoStepTips.setImageResource(C1965R.mipmap.icon_mini_geo_step_one);
        this.ivMiniGeoStepTips.setVisibility(8);
        this.tvMiniGeoStepTips.setText(getContext().getResources().getString(C1965R.string.dialog_geo_horizontal_tips));
    ...
    /* renamed from: com.ipotensic.kernel.controllers.settings.Setting2Controller$8 */
    static /* synthetic */ class C22928 {
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        boolean z = false;
        switch (C22928.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()]) {
            case 1:
                ...
                if (iMagCalibrationHelper != null && iMagCalibrationHelper.isStart()) {
                    try {
                        ...
                        DDLog.m1684e("校准结果报错:" + e.getMessage());
                        return;
                    }
                }
                break;
            case 2:
                ...
                if (iMagCalibrationHelper2 != null) {
                    ...
                    DDLog.m1684e("校准结果的结果:" + flightRevCalResultData.toString());
                    break;
                }
                break;
            case 3:
