...
public class RightController extends BaseController {
    ...
    public RightController(AppCompatActivity appCompatActivity, View view) {
        ...
        this.visualEffectView = (VisualEffectView) getContext().findViewById(C1965R.id.visual_show_view);
        this.tvSelectTargetTips = (TextView) getContext().findViewById(C1965R.id.tv_select_target_tips);
        ...
        RightControllerModel rightControllerModel = new RightControllerModel(getContext(), new RightControllerModel.OnRightControllerListener() { // from class: com.ipotensic.kernel.controllers.RightController.3
            ...
            public void onSwitchMode(CaptureMode captureMode) {
                if (SPHelper.getInstance().getSwitchStatus()) {
                    ...
                    RightController rightController = RightController.this;
                    rightController.showGuide(rightController.dataBinding.btnSwitchCapture, C1965R.string.guide_right_switch_status);
                } else {
            ...
            public void onCamSettingClick() {
                ...
                RightController rightController = RightController.this;
                rightController.showGuide(rightController.dataBinding.btnCameraSetting, C1965R.string.guide_camera_setting);
            }
            ...
            public void onGalleryClicked() {
                if (!SPHelper.getInstance().getAirborneGallery()) {
                    ...
                    RightController rightController = RightController.this;
                    rightController.showGuide(rightController.dataBinding.btnGallery, C1965R.string.guide_right_gallery);
                }
            }
            ...
            public void showIntelligentGuide() {
                RightController rightController = RightController.this;
                rightController.showGuide(rightController.dataBinding.btnOneKeyVideo, C1965R.string.guide_intelligent_mode);
            }
    ...
    public /* synthetic */ Unit lambda$new$0$RightController(View view) {
        if (SPHelper.getInstance().getBoolean(SPHelper.KEY_ZOOM_SCALE, true)) {
            ...
            showGuide(this.dataBinding.tvZoomScale, C1965R.string.guide_flight_interface_enter_digital_zoom_mode_tips);
            return null;
        }
    ...
    public /* synthetic */ Unit lambda$new$4$RightController(View view) {
        if (SPHelper.getInstance().getBoolean(SPHelper.KEY_TIMED_PHOTOGRAPHY, true)) {
            ...
            showGuide(this.dataBinding.tvTimerScale, C1965R.string.guide_flight_interface_enter_self_timer_mode_tips);
            return null;
        }
    ...
    public /* synthetic */ Unit lambda$new$8$RightController(final Integer num, Integer num2) {
        ...
        this.dataBinding.tvCameraTime.post(new Runnable() { // from class: com.ipotensic.kernel.controllers.-$$Lambda$RightController$UiQP9C0k7IPy9yVxsqPBv4fGtIU
            ...
            public final void run() {
                RightController.this.lambda$new$7$RightController(num);
            }
        });
        return null;
    }
    ...
    public void showGuide(View view, final int i) {
        ...
        }).setBackgroundColor(ContextCompat.getColor(getContext(), C1965R.color.color_guide_bg))).show();
    }

    public /* synthetic */ void lambda$showGuide$10$RightController(int i, View view, Controller controller) {
        ((TextView) view.findViewById(C1965R.id.tv_view)).setText(getContext().getResources().getString(i));
    }

    /* renamed from: com.ipotensic.kernel.controllers.RightController$13 */
    static /* synthetic */ class C216813 {
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        switch (C216813.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()]) {
            case 1:
    ...
    private void updateMaxZoom() {
        ...
        DDLog.m1691w("maxZoom=" + this.maxZoom);
        if (this.maxZoom > 1) {
    ...
    public void onPreviewSizeChanged() {
        if (PhoneConfig.previewSize != null) {
            DDLog.m1684e("一键短片 宽高改变通知:" + PhoneConfig.previewSize.toString());
