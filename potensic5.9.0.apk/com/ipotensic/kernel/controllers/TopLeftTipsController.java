...
public class TopLeftTipsController extends BaseController {
    ...
    public void initView(View view) {
        this.tvTopLeftTip = (TextView) view.findViewById(C1965R.id.tv_top_left_tips);
    }
    ...
    public boolean checkConnect() {
        ...
        this.tvTopLeftTip.setBackgroundResource(C1965R.mipmap.img_top_left_grey);
        this.tvTopLeftTip.setText(getContext().getString(C1965R.string.toast_unconnected_tips));
    ...
    private void showTakeOffTip(boolean z) {
        ...
        if (FlightRevData.get().getFlightRevStateData().getMode() != 2) {
            ...
            this.tvTopLeftTip.setBackgroundResource(z ? C1965R.mipmap.img_top_left_orange : C1965R.mipmap.img_top_left_red);
            TextView textView = this.tvTopLeftTip;
            if (z) {
                context2 = getContext();
                i2 = C1965R.string.toast_gps_mode;
            } else {
                context2 = getContext();
                i2 = C1965R.string.toast_take_off_error_tips;
            }
            textView.setText(context2.getString(i2));
        } else {
            this.tvTopLeftTip.setBackgroundResource(z ? C1965R.mipmap.img_top_left_green : C1965R.mipmap.img_top_left_red);
            TextView textView2 = this.tvTopLeftTip;
            if (z) {
                context = getContext();
                i = C1965R.string.toast_take_off_tips;
            } else {
                context = getContext();
                i = C1965R.string.toast_take_off_error_tips;
            }
    ...
    public void showFlightModeTip(FlightRevStateData flightRevStateData) {
        ...
        if (FlightConfig.isOldProduct()) {
            if (flightRevStateData.isBatteryAbnormal() || flightRevStateData.isGeoCalibration() || flightRevStateData.isFlightIncline() || flightRevStateData.isLastCalOver50km() || flightRevStateData.isGimbalNotReady() || flightRevStateData.isFlightInclineOver35() || flightRevStateData.isFlightInNoFlyZone() || flightRevStateData.isImuPreparing()) {
                this.tvTopLeftTip.setBackgroundResource(C1965R.mipmap.img_top_left_red);
                this.tvTopLeftTip.setText(getContext().getString(C1965R.string.toast_take_off_error_tips));
                if (getBaseView().getVisibility() != 0) {
                    AnimationUtil.transInLeft(getBaseView());
                    return;
                }
            ...
            if (flightRevStateData.isFlight() || flightRevStateData.isTakeOff()) {
                ...
                if (!isNotAllowTakeOff(flightRevStateData) && flightRevStateData.getMode() == 2) {
                    this.tvTopLeftTip.setBackgroundResource(C1965R.mipmap.img_top_left_green);
                    this.tvTopLeftTip.setText(getContext().getString(C1965R.string.toast_take_off_tips));
                    if (getBaseView().getVisibility() != 0) {
                        AnimationUtil.transInLeft(getBaseView());
                        return;
                    }
        ...
        if (!flightRevStateData.isFlight() && !flightRevStateData.isTakeOff()) {
            if (!flightRevStateData.isUnLock() && flightRevStateData.isOutdoor() && flightRevStateData.isGeoTooMuchInterfere()) {
                DDLog.m1684e("提示校准指南针");
                this.tvTopLeftTip.setBackgroundResource(C1965R.mipmap.img_top_left_orange);
                this.tvTopLeftTip.setText(getContext().getString(C1965R.string.need_calibration_compass));
                if (getBaseView().getVisibility() != 0) {
                    AnimationUtil.transInLeft(getBaseView());
                    return;
                }
            ...
            if (mode == 0) {
                if (FlightConfig.isAtomLT() && z2) {
                    this.tvTopLeftTip.setBackgroundResource(C1965R.mipmap.img_top_left_red);
                    this.tvTopLeftTip.setText(getContext().getString(C1965R.string.f2130xc3c93530));
                    if (getBaseView().getVisibility() != 0) {
                        AnimationUtil.transInLeft(getBaseView());
                        return;
                    }
        ...
        if (mode == 0) {
            this.tvTopLeftTip.setBackgroundResource(C1965R.mipmap.img_top_left_red);
            this.tvTopLeftTip.setText(getContext().getString(C1965R.string.toast_atti_mode));
            if (getBaseView().getVisibility() != 0) {
                DDLog.m1684e("空中切姿态");
                AnimationUtil.transInLeft(getBaseView());
                return;
        ...
        if (mode == 1) {
            ...
            this.tvTopLeftTip.setBackgroundResource(C1965R.mipmap.img_top_left_orange);
            this.tvTopLeftTip.setText(getContext().getString(C1965R.string.toast_opti_mode));
            if (getBaseView().getVisibility() != 0) {
                DDLog.m1684e("空中切光流");
                AnimationUtil.transInLeft(getBaseView());
                return;
        ...
        if (mode == 2) {
            try {
                ...
                if (flightRevHomePointData.isInitThisFly() && returnHeight != 0 && distance > 20.0d) {
                    ...
                    String string = getContext().getString(C1965R.string.txt_return_height, new Object[]{str});
                    this.tvTopLeftTip.setBackgroundResource(C1965R.mipmap.img_top_left_green);
                ...
                DDLog.m1684e("显示出错:" + e.getMessage());
            }
        }
    }
    ...
    public void showGpsAccuracyStatus(Activity activity) {
        ...
        ToastUtil.showImageLeft(activity, activity.getString(C1965R.string.toast_phone_gps_weak), activity.getString(C1965R.string.toast_phone_gps_weak_describe), C1965R.mipmap.img_toast_followme_gps_weak);
    }
    ...
    public void showConnectTip(Activity activity) {
        ...
        ToastUtil.showImageLeft(activity, activity.getString(C1965R.string.toast_disconnected), activity.getString(C1965R.string.toast_disconnected_describe), C1965R.mipmap.icon_need_connect_flight);
    }
    ...
    public void showEmergencyStopTip(Activity activity) {
        ...
        if (this.emergencyStopDialog == null) {
            this.emergencyStopDialog = new GeneralDialog((Context) activity, activity.getString(C1965R.string.dialog_emergency_stop), activity.getString(C1965R.string.dialog_emergency_stop_describe), "", "", false, 1, new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.kernel.controllers.TopLeftTipsController.2
    ...
    /* renamed from: com.ipotensic.kernel.controllers.TopLeftTipsController$4 */
    static /* synthetic */ class C22334 {
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        if (C22334.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()] != 1) {
            return;
        }
