...
public class RockController extends BaseController implements RockerTouchView.RockerViewChangeListener {
    ...
    public void initView(View view) {
        this.leftRockerView = (RockerTouchView) view.findViewById(C1965R.id.rocker_view_left);
        this.rightRockerView = (RockerTouchView) view.findViewById(C1965R.id.rocker_view_right);
    ...
    public void setMode(FlightRevSettingData flightRevSettingData) {
        if (flightRevSettingData.isAmericaRockerMode()) {
            this.leftRockerView.setOuterBgBitmap(C1965R.mipmap.icon_mode1_left_rocker);
            this.rightRockerView.setOuterBgBitmap(C1965R.mipmap.icon_mode1_right_rocker);
        } else {
            this.leftRockerView.setOuterBgBitmap(C1965R.mipmap.icon_mode2_left_rocker);
            this.rightRockerView.setOuterBgBitmap(C1965R.mipmap.icon_mode2_right_rocker);
        }
    }
