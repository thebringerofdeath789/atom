...
public class BlurTransController extends BaseController {
    ...
    public BlurTransController(AppCompatActivity appCompatActivity, View view) {
        ...
        this.ivBlurTransBg = (ImageView) view.findViewById(C1965R.id.img_blur_trans_bg);
    }
    ...
    */
    public void onEvent(com.ipotensic.baselib.dispatcher.EventID r3, com.ipotensic.baselib.dispatcher.Event r4) {
        /*
            r2 = this;
            super.onEvent(r3, r4)
            int[] r4 = com.ipotensic.kernel.controllers.BlurTransController.C21013.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID
            int r3 = r3.ordinal()
            r3 = r4[r3]
            r4 = 1
            if (r3 == r4) goto L1f
        ...
        L1f:
            ...
            com.ipotensic.baselib.DDLog.m1684e(r3)
        L24:
    ...
    private void show() {
        try {
            if (this.isShow) {
                ...
                if (yuvData != null) {
                    Bitmap nv21ToBitmap = YuvTransformer.nv21ToBitmap(YuvTransformer.getNv21(yuvData.f2491Y, yuvData.f2489U, yuvData.f2490V, yuvData.width, yuvData.height), yuvData.width, yuvData.height);
