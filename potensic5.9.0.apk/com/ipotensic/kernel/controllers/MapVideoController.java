...
import com.ipotensic.kernel.databinding.ItemMapExplainBinding;
...
import com.ipotensic.kernel.maps.bean.MapExplainBean;
...
public class MapVideoController extends BaseController implements OnLocationChangedListener, AOAEngine.IEngineCallback {
    ...
    private final MutableLiveData isMapFullScreenVisible;
    ...
    private ImageButton noFlyZoneHelpBtn;
    private TextView noFlyZoneHelpQuitBtn;
    private RelativeLayout noFlyZoneHelpView;
    private PreviewController previewController;
    private RecyclerView recyclerView;
    private RvCommonAdapter<MapExplainBean, ItemMapExplainBinding> rvAdapter;
    private RecyclerView rvNoFlyZoneHelp;
    private MapScaleView scaleView;
    private Rect smallBounds;
    private ConstraintLayout.LayoutParams smallLayoutParams;
    private View splashView;
    private Point startOffset;
    private TextView tvTof;
    ...
    public MapVideoController(AppCompatActivity appCompatActivity, View view) {
        ...
        this.isMapFullScreenVisible = mutableLiveData;
        mutableLiveData.observe(appCompatActivity, new Observer<Boolean>() { // from class: com.ipotensic.kernel.controllers.MapVideoController.1
            @Override // androidx.lifecycle.Observer
            public void onChanged(Boolean bool) {
                if (bool.booleanValue()) {
                    MapVideoController.this.mapBtnView.setVisibility(8);
                    MapVideoController.this.scaleView.setVisibility(8);
                    MapVideoController.this.noFlyZoneHelpView.setVisibility(0);
                    MapVideoController.this.noFlyZoneHelpView.bringToFront();
                    MapVideoController.this.videoContainer.setVisibility(8);
                    return;
                }
                MapVideoController.this.mapBtnView.setVisibility(0);
                MapVideoController.this.scaleView.setVisibility(0);
                MapVideoController.this.noFlyZoneHelpView.setVisibility(8);
                ...
                MapVideoController.this.videoContainer.setVisibility(0);
    ...
    public void initView(View view) {
        this.curMode = Mode.MODE_VIDEO;
        this.videoContainer = (RoundRelativeLayout) view.findViewById(C1965R.id.video_container);
        this.crossLineController = (ConstraintLayout) view.findViewById(C1965R.id.rl_cross_line_container);
        this.videoContainer.setCornerRadius(35);
        this.ivScale = (ImageView) view.findViewById(C1965R.id.iv_scale);
        this.layoutScale = (RelativeLayout) view.findViewById(C1965R.id.layout_scale);
        this.twoFingerScaleView = (TwoFingerScaleView) view.findViewById(C1965R.id.two_finger_scale_view);
        this.splashView = view.findViewById(C1965R.id.view_splash);
        this.tvTof = (TextView) view.findViewById(C1965R.id.tvTof);
        this.blurTransController = new BlurTransController(getContext(), view.findViewById(C1965R.id.layout_blur));
        this.locationController = new TestLocationController(getContext(), view);
        this.videoContainer.setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.controllers.MapVideoController.2
        ...
        this.mapBtnView = (ConstraintLayout) view.findViewById(C1965R.id.view_map_control);
        this.noFlyZoneHelpView = (RelativeLayout) view.findViewById(C1965R.id.view_no_fly_zone_help);
        ImageButton imageButton = (ImageButton) this.mapBtnView.findViewById(C1965R.id.iv_no_fly_zone_help);
        this.noFlyZoneHelpBtn = imageButton;
        imageButton.setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.controllers.MapVideoController.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                MapVideoController.this.isMapFullScreenVisible.setValue(true);
                EventDispatcher.get().sendEvent(EventID.EVENT_SHOW_NO_FLY_ZONE_HELP, true);
            }
        });
        TextView textView = (TextView) this.noFlyZoneHelpView.findViewById(C1965R.id.quitMapExplain);
        this.noFlyZoneHelpQuitBtn = textView;
        textView.setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.controllers.MapVideoController.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                MapVideoController.this.isMapFullScreenVisible.setValue(false);
                EventDispatcher.get().sendEvent(EventID.EVENT_SHOW_NO_FLY_ZONE_HELP, false);
            }
        });
        this.rvNoFlyZoneHelp = (RecyclerView) this.noFlyZoneHelpView.findViewById(C1965R.id.rvMapExplain);
        setMapExplainAdapter();
        this.recyclerView = (RecyclerView) view.findViewById(C1965R.id.recycler_view);
        this.scaleView = (MapScaleView) view.findViewById(C1965R.id.scaleView);
        this.flightRecordView = (ConstraintLayout) view.findViewById(C1965R.id.view_flight_record_details);
        JfGLSurfaceView jfGLSurfaceView = (JfGLSurfaceView) view.findViewById(C1965R.id.view_video);
        this.videoView = jfGLSurfaceView;
        jfGLSurfaceView.setYuvFrameReceiver(new JfGLSurfaceView.onYuvFrameReceiver() { // from class: com.ipotensic.kernel.controllers.MapVideoController.5
            ...
            public void receiveYuv() {
                ...
                PhoneConfig.mainHandler.post(new Runnable() { // from class: com.ipotensic.kernel.controllers.MapVideoController.5.1
        ...
        AttitudeBallView attitudeBallView = (AttitudeBallView) view.findViewById(C1965R.id.attitude_view);
        this.attitudeBallView = attitudeBallView;
        attitudeBallView.setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.controllers.MapVideoController.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
        ...
        this.videoBg = (ImageView) view.findViewById(C1965R.id.iv_main_bg);
        addMapView();
        LocationService.getInstance().setOnLocationChangedListener(this);
        DDLog.m1691w("videoBg:" + this.videoBg.getVisibility());
    ...
    private void animToBig(final View view, final Animation.AnimationListener animationListener) {
        try {
            ...
            layoutParams.leftMargin = getContext().getResources().getDimensionPixelSize(C1965R.dimen.kernel_map_left_margin);
            layoutParams.bottomMargin = getContext().getResources().getDimensionPixelSize(C1965R.dimen.kernel_map_bottom_margin);
            layoutParams.bottomToBottom = 0;
            layoutParams.leftToLeft = 0;
            final int i = layoutParams.leftMargin;
            final int i2 = layoutParams.bottomMargin;
            TypedValue typedValue = new TypedValue();
            getContext().getResources().getValue(C1965R.dimen.kernel_map_height_percent, typedValue, true);
            ...
            final int i4 = 1000;
            ofInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.ipotensic.kernel.controllers.MapVideoController.7
    ...
    public void animEnd(Mode mode) {
        ...
        if (SPHelper.getInstance().getFirstEnterMap() && FlightConfig.isConnectFlight() && isMapMode()) {
            GeneralDialog generalDialog = new GeneralDialog(getContext(), 0, new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.kernel.controllers.MapVideoController.8
    ...
    public synchronized void zoomToBigNoAnimation(final Mode mode) {
        ...
        if (mode == Mode.MODE_VIDEO) {
            DDLog.m1691w("切换video 大图模式");
            animToBig(this.videoContainer, new AnimationListenerAdapter() { // from class: com.ipotensic.kernel.controllers.MapVideoController.9
                ...
                public void onAnimationEnd(Animation animation) {
                    DDLog.m1684e("JfRender anim end");
                    PhoneConfig.mainHandler.postDelayed(new Runnable() { // from class: com.ipotensic.kernel.controllers.MapVideoController.9.1
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            DDLog.m1691w("切换map 大图模式");
            animToBig(this.mapContainer, new AnimationListenerAdapter() { // from class: com.ipotensic.kernel.controllers.MapVideoController.10
                @Override // com.ipotensic.baselib.guide.listener.AnimationListenerAdapter, android.view.animation.Animation.AnimationListener
                public void onAnimationStart(Animation animation) {
                ...
                public void onAnimationEnd(Animation animation) {
                    ...
                    MapVideoController.this.tvTof.setVisibility(8);
                    MapVideoController.this.videoContainer.bringToFront();
                    ...
                    PermissionUtil.requestLocationPermissionAndGpsEnable((BaseActivity) MapVideoController.this.getContext(), new SimpleResultListener<Boolean>() { // from class: com.ipotensic.kernel.controllers.MapVideoController.10.1
    ...
    private void addMapView() {
        ...
        mapManager.setMapClickedListener(new MapManager.MapClickedListener() { // from class: com.ipotensic.kernel.controllers.MapVideoController.11
        ...
        RoundRelativeLayout roundRelativeLayout = (RoundRelativeLayout) getBaseView().findViewById(C1965R.id.map_container);
        ...
        if (this.mapView != null) {
            this.mapContainer.postDelayed(new Runnable() { // from class: com.ipotensic.kernel.controllers.MapVideoController.12
                @Override // java.lang.Runnable
                public void run() {
    ...
    private void addDirectIndicateView() {
        if (this.directViewIndicator == null) {
            ...
            imageView.setImageResource(C1965R.mipmap.img_direct_view_indicate);
            ...
            this.directViewIndicator.setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.controllers.MapVideoController.13
                @Override // android.view.View.OnClickListener
    ...
    private void setSurfaceViewVisible(boolean z) {
        ...
        DDLog.m1691w("setSurfaceViewVisible");
        if (z) {
            layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            DDLog.m1691w("videoBg surface gone:false");
        } else {
            layoutParams = new RelativeLayout.LayoutParams(1, 1);
            DDLog.m1691w("videoBg surface gone:true");
        }
    ...
    public void setBackground(boolean z) {
        ...
        DDLog.m1691w("videoBg:" + this.videoBg.getVisibility() + ", isConnect: " + z);
    }
    ...
    /* renamed from: com.ipotensic.kernel.controllers.MapVideoController$15 */
    static /* synthetic */ class C215115 {
        ...
        static {
            ...
            try {
                $SwitchMap$com$ipotensic$baselib$dispatcher$EventID[EventID.EVENT_GET_SD_CARD_STATE_SUCCESS.ordinal()] = 8;
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        switch (C215115.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()]) {
            case 1:
            ...
            case 2:
                ...
                if (attitudeBallView2 != null) {
                    ...
                    if (flightRevFlightInfoData != null) {
                        ...
                        if (this.curMode == Mode.MODE_VIDEO && flightRevFlightInfoData.getTofHeight() >= 1 && flightRevFlightInfoData.getTofHeight() <= 30) {
                            this.tvTof.setVisibility(0);
                            this.tvTof.setText(FlightConfig.getValueWithUnit(UnitUtil.keepOneDigit(flightRevFlightInfoData.getTofHeight() / 10.0f)));
                        } else {
                            this.tvTof.setVisibility(8);
                        }
                    }
            ...
            case 5:
                ...
                break;
            case 6:
                DDLog.m1683d(TAG, "onEvent id is FLIGHT_WAYPOINT_CONTROL");
                boolean booleanValue2 = ((Boolean) event.obj).booleanValue();
                mapBtnShow(booleanValue2, !booleanValue2);
                break;
            case 7:
                DDLog.m1683d(TAG, "onEvent id is EXIT_QUICK_SHOT");
    ...
    public void showWayPointGuide() {
        if (SPHelper.getInstance().getEnterMapOfWaypoint() && this.isWaypointEnterMap && isMapMode()) {
            ...
            GeneralDialog generalDialog = new GeneralDialog(getContext(), FlightConfig.isAtomPanTilt() ? C1965R.raw.waypoint_guide_atom : C1965R.raw.waypoint_guide);
    ...
    public Object drawCircle(CircleStyle circleStyle) {
        MapManager mapManager = this.mapManager;
        if (mapManager != null) {
            return mapManager.drawCircle(circleStyle);
        }
        return null;
    }
    ...
    public void updateCircle(Object obj, CircleStyle circleStyle) {
        MapManager mapManager = this.mapManager;
        if (mapManager != null) {
            mapManager.updateCircle(obj, circleStyle);
        }
    }
    ...
    public void removeCircle(ArrayList<Object> arrayList) {
        MapManager mapManager = this.mapManager;
        if (mapManager != null) {
            mapManager.removeCircle(arrayList);
        }
    }
    ...
    public Object drawPolygon(PolygonStyle polygonStyle) {
        MapManager mapManager = this.mapManager;
        if (mapManager != null) {
            return mapManager.drawPolygon(polygonStyle);
        }
        return null;
    }
    ...
    public void updatePolygon(Object obj, PolygonStyle polygonStyle) {
        MapManager mapManager = this.mapManager;
        if (mapManager != null) {
            mapManager.updatePolygon(obj, polygonStyle);
        }
    }
    ...
    public void removePolygon(ArrayList<Object> arrayList) {
        MapManager mapManager = this.mapManager;
        if (mapManager != null) {
            mapManager.removePolygon(arrayList);
        }
    }
    ...
    public Boolean isPolygonVisibleRegion(ArrayList<CommonLatLng> arrayList) {
        MapManager mapManager = this.mapManager;
        if (mapManager != null) {
            return mapManager.isPolygonVisibleRegion(arrayList);
        }
        return false;
    }
    ...
    public Boolean isCircleVisibleRegion(CommonLatLng commonLatLng, Double d) {
        MapManager mapManager = this.mapManager;
        if (mapManager != null) {
            return mapManager.isCircleVisibleRegion(commonLatLng, d);
        }
        return false;
    }
    ...
    public Boolean isPolygonBounds(ArrayList<CommonLatLng> arrayList, Object obj) {
        MapManager mapManager = this.mapManager;
        if (mapManager != null) {
            return mapManager.isPolygonBounds(arrayList, obj);
        }
        return false;
    }
    ...
    public Boolean isCircleBounds(CommonLatLng commonLatLng, Double d, Object obj) {
        MapManager mapManager = this.mapManager;
        if (mapManager != null) {
            return mapManager.isCircleBounds(commonLatLng, d, obj);
        }
        return false;
    }

    private void setMapExplainAdapter() {
        ArrayList arrayList = new ArrayList();
        arrayList.add(new MapExplainBean(C1965R.string.restricted_zone, C1965R.mipmap.icon_no_fly_zone));
        arrayList.add(new MapExplainBean(C1965R.string.altitude_zone, C1965R.mipmap.icon_height_restriction_zone));
        RvCommonAdapter<MapExplainBean, ItemMapExplainBinding> rvCommonAdapter = new RvCommonAdapter<MapExplainBean, ItemMapExplainBinding>(getContext(), arrayList) { // from class: com.ipotensic.kernel.controllers.MapVideoController.14
            @Override // com.ipotensic.baselib.views.recyclerview.RvCommonAdapter
            protected ItemMapExplainBinding initView(ViewGroup viewGroup) {
                return ItemMapExplainBinding.inflate(LayoutInflater.from(MapVideoController.this.getContext()), viewGroup, false);
            }

            @Override // com.ipotensic.baselib.views.recyclerview.RvCommonAdapter
            protected void convert(ItemMapExplainBinding itemMapExplainBinding, MapExplainBean mapExplainBean, int i) {
                itemMapExplainBinding.tvExplain.setText(MapVideoController.this.getContext().getString(mapExplainBean.getExplainName()));
                itemMapExplainBinding.imgExplain.setImageResource(mapExplainBean.getExplainRes());
            }
        };
        this.rvAdapter = rvCommonAdapter;
        this.rvNoFlyZoneHelp.setAdapter(rvCommonAdapter);
    }

    private void setNoFlyZoneHelpBtn() {
        this.noFlyZoneHelpBtn.setVisibility(8);
    }
}