...
public class TestFactoryController extends BaseController implements View.OnClickListener {
    ...
    /* renamed from: com.ipotensic.kernel.controllers.TestFactoryController$4 */
    static /* synthetic */ class C21934 {
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        int i = C21934.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()];
        if (i == 1) {
    ...
    public TestFactoryController(AppCompatActivity appCompatActivity, View view) {
        ...
        if (this.drawableGreen == null) {
            this.drawableGreen = getContext().getResources().getDrawable(C1965R.drawable.bg_p1_self_test_green_shape);
        }
        if (this.drawableGray == null) {
            this.drawableGray = getContext().getResources().getDrawable(C1965R.drawable.bg_p1_self_test_gray_shape);
        }
    }

    @Override // com.ipotensic.kernel.controllers.BaseController
    public void initView(View view) {
        this.btnCameraTest = (Button) view.findViewById(C1965R.id.tv_camera_test_mode);
        this.btnFlightTest = (Button) view.findViewById(C1965R.id.tv_flight_test_mode);
        this.btnFlightSweepFreq = (Button) view.findViewById(C1965R.id.tv_flight_sweep_mode);
        this.btnFlightFixedFreq = (Button) view.findViewById(C1965R.id.tv_flight_fixed_mode);
        this.btnFlightVariableSpeed = (Button) view.findViewById(C1965R.id.tv_flight_variable_mode);
        this.btnFlightFixedSpeed = (Button) view.findViewById(C1965R.id.tv_flight_fixed_speed_mode);
        this.btnFlightFlash = (Button) view.findViewById(C1965R.id.tv_flight_shining_mode);
        this.btnFlightAlwaysLight = (Button) view.findViewById(C1965R.id.tv_flight_always_light_mode);
        this.btnFlight24gOn = (Button) view.findViewById(C1965R.id.tv_flight_24g_test);
        this.btnClearImuData = (Button) view.findViewById(C1965R.id.tv_clear_imu_data);
        this.restoreFactorySetting = (Button) view.findViewById(C1965R.id.tv_restore_factory_setting);
        this.btnLossPkgOpen = (Button) view.findViewById(C1965R.id.btn_loss_pkg_open);
        this.btnLossPkgClose = (Button) view.findViewById(C1965R.id.btn_loss_pkg_close);
        this.btnCamTemp = (Button) view.findViewById(C1965R.id.btn_cam_temp);
    ...
    public void onClick(View view) {
        int id = view.getId();
        int i = 0;
        if (id == C1965R.id.tv_camera_test_mode) {
        ...
        } else if (id == C1965R.id.tv_flight_test_mode) {
        ...
        } else if (id != C1965R.id.tv_clear_imu_data) {
            if (id == C1965R.id.tv_restore_factory_setting) {
            ...
            } else if (id == C1965R.id.btn_loss_pkg_open) {
                i = DataManager.getInstance().sendFactoryTestData(new byte[]{6, FlightConfig.P1_SELF});
            } else if (id == C1965R.id.btn_loss_pkg_close) {
