...
public class LeftController extends BaseController {
    ...
    public void initView(View view) {
        ...
        this.ivTakeOff = (ImageView) view.findViewById(C1965R.id.iv_take_off);
        this.ivGoHome = (ImageView) view.findViewById(C1965R.id.iv_go_home);
        this.ivFlySet = (ImageView) view.findViewById(C1965R.id.iv_fly_set);
        setGoHomeBtnVisibility();
        if (!FlightConfig.isOldProduct()) {
            setIvTakeOffEnable(false, 0.4f);
        }
        this.ivTakeOff.setOnClickListener(new C21411(1000));
        this.ivGoHome.setOnClickListener(new ScaleClickListener(1000) { // from class: com.ipotensic.kernel.controllers.LeftController.2
            ...
            public void click(View view2) {
                if (SPHelper.getInstance().getGoHome()) {
                    ...
                    NewbieGuide.with(LeftController.this.getContext()).addGuidePage(GuidePage.newInstance().addHighLight(LeftController.this.ivGoHome, new RelativeGuide(C1965R.layout.guide_left, 5)).setEnterAnimation(AnimationUtil.enterAnimation()).setExitAnimation(AnimationUtil.exitAnimation()).setOnLayoutInflatedListener(new OnLayoutInflatedListener() { // from class: com.ipotensic.kernel.controllers.LeftController.2.1
                        ...
                        public void onLayoutInflated(View view3, Controller controller) {
                            ((TextView) view3.findViewById(C1965R.id.tv_view)).setText(LeftController.this.getContext().getResources().getString(C1965R.string.guide_left_go_home));
                        }
                    }).setBackgroundColor(LeftController.this.getContext().getResources().getColor(C1965R.color.color_guide_bg))).show();
                } else if (FlightRevData.get().getFlightRevStateData().isReturning()) {
                    new SlideUnlockDialog(LeftController.this.mContext, LeftController.this.mContext.getString(C1965R.string.dialog_exit_go_home), LeftController.this.mContext.getString(C1965R.string.dialog_exit_go_home_describe), new SlideUnlockDialog.SlideResultListener() { // from class: com.ipotensic.kernel.controllers.LeftController.2.2
                    ...
                    new SlideUnlockDialog(LeftController.this.mContext, LeftController.this.mContext.getString(C1965R.string.dialog_go_home), LeftController.this.mContext.getString(C1965R.string.dialog_go_home_describe), new SlideUnlockDialog.SlideResultListener() { // from class: com.ipotensic.kernel.controllers.LeftController.2.3
                        @Override // com.ipotensic.kernel.view.dialog.SlideUnlockDialog.SlideResultListener
                        public void dealEvent() {
        ...
        this.ivFlySet.setOnClickListener(new ScaleClickListener(1000) { // from class: com.ipotensic.kernel.controllers.LeftController.3
            ...
            public void click(View view2) {
                if (!SPHelper.getInstance().getIntelligentMode()) {
                    ...
                    NewbieGuide.with(LeftController.this.getContext()).addGuidePage(GuidePage.newInstance().addHighLight(LeftController.this.ivFlySet, new RelativeGuide(C1965R.layout.guide_left, 5)).setEnterAnimation(AnimationUtil.enterAnimation()).setExitAnimation(AnimationUtil.exitAnimation()).setOnLayoutInflatedListener(new OnLayoutInflatedListener() { // from class: com.ipotensic.kernel.controllers.LeftController.3.1
                        @Override // com.ipotensic.baselib.guide.listener.OnLayoutInflatedListener
                        public void onLayoutInflated(View view3, Controller controller) {
                            ((TextView) view3.findViewById(C1965R.id.tv_view)).setText(LeftController.this.getContext().getResources().getString(C1965R.string.guide_left_intelligent_mode));
                        }
                    }).setBackgroundColor(LeftController.this.getContext().getResources().getColor(C1965R.color.color_guide_bg))).show();
                }
            }
    ...
    /* renamed from: com.ipotensic.kernel.controllers.LeftController$1 */
    class C21411 extends ScaleClickListener {
        C21411(Integer num) {
            super(num);
        }
        ...
        public void click(View view) {
            if (SPHelper.getInstance().getTakeOff()) {
                ...
                NewbieGuide.with(LeftController.this.getContext()).addGuidePage(GuidePage.newInstance().addHighLight(LeftController.this.ivTakeOff, new RelativeGuide(C1965R.layout.guide_left, 5)).setEnterAnimation(AnimationUtil.enterAnimation()).setExitAnimation(AnimationUtil.exitAnimation()).setOnLayoutInflatedListener(new OnLayoutInflatedListener() { // from class: com.ipotensic.kernel.controllers.LeftController.1.1
                    @Override // com.ipotensic.baselib.guide.listener.OnLayoutInflatedListener
                    public void onLayoutInflated(View view2, Controller controller) {
                        ((TextView) view2.findViewById(C1965R.id.tv_view)).setText(LeftController.this.getContext().getResources().getString(C1965R.string.guide_left_take_off));
                    }
                }).setBackgroundColor(LeftController.this.getContext().getResources().getColor(C1965R.color.color_guide_bg))).show();
                return;
            }
            ...
            if (FlightConfig.isOldProduct()) {
                if (!z) {
                    new SlideUnlockDialog(LeftController.this.mContext, LeftController.this.getContext().getString(C1965R.string.dialog_takeoff), LeftController.this.getContext().getString(C1965R.string.dialog_takeoff_describe), new SlideUnlockDialog.SlideResultListener() { // from class: com.ipotensic.kernel.controllers.-$$Lambda$LeftController$1$rl0QR0k53psYyD1WNrgChbRGsU4
                        @Override // com.ipotensic.kernel.view.dialog.SlideUnlockDialog.SlideResultListener
                        public final void dealEvent() {
                            LeftController.C21411.this.lambda$click$0$LeftController$1();
                        }
                    }).show();
                    return;
                } else if (!isLanding) {
                    new SlideUnlockDialog(LeftController.this.mContext, LeftController.this.getContext().getString(C1965R.string.dialog_landing), LeftController.this.getContext().getString(C1965R.string.dialog_landing_describe), new SlideUnlockDialog.SlideResultListener() { // from class: com.ipotensic.kernel.controllers.-$$Lambda$LeftController$1$llWMXwqFCmNvSsVQ1-zaXjvxBdQ
                        @Override // com.ipotensic.kernel.view.dialog.SlideUnlockDialog.SlideResultListener
                        public final void dealEvent() {
                            LeftController.C21411.this.lambda$click$1$LeftController$1();
                        }
                    }).show();
                    return;
                } else {
                    new SlideUnlockDialog(LeftController.this.mContext, LeftController.this.getContext().getString(C1965R.string.dialog_exit_landing), LeftController.this.getContext().getString(C1965R.string.dialog_exit_landing_describe), new SlideUnlockDialog.SlideResultListener() { // from class: com.ipotensic.kernel.controllers.-$$Lambda$LeftController$1$sPDzpV63ovY-GIy0xayiYku2ziA
                        @Override // com.ipotensic.kernel.view.dialog.SlideUnlockDialog.SlideResultListener
                        public final void dealEvent() {
            ...
            if (FlightConfig.isConnectFlight() && remainedBattery < 5) {
                DDLog.m1684e("电量低于5%不发起飞命令");
                return;
            }
            if (FlightConfig.isConnectFlight() && remainedBattery < 20) {
                DDLog.m1684e("电量低于20%弹强制起飞");
    ...
    public void setUpDown(FlightRevStateData flightRevStateData) {
        ...
        this.ivTakeOff.setImageResource(flightRevStateData.isUnLock() ? C1965R.mipmap.icon_take_landing : C1965R.mipmap.icon_take_off);
        ...
        this.miniTakeoffSlideUnlockDialog.setTextChange(getContext().getString(C1965R.string.dialog_landing), getContext().getString(C1965R.string.dialog_landing_describe), false, true);
    }
    ...
    /* renamed from: com.ipotensic.kernel.controllers.LeftController$4 */
    static /* synthetic */ class C21444 {
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        int i = C21444.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()];
        if (i == 1) {
            setGoHomeBtnVisibility();
            return;
        }
        if (i == 2) {
            if (!((Boolean) event.obj).booleanValue()) {
                this.ivTakeOff.setImageResource(C1965R.mipmap.icon_take_off);
                setIvTakeOffEnable(false, 0.4f);
                dialogDismiss();
            }
