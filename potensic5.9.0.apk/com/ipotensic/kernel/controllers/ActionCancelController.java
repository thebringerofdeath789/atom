...
public class ActionCancelController extends BaseController {
    ...
    public void initView(View view) {
        ...
        this.ivActionCancel = (ImageView) view.findViewById(C1965R.id.iv_cancel_action);
        this.cancelSwoopReturnButton = (ImageButton) view.findViewById(C1965R.id.btn_cancel_swoop_return);
        this.cancelSwoopReturnText = (TextView) view.findViewById(C1965R.id.text_cancel_swoop_return);
                ...
                if (FlightRevData.get().getFlightRevStateData().isReturning()) {
                    ...
                    if (!FlightRevData.get().getFlightRevStateData().isLanding()) {
                        if (ActionCancelController.this.actionDialog == null) {
                            ActionCancelController.this.actionDialog = new GeneralDialog(ActionCancelController.this.context, ActionCancelController.this.context.getString(C1965R.string.dialog_quit_cur_mode), ActionCancelController.this.context.getString(C1965R.string.dialog_quit_cur_mode_describe), (String) null, (String) null, false, 2, new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.kernel.controllers.ActionCancelController.1.1
    ...
    public /* synthetic */ void lambda$initView$0$ActionCancelController(View view) {
        DDLog.m1684e("俯冲返航cancelSwoopReturnButton");
    ...
    public void setVisibility(int i) {
        ...
        if (i == 0) {
            DDLog.m1684e("actionCancelController 1111");
    ...
    public void transInLeft(final View view, int i) {
        Animation loadAnimation = AnimationUtils.loadAnimation(view.getContext(), C1965R.anim.trans_in_left);
        ...
        loadAnimation.setAnimationListener(new Animation.AnimationListener() { // from class: com.ipotensic.kernel.controllers.ActionCancelController.2
            ...
            public void onAnimationStart(Animation animation) {
                DDLog.m1684e("actionCancelController 22222");
    ...
    public void guideViewShow() {
        if (FlightRevData.get().getFlightRevStateData().isFollowing() && SPHelper.getInstance().getFirstFollowMe()) {
            ...
            NewbieGuide.with((Activity) this.context).addGuidePage(GuidePage.newInstance().addHighLight(this.ivActionCancel, new RelativeGuide(C1965R.layout.guide_follow_me, 5)).setEnterAnimation(AnimationUtil.enterAnimation()).setExitAnimation(AnimationUtil.exitAnimation()).setBackgroundColor(getContext().getResources().getColor(C1965R.color.colorTransparent))).show();
        }
    }
