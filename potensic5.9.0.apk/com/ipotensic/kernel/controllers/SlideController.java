...
public class SlideController extends BaseController {
    ...
    public void initView(View view) {
        UpDownSlideView upDownSlideView = (UpDownSlideView) view.findViewById(C1965R.id.view_slide);
    ...
    /* renamed from: com.ipotensic.kernel.controllers.SlideController$2 */
    static /* synthetic */ class C21832 {
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        if (C21832.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()] != 1) {
            return;
        }
        this.slideView.setVisibility(FlightConfig.is_Atom_Series() ? 8 : 0);
    }
