...
public class GuideController extends BaseController {
    ...
    private void init() {
        this.ivLogo = (ImageView) this.top.findViewById(C1965R.id.iv_logo);
        this.layoutConnectState = (RelativeLayout) this.top.findViewById(C1965R.id.layout_connect_state);
        this.ivSignalHd = (ImageView) this.top.findViewById(C1965R.id.iv_signal_hd);
        this.tvUavStatus = (StrokeTextView) this.top.findViewById(C1965R.id.tv_uav_status);
        this.ivHaveHead = (ImageView) this.top.findViewById(C1965R.id.iv_have_direction_mode);
        this.ivGps = (ImageView) this.top.findViewById(C1965R.id.iv_gps);
        this.tvGps = (StrokeTextView) this.top.findViewById(C1965R.id.tv_gps);
        this.layoutBattery = (CircleBatteryView) this.top.findViewById(C1965R.id.view_battery_percentage);
        this.tvRemainFlightTime = (StrokeTextView) this.top.findViewById(C1965R.id.tv_remain_flight_time);
        this.ivSystemSet = (ImageView) this.top.findViewById(C1965R.id.tv_new_setting);
        this.slideView = (UpDownSlideView) this.right.findViewById(C1965R.id.view_slide);
    ...
    public void addGuideView() {
        NewbieGuide.with(getContext()).addGuidePage(getDefaultGuidePage(true).addHighLight(this.ivLogo, new SettingRelativeGuide(C1965R.layout.guide_view_top_new, 80, 0, UnitUtil.dp2px(6), 0, 0, 0, Integer.valueOf(C1965R.string.guide_top_return))).addHighLight(this.layoutConnectState, new SettingRelativeGuide(C1965R.layout.guide_view_top_new, 80, 0, UnitUtil.dp2px(15), 0, 0, 0, Integer.valueOf(C1965R.string.guide_top_device_status))).addHighLight(this.ivGps, new SettingRelativeGuide(C1965R.layout.guide_view_top_new, 80, 0, 0, 0, 0, 0, Integer.valueOf(C1965R.string.guide_top_gps_signal))).addHighLight(this.layoutBattery, new SettingRelativeGuide(C1965R.layout.guide_view_top_new, 80, UnitUtil.dp2px(5), 0, 0, 0, 0, Integer.valueOf(C1965R.string.guide_top_electric))).addHighLight(this.bottom, new RelativeGuide(C1965R.layout.guide_view_bottom2, 5, 0, 0, UnitUtil.dp2px(10), 0, 0))).addGuidePage(getDefaultGuidePage(true).addHighLight(this.tvUavStatus, new SettingRelativeGuide(C1965R.layout.guide_view_top_right, GravityCompat.END, 0, 0, 0, 0, 0, Integer.valueOf(C1965R.string.guide_top_mode))).addHighLight(this.ivSignalHd, new SettingRelativeGuide(C1965R.layout.guide_view_top_right, GravityCompat.END, 0, 0, 0, 0, 0, Integer.valueOf(C1965R.string.guide_top_signal))).addHighLight(this.ivSystemSet, new SettingRelativeGuide(C1965R.layout.guide_view_top_right, GravityCompat.END, 0, 0, 0, 0, 0, Integer.valueOf(C1965R.string.guide_top_setting))).addHighLight(this.map, new RelativeGuide(C1965R.layout.guide_view_map, 5, 0, 0, 0, 0, 0))).addGuidePage(getDefaultGuidePage(false, ContextCompat.getColor(getContext(), C1965R.color.colorFiftyPercent)).addHighLight(this.directViewIndicator, new SettingRelativeGuide(C1965R.layout.guide_view_attitude_ball_indicator, 5, 0, 0, 0, 0, 0))).setOnPageChangedListener(new OnPageChangedListener() { // from class: com.ipotensic.kernel.controllers.-$$Lambda$GuideController$cpMM5hoY6r7gYOUp9x9krgjgcNY
    ...
    public /* synthetic */ void lambda$addGuideView$0$GuideController(int i) {
        if (i == 0) {
            ...
            this.ivHaveHead.setImageResource(C1965R.mipmap.icon_top_head_mode);
            this.ivHaveHead.setImageResource(C1965R.mipmap.icon_top_head_mode);
    ...
    public void showAttitudeBallGuide() {
        NewbieGuide.with(getContext()).addGuidePage(getDefaultGuidePage(true).addHighLight(this.attitudeBallView, new SettingRelativeGuide(C1965R.layout.guide_view_attitude_ball, 5, 0, 0, 0, 0, 0))).setOnGuideChangedListener(new OnGuideChangedListener() { // from class: com.ipotensic.kernel.controllers.GuideController.2
            @Override // com.ipotensic.baselib.guide.listener.OnGuideChangedListener
            public void onRemoved(Controller controller) {
            }
