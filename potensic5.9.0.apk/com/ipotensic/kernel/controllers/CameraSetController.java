...
public class CameraSetController extends BaseController implements View.OnClickListener {
    ...
    public void initView(View view) {
        ...
        view.findViewById(C1965R.id.iv_right_bg).setOnClickListener(this);
        View findViewById = view.findViewById(C1965R.id.view_blank);
        this.viewBlank = findViewById;
        findViewById.setOnClickListener(this);
        SwitchButton switchButton = (SwitchButton) view.findViewById(C1965R.id.slideBtn_grid);
        ...
        view.findViewById(C1965R.id.tv_sd_format).setOnClickListener(this);
        this.videoSegmentView = (GridView) view.findViewById(C1965R.id.gv_video);
        this.qulityGridView = (GridView) view.findViewById(C1965R.id.gv_qulity);
        this.ratioGridView = (GridView) view.findViewById(C1965R.id.gv_ratio);
        this.tvJpg = (TextView) view.findViewById(C1965R.id.tv_jpg);
        this.tvRaw = (TextView) view.findViewById(C1965R.id.tv_raw);
        int i = 1000;
        boolean z = false;
        ...
        SwitchButton switchButton2 = (SwitchButton) view.findViewById(C1965R.id.slideBtn_water_mark);
        ...
        this.lineWaterMark = view.findViewById(C1965R.id.line_water_mark);
        this.viewWaterMark = view.findViewById(C1965R.id.view_water_mark);
        this.lineFormat = view.findViewById(C1965R.id.line_format);
        this.viewFormat = view.findViewById(C1965R.id.view_format);
        this.linePhotoSizes = view.findViewById(C1965R.id.line_photo_sizes);
        this.lineVideoSizes = view.findViewById(C1965R.id.line_video_sizes);
        this.lineVideoSegment = view.findViewById(C1965R.id.line_video_segment);
        this.layoutPhotosSizes = (ExpandableView) view.findViewById(C1965R.id.layout_photo_sizes);
        this.layoutVideoSizes = (ExpandableView) view.findViewById(C1965R.id.layout_video_sizes);
        this.layoutVideoSegment = (ExpandableView) view.findViewById(C1965R.id.layout_video_segment);
        this.clPhotoResolution = (ConstraintLayout) view.findViewById(C1965R.id.rl_photo_resolution);
        this.linePhotoResolution = view.findViewById(C1965R.id.line_photo_resolution);
        this.isInit = true;
        onConfigMenu();
    }
    ...
    public void setPhotoFormat(boolean z) {
        ...
        if (z2) {
            color = getContext().getResources().getColor(C1965R.color.white);
        } else {
            color = getContext().getResources().getColor(C1965R.color.color_white_seventy_percent);
        }
        textView.setTextColor(color);
        TextView textView2 = this.tvRaw;
        if (z2) {
            color2 = getContext().getResources().getColor(C1965R.color.color_white_seventy_percent);
        } else {
            color2 = getContext().getResources().getColor(C1965R.color.white);
        }
        textView2.setTextColor(color2);
        this.tvJpg.setBackgroundResource(z2 ? C1965R.mipmap.img_format_switch_left_select : C1965R.mipmap.img_format_switch_left);
        this.tvRaw.setBackgroundResource(z2 ? C1965R.mipmap.img_format_switch_right : C1965R.mipmap.img_format_switch_right_select);
    }

    @Override // com.ipotensic.kernel.controllers.BaseController
    public void setVisibility(int i) {
        super.setVisibility(i);
        DDLog.m1684e("更新:" + LogUtil.printMethodCaller());
        ...
        this.recordSizeAdapter.setOnItemClickedListener(new ImageGridViewAdapter.OnItemClickedListener() { // from class: com.ipotensic.kernel.controllers.CameraSetController.9
            ...
            public void onItemClicked(int i) {
                ...
                try {
                    ...
                    DDLog.m1684e("record size 出错:" + e.getMessage());
                }
            }
        });
    }
