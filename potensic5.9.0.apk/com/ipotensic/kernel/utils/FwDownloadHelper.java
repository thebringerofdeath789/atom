...
public class FwDownloadHelper {
    ...
    private DownloadListener2 downloadListener = new DownloadListener2() { // from class: com.ipotensic.kernel.utils.FwDownloadHelper.2
        ...
        public void onDownloadStart(long j) {
            DDLog.m1684e("progress: 需要下载固件的总大小= " + j);
        ...
        public void onDownloadProgress(final long j) {
            DDLog.m1684e("progress：" + j);
            DDLog.m1684e("progress：,!activity.isFinishing(): " + (!FwDownloadHelper.this.activity.isFinishing()));
            DDLog.m1684e("progress：,totalSize != 0: " + (FwDownloadHelper.this.totalSize != 0));
            DDLog.m1684e("progress：,upgradeDialog != null:  " + (FwDownloadHelper.this.upgradeDialog != null));
            ...
            try {
                ...
                DDLog.m1684e("progress: 下载进度出错：" + e);
                e.printStackTrace();
            }
        }
        ...
        public void onDownloadEnd(String str, String str2, String str3) {
            ...
            DDLog.m1684e("progress 单个固件下载结束= " + FwDownloadHelper.this.progressSize + ", fileSize = " + str3);
            DDLog.m1684e("固件下载 当前下载的固件是： " + str2 + ", filePath = " + str);
        }
        ...
        public void onDownloadFinished() {
            ...
            FwDownloadHelper.this.activity.runOnUiThread(new Runnable() { // from class: com.ipotensic.kernel.utils.FwDownloadHelper.2.2
                @Override // java.lang.Runnable
                public void run() {
                    DDLog.m1684e("progress: onDownloadFinished");
        ...
        public void onDownloadError(final Exception exc) {
            DDLog.m1684e("progress: onDownloadError" + exc.getMessage());
            FwDownloadHelper.this.isDownloadingFw = false;
            FwDownloadHelper.this.activity.runOnUiThread(new Runnable() { // from class: com.ipotensic.kernel.utils.FwDownloadHelper.2.3
                ...
                public void run() {
                    ...
                    if (exc instanceof UnknownHostException) {
                        ToastUtil.toast(FwDownloadHelper.this.activity, FwDownloadHelper.this.activity.getString(C1965R.string.toast_no_network));
                    } else {
                        ToastUtil.toast(FwDownloadHelper.this.activity, FwDownloadHelper.this.activity.getString(C1965R.string.download_fail));
                    }
        ...
        if (FlightConfig.getLastProductClass() != null) {
            FwDownloadManager.getInstance().getFwFromServer(new OnResultListener<Boolean>() { // from class: com.ipotensic.kernel.utils.FwDownloadHelper.1
                ...
                public void onSuccess(Boolean bool) {
                    DDLog.m1685e("下载固件", "isForceDownload: " + bool);
                    DDLog.m1685e("下载固件", "BaseSyncDialog.isShow: " + BaseSyncDialog.isShow);
                    DDLog.m1685e("下载固件", "upgradeDialog != null && upgradeDialog.isShowing(): " + (FwDownloadHelper.this.upgradeDialog != null && FwDownloadHelper.this.upgradeDialog.isShowing()));
                    DDLog.m1685e("下载固件", "FlightRevData.get().getFlightRevStateData().isFlight(): " + FlightRevData.get().getFlightRevStateData().isFlight());
                    DDLog.m1685e("下载固件", "FlightRevData.get().getFlightRevStateData().isUnLock(): " + FlightRevData.get().getFlightRevStateData().isUnLock());
                    DDLog.m1685e("下载固件", "activity.isFinishing(): " + baseActivity.isFinishing());
                    DDLog.m1685e("下载固件", "FwDownloadManager.getInstance().isDialogShowing(): " + FwDownloadManager.getInstance().isDialogShowing());
                    ...
                    if (FwDownloadHelper.this.downLoadDialog == null || !FwDownloadHelper.this.downLoadDialog.isShowing()) {
                        ...
                        DDLog.m1684e("下载固件弹框isHorizontal: " + z);
                        int i = z ? C1965R.layout.view_dialog_fw_download_black : C1965R.layout.view_dialog_fw_download_white;
                        if (FwDownloadHelper.this.downLoadDialog == null) {
                            FwDownloadHelper.this.downLoadDialog = new FwUpgradeConditionDialog(baseActivity, i, z, bool, new FwUpgradeConditionDialog.FwDownLoadListener() { // from class: com.ipotensic.kernel.utils.FwDownloadHelper.1.1
                                ...
                                public void startDownLoad() {
                                    ...
                                    if (!baseActivity.isFinishing()) {
                                        ...
                                        DDLog.m1685e("正下载固件", "1111111111");
                                        FwDownloadHelper.this.upgradeDialog = new FwUpgradeConditionDialog(baseActivity, z ? C1965R.layout.view_dialog_fw_upgrade_black : C1965R.layout.view_dialog_fw_upgrade_white, z);
                                        DDLog.m1685e("正下载固件", "222222222");
                                        FwDownloadHelper.this.upgradeDialog.show();
                                        DDLog.m1685e("正下载固件", "333333333");
                                    }
    ...
    public void release(BaseActivity baseActivity) {
        ...
        try {
            ...
            DDLog.m1684e("弹窗消失异常:" + e.getMessage());
        }
    }
}