...
public abstract class SimpleLifeCycle implements LifecycleEventObserver {
    ...
    /* renamed from: com.ipotensic.kernel.utils.SimpleLifeCycle$1 */
    static /* synthetic */ class C25121 {
    ...
    public void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
        int i = C25121.$SwitchMap$androidx$lifecycle$Lifecycle$Event[event.ordinal()];
        if (i == 1) {
            onCreate();
            return;
        }
