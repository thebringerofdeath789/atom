...
public class AnimationUtil {
    ...
    public static void transInBottom(final View view, int i) {
        Animation loadAnimation = AnimationUtils.loadAnimation(view.getContext(), C1965R.anim.trans_in_bottom);
    ...
    public static void transOutBottom(final View view) {
        Animation loadAnimation = AnimationUtils.loadAnimation(view.getContext(), C1965R.anim.trans_out_bottom);
        view.startAnimation(loadAnimation);
    ...
    public static void transInTop(final View view) {
        Animation loadAnimation = AnimationUtils.loadAnimation(view.getContext(), C1965R.anim.trans_in_top);
    ...
    public static void transOutTop(final View view) {
        Animation loadAnimation = AnimationUtils.loadAnimation(view.getContext(), C1965R.anim.trans_out_top);
        view.startAnimation(loadAnimation);
    ...
    public static void transOutLeft(final View view) {
        Animation loadAnimation = AnimationUtils.loadAnimation(view.getContext(), C1965R.anim.trans_out_left);
        loadAnimation.setDuration(400L);
        view.startAnimation(loadAnimation);
    ...
    public static void selfRotate(View view) {
        Animation loadAnimation = AnimationUtils.loadAnimation(view.getContext(), C1965R.anim.rotate_self_repeat);
