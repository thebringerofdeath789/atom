...
public class CircularAnim {
    ...
    public static class VisibleBuilder {
        ...
        /* renamed from: go */
        public void m1721go(final OnAnimationEndListener onAnimationEndListener) {
    ...
    public static class FullActivityBuilder {
        ...
        /* renamed from: go */
        public void m1719go(OnAnimationEndListener onAnimationEndListener) {
            this.mOnAnimationEndListener = onAnimationEndListener;
            if (Build.VERSION.SDK_INT < 21) {
                doOnEnd();
                return;
            ...
            createCircularReveal.addListener(new C24911(viewGroup, imageView, sqrt, longValue));
        ...
        /* renamed from: com.ipotensic.kernel.utils.CircularAnim$FullActivityBuilder$1 */
        class C24911 extends AnimatorListenerAdapter {
            final /* synthetic */ ViewGroup val$decorView;
            final /* synthetic */ long val$finalDuration;
            final /* synthetic */ int val$finalRadius;
            final /* synthetic */ ImageView val$view;

            C24911(ViewGroup viewGroup, ImageView imageView, int i, long j) {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                this.val$decorView.postDelayed(new Runnable() { // from class: com.ipotensic.kernel.utils.CircularAnim.FullActivityBuilder.1.1
                    ...
                    public void run() {
                        ...
                        Animator createCircularReveal = ViewAnimationUtils.createCircularReveal(C24911.this.val$view, FullActivityBuilder.this.mTriggerPoint.x, FullActivityBuilder.this.mTriggerPoint.y, C24911.this.val$finalRadius, FullActivityBuilder.this.mStartRadius);
                        createCircularReveal.setDuration(C24911.this.val$finalDuration);
                        createCircularReveal.addListener(new AnimatorListenerAdapter() { // from class: com.ipotensic.kernel.utils.CircularAnim.FullActivityBuilder.1.1.1
                            ...
                            public void onAnimationEnd(Animator animator2) {
                                ...
                                if (FullActivityBuilder.this.mActivity.isFinishing() || C24911.this.val$view.getParent() == null) {
                                    return;
                                }
                                ((ViewGroup) C24911.this.val$view.getParent()).removeView(C24911.this.val$view);
                            }
                        });
