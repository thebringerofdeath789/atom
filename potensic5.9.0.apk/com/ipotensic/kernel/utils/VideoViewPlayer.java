...
public final class VideoViewPlayer {
    ...
    public final void stop() {
        try {
            ...
            DDLog.m1684e("停止失败1 ：" + e.getMessage());
        }
    }
    ...
    public final int getRawRes(VisionExecuteType visionExecuteType) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[visionExecuteType.ordinal()]) {
            case 1:
                return C1965R.raw.video_quick_shot_follow;
            case 2:
                return C1965R.raw.video_quick_shot_circle;
            case 3:
                return C1965R.raw.video_quick_shot_screw;
            case 4:
                return C1965R.raw.video_quick_shot_comet;
            case 5:
                return C1965R.raw.video_quick_shot_skyward;
            case 6:
                return C1965R.raw.video_quick_shot_recess;
            default:
                return this.NONE;
        }
    }
    ...
    public final int getStringRes(VisionExecuteType visionExecuteType) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$1[visionExecuteType.ordinal()]) {
            case 1:
                return C1965R.string.visual_tracking_instructional_animations_guide;
            case 2:
                return C1965R.string.quickshots_circle_instructional_animations_guide;
            case 3:
                return C1965R.string.quickshots_spiral_instructional_animations_guide;
            case 4:
                return C1965R.string.quickshots_boomerang_instructional_animations_guide;
            case 5:
                return C1965R.string.quickshots_rocket_instructional_animations_guide;
            case 6:
                return C1965R.string.quickshots_pull_away_instructional_animations_guide;
            default:
                return this.NONE;
        }
    }
