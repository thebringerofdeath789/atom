...
import com.ipotensic.kernel.databinding.FragmentFriendlyTipsBindingImpl;
...
import com.ipotensic.kernel.databinding.ViewLayoutUomUploadRecordBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
    ...
    private static final int LAYOUT_FRAGMENTFRIENDLYTIPS = 2;
    private static final int LAYOUT_FRAGMENTUPGRADEQUESTION = 3;
    private static final int LAYOUT_VIEWBIGPACKAGEFWTRANSFERFAIL = 4;
    private static final int LAYOUT_VIEWBIGPACKAGEUPGRADEFINISHED = 5;
    private static final int LAYOUT_VIEWDIALOGBATTERYDISCLAIMER = 6;
    private static final int LAYOUT_VIEWLAYOUTCOMPASSCALIBRATION = 7;
    private static final int LAYOUT_VIEWLAYOUTFACTORYTEST = 8;
    private static final int LAYOUT_VIEWLAYOUTGIMBALCALIBRATION = 9;
    private static final int LAYOUT_VIEWLAYOUTGIMBALFINETUNING = 10;
    private static final int LAYOUT_VIEWLAYOUTPAIRDRONEAGAIN = 11;
    private static final int LAYOUT_VIEWLAYOUTREMOTERCONTROLLERCALIBRATION = 12;
    private static final int LAYOUT_VIEWLAYOUTRIGHTVISIONCONTROLLER = 13;
    private static final int LAYOUT_VIEWLAYOUTSETTINGABOUT = 14;
    private static final int LAYOUT_VIEWLAYOUTSETTINGBATTERY = 15;
    private static final int LAYOUT_VIEWLAYOUTSETTINGCALIBRATION = 16;
    private static final int LAYOUT_VIEWLAYOUTSETTINGCAMERA = 17;
    private static final int LAYOUT_VIEWLAYOUTSETTINGCONTROL = 18;
    private static final int LAYOUT_VIEWLAYOUTSETTINGIMAGETRANS = 19;
    private static final int LAYOUT_VIEWLAYOUTSETTINGMAIN = 20;
    private static final int LAYOUT_VIEWLAYOUTSETTINGMAIN1 = 21;
    private static final int LAYOUT_VIEWLAYOUTSETTINGSECURITY = 22;
    ...
    private static final int LAYOUT_VIEWLAYOUTUOMUPLOADRECORD = 26;

    static {
        SparseIntArray sparseIntArray = new SparseIntArray(26);
        INTERNAL_LAYOUT_ID_LOOKUP = sparseIntArray;
        sparseIntArray.put(C1965R.layout.activity_big_package, 1);
        sparseIntArray.put(C1965R.layout.fragment_friendly_tips, 2);
        sparseIntArray.put(C1965R.layout.fragment_upgrade_question, 3);
        sparseIntArray.put(C1965R.layout.view_big_package_fw_transfer_fail, 4);
        sparseIntArray.put(C1965R.layout.view_big_package_upgrade_finished, 5);
        sparseIntArray.put(C1965R.layout.view_dialog_battery_disclaimer, 6);
        sparseIntArray.put(C1965R.layout.view_layout_compass_calibration, 7);
        sparseIntArray.put(C1965R.layout.view_layout_factory_test, 8);
        sparseIntArray.put(C1965R.layout.view_layout_gimbal_calibration, 9);
        sparseIntArray.put(C1965R.layout.view_layout_gimbal_fine_tuning, 10);
        sparseIntArray.put(C1965R.layout.view_layout_pair_drone_again, 11);
        sparseIntArray.put(C1965R.layout.view_layout_remoter_controller_calibration, 12);
        sparseIntArray.put(C1965R.layout.view_layout_right_vision_controller, 13);
        sparseIntArray.put(C1965R.layout.view_layout_setting_about, 14);
        sparseIntArray.put(C1965R.layout.view_layout_setting_battery, 15);
        sparseIntArray.put(C1965R.layout.view_layout_setting_calibration, 16);
        sparseIntArray.put(C1965R.layout.view_layout_setting_camera, 17);
        sparseIntArray.put(C1965R.layout.view_layout_setting_control, 18);
        sparseIntArray.put(C1965R.layout.view_layout_setting_image_trans, 19);
        sparseIntArray.put(C1965R.layout.view_layout_setting_main, 20);
        sparseIntArray.put(C1965R.layout.view_layout_setting_main1, 21);
        sparseIntArray.put(C1965R.layout.view_layout_setting_security, 22);
        sparseIntArray.put(C1965R.layout.view_layout_setting_stick_mode, 23);
        sparseIntArray.put(C1965R.layout.view_layout_test, 24);
        sparseIntArray.put(C1965R.layout.view_layout_test_maintain, 25);
        sparseIntArray.put(C1965R.layout.view_layout_uom_upload_record, 26);
    }
    ...
    public ViewDataBinding getDataBinder(DataBindingComponent dataBindingComponent, View view, int i) {
        ...
        switch (i2) {
            ...
            case 2:
                if ("layout/fragment_friendly_tips_0".equals(tag)) {
                    return new FragmentFriendlyTipsBindingImpl(dataBindingComponent, view);
                }
                throw new IllegalArgumentException("The tag for fragment_friendly_tips is invalid. Received: " + tag);
            case 3:
            ...
            case 26:
                if ("layout/view_layout_uom_upload_record_0".equals(tag)) {
                    return new ViewLayoutUomUploadRecordBindingImpl(dataBindingComponent, view);
                }
                throw new IllegalArgumentException("The tag for view_layout_uom_upload_record is invalid. Received: " + tag);
            default:
                return null;
        }
    }
    ...
    private static class InnerLayoutIdLookup {
        ...
        static {
            ...
            sKeys = hashMap;
            hashMap.put("layout/activity_big_package_0", Integer.valueOf(C1965R.layout.activity_big_package));
            hashMap.put("layout/fragment_friendly_tips_0", Integer.valueOf(C1965R.layout.fragment_friendly_tips));
            hashMap.put("layout/fragment_upgrade_question_0", Integer.valueOf(C1965R.layout.fragment_upgrade_question));
            hashMap.put("layout/view_big_package_fw_transfer_fail_0", Integer.valueOf(C1965R.layout.view_big_package_fw_transfer_fail));
            hashMap.put("layout/view_big_package_upgrade_finished_0", Integer.valueOf(C1965R.layout.view_big_package_upgrade_finished));
            hashMap.put("layout/view_dialog_battery_disclaimer_0", Integer.valueOf(C1965R.layout.view_dialog_battery_disclaimer));
            hashMap.put("layout/view_layout_compass_calibration_0", Integer.valueOf(C1965R.layout.view_layout_compass_calibration));
            hashMap.put("layout/view_layout_factory_test_0", Integer.valueOf(C1965R.layout.view_layout_factory_test));
            hashMap.put("layout/view_layout_gimbal_calibration_0", Integer.valueOf(C1965R.layout.view_layout_gimbal_calibration));
            hashMap.put("layout/view_layout_gimbal_fine_tuning_0", Integer.valueOf(C1965R.layout.view_layout_gimbal_fine_tuning));
            hashMap.put("layout/view_layout_pair_drone_again_0", Integer.valueOf(C1965R.layout.view_layout_pair_drone_again));
            hashMap.put("layout/view_layout_remoter_controller_calibration_0", Integer.valueOf(C1965R.layout.view_layout_remoter_controller_calibration));
            hashMap.put("layout/view_layout_right_vision_controller_0", Integer.valueOf(C1965R.layout.view_layout_right_vision_controller));
            hashMap.put("layout/view_layout_setting_about_0", Integer.valueOf(C1965R.layout.view_layout_setting_about));
            hashMap.put("layout/view_layout_setting_battery_0", Integer.valueOf(C1965R.layout.view_layout_setting_battery));
            hashMap.put("layout/view_layout_setting_calibration_0", Integer.valueOf(C1965R.layout.view_layout_setting_calibration));
            hashMap.put("layout/view_layout_setting_camera_0", Integer.valueOf(C1965R.layout.view_layout_setting_camera));
            hashMap.put("layout/view_layout_setting_control_0", Integer.valueOf(C1965R.layout.view_layout_setting_control));
            hashMap.put("layout/view_layout_setting_image_trans_0", Integer.valueOf(C1965R.layout.view_layout_setting_image_trans));
            hashMap.put("layout/view_layout_setting_main_0", Integer.valueOf(C1965R.layout.view_layout_setting_main));
            hashMap.put("layout/view_layout_setting_main1_0", Integer.valueOf(C1965R.layout.view_layout_setting_main1));
            hashMap.put("layout/view_layout_setting_security_0", Integer.valueOf(C1965R.layout.view_layout_setting_security));
            hashMap.put("layout/view_layout_setting_stick_mode_0", Integer.valueOf(C1965R.layout.view_layout_setting_stick_mode));
            hashMap.put("layout/view_layout_test_0", Integer.valueOf(C1965R.layout.view_layout_test));
            hashMap.put("layout/view_layout_test_maintain_0", Integer.valueOf(C1965R.layout.view_layout_test_maintain));
            hashMap.put("layout/view_layout_uom_upload_record_0", Integer.valueOf(C1965R.layout.view_layout_uom_upload_record));
        }
    }
}