            ...
            if (!(listFiles.length == 0)) {
                for (final File logFile : listFiles) {
                    ...
                    if (StringsKt.startsWith$default(name, crashLogNamePeriod, false, 2, (Object) null)) {
                        DDLog.m1691w("日志文件 ：" + logFile.getAbsolutePath());
