...
public class MainMediaController extends BaseController implements AlbumShowRvAdapter.OnRecyclerViewItemClickListener {
    ...
    public void initView(View view) {
        this.layoutBottom = (RelativeLayout) view.findViewById(C2640R.id.layout_bottom);
        this.tvGoSetting = (TextView) view.findViewById(C2640R.id.tv_go_setting);
        this.layoutNoPermission = (LinearLayout) view.findViewById(C2640R.id.layout_no_permission);
        this.btnCloseNoPermissionTips = (ImageButton) view.findViewById(C2640R.id.btn_close_no_permission);
        this.imgNone = (ImageView) view.findViewById(C2640R.id.img_none);
        TextView textView = (TextView) view.findViewById(C2640R.id.tv_select);
        ...
        ImageButton imageButton = (ImageButton) view.findViewById(C2640R.id.btn_share);
        ...
        ImageButton imageButton2 = (ImageButton) view.findViewById(C2640R.id.btn_delete);
        ...
        this.recyclerView = (RecyclerView) view.findViewById(C2640R.id.recycler_view);
        ...
        ((TopTabView) view.findViewById(C2640R.id.view_top_tab)).setTabs(new TopTabView.OnTopIndicatorChangeListener() { // from class: com.ipotensic.potensicpro.activities.MainMediaController.6
            @Override // com.ipotensic.potensicpro.view.TopTabView.OnTopIndicatorChangeListener
            public void onIndicatorChanged(int i) {
                DDLog.m1684e("onIndicatorChanged");
        ...
        }, getContext().getString(C2640R.string.videos), getContext().getString(C2640R.string.photos));
    }
    ...
    private void showNoPermissionTips() {
        try {
            ...
            this.tvGoSetting.setOnClickListener(new C27727());
    ...
    /* renamed from: com.ipotensic.potensicpro.activities.MainMediaController$7 */
    class C27727 extends ScaleClickListener {
        C27727() {
        }

        @Override // com.ipotensic.baselib.listener.ScaleClickListener
        public void click(View view) {
            new PermissionDialog(MainMediaController.this.getContext(), MainMediaController.this.getContext().getString(C2640R.string.f2314xaf032edb), MainMediaController.this.getContext().getString(C2640R.string.f2313x79422a55), MainMediaController.this.getContext().getString(C2640R.string.dialog_cancel), MainMediaController.this.getContext().getString(C2640R.string.dialog_location_confirm), new PermissionDialog.OnGrantListener() { // from class: com.ipotensic.potensicpro.activities.MainMediaController.7.1
    ...
    public void checkNone() {
        ...
        int i = this.mode;
        if (i == 0) {
            DDLog.m1684e("video.size:" + LocalFileManager.getInstance().getVideoList().size());
            if (LocalFileManager.getInstance().getVideoList().size() == 0) {
                this.imgNone.setVisibility(0);
                this.imgNone.setImageResource(C2640R.mipmap.img_none_local_video);
                this.tvSelect.setTextColor(getContext().getResources().getColor(C2640R.color.color_gray));
                this.tvSelect.setText(getContext().getResources().getString(C2640R.string.main_media_select));
                return;
            }
            this.imgNone.setVisibility(8);
            if (this.albumShowRvAdapter.isSelectMode()) {
                this.tvSelect.setTextColor(getContext().getResources().getColor(C2640R.color.color_gray));
                this.tvSelect.setText(getContext().getResources().getString(C2640R.string.dialog_cancel));
                return;
            } else {
                this.tvSelect.setTextColor(getContext().getResources().getColor(C2640R.color.color_kernel_top_state_blue));
                this.tvSelect.setText(getContext().getResources().getString(C2640R.string.main_media_select));
                return;
            }
        }
        if (i == 1) {
            DDLog.m1684e("photo.size:" + LocalFileManager.getInstance().getPhotoList().size());
            if (LocalFileManager.getInstance().getPhotoList().size() == 0) {
                this.imgNone.setVisibility(0);
                this.imgNone.setImageResource(C2640R.mipmap.img_none_local_pic);
                this.tvSelect.setTextColor(getContext().getResources().getColor(C2640R.color.color_gray));
                this.tvSelect.setText(getContext().getResources().getString(C2640R.string.main_media_select));
                return;
            }
    ...
    public void checkAllDelete() {
        ...
        this.btnDelete.setImageResource(C2640R.mipmap.icon_btn_media_delete_disable);
        this.btnShare.setImageResource(C2640R.mipmap.icon_btn_media_share_disable);
    }
    ...
    public void share() {
        ...
        if (PhoneConfig.isConnectFlightWifi() || NetworkUtils.getNetworkState(getContext()) < 0) {
            new GeneralDialog(getContext(), getContext().getResources().getString(C2640R.string.txt_dialog_make_sure_internet_title), getContext().getResources().getString(C2640R.string.txt_dialog_make_sure_internet_detail), 0, new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.potensicpro.activities.MainMediaController.9
    ...
    /* renamed from: com.ipotensic.potensicpro.activities.MainMediaController$10 */
    class C276410 implements DeleteMediaDialog.DeleteMediaListener {
        C276410() {
        }
                ...
                PhoneConfig.mainHandler.post(new Runnable() { // from class: com.ipotensic.potensicpro.activities.MainMediaController.10.1.1
                    ...
                    public void run() {
                        try {
                            ...
                            DDLog.m1684e("删除报错：" + e.getMessage());
                        }
                    }
                });
            }
    ...
    public void delete() {
        if (this.albumShowRvAdapter.isSelectMode() && this.albumShowRvAdapter.hasPicSelected()) {
            new DeleteMediaDialog(getContext(), getContext().getString(C2640R.string.dialog_delete_these_files), new C276410()).show();
        }
    }
    ...
    public void onItemClick(LocalFile localFile, int i) {
        int i2 = C276612.$SwitchMap$com$ipotensic$baselib$enums$FileTypeEnum[localFile.getFileTypeEnum().ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
                return;
            }
    ...
    public void isHasItemSelected(List<LocalFile> list) {
        ...
        while (it.hasNext()) {
            if (it.next().isSelect()) {
                this.btnDelete.setImageResource(C2640R.mipmap.icon_btn_media_delete);
                this.btnShare.setImageResource(C2640R.mipmap.icon_btn_media_share);
                this.tvSelect.setTextColor(getContext().getResources().getColor(C2640R.color.colorBlack));
                return;
            }
        }
    }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        if (this.albumShowRvAdapter != null) {
            if (i == 99) {
                DDLog.m1691w("photo size:" + LocalFileManager.getInstance().getPhotoList().size());
                this.albumShowRvAdapter.updateAdapterList(LocalFileManager.getInstance().getPhotoList());
            } else if (i == 98) {
                DDLog.m1691w("video size:" + LocalFileManager.getInstance().getVideoList().size());
    ...
    /* renamed from: com.ipotensic.potensicpro.activities.MainMediaController$12 */
    static /* synthetic */ class C276612 {
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        if (C276612.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()] != 1) {
            return;
        }
        refreshAdapter();
    }
