...
public class SplashActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C2640R.layout.activity_splash);
        this.ivBg = (ImageView) findViewById(C2640R.id.iv_background);
        initView();
        initData();
    ...
    public void onAgreeProtocol(long j) {
        PhoneConfig.mainHandler.postDelayed(new Runnable() { // from class: com.ipotensic.potensicpro.activities.SplashActivity.2
            ...
            public void run() {
                DDLog.m1684e("splash 开始启动... : " + ActivityHelper.getInstance().isActivityRunning(PhoneConfig.usrToken == null ? LoginActivity.class : MainActivity.class));
    ...
    private void initView() {
        this.tvExplain = (TextView) findViewById(C2640R.id.tv_explain);
        this.layoutIndicator = (LinearLayout) findViewById(C2640R.id.layout_indicator);
        this.btnStart = (Button) findViewById(C2640R.id.btn_start);
        this.viewPager = (ViewPager) findViewById(C2640R.id.view_pager);
        this.btnSkip = (TextView) findViewById(C2640R.id.btn_skip);
        setOnClickListener();
    }
    ...
    private void initData() {
        this.explains = getResources().getStringArray(C2640R.array.welcome_speech);
        View inflate = LayoutInflater.from(this).inflate(C2640R.layout.view_splash_l, (ViewGroup) null);
        View inflate2 = LayoutInflater.from(this).inflate(C2640R.layout.view_splash_ll, (ViewGroup) null);
        View inflate3 = LayoutInflater.from(this).inflate(C2640R.layout.view_splash_lll, (ViewGroup) null);
        addPage(inflate);
        addPage(inflate2);
        addPage(inflate3);
    ...
    private void addPage(View view) {
        ...
        try {
            ...
            DDLog.m1686e(TAG, "dp2px转换出错", e);
        }
        layoutParams.setMargins(i, i, i, i);
        imageView.setImageResource(C2640R.drawable.level_splash_indicator);
