...
public class VideoTeachActivity extends BaseActivity implements View.OnClickListener, IGetTeachVideoView {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C2640R.layout.activity_video_teach);
        initView();
        setToolBar();
    ...
    private void setToolBar() {
        ...
        ((TextView) toolbar.findViewById(C2640R.id.tv_code_title)).setText(getResources().getString(C2640R.string.main_video_teaching));
    ...
    private void initView() {
        ...
        this.tvNoNetWorkTips = (TextView) findViewById(C2640R.id.tv_no_network);
    }
    ...
    private void setNoContentUI() {
        ...
        this.tvNoNetWorkTips.setText(getText(C2640R.string.txt_no_content));
    }
    ...
    private void setNoNetworkUI() {
        ...
        this.tvNoNetWorkTips.setText(getText(C2640R.string.no_net_work));
    }
    ...
    private class VideoTeachAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new ViewHolder(LayoutInflater.from(VideoTeachActivity.this).inflate(C2640R.layout.view_adapter_video_teach, viewGroup, false));
        }
        ...
        private class ViewHolder extends RecyclerView.ViewHolder {
            ...
            private ViewHolder(View view) {
                ...
                this.ivVideoThumbnail = (ImageView) view.findViewById(C2640R.id.iv_video);
            }
        }
    }
