...
public class UserAgreementActivity2 extends BaseActivity implements View.OnClickListener {
    ...
    private SmartScrollView.onScrollViewScrollChanged listener = new SmartScrollView.onScrollViewScrollChanged() { // from class: com.ipotensic.potensicpro.activities.UserAgreementActivity2.2
        ...
        public void onObservableScrollViewScrollChanged(int i, int i2, int i3, int i4) {
            if (UserAgreementActivity2.this.privacyHeight == 0 || i2 <= UserAgreementActivity2.this.privacyHeight) {
                ...
                UserAgreementActivity2.this.tvTitle.setText(UserAgreementActivity2.this.getString(C2640R.string.user_agreement));
                return;
            }
            UserAgreementActivity2.this.tvTitle.setVisibility(0);
            UserAgreementActivity2.this.tvTitle.setText(UserAgreementActivity2.this.getString(C2640R.string.privacy_policy));
        }
    };
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C2640R.layout.activity_user_agree);
        setToolBar();
        showLoadingDialog();
        initData();
    }
    ...
    private void setToolBar() {
        ...
        TextView textView = (TextView) toolbar.findViewById(C2640R.id.tv_code_title);
        this.tvTitle1 = textView;
        textView.setText(getResources().getString(C2640R.string.user_agreement));
        ...
        ((FrameLayout) findViewById(C2640R.id.fl_web_container)).addView(this.webView, new FrameLayout.LayoutParams(-1, -1));
    }
            ...
            public void onFailure(Call call, IOException iOException) {
                UserAgreementActivity2.this.runOnUiThread(new Runnable() { // from class: com.ipotensic.potensicpro.activities.UserAgreementActivity2.1.1
                    ...
                    public void run() {
                        ...
                        ToastUtil.toast(UserAgreementActivity2.this, UserAgreementActivity2.this.getResources().getString(C2640R.string.please_check_the_network));
                    }
                });
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                UserAgreementActivity2.this.runOnUiThread(new Runnable() { // from class: com.ipotensic.potensicpro.activities.UserAgreementActivity2.1.2
                    ...
                    public void run() {
                        ...
                        ToastUtil.toast(UserAgreementActivity2.this, PhoneConfig.applicationContext.getString(C2640R.string.toast_no_network));
                    }
                });
            }
        });
