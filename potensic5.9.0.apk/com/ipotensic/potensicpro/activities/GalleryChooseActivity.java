...
public class GalleryChooseActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C2640R.layout.activity_gallery_choose);
        initView();
        initData();
    }

    private void initView() {
        RecyclerView recyclerView = (RecyclerView) findViewById(C2640R.id.recycler_view);
        ...
        findViewById(C2640R.id.iv_back).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.potensicpro.activities.GalleryChooseActivity.1
        ...
        new Thread(new Runnable() { // from class: com.ipotensic.potensicpro.activities.GalleryChooseActivity.2
            ...
            public void run() {
                try {
                    ...
                    DDLog.m1684e("获取所有本地图片出错:" + e.getMessage());
                }
            }
        }).start();
    }
    ...
    private class BaseAdapter extends RecyclerView.Adapter<BaseViewHolder> {
        ...
        public BaseViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return GalleryChooseActivity.this.new BaseViewHolder(LayoutInflater.from(GalleryChooseActivity.this).inflate(C2640R.layout.view_adapter_gallery_choose, viewGroup, false));
        }
    ...
    private class BaseViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public BaseViewHolder(View view) {
            super(view);
            ImageView imageView = (ImageView) view.findViewById(C2640R.id.iv_photo);
