...
public class LoginForgetPasswordController extends BaseController implements View.OnClickListener, IForgetPwView {
    ...
    public void initView(View view) {
        view.findViewById(C2640R.id.btn_return).setOnClickListener(this);
    ...
    class MyTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            if (FormatUtil.isEmail(editable.toString().trim())) {
                LoginForgetPasswordController.this.btnNext.setBackgroundResource(C2640R.mipmap.img_btn_tell_us_selected);
            } else {
                LoginForgetPasswordController.this.btnNext.setBackgroundResource(C2640R.mipmap.img_btn_tell_us_normal);
            }
        }
    }
    ...
    public void onClick(View view) {
        ...
        int id = view.getId();
        if (id == C2640R.id.btn_next) {
            forgetPw();
        } else if (id == C2640R.id.btn_return && (onForgetPasswordListener = this.forgetPasswordListener) != null) {
    ...
    private void forgetPw() {
        ...
        if (!FormatUtil.isEmail(replace)) {
            ToastUtil.toast(getContext(), getContext().getString(C2640R.string.toast_correct_email_address));
            return;
        }
    ...
    public void onForgetTokenFail(String str) {
        ToastUtil.toast(getContext(), getContext().getString(C2640R.string.toast_failed_forget_password));
        OnForgetPasswordListener onForgetPasswordListener = this.forgetPasswordListener;
        if (onForgetPasswordListener != null) {
            onForgetPasswordListener.dismissLoadingDialog();
        }
    ...
    public void onForgetError(String str) {
        ToastUtil.toast(getContext(), getContext().getString(C2640R.string.enter_email_tips));
        OnForgetPasswordListener onForgetPasswordListener = this.forgetPasswordListener;
        if (onForgetPasswordListener != null) {
            onForgetPasswordListener.dismissLoadingDialog();
        }
