...
public class FlightRecordActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C2640R.layout.activity_flight_record);
        initData();
        initView();
        setToolBar();
    }
    ...
    private void setToolBar() {
        ...
        ((TextView) this.toolbar.findViewById(C2640R.id.tv_code_title)).setText(getResources().getString(C2640R.string.main_flight_record));
    ...
    private void initView() {
        this.ivEmpty = (ImageView) findViewById(C2640R.id.iv_empty);
        this.tvEmpty = (TextView) findViewById(C2640R.id.tv_empty);
        this.recyclerView = (RecyclerView) findViewById(C2640R.id.rv_view);
    ...
    private class FlightRecordAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new ViewHolder(LayoutInflater.from(FlightRecordActivity.this).inflate(C2640R.layout.view_adapter_flight_record, viewGroup, false));
        }
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            ...
            if (SPHelper.getInstance().isFt()) {
                viewHolder.tvDistance.setText(String.format(FlightRecordActivity.this.getString(C2640R.string.units_ft), Double.valueOf(flightNotes.getDistance() * 3.28083989501d)));
                viewHolder.tvSpeed.setText(String.format(FlightRecordActivity.this.getString(C2640R.string.units_mph), Double.valueOf(flightNotes.getSpeed() * 2.23693632d)));
                viewHolder.tvHeight.setText(String.format(FlightRecordActivity.this.getString(C2640R.string.units_ft), Double.valueOf(flightNotes.getHeight() * 3.28083989501d)));
            } else {
                viewHolder.tvDistance.setText(String.format(FlightRecordActivity.this.getString(C2640R.string.units_m), Double.valueOf(flightNotes.getDistance())));
                viewHolder.tvSpeed.setText(String.format(FlightRecordActivity.this.getString(C2640R.string.units_ms), Double.valueOf(flightNotes.getSpeed())));
                viewHolder.tvHeight.setText(String.format(FlightRecordActivity.this.getString(C2640R.string.units_m), Double.valueOf(flightNotes.getHeight())));
            }
        }
        ...
        private class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            private ViewHolder(View view) {
                super(view);
                this.tvDate = (TextView) view.findViewById(C2640R.id.tv_date);
                this.tvDuration = (TextView) view.findViewById(C2640R.id.tv_duration);
                this.tvDistance = (TextView) view.findViewById(C2640R.id.tv_distance);
                this.tvSpeed = (TextView) view.findViewById(C2640R.id.edt_speed);
                this.tvHeight = (TextView) view.findViewById(C2640R.id.tv_height);
                view.findViewById(C2640R.id.delete).setOnClickListener(this);
            }

            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (view.getId() == C2640R.id.delete) {
