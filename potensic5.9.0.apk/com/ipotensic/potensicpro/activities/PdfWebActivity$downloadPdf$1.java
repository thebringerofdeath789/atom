...
final class PdfWebActivity$downloadPdf$1 implements Runnable {
    ...
    public final void run() {
        try {
            ...
            okHttpUtil.downloadFileSync(1000, str, localFileManager.getPDF_DIR(), this.this$0.getFileName(), System.currentTimeMillis(), new C28101());
        } catch (Exception e) {
            DDLog.m1685e("PdfWebActivity", "downloadPdf..." + e);
        }
    }
    ...
    /* renamed from: com.ipotensic.potensicpro.activities.PdfWebActivity$downloadPdf$1$1 */
    public static final class C28101 implements DownloadListener {
        ...
        public void onDownloadStart() {
            DDLog.m1685e("PdfWebActivity", "onDownloadStart......");
        }

        @Override // com.ipotensic.baselib.okhttp.DownloadListener
        public void onDownloadProgress(float progress, long total) {
            DDLog.m1685e("PdfWebActivity", "onDownloadProgress......" + progress + PropertyUtils.INDEXED_DELIM + total + PropertyUtils.INDEXED_DELIM2);
        }

        @Override // com.ipotensic.baselib.okhttp.DownloadListener
        public void onDownloadEnd(String filePath) {
            DDLog.m1685e("PdfWebActivity", "onDownloadFinished......");
        ...
        public void onDownloadError(Exception e) {
            DDLog.m1685e("PdfWebActivity", "onDownloadError......" + e);
            PdfWebActivity$downloadPdf$1.this.this$0.runOnUiThread(new Runnable() { // from class: com.ipotensic.potensicpro.activities.PdfWebActivity$downloadPdf$1$1$onDownloadError$1
                ...
                public final void run() {
                    PdfWebActivity$downloadPdf$1.this.this$0.hideLoading();
                    ToastUtil.toast(PdfWebActivity$downloadPdf$1.this.this$0, PdfWebActivity$downloadPdf$1.this.this$0.getResources().getString(C2640R.string.dialog_download_failure));
        ...
        public void notEnoughSpace() {
            DDLog.m1685e("PdfWebActivity", "notEnoughSpace......");
