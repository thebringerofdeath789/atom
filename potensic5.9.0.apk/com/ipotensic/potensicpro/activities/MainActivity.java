...
public class MainActivity extends BaseActivity implements OnNetworkChangeListener, IUnreadMsgView, EventDispatcher.OnEventListener {
    ...
    private FwDownloadHelper.DownloadResultListener onResultListener = new FwDownloadHelper.DownloadResultListener() { // from class: com.ipotensic.potensicpro.activities.MainActivity.9
        ...
        public void downloadFailed() {
            if (MainActivity.this.isRevUpgradeMode) {
                ...
                ToastUtil.toast(mainActivity, mainActivity.getString(C2640R.string.txt_no_fireware_file_tips));
            }
        }
    };
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C2640R.layout.activity_main);
        ...
        this.mainDeviceController = new MainDeviceController(this, findViewById(C2640R.id.layout_device));
        this.mainAcademyController = new MainAcademyController(this, (ViewStub) findViewById(C2640R.id.stub_academy));
        MainMediaController mainMediaController = new MainMediaController(this, (ViewStub) findViewById(C2640R.id.stub_media));
        this.mainMediaController = mainMediaController;
        mainMediaController.setMediaControllerListener(this.mediaControllerListener);
        this.mainMeController = new MainMeController(this, (ViewStub) findViewById(C2640R.id.stub_me));
        this.layoutBottomTab = (LinearLayout) findViewById(C2640R.id.layoutBottomTab);
        this.btnTabDevice = (TextView) findViewById(C2640R.id.btnTabDevice);
        this.btnTabAcademy = (TextView) findViewById(C2640R.id.btnTabAcademy);
        this.btnTabGallery = (TextView) findViewById(C2640R.id.btnTabGallery);
        this.btnTabMe = (TextView) findViewById(C2640R.id.btnTabMe);
    ...
    private void initObserver() {
        ...
        this.mainViewModel.isAtomSeries().observe(this, new Observer() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$MainActivity$EffjaXnlewjLRAcGSIIgBFzpA_E
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                MainActivity.lambda$initObserver$3((Boolean) obj);
            }
        });
    ...
    public /* synthetic */ void lambda$initObserver$4$MainActivity(Integer num) {
        ...
        int i = C2640R.color.text_color_setting_blue;
        textView.setTextColor(getColor(intValue == 0 ? C2640R.color.text_color_setting_blue : C2640R.color.color_main_media_indicator_gray));
        this.btnTabAcademy.setTextColor(getColor(num.intValue() == 1 ? C2640R.color.text_color_setting_blue : C2640R.color.color_main_media_indicator_gray));
        this.btnTabGallery.setTextColor(getColor(num.intValue() == 2 ? C2640R.color.text_color_setting_blue : C2640R.color.color_main_media_indicator_gray));
        TextView textView2 = this.btnTabMe;
        if (num.intValue() != 3) {
            i = C2640R.color.color_main_media_indicator_gray;
        }
        textView2.setTextColor(getColor(i));
        ViewUtils.setDrawableTop(this.btnTabDevice, num.intValue() == 0 ? C2640R.mipmap.img_btn_main_tab_equipme_selected : C2640R.mipmap.img_btn_main_tab_equipme_normal);
        ViewUtils.setDrawableTop(this.btnTabAcademy, num.intValue() == 1 ? C2640R.mipmap.icon_academy_selected : C2640R.mipmap.icon_academy_normal);
        ViewUtils.setDrawableTop(this.btnTabGallery, num.intValue() == 2 ? C2640R.mipmap.img_btn_main_tab_media_selected : C2640R.mipmap.img_btn_main_tab_media_normal);
        setTabUnReadView();
    ...
    public void setCurrentTab(int i) {
        ...
        DDLog.m1685e("固件下载", "PhoneConfig.appUpgradeVersion: " + PhoneConfig.appUpgradeVersion);
    ...
    private void setTabUnReadView() {
        ...
        if (value.intValue() == 3) {
            ViewUtils.setDrawableTop(this.btnTabMe, value2.intValue() > 0 ? C2640R.drawable.bg_tab_me_unread_selected : C2640R.mipmap.img_btn_main_tab_me_selected);
        } else {
            ViewUtils.setDrawableTop(this.btnTabMe, value2.intValue() > 0 ? C2640R.drawable.bg_tab_me_unread_normal : C2640R.mipmap.img_btn_main_tab_me_normal);
        }
    }
    ...
    private void showUpdateNoFlyZoneDataDialog() {
        if (this.updateNoFlyZoneDataDialog == null) {
            this.updateNoFlyZoneDataDialog = new GeneralDialog((Context) this, false, getString(C2640R.string.popup_drone_safety_data_needs_updating_title), getString(C2640R.string.popup_drone_safety_data_needs_updating_tips), getString(C2640R.string.button_copy_address_and_close), new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$MainActivity$nMKpB23HnQo757Q7VAHlYp5YFxw
    ...
    public /* synthetic */ void lambda$showUpdateNoFlyZoneDataDialog$6$MainActivity() {
        ...
        DDLog.m1684e("showUpdateNoFlyZoneDataDialog isShow:" + SPHelper.getInstance().isShowUpdateNoFlyZoneData(flightSN) + ",sn=" + flightSN);
    }
    ...
    public void downloadFromPGY() {
        try {
            ...
            DDLog.m1684e("跳转失败：" + e.getMessage());
        }
    }
    ...
    public void downloadFromGooglePlay(String str) {
        try {
            ...
            DDLog.m1684e("GoogleMarket Intent not found");
        }
    }
    ...
    public boolean isAllowChange(int i) {
        if (i == 2) {
            if (!PermissionUtil.hasStoragePermission(this)) {
                ...
                PermissionUtil.requestStoragePermissionWithDialog(this, new C27297());
                return false;
            }
    ...
    class C27297 implements PermissionUtil.OnPermissionListener {
    ...
    public void onNetworkChanged(NetworkType networkType) {
        this.mainViewModel.checkAppVersionUpdate();
        DDLog.m1687i("是否连接飞机:" + PhoneConfig.isConnectFlightWifi());
    ...
    public void upgradeFinish() {
        DDLog.m1684e("固件下载:获取固件信息0 :" + (!SPHelper.getInstance().getIsBigPackage()));
        if (BaseSyncDialog.isShow || SPHelper.getInstance().getIsBigPackage()) {
            return;
        }
        DDLog.m1684e("固件下载:获取固件信息");
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        switch (C272311.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()]) {
            case 1:
