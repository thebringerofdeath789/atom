...
public class CompanyContactActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C2640R.layout.activity_company_contact);
        setToolBar();
        ((TextView) findViewById(C2640R.id.tv_email_content)).setText(getString(C2640R.string.me_our_email));
        TextView textView = (TextView) findViewById(C2640R.id.tv_website_link);
        textView.setText(Html.fromHtml(getString(C2640R.string.me_www)));
    ...
    private void setToolBar() {
        ...
        toolbar.findViewById(C2640R.id.iv_back).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.potensicpro.activities.CompanyContactActivity.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                CompanyContactActivity.this.finish();
            }
        });
        ((TextView) this.toolbar.findViewById(C2640R.id.tv_code_title)).setText(C2640R.string.me_contact_us);
