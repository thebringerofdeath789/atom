...
public class MainMediaPhotoViewerActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        DDLog.m1691w("curPosition:" + this.curPosition);
        setContentView(C2640R.layout.activity_main_photo_viewer);
        this.layoutTop = (ConstraintLayout) findViewById(C2640R.id.layout_top);
        this.layoutBottom = (ConstraintLayout) findViewById(C2640R.id.layout_bottom);
        this.layoutMain = (ConstraintLayout) findViewById(C2640R.id.layout_main);
        this.imgReturn = (ImageView) findViewById(C2640R.id.btn_back);
        this.tvCurDate = (TextView) findViewById(C2640R.id.tv_date);
        ...
        findViewById(C2640R.id.btn_media_info).setOnClickListener(new ScaleClickListener() { // from class: com.ipotensic.potensicpro.activities.MainMediaPhotoViewerActivity.2
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view) {
                MainMediaPhotoViewerActivity.this.showMediaInfo();
            }
        });
        findViewById(C2640R.id.btn_media_share).setOnClickListener(new ScaleClickListener(1000) { // from class: com.ipotensic.potensicpro.activities.MainMediaPhotoViewerActivity.3
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view) {
                MainMediaPhotoViewerActivity.this.share();
            }
        });
        findViewById(C2640R.id.btn_delete).setOnClickListener(new ScaleClickListener() { // from class: com.ipotensic.potensicpro.activities.MainMediaPhotoViewerActivity.4
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view) {
    ...
    private void refreshData(boolean z) {
        ...
        for (int i2 = 0; i2 < LocalFileManager.getInstance().getPhotoList().size(); i2++) {
            ...
            if (localFile.getFileTypeEnum() != FileTypeEnum.TYPE_HEAD) {
                ...
                DDLog.m1691w("curPosition1:" + this.curPosition);
                DDLog.m1691w("i:" + i2);
        ...
        LooperViewPager looperViewPager = (LooperViewPager) findViewById(C2640R.id.loop_viewpager);
        ...
        this.mCycleViewPager.setOnPageChangeListener(new LooperViewPager.OnPageChangeListener() { // from class: com.ipotensic.potensicpro.activities.MainMediaPhotoViewerActivity.5
            ...
            public void onPageSelected(int i4) {
                DDLog.m1687i("curindex :" + MainMediaPhotoViewerActivity.this.curPosition);
    ...
    public synchronized void delete() {
        new DeleteMediaDialog(this, getString(C2640R.string.dialog_delete_this_file), new DeleteMediaDialog.DeleteMediaListener() { // from class: com.ipotensic.potensicpro.activities.MainMediaPhotoViewerActivity.6
            @Override // com.ipotensic.kernel.view.dialog.DeleteMediaDialog.DeleteMediaListener
            public void delete() {
                final LocalFile localFile = (LocalFile) MainMediaPhotoViewerActivity.this.files.get(MainMediaPhotoViewerActivity.this.curPosition);
                if (Build.VERSION.SDK_INT >= 30) {
                    ...
                    LocalFileManager.getInstance().deleteFiles(MainMediaPhotoViewerActivity.this, arrayList, new MediaFileUtils.OnDeleteResultListener() { // from class: com.ipotensic.potensicpro.activities.MainMediaPhotoViewerActivity.6.1
                        ...
                        public void onResult(boolean z) {
                            if (z) {
                                MainMediaPhotoViewerActivity.this.refreshUIAfterDeleteFile(localFile);
                            }
                        }
                    });
                } else {
    ...
    public void share() {
        ...
        if (PhoneConfig.isConnectFlightWifi() || NetworkUtils.getNetworkState(this) < 0) {
            new GeneralDialog(this, getResources().getString(C2640R.string.txt_dialog_make_sure_internet_title), getResources().getString(C2640R.string.txt_dialog_make_sure_internet_detail), 0, new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.potensicpro.activities.MainMediaPhotoViewerActivity.7
    ...
    public Uri getShareFileUri() {
        ...
        DDLog.m1684e("file name :" + localFile.getAbsPath());
    ...
    private class CyclePagerAdapter extends PagerAdapter {
            ...
            this.photoClickListener = new View.OnClickListener() { // from class: com.ipotensic.potensicpro.activities.MainMediaPhotoViewerActivity.CyclePagerAdapter.1
                ...
                public void onClick(View view) {
                    ...
                    if (MainMediaPhotoViewerActivity.this.layoutTop.getVisibility() == 0) {
                        ...
                        i = C2640R.color.colorWhite;
                    } else {
                        resources = CyclePagerAdapter.this.context.getResources();
                        i = C2640R.color.black;
                    }
        ...
        public Object instantiateItem(ViewGroup viewGroup, int i) {
            ...
            DDLog.m1691w("load image curposition:" + MainMediaPhotoViewerActivity.this.curPosition);
