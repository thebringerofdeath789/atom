...
public class ModifyLoginPwdActivity extends BaseActivity implements View.OnClickListener, IChangePswView {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C2640R.layout.activity_modify_login_pwd);
        initView();
    }

    private void initView() {
        findViewById(C2640R.id.btn_return).setOnClickListener(this);
        Button button = (Button) findViewById(C2640R.id.btn_confirm);
        this.btnConfirm = button;
        button.setOnClickListener(this);
        this.etOldPwd = (EditText) findViewById(C2640R.id.et_old_pwd);
        this.etNewPwd = (EditText) findViewById(C2640R.id.et_new_pwd);
        this.etConfirmPwd = (EditText) findViewById(C2640R.id.et_confirm_new_pwd);
        this.tvPwdErrorTips1 = (TextView) findViewById(C2640R.id.tv_pwd_error_tips_1);
        this.tvPwdErrorTips2 = (TextView) findViewById(C2640R.id.tv_pwd_error_tips_2);
        this.tvPwdErrorTips3 = (TextView) findViewById(C2640R.id.tv_pwd_error_tips_3);
        ...
        public void afterTextChanged(Editable editable) {
            if (this.mViewId != ModifyLoginPwdActivity.this.etOldPwd.getId()) {
                if (this.mViewId != ModifyLoginPwdActivity.this.etNewPwd.getId()) {
                    if (this.mViewId == ModifyLoginPwdActivity.this.etConfirmPwd.getId()) {
                        ...
                        if (ModifyLoginPwdActivity.this.confirmPwd.length() > 0) {
                            ModifyLoginPwdActivity.this.etConfirmPwd.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, (Drawable) null, ModifyLoginPwdActivity.this.getResources().getDrawable(C2640R.mipmap.img_icon_pwd_unlock), (Drawable) null);
                        } else {
                            ModifyLoginPwdActivity.this.etConfirmPwd.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, (Drawable) null, ModifyLoginPwdActivity.this.getResources().getDrawable(C2640R.mipmap.img_icon_pwd_lock), (Drawable) null);
                        }
                    ...
                    if (ModifyLoginPwdActivity.this.newPwd.length() > 0) {
                        ModifyLoginPwdActivity.this.etNewPwd.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, (Drawable) null, ModifyLoginPwdActivity.this.getResources().getDrawable(C2640R.mipmap.img_icon_pwd_unlock), (Drawable) null);
                    } else {
                        ModifyLoginPwdActivity.this.etNewPwd.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, (Drawable) null, ModifyLoginPwdActivity.this.getResources().getDrawable(C2640R.mipmap.img_icon_pwd_lock), (Drawable) null);
                    }
                ...
                if (ModifyLoginPwdActivity.this.oldPwd.length() > 0) {
                    ModifyLoginPwdActivity.this.etOldPwd.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, (Drawable) null, ModifyLoginPwdActivity.this.getResources().getDrawable(C2640R.mipmap.img_icon_pwd_unlock), (Drawable) null);
                } else {
                    ModifyLoginPwdActivity.this.etOldPwd.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, (Drawable) null, ModifyLoginPwdActivity.this.getResources().getDrawable(C2640R.mipmap.img_icon_pwd_lock), (Drawable) null);
                }
            ...
            if (!FormatUtil.isTruePassword(ModifyLoginPwdActivity.this.oldPwd) || !FormatUtil.passwordLength(ModifyLoginPwdActivity.this.newPwd) || !FormatUtil.passwordLength(ModifyLoginPwdActivity.this.confirmPwd)) {
                ...
                ModifyLoginPwdActivity.this.btnConfirm.setBackgroundResource(C2640R.mipmap.img_btn_tell_us_normal);
            } else {
                ModifyLoginPwdActivity.this.btnConfirm.setBackgroundResource(C2640R.mipmap.img_btn_tell_us_selected);
    ...
    public void onClick(View view) {
        int id = view.getId();
        if (id == C2640R.id.btn_return) {
            finish();
            return;
        }
        if (id != C2640R.id.btn_confirm || TextUtils.isEmpty(this.newPwd) || TextUtils.isEmpty(this.confirmPwd) || TextUtils.isEmpty(this.oldPwd)) {
            return;
        }
        if (this.newPwd.equals(this.oldPwd)) {
            ToastUtil.toast(this, getString(C2640R.string.toast_not_same_new_psw));
            return;
        }
        if (!this.newPwd.equals(this.confirmPwd)) {
            ToastUtil.toast(this, getString(C2640R.string.toast_not_same_psw));
            return;
        }
        if (!FormatUtil.passwordLength(this.oldPwd) || !FormatUtil.passwordLength(this.newPwd)) {
            ToastUtil.toast(this, getString(C2640R.string.password_error_tips));
    ...
    public void onChangePswSuccess() {
        ...
        new GeneralDialog((Context) this, getString(C2640R.string.dialog_success), getString(C2640R.string.dialog_password_modify_success), C2640R.mipmap.img_dialog_upgrade_success, true, new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.potensicpro.activities.ModifyLoginPwdActivity.3
    ...
    public void onChangePswFailed(String str) {
        dismissLoadingDialog();
        new GeneralDialog((Context) this, getString(C2640R.string.dialog_failure), getString(C2640R.string.dialog_password_modify_failure), C2640R.mipmap.img_dialog_failure, true, new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.potensicpro.activities.ModifyLoginPwdActivity.4
            @Override // com.ipotensic.kernel.view.dialog.GeneralDialog.ClickConfirmListener
            public void confirm() {
            }
        }).show();
