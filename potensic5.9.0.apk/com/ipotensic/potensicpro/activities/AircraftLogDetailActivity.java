...
public class AircraftLogDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        this.f2366rv = (RecyclerView) findViewById(C2640R.id.f2310rv);
        ...
        this.f2366rv.addItemDecoration(new DividerLineaItemDecoration());
        this.f2366rv.setLayoutManager(myLinearLayoutManager);
        AircraftLogAdapter aircraftLogAdapter = new AircraftLogAdapter();
        this.logAdapter = aircraftLogAdapter;
        this.f2366rv.setAdapter(aircraftLogAdapter);
    }
    ...
    private class AircraftLogAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new ViewHolder(LayoutInflater.from(AircraftLogDetailActivity.this).inflate(C2640R.layout.view_adapter_aircraft_log, viewGroup, false));
        }
        ...
        public void loadLog(final LogBean logBean, final int i, String str, String str2) {
            ...
            UserRequestPresenter.getInstance().flightLogs(PhoneConfig.usrToken, strArr, str, str2, new IFlightLogView() { // from class: com.ipotensic.potensicpro.activities.AircraftLogDetailActivity.AircraftLogAdapter.2
                ...
                public void uploadSuccess() {
                    ToastUtil.toast(AircraftLogDetailActivity.this, AircraftLogDetailActivity.this.getString(C2640R.string.toast_upload_success));
                    DDLog.m1685e("flightLog", "上传成功");
                ...
                public void uploadError(Exception exc) {
                    if (exc instanceof UnknownHostException) {
                        ToastUtil.toast(AircraftLogDetailActivity.this, PhoneConfig.applicationContext.getString(C2640R.string.toast_no_network));
                    } else {
                        ToastUtil.toast(AircraftLogDetailActivity.this, AircraftLogDetailActivity.this.getString(C2640R.string.toast_upload_fail));
                    }
                ...
                public void fileIsExist() {
                    ToastUtil.toast(AircraftLogDetailActivity.this, AircraftLogDetailActivity.this.getString(C2640R.string.toast_upload_file_exist));
                ...
                public void notFrequentlyUpload() {
                    ToastUtil.toast(AircraftLogDetailActivity.this, AircraftLogDetailActivity.this.getString(C2640R.string.toast_upload_not_frequently));
                ...
                public void missFiles() {
                    ToastUtil.toast(AircraftLogDetailActivity.this, AircraftLogDetailActivity.this.getString(C2640R.string.toast_upload_miss_parameters));
                ...
                public void onProgress(float f, long j) {
                    ...
                    if (i2 != this.curProgress) {
                        DDLog.m1684e("progress:" + i2 + ",totalLen:" + j);
                        this.curProgress = i2;
        ...
        private class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            private ViewHolder(View view) {
                super(view);
                this.tvName = (TextView) view.findViewById(C2640R.id.tv_name);
            ...
            public void onClick(View view) {
                ...
                if (id == C2640R.id.iv_delete) {
                    synchronized (AircraftLogDetailActivity.this.deleteLock) {
                        File file = new File(filePath);
                        if (file.exists()) {
                            boolean delete = file.delete();
                            DDLog.m1684e("删除日志文件:" + file.getAbsolutePath());
                            DDLog.m1684e("日志文件是否删除成功:" + delete);
                        }
                        if (adapterPosition >= AircraftLogDetailActivity.this.logs.size()) {
                            return;
                        }
                        ToastUtil.toast(AircraftLogDetailActivity.this, AircraftLogDetailActivity.this.getString(C2640R.string.toast_delete_success));
                        ...
                        if (AircraftLogDetailActivity.this.logs.size() == 0) {
                            AircraftLogDetailActivity.this.f2366rv.setVisibility(8);
