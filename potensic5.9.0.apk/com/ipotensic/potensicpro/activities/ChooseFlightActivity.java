...
public class ChooseFlightActivity extends BaseActivity implements EventDispatcher.OnEventListener {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C2640R.layout.activity_device);
        initView();
    ...
    private void initView() {
        this.layoutDevice = (ViewStub) findViewById(C2640R.id.stub_list);
        this.listController = new DeviceListController(this, this.layoutDevice);
        DeviceMethodController deviceMethodController = new DeviceMethodController(this, (ViewStub) findViewById(C2640R.id.stub_method));
    ...
    public void finish() {
        super.finish();
        if (this.type == 0) {
            overridePendingTransition(0, C2640R.anim.trans_out_top);
        }
    }
    ...
    /* renamed from: com.ipotensic.potensicpro.activities.ChooseFlightActivity$3 */
    static /* synthetic */ class C26563 {
    ...
    public void onEvent(EventID eventID, Event event) {
        int i = C26563.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()];
        if (i == 1) {
            if (isFinishing()) {
                return;
            }
            DDLog.m1684e("已获取遥控器版本号");
        ...
        if (i == 3) {
            ...
            if (i == 5 && !ActivityHelper.getInstance().isActivityRunning(KernelActivity.class)) {
                PermissionUtil.requestAllPermissionWithDialog(this, new C26552());
            }
        }
    }

    /* renamed from: com.ipotensic.potensicpro.activities.ChooseFlightActivity$2 */
    class C26552 implements PermissionUtil.OnPermissionListener {
