...
public class InstructionActivity extends BaseActivity implements View.OnClickListener, IGetPdfView {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C2640R.layout.activity_instruction);
        initView();
        try {
            getLocalPdfFile();
        } catch (Exception e) {
            DDLog.m1684e("获取本地pdf报错:" + e.getMessage());
        }
    ...
    private void setToolBar() {
        ...
        ((TextView) toolbar.findViewById(C2640R.id.tv_code_title)).setText(getResources().getString(C2640R.string.main_instructions));
    ...
    private void initView() {
        RecyclerView recyclerView = (RecyclerView) findViewById(C2640R.id.rv_view);
        ...
        this.ivBlank = (ImageView) findViewById(C2640R.id.iv_blank);
        this.tvNoNetWork = (TextView) findViewById(C2640R.id.tv_no_network);
    }
    ...
    private void getLocalPdfFile() throws Exception {
        ...
        if (file.exists() && (listFiles = file.listFiles()) != null && listFiles.length > 0) {
            for (File file2 : listFiles) {
                DDLog.m1685e("pdf", " pdf 文件名 name: " + file2.getName() + ", 文件大小： " + file2.length());
            ...
            if (pdfInfo != null) {
                ...
                DDLog.m1685e("pdf", " SP 保存在本地的文件: " + this.localDocuments.toString());
            }
                ...
                for (int i = 0; i < this.localFiles.size(); i++) {
                    ...
                    while (true) {
                        ...
                        if (this.localFiles.get(i).fileName.equals(getFileName(this.localDocuments.get(i2)))) {
                            DDLog.m1685e("pdf", "本地文件大小： " + this.localFiles.get(i).fileSize + ", 服务器文件大小：" + this.localDocuments.get(i2).getFilesize());
                            if (this.localFiles.get(i).fileSize == this.localDocuments.get(i2).getFilesize()) {
                                this.documents.add(this.localDocuments.get(i2));
                            } else {
                                DDLog.m1685e("pdf", "文件删除成功： " + new File(getLocalPdfPath(), this.localFiles.get(i).fileName).delete());
                            }
                        } else {
                            i2++;
                        }
            ...
            DDLog.m1685e("pdf", " localDocuments的大小: " + this.localDocuments.size() + ", documents的大小: " + this.documents.size());
        }
    ...
    private boolean compareSize(String str, String str2) {
        try {
            ...
            DDLog.m1684e("对比出错:" + e.getMessage());
            DDLog.m1684e("file1:" + str);
            DDLog.m1684e("file2:" + str2);
            return false;
        }
    }
    ...
    private void setNoContentUI() {
        ...
        this.ivBlank.setImageResource(C2640R.mipmap.icon_no_content);
        this.tvNoNetWork.setText(getText(C2640R.string.txt_no_content));
    }

    private void setNoNetworkUI() {
        this.ivBlank.setVisibility(0);
        this.tvNoNetWork.setVisibility(0);
        this.ivBlank.setImageResource(C2640R.mipmap.icon_no_network);
        this.tvNoNetWork.setText(getText(C2640R.string.no_net_work));
    }
    ...
    private class InstructionAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new ViewHolder(LayoutInflater.from(InstructionActivity.this).inflate(C2640R.layout.view_adapter_instruction, viewGroup, false));
        }
        ...
        public void onBindViewHolder(final ViewHolder viewHolder, final int i) {
            ...
            if (isDownloaded) {
                viewHolder.progressView.setText(InstructionActivity.this.getString(C2640R.string.end_download));
            } else {
                viewHolder.progressView.setText(InstructionActivity.this.getString(C2640R.string.start_download));
        ...
        private class ViewHolder extends RecyclerView.ViewHolder {
            ...
            private ViewHolder(View view) {
                ...
                this.tvMessage = (TextView) view.findViewById(C2640R.id.tv_message);
                this.imageView = (ImageView) view.findViewById(C2640R.id.iv_img);
                this.progressView = (PDFDownloadProgressView) view.findViewById(C2640R.id.progressView);
            }
        }
    }
    ...
    public void download(int i, RevUserGetPdfResult.Document document, PDFDownloadProgressView pDFDownloadProgressView) {
        ...
        new Thread(new RunnableC26962(document, pDFDownloadProgressView, i)).start();
    }

    /* renamed from: com.ipotensic.potensicpro.activities.InstructionActivity$2 */
    class RunnableC26962 implements Runnable {
        final /* synthetic */ RevUserGetPdfResult.Document val$document;
        final /* synthetic */ int val$position;
        final /* synthetic */ PDFDownloadProgressView val$progressView;

        RunnableC26962(RevUserGetPdfResult.Document document, PDFDownloadProgressView pDFDownloadProgressView, int i) {
            ...
            try {
                ...
                instructionActivity.runOnUiThread(new Runnable() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$InstructionActivity$2$Eu2LRqvj0YZXMHh8l6nzcGgnCYA
                    ...
                    public final void run() {
                        InstructionActivity.RunnableC26962.this.lambda$run$0$InstructionActivity$2(pDFDownloadProgressView, e);
                    }
                });
            }
        }
        ...
        class AnonymousClass1 implements DownloadListener {
            ...
            public void onDownloadStart() {
                RunnableC26962.this.val$progressView.setTag(true);
            ...
            public void onDownloadProgress(final float f, final long j) {
                InstructionActivity instructionActivity = InstructionActivity.this;
                final PDFDownloadProgressView pDFDownloadProgressView = RunnableC26962.this.val$progressView;
                instructionActivity.runOnUiThread(new Runnable() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$InstructionActivity$2$1$WF2tpgLMjHN5THu0na8BSyBFUis
                    @Override // java.lang.Runnable
                    public final void run() {
                        InstructionActivity.RunnableC26962.AnonymousClass1.this.lambda$onDownloadProgress$0$InstructionActivity$2$1(f, j, pDFDownloadProgressView);
                    }
                });
            }
            ...
            public /* synthetic */ void lambda$onDownloadProgress$0$InstructionActivity$2$1(float f, long j, PDFDownloadProgressView pDFDownloadProgressView) {
                int i = (int) f;
                DDLog.m1685e("pdf", "onDownloadProgress......" + i + ", 下载总大小total: " + j);
                pDFDownloadProgressView.setProgress(i);
                pDFDownloadProgressView.setText(InstructionActivity.this.getString(C2640R.string.pdf_downloading) + "(" + i + "%)");
            }
            ...
            public void onDownloadEnd(String str) {
                InstructionActivity instructionActivity = InstructionActivity.this;
                final PDFDownloadProgressView pDFDownloadProgressView = RunnableC26962.this.val$progressView;
                final int i = RunnableC26962.this.val$position;
                instructionActivity.runOnUiThread(new Runnable() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$InstructionActivity$2$1$CBh0qNUiNehcY5UDZYX50x7YuHo
                    @Override // java.lang.Runnable
                    public final void run() {
                        InstructionActivity.RunnableC26962.AnonymousClass1.this.lambda$onDownloadEnd$1$InstructionActivity$2$1(pDFDownloadProgressView, i);
                    }
                });
            }
            ...
            public /* synthetic */ void lambda$onDownloadEnd$1$InstructionActivity$2$1(PDFDownloadProgressView pDFDownloadProgressView, int i) {
                DDLog.m1685e("pdf", "onDownloadFinished......");
                InstructionActivity.this.isDownloading = false;
                pDFDownloadProgressView.setTag(false);
                pDFDownloadProgressView.setText(InstructionActivity.this.getString(C2640R.string.end_download));
                pDFDownloadProgressView.setProgress(0);
                ToastUtil.showImageTop(InstructionActivity.this, InstructionActivity.this.getResources().getString(C2640R.string.toast_download_success), C2640R.mipmap.icon_toast_successful);
            ...
            public void onDownloadError(Exception exc) {
                InstructionActivity instructionActivity = InstructionActivity.this;
                final PDFDownloadProgressView pDFDownloadProgressView = RunnableC26962.this.val$progressView;
                final RevUserGetPdfResult.Document document = RunnableC26962.this.val$document;
                instructionActivity.runOnUiThread(new Runnable() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$InstructionActivity$2$1$CT-DSy2QNdsQ5gqiBjAqROV9uTU
                    @Override // java.lang.Runnable
                    public final void run() {
                        InstructionActivity.RunnableC26962.AnonymousClass1.this.lambda$onDownloadError$2$InstructionActivity$2$1(pDFDownloadProgressView, document);
                    }
                });
            }
            ...
            public /* synthetic */ void lambda$onDownloadError$2$InstructionActivity$2$1(PDFDownloadProgressView pDFDownloadProgressView, RevUserGetPdfResult.Document document) {
                DDLog.m1685e("pdf", "onDownloadError下载出错......");
                InstructionActivity.this.isDownloading = false;
                pDFDownloadProgressView.setTag(false);
                pDFDownloadProgressView.setText(InstructionActivity.this.getString(C2640R.string.start_download));
                pDFDownloadProgressView.setProgress(0);
                OkHttpUtil.getInstance().cancelDownload();
                ...
                ToastUtil.toast(InstructionActivity.this, InstructionActivity.this.getResources().getString(C2640R.string.dialog_download_failure));
            }
        }
        ...
        public /* synthetic */ void lambda$run$0$InstructionActivity$2(PDFDownloadProgressView pDFDownloadProgressView, Exception exc) {
            ...
            if (exc instanceof UnknownHostException) {
                InstructionActivity instructionActivity = InstructionActivity.this;
                ToastUtil.toast(instructionActivity, instructionActivity.getString(C2640R.string.toast_no_network));
            }
        }
    }
