...
public class FeedbackDetailsActivity extends BaseActivity implements View.OnClickListener, IFbCommitResultView, IFeedbackDeleteView, IFeedbackMarkView {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C2640R.layout.activity_feedback_details);
        initView();
        setToolBar();
        initRequest();
    }
    ...
    private void setToolBar() {
        ...
        ImageView imageView = (ImageView) findViewById(C2640R.id.iv_delete);
    ...
    private void initView() {
        this.layoutViewDefault = (LinearLayout) findViewById(C2640R.id.layout_view_default);
        ...
        this.feedbackPreviewController = new FeedbackPreviewController(this, (RelativeLayout) findViewById(C2640R.id.layout_preview));
    }
    ...
    public void onClick(View view) {
        ...
        int id = view.getId();
        int i = C2640R.mipmap.icon_feedback_select;
        if (id == C2640R.id.iv_back) {
            if (this.feedbackPreviewController.getVisibility() == 0) {
                this.feedbackPreviewController.setVisibility(8);
                this.ivDelete.setVisibility(0);
                this.ivDelete.setImageResource(C2640R.mipmap.icon_feedback_select);
                return;
            }
            finish();
            return;
        }
        if (id != C2640R.id.iv_delete || (list = this.data) == null || list.size() <= 0) {
            return;
        }
        ...
        if (this.isDeleteMode && sb.length() > 0) {
            ...
            new GeneralDialog((Context) this, getString(C2640R.string.fb_confirm_delete), getString(C2640R.string.fb_confirm_delete_content), getString(C2640R.string.dialog_cancel), getString(C2640R.string.dialog_confirm), true, false, new GeneralDialog.DialogListener() { // from class: com.ipotensic.potensicpro.activities.FeedbackDetailsActivity.1
        ...
        if (z) {
            i = C2640R.mipmap.icon_feedback_delete;
        }
    ...
    public void getFailed() {
        dismissLoadingDialog();
        ToastUtil.toast(PhoneConfig.runningActivity, PhoneConfig.applicationContext.getString(C2640R.string.toast_no_network));
        this.ivDelete.setVisibility(4);
        this.recyclerView.setVisibility(8);
    }
    ...
    public void deleteSuccess() {
        ...
        this.detailsAdapter.notifyDataSetChanged();
        ToastUtil.toast(this, getString(C2640R.string.toast_delete_success));
    }
    ...
    private class FeedbackDetailsAdapter extends RecyclerView.Adapter<MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new MyViewHolder(LayoutInflater.from(FeedbackDetailsActivity.this).inflate(C2640R.layout.view_adapter_feedback_details, viewGroup, false));
        }
        ...
        private class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, ExpandableViewHoldersUtil.Expandable {
            ...
            public MyViewHolder(View view) {
                ...
                this.clTopLayout = (ConstraintLayout) view.findViewById(C2640R.id.cl_top_layout);
                this.imageView = (ImageView) view.findViewById(C2640R.id.image_view);
                this.tvUserReplyTime1 = (TextView) view.findViewById(C2640R.id.tv_user_time_1);
                this.tvUserReplyContent1 = (TextView) view.findViewById(C2640R.id.tv_user_reply_1);
                this.ivRedPoint = (ImageView) view.findViewById(C2640R.id.iv_red_point);
                this.ivRight = (ImageView) view.findViewById(C2640R.id.iv_right);
                this.ivDown = (ImageView) view.findViewById(C2640R.id.iv_down);
                this.ivVideoView = (ImageView) view.findViewById(C2640R.id.video_view);
                this.rvUserView = (RecyclerView) view.findViewById(C2640R.id.rv_user_feedback);
                this.rvCustomerView = (RecyclerView) view.findViewById(C2640R.id.rv_customer_feedback);
                this.clCustomerLayout = (ConstraintLayout) view.findViewById(C2640R.id.cl_customer_layout);
                this.line = view.findViewById(C2640R.id.line1);
                this.clBottomLayout = (ConstraintLayout) view.findViewById(C2640R.id.cl_bottom_layout);
                this.tvUserReplyTime2 = (TextView) view.findViewById(C2640R.id.tv_user_time_2);
                this.tvUserReplyContent2 = (TextView) view.findViewById(C2640R.id.tv_user_reply_2);
                this.tvCustomerTime = (TextView) view.findViewById(C2640R.id.tv_customer_reply_time);
                this.tvCustomerReply = (TextView) view.findViewById(C2640R.id.tv_customer_reply);
            ...
            public void bind(int i, RevUserGetFeedbackData.FeedbackInfo feedbackInfo) {
                ...
                this.ivRight.setImageResource(FeedbackDetailsActivity.this.isDeleteMode ? feedbackInfo.isSelected() ? C2640R.mipmap.icon_fb_checkbox_selected : C2640R.mipmap.icon_fb_checkbox_default : C2640R.mipmap.icon_arrow_right);
            ...
            public void onClick(View view) {
                ...
                int id = view.getId();
                if (id != C2640R.id.cl_top_layout) {
                    if (id == C2640R.id.cl_bottom_layout) {
                        FeedbackDetailsAdapter.this.keepOneH.close(this.viewHolder, FeedbackDetailsActivity.this.data);
                        return;
                    }
                    return;
                            ...
                            public void onItemClick(int i, String str) {
                                ...
                                FeedbackDetailsActivity.this.feedbackPreviewController.setExitModeListener(new FeedbackPreviewController.ExitModeListener() { // from class: com.ipotensic.potensicpro.activities.FeedbackDetailsActivity.FeedbackDetailsAdapter.MyViewHolder.1.1
                                    ...
                                    public void exitMode() {
                                        ...
                                        FeedbackDetailsActivity.this.ivDelete.setImageResource(C2640R.mipmap.icon_feedback_select);
                                    }
                                });
                            }
                        });
                ...
                this.ivRight.setImageResource(!isSelected ? C2640R.mipmap.icon_fb_checkbox_selected : C2640R.mipmap.icon_fb_checkbox_default);
            }
