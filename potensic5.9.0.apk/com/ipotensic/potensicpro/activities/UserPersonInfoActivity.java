...
public class UserPersonInfoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C2640R.layout.activity_user_person_info);
        initView();
        SPHelper.getInstance().clearFlight();
    }

    private void initView() {
        findViewById(C2640R.id.tv_skip).setOnClickListener(new ScaleClickListener() { // from class: com.ipotensic.potensicpro.activities.UserPersonInfoActivity.1
            ...
            public void click(View view) {
                ...
                new GeneralDialog(userPersonInfoActivity, userPersonInfoActivity.getString(C2640R.string.dialog_user_person_info_title), UserPersonInfoActivity.this.getString(C2640R.string.dialog_user_person_info_message), 1, new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.potensicpro.activities.UserPersonInfoActivity.1.1
    ...
    class MyTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            ...
            if (trim.length() > 0) {
                UserPersonInfoActivity.this.etNick.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, (Drawable) null, UserPersonInfoActivity.this.getResources().getDrawable(C2640R.mipmap.img_icon_nick_name_unlock), (Drawable) null);
                UserPersonInfoActivity.this.btnConfirm.setBackgroundResource(C2640R.mipmap.img_btn_tell_us_selected);
            } else {
                UserPersonInfoActivity.this.etNick.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, (Drawable) null, UserPersonInfoActivity.this.getResources().getDrawable(C2640R.mipmap.img_icon_nick_name_lock), (Drawable) null);
            }
            if (trim.length() > 22) {
    ...
    public void uploadHeadImg(Bitmap bitmap, final String str) {
        ...
        UserRequestPresenter.getInstance().uploadHeadImage(PhoneConfig.usrToken, str, null, new IUploadHeadImgView() { // from class: com.ipotensic.potensicpro.activities.UserPersonInfoActivity.5
            ...
            public void onUploadFailed(String str2) {
                UserPersonInfoActivity.this.dismissLoadingDialog();
                UserPersonInfoActivity userPersonInfoActivity = UserPersonInfoActivity.this;
                new GeneralDialog(userPersonInfoActivity, userPersonInfoActivity.getString(C2640R.string.dialog_user_failed_to_submit), UserPersonInfoActivity.this.getString(C2640R.string.dialog_user_failed_to_submit_message), 1, new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.potensicpro.activities.UserPersonInfoActivity.5.1
                    @Override // com.ipotensic.kernel.view.dialog.GeneralDialog.ClickConfirmListener
                    public void confirm() {
                        UserPersonInfoActivity.this.startActivity(new Intent(UserPersonInfoActivity.this, (Class<?>) MainActivity.class));
                    }
