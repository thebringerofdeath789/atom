...
public class LoginActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C2640R.layout.activity_login);
        initView();
    }

    private void initView() {
        LoginLoginController loginLoginController = new LoginLoginController(this, (ConstraintLayout) findViewById(C2640R.id.layout_login));
        this.loginController = loginLoginController;
        loginLoginController.setLoginControllerListener(this.loginControllerListener);
        LoginRegisterController loginRegisterController = new LoginRegisterController(this, (ViewStub) findViewById(C2640R.id.stub_register));
        ...
        LoginForgetPasswordController loginForgetPasswordController = new LoginForgetPasswordController(this, (ViewStub) findViewById(C2640R.id.stub_forget_password));
        ...
        LoginSendSuccessController loginSendSuccessController = new LoginSendSuccessController(this, (ViewStub) findViewById(C2640R.id.stub_send_success));
