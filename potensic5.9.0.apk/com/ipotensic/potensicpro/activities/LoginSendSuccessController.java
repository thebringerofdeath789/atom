...
public class LoginSendSuccessController extends BaseController {
    ...
    public void initView(View view) {
        ...
        view.findViewById(C2640R.id.btn_return).setOnClickListener(onClickListener);
        view.findViewById(C2640R.id.btn_back).setOnClickListener(onClickListener);
        this.tvTitle = (TextView) view.findViewById(C2640R.id.tv_code_title);
    }

    public void setSuccessEmail(String str) {
        this.tvTitle.setText(String.format(getContext().getResources().getString(C2640R.string.email_sent), str));
    }
