...
public class DataBinderMapperImpl extends DataBinderMapper {
    ...
    static {
        ...
        sparseIntArray.put(C2640R.layout.activity_find_my_drone, 1);
    }
    ...
    public List<DataBinderMapper> collectDependencies() {
        ...
        arrayList.add(new com.p019gs.keyboard.DataBinderMapperImpl());
    ...
    private static class InnerLayoutIdLookup {
        ...
        static {
            ...
            sKeys = hashMap;
            hashMap.put("layout/activity_find_my_drone_0", Integer.valueOf(C2640R.layout.activity_find_my_drone));
        }
    }
}