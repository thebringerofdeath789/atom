...
public class TopTabView extends LinearLayout implements View.OnClickListener {
    ...
    public TopTabView(Context context, AttributeSet attributeSet) {
        ...
        setOrientation(0);
        Drawable drawable = getContext().getResources().getDrawable(C2640R.mipmap.img_bg_main_media_top_indicator);
    ...
    public void setTabs(OnTopIndicatorChangeListener onTopIndicatorChangeListener, String... strArr) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            textView.setTextColor(getContext().getResources().getColor(C2640R.color.color_main_media_indicator_gray));
    ...
    private void setCurIndex(int i) {
        ...
        while (true) {
            ...
            textView.setTextColor(getContext().getResources().getColor(z ? C2640R.color.color_connect_selected_text : C2640R.color.color_main_media_indicator_gray));
            i2++;
        }
