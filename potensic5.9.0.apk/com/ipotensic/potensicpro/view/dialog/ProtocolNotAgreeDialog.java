...
public class ProtocolNotAgreeDialog extends BaseSyncDialog {
    ...
    public ProtocolNotAgreeDialog(Context context) {
        super(context, C2640R.layout.view_dialog_protocol_tip);
        findViewById(C2640R.id.btn_cancel).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.potensicpro.view.dialog.ProtocolNotAgreeDialog.1
