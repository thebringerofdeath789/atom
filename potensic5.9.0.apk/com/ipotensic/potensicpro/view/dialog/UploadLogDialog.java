...
public class UploadLogDialog extends BaseSyncDialog {
    ...
    public UploadLogDialog(Activity activity) {
        super(activity, C2640R.layout.view_dialog_upload_log);
        setCanceledOnTouchOutside(false);
        this.activity = activity;
        this.tvTitle = (TextView) findViewById(C2640R.id.tv_title);
        this.tvContent = (TextView) findViewById(C2640R.id.tv_content);
        this.loadingView = (ImageView) findViewById(C2640R.id.img_loading);
        Button button = (Button) findViewById(C2640R.id.btn_sure);
        this.btnOk = button;
