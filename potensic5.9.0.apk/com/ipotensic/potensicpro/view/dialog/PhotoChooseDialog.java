...
public class PhotoChooseDialog extends BaseDialog {
    ...
    public PhotoChooseDialog(final AppCompatActivity appCompatActivity, final PhotoChooserUtil.OnChooseListener onChooseListener) {
        super(appCompatActivity, C2640R.layout.view_dialog_header_choose);
        this.activity = appCompatActivity;
        this.listener = onChooseListener;
        findViewById(C2640R.id.btn_take_photo).setOnClickListener(new ScaleClickListener() { // from class: com.ipotensic.potensicpro.view.dialog.PhotoChooseDialog.1
        ...
        findViewById(C2640R.id.btn_upload_photo).setOnClickListener(new ScaleClickListener() { // from class: com.ipotensic.potensicpro.view.dialog.PhotoChooseDialog.2
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view) {
                if (PhotoChooseDialog.this.photoChooserUtil == null) {
                    PhotoChooseDialog.this.photoChooserUtil = new PhotoChooserUtil(appCompatActivity, onChooseListener);
        ...
        findViewById(C2640R.id.btn_cancel).setOnClickListener(new ScaleClickListener() { // from class: com.ipotensic.potensicpro.view.dialog.PhotoChooseDialog.3
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view) {
                PhotoChooseDialog.this.dismiss();
            }
