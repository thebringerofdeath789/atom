...
public class PrivacyDialog extends BaseSyncDialog {
    ...
    public PrivacyDialog(final Context context, OnAgreeListener onAgreeListener) {
        super(context, C2640R.layout.view_dialog_privacy_portrait);
        this.permissionListener = onAgreeListener;
        try {
            TextView textView = (TextView) findViewById(C2640R.id.tv_content);
            String string = context.getResources().getString(C2640R.string.welcome_to_potensicpro_text);
        ...
        findViewById(C2640R.id.btn_confirm).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.potensicpro.view.dialog.PrivacyDialog.3
        ...
        findViewById(C2640R.id.btn_cancel).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.potensicpro.view.dialog.PrivacyDialog.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (PrivacyDialog.this.permissionListener != null) {
