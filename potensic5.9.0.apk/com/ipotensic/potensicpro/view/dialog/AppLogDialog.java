...
public final class AppLogDialog extends Dialog {
    ...
    public AppLogDialog(BaseActivity activity) {
        super(activity, C2640R.style.CustomDialog);
    ...
    /* compiled from: AppLogDialog.kt */
    @Metadata(m2336bv = {1, 0, 3}, m2337d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0004\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0003J\b\u0010\u0004\u001a\u00020\u0005H\u0016J\u0018\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u00022\u0006\u0010\t\u001a\u00020\u0005H\u0016J\u0018\u0010\n\u001a\u00020\u00022\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u0005H\u0016¨\u0006\u000e"}, m2338d2 = {"Lcom/ipotensic/potensicpro/view/dialog/AppLogDialog$LogAdapter;", "Landroidx/recyclerview/widget/RecyclerView$Adapter;", "Lcom/ipotensic/potensicpro/view/dialog/AppLogDialog$BodyViewHolder;", "(Lcom/ipotensic/potensicpro/view/dialog/AppLogDialog;)V", "getItemCount", "", "onBindViewHolder", "", "holder", "position", "onCreateViewHolder", "parent", "Landroid/view/ViewGroup;", "viewType", "app__GooglePalyRelease"}, m2339k = 1, m2340mv = {1, 1, 15})
    public final class LogAdapter extends RecyclerView.Adapter<BodyViewHolder> {
        ...
        public BodyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View inflate = LayoutInflater.from(parent.getContext()).inflate(C2640R.layout.view_item_app_log, parent, false);
        ...
        public void onBindViewHolder(BodyViewHolder holder, final int position) {
            ...
            if (fileItem.isSelect()) {
                holder.getImgSelect().setImageResource(C2640R.mipmap.icon_fb_checkbox_selected);
                holder.itemView.setBackgroundColor(AppLogDialog.this.getContext().getColor(C2640R.color.color_kernel_top_state_green));
            } else {
                holder.getImgSelect().setImageResource(C2640R.mipmap.icon_fb_checkbox_default);
                holder.itemView.setBackgroundColor(AppLogDialog.this.getContext().getColor(C2640R.color.colorTransparent));
            }
    ...
    /* compiled from: AppLogDialog.kt */
    @Metadata(m2336bv = {1, 0, 3}, m2337d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004R\u0011\u0010\u0005\u001a\u00020\u0006¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u0011\u0010\t\u001a\u00020\n¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\f¨\u0006\r"}, m2338d2 = {"Lcom/ipotensic/potensicpro/view/dialog/AppLogDialog$BodyViewHolder;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "view", "Landroid/view/View;", "(Landroid/view/View;)V", "imgSelect", "Landroid/widget/ImageView;", "getImgSelect", "()Landroid/widget/ImageView;", "tvLogName", "Landroid/widget/TextView;", "getTvLogName", "()Landroid/widget/TextView;", "app__GooglePalyRelease"}, m2339k = 1, m2340mv = {1, 1, 15})
    public static final class BodyViewHolder extends RecyclerView.ViewHolder {
        ...
        public BodyViewHolder(View view) {
            ...
            View findViewById = view.findViewById(C2640R.id.tv_log_name);
            ...
            View findViewById2 = view.findViewById(C2640R.id.cb_select);
    ...
    /* compiled from: AppLogDialog.kt */
    @Metadata(m2336bv = {1, 0, 3}, m2337d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u000e\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0086\b\u0018\u00002\u00020\u0001B\u0017\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\b\u0002\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\t\u0010\u000e\u001a\u00020\u0003HÆ\u0003J\t\u0010\u000f\u001a\u00020\u0005HÆ\u0003J\u001d\u0010\u0010\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u0005HÆ\u0001J\u0013\u0010\u0011\u001a\u00020\u00052\b\u0010\u0012\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\u0013\u001a\u00020\u0014HÖ\u0001J\t\u0010\u0015\u001a\u00020\u0016HÖ\u0001R\u001a\u0010\u0002\u001a\u00020\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0007\u0010\b\"\u0004\b\t\u0010\nR\u001a\u0010\u0004\u001a\u00020\u0005X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0004\u0010\u000b\"\u0004\b\f\u0010\r¨\u0006\u0017"}, m2338d2 = {"Lcom/ipotensic/potensicpro/view/dialog/AppLogDialog$FileItem;", "", StringLookupFactory.KEY_FILE, "Ljava/io/File;", "isSelect", "", "(Ljava/io/File;Z)V", "getFile", "()Ljava/io/File;", "setFile", "(Ljava/io/File;)V", "()Z", "setSelect", "(Z)V", "component1", "component2", "copy", "equals", "other", "hashCode", "", "toString", "", "app__GooglePalyRelease"}, m2339k = 1, m2340mv = {1, 1, 15})
