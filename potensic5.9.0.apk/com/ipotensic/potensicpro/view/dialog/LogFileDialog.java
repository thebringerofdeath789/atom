...
public class LogFileDialog extends Dialog {
    ...
    public LogFileDialog(Activity activity) {
        ...
        setContentView(C2640R.layout.view_dialog_share_log_file);
        initData();
        setWindow();
        initView();
    }
    ...
    private void initView() {
        if (this.logFiles != null) {
            findViewById(C2640R.id.btn_close).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.potensicpro.view.dialog.LogFileDialog.2
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    LogFileDialog.this.dismiss();
                }
            });
            this.recyclerView = (RecyclerView) findViewById(C2640R.id.list_log_file);
    ...
    public class MyLogAdapter extends RecyclerView.Adapter<MyTVHolder> {
        ...
        public void onBindViewHolder(MyTVHolder myTVHolder, final int i) {
            myTVHolder.mTextView.setBackground(LogFileDialog.this.getContext().getResources().getDrawable(C2640R.drawable.bg_strock_bottom_black));
