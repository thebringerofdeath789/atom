...
public class BottomTabView extends LinearLayout implements View.OnClickListener {
    ...
    public BottomTabView(Context context, AttributeSet attributeSet) {
        ...
        setGravity(17);
        setOrientation(0);
        setBackgroundResource(C2640R.drawable.shadow_main_bottom_tab);
    ...
    public void showRedPoint(int i) {
        ...
        bottomItemView.setSelectedDrawableRes(i > 0 ? C2640R.drawable.bg_tab_me_unread_selected : C2640R.mipmap.img_btn_main_tab_me_selected);
        bottomItemView.setNormalDrawableRes(i > 0 ? C2640R.drawable.bg_tab_me_unread_normal : C2640R.mipmap.img_btn_main_tab_me_normal);
