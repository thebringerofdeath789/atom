...
public class LoginModuleEditText extends AppCompatEditText {
    ...
    private void initView() {
        this.lock = this.context.getResources().getDrawable(C2640R.mipmap.img_icon_pwd_lock);
        this.unlock = this.context.getResources().getDrawable(C2640R.mipmap.img_icon_pwd_unlock);
