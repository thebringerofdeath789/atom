...
public class FeedbackPicShowAdapter extends RecyclerView.Adapter<PicViewHolder> {
    ...
    public PicViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new PicViewHolder(LayoutInflater.from(this.context).inflate(C2640R.layout.adapter_fb_reply_picture, (ViewGroup) null, false));
    }
    ...
    public void onBindViewHolder(PicViewHolder picViewHolder, final int i) {
        ...
        if (lowerCase.endsWith(".jpg") || lowerCase.endsWith(".png") || lowerCase.endsWith(".jpeg") || lowerCase.endsWith(".webp")) {
            ...
            PicassoLoader.with(this.context).load(str).placeholder(C2640R.mipmap.icon_placeholder).into(picViewHolder.imageView);
        } else {
            picViewHolder.videoView.setVisibility(0);
    ...
    public class PicViewHolder extends RecyclerView.ViewHolder {
        ...
        public PicViewHolder(View view) {
            ...
            this.videoView = (ImageView) view.findViewById(C2640R.id.video_view);
        }
    }
