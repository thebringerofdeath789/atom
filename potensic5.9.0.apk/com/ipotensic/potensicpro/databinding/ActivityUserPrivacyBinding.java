...
public final class ActivityUserPrivacyBinding implements ViewBinding {
    ...
    private ActivityUserPrivacyBinding(ConstraintLayout constraintLayout, ImageButton imageButton, ImageView imageView, SmartScrollView smartScrollView, TextView textView, TextView textView2, TextView textView3, TextView textView4, TextView textView5) {
    ...
    public static ActivityUserPrivacyBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.activity_user_privacy, viewGroup, false);
        if (z) {
    ...
    public static ActivityUserPrivacyBinding bind(View view) {
        int i = C2640R.id.btn_return;
        ImageButton imageButton = (ImageButton) view.findViewById(C2640R.id.btn_return);
        if (imageButton != null) {
            i = C2640R.id.iv_user;
            ImageView imageView = (ImageView) view.findViewById(C2640R.id.iv_user);
            if (imageView != null) {
                i = C2640R.id.scroll_view;
                SmartScrollView smartScrollView = (SmartScrollView) view.findViewById(C2640R.id.scroll_view);
                if (smartScrollView != null) {
                    ...
                    if (textView != null) {
                        ...
                        if (textView2 != null) {
                            i = C2640R.id.tv_privacy_policy;
                            TextView textView3 = (TextView) view.findViewById(C2640R.id.tv_privacy_policy);
                            if (textView3 != null) {
                                i = C2640R.id.tv_privacy_policy_content;
                                TextView textView4 = (TextView) view.findViewById(C2640R.id.tv_privacy_policy_content);
                                if (textView4 != null) {
                                    i = C2640R.id.tv_user;
                                    TextView textView5 = (TextView) view.findViewById(C2640R.id.tv_user);
                                    if (textView5 != null) {
                                        return new ActivityUserPrivacyBinding((ConstraintLayout) view, imageButton, imageView, smartScrollView, textView, textView2, textView3, textView4, textView5);
                                    }
                                }
                            }
                        }
