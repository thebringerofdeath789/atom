...
public final class ActivityAircraftLogBinding implements ViewBinding {
    ...
    /* renamed from: rv */
    public final RecyclerView f2368rv;
    ...
    public static ActivityAircraftLogBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.activity_aircraft_log, viewGroup, false);
        if (z) {
    ...
    public static ActivityAircraftLogBinding bind(View view) {
        int i = C2640R.id.iv_empty_log;
        ImageView imageView = (ImageView) view.findViewById(C2640R.id.iv_empty_log);
        if (imageView != null) {
            i = C2640R.id.f2310rv;
            RecyclerView recyclerView = (RecyclerView) view.findViewById(C2640R.id.f2310rv);
            if (recyclerView != null) {
                ...
                if (findViewById != null) {
                    ...
                    i = C2640R.id.tv_log_tips;
                    TextView textView = (TextView) view.findViewById(C2640R.id.tv_log_tips);
                    if (textView != null) {
                        i = C2640R.id.tv_no_record;
                        TextView textView2 = (TextView) view.findViewById(C2640R.id.tv_no_record);
                        if (textView2 != null) {
