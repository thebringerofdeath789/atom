...
public final class ViewLoginLoginBinding implements ViewBinding {
    ...
    public static ViewLoginLoginBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.view_login_login, viewGroup, false);
        if (z) {
    ...
    public static ViewLoginLoginBinding bind(View view) {
        int i = C2640R.id.btn_login;
        Button button = (Button) view.findViewById(C2640R.id.btn_login);
        if (button != null) {
            ...
            if (constraintLayout != null) {
                ...
                if (constraintLayout2 != null) {
                    i = C2640R.id.edit_login_password;
                    EditText editText = (EditText) view.findViewById(C2640R.id.edit_login_password);
                    if (editText != null) {
                        i = C2640R.id.edit_login_username;
                        EditText editText2 = (EditText) view.findViewById(C2640R.id.edit_login_username);
                        if (editText2 != null) {
                            ...
                            if (textView != null) {
                                ...
                                TextView textView2 = (TextView) view.findViewById(C2640R.id.tv_email_error_tips);
                                if (textView2 != null) {
                                    i = C2640R.id.tv_forget_password;
                                    TextView textView3 = (TextView) view.findViewById(C2640R.id.tv_forget_password);
                                    if (textView3 != null) {
                                        i = C2640R.id.tv_logo;
                                        TextView textView4 = (TextView) view.findViewById(C2640R.id.tv_logo);
                                        if (textView4 != null) {
                                            i = C2640R.id.tv_password_error_tips;
                                            TextView textView5 = (TextView) view.findViewById(C2640R.id.tv_password_error_tips);
                                            if (textView5 != null) {
                                                i = C2640R.id.tv_register;
                                                TextView textView6 = (TextView) view.findViewById(C2640R.id.tv_register);
                                                if (textView6 != null) {
