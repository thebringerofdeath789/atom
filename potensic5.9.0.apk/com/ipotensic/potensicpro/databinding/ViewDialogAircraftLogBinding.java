...
public final class ViewDialogAircraftLogBinding implements ViewBinding {
    ...
    public static ViewDialogAircraftLogBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.view_dialog_aircraft_log, viewGroup, false);
        if (z) {
    ...
    public static ViewDialogAircraftLogBinding bind(View view) {
        ...
        if (imageButton != null) {
            i = C2640R.id.btn_finish;
            Button button = (Button) view.findViewById(C2640R.id.btn_finish);
            if (button != null) {
                i = C2640R.id.et_feedback;
                EditText editText = (EditText) view.findViewById(C2640R.id.et_feedback);
                if (editText != null) {
                    i = C2640R.id.et_model;
                    EditText editText2 = (EditText) view.findViewById(C2640R.id.et_model);
                    if (editText2 != null) {
                        i = C2640R.id.line;
                        ...
                        if (findViewById != null) {
                            ...
                            if (textView != null) {
                                ...
                                TextView textView2 = (TextView) view.findViewById(C2640R.id.tv_feedback);
                                if (textView2 != null) {
                                    i = C2640R.id.tv_model;
                                    TextView textView3 = (TextView) view.findViewById(C2640R.id.tv_model);
                                    if (textView3 != null) {
