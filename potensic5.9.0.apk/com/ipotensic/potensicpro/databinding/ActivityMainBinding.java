...
public final class ActivityMainBinding implements ViewBinding {
    ...
    public static ActivityMainBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.activity_main, viewGroup, false);
        if (z) {
    ...
    public static ActivityMainBinding bind(View view) {
        int i = C2640R.id.btnTabAcademy;
        TextView textView = (TextView) view.findViewById(C2640R.id.btnTabAcademy);
        if (textView != null) {
            i = C2640R.id.btnTabDevice;
            TextView textView2 = (TextView) view.findViewById(C2640R.id.btnTabDevice);
            if (textView2 != null) {
                i = C2640R.id.btnTabGallery;
                TextView textView3 = (TextView) view.findViewById(C2640R.id.btnTabGallery);
                if (textView3 != null) {
                    i = C2640R.id.btnTabMe;
                    TextView textView4 = (TextView) view.findViewById(C2640R.id.btnTabMe);
                    if (textView4 != null) {
                        i = C2640R.id.layoutBottomTab;
                        LinearLayout linearLayout = (LinearLayout) view.findViewById(C2640R.id.layoutBottomTab);
                        if (linearLayout != null) {
                            i = C2640R.id.stub_academy;
                            ViewStub viewStub = (ViewStub) view.findViewById(C2640R.id.stub_academy);
                            if (viewStub != null) {
                                i = C2640R.id.stub_me;
                                ViewStub viewStub2 = (ViewStub) view.findViewById(C2640R.id.stub_me);
                                if (viewStub2 != null) {
                                    i = C2640R.id.stub_media;
                                    ViewStub viewStub3 = (ViewStub) view.findViewById(C2640R.id.stub_media);
                                    if (viewStub3 != null) {
