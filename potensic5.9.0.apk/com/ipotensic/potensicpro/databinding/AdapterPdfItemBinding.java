...
public final class AdapterPdfItemBinding implements ViewBinding {
    ...
    public static AdapterPdfItemBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.adapter_pdf_item, viewGroup, false);
        if (z) {
    ...
    public static AdapterPdfItemBinding bind(View view) {
        int i = C2640R.id.img_pdf;
        ImageView imageView = (ImageView) view.findViewById(C2640R.id.img_pdf);
        if (imageView != null) {
            i = C2640R.id.view_line;
            View findViewById = view.findViewById(C2640R.id.view_line);
