...
public final class ViewMapboxToolBinding implements ViewBinding {
    ...
    public static ViewMapboxToolBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.view_mapbox_tool, viewGroup, false);
        if (z) {
    ...
    public static ViewMapboxToolBinding bind(View view) {
        int i = C2640R.id.iv_map_compass_bg;
        ImageView imageView = (ImageView) view.findViewById(C2640R.id.iv_map_compass_bg);
        if (imageView != null) {
            i = C2640R.id.iv_map_lock;
            ImageButton imageButton = (ImageButton) view.findViewById(C2640R.id.iv_map_lock);
            if (imageButton != null) {
                i = C2640R.id.iv_map_position;
                ImageButton imageButton2 = (ImageButton) view.findViewById(C2640R.id.iv_map_position);
                if (imageButton2 != null) {
                    i = C2640R.id.iv_map_set_hide;
                    ImageButton imageButton3 = (ImageButton) view.findViewById(C2640R.id.iv_map_set_hide);
                    if (imageButton3 != null) {
                        i = C2640R.id.iv_map_type;
                        ImageButton imageButton4 = (ImageButton) view.findViewById(C2640R.id.iv_map_type);
                        if (imageButton4 != null) {
                            i = C2640R.id.view_map_position;
                            View findViewById = view.findViewById(C2640R.id.view_map_position);
                            if (findViewById != null) {
                                ViewMapPositionFindDroneBinding bind = ViewMapPositionFindDroneBinding.bind(findViewById);
                                i = C2640R.id.view_map_set;
                                View findViewById2 = view.findViewById(C2640R.id.view_map_set);
                                if (findViewById2 != null) {
                                    ViewMapboxToolInfoShowBinding bind2 = ViewMapboxToolInfoShowBinding.bind(findViewById2);
                                    i = C2640R.id.view_map_type;
                                    View findViewById3 = view.findViewById(C2640R.id.view_map_type);
