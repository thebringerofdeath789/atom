...
public final class ViewItemAppLogBinding implements ViewBinding {
    ...
    public static ViewItemAppLogBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.view_item_app_log, viewGroup, false);
        if (z) {
    ...
    public static ViewItemAppLogBinding bind(View view) {
        int i = C2640R.id.cb_select;
        ImageView imageView = (ImageView) view.findViewById(C2640R.id.cb_select);
        if (imageView != null) {
            i = C2640R.id.tv_log_name;
            TextView textView = (TextView) view.findViewById(C2640R.id.tv_log_name);
            if (textView != null) {
