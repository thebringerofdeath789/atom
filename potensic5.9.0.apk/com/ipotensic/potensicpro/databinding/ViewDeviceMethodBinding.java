...
public final class ViewDeviceMethodBinding implements ViewBinding {
    ...
    public static ViewDeviceMethodBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.view_device_method, viewGroup, false);
        if (z) {
    ...
    public static ViewDeviceMethodBinding bind(View view) {
        ...
        if (imageButton != null) {
            i = C2640R.id.btn_close;
            ImageButton imageButton2 = (ImageButton) view.findViewById(C2640R.id.btn_close);
            if (imageButton2 != null) {
                i = C2640R.id.iv_gif;
                ImageView imageView = (ImageView) view.findViewById(C2640R.id.iv_gif);
                if (imageView != null) {
                    i = C2640R.id.iv_step;
                    ImageView imageView2 = (ImageView) view.findViewById(C2640R.id.iv_step);
                    if (imageView2 != null) {
                        i = C2640R.id.line;
                        ...
                        if (findViewById != null) {
                            ...
                            if (textView != null) {
                                ...
                                if (textView2 != null) {
                                    i = C2640R.id.tv_next;
                                    TextView textView3 = (TextView) view.findViewById(C2640R.id.tv_next);
                                    if (textView3 != null) {
