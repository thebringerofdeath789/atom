...
public final class ViewMainPageMeBinding implements ViewBinding {
    ...
    public static ViewMainPageMeBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.view_main_page_me, viewGroup, false);
        if (z) {
    ...
    public static ViewMainPageMeBinding bind(View view) {
        int i = C2640R.id.cancel_account;
        ExpandableView expandableView = (ExpandableView) view.findViewById(C2640R.id.cancel_account);
        if (expandableView != null) {
            i = C2640R.id.cl_top_layout;
            ConstraintLayout constraintLayout = (ConstraintLayout) view.findViewById(C2640R.id.cl_top_layout);
            if (constraintLayout != null) {
                i = C2640R.id.img_account_eidt;
                ImageView imageView = (ImageView) view.findViewById(C2640R.id.img_account_eidt);
                if (imageView != null) {
                    i = C2640R.id.img_head;
                    ...
                    if (circleImageView != null) {
                        ...
                        if (imageView2 != null) {
                            i = C2640R.id.iv_feedback;
                            ImageView imageView3 = (ImageView) view.findViewById(C2640R.id.iv_feedback);
                            if (imageView3 != null) {
                                i = C2640R.id.layout_head;
                                LinearLayout linearLayout = (LinearLayout) view.findViewById(C2640R.id.layout_head);
                                if (linearLayout != null) {
                                    i = C2640R.id.layout_top;
                                    ConstraintLayout constraintLayout2 = (ConstraintLayout) view.findViewById(C2640R.id.layout_top);
                                    if (constraintLayout2 != null) {
                                        i = C2640R.id.line_debug;
                                        View findViewById = view.findViewById(C2640R.id.line_debug);
                                        if (findViewById != null) {
                                            i = C2640R.id.logout;
                                            ExpandableView expandableView2 = (ExpandableView) view.findViewById(C2640R.id.logout);
                                            if (expandableView2 != null) {
                                                i = C2640R.id.me_bottom_view;
                                                View findViewById2 = view.findViewById(C2640R.id.me_bottom_view);
                                                if (findViewById2 != null) {
                                                    i = C2640R.id.scroll;
                                                    ScrollView scrollView = (ScrollView) view.findViewById(C2640R.id.scroll);
                                                    if (scrollView != null) {
                                                        i = C2640R.id.tv_badge_num;
                                                        TextView textView = (TextView) view.findViewById(C2640R.id.tv_badge_num);
                                                        if (textView != null) {
                                                            i = C2640R.id.tv_debug;
                                                            TextView textView2 = (TextView) view.findViewById(C2640R.id.tv_debug);
                                                            if (textView2 != null) {
                                                                i = C2640R.id.tv_feedback;
                                                                TextView textView3 = (TextView) view.findViewById(C2640R.id.tv_feedback);
                                                                if (textView3 != null) {
                                                                    i = C2640R.id.tv_find_my_drone;
                                                                    TextView textView4 = (TextView) view.findViewById(C2640R.id.tv_find_my_drone);
                                                                    if (textView4 != null) {
                                                                        i = C2640R.id.tv_modify_login_pwd;
                                                                        TextView textView5 = (TextView) view.findViewById(C2640R.id.tv_modify_login_pwd);
                                                                        if (textView5 != null) {
                                                                            i = C2640R.id.tv_nick_name;
                                                                            TextView textView6 = (TextView) view.findViewById(C2640R.id.tv_nick_name);
                                                                            if (textView6 != null) {
                                                                                i = C2640R.id.tv_position;
                                                                                TextView textView7 = (TextView) view.findViewById(C2640R.id.tv_position);
                                                                                if (textView7 != null) {
                                                                                    i = C2640R.id.tv_reset_guidelines;
                                                                                    TextView textView8 = (TextView) view.findViewById(C2640R.id.tv_reset_guidelines);
                                                                                    if (textView8 != null) {
                                                                                        i = C2640R.id.tv_user_agreement;
                                                                                        TextView textView9 = (TextView) view.findViewById(C2640R.id.tv_user_agreement);
                                                                                        if (textView9 != null) {
