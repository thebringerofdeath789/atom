...
public final class ViewMapPositionFindDroneBinding implements ViewBinding {
    ...
    public static ViewMapPositionFindDroneBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.view_map_position_find_drone, viewGroup, false);
        if (z) {
    ...
    public static ViewMapPositionFindDroneBinding bind(View view) {
        int i = C2640R.id.iv_fly_position;
        ImageButton imageButton = (ImageButton) view.findViewById(C2640R.id.iv_fly_position);
        if (imageButton != null) {
            i = C2640R.id.iv_map_pos_bg;
            ImageView imageView = (ImageView) view.findViewById(C2640R.id.iv_map_pos_bg);
            if (imageView != null) {
                i = C2640R.id.iv_my_position;
                ImageButton imageButton2 = (ImageButton) view.findViewById(C2640R.id.iv_my_position);
