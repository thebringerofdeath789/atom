...
public final class ViewAdapterInstructionBinding implements ViewBinding {
    ...
    public static ViewAdapterInstructionBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.view_adapter_instruction, viewGroup, false);
        if (z) {
    ...
    public static ViewAdapterInstructionBinding bind(View view) {
        ...
        int i = C2640R.id.iv_img;
        ImageView imageView = (ImageView) view.findViewById(C2640R.id.iv_img);
        if (imageView != null) {
            i = C2640R.id.progressView;
            PDFDownloadProgressView pDFDownloadProgressView = (PDFDownloadProgressView) view.findViewById(C2640R.id.progressView);
