...
public final class ActivityPdfBinding implements ViewBinding {
    ...
    public static ActivityPdfBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.activity_pdf, viewGroup, false);
        if (z) {
        ...
        if (imageButton != null) {
            ...
            if (imageView != null) {
                ...
                if (linearLayout != null) {
                    i = C2640R.id.pdfView;
                    PDFView pDFView = (PDFView) view.findViewById(C2640R.id.pdfView);
                    if (pDFView != null) {
                        ...
                        if (recyclerView != null) {
                            ...
                            if (toolbar != null) {
                                ...
                                if (textView != null) {
                                    i = C2640R.id.tv_page_num;
                                    TextView textView2 = (TextView) view.findViewById(C2640R.id.tv_page_num);
                                    if (textView2 != null) {
                                        i = C2640R.id.view_top;
                                        View findViewById = view.findViewById(C2640R.id.view_top);
