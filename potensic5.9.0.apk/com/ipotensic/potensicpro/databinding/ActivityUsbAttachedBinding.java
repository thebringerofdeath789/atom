...
public final class ActivityUsbAttachedBinding implements ViewBinding {
    ...
    public static ActivityUsbAttachedBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.activity_usb_attached, viewGroup, false);
        if (z) {
    ...
    public static ActivityUsbAttachedBinding bind(View view) {
        int i = C2640R.id.btn_send;
        Button button = (Button) view.findViewById(C2640R.id.btn_send);
        if (button != null) {
            i = C2640R.id.surface;
            SurfaceView surfaceView = (SurfaceView) view.findViewById(C2640R.id.surface);
            if (surfaceView != null) {
