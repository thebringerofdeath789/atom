...
public final class ViewMainPageMediaBinding implements ViewBinding {
    ...
    public static ViewMainPageMediaBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.view_main_page_media, viewGroup, false);
        if (z) {
    ...
    public static ViewMainPageMediaBinding bind(View view) {
        int i = C2640R.id.btn_close_no_permission;
        ImageButton imageButton = (ImageButton) view.findViewById(C2640R.id.btn_close_no_permission);
        if (imageButton != null) {
            i = C2640R.id.btn_delete;
            ImageButton imageButton2 = (ImageButton) view.findViewById(C2640R.id.btn_delete);
            if (imageButton2 != null) {
                i = C2640R.id.btn_select;
                ImageButton imageButton3 = (ImageButton) view.findViewById(C2640R.id.btn_select);
                if (imageButton3 != null) {
                    i = C2640R.id.btn_share;
                    ImageButton imageButton4 = (ImageButton) view.findViewById(C2640R.id.btn_share);
                    if (imageButton4 != null) {
                        i = C2640R.id.img_none;
                        ImageView imageView = (ImageView) view.findViewById(C2640R.id.img_none);
                        if (imageView != null) {
                            i = C2640R.id.layout_bottom;
                            RelativeLayout relativeLayout = (RelativeLayout) view.findViewById(C2640R.id.layout_bottom);
                            if (relativeLayout != null) {
                                i = C2640R.id.layout_no_permission;
                                LinearLayout linearLayout = (LinearLayout) view.findViewById(C2640R.id.layout_no_permission);
                                if (linearLayout != null) {
                                    i = C2640R.id.recycler_view;
                                    RecyclerView recyclerView = (RecyclerView) view.findViewById(C2640R.id.recycler_view);
                                    if (recyclerView != null) {
                                        i = C2640R.id.tv_go_setting;
                                        TextView textView = (TextView) view.findViewById(C2640R.id.tv_go_setting);
                                        if (textView != null) {
                                            i = C2640R.id.tv_no_permission;
                                            TextView textView2 = (TextView) view.findViewById(C2640R.id.tv_no_permission);
                                            if (textView2 != null) {
                                                i = C2640R.id.tv_select;
                                                TextView textView3 = (TextView) view.findViewById(C2640R.id.tv_select);
                                                if (textView3 != null) {
                                                    i = C2640R.id.view_head;
                                                    View findViewById = view.findViewById(C2640R.id.view_head);
                                                    if (findViewById != null) {
                                                        i = C2640R.id.view_top_tab;
                                                        TopTabView topTabView = (TopTabView) view.findViewById(C2640R.id.view_top_tab);
                                                        if (topTabView != null) {
