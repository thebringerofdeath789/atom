...
public final class ViewMainPageDeviceBinding implements ViewBinding {
    ...
    public static ViewMainPageDeviceBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.view_main_page_device, viewGroup, false);
        if (z) {
    ...
    public static ViewMainPageDeviceBinding bind(View view) {
        int i = C2640R.id.btn_enter_device;
        TextView textView = (TextView) view.findViewById(C2640R.id.btn_enter_device);
        if (textView != null) {
            i = C2640R.id.btn_menu;
            ImageButton imageButton = (ImageButton) view.findViewById(C2640R.id.btn_menu);
            if (imageButton != null) {
                i = C2640R.id.guide_model_select;
                View findViewById = view.findViewById(C2640R.id.guide_model_select);
                if (findViewById != null) {
                    i = C2640R.id.iv_device_type;
                    ImageView imageView = (ImageView) view.findViewById(C2640R.id.iv_device_type);
                    if (imageView != null) {
                        i = C2640R.id.iv_logo;
                        ImageView imageView2 = (ImageView) view.findViewById(C2640R.id.iv_logo);
                        if (imageView2 != null) {
                            ConstraintLayout constraintLayout = (ConstraintLayout) view;
                            i = C2640R.id.layout_menu;
                            View findViewById2 = view.findViewById(C2640R.id.layout_menu);
                            if (findViewById2 != null) {
                                ViewMainMenuBinding bind = ViewMainMenuBinding.bind(findViewById2);
                                i = C2640R.id.ll_top;
                                LinearLayout linearLayout = (LinearLayout) view.findViewById(C2640R.id.ll_top);
                                if (linearLayout != null) {
                                    i = C2640R.id.tv_check_upgrade;
                                    TextView textView2 = (TextView) view.findViewById(C2640R.id.tv_check_upgrade);
                                    if (textView2 != null) {
                                        i = C2640R.id.tv_choose;
                                        TextView textView3 = (TextView) view.findViewById(C2640R.id.tv_choose);
                                        if (textView3 != null) {
                                            i = C2640R.id.tv_connect_state;
                                            ConnectStateView connectStateView = (ConnectStateView) view.findViewById(C2640R.id.tv_connect_state);
                                            if (connectStateView != null) {
                                                i = C2640R.id.view_blank;
                                                View findViewById3 = view.findViewById(C2640R.id.view_blank);
                                                if (findViewById3 != null) {
                                                    i = C2640R.id.view_enter_bg;
                                                    View findViewById4 = view.findViewById(C2640R.id.view_enter_bg);
