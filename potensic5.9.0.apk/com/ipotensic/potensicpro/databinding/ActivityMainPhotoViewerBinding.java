...
public final class ActivityMainPhotoViewerBinding implements ViewBinding {
    ...
    public static ActivityMainPhotoViewerBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.activity_main_photo_viewer, viewGroup, false);
        if (z) {
    ...
    public static ActivityMainPhotoViewerBinding bind(View view) {
        int i = C2640R.id.btn_back;
        ImageView imageView = (ImageView) view.findViewById(C2640R.id.btn_back);
        if (imageView != null) {
            i = C2640R.id.btn_delete;
            ImageButton imageButton = (ImageButton) view.findViewById(C2640R.id.btn_delete);
            if (imageButton != null) {
                i = C2640R.id.btn_media_info;
                ImageButton imageButton2 = (ImageButton) view.findViewById(C2640R.id.btn_media_info);
                if (imageButton2 != null) {
                    i = C2640R.id.btn_media_share;
                    ImageButton imageButton3 = (ImageButton) view.findViewById(C2640R.id.btn_media_share);
                    if (imageButton3 != null) {
                        i = C2640R.id.layout_bottom;
                        ConstraintLayout constraintLayout = (ConstraintLayout) view.findViewById(C2640R.id.layout_bottom);
                        if (constraintLayout != null) {
                            ConstraintLayout constraintLayout2 = (ConstraintLayout) view;
                            i = C2640R.id.layout_top;
                            ConstraintLayout constraintLayout3 = (ConstraintLayout) view.findViewById(C2640R.id.layout_top);
                            if (constraintLayout3 != null) {
                                ...
                                if (looperViewPager != null) {
                                    i = C2640R.id.tv_date;
                                    TextView textView = (TextView) view.findViewById(C2640R.id.tv_date);
                                    if (textView != null) {
