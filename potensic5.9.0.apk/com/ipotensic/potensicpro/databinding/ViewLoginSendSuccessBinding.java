...
public final class ViewLoginSendSuccessBinding implements ViewBinding {
    ...
    public static ViewLoginSendSuccessBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.view_login_send_success, viewGroup, false);
        if (z) {
    ...
    public static ViewLoginSendSuccessBinding bind(View view) {
        ...
        Button button = (Button) view.findViewById(C2640R.id.btn_back);
        if (button != null) {
            ...
            if (imageButton != null) {
                ...
                if (textView != null) {
                    i = C2640R.id.tv_send_success;
                    TextView textView2 = (TextView) view.findViewById(C2640R.id.tv_send_success);
                    if (textView2 != null) {
