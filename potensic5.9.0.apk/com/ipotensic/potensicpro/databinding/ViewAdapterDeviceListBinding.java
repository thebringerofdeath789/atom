...
public final class ViewAdapterDeviceListBinding implements ViewBinding {
    ...
    public static ViewAdapterDeviceListBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.view_adapter_device_list, viewGroup, false);
        if (z) {
    ...
    public static ViewAdapterDeviceListBinding bind(View view) {
        ...
        int i = C2640R.id.iv_bg;
        ImageView imageView = (ImageView) view.findViewById(C2640R.id.iv_bg);
        if (imageView != null) {
            i = C2640R.id.tv_detail;
            TextView textView = (TextView) view.findViewById(C2640R.id.tv_detail);
            if (textView != null) {
                i = C2640R.id.tv_device_type;
                TextView textView2 = (TextView) view.findViewById(C2640R.id.tv_device_type);
                if (textView2 != null) {
