...
public final class ActivityLoginBinding implements ViewBinding {
    ...
    public static ActivityLoginBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.activity_login, viewGroup, false);
        if (z) {
    ...
    public static ActivityLoginBinding bind(View view) {
        int i = C2640R.id.stub_forget_password;
        ViewStub viewStub = (ViewStub) view.findViewById(C2640R.id.stub_forget_password);
        if (viewStub != null) {
            i = C2640R.id.stub_register;
            ViewStub viewStub2 = (ViewStub) view.findViewById(C2640R.id.stub_register);
            if (viewStub2 != null) {
                i = C2640R.id.stub_send_success;
                ViewStub viewStub3 = (ViewStub) view.findViewById(C2640R.id.stub_send_success);
                if (viewStub3 != null) {
