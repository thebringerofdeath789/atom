...
public final class AdapterPictureSelectBinding implements ViewBinding {
    ...
    public static AdapterPictureSelectBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.adapter_picture_select, viewGroup, false);
        if (z) {
    ...
    public static AdapterPictureSelectBinding bind(View view) {
        ...
        ImageView imageView = (ImageView) view.findViewById(C2640R.id.image_view);
        if (imageView != null) {
            i = C2640R.id.video_view;
            ImageView imageView2 = (ImageView) view.findViewById(C2640R.id.video_view);
            if (imageView2 != null) {
