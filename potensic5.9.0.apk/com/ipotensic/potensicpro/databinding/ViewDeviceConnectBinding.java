...
public final class ViewDeviceConnectBinding implements ViewBinding {
    ...
    public static ViewDeviceConnectBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.view_device_connect, viewGroup, false);
        if (z) {
    ...
    public static ViewDeviceConnectBinding bind(View view) {
        ...
        if (imageButton != null) {
            i = C2640R.id.cv_connect_method;
            CardView cardView = (CardView) view.findViewById(C2640R.id.cv_connect_method);
            if (cardView != null) {
                i = C2640R.id.cv_enter_flight;
                CardView cardView2 = (CardView) view.findViewById(C2640R.id.cv_enter_flight);
                if (cardView2 != null) {
                    i = C2640R.id.tv_connect_method;
                    TextView textView = (TextView) view.findViewById(C2640R.id.tv_connect_method);
                    if (textView != null) {
                        i = C2640R.id.tv_enter_flight;
                        TextView textView2 = (TextView) view.findViewById(C2640R.id.tv_enter_flight);
                        if (textView2 != null) {
                            i = C2640R.id.tv_next_step;
                            TextView textView3 = (TextView) view.findViewById(C2640R.id.tv_next_step);
                            if (textView3 != null) {
