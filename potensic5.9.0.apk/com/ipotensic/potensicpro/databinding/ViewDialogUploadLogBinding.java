...
public final class ViewDialogUploadLogBinding implements ViewBinding {
    ...
    public static ViewDialogUploadLogBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.view_dialog_upload_log, viewGroup, false);
        if (z) {
    ...
    public static ViewDialogUploadLogBinding bind(View view) {
        int i = C2640R.id.btn_sure;
        Button button = (Button) view.findViewById(C2640R.id.btn_sure);
        if (button != null) {
            ...
            if (imageView != null) {
                ...
                if (textView != null) {
                    i = C2640R.id.tv_title;
                    TextView textView2 = (TextView) view.findViewById(C2640R.id.tv_title);
                    if (textView2 != null) {
