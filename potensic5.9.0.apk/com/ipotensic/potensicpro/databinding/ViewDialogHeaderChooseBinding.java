...
public final class ViewDialogHeaderChooseBinding implements ViewBinding {
    ...
    public static ViewDialogHeaderChooseBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.view_dialog_header_choose, viewGroup, false);
        if (z) {
    ...
    public static ViewDialogHeaderChooseBinding bind(View view) {
        ...
        if (button != null) {
            i = C2640R.id.btn_take_photo;
            Button button2 = (Button) view.findViewById(C2640R.id.btn_take_photo);
            if (button2 != null) {
                i = C2640R.id.btn_upload_photo;
                Button button3 = (Button) view.findViewById(C2640R.id.btn_upload_photo);
                if (button3 != null) {
