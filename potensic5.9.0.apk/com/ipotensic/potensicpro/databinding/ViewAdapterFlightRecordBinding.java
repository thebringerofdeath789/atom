...
public final class ViewAdapterFlightRecordBinding implements ViewBinding {
    ...
    public static ViewAdapterFlightRecordBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.view_adapter_flight_record, viewGroup, false);
        if (z) {
    ...
    public static ViewAdapterFlightRecordBinding bind(View view) {
        int i = C2640R.id.delete;
        Button button = (Button) view.findViewById(C2640R.id.delete);
        if (button != null) {
            i = C2640R.id.edt_speed;
            TextView textView = (TextView) view.findViewById(C2640R.id.edt_speed);
            if (textView != null) {
                i = C2640R.id.ll_img;
                ...
                if (linearLayout != null) {
                    ...
                    i = C2640R.id.tv_date;
                    TextView textView2 = (TextView) view.findViewById(C2640R.id.tv_date);
                    if (textView2 != null) {
                        i = C2640R.id.tv_distance;
                        TextView textView3 = (TextView) view.findViewById(C2640R.id.tv_distance);
                        if (textView3 != null) {
                            i = C2640R.id.tv_duration;
                            TextView textView4 = (TextView) view.findViewById(C2640R.id.tv_duration);
                            if (textView4 != null) {
                                i = C2640R.id.tv_height;
                                TextView textView5 = (TextView) view.findViewById(C2640R.id.tv_height);
                                if (textView5 != null) {
