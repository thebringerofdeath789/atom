...
public final class ViewMainPageAcamecyBinding implements ViewBinding {
    ...
    public static ViewMainPageAcamecyBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.view_main_page_acamecy, viewGroup, false);
        if (z) {
    ...
    public static ViewMainPageAcamecyBinding bind(View view) {
        int i = C2640R.id.fl_video;
        FrameLayout frameLayout = (FrameLayout) view.findViewById(C2640R.id.fl_video);
        if (frameLayout != null) {
            i = C2640R.id.img_loading;
            ImageView imageView = (ImageView) view.findViewById(C2640R.id.img_loading);
            if (imageView != null) {
                FrameLayout frameLayout2 = (FrameLayout) view;
                i = C2640R.id.title_view;
                TitleView titleView = (TitleView) view.findViewById(C2640R.id.title_view);
                if (titleView != null) {
