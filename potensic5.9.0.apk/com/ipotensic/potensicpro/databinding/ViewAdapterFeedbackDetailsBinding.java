...
public final class ViewAdapterFeedbackDetailsBinding implements ViewBinding {
    ...
    public static ViewAdapterFeedbackDetailsBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2640R.layout.view_adapter_feedback_details, viewGroup, false);
        if (z) {
    ...
    public static ViewAdapterFeedbackDetailsBinding bind(View view) {
        int i = C2640R.id.cl_bottom_layout;
        ConstraintLayout constraintLayout = (ConstraintLayout) view.findViewById(C2640R.id.cl_bottom_layout);
        if (constraintLayout != null) {
            i = C2640R.id.cl_customer_layout;
            ConstraintLayout constraintLayout2 = (ConstraintLayout) view.findViewById(C2640R.id.cl_customer_layout);
            if (constraintLayout2 != null) {
                i = C2640R.id.cl_top_layout;
                ConstraintLayout constraintLayout3 = (ConstraintLayout) view.findViewById(C2640R.id.cl_top_layout);
                if (constraintLayout3 != null) {
                    i = C2640R.id.image_view;
                    RoundImageView roundImageView = (RoundImageView) view.findViewById(C2640R.id.image_view);
                    if (roundImageView != null) {
                        i = C2640R.id.iv_down;
                        ImageView imageView = (ImageView) view.findViewById(C2640R.id.iv_down);
                        if (imageView != null) {
                            i = C2640R.id.iv_red_point;
                            ImageView imageView2 = (ImageView) view.findViewById(C2640R.id.iv_red_point);
                            if (imageView2 != null) {
                                i = C2640R.id.iv_right;
                                ImageView imageView3 = (ImageView) view.findViewById(C2640R.id.iv_right);
                                if (imageView3 != null) {
                                    i = C2640R.id.line1;
                                    View findViewById = view.findViewById(C2640R.id.line1);
                                    if (findViewById != null) {
                                        i = C2640R.id.rv_customer_feedback;
                                        RecyclerView recyclerView = (RecyclerView) view.findViewById(C2640R.id.rv_customer_feedback);
                                        if (recyclerView != null) {
                                            i = C2640R.id.rv_user_feedback;
                                            RecyclerView recyclerView2 = (RecyclerView) view.findViewById(C2640R.id.rv_user_feedback);
                                            if (recyclerView2 != null) {
                                                i = C2640R.id.tv_customer_reply;
                                                TextView textView = (TextView) view.findViewById(C2640R.id.tv_customer_reply);
                                                if (textView != null) {
                                                    i = C2640R.id.tv_customer_reply_time;
                                                    TextView textView2 = (TextView) view.findViewById(C2640R.id.tv_customer_reply_time);
                                                    if (textView2 != null) {
                                                        i = C2640R.id.tv_me;
                                                        TextView textView3 = (TextView) view.findViewById(C2640R.id.tv_me);
                                                        if (textView3 != null) {
                                                            i = C2640R.id.tv_title_1;
                                                            TextView textView4 = (TextView) view.findViewById(C2640R.id.tv_title_1);
                                                            if (textView4 != null) {
                                                                i = C2640R.id.tv_title_2;
                                                                TextView textView5 = (TextView) view.findViewById(C2640R.id.tv_title_2);
                                                                if (textView5 != null) {
                                                                    i = C2640R.id.tv_user_reply_1;
                                                                    TextView textView6 = (TextView) view.findViewById(C2640R.id.tv_user_reply_1);
                                                                    if (textView6 != null) {
                                                                        i = C2640R.id.tv_user_reply_2;
                                                                        TextView textView7 = (TextView) view.findViewById(C2640R.id.tv_user_reply_2);
                                                                        if (textView7 != null) {
                                                                            i = C2640R.id.tv_user_time_1;
                                                                            TextView textView8 = (TextView) view.findViewById(C2640R.id.tv_user_time_1);
                                                                            if (textView8 != null) {
                                                                                i = C2640R.id.tv_user_time_2;
                                                                                TextView textView9 = (TextView) view.findViewById(C2640R.id.tv_user_time_2);
                                                                                if (textView9 != null) {
                                                                                    i = C2640R.id.video_view;
                                                                                    ImageView imageView4 = (ImageView) view.findViewById(C2640R.id.video_view);
                                                                                    if (imageView4 != null) {
