...
public class FindDroneViewModel extends AndroidViewModel {
    ...
    public void drawCircle(float f) {
        if (this.circleManager.getValue() != null && this.isStyleLoaded.getValue().booleanValue()) {
            if (this.circle.getValue() == null) {
                this.circle.setValue(this.circleManager.getValue().create((CircleManager) new CircleOptions().withLatLng(new LatLng(this.curPlaneLat.getValue().doubleValue(), this.curPlaneLng.getValue().doubleValue())).withCircleColor(ColorUtils.colorToRgbaString(getApplication().getResources().getColor(C2640R.color.color_map_mark_new)))));
            }
    ...
    private void drawHomeLine(List<LatLng> list) {
        ...
        if (this.homeLine.getValue() == null) {
            this.homeLine.setValue(this.lineManager.getValue().create((LineManager) new LineOptions().withLatLngs(list).withLineColor(ColorUtils.colorToRgbaString(getApplication().getResources().getColor(C2640R.color.colorText)))));
        }
    ...
    private void drawPlaneLine(List<LatLng> list) {
        ...
        if (this.line.getValue() == null) {
            this.line.setValue(this.lineManager.getValue().create((LineManager) new LineOptions().withLatLngs(list).withLineColor(ColorUtils.colorToRgbaString(getApplication().getResources().getColor(C2640R.color.color_map_line)))));
        }
