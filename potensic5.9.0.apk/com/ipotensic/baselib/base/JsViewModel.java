...
@Metadata(m2336bv = {1, 0, 3}, m2337d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0006\u0018\u0000 \u00102\u00020\u0001:\u0001\u0010B\u0005¢\u0006\u0002\u0010\u0002J\u000e\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bJ\u000e\u0010\f\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bJ\u0010\u0010\r\u001a\u00020\t2\u0006\u0010\u000e\u001a\u00020\u000bH\u0007J\b\u0010\u000f\u001a\u00020\u000bH\u0007R\u0017\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\u0011"}, m2338d2 = {"Lcom/ipotensic/baselib/base/JsViewModel;", "Landroidx/lifecycle/ViewModel;", "()V", "titleBeanData", "Landroidx/lifecycle/MutableLiveData;", "Lcom/ipotensic/baselib/bean/TitleBean;", "getTitleBeanData", "()Landroidx/lifecycle/MutableLiveData;", "parseData", "", "json", "", "parseTitle", "showTips", "data", "webShowTips", "Companion", "BaseLib_release"}, m2339k = 1, m2340mv = {1, 1, 15})
...
public final class JsViewModel extends ViewModel {
    ...
    public final void parseData(String json) {
        ...
        try {
            ...
            if (optString != null && optString.hashCode() == -268142808 && optString.equals(INIT_TITLE)) {
                ...
                DDLog.m1683d(TAG, titleBean.toString());
            }
        } catch (Exception e) {
            DDLog.m1683d(TAG, "parseData error " + e);
        }
    }
    ...
    public final void showTips(String data) {
        ...
        try {
            ...
            DDLog.m1685e(TAG, "showTips error " + e);
        }
    }
