...
public class UsbConfig {
    public static final byte FLIGHT_REV_MSG_ID_GPSTEST_VALUE = 29;
    ...
    public static final byte REV_FLIGHT_FLY_RECORD = 14;
    ...
    public static final byte REV_NO_FLY_ZONE_CODE = 30;
