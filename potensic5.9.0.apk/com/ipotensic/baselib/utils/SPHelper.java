...
public class SPHelper {
    ...
    public static final String KEY_SHOW_NO_FLY_ZONE = "key_show_no_fly_zone";
    public static final String KEY_SHOW_UPDATE_NO_FLY_ZONE_DATA = "key_show_update_no_fly_zone_data";
    ...
    public static final String KEY_UNITS_KM = "key_units_km";
    ...
    public void setSupportNoFlyZone(boolean z) {
        this.editor.putBoolean(KEY_SHOW_NO_FLY_ZONE, z);
        this.editor.apply();
    }

    public boolean isSupportNoFlyZone() {
        return this.sharedPreferences.getBoolean(KEY_SHOW_NO_FLY_ZONE, false);
    }

    public void setShowUpdateNoFlyZoneData(String str, boolean z) {
        this.editor.putBoolean(str, z);
        this.editor.apply();
    }

    public boolean isShowUpdateNoFlyZoneData(String str) {
    ...
    public void setShowPGCoverTip(String str, boolean z) {
        this.editor.putBoolean(str, z);
        this.editor.apply();
    }

    public boolean isShowPGCoverTip(String str) {
