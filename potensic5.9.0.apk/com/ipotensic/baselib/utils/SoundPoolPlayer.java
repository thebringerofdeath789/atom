...
public class SoundPoolPlayer {
    ...
    public void init(Context context) {
        ...
        CAPTURE_VOICE_ID = soundPool2.load(context, C1819R.raw.capture_tips, 1);
        RECORD_VOICE_ID = this.mSoundPool.load(context, C1819R.raw.record_tips, 1);
        LOSE_CONTROL_VOICE_ID = this.mSoundPool.load(context, C1819R.raw.lose_control_tips, 1);
        RECONNECT_VOICE_ID = this.mSoundPool.load(context, C1819R.raw.reconnect_tips, 1);
        ONE_LEVEL_NO_POWER_VOICE_ID = this.mSoundPool.load(context, C1819R.raw.one_level_no_power, 1);
        TWO_LEVEL_NO_POWER_VOICE_ID = this.mSoundPool.load(context, C1819R.raw.two_level_no_power, 1);
        CONTROLLER_DISCONNECT_ID = this.mSoundPool.load(context, C1819R.raw.sound_controller_disconnect, 1);
        FLY_CTRL_DISCONNECT_ID = this.mSoundPool.load(context, C1819R.raw.sound_fly_ctrl_disconnect, 1);
        GPS_INTERFERENCE_ID = this.mSoundPool.load(context, C1819R.raw.gps_interference_tips, 1);
        COUNTDOWN_ONE = this.mSoundPool.load(context, C1819R.raw.audio_countdown_one, 1);
        COUNTDOWN_TWO = this.mSoundPool.load(context, C1819R.raw.audio_countdown_two, 1);
        COUNTDOWN_THREE = this.mSoundPool.load(context, C1819R.raw.audio_countdown_three, 1);
        SHORT_VIDEO_GO = this.mSoundPool.load(context, C1819R.raw.audio_short_video_go, 1);
    }
