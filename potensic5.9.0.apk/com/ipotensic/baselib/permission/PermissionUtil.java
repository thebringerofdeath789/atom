...
public class PermissionUtil {
    ...
    public static void requestAllPermissionWithDialog(final AppCompatActivity appCompatActivity, final OnPermissionListener onPermissionListener) {
        ...
        if (hasStoragePermission && hasLocationPermission) {
            ...
            new CustomPermissionDialog(appCompatActivity, appCompatActivity.getString(C1819R.string.permission_content), new CustomPermissionDialog.RequestPermissionListener() { // from class: com.ipotensic.baselib.permission.PermissionUtil.2
            ...
            new CustomPermissionDialog(appCompatActivity, appCompatActivity.getString(C1819R.string.android_enter_flight_interface_access_external_storage_tips), new CustomPermissionDialog.RequestPermissionListener() { // from class: com.ipotensic.baselib.permission.PermissionUtil.3
                @Override // com.ipotensic.baselib.views.dailog.CustomPermissionDialog.RequestPermissionListener
                public void grantPermission() {
                    PermissionUtil.requestStoragePermission(AppCompatActivity.this, onPermissionListener);
                }
    ...
    public static void requestStoragePermissionInDownloadWithDialog(final AppCompatActivity appCompatActivity, final OnPermissionListener onPermissionListener) {
        ...
        String string = appCompatActivity.getString(C1819R.string.button_refuse);
        String string2 = appCompatActivity.getString(C1819R.string.button_allow);
        if (!SPHelper.getInstance().getBoolean("key_is_first_camera_and_storage_permission_show", false)) {
            ...
            string = appCompatActivity.getString(C1819R.string.dialog_cancel);
            string2 = appCompatActivity.getString(C1819R.string.dialog_location_confirm);
        }
        String string3 = appCompatActivity.getString(C1819R.string.android_manual_download_tips);
    ...
    public static void requestStoragePermissionInShareWithDialog(final AppCompatActivity appCompatActivity, final OnPermissionListener onPermissionListener) {
        ...
        String string3 = appCompatActivity.getString(C1819R.string.android_manual_share_tips);
    ...
    public static BaseSyncDialog requestLocationPermissionWithDialog(final AppCompatActivity appCompatActivity, final SimpleResultListener<Boolean> simpleResultListener) {
        CustomPermissionDialog customPermissionDialog = new CustomPermissionDialog(appCompatActivity, appCompatActivity.getString(C1819R.string.android_enter_flight_interface_access_location_tips), new CustomPermissionDialog.RequestPermissionListener() { // from class: com.ipotensic.baselib.permission.PermissionUtil.11
            @Override // com.ipotensic.baselib.views.dailog.CustomPermissionDialog.RequestPermissionListener
            public void grantPermission() {
