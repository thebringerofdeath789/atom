            ...
            if (file.exists() && file.isDirectory()) {
                for (File file2 : file.listFiles()) {
                    if (file2.lastModified() < currentTimeMillis) {
                        DDLog.m1684e("file delete:" + file2.lastModified() + ",old time:" + currentTimeMillis);
                        file2.delete();
                    }
                }
            }
    ...
    public long getVideoDuration(String str) {
        ...
        try {
            try {
                ...
                DDLog.m1684e("获取视频信息出错 ：" + e.getMessage());
                try {
        ...
        PhoneConfig.threadPool.execute(new Runnable() { // from class: com.ipotensic.baselib.LocalFileManager.4
            ...
            public void run() {
                synchronized (LocalFileManager.class) {
                    ...
                    DDLog.m1684e("开始扫描媒体文件");
                    LocalFileManager.this.scanVideos();
                    DDLog.m1684e("媒体视频扫描完成");
                    LocalFileManager.this.scanPhotos();
                    DDLog.m1684e("媒体图片扫描完成");
        ...
        if (file.isDirectory()) {
            for (File file2 : file.listFiles()) {
                if (file2.exists() && file2.isFile() && file2.getName().contains(LOG_TAIL) && System.currentTimeMillis() - file2.lastModified() > 2592000000L) {
                    DDLog.m1684e("file delete1:" + file2.lastModified() + ",old time:" + System.currentTimeMillis());
                    file2.delete();
                }
            }
        }
