...
public class Token implements Serializable {
    ...
    public String toString() {
        return "Token{id=" + this.f2114id + ", email='" + this.email + "', nicname='" + this.nicname + "', location='" + this.location + "', regtime='" + this.regtime + "', intime='" + this.intime + "', status=" + this.status + ", token='" + this.token + "', timeout='" + this.timeout + "', userdevice='" + this.userdevice + "', brandcode=" + this.brandcode + ", avatar='" + this.avatar + "'}";
    }
}