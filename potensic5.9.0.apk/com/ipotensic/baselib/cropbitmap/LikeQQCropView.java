...
public class LikeQQCropView extends View {
    ...
    private void initAttr(AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C1819R.styleable.LikeQQCropView);
        this.maskColor = obtainStyledAttributes.getColor(C1819R.styleable.LikeQQCropView_maskColor, Color.parseColor("#60000000"));
        this.bgColor = obtainStyledAttributes.getColor(C1819R.styleable.LikeQQCropView_bgColor, -1);
        this.borderColor = obtainStyledAttributes.getColor(C1819R.styleable.LikeQQCropView_borderColor, ContextCompat.getColor(getContext(), R.color.white));
        this.radius = obtainStyledAttributes.getDimension(C1819R.styleable.LikeQQCropView_radius, -1.0f);
        this.maxScale = obtainStyledAttributes.getFloat(C1819R.styleable.LikeQQCropView_maxScale, 3.0f);
        float f = obtainStyledAttributes.getFloat(C1819R.styleable.LikeQQCropView_doubleClickScale, 1.8f);
        this.doubleClickScale = f;
                            ...
                            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                                ...
                                if (((Float) sparseArray.get(0)).floatValue() == -1.0f && ((Float) sparseArray.get(1)).floatValue() == -1.0f) {
                                    ...
                                    if (((Float) sparseArray.get(1)).floatValue() == -1.0f) {
                                        ...
                                        sparseArray2.put(0, (Float) sparseArray2.get(1));
                                        sparseArray.put(1, Float.valueOf(floatValue3));
                                        floatValue = ((Float) sparseArray.get(1)).floatValue();
                                        floatValue2 = ((Float) sparseArray.get(0)).floatValue();
                                    }
                            ...
                            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                                ...
                                if (((Float) sparseArray2.get(0)).floatValue() == -1.0f && ((Float) sparseArray2.get(1)).floatValue() == -1.0f) {
                                    ...
                                    if (((Float) sparseArray2.get(1)).floatValue() == -1.0f) {
                                        ...
                                        sparseArray3.put(0, (Float) sparseArray3.get(1));
                                        sparseArray2.put(1, Float.valueOf(floatValue3));
                                        floatValue = ((Float) sparseArray2.get(1)).floatValue();
                                        floatValue2 = ((Float) sparseArray2.get(0)).floatValue();
                                    }
