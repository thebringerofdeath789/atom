    ...
    private void drawHighlights(Canvas canvas) {
        ...
        if (highLights != null) {
            for (HighLight highLight : highLights) {
                ...
                int i = C18474.$SwitchMap$com$ipotensic$baselib$guide$model$HighLight$Shape[highLight.getShape().ordinal()];
                if (i == 1) {
            ...
            if (clickToDismissIds != null && clickToDismissIds.length > 0) {
                for (int i : clickToDismissIds) {
                    ...
                    if (findViewById != null) {
                        findViewById.setOnClickListener(new ScaleClickListener(1000, z) { // from class: com.ipotensic.baselib.guide.core.GuideLayout.2
                            @Override // com.ipotensic.baselib.listener.ScaleClickListener
                            public void click(View view) {
                                GuideLayout.this.remove();
                            }
