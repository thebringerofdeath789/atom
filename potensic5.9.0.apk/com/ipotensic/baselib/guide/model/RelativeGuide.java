...
public class RelativeGuide {
    ...
    public final View getGuideLayout(final ViewGroup viewGroup, Controller controller, GuidePage guidePage) {
        ...
        inflate.post(new Runnable() { // from class: com.ipotensic.baselib.guide.model.RelativeGuide.1
            ...
            public void run() {
                ...
                MarginInfo marginInfo = relativeGuide.getMarginInfo(relativeGuide.gravity, viewGroup, inflate.getHeight(), inflate.getWidth());
                LogUtil.m1695e(marginInfo.toString());
                RelativeGuide.this.offsetMargin(marginInfo, viewGroup, inflate);
