...
public class CustomSeekBar extends View {
    ...
    public CustomSeekBar(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C1819R.styleable.MyCustomSeekBarView, i, 0);
        this.progress = (int) obtainStyledAttributes.getDimension(C1819R.styleable.MyCustomSeekBarView_MyCustomSeekBarThumbProgress, 0.0f);
        this.seekBarSize = obtainStyledAttributes.getDimensionPixelSize(C1819R.styleable.MyCustomSeekBarView_MyCustomSeekBarSize, 10);
        this.bgColor = obtainStyledAttributes.getColor(C1819R.styleable.MyCustomSeekBarView_MyCustomSeekBarBgColor, context.getResources().getColor(C1819R.color.color_50_black));
        this.progressColor = obtainStyledAttributes.getColor(C1819R.styleable.MyCustomSeekBarView_MyCustomSeekBarProgressColor, -1);
        this.thumbSize = obtainStyledAttributes.getDimensionPixelSize(C1819R.styleable.MyCustomSeekBarView_MyCustomSeekBarThumbSize, this.size);
        this.thumbTouchSize = obtainStyledAttributes.getDimensionPixelSize(C1819R.styleable.MyCustomSeekBarView_MyCustomSeekBarThumbTouchSize, this.size) + 3;
        this.thumbColor = obtainStyledAttributes.getColor(C1819R.styleable.MyCustomSeekBarView_MyCustomSeekBarThumbColor, -1);
