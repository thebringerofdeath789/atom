...
public class ShadowLayout extends FrameLayout {
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        TypedArray typedArray = getTypedArray(context, attributeSet, C1819R.styleable.ShadowLayout);
        if (typedArray == null) {
            return;
        }
        try {
            this.leftShow = typedArray.getBoolean(C1819R.styleable.ShadowLayout_yc_leftShow, true);
            this.rightShow = typedArray.getBoolean(C1819R.styleable.ShadowLayout_yc_rightShow, true);
            this.bottomShow = typedArray.getBoolean(C1819R.styleable.ShadowLayout_yc_bottomShow, true);
            this.topShow = typedArray.getBoolean(C1819R.styleable.ShadowLayout_yc_topShow, true);
            this.mCornerRadius = typedArray.getDimension(C1819R.styleable.ShadowLayout_yc_cornerRadius, 0.0f);
            this.mShadowLimit = typedArray.getDimension(C1819R.styleable.ShadowLayout_yc_shadowLimit, 0.0f);
            this.mDx = typedArray.getDimension(C1819R.styleable.ShadowLayout_yc_dx, 0.0f);
            this.mDy = typedArray.getDimension(C1819R.styleable.ShadowLayout_yc_dy, 0.0f);
            this.mShadowColor = typedArray.getColor(C1819R.styleable.ShadowLayout_yc_shadowColor, getResources().getColor(C1819R.color.color_shadow));
        } finally {
            typedArray.recycle();
        }
    }
