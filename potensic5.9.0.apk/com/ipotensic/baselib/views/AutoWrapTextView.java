...
public class AutoWrapTextView extends View {
    ...
    private void initStyle(Context context, AttributeSet attributeSet) {
        ...
        this.mTextColor = obtainStyledAttributes.getColor(C1819R.styleable.AutoWrapTextViewStyle_textColor, ViewCompat.MEASURED_STATE_MASK);
        this.mTextSize = obtainStyledAttributes.getDimensionPixelSize(C1819R.styleable.AutoWrapTextViewStyle_textSize, 50);
        this.mLineSpacingExtra = obtainStyledAttributes.getInteger(C1819R.styleable.AutoWrapTextViewStyle_lineSpacingExtra, 15);
