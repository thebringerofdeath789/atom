...
public class ExcelLayout extends ViewGroup {
    ...
    public ExcelLayout(Context context, AttributeSet attributeSet) {
        ...
        this.maxItemSizeY = 0;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1819R.styleable.ExcelLayout);
        this.borderColor = obtainStyledAttributes.getColor(C1819R.styleable.ExcelLayout_ELBorderColor, ViewCompat.MEASURED_STATE_MASK);
    ...
    public class ExcelLayoutParam extends ViewGroup.LayoutParams {
        ...
        public ExcelLayoutParam(Context context, AttributeSet attributeSet) {
            ...
            this.spanY = 0;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1819R.styleable.ExcelLayout);
            this.startX = obtainStyledAttributes.getInt(C1819R.styleable.ExcelLayout_ELStartX, 0);
            this.startY = obtainStyledAttributes.getInt(C1819R.styleable.ExcelLayout_ELStartY, 0);
            this.spanX = obtainStyledAttributes.getInt(C1819R.styleable.ExcelLayout_ELSpanX, 1);
            this.spanY = obtainStyledAttributes.getInt(C1819R.styleable.ExcelLayout_ELSpanY, 1);
            obtainStyledAttributes.recycle();
        }
