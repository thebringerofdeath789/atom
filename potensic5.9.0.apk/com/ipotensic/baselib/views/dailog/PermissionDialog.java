...
@Metadata(m2336bv = {1, 0, 3}, m2337d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001:\u0001\u0014B7\b\u0016\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0005\u0012\u0006\u0010\u0007\u001a\u00020\u0005\u0012\u0006\u0010\b\u001a\u00020\u0005\u0012\u0006\u0010\t\u001a\u00020\n¢\u0006\u0002\u0010\u000bB\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\t\u001a\u00020\n¢\u0006\u0002\u0010\fJ\u0012\u0010\u0012\u001a\u00020\u00132\b\u0010\u0002\u001a\u0004\u0018\u00010\u0003H\u0014R\u0011\u0010\t\u001a\u00020\n¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000eR\u000e\u0010\u000f\u001a\u00020\u0010X\u0082.¢\u0006\u0002\n\u0000R\u000e\u0010\u0011\u001a\u00020\u0010X\u0082.¢\u0006\u0002\n\u0000¨\u0006\u0015"}, m2338d2 = {"Lcom/ipotensic/baselib/views/dailog/PermissionDialog;", "Lcom/ipotensic/baselib/base/BaseSyncDialog;", "context", "Landroid/content/Context;", MessageBundle.TITLE_ENTRY, "", "content", "leftStr", "rightStr", "grantListener", "Lcom/ipotensic/baselib/views/dailog/PermissionDialog$OnGrantListener;", "(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/ipotensic/baselib/views/dailog/PermissionDialog$OnGrantListener;)V", "(Landroid/content/Context;Lcom/ipotensic/baselib/views/dailog/PermissionDialog$OnGrantListener;)V", "getGrantListener", "()Lcom/ipotensic/baselib/views/dailog/PermissionDialog$OnGrantListener;", "tvAllow", "Landroid/widget/TextView;", "tvNotAllow", "initView", "", "OnGrantListener", "BaseLib_release"}, m2339k = 1, m2340mv = {1, 1, 15})
...
public final class PermissionDialog extends BaseSyncDialog {
    ...
    /* compiled from: PermissionDialog.kt */
    @Metadata(m2336bv = {1, 0, 3}, m2337d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006"}, m2338d2 = {"Lcom/ipotensic/baselib/views/dailog/PermissionDialog$OnGrantListener;", "", "onGrant", "", "isGrant", "", "BaseLib_release"}, m2339k = 1, m2340mv = {1, 1, 15})
    ...
    public PermissionDialog(Context context, OnGrantListener grantListener) {
        super(context, C1819R.layout.view_dialog_permission);
    ...
    public PermissionDialog(Context context, String title, String content, String leftStr, String rightStr, OnGrantListener grantListener) {
        ...
        Intrinsics.checkParameterIsNotNull(grantListener, "grantListener");
        View findViewById = findViewById(C1819R.id.tv_title);
        Intrinsics.checkExpressionValueIsNotNull(findViewById, "findViewById<TextView>(R.id.tv_title)");
        ((TextView) findViewById).setText(title);
        View findViewById2 = findViewById(C1819R.id.tv_content);
        Intrinsics.checkExpressionValueIsNotNull(findViewById2, "findViewById<TextView>(R.id.tv_content)");
        ((TextView) findViewById2).setText(content);
        View findViewById3 = findViewById(C1819R.id.tv_not_allow);
        ...
        View findViewById4 = findViewById(C1819R.id.tv_allow);
    ...
    protected void initView(Context context) {
        View findViewById = findViewById(C1819R.id.tv_not_allow);
        ...
        View findViewById2 = findViewById(C1819R.id.tv_allow);
