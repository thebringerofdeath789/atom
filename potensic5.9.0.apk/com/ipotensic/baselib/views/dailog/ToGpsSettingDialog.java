...
public class ToGpsSettingDialog extends BaseSyncDialog {
    ...
    public ToGpsSettingDialog(Context context, final ResultListener<Boolean> resultListener) {
        super(context, C1819R.layout.view_dialog_to_gps_setting);
        setCanceledOnTouchOutside(false);
        setCancelable(false);
        findViewById(C1819R.id.btn_cancel).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.baselib.views.dailog.ToGpsSettingDialog.1
        ...
        findViewById(C1819R.id.btn_confirm).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.baselib.views.dailog.ToGpsSettingDialog.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
