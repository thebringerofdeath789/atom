...
public class WheelView extends View implements Runnable {
    ...
    public WheelView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1819R.attr.WheelStyle);
    }
    ...
    public WheelView(Context context, AttributeSet attributeSet, int i) {
        ...
        initAttrs(context, attributeSet, i, C1819R.style.WheelDefault);
        initTextPaint();
    ...
    public void setStyle(int i) {
        initAttrs(getContext(), null, C1819R.attr.WheelStyle, i);
        initTextPaint();
    ...
    private void initAttrs(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1819R.styleable.WheelView, i, i2);
        this.visibleItemCount = obtainStyledAttributes.getInt(C1819R.styleable.WheelView_wheel_visibleItemCount, 5);
        this.sameWidthEnabled = obtainStyledAttributes.getBoolean(C1819R.styleable.WheelView_wheel_sameWidthEnabled, false);
        this.maxWidthText = obtainStyledAttributes.getString(C1819R.styleable.WheelView_wheel_maxWidthText);
        this.textColor = obtainStyledAttributes.getColor(C1819R.styleable.WheelView_wheel_itemTextColor, -7829368);
        this.selectedTextColor = obtainStyledAttributes.getColor(C1819R.styleable.WheelView_wheel_itemTextColorSelected, ViewCompat.MEASURED_STATE_MASK);
        this.textSize = obtainStyledAttributes.getDimension(C1819R.styleable.WheelView_wheel_itemTextSize, f2 * 15.0f);
        this.selectedTextSize = obtainStyledAttributes.getDimension(C1819R.styleable.WheelView_wheel_itemTextSizeSelected, this.textSize);
        this.selectedTextBold = obtainStyledAttributes.getBoolean(C1819R.styleable.WheelView_wheel_itemTextBoldSelected, false);
        this.textAlign = obtainStyledAttributes.getInt(C1819R.styleable.WheelView_wheel_itemTextAlign, 0);
        this.itemSpace = obtainStyledAttributes.getDimensionPixelSize(C1819R.styleable.WheelView_wheel_itemSpace, (int) (20.0f * f));
        this.cyclicEnabled = obtainStyledAttributes.getBoolean(C1819R.styleable.WheelView_wheel_cyclicEnabled, false);
        this.indicatorEnabled = obtainStyledAttributes.getBoolean(C1819R.styleable.WheelView_wheel_indicatorEnabled, true);
        this.indicatorColor = obtainStyledAttributes.getColor(C1819R.styleable.WheelView_wheel_indicatorColor, -3552823);
        float f3 = f * 1.0f;
        this.indicatorSize = obtainStyledAttributes.getDimension(C1819R.styleable.WheelView_wheel_indicatorSize, f3);
        this.curvedIndicatorSpace = obtainStyledAttributes.getDimensionPixelSize(C1819R.styleable.WheelView_wheel_curvedIndicatorSpace, (int) f3);
        this.curtainEnabled = obtainStyledAttributes.getBoolean(C1819R.styleable.WheelView_wheel_curtainEnabled, false);
        this.curtainColor = obtainStyledAttributes.getColor(C1819R.styleable.WheelView_wheel_curtainColor, -1);
        this.curtainCorner = obtainStyledAttributes.getInt(C1819R.styleable.WheelView_wheel_curtainCorner, 0);
        this.curtainRadius = obtainStyledAttributes.getDimension(C1819R.styleable.WheelView_wheel_curtainRadius, 0.0f);
        this.atmosphericEnabled = obtainStyledAttributes.getBoolean(C1819R.styleable.WheelView_wheel_atmosphericEnabled, false);
        this.curvedEnabled = obtainStyledAttributes.getBoolean(C1819R.styleable.WheelView_wheel_curvedEnabled, false);
        this.curvedMaxAngle = obtainStyledAttributes.getInteger(C1819R.styleable.WheelView_wheel_curvedMaxAngle, 90);
    ...
    */
    private int findPosition(java.lang.Object r8) {
        ...
        L19:
            ...
            goto L5e
        L20:
            com.ipotensic.baselib.views.wheelview.contract.WheelFormatter r5 = r7.formatter
            if (r5 == 0) goto L35
            java.lang.String r5 = r5.formatItem(r3)
            com.ipotensic.baselib.views.wheelview.contract.WheelFormatter r6 = r7.formatter
            java.lang.String r6 = r6.formatItem(r8)
            boolean r5 = r5.equals(r6)
            if (r5 == 0) goto L35
            goto L5e
        L35:
            boolean r5 = r3 instanceof com.ipotensic.baselib.views.wheelview.contract.TextProvider
            if (r5 == 0) goto L4b
            r5 = r3
            com.ipotensic.baselib.views.wheelview.contract.TextProvider r5 = (com.ipotensic.baselib.views.wheelview.contract.TextProvider) r5
        ...
        L62:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ipotensic.baselib.views.wheelview.widget.WheelView.findPosition(java.lang.Object):int");
    }
