...
public class StrokeTextView extends AppCompatTextView {
    ...
    public void init(AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C1819R.styleable.StrokeTextView);
        this.colors = obtainStyledAttributes.getColor(C1819R.styleable.StrokeTextView_stroke_color, getContext().getColor(C1819R.color.black));
