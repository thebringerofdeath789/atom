...
public class NetworkStateReceiver extends BroadcastReceiver {
    ...
    public void register(Context context) {
        ...
        try {
            ...
            this.isRunning = true;
            DDLog.m1691w("注册网络监听广播:" + context.getClass().getSimpleName());
        } catch (Exception e) {
            DDLog.m1684e("注册监听错误:" + e.getMessage());
        }
    }
    ...
    public void unRegister(Context context) {
        if (this.isRunning) {
            ...
            DDLog.m1691w("取消注册网络监听广播:" + context.getClass().getSimpleName());
        }
    }
    ...
    public String getIp(Context context) {
        ...
        DDLog.m1691w("dhcpinfo:" + dhcpInfo.toString());
            ...
            connectivityManager.requestNetwork(builder.build(), new ConnectivityManager.NetworkCallback() { // from class: com.ipotensic.baselib.broadcasts.NetworkStateReceiver.4
                ...
                public void onAvailable(Network network) {
                    ...
                    try {
                        ...
                        DDLog.m1684e("网络 ConnectivityManager.NetworkCallback.onAvailable: " + e.getMessage());
                    }
