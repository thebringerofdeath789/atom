...
public class Share2 {
    ...
    public void shareBySystem() {
        if (checkShareParam()) {
            ...
            if (createShareIntent == null) {
                DDLog.m1685e(TAG, "shareBySystem cancel.");
                return;
            }
            if (this.title == null) {
                this.title = "";
        ...
        switch (str) {
            ...
            case "image/*":
                ...
                if (this.isSingle) {
                    ...
                    DDLog.m1685e(StringLookupFactory.KEY_FILE, "shareFileUri: " + this.shareFileUri);
                } else {
            ...
            case "text/plain":
                ...
                return intent;
            default:
                DDLog.m1685e(TAG, this.contentType + " is not support share type.");
                return null;
        }
    }
    ...
    private boolean checkShareParam() {
        if (this.activity == null) {
            DDLog.m1685e(TAG, "activity is null.");
            return false;
        }
        if (TextUtils.isEmpty(this.contentType)) {
            DDLog.m1685e(TAG, "Share content type is empty.");
            return false;
        }
        if ("text/plain".equals(this.contentType)) {
            ...
            DDLog.m1685e(TAG, "Share text context is empty.");
            return false;
        }
        if (this.shareFileUri != null || this.uris != null) {
            return true;
        }
        DDLog.m1685e(TAG, "Share file path is null.");
        return false;
    }
