            ...
            if (hashCode != 106905) {
                if (hashCode != 3015911) {
                    if (hashCode == 3208415 && tag.equals(TAG_HOME)) {
                        return C1819R.mipmap.icon_home;
                    }
                } else if (tag.equals(TAG_BACK)) {
                    return C1819R.mipmap.img_arrow_left_black;
                }
            } else if (tag.equals(TAG_LANGUAGE)) {
                return C1819R.mipmap.icon_language;
            }
        }
        return 0;
    }
