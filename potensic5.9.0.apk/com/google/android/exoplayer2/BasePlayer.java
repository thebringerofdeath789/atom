...
public abstract class BasePlayer implements Player {
    ...
    public final int getBufferedPercentage() {
        ...
        if (bufferedPosition == C0858C.TIME_UNSET || duration == C0858C.TIME_UNSET) {
            return 0;
        }
        if (duration == 0) {
            return 100;
    ...
    public final long getCurrentLiveOffset() {
        Timeline currentTimeline = getCurrentTimeline();
        return (currentTimeline.isEmpty() || currentTimeline.getWindow(getCurrentWindowIndex(), this.window).windowStartTimeMs == C0858C.TIME_UNSET) ? C0858C.TIME_UNSET : (this.window.getCurrentUnixTimeMs() - this.window.windowStartTimeMs) - getContentPosition();
    }
    ...
    public final long getContentDuration() {
        Timeline currentTimeline = getCurrentTimeline();
        return currentTimeline.isEmpty() ? C0858C.TIME_UNSET : currentTimeline.getWindow(getCurrentWindowIndex(), this.window).getDurationMs();
    }
