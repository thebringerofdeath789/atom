...
public final class OutputConsumerAdapterV30 implements MediaParser.OutputConsumer {
    ...
    public OutputConsumerAdapterV30(Format format, int i, boolean z) {
        ...
        this.sampleTimestampUpperLimitFilterUs = C0858C.TIME_UNSET;
        this.muxedCaptionFormats = ImmutableList.m1541of();
    }
    ...
    public void onSeekMapFound(MediaParser.SeekMap seekMap) {
        ...
        if (this.seekingDisabled) {
            if (durationMicros == -2147483648L) {
                durationMicros = C0858C.TIME_UNSET;
            }
    ...
    private TrackOutput.CryptoData toExoPlayerCryptoData(int i, MediaCodec.CryptoInfo cryptoInfo) {
        ...
        try {
            ...
            Log.m1498e(TAG, new StringBuilder(String.valueOf(valueOf).length() + 43).append("Unexpected error while parsing CryptoInfo: ").append(valueOf).toString(), e);
            i2 = 0;
        }
    ...
    private static final class SeekMapAdapter implements SeekMap {
        ...
        public long getDurationUs() {
            ...
            return durationMicros != -2147483648L ? durationMicros : C0858C.TIME_UNSET;
        }
