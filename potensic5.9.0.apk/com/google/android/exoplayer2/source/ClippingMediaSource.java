...
public final class ClippingMediaSource extends CompositeMediaSource<Void> {
    ...
    private static final class ClippingTimeline extends ForwardingTimeline {
        ...
        public ClippingTimeline(Timeline timeline, long j, long j2) throws IllegalClippingException {
            ...
            if (window.durationUs != C0858C.TIME_UNSET) {
            ...
            this.startUs = max;
            this.endUs = max2;
            this.durationUs = max2 == C0858C.TIME_UNSET ? -9223372036854775807L : max2 - max;
            if (window.isDynamic && (max2 == C0858C.TIME_UNSET || (window.durationUs != C0858C.TIME_UNSET && max2 == window.durationUs))) {
                z = true;
            }
            this.isDynamic = z;
        }
        ...
        public Timeline.Window getWindow(int i, Timeline.Window window, long j) {
            ...
            if (window.defaultPositionUs != C0858C.TIME_UNSET) {
            ...
            long usToMs = C0858C.usToMs(this.startUs);
            if (window.presentationStartTimeMs != C0858C.TIME_UNSET) {
                window.presentationStartTimeMs += usToMs;
            }
            if (window.windowStartTimeMs != C0858C.TIME_UNSET) {
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            return period.set(period.f1881id, period.uid, 0, j == C0858C.TIME_UNSET ? -9223372036854775807L : j - positionInWindowUs, positionInWindowUs);
        }
    }
}