...
public final class HlsPlaylistParser implements ParsingLoadable.Parser<HlsPlaylist> {
                    ...
                    switch (c) {
                        case 0:
                            ...
                            if (resolveToUri2 != null) {
                                ...
                                arrayList3 = arrayList23;
                                Log.m1501w(LOG_TAG, "EXT-X-MEDIA tag with missing mandatory URI attribute: skipping");
                                break;
                            }
                        case 1:
                            format = format2;
    ...
    private static HlsMediaPlaylist parseMediaPlaylist(HlsMasterPlaylist hlsMasterPlaylist, HlsMediaPlaylist hlsMediaPlaylist, LineIterator lineIterator, String str) throws IOException {
        ...
        HlsMediaPlaylist.ServerControl serverControl = new HlsMediaPlaylist.ServerControl(C0858C.TIME_UNSET, false, C0858C.TIME_UNSET, C0858C.TIME_UNSET, false);
        ...
        boolean z5 = false;
        int i4 = 0;
        long j14 = C0858C.TIME_UNSET;
        boolean z6 = false;
        int i5 = 0;
        int i6 = 1;
        long j15 = C0858C.TIME_UNSET;
        long j16 = C0858C.TIME_UNSET;
        boolean z7 = false;
                            ...
                            if (next.startsWith(TAG_SKIP)) {
                                ...
                                if (next.startsWith(TAG_KEY)) {
                                    ...
                                    if (next.startsWith(TAG_BYTERANGE)) {
                                        ...
                                        if (j6 == 0) {
                                            j6 = C0858C.msToUs(Util.parseXsDateTime(next.substring(next.indexOf(58) + 1))) - j10;
                                        } else {
                                            str3 = str5;
                                            i = i4;
                                            part = part2;
                                        ...
                                        int parseOptionalIntAttr = parseOptionalIntAttr(next, REGEX_LAST_PART, j16 != C0858C.TIME_UNSET ? (arrayList5.isEmpty() ? ((HlsMediaPlaylist.Segment) Iterables.getLast(arrayList4)).parts : arrayList5).size() - 1 : -1);
    ...
    private static DrmInitData.SchemeData parseDrmSchemeData(String str, String str2, Map<String, String> map) throws ParserException {
        ...
        if (KEYFORMAT_WIDEVINE_PSSH_BINARY.equals(str2)) {
            ...
            return new DrmInitData.SchemeData(C0858C.WIDEVINE_UUID, MimeTypes.VIDEO_MP4, Base64.decode(parseStringAttr.substring(parseStringAttr.indexOf(44)), 0));
        }
        if (KEYFORMAT_WIDEVINE_PSSH_JSON.equals(str2)) {
            return new DrmInitData.SchemeData(C0858C.WIDEVINE_UUID, "hls", Util.getUtf8Bytes(str));
        }
        ...
        return new DrmInitData.SchemeData(C0858C.PLAYREADY_UUID, MimeTypes.VIDEO_MP4, PsshAtomUtil.buildPsshAtom(C0858C.PLAYREADY_UUID, Base64.decode(parseStringAttr2.substring(parseStringAttr2.indexOf(44)), 0)));
    }
    ...
    private static String parseEncryptionScheme(String str) {
        return (METHOD_SAMPLE_AES_CENC.equals(str) || METHOD_SAMPLE_AES_CTR.equals(str)) ? C0858C.CENC_TYPE_cenc : C0858C.CENC_TYPE_cbcs;
    }
