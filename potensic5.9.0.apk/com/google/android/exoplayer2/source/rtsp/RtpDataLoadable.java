...
final class RtpDataLoadable implements Loader.Loadable {
    ...
    private volatile long pendingSeekPositionUs = C0858C.TIME_UNSET;
    ...
    public void setTimestamp(long j) {
        if (j == C0858C.TIME_UNSET || ((RtpExtractor) Assertions.checkNotNull(this.extractor)).hasReadFirstRtpPacket()) {
            return;
        }
    ...
    public void load() throws IOException {
        ...
        try {
            ...
            while (!this.loadCancelled) {
                if (this.pendingSeekPositionUs != C0858C.TIME_UNSET) {
                    this.extractor.seek(this.nextRtpTimestamp, this.pendingSeekPositionUs);
                    this.pendingSeekPositionUs = C0858C.TIME_UNSET;
                }
