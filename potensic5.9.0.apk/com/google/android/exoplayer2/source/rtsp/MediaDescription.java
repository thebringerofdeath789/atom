...
final class MediaDescription {
    ...
    public static final class RtpMapAttribute {
        ...
        public static RtpMapAttribute parse(String str) throws ParserException {
            ...
            String[] split2 = Util.split(split[1], InternalZipConstants.ZIP_FILE_SEPARATOR);
            Assertions.checkArgument(split2.length >= 2);
            return new RtpMapAttribute(parseInt, split2[0], RtspMessageUtil.parseInt(split2[1]), split2.length == 3 ? RtspMessageUtil.parseInt(split2[2]) : -1);
        }
