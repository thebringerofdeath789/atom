...
class SampleDataQueue {
    ...
    private static AllocationNode readEncryptionData(AllocationNode allocationNode, DecoderInputBuffer decoderInputBuffer, SampleQueue.SampleExtrasHolder sampleExtrasHolder, ParsableByteArray parsableByteArray) {
        ...
        if (cryptoInfo.f1882iv == null) {
            cryptoInfo.f1882iv = new byte[16];
        } else {
            Arrays.fill(cryptoInfo.f1882iv, (byte) 0);
        }
        AllocationNode readData2 = readData(readData, j2, cryptoInfo.f1882iv, i2);
        long j3 = j2 + i2;
        if (z) {
        ...
        cryptoInfo.set(i3, iArr2, iArr4, cryptoData.encryptionKey, cryptoInfo.f1882iv, cryptoData.cryptoMode, cryptoData.encryptedBlocks, cryptoData.clearBlocks);
