...
public final class AdPlaybackState implements Bundleable {
    ...
    public static final AdPlaybackState NONE = new AdPlaybackState(null, new long[0], null, 0, C0858C.TIME_UNSET);
    ...
    public static final class AdGroup implements Bundleable {
        ...
        private static long[] copyDurationsUsWithSpaceForAdCount(long[] jArr, int i) {
            ...
            Arrays.fill(copyOf, length, max, C0858C.TIME_UNSET);
            return copyOf;
        }
    ...
    public AdPlaybackState(Object obj, long... jArr) {
        this(obj, jArr, null, 0L, C0858C.TIME_UNSET);
    }
    ...
    private boolean isPositionBeforeAdGroup(long j, long j2, int i) {
        ...
        return j3 == Long.MIN_VALUE ? j2 == C0858C.TIME_UNSET || j < j2 : j < j3;
    }
    ...
    public static AdPlaybackState fromBundle(Bundle bundle) {
        ...
        long j2 = bundle.getLong(keyForField(4), C0858C.TIME_UNSET);
        if (longArray == null) {
            longArray = new long[0];
        }
