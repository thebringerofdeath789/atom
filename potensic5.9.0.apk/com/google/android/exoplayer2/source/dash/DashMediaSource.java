...
public final class DashMediaSource extends BaseMediaSource {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public Factory(DashChunkSource.Factory factory, DataSource.Factory factory2) {
            ...
            this.targetLiveOffsetOverrideMs = C0858C.TIME_UNSET;
        ...
        public Factory setLivePresentationDelayMs(long j, boolean z) {
            this.targetLiveOffsetOverrideMs = z ? j : C0858C.TIME_UNSET;
            if (!z) {
        ...
        public DashMediaSource createMediaSource(DashManifest dashManifest, MediaItem mediaItem) {
            ...
            boolean z3 = mediaItem.liveConfiguration.targetOffsetMs != C0858C.TIME_UNSET;
        ...
        public DashMediaSource createMediaSource(MediaItem mediaItem) {
            ...
            boolean z3 = mediaItem2.liveConfiguration.targetOffsetMs == C0858C.TIME_UNSET && this.targetLiveOffsetOverrideMs != C0858C.TIME_UNSET;
            if (z || z2 || z3) {
    ...
    private DashMediaSource(MediaItem mediaItem, DashManifest dashManifest, DataSource.Factory factory, ParsingLoadable.Parser<? extends DashManifest> parser, DashChunkSource.Factory factory2, CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory, DrmSessionManager drmSessionManager, LoadErrorHandlingPolicy loadErrorHandlingPolicy, long j) {
        ...
        this.expiredManifestPublishTimeUs = C0858C.TIME_UNSET;
    ...
    public MediaPeriod createPeriod(MediaSource.MediaPeriodId mediaPeriodId, Allocator allocator, long j) {
        ...
        this.periodsById.put(dashMediaPeriod.f1903id, dashMediaPeriod);
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        ...
        this.periodsById.remove(dashMediaPeriod.f1903id);
    }
    ...
    */
    ...
    public void onUtcTimestampResolutionError(IOException iOException) {
        Log.m1498e("DashMediaSource", "Failed to resolve time offset.", iOException);
        processManifest(true);
    }
    ...
    private void processManifest(boolean z) {
        ...
        long msToUs = C0858C.msToUs(Util.getNowUnixTimeMs(this.elapsedRealtimeOffsetMs));
        ...
        if (z2 && this.manifest.timeShiftBufferDepthMs != C0858C.TIME_UNSET) {
            availableStartTimeInManifestUs = Math.max(availableStartTimeInManifestUs, availableEndTimeInManifestUs - C0858C.msToUs(this.manifest.timeShiftBufferDepthMs));
        }
        long j3 = availableEndTimeInManifestUs - availableStartTimeInManifestUs;
        if (this.manifest.dynamic) {
            Assertions.checkState(this.manifest.availabilityStartTimeMs != C0858C.TIME_UNSET);
            long msToUs2 = (msToUs - C0858C.msToUs(this.manifest.availabilityStartTimeMs)) - availableStartTimeInManifestUs;
            updateMediaItemLiveConfiguration(msToUs2, j3);
            long usToMs = this.manifest.availabilityStartTimeMs + C0858C.usToMs(availableStartTimeInManifestUs);
            long msToUs3 = msToUs2 - C0858C.msToUs(this.liveConfiguration.targetOffsetMs);
            j = usToMs;
        ...
        long msToUs4 = availableStartTimeInManifestUs - C0858C.msToUs(period.startMs);
        ...
        if (z && this.manifest.dynamic && this.manifest.minUpdatePeriodMs != C0858C.TIME_UNSET) {
    ...
    private void updateMediaItemLiveConfiguration(long j, long j2) {
        ...
        long j3;
        float f;
        if (this.mediaItem.liveConfiguration.maxOffsetMs != C0858C.TIME_UNSET) {
            usToMs = this.mediaItem.liveConfiguration.maxOffsetMs;
        } else if (this.manifest.serviceDescription != null && this.manifest.serviceDescription.maxOffsetMs != C0858C.TIME_UNSET) {
            usToMs = this.manifest.serviceDescription.maxOffsetMs;
        } else {
            usToMs = C0858C.usToMs(j);
        }
        if (this.mediaItem.liveConfiguration.minOffsetMs != C0858C.TIME_UNSET) {
            usToMs2 = this.mediaItem.liveConfiguration.minOffsetMs;
        } else if (this.manifest.serviceDescription != null && this.manifest.serviceDescription.minOffsetMs != C0858C.TIME_UNSET) {
            usToMs2 = this.manifest.serviceDescription.minOffsetMs;
        } else {
            usToMs2 = C0858C.usToMs(j - j2);
            if (usToMs2 < 0 && usToMs > 0) {
                usToMs2 = 0;
            }
            if (this.manifest.minBufferTimeMs != C0858C.TIME_UNSET) {
        ...
        } else if (this.manifest.serviceDescription != null && this.manifest.serviceDescription.targetOffsetMs != C0858C.TIME_UNSET) {
            j3 = this.manifest.serviceDescription.targetOffsetMs;
        } else if (this.manifest.suggestedPresentationDelayMs != C0858C.TIME_UNSET) {
        ...
        if (j3 > usToMs) {
            j3 = Util.constrainValue(C0858C.usToMs(j - Math.min(MIN_LIVE_DEFAULT_START_POSITION_US, j2 / 2)), j4, usToMs);
        }
        long j5 = j3;
        ...
        this.liveConfiguration = new MediaItem.LiveConfiguration(j5, j4, usToMs, f, f2);
    }
    ...
    private static long getIntervalUntilNextManifestRefreshMs(DashManifest dashManifest, long j) {
        ...
        long msToUs2 = C0858C.msToUs(j);
        long msToUs3 = C0858C.msToUs(dashManifest.availabilityStartTimeMs);
        long msToUs4 = C0858C.msToUs(5000L);
    ...
    private static final class DashTimeline extends Timeline {
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            return period.set(z ? this.manifest.getPeriod(i).f1906id : null, z ? Integer.valueOf(this.firstPeriodId + i) : null, 0, this.manifest.getPeriodDurationUs(i), C0858C.msToUs(this.manifest.getPeriod(i).startMs - this.manifest.getPeriod(0).startMs) - this.offsetInFirstPeriodUs);
        }
        ...
        private static boolean isMovingLiveWindow(DashManifest dashManifest) {
            return dashManifest.dynamic && dashManifest.minUpdatePeriodMs != C0858C.TIME_UNSET && dashManifest.durationMs == C0858C.TIME_UNSET;
        }
    }
