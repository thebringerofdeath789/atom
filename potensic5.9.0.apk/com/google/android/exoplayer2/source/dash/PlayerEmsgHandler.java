...
public final class PlayerEmsgHandler implements Handler.Callback {
    ...
    public static boolean isPlayerEmsgEvent(String str, String str2) {
        return "urn:mpeg:dash:event:2012".equals(str) && ("1".equals(str2) || GeoFence.BUNDLE_KEY_CUSTOMID.equals(str2) || GeoFence.BUNDLE_KEY_FENCESTATUS.equals(str2));
    }
    ...
    public final class PlayerTrackEmsgHandler implements TrackOutput {
        ...
        private long maxLoadedChunkEndTimeUs = C0858C.TIME_UNSET;
        ...
        public void onChunkLoadCompleted(Chunk chunk) {
            if (this.maxLoadedChunkEndTimeUs == C0858C.TIME_UNSET || chunk.endTimeUs > this.maxLoadedChunkEndTimeUs) {
        ...
        public boolean onChunkLoadError(Chunk chunk) {
            ...
            return PlayerEmsgHandler.this.onChunkLoadError(j != C0858C.TIME_UNSET && j < chunk.startTimeUs);
        }
        ...
        private void parsePlayerEmsgEvent(long j, EventMessage eventMessage) {
            ...
            if (manifestPublishTimeMsInEmsg == C0858C.TIME_UNSET) {
                return;
            }
