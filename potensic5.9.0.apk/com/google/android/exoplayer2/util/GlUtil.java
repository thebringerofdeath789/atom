...
public final class GlUtil {
    ...
    public static void checkGlError() {
        while (true) {
            ...
            Log.m1497e(TAG, valueOf.length() != 0 ? "glError ".concat(valueOf) : new String("glError "));
        }
    }
    ...
    private static void addShader(int i, String str, int i2) {
        ...
        if (iArr[0] != 1) {
            ...
            throwGlError(new StringBuilder(String.valueOf(glGetShaderInfoLog).length() + 10 + String.valueOf(str).length()).append(glGetShaderInfoLog).append(", source: ").append(str).toString());
        }
