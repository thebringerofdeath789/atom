...
public final class MimeTypes {
    ...
    public static String getMediaMimeType(String str) {
        ...
        if (!lowerCase.startsWith("mp4a")) {
            return lowerCase.startsWith("mha1") ? AUDIO_MPEGH_MHA1 : lowerCase.startsWith("mhm1") ? AUDIO_MPEGH_MHM1 : (lowerCase.startsWith("ac-3") || lowerCase.startsWith("dac3")) ? AUDIO_AC3 : (lowerCase.startsWith("ec-3") || lowerCase.startsWith("dec3")) ? AUDIO_E_AC3 : lowerCase.startsWith(Ac3Util.E_AC_3_CODEC_STRING) ? AUDIO_E_AC3_JOC : (lowerCase.startsWith("ac-4") || lowerCase.startsWith("dac4")) ? AUDIO_AC4 : (lowerCase.startsWith("dtsc") || lowerCase.startsWith("dtse")) ? AUDIO_DTS : (lowerCase.startsWith("dtsh") || lowerCase.startsWith("dtsl")) ? AUDIO_DTS_HD : lowerCase.startsWith("opus") ? AUDIO_OPUS : lowerCase.startsWith("vorbis") ? AUDIO_VORBIS : lowerCase.startsWith("flac") ? AUDIO_FLAC : lowerCase.startsWith("stpp") ? APPLICATION_TTML : lowerCase.startsWith("wvtt") ? TEXT_VTT : lowerCase.contains("cea708") ? APPLICATION_CEA708 : (lowerCase.contains("eia608") || lowerCase.contains("cea608")) ? APPLICATION_CEA608 : getCustomMimeTypeForCodec(lowerCase);
        }
