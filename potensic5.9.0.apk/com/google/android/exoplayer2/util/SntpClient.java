...
public final class SntpClient {
    ...
    public static long getElapsedRealtimeOffsetMs() {
        long j;
        synchronized (valueLock) {
            j = isInitialized ? elapsedRealtimeOffsetMs : C0858C.TIME_UNSET;
        }
        return j;
    }
    ...
    private static long readTimestamp(byte[] bArr, int i) {
        ...
        return ((read32 - 2208988800L) * 1000) + ((read322 * 1000) / IjkMediaMeta.AV_CH_WIDE_RIGHT);
    }
    ...
    private static void checkValidServerReply(byte b, byte b2, int i, long j) throws IOException {
        ...
        if (b2 != 4 && b2 != 5) {
            throw new IOException(new StringBuilder(26).append("SNTP: Untrusted mode: ").append((int) b2).toString());
        }
        if (i == 0 || i > 15) {
