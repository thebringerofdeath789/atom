...
public class TrackSelectionParameters implements Parcelable {
    ...
    public static class Builder {
        ...
        @Deprecated
        public Builder() {
            this.preferredAudioLanguages = ImmutableList.m1541of();
            this.preferredAudioRoleFlags = 0;
            this.preferredTextLanguages = ImmutableList.m1541of();
        ...
        private void m1494x58dbf263(Context context) {
            CaptioningManager captioningManager;
            if ((Util.SDK_INT >= 23 || Looper.myLooper() != null) && (captioningManager = (CaptioningManager) context.getSystemService("captioning")) != null && captioningManager.isEnabled()) {
                this.preferredTextRoleFlags = 1088;
                Locale locale = captioningManager.getLocale();
                if (locale != null) {
                    this.preferredTextLanguages = ImmutableList.m1542of(Util.getLocaleLanguageTag(locale));
                }
            }
        }
    }
