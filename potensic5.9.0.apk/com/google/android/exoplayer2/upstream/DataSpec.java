...
public final class DataSpec {
    ...
    public String toString() {
        ...
        long j2 = this.length;
        String str = this.key;
        return new StringBuilder(String.valueOf(httpMethodString).length() + 70 + String.valueOf(valueOf).length() + String.valueOf(str).length()).append("DataSpec[").append(httpMethodString).append(StringUtils.SPACE).append(valueOf).append(", ").append(j).append(", ").append(j2).append(", ").append(str).append(", ").append(this.flags).append("]").toString();
    }
}