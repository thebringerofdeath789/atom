...
final class DvbParser {
    ...
    private static final byte[] defaultMap4To8 = {0, 17, 34, UsbConfig.REV_REMOTER_STATE, UsbCameraHandler.MSG_ID_UPGRADE_HANDSHAKE_STATE, FlightConfig.P1_PRO_RC_2, 102, 119, -120, -103, FlightConfig.P3_SE_V0, -69, -52, -35, -18, -1};
    ...
    private static void parseSubtitlingSegment(ParsableBitArray parsableBitArray, SubtitleService subtitleService) {
        ...
        if (readBits3 * 8 > parsableBitArray.bitsLeft()) {
            Log.m1501w(TAG, "Data field length exceeds limit");
        ...
        switch (readBits) {
            ...
            case 17:
                ...
                if (readBits2 == subtitleService.subtitlePageId && pageComposition2 != null) {
                    ...
                    if (pageComposition2.state == 0 && (regionComposition = subtitleService.regions.get(parseRegionComposition.f1910id)) != null) {
                        parseRegionComposition.mergeFrom(regionComposition);
                    }
                    subtitleService.regions.put(parseRegionComposition.f1910id, parseRegionComposition);
                    break;
                }
                break;
            case 18:
                if (readBits2 == subtitleService.subtitlePageId) {
                    ...
                    subtitleService.cluts.put(parseClutDefinition.f1908id, parseClutDefinition);
                    break;
                    ...
                    subtitleService.ancillaryCluts.put(parseClutDefinition2.f1908id, parseClutDefinition2);
                    break;
                }
                break;
            case 19:
                if (readBits2 == subtitleService.subtitlePageId) {
                    ...
                    subtitleService.objects.put(parseObjectData.f1909id, parseObjectData);
                    break;
                } else if (readBits2 == subtitleService.ancillaryPageId) {
                    ObjectData parseObjectData2 = parseObjectData(parsableBitArray);
                    subtitleService.ancillaryObjects.put(parseObjectData2.f1909id, parseObjectData2);
                    break;
                }
                break;
            case 20:
