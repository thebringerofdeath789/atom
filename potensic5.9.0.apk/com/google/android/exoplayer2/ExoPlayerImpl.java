...
final class ExoPlayerImpl extends BasePlayer implements ExoPlayer {
    ...
    public ExoPlayerImpl(Renderer[] rendererArr, TrackSelector trackSelector, MediaSourceFactory mediaSourceFactory, LoadControl loadControl, BandwidthMeter bandwidthMeter, AnalyticsCollector analyticsCollector, boolean z, SeekParameters seekParameters, LivePlaybackSpeedControl livePlaybackSpeedControl, long j, boolean z2, Clock clock, Looper looper, Player player, Player.Commands commands) {
        ...
        Log.m1499i(TAG, new StringBuilder(String.valueOf(hexString).length() + 30 + String.valueOf(str).length()).append("Init ").append(hexString).append(" [").append(ExoPlayerLibraryInfo.VERSION_SLASHY).append("] [").append(str).append("]").toString());
    ...
    public void prepare() {
        ...
        updatePlaybackInfo(copyWithPlaybackState, 1, 1, false, false, 5, C0858C.TIME_UNSET, -1);
    }
    ...
    public void setMediaSources(List<MediaSource> list, boolean z) {
        setMediaSourcesInternal(list, -1, C0858C.TIME_UNSET, z);
    }
    ...
    public void addMediaSources(int i, List<MediaSource> list) {
        ...
        updatePlaybackInfo(maskTimelineAndPosition, 0, 1, false, false, 5, C0858C.TIME_UNSET, -1);
    }
    ...
    public void setPlayWhenReady(boolean z, int i, int i2) {
        ...
        updatePlaybackInfo(copyWithPlayWhenReady, 0, i2, false, false, 5, C0858C.TIME_UNSET, -1);
    }
    ...
    public void seekTo(int i, long j) {
        ...
        this.pendingOperationAcks++;
        if (isPlayingAd()) {
            Log.m1501w(TAG, "seekTo ignored because an ad is playing");
        ...
        this.internalPlayer.seekTo(timeline, i, C0858C.msToUs(j));
    ...
    public void setPlaybackParameters(PlaybackParameters playbackParameters) {
        ...
        updatePlaybackInfo(copyWithPlaybackParameters, 0, 1, false, false, 5, C0858C.TIME_UNSET, -1);
    }
    ...
    public void release() {
        ...
        Log.m1499i(TAG, new StringBuilder(String.valueOf(hexString).length() + 36 + String.valueOf(str).length() + String.valueOf(registeredModules).length()).append("Release ").append(hexString).append(" [").append(ExoPlayerLibraryInfo.VERSION_SLASHY).append("] [").append(str).append("] [").append(registeredModules).append("]").toString());
    ...
    public long getDuration() {
        if (isPlayingAd()) {
            ...
            return C0858C.usToMs(this.period.getAdDurationUs(mediaPeriodId.adGroupIndex, mediaPeriodId.adIndexInAdGroup));
        }
    ...
    public long getCurrentPosition() {
        return C0858C.usToMs(getCurrentPositionUsInternal(this.playbackInfo));
    }
    ...
    public long getBufferedPosition() {
        if (isPlayingAd()) {
            if (this.playbackInfo.loadingMediaPeriodId.equals(this.playbackInfo.periodId)) {
                return C0858C.usToMs(this.playbackInfo.bufferedPositionUs);
            }
            return getDuration();
        }
    ...
    public long getTotalBufferedDuration() {
        return C0858C.usToMs(this.playbackInfo.totalBufferedDurationUs);
    }
    ...
    public long getContentPosition() {
        if (isPlayingAd()) {
            ...
            if (this.playbackInfo.requestedContentPositionUs == C0858C.TIME_UNSET) {
                return this.playbackInfo.timeline.getWindow(getCurrentWindowIndex(), this.window).getDefaultPositionMs();
            }
            return this.period.getPositionInWindowMs() + C0858C.usToMs(this.playbackInfo.requestedContentPositionUs);
        }
    ...
    public long getContentBufferedPosition() {
        ...
        return C0858C.usToMs(periodPositionUsToWindowPositionUs(this.playbackInfo.timeline, this.playbackInfo.loadingMediaPeriodId, j));
    }
    ...
    private long getCurrentPositionUsInternal(PlaybackInfo playbackInfo) {
        if (playbackInfo.timeline.isEmpty()) {
            return C0858C.msToUs(this.maskingWindowPositionMs);
        }
    ...
    private void lambda$new$1$ExoPlayerImpl(ExoPlayerImplInternal.PlaybackInfoUpdate playbackInfoUpdate) {
        long j;
        boolean z;
    ...
    private Player.PositionInfo getPreviousPositionInfo(int i, PlaybackInfo playbackInfo, int i2) {
        ...
        return new Player.PositionInfo(obj, i3, obj2, i4, C0858C.usToMs(j), C0858C.usToMs(requestedContentPositionUs), playbackInfo.periodId.adGroupIndex, playbackInfo.periodId.adIndexInAdGroup);
    }
    ...
    private Player.PositionInfo getPositionInfo(long j) {
        ...
        return new Player.PositionInfo(obj2, currentWindowIndex, obj, i, usToMs, this.playbackInfo.periodId.isAd() ? C0858C.usToMs(getRequestedContentPositionUs(this.playbackInfo)) : usToMs, this.playbackInfo.periodId.adGroupIndex, this.playbackInfo.periodId.adIndexInAdGroup);
    }
    ...
    private static long getRequestedContentPositionUs(PlaybackInfo playbackInfo) {
        ...
        if (playbackInfo.requestedContentPositionUs == C0858C.TIME_UNSET) {
    ...
    private void setMediaSourcesInternal(List<MediaSource> list, int i, long j, boolean z) {
        ...
        this.internalPlayer.setMediaSources(addMediaSourceHolders, i2, C0858C.msToUs(j2), this.shuffleOrder);
    ...
    private PlaybackInfo maskTimelineAndPosition(PlaybackInfo playbackInfo, Timeline timeline, Pair<Object, Long> pair) {
        ...
        if (timeline.isEmpty()) {
            ...
            long msToUs = C0858C.msToUs(this.maskingWindowPositionMs);
            PlaybackInfo copyWithLoadingMediaPeriodId = copyWithTimeline.copyWithNewPosition(dummyPeriodForEmptyTimeline, msToUs, msToUs, msToUs, 0L, TrackGroupArray.EMPTY, this.emptyTrackSelectorResult, ImmutableList.m1541of()).copyWithLoadingMediaPeriodId(dummyPeriodForEmptyTimeline);
            copyWithLoadingMediaPeriodId.bufferedPositionUs = copyWithLoadingMediaPeriodId.positionUs;
    ...
    private Pair<Object, Long> getPeriodPositionAfterTimelineChanged(Timeline timeline, Timeline timeline2) {
        ...
        Pair<Object, Long> periodPosition = timeline.getPeriodPosition(this.window, this.period, getCurrentWindowIndex(), C0858C.msToUs(contentPosition));
        ...
        return getPeriodPositionOrMaskWindowPosition(timeline2, -1, C0858C.TIME_UNSET);
    }
    ...
    private Pair<Object, Long> getPeriodPositionOrMaskWindowPosition(Timeline timeline, int i, long j) {
        ...
        return timeline.getPeriodPosition(this.window, this.period, i, C0858C.msToUs(j));
    }
