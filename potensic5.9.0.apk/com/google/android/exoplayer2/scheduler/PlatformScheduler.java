...
public final class PlatformScheduler implements Scheduler {
    ...
    private static JobInfo buildJobInfo(int i, ComponentName componentName, Requirements requirements, String str, String str2) {
        ...
        if (!filterRequirements.equals(requirements)) {
            Log.m1501w(TAG, new StringBuilder(46).append("Ignoring unsupported requirements: ").append(filterRequirements.getRequirements() ^ requirements.getRequirements()).toString());
        }
    ...
    public static final class PlatformSchedulerService extends JobService {
        ...
        public boolean onStartJob(JobParameters jobParameters) {
            ...
            Log.m1501w(PlatformScheduler.TAG, new StringBuilder(33).append("Requirements not met: ").append(notMetRequirements).toString());
