...
class DefaultDrmSession implements DrmSession {
    ...
    private void doLicense(boolean z) {
        ...
        if (this.state == 4 || restoreKeys()) {
            ...
            if (this.mode == 0 && licenseDurationRemainingSec <= 60) {
                Log.m1495d(TAG, new StringBuilder(88).append("Offline license has expired or will expire soon. Remaining seconds: ").append(licenseDurationRemainingSec).toString());
                postKeyRequest(bArr, 2, z);
            } else if (licenseDurationRemainingSec <= 0) {
                onError(new KeysExpiredException());
            } else {
                this.state = 4;
                dispatchEvent(new Consumer() { // from class: com.google.android.exoplayer2.drm.-$$Lambda$bKbtDH-u_QKCKrOHwO53RHdbHaY
                    @Override // com.google.android.exoplayer2.util.Consumer
                    public final void accept(Object obj) {
    ...
    private long getLicenseDurationRemainingSec() {
        if (!C0858C.WIDEVINE_UUID.equals(this.uuid)) {
        ...
        if (obj == this.currentKeyRequest && isOpen()) {
            ...
            try {
                ...
                if (this.mode == 3) {
                    ...
                    dispatchEvent(new Consumer() { // from class: com.google.android.exoplayer2.drm.-$$Lambda$BcEzLefIcAN2HB1XXErCxeZoNtI
                        @Override // com.google.android.exoplayer2.util.Consumer
                ...
                this.state = 4;
                dispatchEvent(new Consumer() { // from class: com.google.android.exoplayer2.drm.-$$Lambda$Xjvhz80h6FXicBD5mO_f_e7Cy8M
                    @Override // com.google.android.exoplayer2.util.Consumer
                    public final void accept(Object obj3) {
    ...
    private void onError(final Exception exc) {
        ...
        Log.m1498e(TAG, "DRM session error", exc);
    ...
    private class RequestHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            try {
                ...
                Log.m1502w(DefaultDrmSession.TAG, "Key/provisioning request produced an unexpected exception. Not retrying.", e2);
                th = e2;
            }
