...
public final class Id3Decoder extends SimpleMetadataDecoder {
    ...
    public Metadata decode(byte[] bArr, int i) {
        ...
        if (!validateFrames(parsableByteArray, decodeHeader.majorVersion, i2, false)) {
            if (decodeHeader.majorVersion != 4 || !validateFrames(parsableByteArray, 4, i2, true)) {
                Log.m1501w(TAG, new StringBuilder(56).append("Failed to validate ID3 tag with majorVersion=").append(decodeHeader.majorVersion).toString());
                return null;
            }
            z = true;
        }
    ...
    private static Id3Header decodeHeader(ParsableByteArray parsableByteArray) {
        if (parsableByteArray.bytesLeft() < 10) {
            Log.m1501w(TAG, "Data too short to be an ID3 tag");
            return null;
        }
        ...
        if (readUnsignedInt24 != 4801587) {
            ...
            Log.m1501w(TAG, valueOf.length() != 0 ? "Unexpected first three bytes of ID3 tag header: 0x".concat(valueOf) : new String("Unexpected first three bytes of ID3 tag header: 0x"));
            return null;
        }
        ...
        if (readUnsignedByte == 2) {
            if ((readUnsignedByte2 & 64) != 0) {
                Log.m1501w(TAG, "Skipped ID3 tag with majorVersion=2 and undefined compression scheme");
                return null;
            }
            ...
            if (readUnsignedByte != 4) {
                Log.m1501w(TAG, new StringBuilder(57).append("Skipped ID3 tag with unsupported majorVersion=").append(readUnsignedByte).toString());
                return null;
            }
            if ((readUnsignedByte2 & 64) != 0) {
