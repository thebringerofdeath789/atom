...
public final class TextInformationFrame extends Id3Frame {
    ...
    public boolean equals(Object obj) {
        ...
        return Util.areEqual(this.f1892id, textInformationFrame.f1892id) && Util.areEqual(this.description, textInformationFrame.description) && Util.areEqual(this.value, textInformationFrame.value);
    }

    public int hashCode() {
        int hashCode = (527 + this.f1892id.hashCode()) * 31;
