...
public class MediaCodecVideoRenderer extends MediaCodecRenderer {
    ...
    public MediaCodecVideoRenderer(Context context, MediaCodecAdapter.Factory factory, MediaCodecSelector mediaCodecSelector, long j, boolean z, Handler handler, VideoRendererEventListener videoRendererEventListener, int i) {
        ...
        this.joiningDeadlineMs = C0858C.TIME_UNSET;
        this.currentWidth = -1;
    ...
    protected void onPositionReset(long j, boolean z) throws ExoPlaybackException {
        ...
        this.lastBufferPresentationTimeUs = C0858C.TIME_UNSET;
        this.initialPositionUs = C0858C.TIME_UNSET;
    ...
    public boolean isReady() {
        ...
        if (this.joiningDeadlineMs == C0858C.TIME_UNSET) {
            return false;
        }
    ...
    protected void onCodecError(Exception exc) {
        Log.m1498e(TAG, "Video codec error", exc);
    ...
    protected boolean processOutputBuffer(long j, long j2, MediaCodecAdapter mediaCodecAdapter, ByteBuffer byteBuffer, int i, int i2, int i3, long j3, boolean z, boolean z2, Format format) throws ExoPlaybackException {
        ...
        if (this.initialPositionUs == C0858C.TIME_UNSET) {
        ...
        if (this.joiningDeadlineMs == C0858C.TIME_UNSET && j >= outputStreamOffsetUs && (z3 || (z4 && shouldForceRenderOutputBuffer(j6, j4)))) {
        ...
        if (z4 && j != this.initialPositionUs) {
            ...
            boolean z5 = this.joiningDeadlineMs != C0858C.TIME_UNSET;
    ...
    private void setJoiningDeadlineMs() {
        this.joiningDeadlineMs = this.allowedJoiningTimeMs > 0 ? SystemClock.elapsedRealtime() + this.allowedJoiningTimeMs : C0858C.TIME_UNSET;
    }
    ...
    protected CodecMaxValues getCodecMaxValues(MediaCodecInfo mediaCodecInfo, Format format, Format[] formatArr) {
        ...
        if (z) {
            Log.m1501w(TAG, new StringBuilder(66).append("Resolutions unknown. Codec max resolution: ").append(i).append("x").append(i2).toString());
            ...
            if (codecMaxSize != null) {
                ...
                Log.m1501w(TAG, new StringBuilder(57).append("Codec max resolution adjusted to: ").append(i).append("x").append(i2).toString());
            }
        }
        return new CodecMaxValues(i, i2, maxInputSize);
    }
