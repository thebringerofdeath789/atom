...
public final class VideoFrameReleaseHelper {
    ...
    public VideoFrameReleaseHelper(Context context) {
        ...
        this.vsyncDurationNs = C0858C.TIME_UNSET;
        this.vsyncOffsetNs = C0858C.TIME_UNSET;
    ...
    public long adjustReleaseTime(long j) {
        ...
        if (this.lastAdjustedFrameIndex != -1 && this.frameRateEstimator.isSynced()) {
            ...
            if (!adjustmentAllowed(j, frameDurationNs)) {
                ...
                if (vSyncSampler != null || this.vsyncDurationNs == C0858C.TIME_UNSET) {
                    return j2;
                }
                long j3 = vSyncSampler.sampledVsyncTimeNs;
                return j3 == C0858C.TIME_UNSET ? j2 : closestVsync(j2, j3, this.vsyncDurationNs) - this.vsyncOffsetNs;
            }
        }
        j2 = j;
        this.pendingLastAdjustedFrameIndex = this.frameIndex;
    ...
    */
    ...
    private static void setSurfaceFrameRateV30(Surface surface, float f) {
        try {
            ...
            Log.m1498e(TAG, "Failed to call Surface.setFrameRate", e);
        }
    }
    ...
    public void updateDefaultDisplayRefreshRateParams(Display display) {
        if (display != null) {
            ...
            Log.m1501w(TAG, "Unable to query display refresh rate");
            this.vsyncDurationNs = C0858C.TIME_UNSET;
            this.vsyncOffsetNs = C0858C.TIME_UNSET;
        }
    }
    ...
    private static final class VSyncSampler implements Choreographer.FrameCallback, Handler.Callback {
        ...
        public volatile long sampledVsyncTimeNs = C0858C.TIME_UNSET;
        ...
        private void removeObserverInternal() {
            ...
            if (i == 0) {
                ...
                this.sampledVsyncTimeNs = C0858C.TIME_UNSET;
            }
        }
    }
}