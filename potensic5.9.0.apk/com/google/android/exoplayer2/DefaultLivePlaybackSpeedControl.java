...
public final class DefaultLivePlaybackSpeedControl implements LivePlaybackSpeedControl {
    ...
    public static final class Builder {
        ...
        private long maxLiveOffsetErrorUsForUnitSpeed = C0858C.msToUs(20);
        private long targetLiveOffsetIncrementOnRebufferUs = C0858C.msToUs(500);
        ...
        public Builder setMaxLiveOffsetErrorMsForUnitSpeed(long j) {
            Assertions.checkArgument(j > 0);
            this.maxLiveOffsetErrorUsForUnitSpeed = C0858C.msToUs(j);
            return this;
        }

        public Builder setTargetLiveOffsetIncrementOnRebufferMs(long j) {
            Assertions.checkArgument(j >= 0);
            this.targetLiveOffsetIncrementOnRebufferUs = C0858C.msToUs(j);
            return this;
        }
    ...
    private DefaultLivePlaybackSpeedControl(float f, float f2, long j, float f3, long j2, long j3, float f4) {
        ...
        this.mediaConfigurationTargetLiveOffsetUs = C0858C.TIME_UNSET;
        this.targetLiveOffsetOverrideUs = C0858C.TIME_UNSET;
        this.minTargetLiveOffsetUs = C0858C.TIME_UNSET;
        this.maxTargetLiveOffsetUs = C0858C.TIME_UNSET;
        this.minPlaybackSpeed = f;
        this.maxPlaybackSpeed = f2;
        this.adjustedPlaybackSpeed = 1.0f;
        this.lastPlaybackSpeedUpdateMs = C0858C.TIME_UNSET;
        this.idealTargetLiveOffsetUs = C0858C.TIME_UNSET;
        this.currentTargetLiveOffsetUs = C0858C.TIME_UNSET;
        this.smoothedMinPossibleLiveOffsetUs = C0858C.TIME_UNSET;
        this.smoothedMinPossibleLiveOffsetDeviationUs = C0858C.TIME_UNSET;
    }
    ...
    public void setLiveConfiguration(MediaItem.LiveConfiguration liveConfiguration) {
        float f;
        float f2;
        this.mediaConfigurationTargetLiveOffsetUs = C0858C.msToUs(liveConfiguration.targetOffsetMs);
        this.minTargetLiveOffsetUs = C0858C.msToUs(liveConfiguration.minOffsetMs);
        this.maxTargetLiveOffsetUs = C0858C.msToUs(liveConfiguration.maxOffsetMs);
    ...
    public float getAdjustedPlaybackSpeed(long j, long j2) {
        if (this.mediaConfigurationTargetLiveOffsetUs == C0858C.TIME_UNSET) {
            return 1.0f;
        }
        updateSmoothedMinPossibleLiveOffsetUs(j, j2);
        if (this.lastPlaybackSpeedUpdateMs != C0858C.TIME_UNSET && SystemClock.elapsedRealtime() - this.lastPlaybackSpeedUpdateMs < this.minUpdateIntervalMs) {
    ...
    private void maybeResetTargetLiveOffsetUs() {
        ...
        if (j != C0858C.TIME_UNSET) {
            ...
            if (j3 != C0858C.TIME_UNSET && j < j3) {
                j = j3;
            }
            long j4 = this.maxTargetLiveOffsetUs;
            if (j4 != C0858C.TIME_UNSET && j > j4) {
                j = j4;
            }
        } else {
    ...
    private void adjustTargetLiveOffsetUs(long j) {
        ...
        if (this.currentTargetLiveOffsetUs > j2) {
            float msToUs = C0858C.msToUs(this.minUpdateIntervalMs);
        ...
        long j3 = this.maxTargetLiveOffsetUs;
        if (j3 == C0858C.TIME_UNSET || constrainValue <= j3) {
            return;
        }
        this.currentTargetLiveOffsetUs = j3;
    }
