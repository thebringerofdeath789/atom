...
public final class AmrExtractor implements Extractor {
    ...
    private int peekNextSampleSize(ExtractorInput extractorInput) throws IOException {
        ...
        if ((b & 131) > 0) {
            throw new ParserException(new StringBuilder(42).append("Invalid padding bits for frame header ").append((int) b).toString());
        }
    ...
    private int getFrameSizeInBytes(int i) throws ParserException {
        ...
        throw new ParserException(new StringBuilder(str.length() + 35).append("Illegal AMR ").append(str).append(" frame type ").append(i).toString());
    }
    ...
    private void maybeOutputSeekMap(long j, int i) {
        ...
        if ((this.flags & 1) == 0 || j == -1 || ((i2 = this.firstSampleSize) != -1 && i2 != this.currentSampleSize)) {
            SeekMap.Unseekable unseekable = new SeekMap.Unseekable(C0858C.TIME_UNSET);
