            ...
            if (peek == null || extractorInput.getPosition() < peek.elementEndPosition) {
                ...
                if (elementType != 0) {
                    ...
                    if (elementType == 2) {
                        ...
                        if (j > 8) {
                            throw new ParserException(new StringBuilder(42).append("Invalid integer size: ").append(this.elementContentSize).toString());
                        }
                    ...
                    if (elementType == 3) {
                        ...
                        if (j2 > 2147483647L) {
                            throw new ParserException(new StringBuilder(41).append("String element size: ").append(this.elementContentSize).toString());
                        }
                    ...
                    if (elementType == 5) {
                        ...
                        if (j3 != 4 && j3 != 8) {
                            throw new ParserException(new StringBuilder(40).append("Invalid float size: ").append(this.elementContentSize).toString());
                        }
                        this.processor.floatElement(this.elementId, readFloat(extractorInput, (int) j3));
                        this.elementState = 0;
                        return true;
                    }
                    throw new ParserException(new StringBuilder(32).append("Invalid element type ").append(elementType).toString());
                }
