    ...
    */
    public boolean sniff(com.google.android.exoplayer2.extractor.ExtractorInput r9) throws java.io.IOException {
        ...
        L8:
            ...
            boolean r5 = com.google.android.exoplayer2.extractor.p015ts.AdtsReader.isAdtsSyncWord(r5)
            if (r5 != 0) goto L33
            r9.resetPeekPosition()
            int r3 = r3 + 1
            int r2 = r3 - r0
        ...
        L59:
            ...
            goto L8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.extractor.p015ts.AdtsExtractor.sniff(com.google.android.exoplayer2.extractor.ExtractorInput):boolean");
    }
    ...
    private void maybeOutputSeekMap(long j, boolean z, boolean z2) {
        ...
        if (z3 && this.reader.getSampleDurationUs() == C0858C.TIME_UNSET && !z2) {
            return;
        }
        if (z3 && this.reader.getSampleDurationUs() != C0858C.TIME_UNSET) {
            this.extractorOutput.seekMap(getConstantBitrateSeekMap(j));
        } else {
            this.extractorOutput.seekMap(new SeekMap.Unseekable(C0858C.TIME_UNSET));
        }
