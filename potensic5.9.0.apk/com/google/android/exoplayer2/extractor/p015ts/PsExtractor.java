...
public final class PsExtractor implements Extractor {
    ...
    public void seek(long j, long j2) {
        if ((this.timestampAdjuster.getTimestampOffsetUs() == C0858C.TIME_UNSET) || (this.timestampAdjuster.getFirstSampleTimestampUs() != 0 && this.timestampAdjuster.getFirstSampleTimestampUs() != j2)) {
    ...
    private void maybeOutputSeekMap(long j) {
        ...
        if (this.durationReader.getDurationUs() != C0858C.TIME_UNSET) {
