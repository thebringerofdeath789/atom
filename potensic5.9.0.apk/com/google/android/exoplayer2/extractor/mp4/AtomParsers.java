...
final class AtomParsers {
    ...
    public static Metadata parseMdtaFromMeta(Atom.ContainerAtom containerAtom) {
        ...
        while (parsableByteArray2.bytesLeft() > 8) {
            ...
            if (readInt4 >= 0 && readInt4 < readInt) {
                ...
                Log.m1501w(TAG, new StringBuilder(52).append("Skipped metadata with unknown key index: ").append(readInt4).toString());
            }
    ...
    private static Track parseTrak(Atom.ContainerAtom containerAtom, Atom.LeafAtom leafAtom, long j, DrmInitData drmInitData, boolean z, boolean z2) throws ParserException {
        ...
        StsdData parseStsd = parseStsd(((Atom.LeafAtom) Assertions.checkNotNull(containerAtom3.getLeafAtomOfType(Atom.TYPE_stsd))).data, parseTkhd.f1883id, parseTkhd.rotationDegrees, (String) parseMdhd.second, drmInitData, z2);
        ...
        return new Track(parseTkhd.f1883id, trackTypeForHdlr, ((Long) parseMdhd.first).longValue(), parseMvhd, j4, parseStsd.format, parseStsd.requiredSampleTransformation, parseStsd.trackEncryptionBoxes, parseStsd.nalUnitLengthFieldLength, jArr, jArr2);
    }
    ...
    */
    ...
    private static void parseTextSampleEntry(ParsableByteArray parsableByteArray, int i, int i2, int i3, int i4, String str, StsdData stsdData) {
        ...
        if (i != 1414810956) {
            if (i == 1954034535) {
                ...
                immutableList = ImmutableList.m1542of(bArr);
    ...
    private static void parseVideoSampleEntry(ParsableByteArray parsableByteArray, int i, int i2, int i3, int i4, int i5, DrmInitData drmInitData, StsdData stsdData, int i6) throws ParserException {
        ...
        String str5 = i9 == 1831958048 ? MimeTypes.VIDEO_MPEG : i9 == 1211250227 ? MimeTypes.VIDEO_H263 : null;
        byte[] bArr = null;
        while (true) {
            if (position - i7 >= i8) {
                ...
                if (readInt2 == 1685480259 || readInt2 == 1685485123) {
                    ...
                    if (readInt2 == 1987076931) {
                        ...
                        if (readInt2 == 1702061171) {
                            ...
                            list3 = bArr2 != null ? ImmutableList.m1542of(bArr2) : list;
                            str5 = str6;
        ...
        stsdData.format = new Format.Builder().setId(i4).setSampleMimeType(str5).setCodecs(str4).setWidth(readUnsignedShort).setHeight(readUnsignedShort2).setPixelWidthHeightRatio(f).setRotationDegrees(i5).setProjectionData(bArr).setStereoMode(i10).setInitializationData(list).setDrmInitData(drmInitData2).build();
    }
    ...
    */
    ...
    static Pair<Integer, TrackEncryptionBox> parseCommonEncryptionSinfFromParent(ParsableByteArray parsableByteArray, int i, int i2) {
        ...
        if (!C0858C.CENC_TYPE_cenc.equals(str) && !C0858C.CENC_TYPE_cbc1.equals(str) && !C0858C.CENC_TYPE_cens.equals(str) && !C0858C.CENC_TYPE_cbcs.equals(str)) {
            return null;
        }
        Assertions.checkStateNotNull(num, "frma atom is mandatory");
        Assertions.checkState(i5 != -1, "schi atom is mandatory");
        return Pair.create(num, (TrackEncryptionBox) Assertions.checkStateNotNull(parseSchiFromParent(parsableByteArray, i5, i4, str), "tenc atom is mandatory"));
    }
        ...
        public StszSampleSizeBox(Atom.LeafAtom leafAtom, Format format) {
            ...
            if (MimeTypes.AUDIO_RAW.equals(format.sampleMimeType)) {
                ...
                if (readUnsignedIntToInt == 0 || readUnsignedIntToInt % pcmFrameSize != 0) {
                    Log.m1501w(AtomParsers.TAG, new StringBuilder(88).append("Audio sample size mismatch. stsd sample size: ").append(pcmFrameSize).append(", stsz sample size: ").append(readUnsignedIntToInt).toString());
