...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        List<TrackSampleTable> parseTraks = AtomParsers.parseTraks(containerAtom, gaplessInfoHolder, C0858C.TIME_UNSET, null, (this.flags & 1) != 0, z, new Function() { // from class: com.google.android.exoplayer2.extractor.mp4.-$$Lambda$Mp4Extractor$IP-_bKEryH3151zsYMHu9R1OlAQ
        ...
        while (i2 < size) {
            ...
            if (trackSampleTable.sampleCount == 0) {
                ...
                int i4 = i3;
                arrayList = arrayList2;
                long j2 = track.durationUs != C0858C.TIME_UNSET ? track.durationUs : trackSampleTable.durationUs;
    ...
    private void processUnparsedAtom(long j) {
        if (this.atomType == 1836086884) {
            int i = this.atomHeaderBytesRead;
            this.motionPhotoMetadata = new MotionPhotoMetadata(0L, j, C0858C.TIME_UNSET, j + i, this.atomSize - i);
        }
    }
