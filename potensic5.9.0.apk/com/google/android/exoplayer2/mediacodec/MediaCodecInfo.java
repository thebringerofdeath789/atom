...
public final class MediaCodecInfo {
    ...
    private void logNoSupport(String str) {
        ...
        Log.m1495d(TAG, new StringBuilder(String.valueOf(str).length() + 20 + String.valueOf(str2).length() + String.valueOf(str3).length() + String.valueOf(str4).length()).append("NoSupport [").append(str).append("] [").append(str2).append(", ").append(str3).append("] [").append(str4).append("]").toString());
    }
    ...
    private void logAssumedSupport(String str) {
        ...
        String str3 = this.mimeType;
        String str4 = Util.DEVICE_DEBUG_INFO;
        Log.m1495d(TAG, new StringBuilder(String.valueOf(str).length() + 25 + String.valueOf(str2).length() + String.valueOf(str3).length() + String.valueOf(str4).length()).append("AssumedSupport [").append(str).append("] [").append(str2).append(", ").append(str3).append("] [").append(str4).append("]").toString());
    }
    ...
    private static int adjustMaxInputChannelCount(String str, String str2, int i) {
        ...
        Log.m1501w(TAG, new StringBuilder(String.valueOf(str).length() + 59).append("AssumedMaxChannelAdjustment: ").append(str).append(", [").append(i).append(" to ").append(i2).append("]").toString());
        return i2;
    }
