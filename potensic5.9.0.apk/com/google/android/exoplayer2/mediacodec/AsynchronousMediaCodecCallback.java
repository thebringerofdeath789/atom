...
final class AsynchronousMediaCodecCallback extends MediaCodec.Callback {
    ...
    public void flushAsync(final Runnable runnable) {
        synchronized (this.lock) {
            ...
            ((Handler) Util.castNonNull(this.handler)).post(new Runnable() { // from class: com.google.android.exoplayer2.mediacodec.-$$Lambda$AsynchronousMediaCodecCallback$kiZ5I-MTkQ3pbbS-EOnZPGh8_-U
    ...
    private void lambda$flushAsync$0$AsynchronousMediaCodecCallback(Runnable runnable) {
        synchronized (this.lock) {
