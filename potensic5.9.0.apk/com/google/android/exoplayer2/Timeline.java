...
public abstract class Timeline implements Bundleable {
    ...
    public static final class Window implements Bundleable {
        ...
        public long getDefaultPositionMs() {
            return C0858C.usToMs(this.defaultPositionUs);
        }
        ...
        public long getDurationMs() {
            return C0858C.usToMs(this.durationUs);
        }
        ...
        public long getPositionInFirstPeriodMs() {
            return C0858C.usToMs(this.positionInFirstPeriodUs);
        }
        ...
        public static Window fromBundle(Bundle bundle) {
            ...
            long j = bundle.getLong(keyForField(2), C0858C.TIME_UNSET);
            long j2 = bundle.getLong(keyForField(3), C0858C.TIME_UNSET);
            long j3 = bundle.getLong(keyForField(4), C0858C.TIME_UNSET);
            ...
            long j5 = bundle.getLong(keyForField(10), C0858C.TIME_UNSET);
    ...
    public static final class Period implements Bundleable {
        ...
        public long getPositionInWindowMs() {
            return C0858C.usToMs(this.positionInWindowUs);
        }
        ...
        public long getAdDurationUs(int i, int i2) {
            ...
            return adGroup.count != -1 ? adGroup.durationsUs[i2] : C0858C.TIME_UNSET;
        }
        ...
        public boolean equals(Object obj) {
            ...
            return Util.areEqual(this.f1881id, period.f1881id) && Util.areEqual(this.uid, period.uid) && this.windowIndex == period.windowIndex && this.durationUs == period.durationUs && this.positionInWindowUs == period.positionInWindowUs && this.isPlaceholder == period.isPlaceholder && Util.areEqual(this.adPlaybackState, period.adPlaybackState);
        }

        public int hashCode() {
            Object obj = this.f1881id;
        ...
        public static Period fromBundle(Bundle bundle) {
            ...
            long j = bundle.getLong(keyForField(1), C0858C.TIME_UNSET);
    ...
    private static final class RemotableTimeline extends Timeline {
        ...
        public Period getPeriod(int i, Period period, boolean z) {
            ...
            period.set(period2.f1881id, period2.uid, period2.windowIndex, period2.durationUs, period2.positionInWindowUs, period2.adPlaybackState, period2.isPlaceholder);
            return period;
        }
