...
final class StreamVolumeManager {
    ...
    public StreamVolumeManager(Context context, Handler handler, Listener listener) {
        ...
        try {
            ...
            Log.m1502w(TAG, "Error registering stream volume receiver", e);
        }
    }
    ...
    public void release() {
        ...
        if (volumeChangeReceiver != null) {
            try {
                ...
                Log.m1502w(TAG, "Error unregistering stream volume receiver", e);
            }
            this.receiver = null;
        }
    }
    ...
    private static int getVolumeFromManager(AudioManager audioManager, int i) {
        try {
            ...
            Log.m1502w(TAG, new StringBuilder(60).append("Could not retrieve stream volume for stream type ").append(i).toString(), e);
