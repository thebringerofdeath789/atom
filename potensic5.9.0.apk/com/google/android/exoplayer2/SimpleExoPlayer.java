...
public class SimpleExoPlayer extends BasePlayer implements ExoPlayer, ExoPlayer.AudioComponent, ExoPlayer.VideoComponent, ExoPlayer.TextComponent, ExoPlayer.MetadataComponent, ExoPlayer.DeviceComponent {
    ...
    protected SimpleExoPlayer(Builder builder) {
        ...
        try {
            ...
            if (Util.SDK_INT < 21) {
                ...
                this.audioSessionId = C0858C.generateAudioSessionIdV21(applicationContext);
            }
            this.currentCues = Collections.emptyList();
            this.throwsWhenUsingWrongThread = true;
            try {
                exoPlayerImpl = new ExoPlayerImpl(createRenderers, builder.trackSelector, builder.mediaSourceFactory, builder.loadControl, builder.bandwidthMeter, analyticsCollector, builder.useLazyPreparation, builder.seekParameters, builder.livePlaybackSpeedControl, builder.releaseTimeoutMs, builder.pauseAtEndOfMediaItems, builder.clock, builder.looper, this, new Player.Commands.Builder().addAll(15, 16, 17, 18, 19, 20, 21, 22).build());
    ...
    public void setVideoTextureView(TextureView textureView) {
        ...
        if (textureView.getSurfaceTextureListener() != null) {
            Log.m1501w(TAG, "Replacing existing SurfaceTextureListener.");
        }
    ...
    public void setAudioSessionId(int i) {
        ...
        if (i == 0) {
            if (Util.SDK_INT < 21) {
                ...
                i = C0858C.generateAudioSessionIdV21(this.applicationContext);
            }
    ...
    private void removeSurfaceCallbacks() {
        ...
        if (textureView != null) {
            if (textureView.getSurfaceTextureListener() != this.componentListener) {
                Log.m1501w(TAG, "SurfaceTextureListener already unset or replaced.");
            } else {
    ...
    private void verifyApplicationThread() {
        ...
        if (Thread.currentThread() != getApplicationLooper().getThread()) {
            ...
            Log.m1502w(TAG, formatInvariant, this.hasNotifiedFullWrongThreadWarning ? null : new IllegalStateException());
