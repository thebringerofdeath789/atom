...
public final class PlaybackStatsListener implements AnalyticsListener, PlaybackSessionManager.Listener {
    ...
    public void onSessionFinished(AnalyticsListener.EventTime eventTime, String str, boolean z) {
        ...
        playbackStatsTracker.onFinished(eventTime, z, str.equals(this.discontinuityFromSession) ? this.discontinuityFromPositionMs : C0858C.TIME_UNSET);
    ...
    public void onEvents(Player player, AnalyticsListener.Events events) {
        ...
        for (String str : this.playbackStatsTrackers.keySet()) {
            ...
            playbackStatsTracker.onEvents(player, (AnalyticsListener.EventTime) findBestEventTime.first, ((Boolean) findBestEventTime.second).booleanValue(), str.equals(this.discontinuityFromSession) ? this.discontinuityFromPositionMs : C0858C.TIME_UNSET, hasEvent, hasEvent2 ? this.droppedFrames : 0, hasEvent3, hasEvent4, hasEvent5 ? player.getPlayerError() : null, z ? this.nonFatalException : null, hasEvent6 ? this.bandwidthTimeMs : 0L, hasEvent6 ? this.bandwidthBytes : 0L, hasEvent7 ? this.videoFormat : null, hasEvent7 ? this.audioFormat : null, hasEvent(events, str, AnalyticsListener.EVENT_VIDEO_SIZE_CHANGED) ? this.videoSize : null);
        }
    ...
    private static final class PlaybackStatsTracker {
        ...
        public PlaybackStatsTracker(boolean z, AnalyticsListener.EventTime eventTime) {
            ...
            this.firstReportedTimeMs = C0858C.TIME_UNSET;
            this.maxRebufferTimeMs = C0858C.TIME_UNSET;
        ...
        public void onEvents(Player player, AnalyticsListener.EventTime eventTime, boolean z, long j, boolean z2, int i, boolean z3, boolean z4, ExoPlaybackException exoPlaybackException, Exception exc, long j2, long j3, Format format, Format format2, VideoSize videoSize) {
            ...
            if (this.currentPlaybackState != resolveNewPlaybackState || this.currentPlaybackSpeed != f) {
                maybeUpdateMediaTimeHistory(eventTime.realtimeMs, z ? eventTime.eventPlaybackPositionMs : C0858C.TIME_UNSET);
                maybeRecordVideoFormatTime(eventTime.realtimeMs);
                maybeRecordAudioFormatTime(eventTime.realtimeMs);
            }
        ...
        public PlaybackStats build(boolean z) {
            ...
            long j = i2 != 0 ? C0858C.TIME_UNSET : jArr[2];
            int i3 = jArr[1] > 0 ? 1 : 0;
        ...
        private void updatePlaybackState(int i, AnalyticsListener.EventTime eventTime) {
            ...
            jArr[i2] = jArr[i2] + j;
            if (this.firstReportedTimeMs == C0858C.TIME_UNSET) {
        ...
        private void maybeUpdateMediaTimeHistory(long j, long j2) {
            if (this.keepHistory) {
                ...
                this.mediaTimeHistory.add(j2 == C0858C.TIME_UNSET ? guessMediaTimeBasedOnElapsedRealtime(j) : new long[]{j, j2});
            }
        }
