...
public final class DefaultAudioSink implements AudioSink {
    ...
    public int getFormatSupport(Format format) {
        ...
        Log.m1501w(TAG, new StringBuilder(33).append("Invalid PCM encoding: ").append(format.pcmEncoding).toString());
        return 0;
    }
    ...
    public boolean handleBuffer(ByteBuffer byteBuffer, long j, int i) throws AudioSink.InitializationException, AudioSink.WriteException {
        ...
        Log.m1501w(TAG, "Resetting stalled audio track");
        flush();
        return true;
    }
    ...
    private void writeBuffer(ByteBuffer byteBuffer, long j) throws AudioSink.WriteException {
        ...
        if (byteBuffer.hasRemaining()) {
            ...
            if (Util.SDK_INT < 21) {
                ...
                Assertions.checkState(j != C0858C.TIME_UNSET);
    ...
    */
    ...
    private void setAudioTrackPlaybackParametersV23(PlaybackParameters playbackParameters) {
        if (isAudioTrackInitialized()) {
            try {
                ...
                Log.m1502w(TAG, "Failed to set playback params", e);
            }
    ...
    private void setAudioProcessorPlaybackParametersAndSkipSilence(PlaybackParameters playbackParameters, boolean z) {
        ...
        MediaPositionParameters mediaPositionParameters2 = new MediaPositionParameters(playbackParameters, z, C0858C.TIME_UNSET, C0858C.TIME_UNSET);
        if (isAudioTrackInitialized()) {
    ...
    private static Pair<Integer, Integer> getEncodingAndChannelConfigForPassthrough(Format format, AudioCapabilities audioCapabilities) {
        ...
        if (encoding == 18) {
            if (Util.SDK_INT >= 29 && (i = getMaxSupportedChannelCountForPassthroughV29(18, format.sampleRate)) == 0) {
                Log.m1501w(TAG, "E-AC3 JOC encoding supported but no channel count supported");
                return null;
            }
        } else {
    ...
    private final class PositionTrackerListener implements AudioTrackPositionTracker.Listener {
        ...
        public void onPositionFramesMismatch(long j, long j2, long j3, long j4) {
            ...
            Log.m1501w(DefaultAudioSink.TAG, sb);
        }
        ...
        public void onInvalidLatency(long j) {
            Log.m1501w(DefaultAudioSink.TAG, new StringBuilder(61).append("Ignoring impossibly large audio latency: ").append(j).toString());
        }
