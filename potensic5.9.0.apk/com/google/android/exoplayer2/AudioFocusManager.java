...
final class AudioFocusManager {
    ...
    private static int convertAudioAttributesToFocusGain(AudioAttributes audioAttributes) {
        ...
        switch (audioAttributes.usage) {
            case 0:
                Log.m1501w(TAG, "Specify a proper usage in the audio attributes for audio focus handling. Using AUDIOFOCUS_GAIN by default.");
                return 1;
            case 1:
            case 14:
                return 1;
            ...
            case 15:
            default:
                Log.m1501w(TAG, new StringBuilder(37).append("Unidentified audio usage: ").append(audioAttributes.usage).toString());
                return 0;
            case 16:
    ...
    public void handlePlatformAudioFocusChange(int i) {
        ...
        if (i == -1) {
            ...
            Log.m1501w(TAG, new StringBuilder(38).append("Unknown focus change type: ").append(i).toString());
        }
    }
