...
public final class DownloadRequest implements Parcelable {
    ...
    public static class Builder {
        ...
        public DownloadRequest build() {
            String str = this.f1897id;
            Uri uri = this.uri;
            String str2 = this.mimeType;
            List list = this.streamKeys;
            if (list == null) {
                list = ImmutableList.m1541of();
            }
    ...
    DownloadRequest(Parcel parcel) {
        this.f1896id = (String) Util.castNonNull(parcel.readString());
    ...
    public DownloadRequest copyWithKeySetId(byte[] bArr) {
        return new DownloadRequest(this.f1896id, this.uri, this.mimeType, this.streamKeys, bArr, this.customCacheKey, this.data);
    }

    public DownloadRequest copyWithMergedRequest(DownloadRequest downloadRequest) {
        List emptyList;
        Assertions.checkArgument(this.f1896id.equals(downloadRequest.f1896id));
        ...
        return new DownloadRequest(this.f1896id, downloadRequest.uri, downloadRequest.mimeType, emptyList, downloadRequest.keySetId, downloadRequest.customCacheKey, downloadRequest.data);
    }

    public MediaItem toMediaItem() {
        return new MediaItem.Builder().setMediaId(this.f1896id).setUri(this.uri).setCustomCacheKey(this.customCacheKey).setMimeType(this.mimeType).setStreamKeys(this.streamKeys).setDrmKeySetId(this.keySetId).build();
    }

    public String toString() {
        String str = this.mimeType;
        String str2 = this.f1896id;
    ...
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f1896id);
