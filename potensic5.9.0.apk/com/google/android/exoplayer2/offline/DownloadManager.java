...
public final class DownloadManager {
    ...
    private static final class InternalHandler extends Handler {
        ...
        private void initialize(int i) {
            ...
            try {
                try {
                    ...
                    Log.m1498e(DownloadManager.TAG, "Failed to load index.", e);
        ...
        private void setStopReason(String str, int i) {
            if (str == null) {
                ...
                try {
                    ...
                    Log.m1498e(DownloadManager.TAG, "Failed to set manual stop reason", e);
                }
            } else {
                ...
                if (download != null) {
                    ...
                    try {
                        ...
                        Log.m1498e(DownloadManager.TAG, valueOf.length() != 0 ? "Failed to set manual stop reason: ".concat(valueOf) : new String("Failed to set manual stop reason: "), e2);
                    }
                }
            }
            syncTasks();
        ...
        private void addDownload(DownloadRequest downloadRequest, int i) {
            Download download = getDownload(downloadRequest.f1896id, true);
        ...
        private void removeDownload(String str) {
            ...
            if (download == null) {
                String valueOf = String.valueOf(str);
                Log.m1497e(DownloadManager.TAG, valueOf.length() != 0 ? "Failed to remove nonexistent download: ".concat(valueOf) : new String("Failed to remove nonexistent download: "));
            } else {
        ...
        private void removeAllDownloads() {
            ...
            try {
                ...
                Log.m1497e(DownloadManager.TAG, "Failed to load downloads.");
            }
            for (int i = 0; i < this.downloads.size(); i++) {
            ...
            Collections.sort(this.downloads, C0963xdeefc637.INSTANCE);
            try {
                this.downloadIndex.setStatesToRemoving();
            } catch (IOException e) {
                Log.m1498e(DownloadManager.TAG, "Failed to update index.", e);
            }
        ...
        private void syncTasks() {
            ...
            for (int i2 = 0; i2 < this.downloads.size(); i2++) {
                ...
                Task task = this.activeTasks.get(download.request.f1896id);
                int i3 = download.state;
                if (i3 == 0) {
        ...
        private Task syncQueuedDownload(Task task, Download download) {
            if (task == null) {
                ...
                this.activeTasks.put(putDownloadWithState.request.f1896id, task2);
        ...
        private void syncRemovingDownload(Task task, Download download) {
            if (task == null) {
                ...
                this.activeTasks.put(download.request.f1896id, task2);
                task2.start();
                return;
            }
            if (task.isRemove) {
        ...
        private void onContentLengthChanged(Task task, long j) {
            Download download = (Download) Assertions.checkNotNull(getDownload(task.request.f1896id, false));
        ...
        private void onTaskStopped(Task task) {
            String str = task.request.f1896id;
            ...
            if (exc != null) {
                ...
                Log.m1498e(DownloadManager.TAG, new StringBuilder(String.valueOf(valueOf).length() + 20).append("Task failed: ").append(valueOf).append(", ").append(z).toString(), exc);
            }
        ...
        private void onDownloadTaskStopped(Download download, Exception exc) {
            ...
            this.downloads.remove(getDownloadIndex(download2.request.f1896id));
            try {
        ...
        private void onRemoveTaskStopped(Download download) {
            if (download.state == 7) {
                ...
                this.downloads.remove(getDownloadIndex(download.request.f1896id));
                try {
                    this.downloadIndex.removeDownload(download.request.f1896id);
                } catch (IOException unused) {
                    Log.m1497e(DownloadManager.TAG, "Failed to remove from database");
                }
        ...
        private Download putDownload(Download download) {
            ...
            int downloadIndex = getDownloadIndex(download.request.f1896id);
            if (downloadIndex == -1) {
        ...
        private Download getDownload(String str, boolean z) {
            ...
            try {
                ...
                String valueOf = String.valueOf(str);
                Log.m1498e(DownloadManager.TAG, valueOf.length() != 0 ? "Failed to load download: ".concat(valueOf) : new String("Failed to load download: "), e);
                return null;
            }
        }
        ...
        private int getDownloadIndex(String str) {
            for (int i = 0; i < this.downloads.size(); i++) {
                if (this.downloads.get(i).request.f1896id.equals(str)) {
                    return i;
                }
            }
            return -1;
