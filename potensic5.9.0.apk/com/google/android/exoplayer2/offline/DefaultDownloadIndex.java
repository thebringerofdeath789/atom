...
public final class DefaultDownloadIndex implements WritableDownloadIndex {
    ...
    public void setStopReason(String str, int i) throws DatabaseIOException {
        ...
        try {
            ...
            writableDatabase.update(str2, contentValues, new StringBuilder(String.valueOf(str3).length() + 11).append(str3).append(" AND ").append(WHERE_ID_EQUALS).toString(), new String[]{str});
        } catch (SQLException e) {
            throw new DatabaseIOException(e);
        }
    }
            ...
            try {
                ...
                if (version != 3) {
                    ...
                    try {
                        ...
                        writableDatabase.execSQL(new StringBuilder(String.valueOf(str).length() + 415).append("CREATE TABLE ").append(str).append(StringUtils.SPACE).append(TABLE_SCHEMA).toString());
    ...
    private void putDownloadInternal(Download download, SQLiteDatabase sQLiteDatabase) {
        ...
        ContentValues contentValues = new ContentValues();
        contentValues.put("id", download.request.f1896id);
    ...
    private static String getStateQuery(int... iArr) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append(COLUMN_STATE).append(" IN (");
