        ...
        switch (str) {
            case "com.google.android.exoplayer.downloadService.action.ADD_DOWNLOAD":
                ...
                if (downloadRequest == null) {
                    Log.m1497e(TAG, "Ignored ADD_DOWNLOAD: Missing download_request extra");
                    break;
                } else {
            ...
            case "com.google.android.exoplayer.downloadService.action.SET_REQUIREMENTS":
                ...
                if (requirements == null) {
                    Log.m1497e(TAG, "Ignored SET_REQUIREMENTS: Missing requirements extra");
                    break;
                } else {
                    ...
                    if (scheduler != null) {
                        ...
                        if (!supportedRequirements.equals(requirements)) {
                            Log.m1501w(TAG, new StringBuilder(65).append("Ignoring requirements not supported by the Scheduler: ").append(requirements.getRequirements() ^ supportedRequirements.getRequirements()).toString());
            ...
            case "com.google.android.exoplayer.downloadService.action.SET_STOP_REASON":
                if (!((Intent) Assertions.checkNotNull(intent)).hasExtra(KEY_STOP_REASON)) {
                    Log.m1497e(TAG, "Ignored SET_STOP_REASON: Missing stop_reason extra");
                    break;
                } else {
            ...
            case "com.google.android.exoplayer.downloadService.action.REMOVE_DOWNLOAD":
                if (str2 == null) {
                    Log.m1497e(TAG, "Ignored REMOVE_DOWNLOAD: Missing content_id extra");
                    break;
                } else {
            ...
            default:
                ...
                Log.m1497e(TAG, valueOf.length() != 0 ? "Ignored unrecognized action: ".concat(valueOf) : new String("Ignored unrecognized action: "));
                break;
        }
    ...
    private static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public void onDownloadChanged(DownloadManager downloadManager, Download download, Exception exc) {
            ...
            if (serviceMayNeedRestart() && DownloadService.needsStartedService(download.state)) {
                Log.m1501w(DownloadService.TAG, "DownloadService wasn't running. Restarting.");
                restartService();
            }
        }
        ...
        private void restartService() {
            if (this.foregroundAllowed) {
                ...
                try {
                    ...
                    Log.m1501w(DownloadService.TAG, "Failed to restart DownloadService (process is idle).");
                }
            }
        }
        ...
        private void updateScheduler() {
            ...
            if (this.downloadManager.isWaitingForRequirements()) {
                ...
                Log.m1497e(DownloadService.TAG, "Scheduling downloads failed.");
                return;
            }
            this.scheduler.cancel();
        }
