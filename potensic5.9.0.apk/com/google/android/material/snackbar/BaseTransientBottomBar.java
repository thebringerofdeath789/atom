...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    static {
        ...
        SNACKBAR_STYLE_ATTR = new int[]{C1063R.attr.snackbarStyle};
    ...
    private Drawable createThemedBackground() {
        int layer = MaterialColors.layer(this.view, C1063R.attr.colorSurface, C1063R.attr.colorOnSurface, this.view.getBackgroundOverlayColorAlpha());
        float dimension = this.view.getResources().getDimension(C1063R.dimen.mtrl_snackbar_background_corner_radius);
    ...
    protected int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C1063R.layout.mtrl_layout_snackbar : C1063R.layout.design_layout_snackbar;
    }
    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        protected SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C1063R.styleable.SnackbarLayout);
            if (obtainStyledAttributes.hasValue(C1063R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, obtainStyledAttributes.getDimensionPixelSize(C1063R.styleable.SnackbarLayout_elevation, 0));
            }
            this.animationMode = obtainStyledAttributes.getInt(C1063R.styleable.SnackbarLayout_animationMode, 0);
            this.backgroundOverlayColorAlpha = obtainStyledAttributes.getFloat(C1063R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            this.actionTextColorAlpha = obtainStyledAttributes.getFloat(C1063R.styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
            obtainStyledAttributes.recycle();
