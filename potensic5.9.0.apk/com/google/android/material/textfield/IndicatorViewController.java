...
final class IndicatorViewController {
    ...
    public IndicatorViewController(TextInputLayout textInputLayout) {
        ...
        this.captionTranslationYPx = r0.getResources().getDimensionPixelSize(C1063R.dimen.design_textinput_caption_translate_y);
    }
    ...
    void setErrorEnabled(boolean z) {
        ...
        if (z) {
            ...
            appCompatTextView.setId(C1063R.id.textinput_error);
    ...
    void setHelperTextEnabled(boolean z) {
        ...
        if (z) {
            ...
            appCompatTextView.setId(C1063R.id.textinput_helper_text);
            Typeface typeface = this.typeface;
            if (typeface != null) {
