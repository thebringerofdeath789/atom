    ...
    private final class PowerStatusReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if ("android.intent.action.BATTERY_CHANGED".equals(intent.getAction())) {
                ...
                InactivityTimer.this.handler.post(new Runnable() { // from class: com.google.zxing.client.android.-$$Lambda$InactivityTimer$PowerStatusReceiver$CE5USeJ6n0dqNSMxEScPrbo4Gyw
                    @Override // java.lang.Runnable
                    public final void run() {
                        InactivityTimer.PowerStatusReceiver.this.lambda$onReceive$0$InactivityTimer$PowerStatusReceiver(z);
                    }
                });
            }
        }

        public /* synthetic */ void lambda$onReceive$0$InactivityTimer$PowerStatusReceiver(boolean z) {
