...
final class PDF417HighLevelEncoder {
    ...
    private static final byte[] TEXT_MIXED_RAW = {48, 49, 50, UsbConfig.REV_REMOTER_STATE, UsbConfig.REV_REMOTER_MUTE_CODE, 53, 54, 55, PaletteRecord.STANDARD_PALETTE_SIZE, 57, 38, 13, 9, 44, 58, 35, UsbCameraHandler.MSG_ID_SET_TARGET, UsbCameraHandler.MSG_ID_EXECUTE_SHORT_VIDEO, 36, UsbCameraHandler.MSG_ID_VISION_ERROR, 43, 37, 42, 61, 94, 0, 32, 0, 0, 0};
    private static final byte[] TEXT_PUNCTUATION_RAW = {59, DeletedRef3DPtg.sid, 62, 64, 91, 92, 93, 95, 96, UsbConfig.SEND_FUNCTION_CODE_REMOTE_CONTROL, 33, 13, 9, 44, 58, 10, UsbCameraHandler.MSG_ID_SET_TARGET, UsbCameraHandler.MSG_ID_EXECUTE_SHORT_VIDEO, 36, UsbCameraHandler.MSG_ID_VISION_ERROR, 34, 124, 42, UsbCameraHandler.MSG_ID_GET_REMAIN_CAPTURE_SIZE, MemFuncPtg.sid, 63, 123, SendOthersData.FUNC_ID_REMOTER_OUTPUT, UsbCameraHandler.MSG_ID_GET_OSD_STATE, 0};
    ...
    static String encodeHighLevel(String str, Compaction compaction, Charset charset) throws WriterException {
        ...
        int i = C17891.$SwitchMap$com$google$zxing$pdf417$encoder$Compaction[compaction.ordinal()];
        if (i == 1) {
