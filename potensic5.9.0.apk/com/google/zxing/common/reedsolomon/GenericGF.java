...
public final class GenericGF {
    ...
    static {
        ...
        GenericGF genericGF2 = new GenericGF(UserConstants.REQUEST_CODE_DOWNLOAD_FW_FROM_SERVER, 256, 1);
    ...
    public String toString() {
        return "GF(0x" + Integer.toHexString(this.primitive) + ',' + this.size + PropertyUtils.MAPPED_DELIM2;
    }
}