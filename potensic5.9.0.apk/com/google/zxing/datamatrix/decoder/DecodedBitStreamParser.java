...
final class DecodedBitStreamParser {
    ...
    static {
        char[] cArr = {'!', '\"', '#', '$', '%', Typography.amp, '\'', PropertyUtils.MAPPED_DELIM, PropertyUtils.MAPPED_DELIM2, '*', '+', ',', NameUtil.HYPHEN, '.', '/', NameUtil.COLON, ';', Typography.less, '=', Typography.greater, '?', '@', PropertyUtils.INDEXED_DELIM, ICSVParser.DEFAULT_ESCAPE_CHARACTER, PropertyUtils.INDEXED_DELIM2, '^', NameUtil.USCORE};
    ...
    static DecoderResult decode(byte[] bArr) throws FormatException {
        ...
        do {
            if (mode == Mode.ASCII_ENCODE) {
                ...
                int i = C17841.f2032xb73eb560[mode.ordinal()];
                if (i == 1) {
    ...
    static /* synthetic */ class C17841 {
        ...
        static final /* synthetic */ int[] f2032xb73eb560;
        ...
        static {
            ...
            try {
                f2032xb73eb560[Mode.TEXT_ENCODE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f2032xb73eb560[Mode.ANSIX12_ENCODE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f2032xb73eb560[Mode.EDIFACT_ENCODE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f2032xb73eb560[Mode.BASE256_ENCODE.ordinal()] = 5;
