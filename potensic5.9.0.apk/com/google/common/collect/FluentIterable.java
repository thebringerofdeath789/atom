...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    private Iterable<E> getDelegate() {
        return this.iterableDelegate.mo1513or((Optional<Iterable<E>>) this);
    }
    ...
    /* renamed from: of */
    public static <E> FluentIterable<E> m1531of() {
        return from(ImmutableList.m1541of());
    }

    /* renamed from: of */
    public static <E> FluentIterable<E> m1532of(@NullableDecl E e, E... eArr) {
    ...
    public final Optional<E> first() {
        ...
        return it.hasNext() ? Optional.m1519of(it.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (delegate instanceof List) {
            ...
            return Optional.m1519of(list.get(list.size() - 1));
        }
        ...
        if (delegate instanceof SortedSet) {
            return Optional.m1519of(((SortedSet) delegate).last());
        }
        do {
            next = it.next();
        } while (it.hasNext());
        return Optional.m1519of(next);
    }
