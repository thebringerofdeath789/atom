...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public V get(@NullableDecl Object obj, @NullableDecl Object obj2) {
        ...
        return m1530at(num.intValue(), num2.intValue());
    }
    ...
    public Table.Cell<R, C, V> getCell(int i) {
        return new Tables.AbstractCell<R, C, V>(i) { // from class: com.google.common.collect.ArrayTable.2
            ...
            @Override // com.google.common.collect.Table.Cell
            public V getValue() {
                return (V) ArrayTable.this.m1530at(this.rowIndex, this.columnIndex);
            }
        };
    }
    ...
    public V getValue(int i) {
        return m1530at(i / this.columnList.size(), i % this.columnList.size());
    }
    ...
    public Map<R, V> column(C c) {
        ...
        return num == null ? ImmutableMap.m1560of() : new Column(num.intValue());
    }
    ...
    private class Column extends ArrayMap<R, V> {
        ...
        @Override // com.google.common.collect.ArrayTable.ArrayMap
        V getValue(int i) {
            return (V) ArrayTable.this.m1530at(i, this.columnIndex);
        }
    ...
    public Map<C, V> row(R r) {
        Preconditions.checkNotNull(r);
        Integer num = this.rowKeyToIndex.get(r);
        return num == null ? ImmutableMap.m1560of() : new Row(num.intValue());
    }
    ...
    private class Row extends ArrayMap<C, V> {
        ...
        @Override // com.google.common.collect.ArrayTable.ArrayMap
        V getValue(int i) {
            return (V) ArrayTable.this.m1530at(this.rowIndex, i);
        }
