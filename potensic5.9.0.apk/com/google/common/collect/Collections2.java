...
public final class Collections2 {
    ...
    static String toStringImpl(Collection<?> collection) {
        StringBuilder append = newStringBuilderForCollection(collection.size()).append(PropertyUtils.INDEXED_DELIM);
        boolean z = true;
    ...
    private static class PermutationIterator<E> extends AbstractIterator<List<E>> {
        ...
        void calculateNextPermutation() {
            ...
            while (true) {
                ...
                int i2 = this.f1977j;
                int i3 = iArr[i2] + this.f1978o[i2];
                if (i3 < 0) {
                    switchDirection();
                } else if (i3 != i2 + 1) {
                    Collections.swap(this.list, (i2 - iArr[i2]) + i, (i2 - i3) + i);
                    this.f1976c[this.f1977j] = i3;
                    return;
                } else {
                    if (i2 == 0) {
                        return;
