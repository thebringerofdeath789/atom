...
public final class MoreExecutors {
    ...
    */
    ...
    static Executor rejectionPropagatingExecutor(Executor executor, AbstractFuture<?> abstractFuture) {
        ...
        return executor == directExecutor() ? executor : new ExecutorC16635(executor, abstractFuture);
    }

    /* renamed from: com.google.common.util.concurrent.MoreExecutors$5 */
    static class ExecutorC16635 implements Executor {
        boolean thrownFromDelegate = true;
        final /* synthetic */ Executor val$delegate;
        final /* synthetic */ AbstractFuture val$future;

        ExecutorC16635(Executor executor, AbstractFuture abstractFuture) {
        ...
        public void execute(final Runnable runnable) {
            try {
                this.val$delegate.execute(new Runnable() { // from class: com.google.common.util.concurrent.MoreExecutors.5.1
                    @Override // java.lang.Runnable
                    public void run() {
                        ExecutorC16635.this.thrownFromDelegate = false;
                        runnable.run();
                    }
                });
