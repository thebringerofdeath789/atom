...
public final class MediaType {
    ...
    private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.m1555of("charset", Ascii.toLowerCase(Charsets.UTF_8.name()));
    ...
    public static final MediaType GIF = createConstant("image", ContentTypes.EXTENSION_GIF);
    public static final MediaType ICO = createConstant("image", "vnd.microsoft.icon");
    public static final MediaType JPEG = createConstant("image", ContentTypes.EXTENSION_JPG_2);
    public static final MediaType PNG = createConstant("image", ContentTypes.EXTENSION_PNG);
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.m1518on("; ").withKeyValueSeparator("=");

    private static MediaType createConstant(String str, String str2) {
        MediaType addKnownType = addKnownType(new MediaType(str, str2, ImmutableListMultimap.m1554of()));
    ...
    private static MediaType createConstantUtf8(String str, String str2) {
        ...
        addKnownType.parsedCharset = Optional.m1519of(Charsets.UTF_8);
        return addKnownType;
    }
    ...
    public Optional<Charset> charset() {
        ...
        if (optional == null) {
            ...
            while (it.hasNext()) {
                String next = it.next();
                if (str == null) {
                    optional = Optional.m1519of(Charset.forName(next));
                    str = next;
    ...
    public MediaType withParameter(String str, String str2) {
        return withParameters(str, ImmutableSet.m1584of(str2));
    }

    public MediaType withCharset(Charset charset) {
        Preconditions.checkNotNull(charset);
        MediaType withParameter = withParameter("charset", charset.name());
        withParameter.parsedCharset = Optional.m1519of(charset);
    ...
    /* renamed from: is */
    public boolean m1652is(MediaType mediaType) {
    ...
    public static MediaType create(String str, String str2) {
        MediaType create = create(str, str2, ImmutableListMultimap.m1554of());
            ...
            while (tokenizer.hasMore()) {
                ...
                if ('\"' == tokenizer.previewChar()) {
                    ...
                    while ('\"' != tokenizer.previewChar()) {
                        if ('\\' == tokenizer.previewChar()) {
                            tokenizer.consumeCharacter(ICSVParser.DEFAULT_ESCAPE_CHARACTER);
    ...
    public static String escapeAndQuote(String str) {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            if (charAt == '\r' || charAt == '\\' || charAt == '\"') {
                append.append(ICSVParser.DEFAULT_ESCAPE_CHARACTER);
            }
