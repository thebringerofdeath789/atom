...
public final class InternetDomainName {
    ...
    private static final Splitter DOT_SPLITTER = Splitter.m1524on('.');
    private static final Joiner DOT_JOINER = Joiner.m1517on('.');

    static {
        CharMatcher anyOf = CharMatcher.anyOf("-_");
        DASH_MATCHER = anyOf;
        PART_CHAR_MATCHER = CharMatcher.javaLetterOrDigit().mo1516or(anyOf);
    }
    ...
    InternetDomainName(String str) {
        ...
        this.registrySuffixIndex = findSuffixOfType(Optional.m1519of(PublicSuffixType.REGISTRY));
    }
