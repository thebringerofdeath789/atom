...
import com.google.common.p017io.ByteStreams;
...
public final class InetAddresses {
    ...
    private static final Splitter IPV4_SPLITTER = Splitter.m1524on('.').limit(4);
    private static final Splitter IPV6_SPLITTER = Splitter.m1524on(NameUtil.COLON).limit(10);
    ...
    private static byte parseOctet(String str) {
        ...
        if (parseInt > 255 || (str.startsWith(SessionDescription.SUPPORTED_SDP_VERSION) && str.length() > 1)) {
