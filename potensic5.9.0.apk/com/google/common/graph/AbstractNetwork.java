...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
    ...
    class C15101 extends AbstractGraph<N> {
        C15101() {
        }

        @Override // com.google.common.graph.PredecessorsFunction
        public /* bridge */ /* synthetic */ Iterable predecessors(Object obj) {
            return predecessors((C15101) obj);
        }

        @Override // com.google.common.graph.SuccessorsFunction
        public /* bridge */ /* synthetic */ Iterable successors(Object obj) {
            return successors((C15101) obj);
        }
        ...
        public Set<EndpointPair<N>> edges() {
            ...
            return new AbstractSet<EndpointPair<N>>() { // from class: com.google.common.graph.AbstractNetwork.1.1
                ...
                public boolean contains(@NullableDecl Object obj) {
                    ...
                    return C15101.this.isOrderingCompatible(endpointPair) && C15101.this.nodes().contains(endpointPair.nodeU()) && C15101.this.successors((C15101) endpointPair.nodeU()).contains(endpointPair.nodeV());
                }
            };
        }
    ...
    public Set<E> adjacentEdges(E e) {
        ...
        return Sets.difference(Sets.union(incidentEdges(incidentNodes.nodeU()), incidentEdges(incidentNodes.nodeV())), ImmutableSet.m1584of((Object) e));
    }
