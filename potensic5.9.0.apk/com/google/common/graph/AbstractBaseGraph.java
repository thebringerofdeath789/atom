...
abstract class AbstractBaseGraph<N> implements BaseGraph<N> {
    ...
    public Set<EndpointPair<N>> edges() {
        return new AbstractSet<EndpointPair<N>>() { // from class: com.google.common.graph.AbstractBaseGraph.1
            ...
            public UnmodifiableIterator<EndpointPair<N>> iterator() {
                return EndpointPairIterator.m1642of(AbstractBaseGraph.this);
            }
    ...
    public Set<EndpointPair<N>> incidentEdges(N n) {
        ...
        return IncidentEdgeSet.m1636of((BaseGraph) this, (Object) n);
    }
    ...
    private static abstract class IncidentEdgeSet<N> extends AbstractSet<EndpointPair<N>> {
        ...
        /* renamed from: of */
        public static <N> IncidentEdgeSet<N> m1636of(BaseGraph<N> baseGraph, N n) {
        ...
        private static final class Directed<N> extends IncidentEdgeSet<N> {
            ...
            public UnmodifiableIterator<EndpointPair<N>> iterator() {
                ...
                }), Iterators.transform(Sets.difference(this.graph.successors((BaseGraph<N>) this.node), ImmutableSet.m1584of(this.node)).iterator(), new Function<N, EndpointPair<N>>() { // from class: com.google.common.graph.AbstractBaseGraph.IncidentEdgeSet.Directed.2
                    @Override // com.google.common.base.Function
                    public /* bridge */ /* synthetic */ Object apply(Object obj) {
                        return apply((C15072) obj);
                    }
