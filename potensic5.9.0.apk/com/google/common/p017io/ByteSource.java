...
public abstract class ByteSource {
    ...
    class AsCharSource extends CharSource {
        ...
        @Override // com.google.common.p017io.CharSource
    ...
    private final class SlicedByteSource extends ByteSource {
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            if (sizeIfKnown.isPresent()) {
                ...
                return Optional.m1519of(Long.valueOf(Math.min(this.length, longValue - Math.min(this.offset, longValue))));
            }
            return Optional.absent();
        }
    ...
    private static class ByteArrayByteSource extends ByteSource {
        ...
        @Override // com.google.common.p017io.ByteSource
        public Optional<Long> sizeIfKnown() {
            return Optional.m1519of(Long.valueOf(this.length));
        }
    ...
    private static final class EmptyByteSource extends ByteArrayByteSource {
        ...
        @Override // com.google.common.io.ByteSource.ByteArrayByteSource, com.google.common.p017io.ByteSource
        public byte[] read() {
            return this.bytes;
        }
    }
    ...
    private static final class ConcatenatedByteSource extends ByteSource {
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            while (it.hasNext()) {
                ...
                if (j < 0) {
                    return Optional.m1519of(Long.MAX_VALUE);
                }
            }
            return Optional.m1519of(Long.valueOf(j));
        }
