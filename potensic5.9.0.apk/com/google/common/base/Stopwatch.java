...
public final class Stopwatch {
    ...
    public String toString() {
        ...
        return Platform.formatCompact4Digits(elapsedNanos / TimeUnit.NANOSECONDS.convert(1L, r2)) + StringUtils.SPACE + abbreviate(chooseUnit(elapsedNanos));
    }
    ...
    private static String abbreviate(TimeUnit timeUnit) {
        switch (C12581.$SwitchMap$java$util$concurrent$TimeUnit[timeUnit.ordinal()]) {
            case 1:
                return "ns";
            case 2:
                return "μs";
