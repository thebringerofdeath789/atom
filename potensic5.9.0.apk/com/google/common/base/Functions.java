...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f1956f;

        /* renamed from: g */
        private final Function<B, C> f1957g;

        public FunctionComposition(Function<B, C> function, Function<A, ? extends B> function2) {
            this.f1957g = (Function) Preconditions.checkNotNull(function);
            this.f1956f = (Function) Preconditions.checkNotNull(function2);
        }

        @Override // com.google.common.base.Function
        public C apply(@NullableDecl A a) {
            return (C) this.f1957g.apply(this.f1956f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            return this.f1956f.equals(functionComposition.f1956f) && this.f1957g.equals(functionComposition.f1957g);
        }

        public int hashCode() {
            return this.f1956f.hashCode() ^ this.f1957g.hashCode();
        }
