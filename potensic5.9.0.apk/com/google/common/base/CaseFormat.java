...
public abstract class CaseFormat {
    ...
    static {
        CaseFormat caseFormat = new CaseFormat("LOWER_HYPHEN", 0, CharMatcher.m1515is(NameUtil.HYPHEN), "-") { // from class: com.google.common.base.CaseFormat.1
        ...
        String str = "_";
        CaseFormat caseFormat2 = new CaseFormat("LOWER_UNDERSCORE", 1, CharMatcher.m1515is(NameUtil.USCORE), str) { // from class: com.google.common.base.CaseFormat.2
            @Override // com.google.common.base.CaseFormat
        ...
        CaseFormat caseFormat5 = new CaseFormat("UPPER_UNDERSCORE", 4, CharMatcher.m1515is(NameUtil.USCORE), str) { // from class: com.google.common.base.CaseFormat.5
            @Override // com.google.common.base.CaseFormat
            String normalizeWord(String str3) {
    ...
    /* renamed from: to */
    public final String m1514to(CaseFormat caseFormat, String str) {
    ...
    private static final class StringConverter extends Converter<String, String> implements Serializable {
        ...
        protected String doForward(String str) {
            return this.sourceFormat.m1514to(this.targetFormat, str);
        }

        @Override // com.google.common.base.Converter
        protected String doBackward(String str) {
            return this.targetFormat.m1514to(this.sourceFormat, str);
        }
