...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: is */
    public static CharMatcher m1515is(char c) {
        return new C1237Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m1515is(charSequence.charAt(0));
        }
        if (length == 2) {
    ...
    /* renamed from: or */
    public CharMatcher mo1516or(CharMatcher charMatcher) {
        return new C1238Or(this, charMatcher);
    }
    ...
    CharMatcher precomputedInternal() {
        ...
        return new NegatedFastMatcher(precomputedPositive(i, bitSet, charMatcher.endsWith(".negate()") ? charMatcher.substring(0, charMatcher.length() - 9) : charMatcher + ".negate()")) { // from class: com.google.common.base.CharMatcher.1
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m1515is((char) bitSet.nextSetBit(0));
        }
        if (i != 2) {
    ...
    public static String showCharacter(char c) {
        char[] cArr = {ICSVParser.DEFAULT_ESCAPE_CHARACTER, 'u', 0, 0, 0, 0};
        for (int i = 0; i < 4; i++) {
    ...
    private static final class C1238Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C1238Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    private static final class C1237Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo1516or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo1516or(charMatcher);
        }
