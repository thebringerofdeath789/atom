...
import com.google.common.p017io.ByteSource;
import com.google.common.p017io.CharSource;
import com.google.common.p017io.Resources;
import java.io.File;
...
public final class ClassPath {
    ...
    private static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.m1527on(StringUtils.SPACE).omitEmptyStrings();
    ...
    public static class ResourceInfo {
        ...
        /* renamed from: of */
        static ResourceInfo m1677of(String str, ClassLoader classLoader) {
    ...
    static abstract class Scanner {
        ...
        static ImmutableList<URL> parseJavaClassPath() {
            ...
            for (String str : Splitter.m1527on(StandardSystemProperty.PATH_SEPARATOR.value()).split(StandardSystemProperty.JAVA_CLASS_PATH.value())) {
                try {
                    try {
                        builder.add((ImmutableList.Builder) new File(str).toURI().toURL());
                    } catch (SecurityException unused) {
                        builder.add((ImmutableList.Builder) new URL(StringLookupFactory.KEY_FILE, (String) null, new File(str).getAbsolutePath()));
                    }
    ...
    static final class DefaultScanner extends Scanner {
        ...
        ImmutableSet<ResourceInfo> getResources() {
            ...
            for (Map.Entry<ClassLoader, String> entry : this.resources.entries()) {
                builder.add((ImmutableSet.Builder) ResourceInfo.m1677of(entry.getValue(), entry.getKey()));
            }
            return builder.build();
        }
            ...
            for (File file2 : listFiles) {
                ...
                if (file2.isDirectory()) {
                    ...
                    if (set.add(canonicalFile)) {
                        scanDirectory(canonicalFile, classLoader, str + name + InternalZipConstants.ZIP_FILE_SEPARATOR, set);
