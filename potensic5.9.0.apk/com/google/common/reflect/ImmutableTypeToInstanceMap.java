...
public final class ImmutableTypeToInstanceMap<B> extends ForwardingMap<TypeToken<? extends B>, B> implements TypeToInstanceMap<B> {
    ...
    /* renamed from: of */
    public static <B> ImmutableTypeToInstanceMap<B> m1678of() {
        return new ImmutableTypeToInstanceMap<>(ImmutableMap.m1560of());
    }
    ...
    public static final class Builder<B> {
        ...
        public <T extends B> Builder<B> put(Class<T> cls, T t) {
            this.mapBuilder.put(TypeToken.m1680of((Class) cls), t);
            return this;
        }
    ...
    public <T extends B> T getInstance(Class<T> cls) {
        return (T) trustedGet(TypeToken.m1680of((Class) cls));
    }
