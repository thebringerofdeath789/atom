    ...
    */
    ...
    public String getPath() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (i3 == 1 || i3 == 2) {
                append.append(PropertyUtils.INDEXED_DELIM).append(this.pathIndices[i2]).append(PropertyUtils.INDEXED_DELIM2);
