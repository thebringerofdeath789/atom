...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f1804ix = readShort();
        this.header.currentFrame.f1805iy = readShort();
        this.header.currentFrame.f1803iw = readShort();
        this.header.currentFrame.f1802ih = readShort();
        int read = read();
