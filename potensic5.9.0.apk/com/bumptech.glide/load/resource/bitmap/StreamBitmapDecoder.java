...
public class StreamBitmapDecoder implements ResourceDecoder<InputStream, Bitmap> {
    ...
    /* renamed from: ID */
    private static final String f1814ID = "StreamBitmapDecoder.com.bumptech.glide.load.resource.bitmap";
    ...
    @Override // com.bumptech.glide.load.ResourceDecoder
    public String getId() {
        if (this.f1815id == null) {
            this.f1815id = f1814ID + this.downsampler.getId() + this.decodeFormat.name();
        }
        return this.f1815id;
    }
}