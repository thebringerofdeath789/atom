...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
    ...
    public GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> mo2600clone() {
        try {
            ...
            ChildLoadProvider<ModelType, DataType, ResourceType, TranscodeType> childLoadProvider = this.loadProvider;
            genericRequestBuilder.loadProvider = childLoadProvider != null ? childLoadProvider.m2601clone() : null;
    ...
    public Target<TranscodeType> into(ImageView imageView) {
        ...
        if (!this.isTransformationSet && imageView.getScaleType() != null) {
            int i = C07702.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()];
            if (i == 1) {
                applyCenterCrop();
            } else if (i == 2 || i == 3 || i == 4) {
                applyFitCenter();
