...
class Scanner {
    ...
    /* renamed from: GT */
    public static final TokenType f3502GT = new TokenType(9, "GT");
    ...
    /* renamed from: LT */
    public static final TokenType f3503LT = new TokenType(14, "LT");
    ...
    public Scanner(Reader reader, boolean z, EntityExpansion entityExpansion) {
        this.f3504in = new StreamInfo("", reader);
        this.atEOF = false;
        this.trace = z;
    ...
    protected int readNextChar() throws IOException {
        Stack stack;
        int read = this.f3504in.f3506in.read();
        if (read >= 0 || (stack = this.inputStreams) == null || stack.empty()) {
            return read;
        }
        this.f3504in.f3506in.close();
        this.f3504in = (StreamInfo) this.inputStreams.pop();
        return readNextChar();
    }
    ...
    protected int peekChar() throws IOException {
        ...
        if (this.nextChar == 0) {
            ...
            this.f3504in.column++;
            if (this.nextChar == 10) {
                this.f3504in.lineNumber++;
                this.f3504in.column = 1;
            }
        }
    ...
    */
    ...
    public String getUriId() {
        return this.f3504in.f3505id;
    }

    public int getLineNumber() {
        return this.f3504in.lineNumber;
    }

    public int getColumn() {
        return this.f3504in.column;
    }
    ...
    public boolean expandEntity(String str) throws IOException {
        ...
        this.inputStreams.push(this.f3504in);
        this.f3504in = new StreamInfo(expandEntity.getExternalId(), reader);
        return true;
    }
