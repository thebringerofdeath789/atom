...
public class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C1783R.styleable.zxing_finder);
        this.maskColor = obtainStyledAttributes.getColor(C1783R.styleable.zxing_finder_zxing_viewfinder_mask, resources.getColor(C1783R.color.zxing_viewfinder_mask));
        this.resultColor = obtainStyledAttributes.getColor(C1783R.styleable.zxing_finder_zxing_result_view, resources.getColor(C1783R.color.zxing_result_view));
        this.laserColor = obtainStyledAttributes.getColor(C1783R.styleable.zxing_finder_zxing_viewfinder_laser, resources.getColor(C1783R.color.zxing_viewfinder_laser));
        this.resultPointColor = obtainStyledAttributes.getColor(C1783R.styleable.zxing_finder_zxing_possible_result_points, resources.getColor(C1783R.color.zxing_possible_result_points));
        this.laserVisibility = obtainStyledAttributes.getBoolean(C1783R.styleable.zxing_finder_zxing_viewfinder_laser_visibility, true);
