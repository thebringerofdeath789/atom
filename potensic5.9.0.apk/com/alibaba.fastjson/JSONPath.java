...
public class JSONPath implements JSONAware {
    ...
    public boolean containsValue(Object obj, Object obj2) {
        ...
        if (eval instanceof Iterable) {
            ...
            while (it.hasNext()) {
                if (m23eq(it.next(), obj2)) {
                    return true;
                }
            }
            return false;
        }
        return m23eq(eval, obj2);
    }
    ...
    */
    ...
    static class JSONPathParser {
        ...
        Segment readSegement() {
            ...
            if (this.level == 0 && this.path.length() == 1) {
                if (isDigitFirst(this.f64ch)) {
                    return new ArrayAccessSegment(this.f64ch - '0');
                }
                char c = this.f64ch;
                if ((c >= 'a' && c <= 'z') || (c >= 'A' && c <= 'Z')) {
                    return new PropertySegment(Character.toString(this.f64ch), false);
                }
            }
            while (!isEOF()) {
                skipWhitespace();
                ...
                if (c2 != '$') {
                    ...
                    if (c2 == '.' && this.f64ch == '.') {
                        ...
                        int i = this.pos;
                        if (length > i + 3 && this.f64ch == '[' && this.path.charAt(i) == '*' && this.path.charAt(this.pos + 1) == ']' && this.path.charAt(this.pos + 2) == '.') {
                            next();
                            next();
                            next();
                            next();
        ...
        */
        ...
        Filter filterRest(Filter filter) {
            char c = this.f64ch;
            boolean z = c == '&';
            if ((c != '&' || getNextChar() != '&') && (this.f64ch != '|' || getNextChar() != '|')) {
                return filter;
            }
            next();
            next();
        ...
        String readName() {
            ...
            if (isEOF() && Character.isJavaIdentifierPart(this.f64ch)) {
                sb.append(this.f64ch);
            }
            return sb.toString();
        }
        ...
        void accept(char c) {
            if (this.f64ch != c) {
                throw new JSONPathException("expect '" + c + ", but '" + this.f64ch + "'");
            }
            if (isEOF()) {
                return;
            }
    ...
    static class ValueSegment implements Filter {
        ...
        public boolean apply(JSONPath jSONPath, Object obj, Object obj2, Object obj3) {
            ...
            return !this.f76eq ? !equals : equals;
        }
    }
    ...
    static class IntOpSegement implements Filter {
        ...
        public boolean apply(JSONPath jSONPath, Object obj, Object obj2, Object obj3) {
            ...
            if (propertyValue instanceof BigDecimal) {
                ...
                switch (C05891.$SwitchMap$com$alibaba$fastjson$JSONPath$Operator[this.f63op.ordinal()]) {
                    case 1:
                        if (compareTo == 0) {
                            break;
                        }
    ...
    static class DoubleOpSegement implements Filter {
        ...
        public boolean apply(JSONPath jSONPath, Object obj, Object obj2, Object obj3) {
            ...
            switch (C05891.$SwitchMap$com$alibaba$fastjson$JSONPath$Operator[this.f62op.ordinal()]) {
                case 1:
        ...
        public boolean apply(JSONPath jSONPath, Object obj, Object obj2, Object obj3) {
            ...
            if ((eval instanceof Integer) || (eval instanceof Long) || (eval instanceof Short) || (eval instanceof Byte)) {
                ...
                if ((propertyValue instanceof Integer) || (propertyValue instanceof Long) || (propertyValue instanceof Short) || (propertyValue instanceof Byte)) {
                    ...
                    switch (C05891.$SwitchMap$com$alibaba$fastjson$JSONPath$Operator[this.f73op.ordinal()]) {
                        case 1:
    ...
    static class StringOpSegement implements Filter {
        ...
        public boolean apply(JSONPath jSONPath, Object obj, Object obj2, Object obj3) {
            Object propertyValue = jSONPath.getPropertyValue(obj3, this.propertyName, this.propertyNameHash);
            if (this.f75op == Operator.EQ) {
                return this.value.equals(propertyValue);
            }
            if (this.f75op == Operator.NE) {
                return !this.value.equals(propertyValue);
            }
            if (propertyValue == null) {
                return false;
            ...
            return this.f75op == Operator.GE ? compareTo <= 0 : this.f75op == Operator.GT ? compareTo < 0 : this.f75op == Operator.LE ? compareTo >= 0 : this.f75op == Operator.LT && compareTo > 0;
        }
    }
    ...
    /* renamed from: eq */
    static boolean m23eq(Object obj, Object obj2) {
        if (obj == obj2) {
            return true;
        }
