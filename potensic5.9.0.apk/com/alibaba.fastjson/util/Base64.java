...
public class Base64 {
    ...
    /* renamed from: CA */
    public static final char[] f83CA;

    /* renamed from: IA */
    public static final int[] f84IA;
    ...
    public static byte[] decodeFast(char[] cArr, int i, int i2) {
        ...
        int i5 = (i + i2) - 1;
        while (i < i5 && f84IA[cArr[i]] < 0) {
            i++;
        }
        while (i5 > 0 && f84IA[cArr[i5]] < 0) {
            i5--;
        }
    ...
    public static byte[] decodeFast(String str, int i, int i2) {
        ...
        int i5 = (i + i2) - 1;
        while (i < i5 && f84IA[str.charAt(i)] < 0) {
            i++;
        }
        while (i5 > 0 && f84IA[str.charAt(i5)] < 0) {
            i5--;
        }
        ...
        if (i10 < i8) {
            int i22 = 0;
            while (i <= i5 - i6) {
                i4 |= f84IA[str.charAt(i)] << (18 - (i22 * 6));
                i22++;
                i++;
            }
            int i23 = 16;
    ...
    public static byte[] decodeFast(String str) {
        ...
        int i3 = length - 1;
        int i4 = 0;
        while (i4 < i3 && f84IA[str.charAt(i4) & 255] < 0) {
            i4++;
        }
        while (i3 > 0 && f84IA[str.charAt(i3) & 255] < 0) {
            i3--;
        }
        ...
        if (i9 < i7) {
            int i21 = 0;
            while (i4 <= i3 - i5) {
                i2 |= f84IA[str.charAt(i4)] << (18 - (i21 * 6));
                i21++;
                i4++;
            }
            int i22 = 16;
