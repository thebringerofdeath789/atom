...
public class MiscCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    private static boolean FILE_RELATIVE_PATH_SUPPORT = BooleanUtils.TRUE.equals(IOUtils.getStringProperty("fastjson.deserializer.fileRelativePathSupport"));
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int i) throws IOException {
        ...
        if (cls == SimpleDateFormat.class) {
            ...
            if (cls == InetSocketAddress.class) {
                ...
                serializeWriter.write(123);
                if (address != null) {
                    serializeWriter.writeFieldName(GeocodingCriteria.TYPE_ADDRESS);
