...
public abstract class JSONLexerBase implements JSONLexer, Closeable {
    ...
    public final void nextTokenWithChar(char c) {
        ...
        while (true) {
            ...
            if (c2 == c) {
                ...
                throw new JSONException("not match " + c + " - " + this.f80ch + ", info : " + info());
            }
        }
    }
    ...
    public final String scanSymbol(SymbolTable symbolTable, char c) {
        ...
        while (true) {
            ...
            if (next == c) {
                ...
                if (!z) {
                    int i2 = this.f81np;
                    addSymbol = addSymbol(i2 == -1 ? 0 : i2 + 1, this.f82sp, i, symbolTable);
                } else {
                    addSymbol = symbolTable.addSymbol(this.sbuf, 0, this.f82sp, i);
                }
                this.f82sp = 0;
                next();
                return addSymbol;
            ...
            if (next == '\\') {
                if (!z) {
                    ...
                    arrayCopy(this.f81np + 1, this.sbuf, 0, this.f82sp);
                    z = true;
                }
                char next2 = next();
                if (next2 == '\"') {
    ...
    public final String scanSymbolUnQuoted(SymbolTable symbolTable) {
        if (this.token == 1 && this.pos == 0 && this.f79bp == 1) {
            this.f79bp = 0;
        }
        boolean[] zArr = IOUtils.firstIdentifierFlags;
        int i = this.f80ch;
        if (!(i >= zArr.length || zArr[i])) {
            throw new JSONException("illegal identifier : " + this.f80ch + info());
        }
        ...
        this.token = 18;
        if (this.f82sp == 4 && i == 3392903 && charAt(this.f81np) == 'n' && charAt(this.f81np + 1) == 'u' && charAt(this.f81np + 2) == 'l' && charAt(this.f81np + 3) == 'l') {
            return null;
        }
        if (symbolTable == null) {
            return subString(this.f81np, this.f82sp);
        }
        return addSymbol(this.f81np, this.f82sp, i, symbolTable);
    }
        ...
        while (true) {
            ...
            if (next == 26) {
                ...
                if (!this.hasSpecial) {
                    ...
                    copyTo(this.f81np + 1, this.f82sp, this.sbuf);
                }
                char next2 = next();
                if (next2 == '\"') {
                    putChar('\"');
    ...
    public final boolean isRef() {
        return this.f82sp == 4 && charAt(this.f81np + 1) == '$' && charAt(this.f81np + 2) == 'r' && charAt(this.f81np + 3) == 'e' && charAt(this.f81np + 4) == 'f';
    }
    ...
    public final boolean matchField(char[] cArr) {
        ...
        if (charAt == '{') {
            ...
            next();
            this.token = 14;
        } else if (charAt == 'S' && charAt(this.f79bp + 1) == 'e' && charAt(this.f79bp + 2) == 't' && charAt(this.f79bp + 3) == '[') {
            int i = this.f79bp + 3;
            this.f79bp = i;
            this.f80ch = charAt(i);
            this.token = 21;
    ...
    public String scanFieldString(char[] cArr) {
        ...
        int i = length + 1;
        if (charAt(this.f79bp + length) != '\"') {
            this.matchStat = -1;
            return stringDefaultValue();
        }
        int indexOf = indexOf('\"', this.f79bp + cArr.length + 1);
        if (indexOf == -1) {
            throw new JSONException("unclosed str");
        }
        int length2 = this.f79bp + cArr.length + 1;
        ...
        if (charAt == '}') {
            int i8 = i6 + 1;
            char charAt2 = charAt(this.f79bp + i6);
            if (charAt2 == ',') {
                this.token = 16;
                int i9 = this.f79bp + i8;
                this.f79bp = i9;
                this.f80ch = charAt(i9);
            } else if (charAt2 == ']') {
                this.token = 15;
                int i10 = this.f79bp + i8;
                this.f79bp = i10;
                this.f80ch = charAt(i10);
            } else if (charAt2 == '}') {
                this.token = 13;
                int i11 = this.f79bp + i8;
                this.f79bp = i11;
    ...
    public String scanString(char c) {
        this.matchStat = 0;
        char charAt = charAt(this.f79bp + 0);
        if (charAt == 'n') {
            if (charAt(this.f79bp + 1) == 'u' && charAt(this.f79bp + 1 + 1) == 'l' && charAt(this.f79bp + 1 + 2) == 'l') {
                if (charAt(this.f79bp + 4) == c) {
                    int i = this.f79bp + 5;
                    this.f79bp = i;
                    this.f80ch = charAt(i);
                    this.matchStat = 3;
        ...
        int i3 = this.f79bp + i2;
        int indexOf = indexOf('\"', i3);
        if (indexOf == -1) {
            throw new JSONException("unclosed str");
        }
        String subString = subString(this.f79bp + i2, indexOf - i3);
        if (subString.indexOf(92) != -1) {
            while (true) {
                int i4 = 0;
            ...
            int i6 = indexOf - i3;
            subString = readString(sub_chars(this.f79bp + 1, i6), i6);
        }
        int i7 = i2 + (indexOf - i3) + 1;
        int i8 = i7 + 1;
        char charAt2 = charAt(this.f79bp + i7);
        while (charAt2 != c) {
            if (isWhitespace(charAt2)) {
                charAt2 = charAt(this.f79bp + i8);
                i8++;
            } else {
                this.matchStat = -1;
                return subString;
    ...
    public long scanFieldSymbol(char[] cArr) {
        ...
        while (true) {
            int i2 = i + 1;
            char charAt = charAt(this.f79bp + i);
            if (charAt == '\"') {
                int i3 = i2 + 1;
                char charAt2 = charAt(this.f79bp + i2);
                if (charAt2 == ',') {
                    int i4 = this.f79bp + i3;
                    this.f79bp = i4;
                    this.f80ch = charAt(i4);
                    this.matchStat = 3;
                    return j;
                ...
                if (charAt2 == '}') {
                    int i5 = i3 + 1;
                    char charAt3 = charAt(this.f79bp + i3);
                    if (charAt3 == ',') {
                        this.token = 16;
                        int i6 = this.f79bp + i5;
                        this.f79bp = i6;
                        this.f80ch = charAt(i6);
                    } else if (charAt3 == ']') {
                        this.token = 15;
                        int i7 = this.f79bp + i5;
                        this.f79bp = i7;
                        this.f80ch = charAt(i7);
                    } else if (charAt3 == '}') {
                        this.token = 13;
                        int i8 = this.f79bp + i5;
                        this.f79bp = i8;
    ...
    public String scanSymbolWithSeperator(SymbolTable symbolTable, char c) {
        ...
        while (true) {
            int i4 = i3 + 1;
            char charAt2 = charAt(this.f79bp + i3);
            if (charAt2 == '\"') {
                int i5 = this.f79bp;
                int i6 = i5 + 0 + 1;
                String addSymbol = addSymbol(i6, ((i5 + i4) - i6) - 1, i, symbolTable);
                int i7 = i4 + 1;
                char charAt3 = charAt(this.f79bp + i4);
                while (charAt3 != c) {
                    if (isWhitespace(charAt3)) {
                        charAt3 = charAt(this.f79bp + i7);
                        i7++;
                    } else {
                        this.matchStat = -1;
                        return addSymbol;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:51:0x0153, code lost:
        ...
        r11.f79bp += r6 - 1;
        r11.token = 20;
        r11.f80ch = com.alibaba.fastjson.parser.JSONLexer.EOI;
     */
    ...
    */
    ...
    public int scanFieldInt(char[] cArr) {
        ...
        int length = cArr.length;
        int i2 = length + 1;
        char charAt2 = charAt(this.f79bp + length);
        boolean z = charAt2 == '-';
        if (z) {
            charAt2 = charAt(this.f79bp + i2);
            i2++;
        }
        ...
        if (charAt == '}') {
            int i5 = i + 1;
            char charAt3 = charAt(this.f79bp + i);
            if (charAt3 == ',') {
                this.token = 16;
                int i6 = this.f79bp + i5;
                this.f79bp = i6;
    ...
    public final int[] scanFieldIntArray(char[] cArr) {
        ...
        if (charAt3 == ']') {
            i3 = i5 + 1;
            charAt2 = charAt(this.f79bp + i5);
            i2 = 0;
        } else {
            int i6 = 0;
            while (true) {
                if (charAt3 == '-') {
                    charAt3 = charAt(this.f79bp + i5);
                    i5++;
                    z = true;
                } else {
                    z = false;
                ...
                iArr2[i6] = i7;
                if (charAt == ',') {
                    char charAt4 = charAt(this.f79bp + i);
                    i++;
                    charAt = charAt4;
                } else if (charAt == ']') {
                    i3 = i + 1;
                    charAt2 = charAt(this.f79bp + i);
                    break;
                }
                i6 = i2;
                iArr = null;
        ...
        if (charAt2 == '}') {
            int i8 = i3 + 1;
            char charAt5 = charAt(this.f79bp + i3);
            if (charAt5 == ',') {
                this.token = 16;
                this.f79bp += i8 - 1;
                next();
    ...
    */
    ...
    public int scanInt(char c) {
        ...
        char charAt;
        this.matchStat = 0;
        char charAt2 = charAt(this.f79bp + 0);
        boolean z = charAt2 == '\"';
        if (z) {
            charAt2 = charAt(this.f79bp + 1);
            i = 2;
        } else {
            i = 1;
        }
        ...
        if (charAt2 >= '0' && charAt2 <= '9') {
            ...
            while (charAt != c) {
                if (isWhitespace(charAt)) {
                    char charAt3 = charAt(this.f79bp + i2);
                    i2++;
                    charAt = charAt3;
                } else {
                    this.matchStat = -1;
        ...
        if (charAt2 == 'n' && charAt(this.f79bp + i) == 'u' && charAt(this.f79bp + i + 1) == 'l' && charAt(this.f79bp + i + 2) == 'l') {
            this.matchStat = 5;
            int i5 = i + 3;
            int i6 = i5 + 1;
            char charAt4 = charAt(this.f79bp + i5);
            if (z && charAt4 == '\"') {
                int i7 = i6 + 1;
                charAt4 = charAt(this.f79bp + i6);
                i6 = i7;
            }
            while (charAt4 != ',') {
                if (charAt4 == ']') {
                    int i8 = this.f79bp + i6;
                    this.f79bp = i8;
                    this.f80ch = charAt(i8);
                    this.matchStat = 5;
                    this.token = 15;
    ...
    public boolean scanFieldBoolean(char[] cArr) {
        ...
        int length = cArr.length;
        int i2 = length + 1;
        char charAt = charAt(this.f79bp + length);
        if (charAt == 't') {
            int i3 = i2 + 1;
            if (charAt(this.f79bp + i2) != 'r') {
                this.matchStat = -1;
                return false;
            }
            int i4 = i3 + 1;
            if (charAt(this.f79bp + i3) != 'u') {
                this.matchStat = -1;
                return false;
            }
            i = i4 + 1;
            if (charAt(this.f79bp + i4) != 'e') {
                this.matchStat = -1;
                return false;
            }
            z = true;
            ...
            int i5 = i2 + 1;
            if (charAt(this.f79bp + i2) != 'a') {
                this.matchStat = -1;
                return false;
            }
            int i6 = i5 + 1;
            if (charAt(this.f79bp + i5) != 'l') {
                this.matchStat = -1;
                return false;
            }
            int i7 = i6 + 1;
            if (charAt(this.f79bp + i6) != 's') {
                this.matchStat = -1;
                return false;
            }
            int i8 = i7 + 1;
            if (charAt(this.f79bp + i7) != 'e') {
                this.matchStat = -1;
                return false;
            }
            z = false;
        ...
        int i9 = i + 1;
        char charAt2 = charAt(this.f79bp + i);
        if (charAt2 == ',') {
            int i10 = this.f79bp + i9;
            this.f79bp = i10;
            this.f80ch = charAt(i10);
            this.matchStat = 3;
            this.token = 16;
        ...
        if (charAt2 == '}') {
            int i11 = i9 + 1;
            char charAt3 = charAt(this.f79bp + i9);
            if (charAt3 == ',') {
                this.token = 16;
                int i12 = this.f79bp + i11;
                this.f79bp = i12;
                this.f80ch = charAt(i12);
            } else if (charAt3 == ']') {
                this.token = 15;
                int i13 = this.f79bp + i11;
                this.f79bp = i13;
                this.f80ch = charAt(i13);
            } else if (charAt3 == '}') {
                this.token = 13;
                int i14 = this.f79bp + i11;
                this.f79bp = i14;
                this.f80ch = charAt(i14);
            } else if (charAt3 == 26) {
                this.token = 20;
                this.f79bp += i11 - 1;
                this.f80ch = JSONLexer.EOI;
    ...
    public long scanFieldLong(char[] cArr) {
        ...
        if (charAt == '}') {
            ...
            if (charAt3 == ',') {
                this.token = 16;
                int i5 = this.f79bp + i4;
                this.f79bp = i5;
                this.f80ch = charAt(i5);
            } else if (charAt3 == ']') {
                this.token = 15;
                int i6 = this.f79bp + i4;
                this.f79bp = i6;
                this.f80ch = charAt(i6);
            } else if (charAt3 == '}') {
                this.token = 13;
                int i7 = this.f79bp + i4;
                this.f79bp = i7;
                this.f80ch = charAt(i7);
            } else if (charAt3 == 26) {
                this.token = 20;
    ...
    public long scanLong(char c) {
        ...
        if (charAt2 >= '0' && charAt2 <= '9') {
            ...
            if (!(j >= 0 || (j == Long.MIN_VALUE && z2))) {
                throw new NumberFormatException(subString(this.f79bp, i2 - 1));
            }
            if (!z) {
                c2 = c;
            } else {
    ...
    public final float scanFieldFloat(char[] cArr) {
        ...
        int i3 = length2 + 1;
        char charAt2 = charAt(this.f79bp + length2);
        boolean z2 = charAt2 == '\"';
        if (z2) {
            charAt2 = charAt(this.f79bp + i3);
            i3++;
        }
        boolean z3 = charAt2 == '-';
        if (z3) {
        ...
        if (charAt2 >= '0') {
            ...
            if (charAt2 <= '9') {
                ...
                if (charAt == '}') {
                    ...
                    if (charAt4 == ',') {
                        this.token = 16;
                        int i13 = this.f79bp + i12;
                        this.f79bp = i13;
                        this.f80ch = charAt(i13);
                    } else if (charAt4 == ']') {
                        this.token = 15;
                        int i14 = this.f79bp + i12;
                        this.f79bp = i14;
                        this.f80ch = charAt(i14);
                    } else if (charAt4 == '}') {
                        this.token = 13;
                        int i15 = this.f79bp + i12;
                        this.f79bp = i15;
                        this.f80ch = charAt(i15);
                    } else if (charAt4 == 26) {
                        this.f79bp += i12 - 1;
                        this.token = 20;
                        this.f80ch = JSONLexer.EOI;
        ...
        boolean z5 = z2;
        if (charAt2 == 'n' && charAt(this.f79bp + i3) == 'u' && charAt(this.f79bp + i3 + 1) == 'l' && charAt(this.f79bp + i3 + 2) == 'l') {
            this.matchStat = 5;
            int i16 = i3 + 3;
            int i17 = i16 + 1;
            char charAt5 = charAt(this.f79bp + i16);
            if (z5 && charAt5 == '\"') {
                charAt5 = charAt(this.f79bp + i17);
                i17++;
            }
            while (charAt5 != ',') {
                if (charAt5 == '}') {
                    int i18 = this.f79bp + i17;
                    this.f79bp = i18;
                    this.f80ch = charAt(i18);
                    this.matchStat = 5;
                    this.token = 13;
                    return 0.0f;
                }
            ...
            int i19 = this.f79bp + i17;
            this.f79bp = i19;
            this.f80ch = charAt(i19);
            this.matchStat = 5;
            this.token = 16;
            return 0.0f;
        }
    ...
    public final float scanFloat(char c) {
        ...
        if (charAt2 < '0' || charAt2 > '9') {
            if (charAt2 == 'n' && charAt(this.f79bp + i) == 'u' && charAt(this.f79bp + i + 1) == 'l' && charAt(this.f79bp + i + 2) == 'l') {
                ...
                int i5 = i + 3;
                int i6 = i5 + 1;
                char charAt3 = charAt(this.f79bp + i5);
                if (z && charAt3 == '\"') {
                    charAt3 = charAt(this.f79bp + i6);
                    i6++;
                }
                while (charAt3 != ',') {
                    if (charAt3 == ']') {
        ...
        if (charAt == '.') {
            int i9 = i2 + 1;
            char charAt4 = charAt(this.f79bp + i2);
            if (charAt4 >= '0' && charAt4 <= '9') {
                j = (j * 10) + (charAt4 - '0');
                j2 = 10;
                while (true) {
                    i2 = i9 + 1;
                    charAt = charAt(this.f79bp + i9);
                    if (charAt < '0' || charAt > '9') {
                        break;
                    }
                    j = (j * 10) + (charAt - '0');
        ...
        if (z3) {
            int i10 = i2 + 1;
            char charAt5 = charAt(this.f79bp + i2);
            if (charAt5 == '+' || charAt5 == '-') {
                int i11 = i10 + 1;
                charAt = charAt(this.f79bp + i10);
                i2 = i11;
            } else {
                i2 = i10;
                charAt = charAt5;
    ...
    */
    ...
    public BigInteger scanFieldBigInteger(char[] cArr) {
        ...
        if (charAt2 == 'n' && charAt(this.f79bp + i3) == 'u' && charAt(this.f79bp + i3 + 1) == 'l' && charAt(this.f79bp + i3 + 2) == 'l') {
            ...
            int i12 = i3 + 3;
            int i13 = i12 + 1;
            char charAt4 = charAt(this.f79bp + i12);
            if (z && charAt4 == '\"') {
                charAt4 = charAt(this.f79bp + i13);
                i13++;
            }
            while (charAt4 != ',') {
                if (charAt4 == '}') {
                    int i14 = this.f79bp + i13;
                    this.f79bp = i14;
                    this.f80ch = charAt(i14);
                    this.matchStat = 5;
                    this.token = 13;
    ...
    public Date scanFieldDate(char[] cArr) {
        ...
        if (charAt2 == '}') {
            ...
            if (charAt3 == ',') {
                ...
                this.token = 15;
                int i11 = this.f79bp + i9;
                this.f79bp = i11;
                this.f80ch = charAt(i11);
            } else if (charAt3 == '}') {
                this.token = 13;
                int i12 = this.f79bp + i9;
                this.f79bp = i12;
                this.f80ch = charAt(i12);
            } else if (charAt3 == 26) {
                this.token = 20;
    ...
    public Date scanDate(char c) {
        ...
        int i2 = 5;
        if (charAt == '\"') {
            int indexOf = indexOf('\"', this.f79bp + 1);
            if (indexOf == -1) {
                throw new JSONException("unclosed str");
            }
            int i3 = this.f79bp + 1;
            ...
            if (charAt == '-' || (charAt >= '0' && charAt <= '9')) {
                ...
                date = new Date(j);
                i2 = i;
            } else if (charAt == 'n' && charAt(this.f79bp + 1) == 'u' && charAt(this.f79bp + 1 + 1) == 'l' && charAt(this.f79bp + 1 + 2) == 'l') {
                this.matchStat = 5;
                charAt = charAt(this.f79bp + 4);
                date = null;
            } else {
                this.matchStat = -1;
                return null;
        ...
        if (charAt == ']') {
            ...
            if (charAt2 == ',') {
                ...
                this.token = 13;
                int i16 = this.f79bp + i13;
                this.f79bp = i16;
                this.f80ch = charAt(i16);
            } else if (charAt2 == 26) {
                this.token = 20;
                this.f79bp += i13 - 1;
                this.f80ch = JSONLexer.EOI;
    ...
    public UUID scanFieldUUID(char[] cArr) {
        ...
        if (charAt2 == '\"') {
            ...
            if (charAt2 == 'n') {
                int i30 = i15 + 1;
                if (charAt(this.f79bp + i15) == 'u') {
                    int i31 = i30 + 1;
                    if (charAt(this.f79bp + i30) == 'l') {
                        int i32 = i31 + 1;
                        if (charAt(this.f79bp + i31) == 'l') {
                            charAt = charAt(this.f79bp + i32);
                            i = i32 + 1;
                            uuid = null;
                        }
                    }
        ...
        if (charAt == ',') {
            int i33 = this.f79bp + i;
            this.f79bp = i33;
            this.f80ch = charAt(i33);
            this.matchStat = 3;
            return uuid;
        }
        if (charAt == '}') {
            int i34 = i + 1;
            char charAt10 = charAt(this.f79bp + i);
            if (charAt10 == ',') {
                this.token = 16;
                int i35 = this.f79bp + i34;
                this.f79bp = i35;
                this.f80ch = charAt(i35);
            } else if (charAt10 == ']') {
                this.token = 15;
                int i36 = this.f79bp + i34;
                this.f79bp = i36;
                this.f80ch = charAt(i36);
            } else if (charAt10 == '}') {
                this.token = 13;
                int i37 = this.f79bp + i34;
                this.f79bp = i37;
                this.f80ch = charAt(i37);
            } else if (charAt10 == 26) {
                this.token = 20;
                this.f79bp += i34 - 1;
                this.f80ch = JSONLexer.EOI;
    ...
    public UUID scanUUID(char c) {
        ...
        } else if (charAt2 == 'n' && charAt(this.f79bp + 1) == 'u' && charAt(this.f79bp + 2) == 'l' && charAt(this.f79bp + 3) == 'l') {
            i = 5;
            charAt = charAt(this.f79bp + 4);
            uuid = null;
        } else {
        ...
        if (charAt == ',') {
            int i30 = this.f79bp + i;
            this.f79bp = i30;
            this.f80ch = charAt(i30);
            this.matchStat = 3;
            return uuid;
        }
        if (charAt == ']') {
            ...
            if (charAt10 == ',') {
                this.token = 16;
                int i32 = this.f79bp + i31;
                this.f79bp = i32;
                this.f80ch = charAt(i32);
            } else if (charAt10 == ']') {
                this.token = 15;
                int i33 = this.f79bp + i31;
                this.f79bp = i33;
                this.f80ch = charAt(i33);
            } else if (charAt10 == '}') {
                this.token = 13;
                int i34 = this.f79bp + i31;
                this.f79bp = i34;
                this.f80ch = charAt(i34);
            } else if (charAt10 == 26) {
                this.token = 20;
                this.f79bp += i31 - 1;
                this.f80ch = JSONLexer.EOI;
    ...
    public final void scanIdent() {
        this.f81np = this.f79bp - 1;
        this.hasSpecial = false;
        do {
            this.f82sp++;
            next();
        } while (Character.isLetterOrDigit(this.f80ch));
    ...
    public final void scanHex() {
        char next;
        if (this.f80ch != 'x') {
            throw new JSONException("illegal state. " + this.f80ch);
        }
        next();
        if (this.f80ch != '\'') {
            throw new JSONException("illegal state. " + this.f80ch);
