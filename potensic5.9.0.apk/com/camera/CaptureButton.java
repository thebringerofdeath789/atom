...
public class CaptureButton extends View {
    ...
    public CaptureButton(Context context, int i) {
        ...
        DDLog.m1687i("CaptureButtom start");
        this.duration = 10000;
        DDLog.m1687i("CaptureButtom end");
    ...
    private void resetRecordAnim() {
        this.state = 5;
        this.progress = 0.0f;
        DDLog.m1684e("录制resetRecordAnim1111111111");
        invalidate();
        DDLog.m1684e("录制resetRecordAnim22222");
