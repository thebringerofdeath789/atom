...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    /* renamed from: sm */
    private SensorManager f1818sm = null;
    ...
    public void setZoom(float f, int i) {
        ...
        if (this.mParams.isZoomSupported() && this.mParams.isSmoothZoomSupported()) {
            ...
            if (i == 145 && !this.isRecorder) {
                ...
                DDLog.m1687i("setZoom = " + this.nowScaleRate);
            }
        }
    }
    ...
    public void doStartPreview(SurfaceHolder surfaceHolder, float f) {
        ...
        if (camera != null) {
            try {
                ...
                DDLog.m1684e("previewSize width:" + this.preview_width);
                DDLog.m1684e("previewSize height:" + this.preview_height);
                ...
                DDLog.m1684e("开启预览报错:" + e.getMessage());
            }
        }
    }
        ...
        if (camera != null) {
            try {
                ...
                try {
                    ...
                    DDLog.m1684e("停止预览报错:" + e.getMessage());
                }
                this.isPreviewing = false;
                Log.i(TAG, "=== Stop Preview ===");
            } catch (Exception e2) {
                DDLog.m1684e("停止预览报错1:" + e2.getMessage());
            }
        }
    }
    ...
    public void takePicture(final TakePictureCallback takePictureCallback) {
        ...
        try {
            ...
            DDLog.m1684e("拍照报错:" + e.getMessage());
        }
    }
    ...
    public void stopRecord(final boolean z, final StopRecordCallback stopRecordCallback) {
        if (this.isRecorder) {
            DDLog.m1684e("录像 当前线程：" + (Looper.getMainLooper() == Looper.myLooper()));
            ...
            if (mediaRecorder != null) {
                ...
                PhoneConfig.threadPool.execute(new Runnable() { // from class: com.camera.CameraInterface.3
                    ...
                    /* JADX WARN: Code restructure failed: missing block: B:6:0x001f, code lost:
                        ...
                        com.ipotensic.baselib.DDLog.m1684e("录制停止2");
                        r7.this$0.mediaRecorder.release();
                        com.ipotensic.baselib.DDLog.m1684e("录制停止3");
                     */
                    ...
                    */
                    public void run() {
                        /*
                            ...
                            com.ipotensic.baselib.DDLog.m1684e(r4)     // Catch: java.lang.Throwable -> L39 java.lang.Exception -> L3c
                            ...
                            if (r4 == 0) goto L2e
                        L1f:
                            com.ipotensic.baselib.DDLog.m1684e(r1)
                            ...
                            r1.release()
                            com.ipotensic.baselib.DDLog.m1684e(r0)
                        L2e:
                        ...
                        L3c:
                            ...
                            com.ipotensic.baselib.DDLog.m1684e(r5)     // Catch: java.lang.Throwable -> L39
                        ...
                        Ld4:
                            ...
                            throw r4
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.camera.CameraInterface.RunnableC08103.run():void");
                    }
                });
            }
        }
    ...
    void registerSensorManager(Context context) {
        if (this.f1818sm == null) {
            this.f1818sm = (SensorManager) context.getSystemService("sensor");
        }
        SensorManager sensorManager = this.f1818sm;
    ...
    void unregisterSensorManager(Context context) {
        ...
        this.f1818sm.unregisterListener(this.sensorEventListener);
    }
