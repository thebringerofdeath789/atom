...
public class JCameraView extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder.Callback, CameraView {
    ...
    public JCameraView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C0832R.styleable.JCameraView, i, 0);
        this.iconSize = obtainStyledAttributes.getDimensionPixelSize(C0832R.styleable.JCameraView_iconSize, (int) TypedValue.applyDimension(2, 35.0f, getResources().getDisplayMetrics()));
        this.iconMargin = obtainStyledAttributes.getDimensionPixelSize(C0832R.styleable.JCameraView_iconMargin, (int) TypedValue.applyDimension(2, 15.0f, getResources().getDisplayMetrics()));
        this.iconSrc = obtainStyledAttributes.getResourceId(C0832R.styleable.JCameraView_iconSrc, C0832R.drawable.ic_camera);
        this.iconLeft = obtainStyledAttributes.getResourceId(C0832R.styleable.JCameraView_iconLeft, 0);
        this.iconRight = obtainStyledAttributes.getResourceId(C0832R.styleable.JCameraView_iconRight, 0);
        this.duration = obtainStyledAttributes.getInteger(C0832R.styleable.JCameraView_duration_max, 10000);
    ...
    private void initView() {
        ...
        View inflate = LayoutInflater.from(this.mContext).inflate(C0832R.layout.camera_view, this);
        this.mVideoView = (VideoView) inflate.findViewById(C0832R.id.video_preview);
        this.mPhoto = (ImageView) inflate.findViewById(C0832R.id.image_photo);
        ImageView imageView = (ImageView) inflate.findViewById(C0832R.id.image_switch);
        this.mSwitchCamera = imageView;
        imageView.setImageResource(this.iconSrc);
        CaptureLayout captureLayout = (CaptureLayout) inflate.findViewById(C0832R.id.capture_layout);
        ...
        this.mFoucsView = (FoucsView) inflate.findViewById(C0832R.id.fouce_view);
        ...
        this.mCaptureLayout.setTypeListener(new TypeListener() { // from class: com.camera.JCameraView.3
            ...
            public void cancel() {
                DDLog.m1684e("录像 取消mCaptureLayout");
    ...
    public void onResume() {
        DDLog.m1687i("JCameraView onResume");
        resetState(4);
    ...
    public void onPause() {
        DDLog.m1687i("JCameraView onPause");
        stopVideo();
        resetState(1);
    ...
    public void surfaceCreated(SurfaceHolder surfaceHolder) {
        DDLog.m1687i("JCameraView SurfaceCreated");
    ...
    public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
        DDLog.m1687i("JCameraView SurfaceDestroyed");
        ...
        new Thread(new Runnable() { // from class: com.camera.JCameraView.8
            ...
            public void run() {
                try {
                    ...
                    DDLog.m1684e("播放出错：" + e.getMessage());
                }
            }
        }).start();
    }
    ...
    public void startPreviewCallback() {
        DDLog.m1687i("startPreviewCallback");
