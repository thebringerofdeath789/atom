...
public final class ViewLoginRegisterBinding implements ViewBinding {
    ...
    public static ViewLoginRegisterBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.view_login_register, viewGroup, false);
        if (z) {
            ...
            if (checkBox != null) {
                ...
                if (constraintLayout != null) {
                    ...
                    if (constraintLayout2 != null) {
                        ...
                        EditText editText = (EditText) view.findViewById(R.id.edit_register_password);
                        if (editText != null) {
                            i = R.id.edit_register_username;
                            EditText editText2 = (EditText) view.findViewById(R.id.edit_register_username);
                            if (editText2 != null) {
                                i = R.id.tv_choose_country;
                                TextView textView = (TextView) view.findViewById(R.id.tv_choose_country);
                                if (textView != null) {
                                    i = R.id.tv_code_title;
                                    TextView textView2 = (TextView) view.findViewById(R.id.tv_code_title);
                                    if (textView2 != null) {
                                        i = R.id.tv_email_error_tips;
                                        TextView textView3 = (TextView) view.findViewById(R.id.tv_email_error_tips);
                                        if (textView3 != null) {
                                            i = R.id.tv_login;
                                            TextView textView4 = (TextView) view.findViewById(R.id.tv_login);
                                            if (textView4 != null) {
                                                i = R.id.tv_logo;
                                                TextView textView5 = (TextView) view.findViewById(R.id.tv_logo);
                                                if (textView5 != null) {
                                                    i = R.id.tv_password_error_tips;
                                                    TextView textView6 = (TextView) view.findViewById(R.id.tv_password_error_tips);
                                                    if (textView6 != null) {
                                                        i = R.id.tv_user_agreement_content;
                                                        TextView textView7 = (TextView) view.findViewById(R.id.tv_user_agreement_content);
                                                        if (textView7 != null) {
