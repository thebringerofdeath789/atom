...
public final class ActivityFeedbackBinding implements ViewBinding {
    ...
    public static ActivityFeedbackBinding bind(View view) {
        int i = R.id.btn_tell_us;
        Button button = (Button) view.findViewById(R.id.btn_tell_us);
        if (button != null) {
            i = R.id.et_content;
                        ...
                        if (imageView3 != null) {
                            ...
                            if (linearLayout != null) {
                                ...
                                if (findViewById != null) {
                                    ...
                                    HorizontalPhotosView horizontalPhotosView = (HorizontalPhotosView) view.findViewById(R.id.recycler_view);
                                        ...
                                        if (toolbar != null) {
                                            ...
                                            if (textView != null) {
                                                ...
                                                if (textView2 != null) {
                                                    ...
                                                    TextView textView3 = (TextView) view.findViewById(R.id.tv_contact_us);
                                                    if (textView3 != null) {
                                                        i = R.id.tv_description;
                                                        TextView textView4 = (TextView) view.findViewById(R.id.tv_description);
                                                        if (textView4 != null) {
                                                            i = R.id.tv_num_tip;
                                                            TextView textView5 = (TextView) view.findViewById(R.id.tv_num_tip);
                                                            if (textView5 != null) {
                                                                i = R.id.tv_upload_num;
                                                                TextView textView6 = (TextView) view.findViewById(R.id.tv_upload_num);
                                                                if (textView6 != null) {
