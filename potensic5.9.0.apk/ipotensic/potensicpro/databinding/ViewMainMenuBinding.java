            ...
            if (group != null) {
                ...
                if (group2 != null) {
                    ...
                    if (imageView != null) {
                        ...
                        TextView textView = (TextView) view.findViewById(R.id.tv_aircraft_log_atom);
                        if (textView != null) {
                            i = R.id.tv_flight_log;
                            TextView textView2 = (TextView) view.findViewById(R.id.tv_flight_log);
                            if (textView2 != null) {
                                i = R.id.tv_flight_record;
                                TextView textView3 = (TextView) view.findViewById(R.id.tv_flight_record);
                                if (textView3 != null) {
                                    i = R.id.tv_flight_record_atom;
                                    TextView textView4 = (TextView) view.findViewById(R.id.tv_flight_record_atom);
                                    if (textView4 != null) {
                                        i = R.id.tv_instructions;
                                        TextView textView5 = (TextView) view.findViewById(R.id.tv_instructions);
                                        if (textView5 != null) {
                                            i = R.id.tv_quick_guide;
                                            TextView textView6 = (TextView) view.findViewById(R.id.tv_quick_guide);
                                            if (textView6 != null) {
                                                i = R.id.tv_video_teach;
                                                TextView textView7 = (TextView) view.findViewById(R.id.tv_video_teach);
                                                if (textView7 != null) {
