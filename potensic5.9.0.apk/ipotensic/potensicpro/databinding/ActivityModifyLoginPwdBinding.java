...
public final class ActivityModifyLoginPwdBinding implements ViewBinding {
    ...
    public static ActivityModifyLoginPwdBinding bind(View view) {
        ...
        if (button != null) {
            ...
            if (imageButton != null) {
                i = R.id.et_confirm_new_pwd;
                EditText editText = (EditText) view.findViewById(R.id.et_confirm_new_pwd);
                if (editText != null) {
                    i = R.id.et_new_pwd;
                    ...
                    if (editText2 != null) {
                        ...
                        if (editText3 != null) {
                            i = R.id.tv_pwd_error_tips_1;
                            TextView textView = (TextView) view.findViewById(R.id.tv_pwd_error_tips_1);
                            if (textView != null) {
                                i = R.id.tv_pwd_error_tips_2;
                                TextView textView2 = (TextView) view.findViewById(R.id.tv_pwd_error_tips_2);
                                if (textView2 != null) {
                                    i = R.id.tv_pwd_error_tips_3;
                                    TextView textView3 = (TextView) view.findViewById(R.id.tv_pwd_error_tips_3);
                                    if (textView3 != null) {
