...
public class MainDeviceController extends BaseController implements View.OnClickListener, AOAEngine.IEngineCallback, OnGuideChangedListener, OnLocationChangedListener {
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        int i = AnonymousClass18.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()];
        if (i == 1) {
    ...
    /* renamed from: com.ipotensic.potensicpro.activities.MainDeviceController$18, reason: invalid class name */
    ...
    public /* synthetic */ void lambda$showItemsGuide$8$MainDeviceController() {
        ...
        if (FlightConfig.is_Atom_Series()) {
            onGuideChangedListener.addGuidePage(getDefaultGuidePage().addHighLight(this.tvFlightRecordAtom, new RelativeGuide(R.layout.guide_view_main_top_left, GravityCompat.START, 0, UnitUtil.dp2px(32), 0, 0, 0)).setOnLayoutInflatedListener(new OnLayoutInflatedListener() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$MainDeviceController$2T0bUPL3cBl5xi7TOp2c3Q5LHdM
                @Override // com.ipotensic.baselib.guide.listener.OnLayoutInflatedListener
                public final void onLayoutInflated(View view, Controller controller) {
    ...
    private void setOnClickListener(View view) {
        ...
        view.findViewById(R.id.tv_check_upgrade).setOnClickListener(new ScaleClickListener() { // from class: com.ipotensic.potensicpro.activities.MainDeviceController.13
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view2) {
    ...
    /* renamed from: com.ipotensic.potensicpro.activities.MainDeviceController$15, reason: invalid class name */
    class AnonymousClass15 implements SimpleResultListener<Boolean> {
        AnonymousClass15() {
        }
    ...
    public void startKernelActivity() {
        hideMenu();
        checkPermission(new AnonymousClass15());
    }

    @Override // android.view.View.OnClickListener
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_menu /* 2131296420 */:
                controlMenuView(true);
                break;
            case R.id.btn_menu_close /* 2131296421 */:
            case R.id.iv_close_atom /* 2131296761 */:
            case R.id.view_blank /* 2131297917 */:
                if (!isGuideShow()) {
    ...
    */
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i == 101 && intent != null) {
            boolean booleanExtra = intent.getBooleanExtra("isDownloadEnd", false);
            this.tvCheckUpgrade.setText(getContext().getString(booleanExtra ? R.string.download_finish : R.string.upgrade_check));
            this.tvCheckUpgrade.setEnabled(!booleanExtra);
            return;
        }
        String lastFlightModel = FlightConfig.getLastFlightModel();
        if (FlightConfig.isConnectFlight() && lastFlightModel != null) {
            showMenuGuidePage();
            return;
        }
        if (lastFlightModel == null) {
            toTeach();
        }
        if (i == 102) {
            if (intent != null) {
                try {
                    ...
                    if (stringExtra != null) {
                        ...
                        while (true) {
                            ...
                            Flight flight = values[i3];
                            if (flight.getFlightTypeString().equals(stringExtra)) {
                                break;
                            } else {
                                i3++;
                            }
