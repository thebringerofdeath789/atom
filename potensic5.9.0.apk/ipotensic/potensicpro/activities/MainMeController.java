...
public class MainMeController extends BaseController implements View.OnClickListener {
    ...
    public void initView(View view) {
        ...
        view.findViewById(R.id.btn_cancel_account).setOnClickListener(this);
        ...
        circleImageView.setBorderColor(getContext().getResources().getColor(R.color.color_full_white));
    ...
    private void setOnClickListener(View view) {
        ...
        this.tvNickName.setOnClickListener(new ScaleClickListener(i) { // from class: com.ipotensic.potensicpro.activities.MainMeController.1
            ...
            public void click(View view2) {
                MainMeController.this.tvNickName.setBackground(MainMeController.this.getContext().getDrawable(R.drawable.bg_nick_name_selected));
                ...
                ToastUtil.toast(MainMeController.this.getContext(), MainMeController.this.getContext().getString(R.string.account_copy_successfully));
        ...
        view.findViewById(R.id.img_account_eidt).setOnClickListener(new ScaleClickListener(i) { // from class: com.ipotensic.potensicpro.activities.MainMeController.3
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view2) {
                MainMeController.this.getContext().startActivityForResult(new Intent(MainMeController.this.getContext(), (Class<?>) NickNameActivity.class), 100);
            }
        });
        view.findViewById(R.id.tv_feedback).setOnClickListener(new ScaleClickListener(i) { // from class: com.ipotensic.potensicpro.activities.MainMeController.4
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view2) {
                MainMeController.this.getContext().startActivity(new Intent(MainMeController.this.getContext(), (Class<?>) FeedbackActivity.class));
            }
        });
        view.findViewById(R.id.tv_user_agreement).setOnClickListener(new ScaleClickListener(i) { // from class: com.ipotensic.potensicpro.activities.MainMeController.5
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view2) {
        ...
        view.findViewById(R.id.tv_modify_login_pwd).setOnClickListener(new ScaleClickListener(i) { // from class: com.ipotensic.potensicpro.activities.MainMeController.6
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view2) {
        ...
        view.findViewById(R.id.tv_find_my_drone).setOnClickListener(new ScaleClickListener(i) { // from class: com.ipotensic.potensicpro.activities.MainMeController.7
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view2) {
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.btn_cancel_account) {
            if (PhoneConfig.usrToken != null) {
                new GeneralDialog(this.activity, getContext().getString(R.string.main_me_cancel_account_title), getContext().getString(R.string.main_me_cancel_account_content), new GeneralDialog.DialogListener() { // from class: com.ipotensic.potensicpro.activities.MainMeController.11
                        ...
                        if (PhoneConfig.usrToken != null) {
                            ...
                            OkHttpUtil.getInstance().postJson(110, UserConstants.URL_APP_CANCEL_ACCOUNT, jSONObject.toString(), new CallBackString<Integer>() { // from class: com.ipotensic.potensicpro.activities.MainMeController.11.1
                                ...
                                public void onResponse(int i, Integer num) {
                                    ...
                                    ToastUtil.toast(MainMeController.this.activity, MainMeController.this.activity.getString(R.string.toast_no_network));
                                }
            ...
            if (id != R.id.btn_logout) {
                if (id == R.id.tv_reset_guidelines) {
                    new GeneralDialog(this.activity, getContext().getString(R.string.dialog_reset_guidelines), getContext().getString(R.string.dialog_reset_guidelines_describe), new GeneralDialog.DialogListener() { // from class: com.ipotensic.potensicpro.activities.MainMeController.10
                        @Override // com.ipotensic.kernel.view.dialog.GeneralDialog.DialogListener
                        public void cancel() {
                        }
            ...
            if (PhoneConfig.usrToken != null) {
                new GeneralDialog(this.activity, getContext().getString(R.string.dialog_confirm_out), getContext().getString(R.string.dialog_confirm_out_describe), new GeneralDialog.DialogListener() { // from class: com.ipotensic.potensicpro.activities.MainMeController.9
                    @Override // com.ipotensic.kernel.view.dialog.GeneralDialog.DialogListener
                    public void cancel() {
                    }
    ...
    public void onLoginLoadHeadImg() {
        try {
            ...
            PhoneConfig.threadPool.execute(new Runnable() { // from class: com.ipotensic.potensicpro.activities.MainMeController.13
                ...
                public void run() {
                    try {
                        DDLog.w("LoginSuccess", "download head img:" + PhoneConfig.usrToken.getAvatar());
