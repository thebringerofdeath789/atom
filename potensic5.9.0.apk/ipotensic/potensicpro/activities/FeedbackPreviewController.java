...
public class FeedbackPreviewController extends BaseController {
    ...
    /* renamed from: com.ipotensic.potensicpro.activities.FeedbackPreviewController$1 */
    ...
    /* renamed from: com.ipotensic.potensicpro.activities.FeedbackPreviewController$2 */
    class AnonymousClass2 implements LooperViewPager.OnPageChangeListener {
        @Override // com.ipotensic.baselib.views.LooperViewPager.OnPageChangeListener
        public void onPageScrollStateChanged(int i2) {
        }
    ...
    /* renamed from: com.ipotensic.potensicpro.activities.FeedbackPreviewController$3 */
    ...
    private class LoopPagerAdapter extends PagerAdapter {
        ...
        /* synthetic */ LoopPagerAdapter(FeedbackPreviewController feedbackPreviewController, AnonymousClass1 anonymousClass1) {
            this();
        }
        ...
        public Object instantiateItem(ViewGroup viewGroup, int i) {
            ...
            if (FeedbackPreviewController.this.curPosition < FeedbackPreviewController.this.sources.size() && i < FeedbackPreviewController.this.sources.size()) {
                AlbumItem albumItem = (AlbumItem) FeedbackPreviewController.this.sources.get(i);
                if (albumItem != null && albumItem.url != null) {
                    if (!albumItem.isVideo) {
                        ...
                        photoView4.setOnClickListener(new ScaleClickListener() { // from class: com.ipotensic.potensicpro.activities.FeedbackPreviewController.LoopPagerAdapter.1
                            final /* synthetic */ AlbumItem val$item;

                            AnonymousClass1(AlbumItem albumItem2) {
                                r2 = albumItem2;
                            }

                            @Override // com.ipotensic.baselib.listener.ScaleClickListener
                            public void click(View view2) {
                                FeedbackPreviewController.this.playVideo(r2.url);
                            }
                        });
                        if (TextUtils.isEmpty(albumItem2.videoThumbnailUrl)) {
                            MediaRetriever.withVideo(albumItem2.url).thumbnailType(2).metaKeys(null).into(photoView3);
                            photoView = relativeLayout;
                        } else {
                            PicassoLoader.with(FeedbackPreviewController.this.getContext()).load(albumItem2.videoThumbnailUrl).into(photoView3);
                            photoView = relativeLayout;
                        }
                    }
                    view = photoView;
        ...
        /* renamed from: com.ipotensic.potensicpro.activities.FeedbackPreviewController$LoopPagerAdapter$1 */
        ...
        /* renamed from: com.ipotensic.potensicpro.activities.FeedbackPreviewController$LoopPagerAdapter$2 */
    ...
    /* renamed from: com.ipotensic.potensicpro.activities.FeedbackPreviewController$4 */
    class AnonymousClass4 implements VideoView.OnStateChangeListener {
        @Override // xyz.doikki.videoplayer.player.VideoView.OnStateChangeListener
        public void onPlayerStateChanged(int i) {
        }
