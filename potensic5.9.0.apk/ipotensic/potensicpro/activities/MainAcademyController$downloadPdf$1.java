...
final class MainAcademyController$downloadPdf$1 implements Runnable {
    ...
    public final void run() {
        ...
        try {
            ...
            okHttpUtil.downloadFileSync(1000, str3, pdf_dir, str2, System.currentTimeMillis(), new AnonymousClass1());
        } catch (Exception e) {
            str = this.this$0.TAG;
            DDLog.e(str, "downloadPdf..." + e);
        }
    }
    ...
    /* renamed from: com.ipotensic.potensicpro.activities.MainAcademyController$downloadPdf$1$1, reason: invalid class name */
    public static final class AnonymousClass1 implements DownloadListener {
        ...
        public void onDownloadProgress(float progress, long total) {
            String str;
            str = MainAcademyController$downloadPdf$1.this.this$0.TAG;
            DDLog.e(str, "onDownloadProgress......" + progress + PropertyUtils.INDEXED_DELIM + total + PropertyUtils.INDEXED_DELIM2);
        }
        ...
        public void onDownloadEnd(String filePath) {
            String str;
            str = MainAcademyController$downloadPdf$1.this.this$0.TAG;
            DDLog.e(str, "onDownloadFinished......");
