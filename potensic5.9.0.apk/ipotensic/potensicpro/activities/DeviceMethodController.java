...
public class DeviceMethodController extends BaseController implements View.OnClickListener {
    ...
    private void initData() {
        ...
        if (this.flightType.equalsIgnoreCase(FlightConfig.MODEL_ATOM_LT)) {
            ...
            GuideItem guideItem12 = new GuideItem(1, getContext().getString(R.string.guide_title_install_teach), R.drawable.img_gif_step2_atomlt, getContext().getString(R.string.atom_lt_homepage_drone_guidelines_tips1) + "\n\n" + getContext().getString(R.string.atom_lt_homepage_drone_guidelines_tips2) + "\n\n" + getContext().getString(R.string.atom_lt_homepage_drone_guidelines_tips3), R.mipmap.img_step2_mini);
