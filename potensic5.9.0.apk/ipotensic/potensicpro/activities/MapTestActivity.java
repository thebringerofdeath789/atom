...
public class MapTestActivity extends Activity {
    ...
    public Bitmap getBlueMarkWithIndex(String str) {
        View inflate = LayoutInflater.from(this).inflate(R.layout.view_layout_test_map_mark, (ViewGroup) null);
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.mapView.addOnDidFailLoadingMapListener(new MapView.OnDidFailLoadingMapListener() { // from class: com.ipotensic.potensicpro.activities.MapTestActivity.2
            ...
            public void onDidFailLoadingMap(String str) {
                DDLog.e("mapbox load failed :" + str);
            }
        });
        this.mapView.addOnCameraDidChangeListener(new MapView.OnCameraDidChangeListener() { // from class: com.ipotensic.potensicpro.activities.MapTestActivity.3
            ...
            public void onCameraDidChange(boolean z) {
                DDLog.e("mapbox onCameraDidChange");
        ...
        findViewById(R.id.toSmall).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.potensicpro.activities.MapTestActivity.5
        ...
        findViewById(R.id.toBig).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.potensicpro.activities.MapTestActivity.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                MapTestActivity mapTestActivity = MapTestActivity.this;
    ...
    public void animToBig(final View view, final Animation.AnimationListener animationListener) {
        try {
            ...
            layoutParams.leftMargin = getResources().getDimensionPixelSize(R.dimen.kernel_map_left_margin);
            layoutParams.bottomMargin = getResources().getDimensionPixelSize(R.dimen.kernel_map_bottom_margin);
            layoutParams.bottomToBottom = 0;
            layoutParams.leftToLeft = 0;
            final int i = layoutParams.leftMargin;
            final int i2 = layoutParams.bottomMargin;
            TypedValue typedValue = new TypedValue();
            getResources().getValue(R.dimen.kernel_map_height_percent, typedValue, true);
    ...
    public Polyline addLine(MapboxMap mapboxMap, ArrayList<LatLng> arrayList) {
        return mapboxMap.addPolyline(new PolylineOptions().addAll(arrayList).color(ContextCompat.getColor(this, R.color.red)).alpha(0.5f).width(2.0f));
    }

    public Polyline addBlueLine(MapboxMap mapboxMap, ArrayList<LatLng> arrayList) {
        return mapboxMap.addPolyline(new PolylineOptions().addAll(arrayList).color(ContextCompat.getColor(this, R.color.mapbox_blue)).alpha(0.5f).width(2.0f));
    }
}