...
public final class MainAcademyController extends BaseController {
    ...
    public void initView(View baseView) {
        ...
        if (str != null) {
            ...
            ToastUtil.toast(appCompatActivity, appCompatActivity.getString(R.string.toast_no_network));
        }
    }

    private final void initWebSettings(View baseView) {
        View findViewById = baseView.findViewById(R.id.title_view);
        ...
        View findViewById2 = baseView.findViewById(R.id.img_loading);
        ...
        View findViewById3 = baseView.findViewById(R.id.fl_video);
        ...
        FrameLayout frameLayout = (FrameLayout) baseView.findViewById(R.id.ll_container);
        WebView webView = this.webView;
        if (webView == null) {
            Intrinsics.throwUninitializedPropertyAccessException("webView");
        }
        ...
        titleView.setTitle(this.activity.getString(R.string.guide_homepage_academy_title));
        ...
        webView6.setWebChromeClient(new WebChromeClient() { // from class: com.ipotensic.potensicpro.activities.MainAcademyController$initWebSettings$4
            ...
            public void onReceivedTitle(WebView view, String title) {
                ...
                DDLog.d(str, "onReceivedTitle---" + title);
        ...
        webView7.setWebViewClient(new WebViewClient() { // from class: com.ipotensic.potensicpro.activities.MainAcademyController$initWebSettings$5
            ...
            public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
                ...
                str = MainAcademyController.this.TAG;
                DDLog.e(str, "[onReceivedError]" + String.valueOf(error));
            }
            ...
            public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
                ...
                str = MainAcademyController.this.TAG;
                DDLog.e(str, "[onReceivedSslError]" + String.valueOf(error));
            }
        });
    }
    ...
    public final void onConfigurationChanged(Configuration newConfig) {
        ...
        try {
            DDLog.d(this.TAG, "[onConfigurationChanged]" + newConfig.orientation);
    ...
    public final void loadPdf(String url) {
        try {
            ...
            DDLog.d(this.TAG, "fileName=" + this.fileName);
    ...
    public final void jsMethod(String params) {
        ...
        DDLog.d(this.TAG, "jsMethod---" + params);
    }
