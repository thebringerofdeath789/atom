...
public class ConnectStateView extends RelativeLayout implements EventDispatcher.OnEventListener, View.OnClickListener {
    ...
    public void setSearchState() {
        ...
        this.tvBottom.setText(getContext().getString(R.string.connect_state_check));
        this.imgTopOut.setImageResource(R.mipmap.img_icon_connect_state_check);
    ...
    protected void onDetachedFromWindow() {
        ...
        DDLog.e("onDetachedFromWindow  6666");
    }
    ...
    public void setState(State state) {
        ...
        this.mainHandler.post(new Runnable() { // from class: com.ipotensic.potensicpro.view.ConnectStateView.2
            ...
            public void run() {
                switch (AnonymousClass3.$SwitchMap$com$ipotensic$baselib$enums$State[ConnectStateView.this.state.ordinal()]) {
                    case 1:
                        ConnectStateView.this.imgConnectStatus.setImageResource(R.mipmap.img_usb_connect_status0);
                        break;
                    case 2:
                        ConnectStateView.this.imgConnectStatus.setImageResource(R.mipmap.img_usb_connect_status0);
                        break;
                    case 3:
                        ConnectStateView.this.imgConnectStatus.setImageResource(R.mipmap.img_usb_connect_status1);
                        break;
                    case 4:
                    case 5:
                        ConnectStateView.this.imgConnectStatus.setImageResource(R.mipmap.img_usb_connect_status2);
                        break;
                    case 6:
                        ConnectStateView.this.imgConnectStatus.setImageResource(R.mipmap.img_wifi_connect_status0);
                        break;
                    case 7:
                        ConnectStateView.this.imgConnectStatus.setImageResource(R.mipmap.img_wifi_connect_status0);
                        break;
                    case 8:
                        ConnectStateView.this.imgConnectStatus.setImageResource(R.mipmap.img_wifi_connect_status1);
                        break;
                    case 9:
                        ConnectStateView.this.imgConnectStatus.setImageResource(R.mipmap.img_wifi_connect_status2);
                        break;
                }
    ...
    /* renamed from: com.ipotensic.potensicpro.view.ConnectStateView$3, reason: invalid class name */
