...
public class BottomItemView extends AppCompatTextView {
    ...
    public BottomItemView(Context context) {
        super(context);
        this.selectedTextColor = context.getResources().getColor(R.color.color_main_tab_blue);
        this.normalTextColor = context.getResources().getColor(R.color.color_full_black);
    }
