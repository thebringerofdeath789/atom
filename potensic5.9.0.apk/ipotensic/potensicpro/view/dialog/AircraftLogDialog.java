...
public class AircraftLogDialog extends BaseDialog {
    ...
    public AircraftLogDialog(Context context, OnClickListener onClickListener) {
        super(context, R.layout.view_dialog_aircraft_log);
    ...
    protected void initView(Context context) {
        ...
        final EditText editText2 = (EditText) findViewById(R.id.et_feedback);
        findViewById(R.id.btn_close).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.potensicpro.view.dialog.AircraftLogDialog.1
        ...
        findViewById(R.id.btn_finish).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.potensicpro.view.dialog.AircraftLogDialog.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                AircraftLogDialog.this.dismiss();
