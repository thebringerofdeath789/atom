...
public final class ErrorCode {
    ...
    static {
        int i = 0;
        ErrorCode errorCode = new ErrorCode("UNOWNED", 0, WarnErrorType.WARN_NORMAL, 0L, TipPriority.NONE, 0, 0, 0, false, i, TelnetCommand.EL, null);
        UNOWNED = errorCode;
        ErrorCode errorCode2 = new ErrorCode("NOFLY_FORCED_LANDING_PROGRESS", 1, WarnErrorType.WARN_LONGSHOW, 0L, TipPriority.HIGH, R.string.toast_no_fly_zone_drone_is_forced_landing, R.string.toast_no_fly_zone_drone_is_forced_landing, 0, false, 0, 224, null);
        ...
        ErrorCode errorCode3 = new ErrorCode("NOFLY_FORCED_RETURN_PROGRESS", 2, WarnErrorType.WARN_LONGSHOW, j, TipPriority.HIGH, R.string.toast_approaching_the_no_fly_zone, R.string.toast_approaching_the_no_fly_zone, i, z, i2, i3, defaultConstructorMarker);
        NOFLY_FORCED_RETURN_PROGRESS = errorCode3;
        ErrorCode errorCode4 = new ErrorCode("ALTITUDE_EXCEEDED_HEIGHT_LIMIT", 3, WarnErrorType.WARN_LONGSHOW, j, TipPriority.HIGH, R.string.toast_the_drone_has_exceeded_the_maximum_altitude_limit_in_the_altitude_restricted_area, R.string.toast_the_drone_has_exceeded_the_maximum_altitude_limit_in_the_altitude_restricted_area, i, z, i2, i3, defaultConstructorMarker);
