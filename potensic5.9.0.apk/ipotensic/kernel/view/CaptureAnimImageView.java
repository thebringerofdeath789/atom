...
public class CaptureAnimImageView extends ImageView {
    ...
    public void show(Bitmap bitmap, View view) {
        ...
        setVisibility(0);
        postDelayed(new AnonymousClass3(view), 100L);
    }

    /* renamed from: com.ipotensic.kernel.view.CaptureAnimImageView$3, reason: invalid class name */
        ...
        class AnonymousClass1 implements Runnable {
            ...
            public void run() {
                CaptureAnimImageView.this.postDelayed(new Runnable() { // from class: com.ipotensic.kernel.view.CaptureAnimImageView.3.1.1
                    @Override // java.lang.Runnable
                    public void run() {
                        AnonymousClass3.this.val$endView.getGlobalVisibleRect(new Rect());
                        CaptureAnimImageView.this.animate().scaleX(0.05f).scaleY(0.05f).translationXBy((r0.left + (AnonymousClass3.this.val$endView.getWidth() / 2)) - CaptureAnimImageView.this.getPivotX()).translationYBy((r0.top + (AnonymousClass3.this.val$endView.getHeight() / 2)) - CaptureAnimImageView.this.getPivotY()).setDuration(300L).withEndAction(new Runnable() { // from class: com.ipotensic.kernel.view.CaptureAnimImageView.3.1.1.1
                            @Override // java.lang.Runnable
                            public void run() {
