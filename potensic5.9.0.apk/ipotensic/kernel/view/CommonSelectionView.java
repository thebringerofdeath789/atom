...
public class CommonSelectionView extends RelativeLayout {
    ...
    public CommonSelectionView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        init(context);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.CommonSelectionView);
        this.singleSelection = obtainStyledAttributes.getBoolean(R.styleable.CommonSelectionView_singleSelection, true);
        String string = obtainStyledAttributes.getString(R.styleable.CommonSelectionView_childText1);
        String string2 = obtainStyledAttributes.getString(R.styleable.CommonSelectionView_childText2);
        String string3 = obtainStyledAttributes.getString(R.styleable.CommonSelectionView_childText3);
        String string4 = obtainStyledAttributes.getString(R.styleable.CommonSelectionView_childText4);
        String string5 = obtainStyledAttributes.getString(R.styleable.CommonSelectionView_childText5);
        String string6 = obtainStyledAttributes.getString(R.styleable.CommonSelectionView_childText6);
    ...
    private void init(Context context) {
        this.radioGroup = (RadioGroup) View.inflate(context, R.layout.view_common_selection_view, this).findViewById(R.id.rg);
    }
    ...
    private void addTextView(final int i, String str, int i2) {
        ...
        drawableTextView.setTextColor(ContextCompat.getColor(getContext(), R.color.white));
    ...
    private void addDividerLine() {
        ...
        view.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.color_gray));
    ...
    private void setCheckChildBg(View view, int i) {
        if (i == 0) {
            view.setBackground(ContextCompat.getDrawable(getContext(), R.drawable.bg_flight_setting_check_select_left));
        } else if (i == this.size - 1) {
            view.setBackground(ContextCompat.getDrawable(getContext(), R.drawable.bg_flight_setting_check_select_right));
        } else {
            view.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.colorSettingSelectBg));
        }
    }
