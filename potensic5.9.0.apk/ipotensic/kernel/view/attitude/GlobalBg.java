...
public class GlobalBg {
    ...
    public void draw(Canvas canvas) {
        this.paint.setStyle(Paint.Style.FILL);
        this.paint.setColor(this.context.getResources().getColor(R.color.color_attitude_view_bg));
        float f = this.width;
        canvas.drawCircle(f / 2.0f, this.height / 2.0f, f / 2.0f, this.paint);
        this.paint.setStyle(Paint.Style.STROKE);
        this.paint.setColor(this.context.getResources().getColor(R.color.colorGray));
