...
public class CommonSwitchView extends RelativeLayout {
    ...
    public CommonSwitchView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        boolean z = obtainStyledAttributes.getBoolean(R.styleable.CommonSwitchView_switchButtonVisible, true);
        boolean z2 = obtainStyledAttributes.getBoolean(R.styleable.CommonSwitchView_checked, false);
        boolean z3 = obtainStyledAttributes.getBoolean(R.styleable.CommonSwitchView_switchButtonEnable, true);
        ...
        int resourceId = obtainStyledAttributes.getResourceId(R.styleable.CommonSwitchView_img_src, 0);
        if (resourceId == 0) {
