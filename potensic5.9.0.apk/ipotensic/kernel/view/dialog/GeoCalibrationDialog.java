...
public class GeoCalibrationDialog extends BaseSyncDialog implements View.OnClickListener, EventDispatcher.OnEventListener {
    ...
    protected void initView(Context context) {
        ...
        this.llHorizontal = findViewById(R.id.ll_horizontal);
        this.llVertical = findViewById(R.id.ll_vertical);
        this.tvMiniGeoTips = (TextView) findViewById(R.id.tv_mini_geo_tips);
        ...
        if (lastFlight != null) {
            ...
            if (FlightConfig.is_Atom_Series()) {
                ...
                this.tvMiniGeoTips.setText(getContext().getString(R.string.setting_mini_geo_tip));
                return;
            }
            if (lastFlight == Flight.Flight_P5) {
                ...
                this.llVertical.setVisibility(8);
                this.tvMiniGeoTips.setVisibility(0);
                this.tvMiniGeoTips.setText(getContext().getString(R.string.compass_calibration_tips));
            }
        }
    }
            ...
            if (FlightConfig.is_Atom_Series()) {
                ...
                this.miniMagCalibrationHelper.setCalibrationResultListener(new OnCalibrationResultListener() { // from class: com.ipotensic.kernel.view.dialog.GeoCalibrationDialog.2
                    ...
                    public void onHorizontalCalibration() {
                        ...
                        GeoCalibrationDialog.this.tvGeoCalibrationTitle.setText(GeoCalibrationDialog.this.getContext().getString(R.string.dialog_geo_title_horizontal));
                        ...
                        GeoCalibrationDialog.this.tvContentOne.setText(GeoCalibrationDialog.this.getContext().getString(R.string.dialog_geo_horizontal_tips));
                    ...
                    public void onVerticalCalibration() {
                        ...
                        GeoCalibrationDialog.this.tvGeoCalibrationTitle.setText(GeoCalibrationDialog.this.getContext().getString(R.string.dialog_geo_title_vertical));
                        ...
                        GeoCalibrationDialog.this.tvContentTwo.setText(GeoCalibrationDialog.this.getContext().getString(R.string.dialog_geo_vertical_tips));
                    }
                    ...
                    public void onResultSuccess(MagCalibrationResult magCalibrationResult) {
                        GeoCalibrationDialog.this.isCalibrating = false;
                        ToastUtil.showImageTop((Activity) GeoCalibrationDialog.this.context, GeoCalibrationDialog.this.context.getString(R.string.toast_geo_calibration_finish), R.mipmap.icon_toast_successful);
    ...
    public /* synthetic */ void lambda$onCalibrateResult$0$GeoCalibrationDialog(int i, DialogInterface dialogInterface) {
        ...
        if (this.failedDialog == null) {
            ...
            this.failedDialog = new GeneralDialog(context, context.getString(R.string.sys_calibration_geomagnetic), str, this.context.getString(R.string.dialog_cancel), this.context.getString(R.string.dialog_ok), false, 1, new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.kernel.view.dialog.GeoCalibrationDialog.3
    ...
    public void setUpdateData(FlightRevStateData flightRevStateData) {
        ...
        if (flightRevStateData.isMagnetometerHorizontalCalibrating()) {
            if (!this.horizontalDrawable.isRunning()) {
                ...
                this.llVertical.setVisibility(8);
                this.tvContentOne.setText(getContext().getString(R.string.dialog_geo_horizontal_tips));
                this.tvMiniGeoTips.setVisibility(8);
            }
        ...
        if (flightRevStateData.isMagnetometerVerticalCalibrating()) {
            ...
            this.llHorizontal.setVisibility(8);
            this.llVertical.setVisibility(0);
            this.tvContentTwo.setText(getContext().getString(R.string.dialog_geo_vertical_tips));
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void reset() {
        DDLog.e("\u6821\u51c6\u7ed3\u679c:MagCalibrationResult reset:");
        setDialogSize();
        this.isGeoHorizontalComplete = false;
        this.isGeoVerticalComplete = false;
        this.tvGeoCalibrationTitle.setText(getContext().getString(R.string.sys_calibration_geomagnetic));
        this.horizontalDrawable.stop();
        this.verticalDrawable.stop();
        this.btnStart.setVisibility(0);
        this.ivHorizontal.setVisibility(0);
        this.ivVertical.setVisibility(8);
        this.tvContentOne.setText(getContext().getString(R.string.dialog_geo_calibration_tips_one));
        this.tvContentTwo.setText(getContext().getString(R.string.dialog_geo_calibration_tips_two));
        Flight lastFlight = FlightConfig.getLastFlight();
        if (lastFlight != null) {
        ...
        if (FlightConfig.is_Atom_Series() && isShowing()) {
            ...
            if (i == 2) {
                ...
                if (iMagCalibrationHelper3 != null) {
                    ...
                    DDLog.e("\u6821\u51c6\u7ed3\u679c\u7684\u7ed3\u679c1:" + flightRevCalResultData.toString());
                    return;
                }
                return;
            }
    ...
    /* renamed from: com.ipotensic.kernel.view.dialog.GeoCalibrationDialog$4, reason: invalid class name */
