...
public class LowPowerReturningDialog extends BaseSyncDialog {
    ...
    public LowPowerReturningDialog(Context context, ConfirmListener confirmListener) {
        super(context, R.layout.dialog_low_power_returning);
    ...
    protected void initView(Context context) {
        findViewById(R.id.btn_ok).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.view.dialog.LowPowerReturningDialog.1
