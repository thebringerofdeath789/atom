...
public class SettingGimbalCalibrationFragment extends BaseKFragment<ViewLayoutGimbalCalibrationBinding> {
    ...
    private final Handler handler = new Handler(Looper.getMainLooper()) { // from class: com.ipotensic.kernel.fragment.calibration.SettingGimbalCalibrationFragment.1
        ...
        public void handleMessage(Message message) {
            ...
            if (i <= 0) {
                ...
                SettingGimbalCalibrationFragment.this.model.resultStr.set(SettingGimbalCalibrationFragment.this.getString(R.string.calibration_successful_wait_reboot) + "  (" + i + "s)");
    ...
    public int getLayoutId() {
        return R.layout.view_layout_gimbal_calibration;
    }
    ...
    /* renamed from: com.ipotensic.kernel.fragment.calibration.SettingGimbalCalibrationFragment$3, reason: invalid class name */
