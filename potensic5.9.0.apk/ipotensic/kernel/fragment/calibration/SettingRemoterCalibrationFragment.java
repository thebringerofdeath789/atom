...
public class SettingRemoterCalibrationFragment extends BaseKFragment<ViewLayoutRemoterControllerCalibrationBinding> implements BaseModelObservable.OnPropertyChangeListener {
    ...
    private final Handler handler = new Handler(Looper.getMainLooper()) { // from class: com.ipotensic.kernel.fragment.calibration.SettingRemoterCalibrationFragment.1
        ...
        public void handleMessage(Message message) {
            int i = message.arg1;
            ((ViewLayoutRemoterControllerCalibrationBinding) SettingRemoterCalibrationFragment.this.mBind).tvCountDown.setText(String.format(SettingRemoterCalibrationFragment.this.getString(R.string.exiting), Integer.valueOf(i)));
            if (i <= 0) {
    ...
    public int getLayoutId() {
        return R.layout.view_layout_remoter_controller_calibration;
    }
    ...
    public void onResume() {
        super.onResume();
        DDLog.e("SettingRemoteControllerCalibrationFragment", "onResume isExit" + this.isExit);
    ...
    /* renamed from: com.ipotensic.kernel.fragment.calibration.SettingRemoterCalibrationFragment$2, reason: invalid class name */
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        if (i == 1) {
            DDLog.e("SettingRemoteControllerCalibrationFragment", "\u9065\u63a7\u5668\u6821\u51c6\u7ed3\u679c: \u98de\u673a\u65ad\u5f00");
            quitAndExitActivity();
            return;
        }
        if (i != 2) {
        ...
        if (flightRevRemoterCalibrationData3 != null) {
            DDLog.e("SettingRemoteControllerCalibrationFragment", "\u9065\u63a7\u5668\u6821\u51c6\u7ed3\u679c:" + flightRevRemoterCalibrationData3.toString());
            ...
            if (flightRevRemoterCalibrationData3.isStep0() && flightRevRemoterCalibrationData3.isCalSuccess() && ((flightRevRemoterCalibrationData2 = this.remoterCalibrationData) == null || !flightRevRemoterCalibrationData2.isCalSuccess())) {
                ...
                ((ViewLayoutRemoterControllerCalibrationBinding) this.mBind).tvResultTitle.setText(R.string.calibration_successful);
            ...
            if (flightRevRemoterCalibrationData3.isCalFailed() && ((flightRevRemoterCalibrationData = this.remoterCalibrationData) == null || !flightRevRemoterCalibrationData.isCalFailed())) {
                DDLog.e("SettingRemoteControllerCalibrationFragment", "\u6307\u5357\u9488\u6821\u51c6  \u5931\u8d25");
                this.model.setCalibrationResult(true);
                ((ViewLayoutRemoterControllerCalibrationBinding) this.mBind).tvResultTitle.setText(R.string.calibration_failed);
                if (((ViewLayoutRemoterControllerCalibrationBinding) this.mBind).clCalibrationResult.getVisibility() != 0) {
                    ((ViewLayoutRemoterControllerCalibrationBinding) this.mBind).ivCalibrationResult.animate().alpha(1.0f).setDuration(100L).start();
                    ((ViewLayoutRemoterControllerCalibrationBinding) this.mBind).layoutCalStep2.setVisibility(8);
                    ((ViewLayoutRemoterControllerCalibrationBinding) this.mBind).clCalibrationResult.setVisibility(0);
        ...
        try {
            this.remoterCalibrationData = flightRevRemoterCalibrationData3.m32clone();
        } catch (Exception e) {
            DDLog.e("SettingRemoteControllerCalibrationFragment", "\u8d4b\u503c\u5931\u8d25:" + e.getMessage());
        }
    }
    ...
    private void setWheelState(FlightRevRemoterCalibrationData flightRevRemoterCalibrationData) {
        ((ViewLayoutRemoterControllerCalibrationBinding) this.mBind).imgLeftWheel.setImageResource(flightRevRemoterCalibrationData.isLeftTrackWheelCalSuccess() ? R.mipmap.img_bg_track_wheel_left_enable : R.mipmap.img_bg_track_wheel_left_disable);
        ((ViewLayoutRemoterControllerCalibrationBinding) this.mBind).imgRightWheel.setImageResource(flightRevRemoterCalibrationData.isRightTrackWheelCalSuccess() ? R.mipmap.img_bg_track_wheel_right_enable : R.mipmap.img_bg_track_wheel_right_disable);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void quitAndExitActivity() {
        DDLog.e("SettingRemoteControllerCalibrationFragment", "quitAndExitActivity");
