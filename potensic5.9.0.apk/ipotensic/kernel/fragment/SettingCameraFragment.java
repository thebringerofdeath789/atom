...
public class SettingCameraFragment extends BaseKFragment<ViewLayoutSettingCameraBinding> {
    ...
    public int getLayoutId() {
        return R.layout.view_layout_setting_camera;
    }

    /* renamed from: com.ipotensic.kernel.fragment.SettingCameraFragment$1, reason: invalid class name */
    class AnonymousClass1 implements SettingCameraModel.OnSettingCameraListener {
        AnonymousClass1() {
        }
    ...
    public void initData() {
        this.model = new SettingCameraModel(new AnonymousClass1());
        ...
        boolean z = false;
        ((ViewLayoutSettingCameraBinding) this.mBind).gridLayout.setIconItems(R.mipmap.cb_dot_unselected, R.mipmap.cb_cross_unselected, R.mipmap.cb_sharp_unselected, R.mipmap.cb_dot_select, R.mipmap.cb_cross_select, R.mipmap.cb_sharp_select);
    ...
    public boolean isTimedTakingCheck() {
        ...
        if (z) {
            ToastUtil.toast(getActivity(), getString(R.string.flight_interface_exit_self_timer_mode_before_setting_tips));
        }
        return z;
    }
    ...
    public void controlViews(boolean z) {
        DDLog.d("SettingCameraFragment", "controlViews=" + z);
        boolean z2 = false;
        if (z) {
    ...
    /* renamed from: com.ipotensic.kernel.fragment.SettingCameraFragment$6, reason: invalid class name */
