...
public class CameraSettingRightFragment extends BaseFragment {
    ...
    /* renamed from: com.ipotensic.kernel.fragment.CameraSettingRightFragment$1 */
    class AnonymousClass1 implements HorizontalWheelView.OnWheelViewListener {
        AnonymousClass1() {
        }
    ...
    private void initListener() {
        ...
        this.mBind.tvAutoWhiteBalance.setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.kernel.fragment.-$$Lambda$CameraSettingRightFragment$EnXgU2nL5HrT5HQh_G5pAWb87Ak
            public /* synthetic */ $$Lambda$CameraSettingRightFragment$EnXgU2nL5HrT5HQh_G5pAWb87Ak() {
            }
    ...
    /* renamed from: com.ipotensic.kernel.fragment.CameraSettingRightFragment$2 */
    class AnonymousClass2 implements HorizontalWheelView.OnWheelViewListener {
        AnonymousClass2() {
        }
    ...
    /* renamed from: com.ipotensic.kernel.fragment.CameraSettingRightFragment$3 */
    ...
    private void initObserver() {
        this.kernelViewModel.getSetRecordSizeSuccess().observe(this, new Observer() { // from class: com.ipotensic.kernel.fragment.-$$Lambda$CameraSettingRightFragment$6mMjyo7zwRJPZgt7qxqzERLGwUw
            public /* synthetic */ $$Lambda$CameraSettingRightFragment$6mMjyo7zwRJPZgt7qxqzERLGwUw() {
            }
    ...
    private void enableSeekbar() {
        ...
        this.mBind.sbWhiteBalance.setThumb(AppCompatResources.getDrawable(getContext(), R.mipmap.seekbar_thumb));
    }

    private void disableSeekbar() {
        this.mBind.sbWhiteBalance.setEnabled(false);
        this.mBind.tvColorTemperature.setTextColor(Color.parseColor("#999999"));
        this.mBind.sbWhiteBalance.setThumb(AppCompatResources.getDrawable(getContext(), R.mipmap.seekbar_thumb_disable));
    }
}