...
final class FriendlyTipsFragment$initObserver$2<T> implements Observer<DroneNoticeBean> {
    FriendlyTipsFragment$initObserver$2() {
    }
    ...
    public final void onChanged(DroneNoticeBean droneNoticeBean) {
        ...
        KernelViewModel kernelViewModel2;
        ...
        if (droneNoticeBean != null) {
            kernelViewModel = FriendlyTipsFragment.this.kernelViewModel;
            if (kernelViewModel == null) {
                Intrinsics.throwNpe();
            }
            if (!kernelViewModel.getLongTipList().isEmpty()) {
                kernelViewModel2 = FriendlyTipsFragment.this.kernelViewModel;
                if (kernelViewModel2 == null) {
                    Intrinsics.throwNpe();
                }
                kernelViewModel2.getLongTipList().get(0);
