...
public class SettingSecurityFragment extends BaseKFragment<ViewLayoutSettingSecurityBinding> implements SettingSecurityModel.OnSecurityListener {
    ...
    public void initListener() {
        ...
        ((ViewLayoutSettingSecurityBinding) this.mBind).csvBeginner.setListener(new CommonSwitchView.OnSwitchChangeListener() { // from class: com.ipotensic.kernel.fragment.SettingSecurityFragment.2
            ...
            public void onCheckedChanged(View view, boolean z) {
                ...
                SettingSecurityFragment.this.onToast(R.string.returning_switch_mode_unavailable);
            }
        ...
        ((ViewLayoutSettingSecurityBinding) this.mBind).cswStop.setListener(new CommonSwitchView.OnSwitchChangeListener() { // from class: com.ipotensic.kernel.fragment.SettingSecurityFragment.6
            ...
            public void onCheckedChanged(View view, boolean z) {
                if (!FlightRevData.get().getFlightRevStateData().isSupportEmergencyStop()) {
                    ToastUtil.toast(SettingSecurityFragment.this.getActivity(), SettingSecurityFragment.this.getString(R.string.toast_please_upgrade_the_drone_to_the_latest_firmware));
    ...
    public void initData() {
        ...
        this.model.showBatteryInfo.addOnPropertyChangedCallback(new AnonymousClass8());
        ((ViewLayoutSettingSecurityBinding) this.mBind).edtDistanceLimit.setInputEnable(this.model.isDistanceEnable(true));
        ViewUtils.setViewEnableWithAlpha(((ViewLayoutSettingSecurityBinding) this.mBind).seekbarDistanceLimit, this.model.isDistanceEnable(false));
    ...
    /* renamed from: com.ipotensic.kernel.fragment.SettingSecurityFragment$8, reason: invalid class name */
            ...
            if (SettingSecurityFragment.this.model.showBatteryInfo.get()) {
                ...
                ((ViewLayoutSettingSecurityBinding) SettingSecurityFragment.this.mBind).layoutSetting.post(new Runnable() { // from class: com.ipotensic.kernel.fragment.-$$Lambda$SettingSecurityFragment$8$sSJDJIskykgmwXJeeA1JSxim1V8
                    ...
                    public final void run() {
                        SettingSecurityFragment.AnonymousClass8.this.lambda$onPropertyChanged$0$SettingSecurityFragment$8();
                    }
                });
            } else {
    ...
    /* renamed from: com.ipotensic.kernel.fragment.SettingSecurityFragment$20, reason: invalid class name */
    ...
    public /* synthetic */ void lambda$initObserver$8$SettingSecurityFragment(CtrlType ctrlType) {
        int i = AnonymousClass20.$SwitchMap$com$logan$flight$enums$CtrlType[ctrlType.ordinal()];
        if (i == 1) {
    ...
    private void setUnitString() {
        ((ViewLayoutSettingSecurityBinding) this.mBind).csvBeginner.setContent(getString(R.string.settings_safety_flight_mode_beginner_mode_tips));
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        switch (AnonymousClass20.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()]) {
            case 1:
                this.model.updateFlightType();
                onFlightTypeDefine();
                setUomUIVisible();
    ...
    public void showEmergencyStopDialog() {
        if (this.emergencyStopDialog == null) {
            this.emergencyStopDialog = new GeneralDialog(getContext(), getContext().getString(R.string.popup_confirm_to_disable_emergency_propeller_stop_midflight_title), getContext().getString(R.string.popup_confirm_to_disable_emergency_propeller_stop_midflight_tips), getContext().getString(R.string.dialog_confirm), new GeneralDialog.DialogListener() { // from class: com.ipotensic.kernel.fragment.SettingSecurityFragment.16
        ...
        ((ViewLayoutSettingSecurityBinding) this.mBind).tvUomExpand.setOnClickListener(new ScaleClickListener(z) { // from class: com.ipotensic.kernel.fragment.SettingSecurityFragment.18
            ...
            public void click(View view) {
                if (((ViewLayoutSettingSecurityBinding) SettingSecurityFragment.this.mBind).layoutUomExpend.getVisibility() == 0) {
                    ...
                    ViewUtils.setDrawableRight(((ViewLayoutSettingSecurityBinding) SettingSecurityFragment.this.mBind).tvUomExpand, R.mipmap.button_arrow_unfold);
                } else {
                    ((ViewLayoutSettingSecurityBinding) SettingSecurityFragment.this.mBind).layoutUomExpend.setVisibility(0);
                    ViewUtils.setDrawableRight(((ViewLayoutSettingSecurityBinding) SettingSecurityFragment.this.mBind).tvUomExpand, R.mipmap.button_function_open);
                }
            }
        });
        SpannableString spannableString = new SpannableString(getString(R.string.uom_settings_dynamic_data_transmission_tips));
        try {
            String string = getString(R.string.uom_interim_regulations_on_the_administration_of_unmanned_aerial_vehicle_flights);
            String string2 = getString(R.string.uom_rules_for_the_operation_and_safety_management_of_civilian_unmanned_aerial_vehicles);
            String string3 = getString(R.string.uom_safety_requirements_for_civilian_unmanned_aerial_vehicle_systems);
            ...
            while (i < arrayList.size()) {
                ...
                spannableString.setSpan(new ClickableSpan() { // from class: com.ipotensic.kernel.fragment.SettingSecurityFragment.19
                    ...
                    public void updateDrawState(TextPaint textPaint) {
                        ...
                        textPaint.setColor(SettingSecurityFragment.this.requireActivity().getColor(R.color.color_dialog_blue_bg));
                    }
