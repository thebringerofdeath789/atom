...
public final class ViewLayoutSetting4Item1Binding implements ViewBinding {
    ...
    public static ViewLayoutSetting4Item1Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.view_layout_setting4_item1, viewGroup, false);
        if (z) {
    ...
    public static ViewLayoutSetting4Item1Binding bind(View view) {
        View findViewById;
        int i = R.id.battery_progress_view;
        BatteryProgressView batteryProgressView = (BatteryProgressView) view.findViewById(i);
        if (batteryProgressView != null && (findViewById = view.findViewById((i = R.id.line))) != null) {
            i = R.id.right;
            ...
            if (constraintLayout != null) {
                ...
                if (textView != null) {
                    ...
                    if (textView2 != null) {
                        ...
                        if (textView3 != null) {
                            i = R.id.tv_temperature_tips;
                            TextView textView4 = (TextView) view.findViewById(i);
                            if (textView4 != null) {
                                i = R.id.tv_voltage;
                                TextView textView5 = (TextView) view.findViewById(i);
                                if (textView5 != null) {
                                    i = R.id.tv_voltage_tips;
