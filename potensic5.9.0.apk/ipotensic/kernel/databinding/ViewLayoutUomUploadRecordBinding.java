...
public abstract class ViewLayoutUomUploadRecordBinding extends ViewDataBinding {
    ...
    public static ViewLayoutUomUploadRecordBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z, Object obj) {
        return (ViewLayoutUomUploadRecordBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.view_layout_uom_upload_record, viewGroup, z, obj);
    }
    ...
    public static ViewLayoutUomUploadRecordBinding inflate(LayoutInflater layoutInflater, Object obj) {
        return (ViewLayoutUomUploadRecordBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.view_layout_uom_upload_record, null, false, obj);
    }
    ...
    public static ViewLayoutUomUploadRecordBinding bind(View view, Object obj) {
        return (ViewLayoutUomUploadRecordBinding) bind(obj, view, R.layout.view_layout_uom_upload_record);
    }
}