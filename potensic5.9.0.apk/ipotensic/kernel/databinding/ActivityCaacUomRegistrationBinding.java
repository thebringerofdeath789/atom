...
public final class ActivityCaacUomRegistrationBinding implements ViewBinding {
    ...
    public static ActivityCaacUomRegistrationBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.activity_caac_uom_registration, viewGroup, false);
        if (z) {
                                    ...
                                    if (imageView3 != null) {
                                        ...
                                        if (imageView4 != null) {
                                            ...
                                            if (imageView5 != null) {
                                                ...
                                                if (imageView6 != null) {
                                                    i = R.id.layoutDownloadQRCodeDetail;
                                                    RelativeLayout relativeLayout = (RelativeLayout) view.findViewById(i);
                                                    if (relativeLayout != null) {
                                                        i = R.id.layoutDownloadQRCodeEnlarge;
                                                        LinearLayout linearLayout = (LinearLayout) view.findViewById(i);
                                                        if (linearLayout != null) {
                                                            i = R.id.layoutInfoQRCodeDetail;
                                                            ConstraintLayout constraintLayout = (ConstraintLayout) view.findViewById(i);
                                                            if (constraintLayout != null) {
                                                                i = R.id.layoutInfoQRCodeEnlarge;
                                                                ...
                                                                if (linearLayout2 != null) {
                                                                    ...
                                                                    if (linearLayout3 != null) {
                                                                        ...
                                                                        if (relativeLayout2 != null && (findViewById = view.findViewById((i = R.id.line1))) != null && (findViewById2 = view.findViewById((i = R.id.line2))) != null) {
                                                                            i = R.id.tvDownloadQRCodeEnlarge;
                                                                            ...
                                                                            if (textView3 != null) {
                                                                                ...
                                                                                if (textView4 != null) {
                                                                                    ...
                                                                                    if (textView5 != null) {
                                                                                        i = R.id.tvInfoQRCodeEnlarge;
                                                                                        TextView textView6 = (TextView) view.findViewById(i);
                                                                                        if (textView6 != null) {
                                                                                            i = R.id.tvOrder1Tips;
                                                                                            TextView textView7 = (TextView) view.findViewById(i);
                                                                                            if (textView7 != null) {
                                                                                                i = R.id.tvOrder1Title;
                                                                                                TextView textView8 = (TextView) view.findViewById(i);
                                                                                                if (textView8 != null) {
                                                                                                    i = R.id.tvOrder1Url;
                                                                                                    TextView textView9 = (TextView) view.findViewById(i);
                                                                                                    if (textView9 != null) {
                                                                                                        i = R.id.tvOrder2Title;
                                                                                                        TextView textView10 = (TextView) view.findViewById(i);
                                                                                                        if (textView10 != null) {
                                                                                                            i = R.id.tvOrder3Title;
