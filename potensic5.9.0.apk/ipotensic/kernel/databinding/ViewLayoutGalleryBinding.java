...
public final class ViewLayoutGalleryBinding implements ViewBinding {
    ...
    public static ViewLayoutGalleryBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.view_layout_gallery, viewGroup, false);
        if (z) {
                    ...
                    if (imageView2 != null) {
                        ...
                        if (constraintLayout != null) {
                            ...
                            if (constraintLayout3 != null) {
                                ...
                                if (constraintLayout4 != null && (findViewById = view.findViewById((i = R.id.line_photos_tab_bottom))) != null && (findViewById2 = view.findViewById((i = R.id.line_videos_tab_bottom))) != null) {
