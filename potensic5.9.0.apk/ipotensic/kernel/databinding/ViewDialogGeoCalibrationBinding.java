...
public final class ViewDialogGeoCalibrationBinding implements ViewBinding {
    ...
    public static ViewDialogGeoCalibrationBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.view_dialog_geo_calibration, viewGroup, false);
        if (z) {
                            ...
                            if (relativeLayout2 != null) {
                                ...
                                if (scrollView != null) {
                                    ...
                                    if (textView != null) {
                                        ...
                                        if (textView2 != null) {
                                            i = R.id.tv_geo_calibration;
                                            TextView textView3 = (TextView) view.findViewById(i);
                                            if (textView3 != null) {
                                                i = R.id.tv_mini_geo_tips;
