...
public final class ViewRightCameraSetBinding implements ViewBinding {
    ...
    public static ViewRightCameraSetBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.view_right_camera_set, viewGroup, false);
        if (z) {
        ...
        if (expandableView != null) {
            ...
            if (imageGridView != null) {
                ...
                if (imageGridView2 != null) {
                    ...
                    if (imageGridView3 != null && (findViewById = view.findViewById((i = R.id.include1))) != null) {
                        ...
                        if (findViewById9 != null) {
                            ...
                            if (imageView != null) {
                                i = R.id.layout_photo_sizes;
                                ExpandableView expandableView2 = (ExpandableView) view.findViewById(i);
                                if (expandableView2 != null) {
                                    i = R.id.layout_video_segment;
                                    ExpandableView expandableView3 = (ExpandableView) view.findViewById(i);
                                    if (expandableView3 != null) {
                                        i = R.id.layout_video_sizes;
                                        ExpandableView expandableView4 = (ExpandableView) view.findViewById(i);
                                        if (expandableView4 != null && (findViewById2 = view.findViewById((i = R.id.line_format))) != null && (findViewById3 = view.findViewById((i = R.id.line_photo_resolution))) != null && (findViewById4 = view.findViewById((i = R.id.line_photo_sizes))) != null && (findViewById5 = view.findViewById((i = R.id.line_video_segment))) != null && (findViewById6 = view.findViewById((i = R.id.line_video_sizes))) != null && (findViewById7 = view.findViewById((i = R.id.line_water_mark))) != null) {
                                            i = R.id.ll_camera_set;
                                            LinearLayout linearLayout = (LinearLayout) view.findViewById(i);
                                            if (linearLayout != null) {
                                                i = R.id.photo_resolution_title;
                                                TextView textView = (TextView) view.findViewById(i);
                                                if (textView != null) {
                                                    i = R.id.rl_photo_resolution;
                                                    ConstraintLayout constraintLayout = (ConstraintLayout) view.findViewById(i);
                                                    if (constraintLayout != null) {
                                                        i = R.id.scrollView;
                                                        ScrollView scrollView = (ScrollView) view.findViewById(i);
                                                        if (scrollView != null) {
                                                            i = R.id.tv_photo_resolution;
                                                            TextView textView2 = (TextView) view.findViewById(i);
                                                            if (textView2 != null && (findViewById8 = view.findViewById((i = R.id.view_format))) != null) {
                                                                ViewRightCameraSetItem4Binding bind3 = ViewRightCameraSetItem4Binding.bind(findViewById8);
                                                                i = R.id.view_water_mark;
