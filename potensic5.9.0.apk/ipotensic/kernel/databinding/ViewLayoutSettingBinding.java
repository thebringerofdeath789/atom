...
public final class ViewLayoutSettingBinding implements ViewBinding {
    ...
    public static ViewLayoutSettingBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.view_layout_setting, viewGroup, false);
        if (z) {
    ...
    public static ViewLayoutSettingBinding bind(View view) {
        View findViewById;
        int i = R.id.btn_indicator_1;
        ImageButton imageButton = (ImageButton) view.findViewById(i);
        if (imageButton != null) {
            i = R.id.btn_indicator_2;
            ImageButton imageButton2 = (ImageButton) view.findViewById(i);
            if (imageButton2 != null) {
                i = R.id.btn_indicator_3;
                ImageButton imageButton3 = (ImageButton) view.findViewById(i);
                if (imageButton3 != null) {
                    i = R.id.btn_indicator_4;
                    ImageButton imageButton4 = (ImageButton) view.findViewById(i);
                    if (imageButton4 != null) {
                        i = R.id.btn_indicator_5;
                        ImageButton imageButton5 = (ImageButton) view.findViewById(i);
                        if (imageButton5 != null) {
                            i = R.id.layout_indicator;
                            LinearLayout linearLayout = (LinearLayout) view.findViewById(i);
                            if (linearLayout != null) {
                                i = R.id.stub_setting_1;
                                ViewStub viewStub = (ViewStub) view.findViewById(i);
                                if (viewStub != null) {
                                    i = R.id.stub_setting_2;
                                    ViewStub viewStub2 = (ViewStub) view.findViewById(i);
                                    if (viewStub2 != null) {
                                        i = R.id.stub_setting_3;
                                        ViewStub viewStub3 = (ViewStub) view.findViewById(i);
                                        if (viewStub3 != null) {
                                            i = R.id.stub_setting_4;
                                            ViewStub viewStub4 = (ViewStub) view.findViewById(i);
                                            if (viewStub4 != null) {
                                                i = R.id.stub_setting_5;
                                                ViewStub viewStub5 = (ViewStub) view.findViewById(i);
                                                if (viewStub5 != null && (findViewById = view.findViewById((i = R.id.view_left_blank))) != null) {
