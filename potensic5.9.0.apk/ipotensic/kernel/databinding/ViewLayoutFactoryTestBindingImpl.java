...
public class ViewLayoutFactoryTestBindingImpl extends ViewLayoutFactoryTestBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.ll_test, 2);
        sparseIntArray.put(R.id.view_factory_test, 3);
        sparseIntArray.put(R.id.view_office_test, 4);
        sparseIntArray.put(R.id.view_camera_test, 5);
        sparseIntArray.put(R.id.view_maintain_test, 6);
        sparseIntArray.put(R.id.view_open_model_test, 7);
        sparseIntArray.put(R.id.view_open_gps_test, 8);
        sparseIntArray.put(R.id.view_imu_cal, 9);
        sparseIntArray.put(R.id.view_location_test, 10);
        sparseIntArray.put(R.id.view_fpv_test, 11);
        sparseIntArray.put(R.id.view_gps_signal_test, 12);
    }
