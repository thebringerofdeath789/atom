...
public class ViewBigPackageUpgradeFinishedBindingImpl extends ViewBigPackageUpgradeFinishedBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.btn_upgrade_finished_close, 2);
        sparseIntArray.put(R.id.iv_upgrade_success, 3);
        sparseIntArray.put(R.id.tv_tips, 4);
        sparseIntArray.put(R.id.tv_upgrade_finished_count_down, 5);
    }
