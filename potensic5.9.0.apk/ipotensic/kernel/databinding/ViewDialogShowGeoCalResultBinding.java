...
public final class ViewDialogShowGeoCalResultBinding implements ViewBinding {
    ...
    public static ViewDialogShowGeoCalResultBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.view_dialog_show_geo_cal_result, viewGroup, false);
        if (z) {
    ...
    public static ViewDialogShowGeoCalResultBinding bind(View view) {
        ...
        if (imageButton != null) {
            i = R.id.tv_bias_result0;
            TextView textView = (TextView) view.findViewById(i);
            if (textView != null) {
                i = R.id.tv_bias_result1;
                TextView textView2 = (TextView) view.findViewById(i);
                if (textView2 != null) {
                    i = R.id.tv_bias_result2;
                    TextView textView3 = (TextView) view.findViewById(i);
                    if (textView3 != null) {
                        i = R.id.tv_mg_db_result;
                        TextView textView4 = (TextView) view.findViewById(i);
                        if (textView4 != null) {
                            i = R.id.tv_offdiag_result0;
                            TextView textView5 = (TextView) view.findViewById(i);
                            if (textView5 != null) {
                                i = R.id.tv_offdiag_result1;
                                TextView textView6 = (TextView) view.findViewById(i);
                                if (textView6 != null) {
                                    i = R.id.tv_offdiag_result2;
                                    TextView textView7 = (TextView) view.findViewById(i);
                                    if (textView7 != null) {
                                        i = R.id.tv_result;
                                        TextView textView8 = (TextView) view.findViewById(i);
                                        if (textView8 != null) {
                                            i = R.id.tv_scale_result0;
                                            TextView textView9 = (TextView) view.findViewById(i);
                                            if (textView9 != null) {
                                                i = R.id.tv_scale_result1;
                                                TextView textView10 = (TextView) view.findViewById(i);
                                                if (textView10 != null) {
                                                    i = R.id.tv_scale_result2;
