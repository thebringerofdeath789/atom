...
public final class ViewLayoutSetting5Item2Binding implements ViewBinding {
    ...
    public static ViewLayoutSetting5Item2Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.view_layout_setting5_item2, viewGroup, false);
        if (z) {
                        ...
                        if (constraintLayout5 != null) {
                            ...
                            if (constraintLayout6 != null) {
                                ...
                                if (constraintLayout7 != null) {
                                    ...
                                    if (textView != null) {
                                        i = R.id.layout_battery_update;
                                        LinearLayout linearLayout = (LinearLayout) view.findViewById(i);
                                        if (linearLayout != null) {
                                            i = R.id.layout_camera_update;
                                            LinearLayout linearLayout2 = (LinearLayout) view.findViewById(i);
                                            if (linearLayout2 != null) {
                                                i = R.id.layout_flight_update;
                                                LinearLayout linearLayout3 = (LinearLayout) view.findViewById(i);
                                                if (linearLayout3 != null) {
                                                    i = R.id.layout_fpv_update;
                                                    LinearLayout linearLayout4 = (LinearLayout) view.findViewById(i);
                                                    if (linearLayout4 != null) {
                                                        i = R.id.layout_ptz_update;
                                                        LinearLayout linearLayout5 = (LinearLayout) view.findViewById(i);
                                                        if (linearLayout5 != null) {
                                                            i = R.id.layout_remote_update;
                                                                ...
                                                                if (textView2 != null) {
                                                                    ...
                                                                    if (textView3 != null) {
                                                                        ...
                                                                        if (textView4 != null) {
                                                                            ...
                                                                            if (textView5 != null) {
                                                                                i = R.id.tv_battery_update;
                                                                                TextView textView6 = (TextView) view.findViewById(i);
                                                                                if (textView6 != null) {
                                                                                    i = R.id.tv_cam_tips;
                                                                                    TextView textView7 = (TextView) view.findViewById(i);
                                                                                    if (textView7 != null) {
                                                                                        i = R.id.tv_cam_update;
                                                                                                                        ...
                                                                                                                        if (textView16 != null) {
                                                                                                                            ...
                                                                                                                            if (textView17 != null) {
                                                                                                                                ...
                                                                                                                                if (textView18 != null) {
                                                                                                                                    ...
                                                                                                                                    if (textView19 != null) {
                                                                                                                                        i = R.id.tv_ptz_update;
                                                                                                                                        TextView textView20 = (TextView) view.findViewById(i);
                                                                                                                                        if (textView20 != null) {
                                                                                                                                            i = R.id.tv_remote_tips;
                                                                                                                                            TextView textView21 = (TextView) view.findViewById(i);
                                                                                                                                            if (textView21 != null) {
                                                                                                                                                i = R.id.tv_remote_update;
