...
public abstract class ViewLayoutSettingImageTransBinding extends ViewDataBinding {
    ...
    public static ViewLayoutSettingImageTransBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z, Object obj) {
        return (ViewLayoutSettingImageTransBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.view_layout_setting_image_trans, viewGroup, z, obj);
    }
    ...
    public static ViewLayoutSettingImageTransBinding inflate(LayoutInflater layoutInflater, Object obj) {
        return (ViewLayoutSettingImageTransBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.view_layout_setting_image_trans, null, false, obj);
    }
    ...
    public static ViewLayoutSettingImageTransBinding bind(View view, Object obj) {
        return (ViewLayoutSettingImageTransBinding) bind(obj, view, R.layout.view_layout_setting_image_trans);
    }
}