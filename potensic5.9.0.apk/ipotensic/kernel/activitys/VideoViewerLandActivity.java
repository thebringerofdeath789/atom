...
public class VideoViewerLandActivity extends BaseActivity implements EventDispatcher.OnEventListener {
    ...
    private final VideoLoopManager.OnPageLoopListener pagerChangeListener = new VideoLoopManager.OnPageLoopListener() { // from class: com.ipotensic.kernel.activitys.VideoViewerLandActivity.12
        ...
        @Override // com.ipotensic.kernel.manager.VideoLoopManager.OnPageLoopListener
        public void onClickPlay(Serializable serializable) {
            if (serializable instanceof LocalFile) {
                ...
                if (((RemoteFile) VideoViewerLandActivity.this.data).isFromUsb()) {
                    VideoViewerLandActivity.this.download(new OnResultListener() { // from class: com.ipotensic.kernel.activitys.VideoViewerLandActivity.12.1
                        final /* synthetic */ Serializable val$file;

                        @Override // com.ipotensic.baselib.okhttp.OnResultListener
                        public void onFailed(Exception exc) {
                        }

                        AnonymousClass1(Serializable serializable2) {
                            r2 = serializable2;
                        }

                        @Override // com.ipotensic.baselib.okhttp.OnResultListener
                        public void onSuccess(Object obj) {
                            VideoViewerLandActivity.this.toPlay(r2);
                        }
                    });
                } else {
                    VideoViewerLandActivity.this.toPlay(serializable2);
                }
            }
        }

        /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$12$1 */
    ...
    /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$1 */
    ...
    /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$2 */
    ...
    /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$3 */
    ...
    /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$4 */
    ...
    /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$5 */
    ...
    /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$6 */
        ...
        if (serializable instanceof RemoteFile) {
            if (!((RemoteFile) serializable).isDownloaded()) {
                PermissionUtil.requestStoragePermissionInDownloadWithDialog(this, new PermissionUtil.OnPermissionListener() { // from class: com.ipotensic.kernel.activitys.VideoViewerLandActivity.7
                    ...
                    AnonymousClass7(OnResultListener onResultListener2) {
                        r2 = onResultListener2;
                    }

                    /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$7$1 */
                    class AnonymousClass1 implements VideoPlayerUtils.OnDownloadListener {
    ...
    /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$7 */
    ...
    class AnonymousClass8 implements OnResultListener<Boolean> {
        ...
        public void onSuccess(Boolean bool) {
            if (bool.booleanValue()) {
                ...
                PhoneConfig.threadPool.execute(new Runnable() { // from class: com.ipotensic.kernel.activitys.VideoViewerLandActivity.8.1
                    ...
                    /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$8$1$1 */
        ...
        /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$8$1 */
        ...
        /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$8$2 */
    ...
    class AnonymousClass9 implements PermissionUtil.OnPermissionListener {
        ...
        public void onGrant() {
            ...
            if (VideoViewerLandActivity.this.data instanceof RemoteFile) {
                ...
                VideoViewerLandActivity.this.download(new OnResultListener() { // from class: com.ipotensic.kernel.activitys.VideoViewerLandActivity.9.1
                    ...
                    /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$9$1$1 */
                    class C00531 implements PermissionUtil.OnPermissionListener {
                        @Override // com.ipotensic.baselib.permission.PermissionUtil.OnPermissionListener
                        public void onDenied() {
                        }
        ...
        /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$9$1 */
        class AnonymousClass1 implements OnResultListener {
            @Override // com.ipotensic.baselib.okhttp.OnResultListener
            public void onFailed(Exception exc) {
            }
    ...
    /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$10 */
    ...
    /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$11 */
    class AnonymousClass11 implements IMediaInfoCallback {
        AnonymousClass11() {
        }
    ...
    /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$12 */
    class AnonymousClass12 implements VideoLoopManager.OnPageLoopListener {
        AnonymousClass12() {
        }
        ...
        @Override // com.ipotensic.kernel.manager.VideoLoopManager.OnPageLoopListener
        public void onClickPlay(Serializable serializable2) {
            if (serializable2 instanceof LocalFile) {
                ...
                if (((RemoteFile) VideoViewerLandActivity.this.data).isFromUsb()) {
                    VideoViewerLandActivity.this.download(new OnResultListener() { // from class: com.ipotensic.kernel.activitys.VideoViewerLandActivity.12.1
                        ...
                        AnonymousClass1(Serializable serializable22) {
                            r2 = serializable22;
                        }
                    ...
                    VideoViewerLandActivity.this.toPlay(serializable22);
                }
            }
        }
    ...
    /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$13 */
    class AnonymousClass13 extends ScaleClickListener {
        AnonymousClass13() {
        }
    ...
    /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$14 */
    ...
    /* renamed from: com.ipotensic.kernel.activitys.VideoViewerLandActivity$15 */
