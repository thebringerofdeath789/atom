...
public class DataBinderMapperImpl extends DataBinderMapper {
    ...
    static {
        ...
        sparseIntArray.put(R.layout.fragment_friendly_tips, 2);
        sparseIntArray.put(R.layout.fragment_upgrade_question, 3);
        sparseIntArray.put(R.layout.view_big_package_fw_transfer_fail, 4);
        sparseIntArray.put(R.layout.view_big_package_upgrade_finished, 5);
        sparseIntArray.put(R.layout.view_dialog_battery_disclaimer, 6);
        sparseIntArray.put(R.layout.view_layout_compass_calibration, 7);
        sparseIntArray.put(R.layout.view_layout_factory_test, 8);
        sparseIntArray.put(R.layout.view_layout_gimbal_calibration, 9);
        sparseIntArray.put(R.layout.view_layout_gimbal_fine_tuning, 10);
        sparseIntArray.put(R.layout.view_layout_pair_drone_again, 11);
        sparseIntArray.put(R.layout.view_layout_remoter_controller_calibration, 12);
        sparseIntArray.put(R.layout.view_layout_right_vision_controller, 13);
        sparseIntArray.put(R.layout.view_layout_setting_about, 14);
        sparseIntArray.put(R.layout.view_layout_setting_battery, 15);
        sparseIntArray.put(R.layout.view_layout_setting_calibration, 16);
        sparseIntArray.put(R.layout.view_layout_setting_camera, 17);
        sparseIntArray.put(R.layout.view_layout_setting_control, 18);
        sparseIntArray.put(R.layout.view_layout_setting_image_trans, 19);
        sparseIntArray.put(R.layout.view_layout_setting_main, 20);
        sparseIntArray.put(R.layout.view_layout_setting_main1, 21);
        sparseIntArray.put(R.layout.view_layout_setting_security, 22);
        ...
        sparseIntArray.put(R.layout.view_layout_uom_upload_record, 26);
    }
    ...
    private static class InnerLayoutIdLookup {
        ...
        static {
            ...
            hashMap.put("layout/fragment_friendly_tips_0", Integer.valueOf(R.layout.fragment_friendly_tips));
            ...
            hashMap.put("layout/view_layout_uom_upload_record_0", Integer.valueOf(R.layout.view_layout_uom_upload_record));
        }
    }
}