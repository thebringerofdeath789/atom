...
public class VideoPlayerManager {
    ...
    public void setPlayer() {
        ...
        this.viewPager = (LooperViewPager) dIYVodControlView.findViewById(R.id.loop_viewpager);
        this.btnBack = (ImageView) dIYVodControlView.findViewById(R.id.btn_back);
        this.btnInfo = (ImageView) dIYVodControlView.findViewById(R.id.btn_info);
        this.btnShare = (ImageView) dIYVodControlView.findViewById(R.id.btn_share);
        this.btnDownload = (ImageView) dIYVodControlView.findViewById(R.id.btn_download);
        this.btnDelete = (ImageView) dIYVodControlView.findViewById(R.id.btn_delete);
        this.tvTitle = (TextView) dIYVodControlView.findViewById(R.id.tv_code_title);
        ...
        this.videoPlayer.addOnStateChangeListener(new VideoView.OnStateChangeListener() { // from class: com.ipotensic.kernel.manager.VideoPlayerManager.6
            ...
            public void onPlayStateChanged(int i) {
                ...
                if (i == -1 && VideoPlayerManager.this.isServerVideo) {
                    ToastUtil.toast(VideoPlayerManager.this.activity, VideoPlayerManager.this.activity.getResources().getString(R.string.please_check_the_network));
                }
            }
        });
