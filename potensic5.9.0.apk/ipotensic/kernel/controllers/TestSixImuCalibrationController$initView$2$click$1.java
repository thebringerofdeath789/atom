...
final class TestSixImuCalibrationController$initView$2$click$1<T> implements SimpleResultListener<Boolean> {
    TestSixImuCalibrationController$initView$2$click$1() {
    }
