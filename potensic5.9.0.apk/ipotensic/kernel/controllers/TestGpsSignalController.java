...
public final class TestGpsSignalController extends BaseController {
    ...
    public void initView(View baseView) {
        ...
        String flightSN;
        if (baseView != null) {
            View findViewById = baseView.findViewById(R.id.tvDroneSn);
            if (findViewById == null) {
                throw new TypeCastException("null cannot be cast to non-null type android.widget.TextView");
            }
            this.tvDroneSn = (TextView) findViewById;
            View findViewById2 = baseView.findViewById(R.id.switchBtn);
            ...
            View findViewById3 = baseView.findViewById(R.id.switchRecordBtn);
            if (findViewById3 == null) {
                throw new TypeCastException("null cannot be cast to non-null type com.ipotensic.kernel.view.SwitchButton");
            }
            this.switchRecordBtn = (SwitchButton) findViewById3;
            View findViewById4 = baseView.findViewById(R.id.tvGPSInfo);
            if (findViewById4 == null) {
                throw new TypeCastException("null cannot be cast to non-null type android.widget.TextView");
            }
            this.tvGPSInfo = (TextView) findViewById4;
            View findViewById5 = baseView.findViewById(R.id.tvGPCarrierRatio);
            if (findViewById5 == null) {
                throw new TypeCastException("null cannot be cast to non-null type android.widget.TextView");
            }
            this.tvGPCarrierRatio = (TextView) findViewById5;
            View findViewById6 = baseView.findViewById(R.id.rvGPCarrierRatio);
            if (findViewById6 == null) {
                throw new TypeCastException("null cannot be cast to non-null type androidx.recyclerview.widget.RecyclerView");
            }
            this.rvGPCarrierRatio = (RecyclerView) findViewById6;
            View findViewById7 = baseView.findViewById(R.id.tvBDCarrierRatio);
            if (findViewById7 == null) {
                throw new TypeCastException("null cannot be cast to non-null type android.widget.TextView");
            }
            this.tvBDCarrierRatio = (TextView) findViewById7;
            View findViewById8 = baseView.findViewById(R.id.rvBDCarrierRatio);
            if (findViewById8 == null) {
                throw new TypeCastException("null cannot be cast to non-null type androidx.recyclerview.widget.RecyclerView");
            }
            this.rvBDCarrierRatio = (RecyclerView) findViewById8;
            View findViewById9 = baseView.findViewById(R.id.tvGACarrierRatio);
            if (findViewById9 == null) {
                throw new TypeCastException("null cannot be cast to non-null type android.widget.TextView");
            }
            this.tvGACarrierRatio = (TextView) findViewById9;
            View findViewById10 = baseView.findViewById(R.id.rvGACarrierRatio);
            if (findViewById10 == null) {
                throw new TypeCastException("null cannot be cast to non-null type androidx.recyclerview.widget.RecyclerView");
            }
            this.rvGACarrierRatio = (RecyclerView) findViewById10;
            View findViewById11 = baseView.findViewById(R.id.tvGLCarrierRatio);
            if (findViewById11 == null) {
                throw new TypeCastException("null cannot be cast to non-null type android.widget.TextView");
            }
            this.tvGLCarrierRatio = (TextView) findViewById11;
            View findViewById12 = baseView.findViewById(R.id.rvGLCarrierRatio);
            ...
            if (switchButton2 != null) {
                switchButton2.switchStateListener(new SwitchButton.SwitchStateListener() { // from class: com.ipotensic.kernel.controllers.TestGpsSignalController$initView$$inlined$let$lambda$1
                    ...
                    public void onStateChanged(View view, boolean z) {
                        ...
                        ToastUtil.toast(TestGpsSignalController.this.getContext(), TestGpsSignalController.this.getContext().getString(R.string.txt_disconnect_set_fail));
                    }
                });
            }
        ...
        return new RvCommonAdapter<Byte, ItemGpsDebugLayoutBinding>(appCompatActivity, signalList) { // from class: com.ipotensic.kernel.controllers.TestGpsSignalController$withGPAdapter$1
            ...
            protected void convert(ItemGpsDebugLayoutBinding holder, byte data, int position) {
                ...
                if (position < 6) {
                        ...
                        if (((Number) pair2.getFirst()).floatValue() < 38.0f) {
                            ...
                            if (((Number) pair3.getFirst()).floatValue() >= 37.0f) {
                                ...
                                if (((Number) pair4.getSecond()).floatValue() >= 38.0f) {
                                    holder.tvCarrierRatio.setTextColor(ContextCompat.getColor(TestGpsSignalController.this.getContext(), R.color.aqua));
                                    holder.tvCarrierRatioValue.setTextColor(ContextCompat.getColor(TestGpsSignalController.this.getContext(), R.color.aqua));
                                    return;
                                } else {
                                    holder.tvCarrierRatio.setTextColor(ContextCompat.getColor(TestGpsSignalController.this.getContext(), R.color.red));
                                    holder.tvCarrierRatioValue.setTextColor(ContextCompat.getColor(TestGpsSignalController.this.getContext(), R.color.red));
                                    return;
                                }
                            }
                            holder.tvCarrierRatio.setTextColor(ContextCompat.getColor(TestGpsSignalController.this.getContext(), R.color.red));
                    ...
                    holder.tvCarrierRatio.setTextColor(ContextCompat.getColor(TestGpsSignalController.this.getContext(), R.color.color_zoom_green));
                    holder.tvCarrierRatioValue.setTextColor(ContextCompat.getColor(TestGpsSignalController.this.getContext(), R.color.color_zoom_green));
                    return;
                }
                holder.tvCarrierRatio.setTextColor(ContextCompat.getColor(TestGpsSignalController.this.getContext(), R.color.white));
                holder.tvCarrierRatioValue.setTextColor(ContextCompat.getColor(TestGpsSignalController.this.getContext(), R.color.white));
            }
    ...
    public final String writeData() {
        ...
        try {
            ...
            stringBuffer.append('\u3010' + FormatUtil.formatTimeSss(System.currentTimeMillis()) + "\u3011\n");
            List<Byte> list = this.gpIDSignalList;
            int i = 0;
