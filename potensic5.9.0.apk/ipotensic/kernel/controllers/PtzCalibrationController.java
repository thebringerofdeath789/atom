...
public class PtzCalibrationController extends BaseController implements View.OnClickListener {
    ...
    public void initView(View view) {
        ...
        this.layoutPtzCal = (ConstraintLayout) view.findViewById(R.id.layout_ptz_micro_cal);
    }
    ...
    /* renamed from: com.ipotensic.kernel.controllers.PtzCalibrationController$1, reason: invalid class name */
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        if (AnonymousClass1.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()] == 1 && this.layoutPtzCal != null) {
