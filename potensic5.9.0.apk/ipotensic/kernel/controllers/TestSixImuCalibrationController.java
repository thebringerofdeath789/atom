...
public final class TestSixImuCalibrationController extends BaseController {
        ...
        observableBoolean.addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() { // from class: com.ipotensic.kernel.controllers.TestSixImuCalibrationController.1
            ...
            public void onPropertyChanged(Observable sender, int propertyId) {
                if (!TestSixImuCalibrationController.this.isStartCalibration.get()) {
                    ...
                    TestSixImuCalibrationController.access$getBtnStartCal$p(TestSixImuCalibrationController.this).setTextColor(TestSixImuCalibrationController.this.getContext().getColor(R.color.white));
                    TestSixImuCalibrationController.access$getBtnStartCal$p(TestSixImuCalibrationController.this).setBackgroundResource(R.drawable.bg_blue_solid_4_shape);
                    return;
                }
                TestSixImuCalibrationController.access$getBtnStartCal$p(TestSixImuCalibrationController.this).setText("\u505c\u6b62\u6821\u51c6");
                TestSixImuCalibrationController.access$getBtnStartCal$p(TestSixImuCalibrationController.this).setTextColor(TestSixImuCalibrationController.this.getContext().getColor(R.color.color_disconnect_red));
                TestSixImuCalibrationController.access$getBtnStartCal$p(TestSixImuCalibrationController.this).setBackgroundResource(R.drawable.bg_green_solid_4_shape);
            }
        });
    ...
    public final void setSelectBg(TextView tv2, boolean isSelect) {
        ...
        tv2.setBackgroundColor(getContext().getColor(isSelect ? R.color.color_connect_green : R.color.color_gray));
    }

    @Override // com.ipotensic.kernel.controllers.BaseController
    public void initView(View baseView) {
        Intrinsics.checkParameterIsNotNull(baseView, "baseView");
        View findViewById = baseView.findViewById(R.id.btn_start);
        ...
        View findViewById2 = baseView.findViewById(R.id.btn_quit);
        ...
        View findViewById3 = baseView.findViewById(R.id.tv_up);
        ...
        View findViewById4 = baseView.findViewById(R.id.tv_below);
        ...
        View findViewById5 = baseView.findViewById(R.id.tv_back);
        ...
        View findViewById6 = baseView.findViewById(R.id.tv_front);
        ...
        View findViewById7 = baseView.findViewById(R.id.tv_left);
        ...
        View findViewById8 = baseView.findViewById(R.id.tv_right);
        ...
        View findViewById9 = baseView.findViewById(R.id.tv_state);
        ...
        View findViewById10 = baseView.findViewById(R.id.form);
        ...
        if (i == 1) {
            ...
            if (revGeneralData.getCommand() == GeneralCommand.IMU_CAL_RESULT) {
                if (revGeneralData.getImuCalResult().get校准开启()) {
                    ...
                    textView2.setTextColor(getContext().getColor(R.color.color_default_value_blue));
                    ...
                    textView4.setTextColor(getContext().getColor(R.color.color_progress_green));
                    ...
                    textView6.setTextColor(getContext().getColor(R.color.color_disconnect_red));
                    ...
                    textView8.setTextColor(getContext().getColor(R.color.color_disconnect_red));
                }
