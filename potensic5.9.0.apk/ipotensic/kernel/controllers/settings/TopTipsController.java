...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000R\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\b\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u0000 %2\u00020\u0001:\u0001%B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u00a2\u0006\u0002\u0010\u0006J\b\u0010\u001a\u001a\u00020\u0011H\u0002J\u0010\u0010\u001b\u001a\u00020\u00112\u0006\u0010\u0004\u001a\u00020\u0005H\u0016J\b\u0010\u001c\u001a\u00020\fH\u0002J\b\u0010\u001d\u001a\u00020\u0011H\u0016J\u001a\u0010\u001e\u001a\u00020\u00112\u0006\u0010\u001f\u001a\u00020 2\b\u0010!\u001a\u0004\u0018\u00010\"H\u0016J\u000e\u0010#\u001a\u00020\u00112\u0006\u0010$\u001a\u00020\bR\u000e\u0010\u0007\u001a\u00020\bX\u0082\u000e\u00a2\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u0082\u0004\u00a2\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\fX\u0082\u000e\u00a2\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\u000eX\u0082.\u00a2\u0006\u0002\n\u0000R\"\u0010\u000f\u001a\n\u0012\u0004\u0012\u00020\u0011\u0018\u00010\u0010X\u0086\u000e\u00a2\u0006\u000e\n\u0000\u001a\u0004\b\u0012\u0010\u0013\"\u0004\b\u0014\u0010\u0015R\u000e\u0010\u0016\u001a\u00020\u0017X\u0082.\u00a2\u0006\u0002\n\u0000R\u000e\u0010\u0018\u001a\u00020\u0017X\u0082.\u00a2\u0006\u0002\n\u0000R\u000e\u0010\u0019\u001a\u00020\bX\u0082\u000e\u00a2\u0006\u0002\n\u0000\u00a8\u0006&"}, d2 = {"Lcom/ipotensic/kernel/controllers/settings/TopTipsController;", "Lcom/ipotensic/kernel/controllers/BaseController;", "activity", "Landroidx/appcompat/app/AppCompatActivity;", "baseView", "Landroid/view/View;", "(Landroidx/appcompat/app/AppCompatActivity;Landroid/view/View;)V", "countDownNum", "", "handler", "Landroid/os/Handler;", "isShowLandingTip", "", "ivClose", "Landroid/widget/ImageView;", "onClose", "Lkotlin/Function0;", "", "getOnClose", "()Lkotlin/jvm/functions/Function0;", "setOnClose", "(Lkotlin/jvm/functions/Function0;)V", "tvContent", "Landroid/widget/TextView;", "tvCountDown", "windCount", "close", "initView", "isWinTips", "onDestroy", "onEvent", "what", "Lcom/ipotensic/baselib/dispatcher/EventID;", NotificationCompat.CATEGORY_EVENT, "Lcom/ipotensic/baselib/dispatcher/Event;", "setContent", "idRes", "Companion", "Kernel_mapboxRelease"}, k = 1, mv = {1, 1, 15})
...
public final class TopTipsController extends BaseController {
    ...
    public void initView(View baseView) {
        Intrinsics.checkParameterIsNotNull(baseView, "baseView");
        View findViewById = baseView.findViewById(R.id.tv_content);
        Intrinsics.checkExpressionValueIsNotNull(findViewById, "baseView.findViewById(R.id.tv_content)");
        this.tvContent = (TextView) findViewById;
        View findViewById2 = baseView.findViewById(R.id.tv_count_down);
        ...
        View findViewById3 = baseView.findViewById(R.id.iv_close);
    ...
    public final void setContent(int idRes) {
        if (getVisibility() == 8) {
            DDLog.e("isReturning22 windCount " + this.windCount);
    ...
    public final void close() {
        if (isWinTips()) {
            ...
            DDLog.e("isReturning33 windCount " + this.windCount);
        }
    ...
    private final boolean isWinTips() {
        ...
        if (!Intrinsics.areEqual(textView.getText(), getContext().getString(R.string.dialog_return_strong_wind_tips))) {
            TextView textView2 = this.tvContent;
            if (textView2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("tvContent");
            }
            if (!Intrinsics.areEqual(textView2.getText(), getContext().getString(R.string.dialog_strong_wind_tips))) {
                return false;
            }
        }
        return true;
    ...
    public void onEvent(EventID what, Event event) {
        ...
        if (i == 1) {
            ...
            if (((FlightRevFlightInfoData) obj).getWindSpeed() >= 10) {
                ...
                this.windCount = i2;
                if (i2 >= 12) {
                    DDLog.e("windCount " + this.windCount);
                    ...
                    if (revStateData.isReturning()) {
                        setContent(R.string.dialog_return_strong_wind_tips);
                        return;
                    } else {
                        setContent(R.string.dialog_strong_wind_tips);
                        return;
                    }
                }
                return;
        ...
        if (FlightConfig.is_Atom_Series()) {
            if (flightRevStateData.isLanding()) {
                ...
                if (!flightRevData2.getNoFlyZoneData().getIsLocatedNoFlyZone()) {
                    ...
                    setContent(R.string.rocker_controller_landing);
                    return;
                }
            }
            this.isShowLandingTip = false;
            if (getVisibility() == 0) {
                ...
                if (Intrinsics.areEqual(textView.getText(), getContext().getString(R.string.rocker_controller_landing))) {
                    close();
                }
            }
        }
