...
public class Setting1Controller extends BaseController implements View.OnClickListener, SwitchButton.SwitchStateListener {
    ...
    private void initLimitUI() {
        ...
        this.tvCodeTitle.setText(PhoneConfig.isFt ? String.format(getContext().getString(R.string.sys_basic_beginner_mode_describe1), Integer.valueOf(FlightConfig.get_value(30))) : getContext().getString(R.string.sys_basic_beginner_mode_describe));
        TextView textView2 = this.tvReturnHeightTitle;
        StringBuilder append = new StringBuilder().append(getContext().getString(R.string.txt_set_range));
        ...
        StringBuilder append2 = new StringBuilder().append(getContext().getString(R.string.sys_basic_altitude_limitation));
        ...
        StringBuilder append3 = new StringBuilder().append(getContext().getString(R.string.sys_basic_distance_limitation));
        ...
        StringBuilder append4 = new StringBuilder().append(getContext().getString(R.string.sys_basic_radius));
        ...
        StringBuilder append5 = new StringBuilder().append(getContext().getString(R.string.sys_basic_speed));
            ...
            public void onResult(View view, int i) {
                ...
                if (id != Setting1Controller.this.etRadius.getId()) {
                    if (id != Setting1Controller.this.etSpeed.getId()) {
                        if (id != Setting1Controller.this.etReturnHeight.getId()) {
                            if (id != Setting1Controller.this.etLimitDistance.getId()) {
                                if (id == Setting1Controller.this.etLimitHeight.getId()) {
                                    DDLog.e("inputFinishListener", "\u9ad8\u5ea6\u9650\u5236\uff1a" + i);
                            ...
                            DDLog.e("inputFinishListener", "\u8ddd\u79bb\u9650\u5236\uff1a" + i);
                        ...
                        DDLog.e("inputFinishListener", "\u8fd4\u822a\u9ad8\u5ea6\uff1a" + i);
        ...
        this.seekBarChangeListener = new SeekBar.OnSeekBarChangeListener() { // from class: com.ipotensic.kernel.controllers.settings.Setting1Controller.3
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                ...
                if (id == Setting1Controller.this.returnHeightSeekbar.getId()) {
                    ...
                    DDLog.e("onProgressChanged", "\u8bbe\u7f6e\u8fd4\u822a\u9ad8\u5ea6:" + value);
                    if (PhoneConfig.isFt) {
                    ...
                    if (value > value2) {
                        ...
                        DDLog.e("onProgressChanged", "\u8fd4\u822a\u9ad8\u5ea6\u5927\u4e8e\u9650\u9ad8\uff0c\u4e4b\u524d\u7684\u9650\u9ad8=" + value2);
                        return;
                    }
                    return;
                }
                if (id == Setting1Controller.this.limitDistanceSeekbar.getId()) {
                    ...
                    DDLog.e("onProgressChanged", "\u8bbe\u7f6e\u8ddd\u79bb\u9650\u5236\uff1a" + value3);
                    if (PhoneConfig.isFt) {
                ...
                if (id == Setting1Controller.this.limitHeightSeekbar.getId()) {
                    ...
                    DDLog.e("onProgressChanged", "\u8bbe\u7f6e\u9ad8\u5ea6\u9650\u5236\uff1a" + value4);
                    if (PhoneConfig.isFt) {
                    ...
                    if (value4 < value5) {
                        ...
                        DDLog.e("onProgressChanged", "\u9650\u9ad8\u5c0f\u4e8e\u8fd4\u822a\u9ad8\u5ea6\uff0c\u4e4b\u524d\u7684\u8fd4\u822a\u9ad8\u5ea6=" + value5);
    ...
    public void initView(View view) {
        this.tvCodeTitle = (TextView) view.findViewById(R.id.tv_code_title);
        this.tvReturnHeightUnit = (TextView) view.findViewById(R.id.tv_unit_return_height);
        this.tvHeightUnit = (TextView) view.findViewById(R.id.tv_unit_height);
        this.tvDistanceUnit = (TextView) view.findViewById(R.id.tv_unit_distance);
        this.tvCircleRadiusUnit = (TextView) view.findViewById(R.id.tv_unit_circle_radius);
        this.tvCircleSpeedUnit = (TextView) view.findViewById(R.id.tv_unit_circle_speed);
        this.radiusSeekBar = (CustomSeekbar) view.findViewById(R.id.seekBar_radius);
        this.speedSeekBar = (CustomSeekbar) view.findViewById(R.id.seekBar_speed);
        this.etRadius = (CursorEditText) view.findViewById(R.id.tv_radius);
        this.etSpeed = (CursorEditText) view.findViewById(R.id.edt_speed);
        this.layoutCircle = (ConstraintLayout) view.findViewById(R.id.layout_circle);
        this.etReturnHeight = (CursorEditText) view.findViewById(R.id.et_return_height_value);
        this.sbNewMode = (SwitchButton) view.findViewById(R.id.slideBtn_new_mode);
        ...
        this.layoutSpeedSetting = (RelativeLayout) view.findViewById(R.id.layout_speed_setting);
        this.tvSportSpeedTooFast = (TextView) view.findViewById(R.id.tv_speed_change);
        this.tvRadiusTitle = (TextView) view.findViewById(R.id.tv_radius_tips);
        this.tvSpeedTitle = (TextView) view.findViewById(R.id.tv_speed_tips);
        this.tvGentlyLowMode = (TextView) view.findViewById(R.id.tv_gently_mode);
        this.tvNormalMiddleMode = (TextView) view.findViewById(R.id.tv_normal_mode);
        this.tvSportHighMode = (TextView) view.findViewById(R.id.tv_sport_mode);
        this.layoutSpeedMode = (LinearLayout) view.findViewById(R.id.layout_speed_mode);
        this.limitHeightSeekbar = (CustomSeekbar) view.findViewById(R.id.seekBar_altitude);
        this.limitDistanceSeekbar = (CustomSeekbar) view.findViewById(R.id.seekBar_distance);
        this.returnHeightSeekbar = (CustomSeekbar) view.findViewById(R.id.seekBar_return_height);
        this.sbNoLimit = (SwitchButton) view.findViewById(R.id.switch_btn_no_limit);
        this.tvHeightLimitTitle = (TextView) view.findViewById(R.id.tv_fly_fence_altitide);
        this.tvDistanceLimitTitle = (TextView) view.findViewById(R.id.tv_fly_fence_distance);
        this.tvReturnHeightTitle = (TextView) view.findViewById(R.id.tv_return_height);
        this.etLimitHeight = (CursorEditText) view.findViewById(R.id.tv_show_altitude_value);
        this.etLimitDistance = (CursorEditText) view.findViewById(R.id.tv_show_distance_value);
        this.layoutFlyFence = (ConstraintLayout) view.findViewById(R.id.layout_fly_fence_setting);
        this.layoutReturnHeight = (ConstraintLayout) view.findViewById(R.id.layout_return_height_setting);
        this.layoutRthSetting = (LinearLayout) view.findViewById(R.id.layout_return_height);
        this.tvReturnHeightSettingTitle = (TextView) view.findViewById(R.id.tv_return_height_title);
        this.tvFlyFenceSettingTitle = (TextView) view.findViewById(R.id.tv_fly_fence_title);
    ...
    public void updateData() {
        ...
        DDLog.e("updateData", "\u8ddd\u79bb\u9650\u5236\uff1a" + this.limitDistanceSeekbar.getValue() + ",\u8fd4\u822a\u9ad8\u5ea6\uff1a" + this.returnHeightSeekbar.getValue() + ",\u9ad8\u5ea6\u9650\u5236\uff1a" + this.limitHeightSeekbar.getValue());
        DDLog.e("\u8bbe\u7f6e isNoLimit\uff1a" + (limitDistance == 65535));
    ...
    private void setEnableClick(boolean z) {
        ...
        this.etReturnHeight.setTextColor(z ? getContext().getResources().getColor(R.color.colorGradientBlueStart) : getContext().getResources().getColor(R.color.colorWhite));
        this.etReturnHeight.setAlpha(z ? 1.0f : 0.5f);
        this.etLimitHeight.setEnabled(z);
        this.etLimitHeight.setTextColor(z ? getContext().getResources().getColor(R.color.colorGradientBlueStart) : getContext().getResources().getColor(R.color.colorWhite));
        this.etLimitHeight.setAlpha(z ? 1.0f : 0.5f);
        this.etLimitDistance.setEnabled(z);
        this.etLimitDistance.setTextColor(z ? getContext().getResources().getColor(R.color.colorGradientBlueStart) : getContext().getResources().getColor(R.color.colorWhite));
        this.etLimitDistance.setAlpha(z ? 1.0f : 0.5f);
        this.etRadius.setEnabled(z);
        this.etRadius.setTextColor(z ? getContext().getResources().getColor(R.color.colorGradientBlueStart) : getContext().getResources().getColor(R.color.colorWhite));
        this.etRadius.setAlpha(z ? 1.0f : 0.5f);
        this.etSpeed.setEnabled(z);
        this.etSpeed.setTextColor(z ? getContext().getResources().getColor(R.color.colorGradientBlueStart) : getContext().getResources().getColor(R.color.colorWhite));
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.iv_left) {
            ...
            this.ivLeft.setImageResource(R.mipmap.icon_direction_left_selected);
            this.ivRight.setImageResource(R.mipmap.icon_direction_right_disable);
            return;
        }
        if (id == R.id.iv_right) {
            FlightSendData.get().getSendFlightSetData().setClockwise(true);
            this.ivLeft.setImageResource(R.mipmap.icon_direction_left_disable);
            this.ivRight.setImageResource(R.mipmap.icon_direction_right_selected);
            return;
        }
        if (id == R.id.tv_gently_mode) {
            sendSpeedMode(0);
            return;
        }
        ...
        if (id == R.id.tv_sport_mode) {
            if (FlightConfig.isConnectFlight() && FlightRevData.get().getFlightRevFlightInfoData().getVerticalDistance() <= 8.0d) {
                if (PhoneConfig.isFt) {
                    ToastUtil.toast(getContext(), getContext().getResources().getString(R.string.switch_sport_mode_tip, "26ft"));
                    return;
                } else {
                    ToastUtil.toast(getContext(), getContext().getResources().getString(R.string.switch_sport_mode_tip, "8m"));
                    return;
                }
            }
            if (FlightConfig.isConnectFlight() && FlightRevData.get().getFlightRevFlightInfoData().getRemainedBattery() <= 30) {
                ToastUtil.toast(getContext(), getContext().getResources().getString(R.string.low_power_quit_sport_mode));
                return;
            }
            sendSpeedMode(2);
            if (FlightConfig.isConnectFlight()) {
        ...
        if (id == R.id.tv_return_height_title) {
            showReturnHeightVideo();
        }
    }
    ...
    private void sendSpeedMode(int i) {
        if (FlightRevData.get().getFlightRevStateData().isReturning()) {
            ToastUtil.toast(getContext(), getContext().getString(R.string.returning_switch_mode_unavailable));
    ...
    public void onStateChanged(View view, boolean z) {
        ...
        if (view.getId() == this.sbNewMode.getId()) {
            ...
            if (z) {
                ...
                DDLog.e("onStateChanged", "\u8ddd\u79bb\u9650\u5236\uff1a" + this.limitDistanceSeekbar.getDefaultValue() + ",\u8fd4\u822a\u9ad8\u5ea6\uff1a" + this.returnHeightSeekbar.getDefaultValue() + ",\u9ad8\u5ea6\u9650\u5236\uff1a" + this.limitHeightSeekbar.getDefaultValue());
                ...
                DDLog.e("onStateChanged", "\u8ddd\u79bb\u9650\u5236\uff1a" + this.limitDistanceSeekbar.getValue() + ",\u8fd4\u822a\u9ad8\u5ea6\uff1a" + this.returnHeightSeekbar.getValue() + ",\u9ad8\u5ea6\u9650\u5236\uff1a" + this.limitHeightSeekbar.getValue());
            ...
            this.ivLeft.setImageResource(R.mipmap.icon_direction_left_disable);
            this.ivRight.setImageResource(R.mipmap.icon_direction_right_selected_disable);
            FlightSendData.get().getSendFlightSetData().setClockwise(true);
            setButtonEnable(z);
        }
    }
    ...
    private void showCloseNewHandModeDialog() {
        GeneralOneButtonDialog confirmStr = new GeneralOneButtonDialog(getContext()).setTitleId(R.string.settings_safety_exit_beginner_mode_title).setContent(getContext().getString(R.string.settings_safety_exit_beginner_mode_tips)).setConfirmStr(R.string.txt_guide_map_know);
    ...
    private void setDefaultUI() {
        ...
        customSeekbar3.setValue(customSeekbar3.getDefaultValue());
        DDLog.e("setDefaultUI", "\u8ddd\u79bb\u9650\u5236\uff1a" + this.limitDistanceSeekbar.getValue() + ",\u8fd4\u822a\u9ad8\u5ea6\uff1a" + this.returnHeightSeekbar.getValue() + ",\u9ad8\u5ea6\u9650\u5236\uff1a" + this.limitHeightSeekbar.getValue());
        CustomSeekbar customSeekbar4 = this.radiusSeekBar;
        customSeekbar4.setValue(customSeekbar4.getDefaultValue());
        CustomSeekbar customSeekbar5 = this.speedSeekBar;
        customSeekbar5.setValue(customSeekbar5.getDefaultValue());
    ...
    public void setSpeedUI(int i) {
        if (this.layoutSpeedSetting != null) {
            this.tvGentlyLowMode.setTextColor(getContext().getResources().getColor(i == 0 ? R.color.white : R.color.color_white_seventy_percent));
            this.tvGentlyLowMode.setBackgroundColor(getContext().getResources().getColor(i == 0 ? R.color.colorFormatSdCard : R.color.colorTransparent));
            this.tvNormalMiddleMode.setTextColor(getContext().getResources().getColor(i == 1 ? R.color.white : R.color.color_white_seventy_percent));
            this.tvNormalMiddleMode.setBackgroundColor(getContext().getResources().getColor(i == 1 ? R.color.colorFormatSdCard : R.color.colorTransparent));
            this.tvSportHighMode.setTextColor(getContext().getResources().getColor(i == 2 ? R.color.white : R.color.color_white_seventy_percent));
            this.tvSportHighMode.setBackgroundColor(getContext().getResources().getColor(i == 2 ? R.color.colorFormatSdCard : R.color.colorTransparent));
        }
    }

    /* renamed from: com.ipotensic.kernel.controllers.settings.Setting1Controller$7, reason: invalid class name */
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        int i = AnonymousClass7.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()];
        if (i != 1) {
            if (i == 2) {
        ...
        if (flightRevStateData != null) {
            if (this.stateData.getSpeedMode() != flightRevStateData.getSpeedMode()) {
                ...
                try {
                    this.stateData = flightRevStateData.m33clone();
                } catch (Exception e) {
                    DDLog.e("\u590d\u5236\u51fa\u9519:" + e.getMessage());
                }
            }
            if (flightRevStateData.isReturning()) {
                this.tvReturnHeightSettingTitle.setText(getContext().getString(R.string.txt_flight_lowest_return_height) + StringUtils.SPACE + getContext().getString(R.string.txt_return_not_available));
                this.tvFlyFenceSettingTitle.setText(getContext().getString(R.string.txt_fly_fence) + StringUtils.SPACE + getContext().getString(R.string.txt_return_not_available));
                this.sbNewMode.setViewEnable(false);
            ...
            this.tvReturnHeightSettingTitle.setText(getContext().getString(R.string.txt_flight_lowest_return_height));
            this.tvFlyFenceSettingTitle.setText(getContext().getString(R.string.txt_fly_fence));
