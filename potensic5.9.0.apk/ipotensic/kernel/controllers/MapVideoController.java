...
public class MapVideoController extends BaseController implements OnLocationChangedListener, AOAEngine.IEngineCallback {
    ...
    public void initView(View view) {
        ...
        this.tvTof = (TextView) view.findViewById(R.id.tvTof);
        ...
        this.noFlyZoneHelpView = (RelativeLayout) view.findViewById(R.id.view_no_fly_zone_help);
        ImageButton imageButton = (ImageButton) this.mapBtnView.findViewById(R.id.iv_no_fly_zone_help);
        ...
        TextView textView = (TextView) this.noFlyZoneHelpView.findViewById(R.id.quitMapExplain);
        ...
        this.rvNoFlyZoneHelp = (RecyclerView) this.noFlyZoneHelpView.findViewById(R.id.rvMapExplain);
    ...
    /* renamed from: com.ipotensic.kernel.controllers.MapVideoController$15, reason: invalid class name */
    ...
    private void setMapExplainAdapter() {
        ...
        arrayList.add(new MapExplainBean(R.string.restricted_zone, R.mipmap.icon_no_fly_zone));
        arrayList.add(new MapExplainBean(R.string.altitude_zone, R.mipmap.icon_height_restriction_zone));
