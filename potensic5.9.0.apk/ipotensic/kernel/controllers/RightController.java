...
public class RightController extends BaseController {
    ...
    /* renamed from: com.ipotensic.kernel.controllers.RightController$1 */
    ...
    public RightController(AppCompatActivity appCompatActivity, View view) {
        ...
        this.visualEffectView.init(new VisualEffectView.onDrawListener() { // from class: com.ipotensic.kernel.controllers.RightController.2
            ...
            /* renamed from: com.ipotensic.kernel.controllers.RightController$2$1 */
        ...
        this.dataBinding.tvZoomScale.setOnClick(new Function1() { // from class: com.ipotensic.kernel.controllers.-$$Lambda$RightController$gbO3EHNeKeTKECJoeN43ucu4sxA
            public /* synthetic */ $$Lambda$RightController$gbO3EHNeKeTKECJoeN43ucu4sxA() {
            }
        ...
        this.dataBinding.tvZoomScale.setOnLongClick(new Function1() { // from class: com.ipotensic.kernel.controllers.-$$Lambda$RightController$lagKtR6V5eI5a8moqfF7xCsNkFk
            public /* synthetic */ $$Lambda$RightController$lagKtR6V5eI5a8moqfF7xCsNkFk() {
            }
        ...
        this.dataBinding.tvZoomScale.setOnTouchAction(new Function1() { // from class: com.ipotensic.kernel.controllers.-$$Lambda$RightController$OVbaMfZKeshyMEIsxmGq9eTLUrE
            public /* synthetic */ $$Lambda$RightController$OVbaMfZKeshyMEIsxmGq9eTLUrE() {
            }
        ...
        this.dataBinding.zoomControlView.setOnZoomChangedListener(new Function2() { // from class: com.ipotensic.kernel.controllers.-$$Lambda$RightController$P5PClAJu7AvAnqTvfqGRxIsr7Z8
            public /* synthetic */ $$Lambda$RightController$P5PClAJu7AvAnqTvfqGRxIsr7Z8() {
            }
        ...
        this.dataBinding.tvTimerScale.setOnClick(new Function1() { // from class: com.ipotensic.kernel.controllers.-$$Lambda$RightController$MMXLhGMRe314uIJ15k5gZVlG8HY
            public /* synthetic */ $$Lambda$RightController$MMXLhGMRe314uIJ15k5gZVlG8HY() {
            }
        ...
        this.dataBinding.tvTimerScale.setOnLongClick(new Function1() { // from class: com.ipotensic.kernel.controllers.-$$Lambda$RightController$QIBvcI7xWKjF81EW1-FstjhpfOc
            public /* synthetic */ $$Lambda$RightController$QIBvcI7xWKjF81EW1FstjhpfOc() {
            }
        ...
        this.dataBinding.tvTimerScale.setOnTouchAction(new Function1() { // from class: com.ipotensic.kernel.controllers.-$$Lambda$RightController$Xi-KZsCcF2fsj4n4dtIwomIQ2ZA
            public /* synthetic */ $$Lambda$RightController$XiKZsCcF2fsj4n4dtIwomIQ2ZA() {
            }
        ...
        this.dataBinding.timerControlView.setOnTimeChangedListener(new Function2() { // from class: com.ipotensic.kernel.controllers.-$$Lambda$RightController$LMfHUf5qBvmLQcCR-b0YDgMRmaY
            public /* synthetic */ $$Lambda$RightController$LMfHUf5qBvmLQcCRb0YDgMRmaY() {
            }
        ...
        this.model.isJpgData.observe(getContext(), new Observer() { // from class: com.ipotensic.kernel.controllers.-$$Lambda$RightController$jyzB6YgmD8A16gwIwNCV6_8QATI
            public /* synthetic */ $$Lambda$RightController$jyzB6YgmD8A16gwIwNCV6_8QATI() {
            }
    ...
    /* renamed from: com.ipotensic.kernel.controllers.RightController$2 */
    class AnonymousClass2 implements VisualEffectView.onDrawListener {
        AnonymousClass2() {
        }
    ...
    /* renamed from: com.ipotensic.kernel.controllers.RightController$3 */
    class AnonymousClass3 implements RightControllerModel.OnRightControllerListener {
        AnonymousClass3() {
        }
    ...
    /* renamed from: com.ipotensic.kernel.controllers.RightController$4 */
    ...
    /* renamed from: com.ipotensic.kernel.controllers.RightController$5 */
    ...
    public /* synthetic */ Unit lambda$new$8$RightController(Integer num, Integer num2) {
        PhotoChildMode value = this.kernelViewModel.getPhotoChildModeData().getValue();
        if (value != null) {
            if (num.intValue() > 0) {
                value.childMode = 1;
        ...
        this.dataBinding.tvCameraTime.post(new Runnable() { // from class: com.ipotensic.kernel.controllers.-$$Lambda$RightController$UiQP9C0k7IPy9yVxsqPBv4fGtIU
            public final /* synthetic */ Integer f$1;

            public /* synthetic */ $$Lambda$RightController$UiQP9C0k7IPy9yVxsqPBv4fGtIU(Integer num3) {
                r2 = num3;
            }

            @Override // java.lang.Runnable
            public final void run() {
                RightController.this.lambda$new$7$RightController(r2);
            }
        });
        return null;
    }

    public /* synthetic */ void lambda$new$7$RightController(Integer num) {
        this.dataBinding.tvCameraTime.setText(num + "s");
    }

    /* renamed from: com.ipotensic.kernel.controllers.RightController$6 */
    ...
    /* renamed from: com.ipotensic.kernel.controllers.RightController$7 */
    ...
    /* renamed from: com.ipotensic.kernel.controllers.RightController$8 */
    ...
    /* renamed from: com.ipotensic.kernel.controllers.RightController$9 */
    ...
    public void showGuide(View view, int i) {
        NewbieGuide.with(getContext()).addGuidePage(GuidePage.newInstance().addHighLight(view, new RelativeGuide(R.layout.guide_right, 3)).setEnterAnimation(AnimationUtil.enterAnimation()).setExitAnimation(AnimationUtil.exitAnimation()).setOnLayoutInflatedListener(new OnLayoutInflatedListener() { // from class: com.ipotensic.kernel.controllers.-$$Lambda$RightController$HvzN2jrryrNND5Efbm2j_O70ND4
            ...
            public /* synthetic */ $$Lambda$RightController$HvzN2jrryrNND5Efbm2j_O70ND4(int i2) {
                r2 = i2;
            }
            ...
            public final void onLayoutInflated(View view2, Controller controller) {
                RightController.this.lambda$showGuide$10$RightController(r2, view2, controller);
            }
    ...
    /* renamed from: com.ipotensic.kernel.controllers.RightController$13 */
    ...
    /* renamed from: com.ipotensic.kernel.controllers.RightController$10 */
    class AnonymousClass10 extends Observable.OnPropertyChangedCallback {
        ...
        AnonymousClass10(SimpleResultListener simpleResultListener) {
        ...
        public void onPropertyChanged(Observable observable, int i) {
            ...
            SimpleResultListener simpleResultListener = r2;
    ...
    public void exitQuickShot(SimpleResultListener<Boolean> simpleResultListener) {
        if (this.model.isTrackFunctionOpen.get()) {
            this.model.isTrackFunctionOpen.addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() { // from class: com.ipotensic.kernel.controllers.RightController.10
                ...
                public void onPropertyChanged(Observable observable, int i) {
                    ...
                    SimpleResultListener simpleResultListener2 = r2;
    ...
    /* renamed from: com.ipotensic.kernel.controllers.RightController$11 */
    class AnonymousClass11 implements OnSuccessListener {
        @Override // com.ipotensic.baselib.listener.OnSuccessListener
        public void onResult(boolean z) {
        }
    ...
    /* renamed from: com.ipotensic.kernel.controllers.RightController$12 */
