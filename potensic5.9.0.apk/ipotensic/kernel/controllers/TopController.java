...
public class TopController extends BaseController implements AOAEngine.IEngineCallback {
    ...
    private void updateGimbalTips(boolean z) {
        if (z) {
            this.ivGimbalTips.setImageResource(R.mipmap.img_icon_gimbal_tips_red);
            this.tvGimbalTips.setTextColor(ContextCompat.getColor(this.context, R.color.color_battery_warn_for));
        } else {
            this.ivGimbalTips.setImageResource(R.mipmap.img_icon_gimbal_tips);
            this.tvGimbalTips.setTextColor(ContextCompat.getColor(this.context, R.color.colorWhite));
        }
    }
