...
public class SettingGimbalFineTuningModel extends BaseObservable {
    ...
    public final CursorStringEditText.OnInputFinishListener levelValueInputListener = new CursorStringEditText.OnInputFinishListener() { // from class: com.ipotensic.kernel.model.calibration.SettingGimbalFineTuningModel.1
        ...
        public void onResult(View view, String str) {
            ...
            if (str == null) {
                ...
                ToastUtil.toast(SettingGimbalFineTuningModel.this.activity, SettingGimbalFineTuningModel.this.activity.getString(R.string.invalid_value));
            } else if (str.equals("")) {
                SettingGimbalFineTuningModel.this.levelValue.set(SettingGimbalFineTuningModel.this.levelValue.get());
                SettingGimbalFineTuningModel.this.notifyChange();
    ...
    private boolean checkErrorStatus() {
        ...
        if (error_status == 4) {
            ...
            ToastUtil.toast(activity, activity.getString(R.string.warning_the_gimbal_is_stuck_briefly_tips));
            return true;
        }
        if (error_status == 5) {
            Activity activity2 = this.activity;
            ToastUtil.toast(activity2, activity2.getString(R.string.warning_flight_interface_the_gimbal_motor_is_overloaded_tips));
            return true;
        }
        if (error_status == 3) {
            Activity activity3 = this.activity;
            ToastUtil.toast(activity3, activity3.getString(R.string.txt_error_gimbal_need_calibration));
            return true;
        }
        if (error_status == 6) {
            Activity activity4 = this.activity;
            ToastUtil.toast(activity4, activity4.getString(R.string.txt_error_gimbal_angle_too_big));
            return true;
        }
        ...
        ToastUtil.toast(activity5, activity5.getString(R.string.txt_error_gimbal_error));
        return true;
    }
    ...
    public void update(FlightRevGimbalSettingData flightRevGimbalSettingData) {
        if (this.levelValue != null) {
            DDLog.e("\u4e91\u53f0\u5fae\u8c03getTuningRoll= " + ((int) flightRevGimbalSettingData.getTuningRoll()) + ", getTuningYaw= " + ((int) flightRevGimbalSettingData.getTuningYaw()));
            ...
            DDLog.e("\u4e91\u53f0\u5fae\u8c03\uff0c\u8f6c\u6362\u4e4b\u524d\u7684\u503ctuningRoll= " + tuningRoll + ", tuningYaw = " + tuningYaw);
