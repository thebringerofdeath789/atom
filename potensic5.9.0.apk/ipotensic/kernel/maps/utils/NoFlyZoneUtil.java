...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000F\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0006\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u0007\n\u0002\b\u0003\b\u00c6\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002\u00a2\u0006\u0002\u0010\u0002J\u000e\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\u0004J\u001e\u0010\f\u001a\u0012\u0012\u0004\u0012\u00020\u000e0\rj\b\u0012\u0004\u0012\u00020\u000e`\u000f2\u0006\u0010\u0010\u001a\u00020\u0011J%\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0010\u001a\u00020\u00112\b\u0010\u0014\u001a\u0004\u0018\u00010\u00132\u0006\u0010\u0015\u001a\u00020\u0016\u00a2\u0006\u0002\u0010\u0017J'\u0010\u0018\u001a\u00020\u00132\u0006\u0010\u0010\u001a\u00020\u00112\b\u0010\u0014\u001a\u0004\u0018\u00010\u00132\u0006\u0010\u0015\u001a\u00020\u0016H\u0016\u00a2\u0006\u0002\u0010\u0017R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T\u00a2\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0086T\u00a2\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004X\u0086T\u00a2\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0004X\u0082T\u00a2\u0006\u0002\n\u0000\u00a8\u0006\u0019"}, d2 = {"Lcom/ipotensic/kernel/maps/utils/NoFlyZoneUtil;", "", "()V", "FLAVOR", "", "NO_FLY_ZONE_BOUNDS_RADIUS", "", "NO_FLY_ZONE_DATA_DOWNLOAD_URL", "TAG", "isShowUpdateNoFlyZoneTip", "", OutputKeys.VERSION, "parseNoFlyZoneJson", "Ljava/util/ArrayList;", "Lcom/ipotensic/kernel/maps/bean/NoFlyZoneModel;", "Lkotlin/collections/ArrayList;", "context", "Landroid/content/Context;", "withLevelFillColor", "", "level", "height", "", "(Landroid/content/Context;Ljava/lang/Integer;F)I", "withLevelStrokeColor", "Kernel_mapboxRelease"}, k = 1, mv = {1, 1, 15})
...
public final class NoFlyZoneUtil {
    ...
    public int withLevelStrokeColor(Context context, Integer level, float height) {
        ...
        if (level != null && level.intValue() == 0) {
            return ContextCompat.getColor(context, R.color.color_E6FF771E);
        }
        if (level != null && level.intValue() == 1) {
            return ContextCompat.getColor(context, R.color.color_E60068D9);
        }
        if (level != null && level.intValue() == 2) {
            if (height > 0.0f) {
                return ContextCompat.getColor(context, R.color.color_E6E4AF00);
            }
            return ContextCompat.getColor(context, R.color.no_fly_stroke_color);
        }
        if (level != null && level.intValue() == 3) {
            return ContextCompat.getColor(context, R.color.color_E6FF0312);
        }
        return ContextCompat.getColor(context, R.color.no_fly_stroke_color);
    }
    ...
    public final int withLevelFillColor(Context context, Integer level, float height) {
        Intrinsics.checkParameterIsNotNull(context, "context");
        if (level != null && level.intValue() == 0) {
            return ContextCompat.getColor(context, R.color.color_29FF771E);
        }
        if (level != null && level.intValue() == 1) {
            return ContextCompat.getColor(context, R.color.color_290068D9);
        }
        if (level != null && level.intValue() == 2) {
            if (height > 0.0f) {
                return ContextCompat.getColor(context, R.color.color_29E4AF00);
            }
            return ContextCompat.getColor(context, R.color.no_fly_fill_color);
        }
        if (level != null && level.intValue() == 3) {
            return ContextCompat.getColor(context, R.color.color_29FF0312);
        }
        return ContextCompat.getColor(context, R.color.no_fly_fill_color);
    }

    public final boolean isShowUpdateNoFlyZoneTip(String r4) {
        Intrinsics.checkParameterIsNotNull(r4, "version");
        if ((FlightConfig.isBigPackageAtomSEV3() && CommonUtil.hasNewVersion(r4, "1.5.5")) || (FlightConfig.isBigPackageAtomV2() && CommonUtil.hasNewVersion(r4, "2.0.0"))) {
