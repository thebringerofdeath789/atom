...
public class CustomPermissionDialog extends BaseSyncDialog {
    ...
    public CustomPermissionDialog(Context context, String str, String str2, String str3, String str4, RequestPermissionListener requestPermissionListener) {
        super(context, context.getResources().getConfiguration().orientation == 2 ? R.layout.view_dialog_permission_landscape : R.layout.view_dialog_permission_portrait);
        this.permissionListener = requestPermissionListener;
        this.context = context;
        setSize();
        setCanceledOnTouchOutside(false);
        TextView textView = (TextView) findViewById(R.id.tv_head);
        TextView textView2 = (TextView) findViewById(R.id.tv_code_title);
    ...
    public CustomPermissionDialog(Context context, String str, RequestPermissionListener requestPermissionListener) {
        ...
        setSize();
        setCanceledOnTouchOutside(false);
        ((TextView) findViewById(R.id.tv_code_title)).setText(str);
        findViewById(R.id.btn_confirm).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.baselib.views.dailog.CustomPermissionDialog.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (CustomPermissionDialog.this.permissionListener != null) {
                    CustomPermissionDialog.this.permissionListener.grantPermission();
        ...
        findViewById(R.id.btn_cancel).setOnClickListener(new View.OnClickListener() { // from class: com.ipotensic.baselib.views.dailog.CustomPermissionDialog.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                CustomPermissionDialog.this.dismiss();
            }
