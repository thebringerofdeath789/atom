...
public class LooperViewPager extends ViewGroup {
    ...
    */
    private void scrollToItem(int i, boolean z, int i2, boolean z2) {
        ...
        if (pagerAdapter != null && pagerAdapter.getCount() != 0) {
            if (i >= 0) {
                i3 = i % this.mAdapter.getCount();
            } else if (i % this.mAdapter.getCount() != 0) {
                i3 = this.mAdapter.getCount() - ((-i) % this.mAdapter.getCount());
            }
            if (!z) {
    ...
    */
    void populate(int i) {
        ...
        int max = Math.max(0, this.mCurItem - i7);
        int count2 = this.mAdapter.getCount();
        int min = Math.min(count2 - 1, this.mCurItem + i7);
        if (count2 != this.mExpectedAdapterCount) {
            try {
        ...
        itemInfo2 = null;
        if (itemInfo2 == null && count2 > 0) {
            itemInfo2 = addNewItem(this.mCurItem, i8);
        }
        if (itemInfo2 != null) {
            int i9 = i8 - 1;
            ...
            while (true) {
                ...
                if (f2 >= paddingLeft && i12 < max) {
                    ...
                    if (i12 != itemInfo6.position || itemInfo6.scrolling) {
                        ...
                        if (i12 >= 0 && count2 != 0) {
                            this.mAdapter.destroyItem((ViewGroup) this, i12 % count2, itemInfo6.object);
                            i3 = min;
                        } else {
                            if (this.mAdapter.getCount() == 0 || i12 % this.mAdapter.getCount() == 0) {
                                i3 = min;
                                i5 = 0;
                            } else {
                                i3 = min;
                                i5 = this.mAdapter.getCount() - ((-i12) % this.mAdapter.getCount());
                            }
                            this.mAdapter.destroyItem((ViewGroup) this, i5, itemInfo6.object);
                        }
                        i9--;
                        i8--;
                        itemInfo5 = i9 >= 0 ? this.mItems.get(i9) : null;
                    }
                } else {
                    i3 = min;
                    if (itemInfo6 != null && i12 == itemInfo6.position) {
                        ...
                        itemInfo5 = i9 >= 0 ? this.mItems.get(i9) : null;
                        if (i9 < 0) {
                            itemInfo5 = this.mItems.get((this.mItems.size() == 0 || i9 % this.mItems.size() == 0) ? 0 : this.mItems.size() - ((-i9) % this.mItems.size()));
                        }
                    } else {
                        if (count2 != 0 && i12 >= 0) {
                            count = i12 % count2;
                        } else {
                            count = (this.mAdapter.getCount() == 0 || i12 % this.mAdapter.getCount() == 0) ? 0 : this.mAdapter.getCount() - ((-i12) % this.mAdapter.getCount());
                        }
                        int i13 = 0;
                        while (i13 < this.mItems.size()) {
                            int i14 = this.mItems.get(i13).position;
                            if (i14 >= 0 && count2 != 0) {
                                i4 = i14 % count2;
                                itemInfo4 = itemInfo;
                            } else if (this.mAdapter.getCount() == 0 || i14 % this.mAdapter.getCount() == 0) {
                                itemInfo4 = itemInfo;
                                i4 = 0;
                            } else {
                                itemInfo4 = itemInfo;
                                i4 = this.mAdapter.getCount() - ((-i14) % this.mAdapter.getCount());
                            }
                            if (count == i4) {
                                this.mAdapter.destroyItem((ViewGroup) this, count, this.mItems.get(i13).object);
                        ...
                        itemInfo3 = itemInfo;
                        f2 += addNewItem(i12, i9 + 1).widthFactor;
                        i8++;
                        itemInfo6 = i9 >= 0 ? this.mItems.get(i9) : null;
                        i12--;
                        min = i3;
                        itemInfo = itemInfo3;
                        f = 2.0f;
            ...
            int i15 = i8 + 1;
            if (f3 < f) {
                ItemInfo itemInfo7 = i15 < this.mItems.size() ? this.mItems.get(i15) : null;
                float paddingRight = clientWidth <= 0 ? 0.0f : (getPaddingRight() / clientWidth) + f;
                int i16 = this.mCurItem;
                int i17 = i16 + 2;
                while (true) {
                    i16++;
                    if (i16 >= count2 && i16 > i17) {
                        break;
                    }
                    if (f3 >= paddingRight && i16 > min) {
                        if (itemInfo7 == null) {
                            break;
                        }
                        if (i16 == itemInfo7.position && !itemInfo7.scrolling) {
                            this.mItems.remove(i15);
                            if (i16 >= 0 && count2 != 0) {
                                this.mAdapter.destroyItem((ViewGroup) this, i16 % count2, itemInfo7.object);
                            } else {
                                this.mAdapter.destroyItem((ViewGroup) this, (this.mAdapter.getCount() == 0 || i16 % this.mAdapter.getCount() == 0) ? 0 : this.mAdapter.getCount() - ((-i16) % this.mAdapter.getCount()), itemInfo7.object);
                            }
                            if (i15 < this.mItems.size()) {
                                itemInfo7 = this.mItems.get(i15);
                            }
                        }
                    } else if (itemInfo7 != null && i16 == itemInfo7.position) {
                        ...
                        ItemInfo addNewItem = addNewItem(i16, i15);
                        i15++;
                        f3 += addNewItem.widthFactor;
                        itemInfo7 = i15 < this.mItems.size() ? this.mItems.get(i15) : null;
                    }
                }
            }
