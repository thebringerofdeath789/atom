...
public class GuidePage {
    ...
    public GuidePage addClickView(View view) {
        ...
        highlightView.setOptions(new HighlightOptions.Builder().setOnClickListener($$Lambda$GuidePage$ZqS2Kb2ybVaZczr35_ZB3dDD8k.INSTANCE).build());
    ...
    /* renamed from: com.ipotensic.baselib.guide.model.GuidePage$1 */
    class AnonymousClass1 implements OnHighlightClickListener {
        @Override // android.view.View.OnClickListener
        public void onClick(View view2) {
        }
