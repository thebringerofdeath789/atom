...
public class ActivityHelper implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        add(activity);
        DDLog.w(activity.getClass().getSimpleName() + " onCreated");
    }
    ...
    public void onActivityResumed(Activity activity) {
        DDLog.w(activity.getClass().getSimpleName() + " onResumed");
    }

    @Override // android.app.Application.ActivityLifecycleCallbacks
    public void onActivityPaused(Activity activity) {
        DDLog.w(activity.getClass().getSimpleName() + " onPaused");
    }

    @Override // android.app.Application.ActivityLifecycleCallbacks
    public void onActivityStopped(Activity activity) {
        DDLog.w(activity.getClass().getSimpleName() + " onStop");
    ...
    public void onActivityDestroyed(Activity activity) {
        remove(activity);
        DDLog.w(activity.getClass().getSimpleName() + " onDestroyed");
