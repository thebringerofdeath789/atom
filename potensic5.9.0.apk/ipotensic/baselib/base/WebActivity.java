...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000^\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\n\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0016\u0018\u0000 02\u00020\u0001:\u00010B\u0005\u00a2\u0006\u0002\u0010\u0002J\b\u0010\u001e\u001a\u00020\u001fH\u0016J\b\u0010 \u001a\u00020\u001fH\u0002J\b\u0010!\u001a\u00020\u001fH\u0003J\u0010\u0010\"\u001a\u00020\u001f2\u0006\u0010#\u001a\u00020\u0014H\u0002J\u0010\u0010$\u001a\u00020\u001f2\u0006\u0010%\u001a\u00020\u0014H\u0002J\u0010\u0010&\u001a\u00020\u001f2\u0006\u0010\u0017\u001a\u00020\u0014H\u0016J\b\u0010'\u001a\u00020\u001fH\u0016J\u0010\u0010(\u001a\u00020\u001f2\u0006\u0010)\u001a\u00020*H\u0016J\u0012\u0010+\u001a\u00020\u001f2\b\u0010,\u001a\u0004\u0018\u00010-H\u0014J\b\u0010.\u001a\u00020\u001fH\u0014J\b\u0010/\u001a\u00020\u001fH\u0016R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082.\u00a2\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u000e\u00a2\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u0082.\u00a2\u0006\u0002\n\u0000R\u0010\u0010\t\u001a\u0004\u0018\u00010\nX\u0082\u000e\u00a2\u0006\u0002\n\u0000R\u0010\u0010\u000b\u001a\u0004\u0018\u00010\fX\u0082\u000e\u00a2\u0006\u0002\n\u0000R\u001a\u0010\r\u001a\u00020\u000eX\u0086.\u00a2\u0006\u000e\n\u0000\u001a\u0004\b\u000f\u0010\u0010\"\u0004\b\u0011\u0010\u0012R\u0010\u0010\u0013\u001a\u0004\u0018\u00010\u0014X\u0082\u000e\u00a2\u0006\u0002\n\u0000R\u000e\u0010\u0015\u001a\u00020\u0016X\u0082.\u00a2\u0006\u0002\n\u0000R\u001c\u0010\u0017\u001a\u0004\u0018\u00010\u0014X\u0086\u000e\u00a2\u0006\u000e\n\u0000\u001a\u0004\b\u0018\u0010\u0019\"\u0004\b\u001a\u0010\u001bR\u000e\u0010\u001c\u001a\u00020\u001dX\u0082.\u00a2\u0006\u0002\n\u0000\u00a8\u00061"}, d2 = {"Lcom/ipotensic/baselib/base/WebActivity;", "Lcom/ipotensic/baselib/base/BaseActivity;", "()V", "flVideo", "Landroid/widget/FrameLayout;", "isHome", "", "jsInterface", "Lcom/ipotensic/baselib/base/JsViewModel;", "mCustomView", "Landroid/view/View;", "mCustomViewCallback", "Landroid/webkit/WebChromeClient$CustomViewCallback;", "progressBar", "Landroid/widget/ImageView;", "getProgressBar", "()Landroid/widget/ImageView;", "setProgressBar", "(Landroid/widget/ImageView;)V", MessageBundle.TITLE_ENTRY, "", "titleView", "Lcom/ipotensic/baselib/views/TitleView;", "url", "getUrl", "()Ljava/lang/String;", "setUrl", "(Ljava/lang/String;)V", "webView", "Landroid/webkit/WebView;", "hideLoading", "", "initObserver", "initWebSettings", "jsMethod", "params", "jsMethodWithCallback", "function", "loadPdf", "onBackPressed", "onConfigurationChanged", "newConfig", "Landroid/content/res/Configuration;", "onCreate", "savedInstanceState", "Landroid/os/Bundle;", "onDestroy", "showLoading", "Companion", "BaseLib_release"}, k = 1, mv = {1, 1, 15})
...
public class WebActivity extends BaseActivity {
    ...
    private final void initWebSettings() {
        ...
        View findViewById3 = findViewById(R.id.fl_video);
        ...
        webView6.setWebChromeClient(new WebChromeClient() { // from class: com.ipotensic.baselib.base.WebActivity$initWebSettings$4
            WebActivity$initWebSettings$4() {
            }

            @Override // android.webkit.WebChromeClient
            public void onReceivedTitle(WebView view, String r3) {
                super.onReceivedTitle(view, r3);
                DDLog.d("WebActivity", "onReceivedTitle---" + r3);
                WebActivity.access$getTitleView$p(WebActivity.this).setTitle(r3);
            }

            @Override // android.webkit.WebChromeClient
            public boolean onJsAlert(WebView view, String url, String message, JsResult result) {
                DDLog.d("WebActivity", "alert---" + url + message + String.valueOf(result));
            ...
            public void onShowCustomView(View view, WebChromeClient.CustomViewCallback callback) {
                ...
                DDLog.d("WebActivity", "onShowCustomView---");
            }
            ...
            public void onHideCustomView() {
                ...
                DDLog.d("WebActivity", "onHideCustomView---");
            }
        });
        ...
        webView7.setWebViewClient(new WebViewClient() { // from class: com.ipotensic.baselib.base.WebActivity$initWebSettings$5
            WebActivity$initWebSettings$5() {
            }

            @Override // android.webkit.WebViewClient
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                DDLog.d("WebActivity", "[shouldOverrideUrlLoading]" + url);
                if (url != null && (StringsKt.startsWith$default(url, "http://", false, 2, (Object) null) || StringsKt.startsWith$default(url, "https://", false, 2, (Object) null))) {
                    if (StringsKt.endsWith$default(url, ".pdf", false, 2, (Object) null)) {
                        ...
                        WebActivity webActivity = WebActivity.this;
                        ToastUtil.toast(webActivity, webActivity.getString(R.string.toast_no_network));
                        return true;
                    }
                    if (!NetworkUtils.isNetConnected(WebActivity.this)) {
                        WebActivity webActivity2 = WebActivity.this;
                        ToastUtil.toast(webActivity2, webActivity2.getString(R.string.toast_no_network));
                        return true;
                    }
                    if (view == null) {
                        return true;
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                DDLog.d("WebActivity", "[onPageStarted]" + url);
            }

            @Override // android.webkit.WebViewClient
            public void onPageFinished(WebView view, String url) {
                super.onPageFinished(view, url);
                DDLog.d("WebActivity", "[onPageFinished]" + url);
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        DDLog.d(TAG, "[onConfigurationChanged]" + newConfig.orientation);
        ...
        if (i == 1) {
            ...
            frameLayout.postDelayed(new Runnable() { // from class: com.ipotensic.baselib.base.WebActivity$onConfigurationChanged$2
                WebActivity$onConfigurationChanged$2() {
                }
        ...
        frameLayout2.postDelayed(new Runnable() { // from class: com.ipotensic.baselib.base.WebActivity$onConfigurationChanged$1
            WebActivity$onConfigurationChanged$1() {
            }
    ...
    public final void jsMethod(String params) {
        ...
        DDLog.d(TAG, "jsMethod---" + params);
    }

    public final void jsMethodWithCallback(String function) {
        WebView webView = this.webView;
        if (webView == null) {
            Intrinsics.throwUninitializedPropertyAccessException("webView");
        }
        webView.evaluateJavascript("javascript:phoneCallJsMethodWithCallback('" + function + "')", new ValueCallback<String>() { // from class: com.ipotensic.baselib.base.WebActivity$jsMethodWithCallback$1
            ...
            WebActivity$jsMethodWithCallback$1(String function2) {
                r2 = function2;
            }
            ...
            public final void onReceiveValue(String it) {
                ...
                DDLog.d("WebActivity", "jsMethodWithCallback---" + r2 + ",callback=" + it);
            }
        });
    }
