            ...
            public void handleMessage(Message message) {
                ...
                if (i != 1) {
                    ...
                    while (true) {
                        ...
                        if (editText2.isFocused()) {
                            ((OnKeyboardStatusChangeListener) Objects.requireNonNull((OnKeyboardStatusChangeListener) OnKeyboardListener.this.map.get(editText2))).onKeyboardDismiss();
                            break;
                        }
                    }
                    removeMessages(2);
                ...
                while (true) {
                    ...
                    if (editText3.isFocused()) {
                        ((OnKeyboardStatusChangeListener) Objects.requireNonNull((OnKeyboardStatusChangeListener) OnKeyboardListener.this.map.get(editText3))).onKeyboardShow(i2, i3);
                        break;
                    }
                }
                removeMessages(1);
