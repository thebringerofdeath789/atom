...
public class NotchTools implements INotchSupport {
    ...
    /* renamed from: com.ipotensic.baselib.notchtools.NotchTools$1 */
    class AnonymousClass1 implements Runnable {
        final /* synthetic */ Activity val$activity;
        final /* synthetic */ OnNotchCallBack val$notchCallBack;

        AnonymousClass1(Activity activity, OnNotchCallBack onNotchCallBack) {
            r2 = activity;
            r3 = onNotchCallBack;
        }
        ...
        public void run() {
            if (NotchTools.this.notchScreenSupport == null) {
                NotchTools.this.checkScreenSupportInit(r2.getWindow());
            }
            if (NotchTools.this.notchScreenSupport != null) {
                NotchTools.this.notchScreenSupport.fullScreenDontUseStatusForLandscape(r2, r3);
            }
        }
    }
    ...
    public void fullScreenDontUseStatusForLandscape(Activity activity, OnNotchCallBack onNotchCallBack) {
        ThreadUtils.post2UI(new Runnable() { // from class: com.ipotensic.baselib.notchtools.NotchTools.1
            ...
            AnonymousClass1(Activity activity2, OnNotchCallBack onNotchCallBack2) {
                r2 = activity2;
                r3 = onNotchCallBack2;
            }
