...
public class ParseUtil {
    ...
    */
    public static int contain(byte[] bArr, byte[] bArr2) {
        int length;
        int length2;
        ...
        for (int i2 = 0; i2 < i; i2++) {
            for (int i3 = 0; i3 < length2; i3++) {
                ...
                if (i3 == length2 - 1 && bArr[i4] == bArr2[i3]) {
                    return i2;
                }
            }
        }
    ...
    public static long getUnsignedIntFromByteArrLittle(byte[] bArr, int i) {
        ByteBuffer.wrap(bArr).order(ByteOrder.LITTLE_ENDIAN);
        return r2.getInt(i) & 4294967295L;
    }

    public static long getUnsignedIntFromByteArrBig(byte[] bArr, int i) {
