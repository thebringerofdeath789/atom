...
public class ActivityNavigator extends Navigator<Destination> {
    ...
    public static class Destination extends NavDestination {
        ...
        public void onInflate(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0428R.styleable.ActivityNavigator);
            String string = obtainAttributes.getString(C0428R.styleable.ActivityNavigator_android_name);
            if (string != null) {
                setComponentName(new ComponentName(context, (Class<?>) parseClassFromName(context, string, Activity.class)));
            }
            setAction(obtainAttributes.getString(C0428R.styleable.ActivityNavigator_action));
            String string2 = obtainAttributes.getString(C0428R.styleable.ActivityNavigator_data);
            if (string2 != null) {
                setData(Uri.parse(string2));
            }
            setDataPattern(obtainAttributes.getString(C0428R.styleable.ActivityNavigator_dataPattern));
