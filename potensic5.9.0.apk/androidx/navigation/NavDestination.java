...
import androidx.navigation.common.C0429R;
...
public class NavDestination {
    ...
    public void onInflate(Context context, AttributeSet attributeSet) {
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0429R.styleable.Navigator);
        setId(obtainAttributes.getResourceId(C0429R.styleable.Navigator_android_id, 0));
        this.mIdName = getDisplayName(context, this.mId);
        setLabel(obtainAttributes.getText(C0429R.styleable.Navigator_android_label));
