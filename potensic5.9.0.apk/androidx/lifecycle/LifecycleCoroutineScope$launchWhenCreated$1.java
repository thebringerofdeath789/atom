...
@DebugMetadata(m2346c = "androidx.lifecycle.LifecycleCoroutineScope$launchWhenCreated$1", m2347f = "Lifecycle.kt", m2348i = {0}, m2349l = {74}, m2350m = "invokeSuspend", m2351n = {"$this$launch"}, m2352s = {"L$0"})
...
final class LifecycleCoroutineScope$launchWhenCreated$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
        ...
        lifecycleCoroutineScope$launchWhenCreated$1.f38p$ = (CoroutineScope) obj;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            CoroutineScope coroutineScope = this.f38p$;
