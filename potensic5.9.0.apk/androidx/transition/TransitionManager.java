...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo2598clone = transition.mo2598clone();
        mo2598clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo2598clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo2598clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo2598clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo2598clone = transition.mo2598clone();
        sceneChangeSetup(viewGroup, mo2598clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo2598clone);
    }
