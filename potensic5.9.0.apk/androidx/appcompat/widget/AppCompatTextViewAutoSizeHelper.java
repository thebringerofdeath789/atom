...
class AppCompatTextViewAutoSizeHelper {
    ...
    void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        ViewCompat.saveAttributeDataForStyleable(textView, textView.getContext(), C0046R.styleable.AppCompatTextView, attributeSet, obtainStyledAttributes, i, 0);
        ...
        if (obtainStyledAttributes.hasValue(C0046R.styleable.AppCompatTextView_autoSizePresetSizes) && (resourceId = obtainStyledAttributes.getResourceId(C0046R.styleable.AppCompatTextView_autoSizePresetSizes, 0)) > 0) {
