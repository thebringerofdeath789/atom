...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C0046R.styleable.SearchView_layout, C0046R.layout.abc_search_view), (ViewGroup) this, true);
        ...
        View findViewById = findViewById(C0046R.id.search_plate);
        this.mSearchPlate = findViewById;
        View findViewById2 = findViewById(C0046R.id.submit_area);
        ...
        ViewCompat.setBackground(findViewById, obtainStyledAttributes.getDrawable(C0046R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(findViewById2, obtainStyledAttributes.getDrawable(C0046R.styleable.SearchView_submitBackground));
        imageView.setImageDrawable(obtainStyledAttributes.getDrawable(C0046R.styleable.SearchView_searchIcon));
        imageView2.setImageDrawable(obtainStyledAttributes.getDrawable(C0046R.styleable.SearchView_goIcon));
        imageView3.setImageDrawable(obtainStyledAttributes.getDrawable(C0046R.styleable.SearchView_closeIcon));
        imageView4.setImageDrawable(obtainStyledAttributes.getDrawable(C0046R.styleable.SearchView_voiceIcon));
        imageView5.setImageDrawable(obtainStyledAttributes.getDrawable(C0046R.styleable.SearchView_searchIcon));
