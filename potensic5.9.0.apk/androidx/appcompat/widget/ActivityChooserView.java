...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, C0046R.styleable.ActivityChooserView, attributeSet, obtainStyledAttributes, i, 0);
        ...
        View findViewById = findViewById(C0046R.id.activity_chooser_view_content);
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    ...
                    View inflate = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0046R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    inflate.setId(1);
                    ((TextView) inflate.findViewById(C0046R.id.title)).setText(ActivityChooserView.this.getContext().getString(C0046R.string.abc_activity_chooser_view_see_all));
                    return inflate;
                }
                throw new IllegalArgumentException();
            }
