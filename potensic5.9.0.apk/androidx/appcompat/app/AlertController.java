...
class AlertController {
    ...
    private void setupView() {
        ...
        View findViewById2;
        View findViewById3 = this.mWindow.findViewById(C0046R.id.parentPanel);
        View findViewById4 = findViewById3.findViewById(C0046R.id.topPanel);
        View findViewById5 = findViewById3.findViewById(C0046R.id.contentPanel);
        View findViewById6 = findViewById3.findViewById(C0046R.id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById3.findViewById(C0046R.id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById7 = viewGroup.findViewById(C0046R.id.topPanel);
        View findViewById8 = viewGroup.findViewById(C0046R.id.contentPanel);
        View findViewById9 = viewGroup.findViewById(C0046R.id.buttonPanel);
        ...
        if (!z3 && resolvePanel2 != null && (findViewById2 = resolvePanel2.findViewById(C0046R.id.textSpacerNoButtons)) != null) {
        ...
        if (z2 != 0) {
            ...
            View findViewById10 = (this.mMessage == null && this.mListView == null) ? null : resolvePanel.findViewById(C0046R.id.titleDividerNoCustom);
            if (findViewById10 != null) {
                findViewById10.setVisibility(0);
            }
        } else if (resolvePanel2 != null && (findViewById = resolvePanel2.findViewById(C0046R.id.textSpacerNoTitle)) != null) {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View findViewById = this.mWindow.findViewById(C0046R.id.scrollIndicatorUp);
        final View findViewById2 = this.mWindow.findViewById(C0046R.id.scrollIndicatorDown);
