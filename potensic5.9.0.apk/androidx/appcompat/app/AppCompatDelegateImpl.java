    ...
    */
    ...
    private ViewGroup createSubDecor() {
        ...
        if (!this.mWindowNoTitle) {
            if (this.mIsFloating) {
                viewGroup = (ViewGroup) from.inflate(C0046R.layout.abc_dialog_title_material, (ViewGroup) null);
                ...
                viewGroup = (ViewGroup) LayoutInflater.from(context).inflate(C0046R.layout.abc_screen_toolbar, (ViewGroup) null);
            ...
            viewGroup = this.mOverlayActionMode ? (ViewGroup) from.inflate(C0046R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null) : (ViewGroup) from.inflate(C0046R.layout.abc_screen_simple, (ViewGroup) null);
        }
        if (viewGroup == null) {
    ...
    */
    public android.view.View createView(android.view.View r12, java.lang.String r13, android.content.Context r14, android.util.AttributeSet r15) {
        /*
            ...
            int[] r2 = androidx.appcompat.C0046R.styleable.AppCompatTheme
            android.content.res.TypedArray r0 = r0.obtainStyledAttributes(r2)
            int r2 = androidx.appcompat.C0046R.styleable.AppCompatTheme_viewInflaterClass
    ...
    protected static final class PanelFeatureState {
        ...
        void setStyle(Context context) {
            ...
            if (typedValue.resourceId != 0) {
                ...
                newTheme.applyStyle(C0046R.style.Theme_AppCompat_CompactMenu, true);
            }
            androidx.appcompat.view.ContextThemeWrapper contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(context, 0);
