    ...
    private static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                hashMap.put(CameraManager.class, FlightConfig.PRODUCT_CLASS_CAMERA);
                hashMap.put(JobScheduler.class, "jobscheduler");
                hashMap.put(LauncherApps.class, "launcherapps");
                hashMap.put(MediaProjectionManager.class, "media_projection");
                hashMap.put(MediaSessionManager.class, "media_session");
                hashMap.put(RestrictionsManager.class, MapboxMapMatching.IGNORE_RESTRICTIONS);
            ...
            hashMap.put(NotificationManager.class, StepManeuver.NOTIFICATION);
