...
public class TUnmodifiableFloatCharMap implements TFloatCharMap, Serializable {
    ...
    /* renamed from: m */
    private final TFloatCharMap f3681m;
    private transient TFloatSet keySet = null;
    private transient TCharCollection values = null;

    public TUnmodifiableFloatCharMap(TFloatCharMap tFloatCharMap) {
        Objects.requireNonNull(tFloatCharMap);
        this.f3681m = tFloatCharMap;
    }

    @Override // gnu.trove.map.TFloatCharMap
    public int size() {
        return this.f3681m.size();
    }

    @Override // gnu.trove.map.TFloatCharMap
    public boolean isEmpty() {
        return this.f3681m.isEmpty();
    }

    @Override // gnu.trove.map.TFloatCharMap
    public boolean containsKey(float f) {
        return this.f3681m.containsKey(f);
    }

    @Override // gnu.trove.map.TFloatCharMap
    public boolean containsValue(char c) {
        return this.f3681m.containsValue(c);
    }

    @Override // gnu.trove.map.TFloatCharMap
    public char get(float f) {
        return this.f3681m.get(f);
    }
    ...
    public TFloatSet keySet() {
        if (this.keySet == null) {
            this.keySet = TCollections.unmodifiableSet(this.f3681m.keySet());
        }
        return this.keySet;
    }
    ...
    @Override // gnu.trove.map.TFloatCharMap
    public float[] keys() {
        return this.f3681m.keys();
    }

    @Override // gnu.trove.map.TFloatCharMap
    public float[] keys(float[] fArr) {
        return this.f3681m.keys(fArr);
    }

    @Override // gnu.trove.map.TFloatCharMap
    public TCharCollection valueCollection() {
        if (this.values == null) {
            this.values = TCollections.unmodifiableCollection(this.f3681m.valueCollection());
        }
        return this.values;
    }
    ...
    @Override // gnu.trove.map.TFloatCharMap
    public char[] values() {
        return this.f3681m.values();
    }

    @Override // gnu.trove.map.TFloatCharMap
    public char[] values(char[] cArr) {
        return this.f3681m.values(cArr);
    }

    public boolean equals(Object obj) {
        return obj == this || this.f3681m.equals(obj);
    }
    ...
    public String toString() {
        return this.f3681m.toString();
    }

    @Override // gnu.trove.map.TFloatCharMap
    public float getNoEntryKey() {
        return this.f3681m.getNoEntryKey();
    }

    @Override // gnu.trove.map.TFloatCharMap
    public char getNoEntryValue() {
        return this.f3681m.getNoEntryValue();
    }

    @Override // gnu.trove.map.TFloatCharMap
    public boolean forEachKey(TFloatProcedure tFloatProcedure) {
        return this.f3681m.forEachKey(tFloatProcedure);
    }

    @Override // gnu.trove.map.TFloatCharMap
    public boolean forEachValue(TCharProcedure tCharProcedure) {
        return this.f3681m.forEachValue(tCharProcedure);
    }

    @Override // gnu.trove.map.TFloatCharMap
    public boolean forEachEntry(TFloatCharProcedure tFloatCharProcedure) {
        return this.f3681m.forEachEntry(tFloatCharProcedure);
    }
    ...
    public TFloatCharIterator iterator() {
        return new TFloatCharIterator() { // from class: gnu.trove.impl.unmodifiable.TUnmodifiableFloatCharMap.1
            ...
            {
                this.iter = TUnmodifiableFloatCharMap.this.f3681m.iterator();
            }
