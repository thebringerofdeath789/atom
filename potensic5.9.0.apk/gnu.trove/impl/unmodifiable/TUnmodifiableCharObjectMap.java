...
public class TUnmodifiableCharObjectMap<V> implements TCharObjectMap<V>, Serializable {
    ...
    /* renamed from: m */
    private final TCharObjectMap<V> f3668m;
    private transient TCharSet keySet = null;
    private transient Collection<V> values = null;

    public TUnmodifiableCharObjectMap(TCharObjectMap<V> tCharObjectMap) {
        Objects.requireNonNull(tCharObjectMap);
        this.f3668m = tCharObjectMap;
    }

    @Override // gnu.trove.map.TCharObjectMap
    public int size() {
        return this.f3668m.size();
    }

    @Override // gnu.trove.map.TCharObjectMap
    public boolean isEmpty() {
        return this.f3668m.isEmpty();
    }

    @Override // gnu.trove.map.TCharObjectMap
    public boolean containsKey(char c) {
        return this.f3668m.containsKey(c);
    }

    @Override // gnu.trove.map.TCharObjectMap
    public boolean containsValue(Object obj) {
        return this.f3668m.containsValue(obj);
    }

    @Override // gnu.trove.map.TCharObjectMap
    public V get(char c) {
        return this.f3668m.get(c);
    }
    ...
    public TCharSet keySet() {
        if (this.keySet == null) {
            this.keySet = TCollections.unmodifiableSet(this.f3668m.keySet());
        }
        return this.keySet;
    }
    ...
    @Override // gnu.trove.map.TCharObjectMap
    public char[] keys() {
        return this.f3668m.keys();
    }

    @Override // gnu.trove.map.TCharObjectMap
    public char[] keys(char[] cArr) {
        return this.f3668m.keys(cArr);
    }

    @Override // gnu.trove.map.TCharObjectMap
    public Collection<V> valueCollection() {
        if (this.values == null) {
            this.values = Collections.unmodifiableCollection(this.f3668m.valueCollection());
        }
        return this.values;
    }
    ...
    public Object[] values() {
        return this.f3668m.values();
    }

    @Override // gnu.trove.map.TCharObjectMap
    public V[] values(V[] vArr) {
        return this.f3668m.values(vArr);
    }

    @Override // gnu.trove.map.TCharObjectMap
    public boolean equals(Object obj) {
        return obj == this || this.f3668m.equals(obj);
    }

    @Override // gnu.trove.map.TCharObjectMap
    public int hashCode() {
        return this.f3668m.hashCode();
    }

    public String toString() {
        return this.f3668m.toString();
    }

    @Override // gnu.trove.map.TCharObjectMap
    public char getNoEntryKey() {
        return this.f3668m.getNoEntryKey();
    }

    @Override // gnu.trove.map.TCharObjectMap
    public boolean forEachKey(TCharProcedure tCharProcedure) {
        return this.f3668m.forEachKey(tCharProcedure);
    }

    @Override // gnu.trove.map.TCharObjectMap
    public boolean forEachValue(TObjectProcedure<? super V> tObjectProcedure) {
        return this.f3668m.forEachValue(tObjectProcedure);
    }

    @Override // gnu.trove.map.TCharObjectMap
    public boolean forEachEntry(TCharObjectProcedure<? super V> tCharObjectProcedure) {
        return this.f3668m.forEachEntry(tCharObjectProcedure);
    }
    ...
    public TCharObjectIterator<V> iterator() {
        return new TCharObjectIterator<V>() { // from class: gnu.trove.impl.unmodifiable.TUnmodifiableCharObjectMap.1
            ...
            {
                this.iter = TUnmodifiableCharObjectMap.this.f3668m.iterator();
            }
