...
public class TUnmodifiableObjectByteMap<K> implements TObjectByteMap<K>, Serializable {
    ...
    /* renamed from: m */
    private final TObjectByteMap<K> f3710m;
    private transient Set<K> keySet = null;
    private transient TByteCollection values = null;

    public TUnmodifiableObjectByteMap(TObjectByteMap<K> tObjectByteMap) {
        Objects.requireNonNull(tObjectByteMap);
        this.f3710m = tObjectByteMap;
    }

    @Override // gnu.trove.map.TObjectByteMap
    public int size() {
        return this.f3710m.size();
    }

    @Override // gnu.trove.map.TObjectByteMap
    public boolean isEmpty() {
        return this.f3710m.isEmpty();
    }

    @Override // gnu.trove.map.TObjectByteMap
    public boolean containsKey(Object obj) {
        return this.f3710m.containsKey(obj);
    }

    @Override // gnu.trove.map.TObjectByteMap
    public boolean containsValue(byte b) {
        return this.f3710m.containsValue(b);
    }

    @Override // gnu.trove.map.TObjectByteMap
    public byte get(Object obj) {
        return this.f3710m.get(obj);
    }
    ...
    public Set<K> keySet() {
        if (this.keySet == null) {
            this.keySet = Collections.unmodifiableSet(this.f3710m.keySet());
        }
        return this.keySet;
    }
    ...
    @Override // gnu.trove.map.TObjectByteMap
    public Object[] keys() {
        return this.f3710m.keys();
    }

    @Override // gnu.trove.map.TObjectByteMap
    public K[] keys(K[] kArr) {
        return this.f3710m.keys(kArr);
    }

    @Override // gnu.trove.map.TObjectByteMap
    public TByteCollection valueCollection() {
        if (this.values == null) {
            this.values = TCollections.unmodifiableCollection(this.f3710m.valueCollection());
        }
        return this.values;
    }
    ...
    @Override // gnu.trove.map.TObjectByteMap
    public byte[] values() {
        return this.f3710m.values();
    }

    @Override // gnu.trove.map.TObjectByteMap
    public byte[] values(byte[] bArr) {
        return this.f3710m.values(bArr);
    }

    @Override // gnu.trove.map.TObjectByteMap
    public boolean equals(Object obj) {
        return obj == this || this.f3710m.equals(obj);
    }

    @Override // gnu.trove.map.TObjectByteMap
    public int hashCode() {
        return this.f3710m.hashCode();
    }
    ...
    public byte getNoEntryValue() {
        return this.f3710m.getNoEntryValue();
    }

    @Override // gnu.trove.map.TObjectByteMap
    public boolean forEachKey(TObjectProcedure<? super K> tObjectProcedure) {
        return this.f3710m.forEachKey(tObjectProcedure);
    }

    @Override // gnu.trove.map.TObjectByteMap
    public boolean forEachValue(TByteProcedure tByteProcedure) {
        return this.f3710m.forEachValue(tByteProcedure);
    }

    @Override // gnu.trove.map.TObjectByteMap
    public boolean forEachEntry(TObjectByteProcedure<? super K> tObjectByteProcedure) {
        return this.f3710m.forEachEntry(tObjectByteProcedure);
    }
    ...
    public TObjectByteIterator<K> iterator() {
        return new TObjectByteIterator<K>() { // from class: gnu.trove.impl.unmodifiable.TUnmodifiableObjectByteMap.1
            ...
            {
                this.iter = TUnmodifiableObjectByteMap.this.f3710m.iterator();
            }
