...
public class TUnmodifiableCharIntMap implements TCharIntMap, Serializable {
    ...
    /* renamed from: m */
    private final TCharIntMap f3666m;
    private transient TCharSet keySet = null;
    private transient TIntCollection values = null;

    public TUnmodifiableCharIntMap(TCharIntMap tCharIntMap) {
        Objects.requireNonNull(tCharIntMap);
        this.f3666m = tCharIntMap;
    }

    @Override // gnu.trove.map.TCharIntMap
    public int size() {
        return this.f3666m.size();
    }

    @Override // gnu.trove.map.TCharIntMap
    public boolean isEmpty() {
        return this.f3666m.isEmpty();
    }

    @Override // gnu.trove.map.TCharIntMap
    public boolean containsKey(char c) {
        return this.f3666m.containsKey(c);
    }

    @Override // gnu.trove.map.TCharIntMap
    public boolean containsValue(int i) {
        return this.f3666m.containsValue(i);
    }

    @Override // gnu.trove.map.TCharIntMap
    public int get(char c) {
        return this.f3666m.get(c);
    }
    ...
    public TCharSet keySet() {
        if (this.keySet == null) {
            this.keySet = TCollections.unmodifiableSet(this.f3666m.keySet());
        }
        return this.keySet;
    }
    ...
    @Override // gnu.trove.map.TCharIntMap
    public char[] keys() {
        return this.f3666m.keys();
    }

    @Override // gnu.trove.map.TCharIntMap
    public char[] keys(char[] cArr) {
        return this.f3666m.keys(cArr);
    }

    @Override // gnu.trove.map.TCharIntMap
    public TIntCollection valueCollection() {
        if (this.values == null) {
            this.values = TCollections.unmodifiableCollection(this.f3666m.valueCollection());
        }
        return this.values;
    }
    ...
    @Override // gnu.trove.map.TCharIntMap
    public int[] values() {
        return this.f3666m.values();
    }

    @Override // gnu.trove.map.TCharIntMap
    public int[] values(int[] iArr) {
        return this.f3666m.values(iArr);
    }

    public boolean equals(Object obj) {
        return obj == this || this.f3666m.equals(obj);
    }

    public int hashCode() {
        return this.f3666m.hashCode();
    }

    public String toString() {
        return this.f3666m.toString();
    }

    @Override // gnu.trove.map.TCharIntMap
    public char getNoEntryKey() {
        return this.f3666m.getNoEntryKey();
    }

    @Override // gnu.trove.map.TCharIntMap
    public int getNoEntryValue() {
        return this.f3666m.getNoEntryValue();
    }

    @Override // gnu.trove.map.TCharIntMap
    public boolean forEachKey(TCharProcedure tCharProcedure) {
        return this.f3666m.forEachKey(tCharProcedure);
    }

    @Override // gnu.trove.map.TCharIntMap
    public boolean forEachValue(TIntProcedure tIntProcedure) {
        return this.f3666m.forEachValue(tIntProcedure);
    }

    @Override // gnu.trove.map.TCharIntMap
    public boolean forEachEntry(TCharIntProcedure tCharIntProcedure) {
        return this.f3666m.forEachEntry(tCharIntProcedure);
    }
    ...
    public TCharIntIterator iterator() {
        return new TCharIntIterator() { // from class: gnu.trove.impl.unmodifiable.TUnmodifiableCharIntMap.1
            ...
            {
                this.iter = TUnmodifiableCharIntMap.this.f3666m.iterator();
            }
