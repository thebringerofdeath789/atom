...
public class TUnmodifiableFloatFloatMap implements TFloatFloatMap, Serializable {
    ...
    public boolean isEmpty() {
        return this.f3685m.isEmpty();
    }

    @Override // gnu.trove.map.TFloatFloatMap
    public boolean containsKey(float f) {
        return this.f3685m.containsKey(f);
    }

    @Override // gnu.trove.map.TFloatFloatMap
    public boolean containsValue(float f) {
        return this.f3685m.containsValue(f);
    }

    @Override // gnu.trove.map.TFloatFloatMap
    public float get(float f) {
        return this.f3685m.get(f);
    }
    ...
    public TFloatSet keySet() {
        if (this.keySet == null) {
            this.keySet = TCollections.unmodifiableSet(this.f3685m.keySet());
        }
        return this.keySet;
    }
    ...
    @Override // gnu.trove.map.TFloatFloatMap
    public float[] keys() {
        return this.f3685m.keys();
    }

    @Override // gnu.trove.map.TFloatFloatMap
    public float[] keys(float[] fArr) {
        return this.f3685m.keys(fArr);
    }

    @Override // gnu.trove.map.TFloatFloatMap
    public TFloatCollection valueCollection() {
        if (this.values == null) {
            this.values = TCollections.unmodifiableCollection(this.f3685m.valueCollection());
        }
        return this.values;
    }
    ...
    @Override // gnu.trove.map.TFloatFloatMap
    public float[] values() {
        return this.f3685m.values();
    }

    @Override // gnu.trove.map.TFloatFloatMap
    public float[] values(float[] fArr) {
        return this.f3685m.values(fArr);
    }

    public boolean equals(Object obj) {
        return obj == this || this.f3685m.equals(obj);
    }

    public int hashCode() {
        return this.f3685m.hashCode();
    }

    public String toString() {
        return this.f3685m.toString();
    }

    @Override // gnu.trove.map.TFloatFloatMap
    public float getNoEntryKey() {
        return this.f3685m.getNoEntryKey();
    }

    @Override // gnu.trove.map.TFloatFloatMap
    public float getNoEntryValue() {
        return this.f3685m.getNoEntryValue();
    }

    @Override // gnu.trove.map.TFloatFloatMap
    public boolean forEachKey(TFloatProcedure tFloatProcedure) {
        return this.f3685m.forEachKey(tFloatProcedure);
    }

    @Override // gnu.trove.map.TFloatFloatMap
    public boolean forEachValue(TFloatProcedure tFloatProcedure) {
        return this.f3685m.forEachValue(tFloatProcedure);
    }

    @Override // gnu.trove.map.TFloatFloatMap
    public boolean forEachEntry(TFloatFloatProcedure tFloatFloatProcedure) {
        return this.f3685m.forEachEntry(tFloatFloatProcedure);
    }
    ...
    public TFloatFloatIterator iterator() {
        return new TFloatFloatIterator() { // from class: gnu.trove.impl.unmodifiable.TUnmodifiableFloatFloatMap.1
            ...
            {
                this.iter = TUnmodifiableFloatFloatMap.this.f3685m.iterator();
            }
