...
public class TUnmodifiableDoubleByteMap implements TDoubleByteMap, Serializable {
    ...
    public boolean isEmpty() {
        return this.f3670m.isEmpty();
    }

    @Override // gnu.trove.map.TDoubleByteMap
    public boolean containsKey(double d) {
        return this.f3670m.containsKey(d);
    }

    @Override // gnu.trove.map.TDoubleByteMap
    public boolean containsValue(byte b) {
        return this.f3670m.containsValue(b);
    }

    @Override // gnu.trove.map.TDoubleByteMap
    public byte get(double d) {
        return this.f3670m.get(d);
    }
    ...
    public TDoubleSet keySet() {
        if (this.keySet == null) {
            this.keySet = TCollections.unmodifiableSet(this.f3670m.keySet());
        }
        return this.keySet;
    }
    ...
    @Override // gnu.trove.map.TDoubleByteMap
    public double[] keys() {
        return this.f3670m.keys();
    }

    @Override // gnu.trove.map.TDoubleByteMap
    public double[] keys(double[] dArr) {
        return this.f3670m.keys(dArr);
    }

    @Override // gnu.trove.map.TDoubleByteMap
    public TByteCollection valueCollection() {
        if (this.values == null) {
            this.values = TCollections.unmodifiableCollection(this.f3670m.valueCollection());
        }
        return this.values;
    }
    ...
    @Override // gnu.trove.map.TDoubleByteMap
    public byte[] values() {
        return this.f3670m.values();
    }

    @Override // gnu.trove.map.TDoubleByteMap
    public byte[] values(byte[] bArr) {
        return this.f3670m.values(bArr);
    }

    public boolean equals(Object obj) {
        return obj == this || this.f3670m.equals(obj);
    }

    public int hashCode() {
        return this.f3670m.hashCode();
    }

    public String toString() {
        return this.f3670m.toString();
    }

    @Override // gnu.trove.map.TDoubleByteMap
    public double getNoEntryKey() {
        return this.f3670m.getNoEntryKey();
    }

    @Override // gnu.trove.map.TDoubleByteMap
    public byte getNoEntryValue() {
        return this.f3670m.getNoEntryValue();
    }

    @Override // gnu.trove.map.TDoubleByteMap
    public boolean forEachKey(TDoubleProcedure tDoubleProcedure) {
        return this.f3670m.forEachKey(tDoubleProcedure);
    }

    @Override // gnu.trove.map.TDoubleByteMap
    public boolean forEachValue(TByteProcedure tByteProcedure) {
        return this.f3670m.forEachValue(tByteProcedure);
    }

    @Override // gnu.trove.map.TDoubleByteMap
    public boolean forEachEntry(TDoubleByteProcedure tDoubleByteProcedure) {
        return this.f3670m.forEachEntry(tDoubleByteProcedure);
    }
    ...
    public TDoubleByteIterator iterator() {
        return new TDoubleByteIterator() { // from class: gnu.trove.impl.unmodifiable.TUnmodifiableDoubleByteMap.1
            ...
            {
                this.iter = TUnmodifiableDoubleByteMap.this.f3670m.iterator();
            }
