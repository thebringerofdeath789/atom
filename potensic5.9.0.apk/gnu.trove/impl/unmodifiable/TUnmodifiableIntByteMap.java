...
public class TUnmodifiableIntByteMap implements TIntByteMap, Serializable {
    ...
    public boolean isEmpty() {
        return this.f3690m.isEmpty();
    }

    @Override // gnu.trove.map.TIntByteMap
    public boolean containsKey(int i) {
        return this.f3690m.containsKey(i);
    }

    @Override // gnu.trove.map.TIntByteMap
    public boolean containsValue(byte b) {
        return this.f3690m.containsValue(b);
    }

    @Override // gnu.trove.map.TIntByteMap
    public byte get(int i) {
        return this.f3690m.get(i);
    }
    ...
    public TIntSet keySet() {
        if (this.keySet == null) {
            this.keySet = TCollections.unmodifiableSet(this.f3690m.keySet());
        }
        return this.keySet;
    }
    ...
    @Override // gnu.trove.map.TIntByteMap
    public int[] keys() {
        return this.f3690m.keys();
    }

    @Override // gnu.trove.map.TIntByteMap
    public int[] keys(int[] iArr) {
        return this.f3690m.keys(iArr);
    }

    @Override // gnu.trove.map.TIntByteMap
    public TByteCollection valueCollection() {
        if (this.values == null) {
            this.values = TCollections.unmodifiableCollection(this.f3690m.valueCollection());
        }
        return this.values;
    }
    ...
    @Override // gnu.trove.map.TIntByteMap
    public byte[] values() {
        return this.f3690m.values();
    }

    @Override // gnu.trove.map.TIntByteMap
    public byte[] values(byte[] bArr) {
        return this.f3690m.values(bArr);
    }

    public boolean equals(Object obj) {
        return obj == this || this.f3690m.equals(obj);
    }

    public int hashCode() {
        return this.f3690m.hashCode();
    }

    public String toString() {
        return this.f3690m.toString();
    }

    @Override // gnu.trove.map.TIntByteMap
    public int getNoEntryKey() {
        return this.f3690m.getNoEntryKey();
    }

    @Override // gnu.trove.map.TIntByteMap
    public byte getNoEntryValue() {
        return this.f3690m.getNoEntryValue();
    }

    @Override // gnu.trove.map.TIntByteMap
    public boolean forEachKey(TIntProcedure tIntProcedure) {
        return this.f3690m.forEachKey(tIntProcedure);
    }

    @Override // gnu.trove.map.TIntByteMap
    public boolean forEachValue(TByteProcedure tByteProcedure) {
        return this.f3690m.forEachValue(tByteProcedure);
    }

    @Override // gnu.trove.map.TIntByteMap
    public boolean forEachEntry(TIntByteProcedure tIntByteProcedure) {
        return this.f3690m.forEachEntry(tIntByteProcedure);
    }
    ...
    public TIntByteIterator iterator() {
        return new TIntByteIterator() { // from class: gnu.trove.impl.unmodifiable.TUnmodifiableIntByteMap.1
            ...
            {
                this.iter = TUnmodifiableIntByteMap.this.f3690m.iterator();
            }
