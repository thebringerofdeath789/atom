...
public class TFloatSetDecorator extends AbstractSet<Float> implements Set<Float>, Externalizable {
    ...
    public Iterator<Float> iterator() {
        return new Iterator<Float>() { // from class: gnu.trove.decorator.TFloatSetDecorator.1
            ...
            /* renamed from: it */
            private final TFloatIterator f3543it;

            {
                this.f3543it = TFloatSetDecorator.this._set.iterator();
            }

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // java.util.Iterator
            public Float next() {
                return Float.valueOf(this.f3543it.next());
            }

            @Override // java.util.Iterator
            public boolean hasNext() {
                return this.f3543it.hasNext();
            }
