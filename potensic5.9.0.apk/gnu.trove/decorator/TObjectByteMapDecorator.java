...
public class TObjectByteMapDecorator<K> extends AbstractMap<K, Byte> implements Map<K, Byte>, Externalizable, Cloneable {
    ...
    /* renamed from: gnu.trove.decorator.TObjectByteMapDecorator$1 */
    class C34881 extends AbstractSet<Map.Entry<K, Byte>> {
        C34881() {
        }
        ...
        public Iterator<Map.Entry<K, Byte>> iterator() {
            return new Iterator<Map.Entry<K, Byte>>() { // from class: gnu.trove.decorator.TObjectByteMapDecorator.1.1
                ...
                /* renamed from: it */
                private final TObjectByteIterator<K> f3563it;

                {
                    this.f3563it = TObjectByteMapDecorator.this._map.iterator();
                }

                @Override // java.util.Iterator
                public Map.Entry<K, Byte> next() {
                    this.f3563it.advance();
                    return new Map.Entry<K, Byte>(TObjectByteMapDecorator.this.wrapValue(this.f3563it.value()), this.f3563it.key()) { // from class: gnu.trove.decorator.TObjectByteMapDecorator.1.1.1
                        private Byte val;
