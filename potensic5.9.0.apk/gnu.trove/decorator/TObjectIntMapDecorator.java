...
public class TObjectIntMapDecorator<K> extends AbstractMap<K, Integer> implements Map<K, Integer>, Externalizable, Cloneable {
    ...
    /* renamed from: gnu.trove.decorator.TObjectIntMapDecorator$1 */
    class C34921 extends AbstractSet<Map.Entry<K, Integer>> {
        C34921() {
        }
        ...
        public Iterator<Map.Entry<K, Integer>> iterator() {
            return new Iterator<Map.Entry<K, Integer>>() { // from class: gnu.trove.decorator.TObjectIntMapDecorator.1.1
                ...
                /* renamed from: it */
                private final TObjectIntIterator<K> f3567it;

                {
                    this.f3567it = TObjectIntMapDecorator.this._map.iterator();
                }

                @Override // java.util.Iterator
                public Map.Entry<K, Integer> next() {
                    this.f3567it.advance();
                    return new Map.Entry<K, Integer>(TObjectIntMapDecorator.this.wrapValue(this.f3567it.value()), this.f3567it.key()) { // from class: gnu.trove.decorator.TObjectIntMapDecorator.1.1.1
                        private Integer val;
