...
public class TDoubleObjectMapDecorator<V> extends AbstractMap<Double, V> implements Map<Double, V>, Externalizable, Cloneable {
    ...
    /* renamed from: gnu.trove.decorator.TDoubleObjectMapDecorator$1 */
    class C34581 extends AbstractSet<Map.Entry<Double, V>> {
        C34581() {
        }
        ...
        public Iterator<Map.Entry<Double, V>> iterator() {
            return new Iterator<Map.Entry<Double, V>>() { // from class: gnu.trove.decorator.TDoubleObjectMapDecorator.1.1
                ...
                /* renamed from: it */
                private final TDoubleObjectIterator<V> f3533it;

                {
                    this.f3533it = TDoubleObjectMapDecorator.this._map.iterator();
                }

                @Override // java.util.Iterator
                public Map.Entry<Double, V> next() {
                    this.f3533it.advance();
                    double key = this.f3533it.key();
                    return new Map.Entry<Double, V>(this.f3533it.value(), key == TDoubleObjectMapDecorator.this._map.getNoEntryKey() ? null : TDoubleObjectMapDecorator.this.wrapKey(key)) { // from class: gnu.trove.decorator.TDoubleObjectMapDecorator.1.1.1
                        private V val;
