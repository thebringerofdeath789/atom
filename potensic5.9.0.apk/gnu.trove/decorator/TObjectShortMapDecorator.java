...
public class TObjectShortMapDecorator<K> extends AbstractMap<K, Short> implements Map<K, Short>, Externalizable, Cloneable {
    ...
    /* renamed from: gnu.trove.decorator.TObjectShortMapDecorator$1 */
    class C34941 extends AbstractSet<Map.Entry<K, Short>> {
        C34941() {
        }
        ...
        public Iterator<Map.Entry<K, Short>> iterator() {
            return new Iterator<Map.Entry<K, Short>>() { // from class: gnu.trove.decorator.TObjectShortMapDecorator.1.1
                ...
                /* renamed from: it */
                private final TObjectShortIterator<K> f3569it;

                {
                    this.f3569it = TObjectShortMapDecorator.this._map.iterator();
                }

                @Override // java.util.Iterator
                public Map.Entry<K, Short> next() {
                    this.f3569it.advance();
                    return new Map.Entry<K, Short>(TObjectShortMapDecorator.this.wrapValue(this.f3569it.value()), this.f3569it.key()) { // from class: gnu.trove.decorator.TObjectShortMapDecorator.1.1.1
                        private Short val;
