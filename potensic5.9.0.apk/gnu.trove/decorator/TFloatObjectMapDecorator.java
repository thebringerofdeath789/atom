...
public class TFloatObjectMapDecorator<V> extends AbstractMap<Float, V> implements Map<Float, V>, Externalizable, Cloneable {
    ...
    /* renamed from: gnu.trove.decorator.TFloatObjectMapDecorator$1 */
    class C34671 extends AbstractSet<Map.Entry<Float, V>> {
        C34671() {
        }
        ...
        public Iterator<Map.Entry<Float, V>> iterator() {
            return new Iterator<Map.Entry<Float, V>>() { // from class: gnu.trove.decorator.TFloatObjectMapDecorator.1.1
                ...
                /* renamed from: it */
                private final TFloatObjectIterator<V> f3542it;

                {
                    this.f3542it = TFloatObjectMapDecorator.this._map.iterator();
                }

                @Override // java.util.Iterator
                public Map.Entry<Float, V> next() {
                    this.f3542it.advance();
                    float key = this.f3542it.key();
                    return new Map.Entry<Float, V>(this.f3542it.value(), key == TFloatObjectMapDecorator.this._map.getNoEntryKey() ? null : TFloatObjectMapDecorator.this.wrapKey(key)) { // from class: gnu.trove.decorator.TFloatObjectMapDecorator.1.1.1
                        private V val;
