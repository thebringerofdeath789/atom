...
public class TLongObjectMapDecorator<V> extends AbstractMap<Long, V> implements Map<Long, V>, Externalizable, Cloneable {
    ...
    /* renamed from: gnu.trove.decorator.TLongObjectMapDecorator$1 */
    class C34851 extends AbstractSet<Map.Entry<Long, V>> {
        C34851() {
        }
        ...
        public Iterator<Map.Entry<Long, V>> iterator() {
            return new Iterator<Map.Entry<Long, V>>() { // from class: gnu.trove.decorator.TLongObjectMapDecorator.1.1
                ...
                /* renamed from: it */
                private final TLongObjectIterator<V> f3560it;

                {
                    this.f3560it = TLongObjectMapDecorator.this._map.iterator();
                }

                @Override // java.util.Iterator
                public Map.Entry<Long, V> next() {
                    this.f3560it.advance();
                    long key = this.f3560it.key();
                    return new Map.Entry<Long, V>(this.f3560it.value(), key == TLongObjectMapDecorator.this._map.getNoEntryKey() ? null : TLongObjectMapDecorator.this.wrapKey(key)) { // from class: gnu.trove.decorator.TLongObjectMapDecorator.1.1.1
                        private V val;
