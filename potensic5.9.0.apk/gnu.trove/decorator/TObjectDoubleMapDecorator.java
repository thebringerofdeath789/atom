...
public class TObjectDoubleMapDecorator<K> extends AbstractMap<K, Double> implements Map<K, Double>, Externalizable, Cloneable {
    ...
    /* renamed from: gnu.trove.decorator.TObjectDoubleMapDecorator$1 */
    class C34901 extends AbstractSet<Map.Entry<K, Double>> {
        C34901() {
        }
        ...
        public Iterator<Map.Entry<K, Double>> iterator() {
            return new Iterator<Map.Entry<K, Double>>() { // from class: gnu.trove.decorator.TObjectDoubleMapDecorator.1.1
                ...
                /* renamed from: it */
                private final TObjectDoubleIterator<K> f3565it;

                {
                    this.f3565it = TObjectDoubleMapDecorator.this._map.iterator();
                }

                @Override // java.util.Iterator
                public Map.Entry<K, Double> next() {
                    this.f3565it.advance();
                    return new Map.Entry<K, Double>(TObjectDoubleMapDecorator.this.wrapValue(this.f3565it.value()), this.f3565it.key()) { // from class: gnu.trove.decorator.TObjectDoubleMapDecorator.1.1.1
                        private Double val;
