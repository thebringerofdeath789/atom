...
public class TObjectFloatMapDecorator<K> extends AbstractMap<K, Float> implements Map<K, Float>, Externalizable, Cloneable {
    ...
    /* renamed from: gnu.trove.decorator.TObjectFloatMapDecorator$1 */
    class C34911 extends AbstractSet<Map.Entry<K, Float>> {
        C34911() {
        }
        ...
        public Iterator<Map.Entry<K, Float>> iterator() {
            return new Iterator<Map.Entry<K, Float>>() { // from class: gnu.trove.decorator.TObjectFloatMapDecorator.1.1
                ...
                /* renamed from: it */
                private final TObjectFloatIterator<K> f3566it;

                {
                    this.f3566it = TObjectFloatMapDecorator.this._map.iterator();
                }

                @Override // java.util.Iterator
                public Map.Entry<K, Float> next() {
                    this.f3566it.advance();
                    return new Map.Entry<K, Float>(TObjectFloatMapDecorator.this.wrapValue(this.f3566it.value()), this.f3566it.key()) { // from class: gnu.trove.decorator.TObjectFloatMapDecorator.1.1.1
                        private Float val;
