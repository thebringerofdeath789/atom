...
public class TObjectFloatHashMap<K> extends TObjectHash<K> implements TObjectFloatMap<K>, Externalizable {
    ...
    public TObjectFloatHashMap() {
        this.PUT_ALL_PROC = new TObjectFloatProcedure<K>() { // from class: gnu.trove.map.hash.TObjectFloatHashMap.1
            ...
            public boolean execute(K k, float f) {
                TObjectFloatHashMap.this.put(k, f);
                return true;
            }
        };
    ...
    public TObjectFloatHashMap(int i, float f, float f2) {
        ...
        this.PUT_ALL_PROC = new TObjectFloatProcedure<K>() { // from class: gnu.trove.map.hash.TObjectFloatHashMap.1
            ...
            public boolean execute(K k, float f22) {
                TObjectFloatHashMap.this.put(k, f22);
                return true;
            }
        };
    ...
    public TObjectFloatHashMap(TObjectFloatMap<? extends K> tObjectFloatMap) {
        this(tObjectFloatMap.size(), 0.5f, tObjectFloatMap.getNoEntryValue());
        if (tObjectFloatMap instanceof TObjectFloatHashMap) {
            TObjectFloatHashMap tObjectFloatHashMap = (TObjectFloatHashMap) tObjectFloatMap;
            this._loadFactor = Math.abs(tObjectFloatHashMap._loadFactor);
            float f = tObjectFloatHashMap.no_entry_value;
    ...
    protected class KeyView extends TObjectFloatHashMap<K>.MapBackedView<K> {
        ...
        @Override // gnu.trove.map.hash.TObjectFloatHashMap.MapBackedView
        public boolean removeElement(K k) {
            return TObjectFloatHashMap.this.no_entry_value != TObjectFloatHashMap.this.remove(k);
        }
    ...
    class TFloatValueCollection implements TFloatCollection {
        ...
        @Override // gnu.trove.TFloatCollection
        public boolean isEmpty() {
            return TObjectFloatHashMap.this._size == 0;
        }

        @Override // gnu.trove.TFloatCollection
        public boolean contains(float f) {
            return TObjectFloatHashMap.this.containsValue(f);
        }
        ...
        public boolean remove(float f) {
            float[] fArr = TObjectFloatHashMap.this._values;
        ...
        public boolean containsAll(float[] fArr) {
            for (float f : fArr) {
                if (!TObjectFloatHashMap.this.containsValue(f)) {
                    return false;
                }
            }
            return true;
        ...
        public boolean retainAll(float[] fArr) {
            Arrays.sort(fArr);
            float[] fArr2 = TObjectFloatHashMap.this._values;
            Object[] objArr = TObjectFloatHashMap.this._set;
            int length = objArr.length;
            boolean z = false;
            while (true) {
        ...
        public boolean forEach(TFloatProcedure tFloatProcedure) {
            return TObjectFloatHashMap.this.forEachValue(tFloatProcedure);
        }

        public String toString() {
            final StringBuilder sb = new StringBuilder("{");
            TObjectFloatHashMap.this.forEachValue(new TFloatProcedure() { // from class: gnu.trove.map.hash.TObjectFloatHashMap.TFloatValueCollection.1
        ...
        class TObjectFloatValueHashIterator implements TFloatIterator {
            ...
            TObjectFloatValueHashIterator() {
                ...
                this._hash = tObjectFloatHashMap;
                this._expectedSize = tObjectFloatHashMap.size();
