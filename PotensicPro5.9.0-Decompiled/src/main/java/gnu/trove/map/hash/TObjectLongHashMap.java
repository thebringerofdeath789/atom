...
public class TObjectLongHashMap<K> extends TObjectHash<K> implements TObjectLongMap<K>, Externalizable {
    ...
    public TObjectLongHashMap() {
        this.PUT_ALL_PROC = new TObjectLongProcedure<K>() { // from class: gnu.trove.map.hash.TObjectLongHashMap.1
    ...
    public TObjectLongHashMap(TObjectLongMap<? extends K> tObjectLongMap) {
        this(tObjectLongMap.size(), 0.5f, tObjectLongMap.getNoEntryValue());
        if (tObjectLongMap instanceof TObjectLongHashMap) {
            TObjectLongHashMap tObjectLongHashMap = (TObjectLongHashMap) tObjectLongMap;
            this._loadFactor = Math.abs(tObjectLongHashMap._loadFactor);
            long j = tObjectLongHashMap.no_entry_value;
            this.no_entry_value = j;
            if (j != 0) {
                Arrays.fill(this._values, j);
            }
    ...
    protected class KeyView extends TObjectLongHashMap<K>.MapBackedView<K> {
        ...
        @Override // gnu.trove.map.hash.TObjectLongHashMap.MapBackedView
        public boolean removeElement(K k) {
            return TObjectLongHashMap.this.no_entry_value != TObjectLongHashMap.this.remove(k);
        }
    ...
    class TLongValueCollection implements TLongCollection {
        ...
        public boolean remove(long j) {
            long[] jArr = TObjectLongHashMap.this._values;
        ...
        public boolean retainAll(long[] jArr) {
            Arrays.sort(jArr);
            long[] jArr2 = TObjectLongHashMap.this._values;
            Object[] objArr = TObjectLongHashMap.this._set;
            int length = objArr.length;
            boolean z = false;
            while (true) {
        ...
        public boolean forEach(TLongProcedure tLongProcedure) {
            return TObjectLongHashMap.this.forEachValue(tLongProcedure);
        }

        public String toString() {
            final StringBuilder sb = new StringBuilder("{");
            TObjectLongHashMap.this.forEachValue(new TLongProcedure() { // from class: gnu.trove.map.hash.TObjectLongHashMap.TLongValueCollection.1
        ...
        class TObjectLongValueHashIterator implements TLongIterator {
            ...
            TObjectLongValueHashIterator() {
                ...
                this._hash = tObjectLongHashMap;
                this._expectedSize = tObjectLongHashMap.size();
    ...
    class TObjectLongHashIterator<K> extends TObjectHashIterator<K> implements TObjectLongIterator<K> {
        ...
        public TObjectLongHashIterator(TObjectLongHashMap<K> tObjectLongHashMap) {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("{");
        forEachEntry(new TObjectLongProcedure<K>() { // from class: gnu.trove.map.hash.TObjectLongHashMap.2
            private boolean first = true;
