...
public class TObjectDoubleCustomHashMap<K> extends TCustomObjectHash<K> implements TObjectDoubleMap<K>, Externalizable {
    ...
    class TDoubleValueCollection implements TDoubleCollection {
        ...
        @Override // gnu.trove.TDoubleCollection
        public boolean isEmpty() {
            return TObjectDoubleCustomHashMap.this._size == 0;
        }
        ...
        public String toString() {
            ...
            TObjectDoubleCustomHashMap.this.forEachValue(new TDoubleProcedure() { // from class: gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap.TDoubleValueCollection.1
        ...
        class TObjectDoubleValueHashIterator implements TDoubleIterator {
            ...
            TObjectDoubleValueHashIterator() {
                ...
                this._hash = tObjectDoubleCustomHashMap;
                this._expectedSize = tObjectDoubleCustomHashMap.size();
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("{");
        forEachEntry(new TObjectDoubleProcedure<K>() { // from class: gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap.2
            private boolean first = true;
