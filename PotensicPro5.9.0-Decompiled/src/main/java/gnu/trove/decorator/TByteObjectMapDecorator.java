...
public class TByteObjectMapDecorator<V> extends AbstractMap<Byte, V> implements Map<Byte, V>, Externalizable, Cloneable {
    ...
    class AnonymousClass1 extends AbstractSet<Map.Entry<Byte, V>> {
        AnonymousClass1() {
        }
        ...
        public Iterator<Map.Entry<Byte, V>> iterator() {
            return new Iterator<Map.Entry<Byte, V>>() { // from class: gnu.trove.decorator.TByteObjectMapDecorator.1.1
                ...
                public Map.Entry<Byte, V> next() {
                    ...
                    return new Map.Entry<Byte, V>(this.it.value(), key == TByteObjectMapDecorator.this._map.getNoEntryKey() ? null : TByteObjectMapDecorator.this.wrapKey(key)) { // from class: gnu.trove.decorator.TByteObjectMapDecorator.1.1.1
                        private V val;
