...
public class TShortObjectMapDecorator<V> extends AbstractMap<Short, V> implements Map<Short, V>, Externalizable, Cloneable {
    ...
    class AnonymousClass1 extends AbstractSet<Map.Entry<Short, V>> {
        AnonymousClass1() {
        }
        ...
        public Iterator<Map.Entry<Short, V>> iterator() {
            return new Iterator<Map.Entry<Short, V>>() { // from class: gnu.trove.decorator.TShortObjectMapDecorator.1.1
                ...
                public Map.Entry<Short, V> next() {
                    ...
                    return new Map.Entry<Short, V>(this.it.value(), key == TShortObjectMapDecorator.this._map.getNoEntryKey() ? null : TShortObjectMapDecorator.this.wrapKey(key)) { // from class: gnu.trove.decorator.TShortObjectMapDecorator.1.1.1
                        private V val;
