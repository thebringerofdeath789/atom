...
public class TCharObjectMapDecorator<V> extends AbstractMap<Character, V> implements Map<Character, V>, Externalizable, Cloneable {
    ...
    /* renamed from: gnu.trove.decorator.TCharObjectMapDecorator$1, reason: invalid class name */
    class AnonymousClass1 extends AbstractSet<Map.Entry<Character, V>> {
        AnonymousClass1() {
        }
        ...
        public Iterator<Map.Entry<Character, V>> iterator() {
            return new Iterator<Map.Entry<Character, V>>() { // from class: gnu.trove.decorator.TCharObjectMapDecorator.1.1
                ...
                public Map.Entry<Character, V> next() {
                    ...
                    return new Map.Entry<Character, V>(this.it.value(), key == TCharObjectMapDecorator.this._map.getNoEntryKey() ? null : TCharObjectMapDecorator.this.wrapKey(key)) { // from class: gnu.trove.decorator.TCharObjectMapDecorator.1.1.1
                        private V val;
