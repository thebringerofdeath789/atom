...
public class TIntObjectMapDecorator<V> extends AbstractMap<Integer, V> implements Map<Integer, V>, Externalizable, Cloneable {
    ...
    class AnonymousClass1 extends AbstractSet<Map.Entry<Integer, V>> {
        AnonymousClass1() {
        }
        ...
        public Iterator<Map.Entry<Integer, V>> iterator() {
            return new Iterator<Map.Entry<Integer, V>>() { // from class: gnu.trove.decorator.TIntObjectMapDecorator.1.1
                ...
                public Map.Entry<Integer, V> next() {
                    this.it.advance();
                    int key = this.it.key();
                    return new Map.Entry<Integer, V>(this.it.value(), key == TIntObjectMapDecorator.this._map.getNoEntryKey() ? null : TIntObjectMapDecorator.this.wrapKey(key)) { // from class: gnu.trove.decorator.TIntObjectMapDecorator.1.1.1
                        private V val;
