...
public final class HttpHeaders {
    ...
    */
    ...
    public static final boolean promisesBody(Response promisesBody) {
        ...
        return (((code >= 100 && code < 200) || code == 204 || code == 304) && Util.headersContentLength(promisesBody) == -1 && !StringsKt.equals(HttpHeaders.Values.CHUNKED, Response.header$default(promisesBody, "Transfer-Encoding", null, 2, null), true)) ? false : true;
    }
