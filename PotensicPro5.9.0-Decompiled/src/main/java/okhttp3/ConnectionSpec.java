...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m1401deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m1403deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public String toString() {
        return !this.isTls ? "ConnectionSpec()" : "ConnectionSpec(cipherSuites=" + Objects.toString(cipherSuites(), "[all enabled]") + ", tlsVersions=" + Objects.toString(tlsVersions(), "[all enabled]") + ", supportsTlsExtensions=" + this.supportsTlsExtensions + PropertyUtils.MAPPED_DELIM2;
    }
