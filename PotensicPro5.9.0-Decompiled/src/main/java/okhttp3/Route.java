...
public final class Route {
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = GeocodingCriteria.TYPE_ADDRESS, imports = {}))
