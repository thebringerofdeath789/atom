...
public final class Address {
    ...
    public final List<Protocol> m1378deprecated_protocols() {
        return this.protocols;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "connectionSpecs", imports = {}))
    /* renamed from: -deprecated_connectionSpecs, reason: not valid java name */
    public final List<ConnectionSpec> m1375deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }
    ...
    public String toString() {
        ...
        Object obj;
        StringBuilder append2 = new StringBuilder().append("Address{").append(this.url.host()).append(NameUtil.COLON).append(this.url.port()).append(", ");
        if (this.proxy != null) {
        ...
        return append2.append(append.append(obj).toString()).append(StringSubstitutor.DEFAULT_VAR_END).toString();
    }
}
