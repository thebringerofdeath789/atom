...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public final List<Interceptor> m1472deprecated_interceptors() {
        return this.interceptors;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "networkInterceptors", imports = {}))
    /* renamed from: -deprecated_networkInterceptors, reason: not valid java name */
    public final List<Interceptor> m1473deprecated_networkInterceptors() {
        return this.networkInterceptors;
    }
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = StringLookupFactory.KEY_DNS, imports = {}))
    ...
    public final SSLSocketFactory m1482deprecated_sslSocketFactory() {
        return sslSocketFactory();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "connectionSpecs", imports = {}))
    /* renamed from: -deprecated_connectionSpecs, reason: not valid java name */
    public final List<ConnectionSpec> m1464deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }
    ...
    public static final class Builder {
        ...
        public final Builder m1484addInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
        ...
        public final Builder m1485addNetworkInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
            Intrinsics.checkNotNullParameter(block, "block");
        ...
        public final Builder callTimeout(long timeout, TimeUnit unit) {
            ...
            Builder builder = this;
            builder.callTimeout = Util.checkDuration(RtspHeaders.Values.TIMEOUT, timeout, unit);
            return builder;
        }
        ...
        public final Builder connectTimeout(long timeout, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            Builder builder = this;
            builder.connectTimeout = Util.checkDuration(RtspHeaders.Values.TIMEOUT, timeout, unit);
            return builder;
        }
        ...
        public final Builder readTimeout(long timeout, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            Builder builder = this;
            builder.readTimeout = Util.checkDuration(RtspHeaders.Values.TIMEOUT, timeout, unit);
            return builder;
        }
        ...
        public final Builder writeTimeout(long timeout, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            Builder builder = this;
            builder.writeTimeout = Util.checkDuration(RtspHeaders.Values.TIMEOUT, timeout, unit);
            return builder;
        }
