...
public final class LoggingEventListener extends EventListener {
    ...
    private final void logWithTime(String message) {
        this.logger.log(PropertyUtils.INDEXED_DELIM + TimeUnit.NANOSECONDS.toMillis(System.nanoTime() - this.startNs) + " ms] " + message);
    }
