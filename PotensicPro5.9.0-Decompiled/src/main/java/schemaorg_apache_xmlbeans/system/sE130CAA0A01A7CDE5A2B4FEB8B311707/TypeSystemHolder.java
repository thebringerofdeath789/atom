...
public class TypeSystemHolder {
    ...
    static /* synthetic */ Class class$schemaorg_apache_xmlbeans$system$sE130CAA0A01A7CDE5A2B4FEB8B311707$TypeSystemHolder;
    ...
    private static final SchemaTypeSystem loadTypeSystem() {
        try {
            Class cls = class$schemaorg_apache_xmlbeans$system$sE130CAA0A01A7CDE5A2B4FEB8B311707$TypeSystemHolder;
            if (cls == null) {
                cls = class$("schemaorg_apache_xmlbeans.system.sE130CAA0A01A7CDE5A2B4FEB8B311707.TypeSystemHolder");
                class$schemaorg_apache_xmlbeans$system$sE130CAA0A01A7CDE5A2B4FEB8B311707$TypeSystemHolder = cls;
            }
            ...
            Class cls4 = class$schemaorg_apache_xmlbeans$system$sE130CAA0A01A7CDE5A2B4FEB8B311707$TypeSystemHolder;
            if (cls4 == null) {
                cls4 = class$("schemaorg_apache_xmlbeans.system.sE130CAA0A01A7CDE5A2B4FEB8B311707.TypeSystemHolder");
                class$schemaorg_apache_xmlbeans$system$sE130CAA0A01A7CDE5A2B4FEB8B311707$TypeSystemHolder = cls4;
            }
            objArr[0] = cls4;
