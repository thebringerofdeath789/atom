...
public class TypeSystemHolder {
    ...
    static /* synthetic */ Class class$schemaorg_apache_xmlbeans$system$sXMLCONFIG$TypeSystemHolder;
    ...
    private static final SchemaTypeSystem loadTypeSystem() {
        try {
            Class cls = class$schemaorg_apache_xmlbeans$system$sXMLCONFIG$TypeSystemHolder;
            if (cls == null) {
                cls = class$("schemaorg_apache_xmlbeans.system.sXMLCONFIG.TypeSystemHolder");
                class$schemaorg_apache_xmlbeans$system$sXMLCONFIG$TypeSystemHolder = cls;
            }
            ...
            Class cls4 = class$schemaorg_apache_xmlbeans$system$sXMLCONFIG$TypeSystemHolder;
            if (cls4 == null) {
                cls4 = class$("schemaorg_apache_xmlbeans.system.sXMLCONFIG.TypeSystemHolder");
                class$schemaorg_apache_xmlbeans$system$sXMLCONFIG$TypeSystemHolder = cls4;
            }
            objArr[0] = cls4;
