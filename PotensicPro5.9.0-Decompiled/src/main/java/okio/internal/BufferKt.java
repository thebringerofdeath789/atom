...
public final class BufferKt {
    ...
    /* JADX WARN: Removed duplicated region for block: B:48:0x00ce A[EDGE_INSN: B:48:0x00ce->B:42:0x00ce BREAK  A[LOOP:0: B:4:0x0016->B:47:?], SYNTHETIC] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:39:0x00bb A[EDGE_INSN: B:39:0x00bb->B:36:0x00bb BREAK  A[LOOP:0: B:4:0x0012->B:38:?], SYNTHETIC] */
    ...
    */
    ...
    public static final int commonReadUtf8CodePoint(Buffer commonReadUtf8CodePoint) {
        ...
        if (commonReadUtf8CodePoint.size() < j) {
            throw new EOFException("size < " + i2 + ": " + commonReadUtf8CodePoint.size() + " (to read code point prefixed 0x" + Util.toHexString(b) + PropertyUtils.MAPPED_DELIM2);
        }
