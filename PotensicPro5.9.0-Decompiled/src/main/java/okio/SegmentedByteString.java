...
public final class SegmentedByteString extends ByteString {
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        ...
        if (!(endIndex <= size())) {
            throw new IllegalArgumentException(("endIndex=" + endIndex + " > length(" + size() + PropertyUtils.MAPPED_DELIM2).toString());
        }
