...
public final class buffer implements BufferedSource {
    ...
    */
    ...
    public String toString() {
        return "buffer(" + this.source + PropertyUtils.MAPPED_DELIM2;
    }
}
