...
public class XercesDOMAdapter extends AbstractDOMAdapter {
    ...
    public Document getDocument(InputStream inputStream, boolean z) throws IOException, JDOMException {
        try {
            ...
            method.invoke(newInstance, "http://xml.org/sax/features/namespaces", new Boolean(true));
            if (z) {
            ...
            if (targetException instanceof SAXParseException) {
                ...
                throw new JDOMException(new StringBuffer("Error on line ").append(sAXParseException.getLineNumber()).append(" of XML document: ").append(sAXParseException.getMessage()).toString(), e);
            }
