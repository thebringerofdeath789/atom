...
public interface CTSchemeColor extends XmlObject {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(CTSchemeColor.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sE130CAA0A01A7CDE5A2B4FEB8B311707").resolveHandle("ctschemecolor5feftype");
    ...
    public static final class Factory {
        ...
        public static CTSchemeColor newInstance() {
            return (CTSchemeColor) XmlBeans.getContextTypeLoader().newInstance(CTSchemeColor.type, null);
        }

        public static CTSchemeColor newInstance(XmlOptions xmlOptions) {
            return (CTSchemeColor) XmlBeans.getContextTypeLoader().newInstance(CTSchemeColor.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xMLInputStream, CTSchemeColor.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xMLInputStream, CTSchemeColor.type, xmlOptions);
        }

        public static CTSchemeColor parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSchemeColor) XmlBeans.getContextTypeLoader().parse(xMLStreamReader, CTSchemeColor.type, (XmlOptions) null);
        }

        public static CTSchemeColor parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSchemeColor) XmlBeans.getContextTypeLoader().parse(xMLStreamReader, CTSchemeColor.type, xmlOptions);
        }

        public static CTSchemeColor parse(File file) throws XmlException, IOException {
            return (CTSchemeColor) XmlBeans.getContextTypeLoader().parse(file, CTSchemeColor.type, (XmlOptions) null);
        }

        public static CTSchemeColor parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSchemeColor) XmlBeans.getContextTypeLoader().parse(file, CTSchemeColor.type, xmlOptions);
        }

        public static CTSchemeColor parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSchemeColor) XmlBeans.getContextTypeLoader().parse(inputStream, CTSchemeColor.type, (XmlOptions) null);
        }

        public static CTSchemeColor parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSchemeColor) XmlBeans.getContextTypeLoader().parse(inputStream, CTSchemeColor.type, xmlOptions);
        }

        public static CTSchemeColor parse(Reader reader) throws XmlException, IOException {
            return (CTSchemeColor) XmlBeans.getContextTypeLoader().parse(reader, CTSchemeColor.type, (XmlOptions) null);
        }

        public static CTSchemeColor parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSchemeColor) XmlBeans.getContextTypeLoader().parse(reader, CTSchemeColor.type, xmlOptions);
        }

        public static CTSchemeColor parse(String str) throws XmlException {
            return (CTSchemeColor) XmlBeans.getContextTypeLoader().parse(str, CTSchemeColor.type, (XmlOptions) null);
        }

        public static CTSchemeColor parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTSchemeColor) XmlBeans.getContextTypeLoader().parse(str, CTSchemeColor.type, xmlOptions);
        }

        public static CTSchemeColor parse(URL url) throws XmlException, IOException {
            return (CTSchemeColor) XmlBeans.getContextTypeLoader().parse(url, CTSchemeColor.type, (XmlOptions) null);
        }

        public static CTSchemeColor parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSchemeColor) XmlBeans.getContextTypeLoader().parse(url, CTSchemeColor.type, xmlOptions);
        }

        public static CTSchemeColor parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTSchemeColor) XmlBeans.getContextTypeLoader().parse(xMLInputStream, CTSchemeColor.type, (XmlOptions) null);
        }
        ...
        public static CTSchemeColor parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSchemeColor) XmlBeans.getContextTypeLoader().parse(xMLInputStream, CTSchemeColor.type, xmlOptions);
        }

        public static CTSchemeColor parse(Node node) throws XmlException {
            return (CTSchemeColor) XmlBeans.getContextTypeLoader().parse(node, CTSchemeColor.type, (XmlOptions) null);
        }

        public static CTSchemeColor parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSchemeColor) XmlBeans.getContextTypeLoader().parse(node, CTSchemeColor.type, xmlOptions);
        }
    }
