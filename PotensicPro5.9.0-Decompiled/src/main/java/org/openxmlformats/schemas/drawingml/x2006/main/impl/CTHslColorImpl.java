...
public class CTHslColorImpl extends XmlComplexContentImpl implements CTHslColor {
    ...
    public int getHue2() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(HUE2$56);
            if (simpleValue == null) {
                return 0;
            }
    ...
    public int getLum2() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(LUM2$60);
            if (simpleValue == null) {
                return 0;
            }
            return simpleValue.getIntValue();
    ...
    public int getSat2() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(SAT2$58);
            if (simpleValue == null) {
                return 0;
            }
            return simpleValue.getIntValue();
    ...
    public STPositiveFixedAngle xgetHue2() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            sTPositiveFixedAngle = (STPositiveFixedAngle) get_store().find_attribute_user(HUE2$56);
        }
    ...
    public STPercentage xgetLum2() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            sTPercentage = (STPercentage) get_store().find_attribute_user(LUM2$60);
        }
        return sTPercentage;
    }
    ...
    public STPercentage xgetSat2() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            sTPercentage = (STPercentage) get_store().find_attribute_user(SAT2$58);
        }
        return sTPercentage;
    }
