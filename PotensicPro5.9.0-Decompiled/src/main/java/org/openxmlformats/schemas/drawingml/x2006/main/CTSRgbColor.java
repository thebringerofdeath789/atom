...
public interface CTSRgbColor extends XmlObject {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(CTSRgbColor.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sE130CAA0A01A7CDE5A2B4FEB8B311707").resolveHandle("ctsrgbcolor5bdatype");
    ...
    public static final class Factory {
        ...
        public static CTSRgbColor newInstance() {
            return (CTSRgbColor) XmlBeans.getContextTypeLoader().newInstance(CTSRgbColor.type, null);
        }

        public static CTSRgbColor newInstance(XmlOptions xmlOptions) {
            return (CTSRgbColor) XmlBeans.getContextTypeLoader().newInstance(CTSRgbColor.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xMLInputStream, CTSRgbColor.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xMLInputStream, CTSRgbColor.type, xmlOptions);
        }

        public static CTSRgbColor parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSRgbColor) XmlBeans.getContextTypeLoader().parse(xMLStreamReader, CTSRgbColor.type, (XmlOptions) null);
        }

        public static CTSRgbColor parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSRgbColor) XmlBeans.getContextTypeLoader().parse(xMLStreamReader, CTSRgbColor.type, xmlOptions);
        }

        public static CTSRgbColor parse(File file) throws XmlException, IOException {
            return (CTSRgbColor) XmlBeans.getContextTypeLoader().parse(file, CTSRgbColor.type, (XmlOptions) null);
        }

        public static CTSRgbColor parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSRgbColor) XmlBeans.getContextTypeLoader().parse(file, CTSRgbColor.type, xmlOptions);
        }

        public static CTSRgbColor parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSRgbColor) XmlBeans.getContextTypeLoader().parse(inputStream, CTSRgbColor.type, (XmlOptions) null);
        }

        public static CTSRgbColor parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSRgbColor) XmlBeans.getContextTypeLoader().parse(inputStream, CTSRgbColor.type, xmlOptions);
        }

        public static CTSRgbColor parse(Reader reader) throws XmlException, IOException {
            return (CTSRgbColor) XmlBeans.getContextTypeLoader().parse(reader, CTSRgbColor.type, (XmlOptions) null);
        }

        public static CTSRgbColor parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSRgbColor) XmlBeans.getContextTypeLoader().parse(reader, CTSRgbColor.type, xmlOptions);
        }

        public static CTSRgbColor parse(String str) throws XmlException {
            return (CTSRgbColor) XmlBeans.getContextTypeLoader().parse(str, CTSRgbColor.type, (XmlOptions) null);
        }

        public static CTSRgbColor parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTSRgbColor) XmlBeans.getContextTypeLoader().parse(str, CTSRgbColor.type, xmlOptions);
        }

        public static CTSRgbColor parse(URL url) throws XmlException, IOException {
            return (CTSRgbColor) XmlBeans.getContextTypeLoader().parse(url, CTSRgbColor.type, (XmlOptions) null);
        }

        public static CTSRgbColor parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSRgbColor) XmlBeans.getContextTypeLoader().parse(url, CTSRgbColor.type, xmlOptions);
        }

        public static CTSRgbColor parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTSRgbColor) XmlBeans.getContextTypeLoader().parse(xMLInputStream, CTSRgbColor.type, (XmlOptions) null);
        }
        ...
        public static CTSRgbColor parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSRgbColor) XmlBeans.getContextTypeLoader().parse(xMLInputStream, CTSRgbColor.type, xmlOptions);
        }

        public static CTSRgbColor parse(Node node) throws XmlException {
            return (CTSRgbColor) XmlBeans.getContextTypeLoader().parse(node, CTSRgbColor.type, (XmlOptions) null);
        }

        public static CTSRgbColor parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSRgbColor) XmlBeans.getContextTypeLoader().parse(node, CTSRgbColor.type, xmlOptions);
        }
    }
    ...
    void xsetVal(STHexBinary3 sTHexBinary3);
}
