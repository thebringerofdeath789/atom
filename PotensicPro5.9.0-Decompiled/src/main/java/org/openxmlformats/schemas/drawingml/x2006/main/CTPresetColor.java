...
public interface CTPresetColor extends XmlObject {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(CTPresetColor.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sE130CAA0A01A7CDE5A2B4FEB8B311707").resolveHandle("ctpresetcolora675type");
    ...
    public static final class Factory {
        ...
        public static CTPresetColor newInstance() {
            return (CTPresetColor) XmlBeans.getContextTypeLoader().newInstance(CTPresetColor.type, null);
        }

        public static CTPresetColor newInstance(XmlOptions xmlOptions) {
            return (CTPresetColor) XmlBeans.getContextTypeLoader().newInstance(CTPresetColor.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xMLInputStream, CTPresetColor.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xMLInputStream, CTPresetColor.type, xmlOptions);
        }

        public static CTPresetColor parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTPresetColor) XmlBeans.getContextTypeLoader().parse(xMLStreamReader, CTPresetColor.type, (XmlOptions) null);
        }

        public static CTPresetColor parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTPresetColor) XmlBeans.getContextTypeLoader().parse(xMLStreamReader, CTPresetColor.type, xmlOptions);
        }

        public static CTPresetColor parse(File file) throws XmlException, IOException {
            return (CTPresetColor) XmlBeans.getContextTypeLoader().parse(file, CTPresetColor.type, (XmlOptions) null);
        }

        public static CTPresetColor parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPresetColor) XmlBeans.getContextTypeLoader().parse(file, CTPresetColor.type, xmlOptions);
        }

        public static CTPresetColor parse(InputStream inputStream) throws XmlException, IOException {
            return (CTPresetColor) XmlBeans.getContextTypeLoader().parse(inputStream, CTPresetColor.type, (XmlOptions) null);
        }

        public static CTPresetColor parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPresetColor) XmlBeans.getContextTypeLoader().parse(inputStream, CTPresetColor.type, xmlOptions);
        }

        public static CTPresetColor parse(Reader reader) throws XmlException, IOException {
            return (CTPresetColor) XmlBeans.getContextTypeLoader().parse(reader, CTPresetColor.type, (XmlOptions) null);
        }

        public static CTPresetColor parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPresetColor) XmlBeans.getContextTypeLoader().parse(reader, CTPresetColor.type, xmlOptions);
        }

        public static CTPresetColor parse(String str) throws XmlException {
            return (CTPresetColor) XmlBeans.getContextTypeLoader().parse(str, CTPresetColor.type, (XmlOptions) null);
        }

        public static CTPresetColor parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTPresetColor) XmlBeans.getContextTypeLoader().parse(str, CTPresetColor.type, xmlOptions);
        }

        public static CTPresetColor parse(URL url) throws XmlException, IOException {
            return (CTPresetColor) XmlBeans.getContextTypeLoader().parse(url, CTPresetColor.type, (XmlOptions) null);
        }

        public static CTPresetColor parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPresetColor) XmlBeans.getContextTypeLoader().parse(url, CTPresetColor.type, xmlOptions);
        }

        public static CTPresetColor parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTPresetColor) XmlBeans.getContextTypeLoader().parse(xMLInputStream, CTPresetColor.type, (XmlOptions) null);
        }
        ...
        public static CTPresetColor parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTPresetColor) XmlBeans.getContextTypeLoader().parse(xMLInputStream, CTPresetColor.type, xmlOptions);
        }

        public static CTPresetColor parse(Node node) throws XmlException {
            return (CTPresetColor) XmlBeans.getContextTypeLoader().parse(node, CTPresetColor.type, (XmlOptions) null);
        }

        public static CTPresetColor parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTPresetColor) XmlBeans.getContextTypeLoader().parse(node, CTPresetColor.type, xmlOptions);
        }
    }
