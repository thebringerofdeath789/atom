...
public class CTFontReferenceImpl extends XmlComplexContentImpl implements CTFontReference {
    ...
    public void xsetIdx(STFontCollectionIndex sTFontCollectionIndex) {
        synchronized (monitor()) {
            ...
            TypeStore typeStore = get_store();
            QName qName = IDX$12;
            STFontCollectionIndex sTFontCollectionIndex2 = (STFontCollectionIndex) typeStore.find_attribute_user(qName);
            if (sTFontCollectionIndex2 == null) {
                sTFontCollectionIndex2 = (STFontCollectionIndex) get_store().add_attribute_user(qName);
            }
