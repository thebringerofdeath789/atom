...
public interface CTFtnEdn extends XmlObject {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(CTFtnEdn.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sE130CAA0A01A7CDE5A2B4FEB8B311707").resolveHandle("ctftnedncad9type");
    ...
    public static final class Factory {
        ...
        public static CTFtnEdn newInstance() {
            return (CTFtnEdn) XmlBeans.getContextTypeLoader().newInstance(CTFtnEdn.type, null);
        }

        public static CTFtnEdn newInstance(XmlOptions xmlOptions) {
            return (CTFtnEdn) XmlBeans.getContextTypeLoader().newInstance(CTFtnEdn.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xMLInputStream, CTFtnEdn.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xMLInputStream, CTFtnEdn.type, xmlOptions);
        }

        public static CTFtnEdn parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTFtnEdn) XmlBeans.getContextTypeLoader().parse(xMLStreamReader, CTFtnEdn.type, (XmlOptions) null);
        }

        public static CTFtnEdn parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTFtnEdn) XmlBeans.getContextTypeLoader().parse(xMLStreamReader, CTFtnEdn.type, xmlOptions);
        }

        public static CTFtnEdn parse(File file) throws XmlException, IOException {
            return (CTFtnEdn) XmlBeans.getContextTypeLoader().parse(file, CTFtnEdn.type, (XmlOptions) null);
        }

        public static CTFtnEdn parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFtnEdn) XmlBeans.getContextTypeLoader().parse(file, CTFtnEdn.type, xmlOptions);
        }

        public static CTFtnEdn parse(InputStream inputStream) throws XmlException, IOException {
            return (CTFtnEdn) XmlBeans.getContextTypeLoader().parse(inputStream, CTFtnEdn.type, (XmlOptions) null);
        }

        public static CTFtnEdn parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFtnEdn) XmlBeans.getContextTypeLoader().parse(inputStream, CTFtnEdn.type, xmlOptions);
        }

        public static CTFtnEdn parse(Reader reader) throws XmlException, IOException {
            return (CTFtnEdn) XmlBeans.getContextTypeLoader().parse(reader, CTFtnEdn.type, (XmlOptions) null);
        }

        public static CTFtnEdn parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFtnEdn) XmlBeans.getContextTypeLoader().parse(reader, CTFtnEdn.type, xmlOptions);
        }

        public static CTFtnEdn parse(String str) throws XmlException {
            return (CTFtnEdn) XmlBeans.getContextTypeLoader().parse(str, CTFtnEdn.type, (XmlOptions) null);
        }

        public static CTFtnEdn parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTFtnEdn) XmlBeans.getContextTypeLoader().parse(str, CTFtnEdn.type, xmlOptions);
        }

        public static CTFtnEdn parse(URL url) throws XmlException, IOException {
            return (CTFtnEdn) XmlBeans.getContextTypeLoader().parse(url, CTFtnEdn.type, (XmlOptions) null);
        }

        public static CTFtnEdn parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFtnEdn) XmlBeans.getContextTypeLoader().parse(url, CTFtnEdn.type, xmlOptions);
        }

        public static CTFtnEdn parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTFtnEdn) XmlBeans.getContextTypeLoader().parse(xMLInputStream, CTFtnEdn.type, (XmlOptions) null);
        }

        public static CTFtnEdn parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTFtnEdn) XmlBeans.getContextTypeLoader().parse(xMLInputStream, CTFtnEdn.type, xmlOptions);
        }

        public static CTFtnEdn parse(Node node) throws XmlException {
            return (CTFtnEdn) XmlBeans.getContextTypeLoader().parse(node, CTFtnEdn.type, (XmlOptions) null);
        }

        public static CTFtnEdn parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTFtnEdn) XmlBeans.getContextTypeLoader().parse(node, CTFtnEdn.type, xmlOptions);
        }
    }
