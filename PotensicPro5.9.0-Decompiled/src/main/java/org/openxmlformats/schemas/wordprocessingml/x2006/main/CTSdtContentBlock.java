...
public interface CTSdtContentBlock extends XmlObject {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(CTSdtContentBlock.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sE130CAA0A01A7CDE5A2B4FEB8B311707").resolveHandle("ctsdtcontentblockb37btype");
    ...
    public static final class Factory {
        ...
        public static CTSdtContentBlock newInstance() {
            return (CTSdtContentBlock) XmlBeans.getContextTypeLoader().newInstance(CTSdtContentBlock.type, null);
        }

        public static CTSdtContentBlock newInstance(XmlOptions xmlOptions) {
            return (CTSdtContentBlock) XmlBeans.getContextTypeLoader().newInstance(CTSdtContentBlock.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xMLInputStream, CTSdtContentBlock.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xMLInputStream, CTSdtContentBlock.type, xmlOptions);
        }

        public static CTSdtContentBlock parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSdtContentBlock) XmlBeans.getContextTypeLoader().parse(xMLStreamReader, CTSdtContentBlock.type, (XmlOptions) null);
        }

        public static CTSdtContentBlock parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentBlock) XmlBeans.getContextTypeLoader().parse(xMLStreamReader, CTSdtContentBlock.type, xmlOptions);
        }

        public static CTSdtContentBlock parse(File file) throws XmlException, IOException {
            return (CTSdtContentBlock) XmlBeans.getContextTypeLoader().parse(file, CTSdtContentBlock.type, (XmlOptions) null);
        }

        public static CTSdtContentBlock parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentBlock) XmlBeans.getContextTypeLoader().parse(file, CTSdtContentBlock.type, xmlOptions);
        }

        public static CTSdtContentBlock parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSdtContentBlock) XmlBeans.getContextTypeLoader().parse(inputStream, CTSdtContentBlock.type, (XmlOptions) null);
        }

        public static CTSdtContentBlock parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentBlock) XmlBeans.getContextTypeLoader().parse(inputStream, CTSdtContentBlock.type, xmlOptions);
        }

        public static CTSdtContentBlock parse(Reader reader) throws XmlException, IOException {
            return (CTSdtContentBlock) XmlBeans.getContextTypeLoader().parse(reader, CTSdtContentBlock.type, (XmlOptions) null);
        }

        public static CTSdtContentBlock parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentBlock) XmlBeans.getContextTypeLoader().parse(reader, CTSdtContentBlock.type, xmlOptions);
        }

        public static CTSdtContentBlock parse(String str) throws XmlException {
            return (CTSdtContentBlock) XmlBeans.getContextTypeLoader().parse(str, CTSdtContentBlock.type, (XmlOptions) null);
        }

        public static CTSdtContentBlock parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentBlock) XmlBeans.getContextTypeLoader().parse(str, CTSdtContentBlock.type, xmlOptions);
        }

        public static CTSdtContentBlock parse(URL url) throws XmlException, IOException {
            return (CTSdtContentBlock) XmlBeans.getContextTypeLoader().parse(url, CTSdtContentBlock.type, (XmlOptions) null);
        }

        public static CTSdtContentBlock parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentBlock) XmlBeans.getContextTypeLoader().parse(url, CTSdtContentBlock.type, xmlOptions);
        }

        public static CTSdtContentBlock parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTSdtContentBlock) XmlBeans.getContextTypeLoader().parse(xMLInputStream, CTSdtContentBlock.type, (XmlOptions) null);
        }
        ...
        public static CTSdtContentBlock parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSdtContentBlock) XmlBeans.getContextTypeLoader().parse(xMLInputStream, CTSdtContentBlock.type, xmlOptions);
        }

        public static CTSdtContentBlock parse(Node node) throws XmlException {
            return (CTSdtContentBlock) XmlBeans.getContextTypeLoader().parse(node, CTSdtContentBlock.type, (XmlOptions) null);
        }

        public static CTSdtContentBlock parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentBlock) XmlBeans.getContextTypeLoader().parse(node, CTSdtContentBlock.type, xmlOptions);
        }
    }
