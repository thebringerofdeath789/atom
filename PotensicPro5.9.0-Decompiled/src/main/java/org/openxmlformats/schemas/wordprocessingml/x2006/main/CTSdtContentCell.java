...
public interface CTSdtContentCell extends XmlObject {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(CTSdtContentCell.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sE130CAA0A01A7CDE5A2B4FEB8B311707").resolveHandle("ctsdtcontentcellb170type");
    ...
    public static final class Factory {
        ...
        public static CTSdtContentCell newInstance() {
            return (CTSdtContentCell) XmlBeans.getContextTypeLoader().newInstance(CTSdtContentCell.type, null);
        }

        public static CTSdtContentCell newInstance(XmlOptions xmlOptions) {
            return (CTSdtContentCell) XmlBeans.getContextTypeLoader().newInstance(CTSdtContentCell.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xMLInputStream, CTSdtContentCell.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xMLInputStream, CTSdtContentCell.type, xmlOptions);
        }

        public static CTSdtContentCell parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSdtContentCell) XmlBeans.getContextTypeLoader().parse(xMLStreamReader, CTSdtContentCell.type, (XmlOptions) null);
        }

        public static CTSdtContentCell parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentCell) XmlBeans.getContextTypeLoader().parse(xMLStreamReader, CTSdtContentCell.type, xmlOptions);
        }

        public static CTSdtContentCell parse(File file) throws XmlException, IOException {
            return (CTSdtContentCell) XmlBeans.getContextTypeLoader().parse(file, CTSdtContentCell.type, (XmlOptions) null);
        }

        public static CTSdtContentCell parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentCell) XmlBeans.getContextTypeLoader().parse(file, CTSdtContentCell.type, xmlOptions);
        }

        public static CTSdtContentCell parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSdtContentCell) XmlBeans.getContextTypeLoader().parse(inputStream, CTSdtContentCell.type, (XmlOptions) null);
        }

        public static CTSdtContentCell parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentCell) XmlBeans.getContextTypeLoader().parse(inputStream, CTSdtContentCell.type, xmlOptions);
        }

        public static CTSdtContentCell parse(Reader reader) throws XmlException, IOException {
            return (CTSdtContentCell) XmlBeans.getContextTypeLoader().parse(reader, CTSdtContentCell.type, (XmlOptions) null);
        }

        public static CTSdtContentCell parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentCell) XmlBeans.getContextTypeLoader().parse(reader, CTSdtContentCell.type, xmlOptions);
        }

        public static CTSdtContentCell parse(String str) throws XmlException {
            return (CTSdtContentCell) XmlBeans.getContextTypeLoader().parse(str, CTSdtContentCell.type, (XmlOptions) null);
        }

        public static CTSdtContentCell parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentCell) XmlBeans.getContextTypeLoader().parse(str, CTSdtContentCell.type, xmlOptions);
        }

        public static CTSdtContentCell parse(URL url) throws XmlException, IOException {
            return (CTSdtContentCell) XmlBeans.getContextTypeLoader().parse(url, CTSdtContentCell.type, (XmlOptions) null);
        }

        public static CTSdtContentCell parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentCell) XmlBeans.getContextTypeLoader().parse(url, CTSdtContentCell.type, xmlOptions);
        }

        public static CTSdtContentCell parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTSdtContentCell) XmlBeans.getContextTypeLoader().parse(xMLInputStream, CTSdtContentCell.type, (XmlOptions) null);
        }
        ...
        public static CTSdtContentCell parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSdtContentCell) XmlBeans.getContextTypeLoader().parse(xMLInputStream, CTSdtContentCell.type, xmlOptions);
        }

        public static CTSdtContentCell parse(Node node) throws XmlException {
            return (CTSdtContentCell) XmlBeans.getContextTypeLoader().parse(node, CTSdtContentCell.type, (XmlOptions) null);
        }

        public static CTSdtContentCell parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentCell) XmlBeans.getContextTypeLoader().parse(node, CTSdtContentCell.type, xmlOptions);
        }
    }
