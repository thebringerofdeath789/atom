...
public class CTCommentImpl extends CTTrackChangeImpl implements CTComment {
    ...
    public String getInitials() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(INITIALS$60);
            if (simpleValue == null) {
                return null;
            }
    ...
    public boolean isSetInitials() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            z = get_store().find_attribute_user(INITIALS$60) != null;
        }
        return z;
    }
    ...
    public STString xgetInitials() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            sTString = (STString) get_store().find_attribute_user(INITIALS$60);
        }
        return sTString;
    }
