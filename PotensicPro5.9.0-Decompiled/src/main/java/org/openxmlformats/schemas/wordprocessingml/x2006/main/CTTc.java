...
public interface CTTc extends XmlObject {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(CTTc.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sE130CAA0A01A7CDE5A2B4FEB8B311707").resolveHandle("cttc4019type");
    ...
    public static final class Factory {
        ...
        public static CTTc newInstance() {
            return (CTTc) XmlBeans.getContextTypeLoader().newInstance(CTTc.type, null);
        }

        public static CTTc newInstance(XmlOptions xmlOptions) {
            return (CTTc) XmlBeans.getContextTypeLoader().newInstance(CTTc.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xMLInputStream, CTTc.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xMLInputStream, CTTc.type, xmlOptions);
        }

        public static CTTc parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTTc) XmlBeans.getContextTypeLoader().parse(xMLStreamReader, CTTc.type, (XmlOptions) null);
        }

        public static CTTc parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTTc) XmlBeans.getContextTypeLoader().parse(xMLStreamReader, CTTc.type, xmlOptions);
        }

        public static CTTc parse(File file) throws XmlException, IOException {
            return (CTTc) XmlBeans.getContextTypeLoader().parse(file, CTTc.type, (XmlOptions) null);
        }

        public static CTTc parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTc) XmlBeans.getContextTypeLoader().parse(file, CTTc.type, xmlOptions);
        }

        public static CTTc parse(InputStream inputStream) throws XmlException, IOException {
            return (CTTc) XmlBeans.getContextTypeLoader().parse(inputStream, CTTc.type, (XmlOptions) null);
        }

        public static CTTc parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTc) XmlBeans.getContextTypeLoader().parse(inputStream, CTTc.type, xmlOptions);
        }

        public static CTTc parse(Reader reader) throws XmlException, IOException {
            return (CTTc) XmlBeans.getContextTypeLoader().parse(reader, CTTc.type, (XmlOptions) null);
        }

        public static CTTc parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTc) XmlBeans.getContextTypeLoader().parse(reader, CTTc.type, xmlOptions);
        }

        public static CTTc parse(String str) throws XmlException {
            return (CTTc) XmlBeans.getContextTypeLoader().parse(str, CTTc.type, (XmlOptions) null);
        }

        public static CTTc parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTTc) XmlBeans.getContextTypeLoader().parse(str, CTTc.type, xmlOptions);
        }

        public static CTTc parse(URL url) throws XmlException, IOException {
            return (CTTc) XmlBeans.getContextTypeLoader().parse(url, CTTc.type, (XmlOptions) null);
        }

        public static CTTc parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTc) XmlBeans.getContextTypeLoader().parse(url, CTTc.type, xmlOptions);
        }

        public static CTTc parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTTc) XmlBeans.getContextTypeLoader().parse(xMLInputStream, CTTc.type, (XmlOptions) null);
        }

        public static CTTc parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTTc) XmlBeans.getContextTypeLoader().parse(xMLInputStream, CTTc.type, xmlOptions);
        }

        public static CTTc parse(Node node) throws XmlException {
            return (CTTc) XmlBeans.getContextTypeLoader().parse(node, CTTc.type, (XmlOptions) null);
        }

        public static CTTc parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTTc) XmlBeans.getContextTypeLoader().parse(node, CTTc.type, xmlOptions);
        }
    }
