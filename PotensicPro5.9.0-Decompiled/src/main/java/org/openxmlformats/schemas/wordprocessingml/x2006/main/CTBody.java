...
public interface CTBody extends XmlObject {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(CTBody.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sE130CAA0A01A7CDE5A2B4FEB8B311707").resolveHandle("ctbody0f06type");
    ...
    public static final class Factory {
        ...
        public static CTBody newInstance() {
            return (CTBody) XmlBeans.getContextTypeLoader().newInstance(CTBody.type, null);
        }

        public static CTBody newInstance(XmlOptions xmlOptions) {
            return (CTBody) XmlBeans.getContextTypeLoader().newInstance(CTBody.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xMLInputStream, CTBody.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xMLInputStream, CTBody.type, xmlOptions);
        }

        public static CTBody parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTBody) XmlBeans.getContextTypeLoader().parse(xMLStreamReader, CTBody.type, (XmlOptions) null);
        }

        public static CTBody parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTBody) XmlBeans.getContextTypeLoader().parse(xMLStreamReader, CTBody.type, xmlOptions);
        }

        public static CTBody parse(File file) throws XmlException, IOException {
            return (CTBody) XmlBeans.getContextTypeLoader().parse(file, CTBody.type, (XmlOptions) null);
        }

        public static CTBody parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTBody) XmlBeans.getContextTypeLoader().parse(file, CTBody.type, xmlOptions);
        }

        public static CTBody parse(InputStream inputStream) throws XmlException, IOException {
            return (CTBody) XmlBeans.getContextTypeLoader().parse(inputStream, CTBody.type, (XmlOptions) null);
        }

        public static CTBody parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTBody) XmlBeans.getContextTypeLoader().parse(inputStream, CTBody.type, xmlOptions);
        }

        public static CTBody parse(Reader reader) throws XmlException, IOException {
            return (CTBody) XmlBeans.getContextTypeLoader().parse(reader, CTBody.type, (XmlOptions) null);
        }

        public static CTBody parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTBody) XmlBeans.getContextTypeLoader().parse(reader, CTBody.type, xmlOptions);
        }

        public static CTBody parse(String str) throws XmlException {
            return (CTBody) XmlBeans.getContextTypeLoader().parse(str, CTBody.type, (XmlOptions) null);
        }

        public static CTBody parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTBody) XmlBeans.getContextTypeLoader().parse(str, CTBody.type, xmlOptions);
        }

        public static CTBody parse(URL url) throws XmlException, IOException {
            return (CTBody) XmlBeans.getContextTypeLoader().parse(url, CTBody.type, (XmlOptions) null);
        }

        public static CTBody parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTBody) XmlBeans.getContextTypeLoader().parse(url, CTBody.type, xmlOptions);
        }

        public static CTBody parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTBody) XmlBeans.getContextTypeLoader().parse(xMLInputStream, CTBody.type, (XmlOptions) null);
        }

        public static CTBody parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTBody) XmlBeans.getContextTypeLoader().parse(xMLInputStream, CTBody.type, xmlOptions);
        }

        public static CTBody parse(Node node) throws XmlException {
            return (CTBody) XmlBeans.getContextTypeLoader().parse(node, CTBody.type, (XmlOptions) null);
        }

        public static CTBody parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTBody) XmlBeans.getContextTypeLoader().parse(node, CTBody.type, xmlOptions);
        }
    }
