...
public final class Vlookup extends Var3or4ArgFunction {
    ...
    public ValueEval evaluate(int i, int i2, ValueEval valueEval, ValueEval valueEval2, ValueEval valueEval3, ValueEval valueEval4) {
        try {
            ...
            return createResultColumnVector(resolveTableArrayArg, LookupUtils.resolveRowOrColIndexArg(valueEval3, i, i2)).getItem(LookupUtils.lookupIndexOfValue(singleValue, LookupUtils.createColumnVector(resolveTableArrayArg, 0), LookupUtils.resolveRangeLookupArg(valueEval4, i, i2)));
