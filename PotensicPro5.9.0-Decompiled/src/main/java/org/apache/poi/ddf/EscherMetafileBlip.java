...
public final class EscherMetafileBlip extends EscherBlipRecord {
    ...
    private static byte[] inflatePictureData(byte[] bArr) {
        try {
            ...
            log.log(5, (Object) "Possibly corrupt compression or non-compressed data", (Throwable) e);
            return bArr;
        }
    }
