...
public class FTP extends SocketClient {
    ...
    public int eprt(InetAddress inetAddress, int i) throws IOException {
        ...
        if (inetAddress instanceof Inet4Address) {
            ...
            sb.append(GeoFence.BUNDLE_KEY_CUSTOMID);
        }
        sb.append("|");
    ...
    public int mfmt(String str, String str2) throws IOException {
        return sendCommand(FTPCmd.MFMT, str2 + StringUtils.SPACE + str);
    }
    ...
    public void setStrictReplyParsing(boolean z) {
        this.strictReplyParsing = z;
    }
