...
public class HashCodeBuilder implements Builder<Integer> {
    ...
    private static void reflectionAppend(Object obj, Class<?> cls, HashCodeBuilder hashCodeBuilder, boolean z, String[] strArr) {
        ...
        try {
            register(obj);
            Field[] fieldArr = (Field[]) ArraySorter.sort(cls.getDeclaredFields(), Comparator.comparing(new Function() { // from class: org.apache.commons.lang3.builder.-$$Lambda$HashCodeBuilder$MuwDFrbA3G-IcKVjEbH-HfGjxvU
