...
public class TypeUtils {
    ...
    public static String toLongString(TypeVariable<?> typeVariable) {
        ...
        return sb.append(NameUtil.COLON).append(typeVariableToString(typeVariable)).toString();
    }
    ...
    public static <T> Typed<T> wrap(final Type type) {
        return new Typed() { // from class: org.apache.commons.lang3.reflect.-$$Lambda$TypeUtils$LoeBJ4gkfiUh35ETfPCcYRwhxCY
