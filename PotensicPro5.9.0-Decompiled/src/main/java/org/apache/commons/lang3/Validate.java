...
public class Validate {
    ...
    public static <T> T notNull(T t, final String str, final Object... objArr) {
        return (T) Objects.requireNonNull(t, (Supplier<String>) new Supplier() { // from class: org.apache.commons.lang3.-$$Lambda$Validate$XJJZURDO20sZXXyZMfTRRv13t2c
    ...
    public static <T> T[] notEmpty(T[] tArr, final String str, final Object... objArr) {
        Objects.requireNonNull(tArr, (Supplier<String>) new Supplier() { // from class: org.apache.commons.lang3.-$$Lambda$Validate$AYaavOEfqpRFmoi53Nb4zHgtdgg
            @Override // java.util.function.Supplier
            public final Object get() {
                String format;
                format = String.format(str, objArr);
    ...
    public static <T extends Collection<?>> T notEmpty(T t, final String str, final Object... objArr) {
        Objects.requireNonNull(t, (Supplier<String>) new Supplier() { // from class: org.apache.commons.lang3.-$$Lambda$Validate$FznvsGQuYiKATcRsBqMSYuNyTz8
            @Override // java.util.function.Supplier
            public final Object get() {
                String format;
                format = String.format(str, objArr);
    ...
    public static <T extends Map<?, ?>> T notEmpty(T t, final String str, final Object... objArr) {
        Objects.requireNonNull(t, (Supplier<String>) new Supplier() { // from class: org.apache.commons.lang3.-$$Lambda$Validate$gREza8BL5yDc1L-8frhKK9GN6TQ
            @Override // java.util.function.Supplier
            public final Object get() {
                String format;
                format = String.format(str, objArr);
    ...
    public static <T extends CharSequence> T notEmpty(T t, final String str, final Object... objArr) {
        Objects.requireNonNull(t, (Supplier<String>) new Supplier() { // from class: org.apache.commons.lang3.-$$Lambda$Validate$EsAPntgHB3V26gK-4DhMXps2B-s
            @Override // java.util.function.Supplier
            public final Object get() {
                String format;
                format = String.format(str, objArr);
    ...
    public static <T extends CharSequence> T notBlank(T t, final String str, final Object... objArr) {
        Objects.requireNonNull(t, (Supplier<String>) new Supplier() { // from class: org.apache.commons.lang3.-$$Lambda$Validate$RLoV1XlAEbKKCB-mN0C0at150lk
            @Override // java.util.function.Supplier
            public final Object get() {
                String format;
                format = String.format(str, objArr);
