...
public class SchemaAttributeGroupImpl implements SchemaAttributeGroup {
    ...
    static /* synthetic */ Class class$org$apache$xmlbeans$impl$schema$SchemaAttributeGroupImpl;
    ...
    static {
        if (class$org$apache$xmlbeans$impl$schema$SchemaAttributeGroupImpl == null) {
            class$org$apache$xmlbeans$impl$schema$SchemaAttributeGroupImpl = class$("org.apache.xmlbeans.impl.schema.SchemaAttributeGroupImpl");
        }
