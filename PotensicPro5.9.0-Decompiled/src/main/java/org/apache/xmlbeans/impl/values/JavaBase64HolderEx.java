...
public abstract class JavaBase64HolderEx extends JavaBase64Holder {
    ...
    public static void validateValue(byte[] bArr, SchemaType schemaType, ValidationContext validationContext) {
        ...
        if (facet != null && (intValue3 = ((XmlObjectBase) facet).bigIntegerValue().intValue()) != bArr.length) {
            validationContext.invalid(XmlErrorCodes.DATATYPE_LENGTH_VALID$BINARY, new Object[]{XmlErrorCodes.BASE64BINARY, new Integer(bArr.length), new Integer(intValue3), QNameHelper.readable(schemaType)});
        }
        ...
        if (facet2 != null && (intValue2 = ((XmlObjectBase) facet2).bigIntegerValue().intValue()) > bArr.length) {
            validationContext.invalid(XmlErrorCodes.DATATYPE_MIN_LENGTH_VALID$BINARY, new Object[]{XmlErrorCodes.BASE64BINARY, new Integer(bArr.length), new Integer(intValue2), QNameHelper.readable(schemaType)});
        }
        ...
        if (facet3 != null && (intValue = ((XmlObjectBase) facet3).bigIntegerValue().intValue()) < bArr.length) {
            validationContext.invalid(XmlErrorCodes.DATATYPE_MAX_LENGTH_VALID$BINARY, new Object[]{XmlErrorCodes.BASE64BINARY, new Integer(bArr.length), new Integer(intValue), QNameHelper.readable(schemaType)});
        }
