...
public final class Ac3Util {
    ...
    private static final int[] BITRATE_BY_HALF_FRMSIZECOD = {32, 40, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256, Utils.TARGET_SIZE_MINI_THUMBNAIL, 384, 448, 512, 576, 640};
    private static final int[] SYNCFRAME_SIZE_WORDS_BY_HALF_FRMSIZECOD_44_1 = {69, 87, 104, 121, 139, 174, 208, TelnetCommand.BREAK, 278, 348, 417, 487, 557, 696, 835, 975, 1114, 1253, 1393};
    ...
    public static SyncFrameInfo parseAc3SyncframeInfo(ParsableBitArray parsableBitArray) {
        ...
        if (z) {
            ...
            i3 = CHANNEL_COUNT_BY_ACMOD[readBits4] + (readBit ? 1 : 0);
            ...
            i2 = 1536;
            i3 = CHANNEL_COUNT_BY_ACMOD[readBits8] + (parsableBitArray.readBit() ? 1 : 0);
            i4 = -1;
            str = str2;
        }
        return new SyncFrameInfo(str, i4, i3, i, ac3SyncframeSize, i2);
    }
