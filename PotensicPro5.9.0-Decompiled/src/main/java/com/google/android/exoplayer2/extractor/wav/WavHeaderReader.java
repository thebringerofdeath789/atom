...
final class WavHeaderReader {
    ...
    public static WavHeader peek(ExtractorInput extractorInput) throws IOException {
        ...
        if (readInt != 1463899717) {
            Log.e(TAG, new StringBuilder(36).append("Unsupported RIFF format: ").append(readInt).toString());
            return null;
        }
    ...
    public static Pair<Long, Long> skipToData(ExtractorInput extractorInput) throws IOException {
        ...
        while (peek.id != 1684108385) {
            ...
            if (j > 2147483647L) {
                throw new ParserException(new StringBuilder(51).append("Chunk is too large (~2GB+) to skip; id: ").append(peek.id).toString());
            }
