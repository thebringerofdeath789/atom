...
public final class NalUnitUtil {
    ...
    public static boolean isNalUnitSei(String str, byte b) {
        ...
        return MimeTypes.VIDEO_H265.equals(str) && ((b & UsbConfig.SEND_FUNCTION_CODE_REMOTE_CONTROL) >> 1) == 39;
    }
    ...
    public static int getH265NalUnitType(byte[] bArr, int i) {
        return (bArr[i + 3] & UsbConfig.SEND_FUNCTION_CODE_REMOTE_CONTROL) >> 1;
    }
