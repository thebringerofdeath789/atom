...
public final class Cea608Decoder extends CeaDecoder {
    ...
    private static final int[] SPECIAL_ES_FR_CHARACTER_SET = {193, 201, 211, 218, 220, TelnetCommand.WONT, 8216, 161, 42, 39, 8212, 169, 8480, 8226, 8220, 8221, 192, HSSFShapeTypes.ActionButtonBackPrevious, 199, 200, 202, 203, 235, 206, 207, 239, FTPReply.DIRECTORY_STATUS, 217, TelnetCommand.GA, 219, 171, 187};
    private static final int[] SPECIAL_PT_DE_CHARACTER_SET = {HSSFShapeTypes.ActionButtonEnd, FTPReply.ENTERING_PASSIVE_MODE, NNTPReply.CLOSING_CONNECTION, 204, TelnetCommand.EOF, 210, 242, FTPReply.FILE_STATUS, TelnetCommand.AO, 123, 125, 92, 94, 95, 124, 126, HSSFShapeTypes.ActionButtonBeginning, 228, 214, TelnetCommand.AYT, NNTPReply.ARTICLE_RETRIEVED_REQUEST_TEXT_SEPARATELY, 165, 164, 9474, HSSFShapeTypes.ActionButtonReturn, FTPReply.ENTERING_EPSV_MODE, 216, TelnetCommand.EL, 9484, 9488, 9492, 9496};
