...
public class DefaultDashChunkSource implements DashChunkSource {
    ...
    private long getNowPeriodTimeUs(long j) {
        return this.manifest.availabilityStartTimeMs == C.TIME_UNSET ? C.TIME_UNSET : j - C.msToUs(this.manifest.availabilityStartTimeMs + this.manifest.getPeriod(this.periodIndex).startMs);
    }
