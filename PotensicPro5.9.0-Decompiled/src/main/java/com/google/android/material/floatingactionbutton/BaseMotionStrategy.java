...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    AnimatorSet createAnimator(MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(RtspHeaders.SCALE)) {
            arrayList.add(motionSpec.getAnimator(RtspHeaders.SCALE, this.fab, View.SCALE_Y));
            arrayList.add(motionSpec.getAnimator(RtspHeaders.SCALE, this.fab, View.SCALE_X));
        }
