...
public class EventBus {
    ...
    static final class LoggingHandler implements SubscriberExceptionHandler {
        ...
        private static String message(SubscriberExceptionContext subscriberExceptionContext) {
            ...
            return "Exception thrown by subscriber method " + subscriberMethod.getName() + PropertyUtils.MAPPED_DELIM + subscriberMethod.getParameterTypes()[0].getName() + PropertyUtils.MAPPED_DELIM2 + " on subscriber " + subscriberExceptionContext.getSubscriber() + " when dispatching event: " + subscriberExceptionContext.getEvent();
        }
    }
}
