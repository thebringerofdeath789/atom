    ...
    */
    public com.baidu.location.BDLocation call() {
        /*
            ...
            int r1 = r1.length
            if (r1 <= 0) goto L9b
            com.baidu.location.e.h r0 = r11.b
            com.baidu.location.e.f r0 = com.baidu.location.e.h.a(r0)
        ...
        L18:
            int r5 = r0.length
            if (r3 >= r5) goto L31
            android.content.Context r4 = com.baidu.location.e.h.p()     // Catch: java.lang.Exception -> L2a
        ...
        L31:
            if (r4 == 0) goto L5f
            android.content.Context r0 = com.baidu.location.e.h.p()     // Catch: java.lang.Throwable -> L54 java.lang.Exception -> L5b
            ...
            android.net.Uri r6 = com.baidu.location.e.h.b(r0)     // Catch: java.lang.Throwable -> L54 java.lang.Exception -> L5b
            java.lang.String[] r7 = r11.a     // Catch: java.lang.Throwable -> L54 java.lang.Exception -> L5b
            r8 = 0
            r9 = 0
            r10 = 0
            android.database.Cursor r0 = r5.query(r6, r7, r8, r9, r10)     // Catch: java.lang.Throwable -> L54 java.lang.Exception -> L5b
            com.baidu.location.BDLocation r2 = com.baidu.location.e.j.a(r0)     // Catch: java.lang.Throwable -> L51 java.lang.Exception -> L5c
            if (r0 == 0) goto L8b
        L50:
            goto L88
        L51:
        ...
        L5f:
            ...
            java.lang.String[] r1 = r11.a
            r0.<init>(r1)
            com.baidu.location.e.h r1 = r11.b     // Catch: java.lang.Throwable -> L7e java.lang.Exception -> L85
            com.baidu.location.e.c r1 = com.baidu.location.e.h.b(r1)     // Catch: java.lang.Throwable -> L7e java.lang.Exception -> L85
            android.database.Cursor r0 = r1.a(r0)     // Catch: java.lang.Throwable -> L7e java.lang.Exception -> L85
            com.baidu.location.BDLocation r1 = com.baidu.location.e.j.a(r0)     // Catch: java.lang.Throwable -> L7b java.lang.Exception -> L86
            if (r0 == 0) goto L79
        ...
        L9b:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.baidu.location.e.i.call():com.baidu.location.BDLocation");
    }
}
