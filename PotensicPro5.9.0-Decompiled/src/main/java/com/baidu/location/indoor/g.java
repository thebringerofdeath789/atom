...
class g extends ScanCallback {
    ...
    */
    public void onScanResult(int r14, android.bluetooth.le.ScanResult r15) {
        /*
            r13 = this;
            com.baidu.location.indoor.f r14 = r13.a
            java.util.concurrent.ConcurrentMap r14 = com.baidu.location.indoor.f.a(r14)
            if (r14 == 0) goto Ld2
            ...
            long r0 = java.lang.System.currentTimeMillis()
            com.baidu.location.indoor.f r14 = r13.a
            long r2 = com.baidu.location.indoor.f.b(r14)
            long r0 = r0 - r2
        ...
        L4c:
            ...
            com.baidu.location.indoor.f r14 = r13.a
            long r0 = java.lang.System.currentTimeMillis()
            com.baidu.location.indoor.f.a(r14, r0)
        ...
        L78:
            r2 = r4
        L79:
            com.baidu.location.indoor.f r6 = r13.a
            java.util.concurrent.ConcurrentMap r6 = com.baidu.location.indoor.f.a(r6)
        ...
        Lc0:
            ...
            r14.size()
            com.baidu.location.indoor.f r14 = r13.a
            com.baidu.location.indoor.f.c(r14)
        Ld2:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.baidu.location.indoor.g.onScanResult(int, android.bluetooth.le.ScanResult):void");
    }
}
