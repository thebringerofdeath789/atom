...
public class JsonParser {
    ...
    public static FormatSdCardData parseFormatSdCard(String str) {
        DDLog.e("相机 parseFormatSdCard:" + str);
        JSONObject parseObject = JSONObject.parseObject(str);
    ...
    public static Boolean parseUpgradeHandshakeState(String str) {
        try {
            ...
            DDLog.e("parseUpgradeHandshakeState result: " + all);
            boolean z = true;
            ...
            DDLog.e("parseUpgradeHandshakeState error: " + e.getMessage());
            return false;
        }
    }
}
