                    ...
                    if (PhoneConfig.isKernelActivityRunning && !NotifyReceiver.this.isConnected && NotifyReceiver.this.notifyListener != null) {
                        try {
                            ...
                            if (NotifyReceiver.this.socket.isConnected()) {
                                ...
                                notifyReceiver.in = notifyReceiver.socket.getInputStream();
                                ...
                                while (NotifyReceiver.this.in.read(bArr) != -1) {
                                    try {
                                                ...
                                                try {
                                                    switch (parseObject.getInteger("msg_id").intValue()) {
                                                        ...
                                                        case 2:
                                                            ...
                                                            DDLog.e("cap_ev:" + doubleValue);
                                                            DDLog.e("cap_ev:" + doubleValue2);
                                        ...
                                        DDLog.e("相机通知解析失败:" + e.getMessage());
                                    }
                                }
                            }
                        } catch (Exception e2) {
                            DDLog.e("相机连接失败:" + e2.getMessage());
                            NotifyReceiver.this.closeSocket(null);
                        }
                    }
                    try {
