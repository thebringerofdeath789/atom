...
public class H264ToYuvDecoder2 {
    ...
    public void init(int i, int i2, byte[] bArr, byte[] bArr2) {
        try {
            ...
            DDLog.e("decode name :" + this.decoder.getName());
        ...
        if (this.decoder != null && !Thread.interrupted()) {
            ...
            do {
                ...
                if (dequeueInputBuffer < 0) {
                    ...
                    DDLog.e("out index:" + dequeueOutputBuffer);
            ...
            DDLog.e("解码 mediacodec flush:" + dequeueInputBuffer);
            this.decoder.flush();
        }
    }
            ...
            while (i8 < i7) {
                if (pixelStride == 1) {
                    ...
                    while (true) {
                        ...
                        if (i4 == 1) {
                            i420.U[i9] = bArr[i10 * pixelStride];
                        } else {
                            i420.V[i9] = bArr[i10 * pixelStride];
                        }
                        i9++;
                        i10++;
                        width = i2;
    ...
    public boolean saveYuv(I420 i420) {
        try {
            ...
            fileOutputStream.write(i420.Y);
            fileOutputStream.write(i420.U);
            fileOutputStream.write(i420.V);
            fileOutputStream.close();
            return true;
        } catch (Exception unused) {
            return false;
