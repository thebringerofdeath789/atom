...
public class JavaTest {
    ...
    private static BlockingQueue<String> as = new LinkedBlockingDeque();
            ...
            */
            public void run() {
                ...
                L61:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.logan.usb.utils.JavaTest.AnonymousClass1.run():void");
            }
        }).start();
    }
        ...
        new Thread(new Runnable() { // from class: com.logan.usb.utils.JavaTest.2
            ...
            public void run() {
                while (JavaTest.isRunning) {
                    try {
                        System.out.println((String) JavaTest.as.take());
    ...
    /* renamed from: com.logan.usb.utils.JavaTest$testRunnable, reason: case insensitive filesystem */
    public static class CallableC0255testRunnable implements Callable<Integer> {
        private int i;

        public CallableC0255testRunnable(int i) {
            this.i = i;
        }
        ...
        public Integer call() throws Exception {
            System.out.println("执行" + this.i);
            System.out.println("执行完成" + this.i);
    ...
    public static class Test implements Cloneable {
        ...
        public Test m30clone() throws CloneNotSupportedException {
