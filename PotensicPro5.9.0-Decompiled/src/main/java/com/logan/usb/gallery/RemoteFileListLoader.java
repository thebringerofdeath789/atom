...
public class RemoteFileListLoader {
    ...
    public void onReceived(byte[] bArr) {
        int length;
        try {
            DDLog.e("收到图库数据:" + ParseUtil.byteToHexString(bArr, 20));
            ...
            if (b == 24) {
                ...
                DDLog.e("图库视频数量：" + this.videoNum);
                DDLog.e("图库图片数量：" + this.picNum);
                int i = this.videoNum;
                int i2 = this.picNum;
            ...
            if (b == 25 && (length = bArr.length - (payloadIndex + 5)) > 0) {
                ...
                DDLog.e("图库 videoNum :" + this.videoNum);
                DDLog.e("图库 picNum :" + this.picNum);
                DDLog.e("图库 videoNum1 :" + RemoteFileManager.getInstance().videoList.size());
                DDLog.e("图库 picNum1 :" + RemoteFileManager.getInstance().photoList.size());
