...
public class UsbGalleryManager {
    ...
    public void getFileDetail(RemoteFile remoteFile, IMediaInfoCallback iMediaInfoCallback) {
        if (remoteFile != null) {
            ...
            DDLog.e("图库获取详情:" + remoteFile.getFileName());
    ...
    public void onReceived(byte[] bArr) {
        DDLog.e("收到图库数据1:" + ParseUtil.byteToHexString(bArr, 20));
        ...
        switch (bArr[payloadIndex]) {
            ...
            case 31:
                ...
                break;
            case 33:
                DDLog.e("收到进入图库数据：" + ParseUtil.byteToHexString(bArr, 50));
