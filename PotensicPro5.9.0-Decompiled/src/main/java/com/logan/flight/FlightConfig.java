...
public class FlightConfig {
    ...
    public static final String TYPE_ATOM_SE_V2 = "Atom SE V2";
    ...
    public static void setFlightType(byte b) {
        DDLog.e("设置 飞机类型:" + ParseUtil.byteToHexString(new byte[]{b}));
