...
public class MapboxMapOptions implements Parcelable {
    ...
    public static MapboxMapOptions createFromAttributes(Context context, AttributeSet attributeSet) {
        return createFromAttributes(new MapboxMapOptions(), context, context.obtainStyledAttributes(attributeSet, R.styleable.mapbox_MapView, 0, 0));
    }
    ...
    static MapboxMapOptions createFromAttributes(MapboxMapOptions mapboxMapOptions, Context context, TypedArray typedArray) {
        ...
        try {
            ...
            mapboxMapOptions.horizontalScrollGesturesEnabled(typedArray.getBoolean(R.styleable.mapbox_MapView_mapbox_uiHorizontalScrollGestures, true));
            ...
            mapboxMapOptions.maxPitchPreference(typedArray.getFloat(R.styleable.mapbox_MapView_mapbox_cameraPitchMax, 60.0f));
            mapboxMapOptions.minPitchPreference(typedArray.getFloat(R.styleable.mapbox_MapView_mapbox_cameraPitchMin, 0.0f));
            ...
            mapboxMapOptions.compassImage(typedArray.getDrawable(R.styleable.mapbox_MapView_mapbox_uiCompassDrawable));
            mapboxMapOptions.compassImageResource(typedArray.getInt(R.styleable.mapbox_MapView_mapbox_uiCompassDrawableRes, R.drawable.mapbox_compass_icon));
            ...
            mapboxMapOptions.setRasterizationMode(GlyphsRasterizationMode.valueOf(typedArray.getInt(R.styleable.mapbox_MapView_mapbox_glyphRasterizationMode, 0)));
