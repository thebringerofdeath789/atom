...
final class AutoValue_MatrixResponse extends C$AutoValue_MatrixResponse {
    AutoValue_MatrixResponse(String str, List<DirectionsWaypoint> list, List<DirectionsWaypoint> list2, List<Double[]> list3, List<Double[]> list4) {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    if ("code".equals(nextName)) {
                        ...
                        builder.destinations(typeAdapter2.read2(jsonReader));
                        ...
                        builder.sources(typeAdapter3.read2(jsonReader));
                        ...
                        builder.durations(typeAdapter4.read2(jsonReader));
                        ...
                        builder.distances(typeAdapter5.read2(jsonReader));
                    } else {
