...
final class AutoValue_OptimizationResponse extends C$AutoValue_OptimizationResponse {
    AutoValue_OptimizationResponse(String str, List<OptimizationWaypoint> list, List<DirectionsRoute> list2) {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    if ("code".equals(nextName)) {
                        ...
                        builder.waypoints(typeAdapter2.read2(jsonReader));
                        ...
                        builder.trips(typeAdapter3.read2(jsonReader));
                    } else {
