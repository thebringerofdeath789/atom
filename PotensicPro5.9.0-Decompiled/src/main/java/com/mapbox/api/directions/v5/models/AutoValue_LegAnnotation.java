...
final class AutoValue_LegAnnotation extends C$AutoValue_LegAnnotation {
    AutoValue_LegAnnotation(Map<String, SerializableJsonElement> map, List<Double> list, List<Double> list2, List<Double> list3, List<MaxSpeed> list4, List<String> list5, List<Integer> list6, List<Integer> list7) {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    if (nextName.equals(DirectionsCriteria.ANNOTATION_CONGESTION_NUMERIC)) {
                        ...
                        builder.speed(typeAdapter5.read2(jsonReader));
                        ...
                        builder.congestion(typeAdapter7.read2(jsonReader));
                    } else {
