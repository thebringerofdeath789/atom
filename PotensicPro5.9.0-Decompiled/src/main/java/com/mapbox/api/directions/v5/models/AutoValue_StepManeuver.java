...
final class AutoValue_StepManeuver extends C$AutoValue_StepManeuver {
    AutoValue_StepManeuver(Map<String, SerializableJsonElement> map, double[] dArr, Double d, Double d2, String str, String str2, String str3, Integer num) {
                    ...
                    switch (nextName) {
                        ...
                        default:
                            if ("instruction".equals(nextName)) {
                                ...
                                builder.instruction(typeAdapter4.read2(jsonReader));
                                break;
                                ...
                                builder.modifier(typeAdapter6.read2(jsonReader));
                                break;
