...
final class AutoValue_IntersectionLanes extends C$AutoValue_IntersectionLanes {
    AutoValue_IntersectionLanes(Map<String, SerializableJsonElement> map, Boolean bool, Boolean bool2, String str, List<String> list) {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    if (nextName.equals("valid_indication")) {
                        ...
                        builder.validIndication(typeAdapter.read2(jsonReader));
                        ...
                        builder.valid(typeAdapter2.read2(jsonReader));
                        ...
                        builder.active(typeAdapter3.read2(jsonReader));
