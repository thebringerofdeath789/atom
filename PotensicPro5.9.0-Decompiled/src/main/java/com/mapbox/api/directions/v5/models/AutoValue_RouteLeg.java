...
final class AutoValue_RouteLeg extends C$AutoValue_RouteLeg {
    AutoValue_RouteLeg(Map<String, SerializableJsonElement> map, List<SilentWaypoint> list, Double d, Double d2, Double d3, String str, List<Admin> list2, List<LegStep> list3, List<Incident> list4, LegAnnotation legAnnotation, List<Closure> list5) {
