                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    switch (nextName) {
                        ...
                        case "alley_bias":
                            ...
                            builder.alleyBias(typeAdapter2.read2(jsonReader));
                            break;
                        case "voice_instructions":
                            ...
                            builder.voiceInstructions(typeAdapter3.read2(jsonReader));
                            break;
                        case "depart_at":
                            TypeAdapter<String> typeAdapter4 = this.string_adapter;
                            if (typeAdapter4 == null) {
                            ...
                            builder.departAt(typeAdapter4.read2(jsonReader));
                            break;
                        case "arrive_by":
                            ...
                            builder.arriveBy(typeAdapter5.read2(jsonReader));
                            break;
                        case "avoid_maneuver_radius":
                            ...
                            builder.avoidManeuverRadius(typeAdapter6.read2(jsonReader));
                            break;
                        case "waypoint_targets":
                            ...
                            builder.waypointTargets(typeAdapter7.read2(jsonReader));
                            break;
                        case "enable_refresh":
                            ...
                            builder.enableRefresh(typeAdapter8.read2(jsonReader));
                            break;
                        case "metadata":
                            ...
                            builder.metadata(typeAdapter9.read2(jsonReader));
                            break;
                        case "max_width":
                            ...
                            builder.maxWidth(typeAdapter10.read2(jsonReader));
                            break;
                        case "continue_straight":
                            ...
                            builder.continueStraight(typeAdapter11.read2(jsonReader));
                            break;
                        case "snapping_include_closures":
                            ...
                            builder.snappingIncludeClosures(typeAdapter12.read2(jsonReader));
                            break;
                        case "waypoints":
                            TypeAdapter<String> typeAdapter13 = this.string_adapter;
                            if (typeAdapter13 == null) {
                            ...
                            builder.waypointIndices(typeAdapter13.read2(jsonReader));
                            break;
                        case "voice_units":
                            TypeAdapter<String> typeAdapter14 = this.string_adapter;
                            if (typeAdapter14 == null) {
                            ...
                            builder.voiceUnits(typeAdapter14.read2(jsonReader));
                            break;
                        case "walking_speed":
                            ...
                            builder.walkingSpeed(typeAdapter15.read2(jsonReader));
                            break;
                        case "waypoint_names":
                            TypeAdapter<String> typeAdapter16 = this.string_adapter;
                            if (typeAdapter16 == null) {
                            ...
                            builder.waypointNames(typeAdapter16.read2(jsonReader));
                            break;
                        case "walkway_bias":
                            ...
                            builder.walkwayBias(typeAdapter17.read2(jsonReader));
                            break;
                        case "max_height":
                            ...
                            builder.maxHeight(typeAdapter18.read2(jsonReader));
                            break;
                        case "compute_toll_cost":
                            ...
                            builder.computeTollCost(typeAdapter19.read2(jsonReader));
                            break;
                        case "max_weight":
                            ...
                            builder.maxWeight(typeAdapter20.read2(jsonReader));
                            break;
                        case "snapping_include_static_closures":
                            ...
                            builder.snappingIncludeStaticClosures(typeAdapter21.read2(jsonReader));
                            break;
                        case "roundabout_exits":
                            ...
                            builder.roundaboutExits(typeAdapter22.read2(jsonReader));
                            break;
                        default:
                            if ("baseUrl".equals(nextName)) {
                                ...
                                builder.baseUrl(typeAdapter23.read2(jsonReader));
                                break;
                                ...
                                builder.user(typeAdapter24.read2(jsonReader));
                                break;
                                ...
                                builder.profile(typeAdapter25.read2(jsonReader));
                                break;
                                ...
                                builder.coordinates(typeAdapter26.read2(jsonReader));
                                break;
                                ...
                                builder.language(typeAdapter28.read2(jsonReader));
                                break;
                                ...
                                builder.radiuses(typeAdapter29.read2(jsonReader));
                                break;
                                ...
                                builder.bearings(typeAdapter30.read2(jsonReader));
                                break;
                                ...
                                builder.layers(typeAdapter31.read2(jsonReader));
                                break;
                                ...
                                builder.overview(typeAdapter33.read2(jsonReader));
                                break;
                                ...
                                builder.steps(typeAdapter34.read2(jsonReader));
                                break;
                                ...
                                builder.exclude(typeAdapter36.read2(jsonReader));
                                break;
                                ...
                                builder.approaches(typeAdapter38.read2(jsonReader));
                                break;
                            } else {
