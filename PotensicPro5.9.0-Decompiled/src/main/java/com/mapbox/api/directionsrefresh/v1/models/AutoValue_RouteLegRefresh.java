...
final class AutoValue_RouteLegRefresh extends C$AutoValue_RouteLegRefresh {
    AutoValue_RouteLegRefresh(Map<String, SerializableJsonElement> map, List<Incident> list, LegAnnotation legAnnotation, List<Closure> list2) {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    if ("incidents".equals(nextName)) {
                        ...
                        builder.incidents(typeAdapter.read2(jsonReader));
                        ...
                        builder.annotation(typeAdapter2.read2(jsonReader));
                        ...
                        builder.closures(typeAdapter3.read2(jsonReader));
                    } else {
