...
final class AutoValue_MapMatchingMatching extends C$AutoValue_MapMatchingMatching {
    AutoValue_MapMatchingMatching(String str, double d, double d2, String str2, double d3, String str3, List<RouteLeg> list, double d4, RouteOptions routeOptions, String str4, String str5) {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    if (nextName.equals("voiceLocale")) {
                        ...
                        builder.voiceLanguage(typeAdapter.read2(jsonReader));
                        ...
                        builder.confidence(typeAdapter9.read2(jsonReader).doubleValue());
                        ...
                        builder.routeOptions(typeAdapter10.read2(jsonReader));
