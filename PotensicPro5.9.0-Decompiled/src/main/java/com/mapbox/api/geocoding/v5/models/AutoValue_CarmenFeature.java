...
final class AutoValue_CarmenFeature extends C$AutoValue_CarmenFeature {
    AutoValue_CarmenFeature(String str, BoundingBox boundingBox, String str2, Geometry geometry, JsonObject jsonObject, String str3, String str4, List<String> list, String str5, double[] dArr, List<CarmenContext> list2, Double d, String str6, String str7, String str8) {
    ...
    static final class GsonTypeAdapter extends TypeAdapter<CarmenFeature> {
        ...
        public void write(JsonWriter jsonWriter, CarmenFeature carmenFeature) throws IOException {
            ...
            if (carmenFeature.id() == null) {
                ...
                typeAdapter3.write(jsonWriter, carmenFeature.id());
            }
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    switch (nextName) {
                        case "center":
                            ...
                            builder.rawCenter(typeAdapter.read2(jsonReader));
                            break;
                        case "matching_text":
                            ...
                            builder.matchingText(typeAdapter2.read2(jsonReader));
                            break;
                        case "matching_place_name":
                            ...
                            builder.matchingPlaceName(typeAdapter3.read2(jsonReader));
                            break;
                        case "place_name":
                            ...
                            builder.placeName(typeAdapter4.read2(jsonReader));
                            break;
                        case "place_type":
                            ...
                            builder.placeType(typeAdapter5.read2(jsonReader));
                            break;
                        case "type":
                            TypeAdapter<String> typeAdapter6 = this.string_adapter;
                            if (typeAdapter6 == null) {
                        ...
                        default:
                            if ("bbox".equals(nextName)) {
                                ...
                                builder.bbox(typeAdapter7.read2(jsonReader));
                                break;
                                ...
                                builder.properties(typeAdapter10.read2(jsonReader));
                                break;
                                ...
                                builder.address(typeAdapter12.read2(jsonReader));
                                break;
                                ...
                                builder.context(typeAdapter13.read2(jsonReader));
                                break;
                                ...
                                builder.relevance(typeAdapter14.read2(jsonReader));
                                break;
                                ...
                                builder.language(typeAdapter15.read2(jsonReader));
                                break;
                            } else {
