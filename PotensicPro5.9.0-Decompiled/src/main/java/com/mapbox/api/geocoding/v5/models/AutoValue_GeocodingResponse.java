...
final class AutoValue_GeocodingResponse extends C$AutoValue_GeocodingResponse {
    AutoValue_GeocodingResponse(String str, List<String> list, List<CarmenFeature> list2, String str2) {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    if ("type".equals(nextName)) {
                        ...
                        builder.query(typeAdapter2.read2(jsonReader));
                        ...
                        builder.features(typeAdapter3.read2(jsonReader));
                        ...
                        builder.attribution(typeAdapter4.read2(jsonReader));
                    } else {
