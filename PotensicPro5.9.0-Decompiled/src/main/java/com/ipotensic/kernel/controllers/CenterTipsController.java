...
public class CenterTipsController extends BaseController {
    ...
    public void initView(View view) {
        this.layoutTipsView = (RelativeLayout) view.findViewById(R.id.layout_center_tips);
        this.tvTipTitle = (TextView) view.findViewById(R.id.tv_dialog_title);
        this.ivTipIcon = (ImageView) view.findViewById(R.id.iv_icon);
    ...
    public void setBatteryFailTip(FlightRevStateData flightRevStateData) {
        ...
        if (FlightConfig.isOldProduct() && flightRevStateData.isReturnCountdown()) {
            this.ivTipIcon.setImageResource(R.mipmap.icon_go_home);
            this.tvTipTitle.setText(getContext().getString(R.string.low_power_return_soon));
            show();
            z = true;
        }
        if (FlightConfig.isP1ProBattery() || !FlightConfig.isOldProduct()) {
            if (!flightRevStateData.isFlight()) {
                if (flightRevStateData.isIs1BatteryDamaged() || flightRevStateData.isIs2BatteryDamaged() || flightRevStateData.isBatteryJump() || flightRevStateData.isBatteryDiffPressure() || flightRevStateData.isBatteryBelowSevenPercent() || flightRevStateData.isBatteryAbnormalAlarm() || flightRevStateData.isBatteryJumpAbnormal() || flightRevStateData.isBatteryFullAbnormalAlarm()) {
                    this.ivTipIcon.setImageResource(R.mipmap.icon_take_off);
                    this.tvTipTitle.setText(getContext().getString(R.string.new_battery_fail_not_takeoff));
                    show();
                }
                z2 = z;
            } else {
                if (flightRevStateData.isIs1BatteryDamaged() || flightRevStateData.isIs2BatteryDamaged() || flightRevStateData.isBatteryBelowSevenPercent()) {
                    this.ivTipIcon.setImageResource(R.mipmap.icon_take_landing);
                    this.tvTipTitle.setText(getContext().getString(R.string.new_battery_fail_in_land));
                    show();
                    z = true;
                }
                if (flightRevStateData.isBatteryDiffPressure() || flightRevStateData.isBatteryAbnormalAlarm() || flightRevStateData.isBatteryJumpAbnormal() || flightRevStateData.isBatteryFullAbnormalAlarm()) {
                    this.ivTipIcon.setImageResource(R.mipmap.icon_go_home);
                    this.tvTipTitle.setText(getContext().getString(R.string.new_battery_fail_go_home));
                    show();
                    z = true;
                }
                if (flightRevStateData.isBatteryJump()) {
                    this.ivTipIcon.setImageResource(R.mipmap.icon_go_home);
                    this.tvTipTitle.setText(getContext().getString(R.string.battery_fail_jump));
                    show();
                    z = true;
                }
                if (flightRevStateData.isBatteryTempLow() || flightRevStateData.isBatteryTempHigh()) {
                    this.ivTipIcon.setImageResource(R.mipmap.img_battery_fail);
                    this.tvTipTitle.setText(getContext().getString(R.string.new_battery_temp_fail_fly_careful));
                    show();
                }
                z2 = z;
            }
            ...
            if (flightRevStateData.isBatteryHighPress() && !flightRevStateData.isNewBattery()) {
                this.ivTipIcon.setImageResource(R.mipmap.icon_take_off);
                this.tvTipTitle.setText(getContext().getString(R.string.error_battery_no_takeoff_fault));
                show();
                z = true;
            }
            if (flightRevStateData.isNewBattery() && (flightRevStateData.isIs1BatteryDamaged() || flightRevStateData.isIs2BatteryDamaged())) {
                this.ivTipIcon.setImageResource(R.mipmap.img_battery_fail);
                this.tvTipTitle.setText(getContext().getString(R.string.battery_fail_in_land));
                show();
                z = true;
            }
            ...
            if (flightRevStateData.isBatteryAbnormalAlarm()) {
                this.ivTipIcon.setImageResource(R.mipmap.icon_take_off);
                this.tvTipTitle.setText(getContext().getString(R.string.battery_capacity_abnormal_takeoff));
                show();
            }
            z2 = z;
        } else {
            if (flightRevStateData.isBatteryHighPress() && !flightRevStateData.isNewBattery()) {
                this.ivTipIcon.setImageResource(R.mipmap.icon_go_home);
                this.tvTipTitle.setText(getContext().getString(R.string.battery_fail_1_pice));
                show();
                z = true;
            }
            if (flightRevStateData.isNewBattery()) {
                ...
                if (flightRevStateData.isIs2BatteryDamaged()) {
                    this.ivTipIcon.setImageResource(R.mipmap.img_battery_fail_return);
                    this.tvTipTitle.setText(getContext().getString(R.string.battery_fail_2_pice));
                    show();
                    z = true;
                }
            ...
            if (flightRevStateData.isBatteryAbnormalAlarm()) {
                this.ivTipIcon.setImageResource(R.mipmap.icon_go_home);
                this.tvTipTitle.setText(getContext().getString(R.string.battery_capacity_abnormal_go_home));
                show();
            }
            z2 = z;
        }
    ...
    /* renamed from: com.ipotensic.kernel.controllers.CenterTipsController$2, reason: invalid class name */
