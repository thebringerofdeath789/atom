...
public class TestCameraController extends BaseController {
    ...
    public void initView(View view) {
        ...
        TextView textView = (TextView) view.findViewById(R.id.btn_send1);
        final EditText editText = (EditText) view.findViewById(R.id.et_fun1);
        final EditText editText2 = (EditText) view.findViewById(R.id.et_params1);
        ...
        ((TextView) view.findViewById(R.id.btn_clear1)).setOnClickListener(new ScaleClickListener() { // from class: com.ipotensic.kernel.controllers.TestCameraController.2
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view2) {
                editText.setText("");
                editText2.setText("");
        ...
        TextView textView2 = (TextView) view.findViewById(R.id.btn_send2);
        final EditText editText3 = (EditText) view.findViewById(R.id.et_fun2);
        final EditText editText4 = (EditText) view.findViewById(R.id.et_params2);
        ((TextView) view.findViewById(R.id.btn_clear2)).setOnClickListener(new ScaleClickListener() { // from class: com.ipotensic.kernel.controllers.TestCameraController.3
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view2) {
                editText3.setText("");
                editText4.setText("");
    ...
    /* renamed from: com.ipotensic.kernel.controllers.TestCameraController$6, reason: invalid class name */
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        int i = AnonymousClass6.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()];
        if (i != 1) {
            if (i != 2) {
                return;
            }
