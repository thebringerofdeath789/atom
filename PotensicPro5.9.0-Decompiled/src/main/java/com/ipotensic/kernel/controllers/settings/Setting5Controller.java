...
public class Setting5Controller extends BaseController implements View.OnClickListener, SwitchButton.SwitchStateListener {
    ...
    public void initView(View view) {
        ...
        this.tvRemote = (TextView) view.findViewById(R.id.iv_remote);
        ...
        SwitchButton switchButton = (SwitchButton) view.findViewById(R.id.slide_hard_decode);
        ...
        TextView textView = (TextView) view.findViewById(R.id.tv_flight_update);
        this.tvFlightUpdate = textView;
        textView.setOnClickListener(this);
        TextView textView2 = (TextView) view.findViewById(R.id.tv_cam_update);
        this.tvCamUpdate = textView2;
        textView2.setOnClickListener(this);
        TextView textView3 = (TextView) view.findViewById(R.id.tv_remote_update);
        this.tvRemoteUpdate = textView3;
        textView3.setOnClickListener(this);
        TextView textView4 = (TextView) view.findViewById(R.id.tv_fpv_update);
        this.tvFpvUpdate = textView4;
        textView4.setOnClickListener(this);
        TextView textView5 = (TextView) view.findViewById(R.id.tv_ptz_update);
        this.tvPtzUpdate = textView5;
        textView5.setOnClickListener(this);
        TextView textView6 = (TextView) view.findViewById(R.id.tv_battery_update);
        this.tvBatteryUpdate = textView6;
        textView6.setOnClickListener(this);
        this.layoutFlightUpdate = (LinearLayout) view.findViewById(R.id.layout_flight_update);
        this.layoutCameraUpdate = (LinearLayout) view.findViewById(R.id.layout_camera_update);
        this.layoutRemoteUpdate = (LinearLayout) view.findViewById(R.id.layout_remote_update);
        this.layoutFpvUpdate = (LinearLayout) view.findViewById(R.id.layout_fpv_update);
        this.layoutPtzUpdate = (LinearLayout) view.findViewById(R.id.layout_ptz_update);
        this.layoutBatteryUpdate = (LinearLayout) view.findViewById(R.id.layout_battery_update);
        ...
        this.clEsc = (ConstraintLayout) view.findViewById(R.id.cl_esc);
        this.tvEsc = (TextView) view.findViewById(R.id.tv_esc);
        View findViewById = view.findViewById(R.id.line_sn);
        LinearLayout linearLayout = (LinearLayout) view.findViewById(R.id.ll_sn);
        this.tvFlightType = (TextView) view.findViewById(R.id.tv_flight_type);
    ...
    public void updateData() {
        ...
        if (FlightConfig.isConnectFlight() || UsbConfig.isUsbConnected) {
            ...
            this.tvFlight.setText(isEmptyVersion(flightRevVersionData.getFlightControlVersion()) ? this.NA : "  V" + flightRevVersionData.getFlightControlVersion());
            int i = 0;
            ...
            if (FlightConfig.isConnectFlight()) {
                this.tvCamera.setText(isEmptyVersion(CameraConfig.get().getSoftVersion()) ? this.NA : "  " + CameraConfig.get().getSoftVersion());
            }
            ...
            this.tvRemote.setText(isEmptyVersion(remoterVersion) ? this.NA : "  V" + remoterVersion);
            ...
            String string = FlightRevData.get().getFlightRemoterBatteryData().isRemoterLowPower() ? getContext().getString(R.string.dialog_upgrade_remote_power_low) : null;
            if (!FlightConfig.isConnectFlight() && UsbConfig.isUsbConnected && string != null) {
                this.layoutRemoteUpdate.setVisibility(4);
            }
            DDLog.e("固件下载", "电池版本：" + flightRevVersionData.getBatteryVersion());
            DDLog.e("固件下载", "电池是否有版本：" + FwDownloadManager.getInstance().getNewBatteryVersion(false));
            this.tvBattery.setText(isEmptyVersion(flightRevVersionData.getBatteryVersion()) ? this.NA : "  V" + flightRevVersionData.getBatteryVersion());
            ...
            this.tvPtz.setText(isEmptyVersion(flightRevVersionData.getGimbalVersion()) ? this.NA : "  V" + flightRevVersionData.getGimbalVersion());
            ...
            if (fpvVersion != null) {
                this.clFpv.setVisibility(0);
                this.tvFpv.setText(isEmptyVersion(fpvVersion) ? this.NA : "  V" + fpvVersion);
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.tv_flight_update) {
            if (z2 || z) {
                ...
                FwUpgradeConditionDialog fwUpgradeConditionDialog = new FwUpgradeConditionDialog(context, context.getString(R.string.flightcontrol), true, z2, z, null, false);
        ...
        if (id == R.id.tv_cam_update) {
            ...
            if (z2 || z || str != null) {
                ...
                FwUpgradeConditionDialog fwUpgradeConditionDialog2 = new FwUpgradeConditionDialog(context2, context2.getString(R.string.camera), true, z2, z, str, false);
        ...
        if (id == R.id.tv_remote_update) {
            if (!FlightConfig.isConnectFlight()) {
                if (z) {
                    ...
                    FwUpgradeConditionDialog fwUpgradeConditionDialog3 = new FwUpgradeConditionDialog(context3, context3.getString(R.string.remotecontrol), false, false, z, null, false);
            ...
            if (z2 || z) {
                ...
                FwUpgradeConditionDialog fwUpgradeConditionDialog4 = new FwUpgradeConditionDialog(context4, context4.getString(R.string.remotecontrol), true, z2, z, null, false);
        ...
        if (id == R.id.tv_fpv_update) {
            ...
            if (!FlightConfig.isConnectFlight()) {
                if (z) {
                    ...
                    FwUpgradeConditionDialog fwUpgradeConditionDialog5 = new FwUpgradeConditionDialog(context5, context5.getString(R.string.fpv), false, false, z, null, false);
            ...
            if (z2 || z) {
                ...
                FwUpgradeConditionDialog fwUpgradeConditionDialog6 = new FwUpgradeConditionDialog(context6, context6.getString(R.string.fpv), true, z2, z, null, false);
        ...
        if (id == R.id.tv_ptz_update) {
            if (z2 || z) {
                ...
                FwUpgradeConditionDialog fwUpgradeConditionDialog7 = new FwUpgradeConditionDialog(context7, context7.getString(R.string.gimbal), true, z2, z, null, false);
        ...
        if (z2 || z) {
            ...
            FwUpgradeConditionDialog fwUpgradeConditionDialog8 = new FwUpgradeConditionDialog(context8, context8.getString(R.string.battery), true, z2, z, null, false);
    ...
    /* renamed from: com.ipotensic.kernel.controllers.settings.Setting5Controller$1, reason: invalid class name */
