...
public class TopController extends BaseController implements AOAEngine.IEngineCallback {
    ...
    public void initView(View view) {
        ...
        this.ivGimbalTips = (ImageView) view.findViewById(R.id.iv_gimbal_tips);
        this.tvGimbalTips = (TextView) view.findViewById(R.id.tv_gimbal_tips);
        this.circleBatteryView = (CircleBatteryView) view.findViewById(R.id.view_battery_percentage);
        this.tvDeviceStatus = (TextView) view.findViewById(R.id.tv_device_status);
        this.tvLowPowerTips = (TextView) view.findViewById(R.id.tv_low_power_tips);
        this.tvUavStatus = (StrokeTextView) view.findViewById(R.id.tv_uav_status);
        this.tvGps = (StrokeTextView) view.findViewById(R.id.tv_gps);
        this.ivGps = (ImageView) view.findViewById(R.id.iv_gps);
        this.ivWifi = (ImageView) view.findViewById(R.id.iv_signal_hd);
        this.ivHighMode = (ImageView) view.findViewById(R.id.iv_speed_mode);
        this.ivHaveHead = (ImageView) view.findViewById(R.id.iv_have_direction_mode);
        this.layoutState = (RoundRelativeLayout) view.findViewById(R.id.layout_state);
        this.ivUav = (ImageView) view.findViewById(R.id.iv_uav);
        this.layoutState.setCornerRadius(21);
        this.imgHD = (ImageView) view.findViewById(R.id.iv_hd);
        StrokeTextView strokeTextView = (StrokeTextView) view.findViewById(R.id.tv_remain_flight_time);
        ...
        view.findViewById(R.id.iv_logo).setOnClickListener(new ScaleClickListener(1000) { // from class: com.ipotensic.kernel.controllers.TopController.2
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view2) {
                TopController.this.getContext().finish();
            }
        });
        ImageView imageView = (ImageView) view.findViewById(R.id.tv_new_setting);
    ...
    public void onUsbAccessoryDisconnected() {
        DDLog.e("usb onUsbAccessoryDisconnected");
        checkTopState();
    }

    @Override // com.logan.usb.AOAEngine.IEngineCallback
    public void onUsbAccessoryConnectError() {
        DDLog.e("usb onUsbAccessoryConnectError");
        checkTopState();
    }
    ...
    private void setDisconnectStatus() {
        ...
        this.imgHD.setImageResource(R.mipmap.icon_hd_disable);
        ...
        this.tvRemainFlightTime.setText(this.context.getString(R.string.test_data));
        this.lastGimbalPitch = 100;
        this.tvGimbalTips.setText(this.context.getString(R.string.test_data));
        this.tvGimbalTips.setTextColor(getContext().getColor(R.color.color_white_fifty_percent));
        this.tvRemainFlightTime.setTextColor(getContext().getColor(R.color.color_white_fifty_percent));
        this.ivUav.setImageResource(R.mipmap.icon_uav_disable);
        ...
        if (FlightConfig.curFlight != null) {
            if (FlightConfig.is_Atom_Series()) {
                ...
                if (flightRevStateData != null && flightRevStateData.getMode() == 2) {
                    ...
                    this.tvGps.setTextColor(getContext().getColor(R.color.colorRemainedBattery));
                    this.ivGps.setImageResource(R.mipmap.icon_gps_mistake);
                }
            ...
            this.ivUav.setImageResource(R.mipmap.icon_uav);
    ...
    public void setWifiLevel(int i) {
        ...
        this.imgHD.setImageResource(R.mipmap.icon_hd_enable);
    }
    ...
    private void setUavStatus(FlightRevStateData flightRevStateData) {
        ...
        if (flightRevStateData.getMode() == 2) {
            this.tvUavStatus.setText(this.context.getString(R.string.plane_gps));
        } else if (flightRevStateData.getMode() == 0) {
            this.tvUavStatus.setText(this.context.getString(R.string.plane_atti));
        } else if (flightRevStateData.getMode() == 1) {
            this.tvUavStatus.setText(FlightConfig.isAtomLT() ? "" : this.context.getString(R.string.optical_flow_mode));
        }
    }
    ...
    private void setViewVisible(FlightRevStateData flightRevStateData) {
        if (FlightRevData.get().getFlightRevVersionData().getFlightControlVersion() != null) {
            if (FlightConfig.isOldProduct()) {
                this.ivHighMode.setImageResource(flightRevStateData.isHighSpeedMode() ? R.mipmap.icon_speed_s : R.mipmap.icon_speed_n);
                this.ivHighMode.setVisibility(flightRevStateData.getMode() != 1 ? 0 : 8);
            } else {
                if (flightRevStateData.getSpeedMode() == 0) {
                    this.ivHighMode.setImageResource(R.mipmap.icon_speed_v);
                } else if (flightRevStateData.getSpeedMode() == 1) {
                    this.ivHighMode.setImageResource(R.mipmap.icon_speed_n);
                } else {
                    this.ivHighMode.setImageResource(R.mipmap.icon_speed_s);
                }
            ...
            this.ivHaveHead.setImageResource(flightRevStateData.isNoHeadMode() ? R.mipmap.icon_top_headless_mode : R.mipmap.icon_top_head_mode);
        }
    }

    /* renamed from: com.ipotensic.kernel.controllers.TopController$5, reason: invalid class name */
    static /* synthetic */ class AnonymousClass5 {
        ...
        static {
            ...
            try {
                $SwitchMap$com$ipotensic$baselib$dispatcher$EventID[EventID.FLIGHT_RECEIVE_BATTERY_DATA.ordinal()] = 7;
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        switch (AnonymousClass5.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()]) {
            case 1:
            ...
            case 6:
                ...
                if (this.lastGimbalPitch != gimbalStateData.getControl_pitch()) {
                    ...
                    this.tvGimbalTips.setTextColor(getContext().getColor(R.color.colorWhite));
    ...
    private void setTopStateTxt(TopState topState, String str) {
        if (str != null) {
            ...
            if (FlightConfig.isOldProduct()) {
                this.tvLowPowerTips.setText(R.string.low_battery_tips);
            } else {
                int powerMode = FlightRevData.get().getFlightRevStateData().getPowerMode();
                if (powerMode == 1) {
                    this.tvLowPowerTips.setText(R.string.mode_one_low_power);
                } else if (powerMode == 2) {
                    this.tvLowPowerTips.setText(R.string.mode_two_low_power);
                }
            }
            this.tvDeviceStatus.setText(str);
            this.tvDeviceStatus.setBackgroundResource(R.color.colorRed);
            return;
        }
    ...
    private enum TopState {
        STATE_DISCONNECT(R.string.plane_disconnecting, R.color.color_kernel_top_state_gray),
        STATE_DISCONNECT_FLIGHT(R.string.remote_not_connected_to_aircraft, R.color.color_kernel_top_state_gray),
        STATE_CONNECTED(R.string.plane_connecting, R.color.color_kernel_top_state_blue),
        STATE_LANDING(R.string.plane_landing, R.color.color_kernel_top_state_light_blue),
        STATE_RETURNING(R.string.plane_returning, R.color.color_kernel_top_state_orange),
        STATE_FLYING(R.string.plane_flighting, R.color.color_kernel_top_state_green),
        STATE_TAKEOFF(R.string.plane_take_off, R.color.color_kernel_top_state_green),
        STATE_WAYPOINT_FLYING(R.string.plane_waypoint_flight, R.color.color_kernel_top_state_green),
        STATE_CIRCLE_FLYING(R.string.plane_hot_circle, R.color.color_kernel_top_state_green),
        STATE_FOLLOW_ME(R.string.plane_follow_up, R.color.color_kernel_top_state_green),
        STATE_VISUAL_TRACKING(R.string.visual_tracking_flight_interface_navigation_tip_bar_title, R.color.color_kernel_top_state_green),
        STATE_QUICK_SHOT(R.string.quickshots_flight_interface_navigation_tip_bar_title, R.color.color_kernel_top_state_green),
        STATE_LOW_POWER(R.string.low_battery_tips, R.color.color_kernel_top_state_red);
