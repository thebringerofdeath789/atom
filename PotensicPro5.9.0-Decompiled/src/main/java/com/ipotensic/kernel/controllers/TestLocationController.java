...
public class TestLocationController extends BaseController {
    ...
    public void initView(View view) {
        this.tvSystemAcc = (TextView) view.findViewById(R.id.tv_system_acc);
        this.tvBdAcc = (TextView) view.findViewById(R.id.tv_bd_acc);
        this.layoutTest = (ConstraintLayout) view.findViewById(R.id.layout_test);
        this.tvSatelliteCount = (TextView) view.findViewById(R.id.tv_count);
