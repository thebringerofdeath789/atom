...
public class WarnController extends BaseController implements View.OnClickListener {
    ...
    /* renamed from: com.ipotensic.kernel.controllers.WarnController$35, reason: invalid class name */
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        int i = AnonymousClass35.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()];
        if (i == 1) {
        ...
        if (i == 3 && !((Boolean) event.obj).booleanValue()) {
            this.errorState = -1;
