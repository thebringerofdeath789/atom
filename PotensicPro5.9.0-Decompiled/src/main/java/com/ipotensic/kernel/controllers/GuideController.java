...
public class GuideController extends BaseController {
    ...
    private void init() {
        ...
        this.ivHd = (ImageView) this.top.findViewById(R.id.iv_hd);
    ...
    public /* synthetic */ void lambda$addGuideView$0$GuideController(int i) {
        if (i == 0) {
            ...
            this.ivHd.setImageResource(R.mipmap.icon_hd_enable);
        ...
        if (i == 2) {
            ...
            this.ivHd.setImageResource(R.mipmap.icon_hd_disable);
