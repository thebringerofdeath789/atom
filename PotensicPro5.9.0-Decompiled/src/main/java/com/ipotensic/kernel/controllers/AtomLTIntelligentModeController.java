...
public class AtomLTIntelligentModeController extends BaseController implements View.OnClickListener {
    ...
    public void initView(View view) {
        this.tvHotCircle = (TextView) view.findViewById(R.id.atomLT_tv_hot_circle);
        this.tvWaypoint = (TextView) view.findViewById(R.id.atomLT_tv_waypoint_flight);
        this.tvFollowMe = (TextView) view.findViewById(R.id.atomLT_tv_follow_me);
        this.tvHotCircle.setOnClickListener(this);
        this.tvWaypoint.setOnClickListener(this);
        this.tvFollowMe.setOnClickListener(this);
        this.viewBlank = view.findViewById(R.id.atomLT_intelligent_view_blank);
        this.viewBg = view.findViewById(R.id.atomLT_intelligent_view_bg);
        View findViewById = view.findViewById(R.id.atomLT_intelligent_view_mode);
        this.viewMode = findViewById;
        findViewById.setOnClickListener(this);
        this.viewBlank.setOnClickListener(this);
        this.tvCircleFlightSetting = (TextView) view.findViewById(R.id.tvCircleFlightSetting);
        this.tvRadiusTips = (TextView) view.findViewById(R.id.tv_radius_tips);
        this.tvUnitCircleRadius = (TextView) view.findViewById(R.id.atomLT_tv_unit_circle_radius);
        this.tvSpeedTips = (TextView) view.findViewById(R.id.tv_speed_tips);
        this.tvUnitCircleSpeed = (TextView) view.findViewById(R.id.atomLT_tv_unit_circle_speed);
        this.tvDirectionTips = (TextView) view.findViewById(R.id.tv_direction_tips);
        this.leftCircleDirection = (ImageButton) view.findViewById(R.id.atomLT_iv_left);
        this.rightCircleDirection = (ImageButton) view.findViewById(R.id.atomLT_iv_right);
        this.startCircleFlight = (Button) view.findViewById(R.id.start_circle_flight);
        ...
        this.atomLTIntelligentModeRight = view.findViewById(R.id.atomLT_intelligent_mode_right);
        this.radiusSeekBar = (CustomSeekbar) view.findViewById(R.id.atomLT_seekBar_radius);
        this.speedSeekBar = (CustomSeekbar) view.findViewById(R.id.atomLT_seekBar_speed);
        this.edtRadius = (CursorEditText) view.findViewById(R.id.atomLT_edt_radius);
        this.edtSpeed = (CursorEditText) view.findViewById(R.id.atomLT_edt_speed);
        this.tvCircleRadiusUnit = (TextView) view.findViewById(R.id.atomLT_tv_unit_circle_radius);
        this.tvCircleSpeedUnit = (TextView) view.findViewById(R.id.atomLT_tv_unit_circle_speed);
        initCircleLimitUI();
    ...
    private void onHotCircleClicked() {
        if (SPHelper.getInstance().getHotCircleMode()) {
            ...
            }).setBackgroundColor(getContext().getResources().getColor(R.color.color_guide_bg))).setOnGuideChangedListener(new OnGuideChangedListener() { // from class: com.ipotensic.kernel.controllers.AtomLTIntelligentModeController.1
            ...
            this.tvWaypoint.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, getContext().getDrawable(R.mipmap.icon_waypoint_flight_disconnect_atomlt), (Drawable) null, (Drawable) null);
            this.tvWaypoint.setAlpha(0.5f);
            this.tvFollowMe.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, getContext().getDrawable(R.mipmap.icon_follow_me_disconnect_atomlt), (Drawable) null, (Drawable) null);
    ...
    public /* synthetic */ void lambda$onHotCircleClicked$0$AtomLTIntelligentModeController(View view, Controller controller) {
        ((TextView) view.findViewById(R.id.tv_view)).setText(getContext().getResources().getString(R.string.guide_intelligent_interest));
        this.tvHotCircle.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, getContext().getDrawable(R.mipmap.icon_circle_flight_click_atomlt), (Drawable) null, (Drawable) null);
    ...
    private void onWaypointFlyClicked() {
        if (SPHelper.getInstance().getWaypointMode()) {
            ...
            }).setBackgroundColor(getContext().getResources().getColor(R.color.color_guide_bg))).setOnGuideChangedListener(new OnGuideChangedListener() { // from class: com.ipotensic.kernel.controllers.AtomLTIntelligentModeController.2
                @Override // com.ipotensic.baselib.guide.listener.OnGuideChangedListener
                public void onRemoved(Controller controller) {
                }
            ...
            this.tvHotCircle.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, getContext().getDrawable(R.mipmap.icon_circle_flight_atomlt), (Drawable) null, (Drawable) null);
    ...
    public /* synthetic */ void lambda$onWaypointFlyClicked$1$AtomLTIntelligentModeController(View view, Controller controller) {
        ((TextView) view.findViewById(R.id.tv_view)).setText(getContext().getResources().getString(R.string.guide_intelligent_waypoint));
        this.tvWaypoint.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, getContext().getDrawable(R.mipmap.icon_waypoint_flight_click_atomlt), (Drawable) null, (Drawable) null);
    ...
    private void onFollowMeClicked() {
        if (SPHelper.getInstance().getFollowMeMode()) {
            ...
            NewbieGuide.with(getContext()).addGuidePage(GuidePage.newInstance().addHighLight(this.tvFollowMe, new RelativeGuide(R.layout.guide_follow_me, 5)).setEnterAnimation(AnimationUtil.enterAnimation()).setExitAnimation(AnimationUtil.exitAnimation()).setOnLayoutInflatedListener(new OnLayoutInflatedListener() { // from class: com.ipotensic.kernel.controllers.-$$Lambda$AtomLTIntelligentModeController$Jtnd2qrWhRTsNNiaP4zUPnf7aUU
                @Override // com.ipotensic.baselib.guide.listener.OnLayoutInflatedListener
                public final void onLayoutInflated(View view, Controller controller) {
                    AtomLTIntelligentModeController.this.lambda$onFollowMeClicked$2$AtomLTIntelligentModeController(view, controller);
                }
            }).setBackgroundColor(getContext().getResources().getColor(R.color.color_guide_bg))).setOnGuideChangedListener(new OnGuideChangedListener() { // from class: com.ipotensic.kernel.controllers.AtomLTIntelligentModeController.3
                @Override // com.ipotensic.baselib.guide.listener.OnGuideChangedListener
                public void onRemoved(Controller controller) {
                }
    ...
    public /* synthetic */ void lambda$onFollowMeClicked$2$AtomLTIntelligentModeController(View view, Controller controller) {
        ((TextView) view.findViewById(R.id.tv_view)).setText(getContext().getResources().getString(R.string.guide_intelligent_follow));
        this.tvFollowMe.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, getContext().getDrawable(R.mipmap.icon_follow_me_click_atomlt), (Drawable) null, (Drawable) null);
        this.tvFollowMe.setAlpha(1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void onIntelligentIconClick() {
        this.tvHotCircle.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, getContext().getDrawable(FlightConfig.isConnectFlight() ? R.mipmap.icon_circle_flight_click_atomlt : R.mipmap.icon_circle_flight_atomlt), (Drawable) null, (Drawable) null);
        this.tvHotCircle.setAlpha(FlightConfig.isConnectFlight() ? 1.0f : 0.5f);
        this.tvWaypoint.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, getContext().getDrawable(FlightConfig.isConnectFlight() ? R.mipmap.icon_waypoint_flight_click_atomlt : R.mipmap.icon_waypoint_flight_disconnect_atomlt), (Drawable) null, (Drawable) null);
        this.tvWaypoint.setAlpha(FlightConfig.isConnectFlight() ? 1.0f : 0.5f);
        this.tvFollowMe.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, getContext().getDrawable(FlightConfig.isConnectFlight() ? R.mipmap.icon_follow_me_click_atomlt : R.mipmap.icon_follow_me_disconnect_atomlt), (Drawable) null, (Drawable) null);
    ...
    public void onClick(View view) {
        ...
        int id = view.getId();
        if (id == R.id.atomLT_tv_hot_circle) {
            onHotCircleClicked();
            return;
        }
        if (id == R.id.atomLT_tv_waypoint_flight) {
            onWaypointFlyClicked();
            return;
        }
        if (id == R.id.atomLT_tv_follow_me) {
            onFollowMeClicked();
            return;
        }
        if (id == R.id.atomLT_intelligent_view_blank) {
            DDLog.e(str, "onClick atomLT_intelligent_view_blank");
            this.isDisable = true;
        ...
        if (id == R.id.atomLT_iv_left) {
            DDLog.e(str, "onClick atomLT_iv_left");
            ...
            this.leftCircleDirection.setImageResource(R.mipmap.icon_circle_direction_left_click_atomlt);
            this.rightCircleDirection.setImageResource(R.mipmap.icon_circle_direction_right_atomlt);
            return;
        }
        if (id == R.id.atomLT_iv_right) {
            DDLog.e(str, "onClick atomLT_iv_right");
            if (FlightConfig.isConnectFlight()) {
                if (!FlightRevData.get().getFlightRevSettingData().isClockwise()) {
                    FlightSendData.get().getSendFlightSetData().setClockwise(true);
                    DataManager.getInstance().startSendSetting();
                }
                this.leftCircleDirection.setImageResource(R.mipmap.icon_circle_direction_left_atomlt);
                this.rightCircleDirection.setImageResource(R.mipmap.icon_circle_direction_right_click_atomlt);
                return;
            }
            return;
        }
        if (id == R.id.start_circle_flight) {
    ...
    public void setVisibility(int i) {
        ...
        if (i == 0) {
            ...
            this.viewBg.setBackgroundColor(FlightConfig.isConnectFlight() ? getContext().getResources().getColor(R.color.color_intelligent_mode_blank) : getContext().getResources().getColor(R.color.colorEightyPercent));
            this.tvHotCircle.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, getContext().getDrawable(FlightConfig.isConnectFlight() ? R.mipmap.icon_circle_flight_click_atomlt : R.mipmap.icon_circle_flight_atomlt), (Drawable) null, (Drawable) null);
            this.tvHotCircle.setAlpha(FlightConfig.isConnectFlight() ? 1.0f : 0.5f);
            this.tvWaypoint.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, getContext().getDrawable(FlightConfig.isConnectFlight() ? R.mipmap.icon_waypoint_flight_click_atomlt : R.mipmap.icon_waypoint_flight_disconnect_atomlt), (Drawable) null, (Drawable) null);
            this.tvWaypoint.setAlpha(FlightConfig.isConnectFlight() ? 1.0f : 0.5f);
    ...
    private void setUpdateView(boolean z) {
        ...
        this.tvHotCircle.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, getContext().getDrawable(z ? R.mipmap.icon_circle_flight_click_atomlt : R.mipmap.icon_circle_flight_atomlt), (Drawable) null, (Drawable) null);
        this.tvHotCircle.setAlpha(z ? 1.0f : 0.5f);
        this.tvCircleFlightSetting.setAlpha(z ? 1.0f : 0.5f);
        this.tvWaypoint.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, getContext().getDrawable(z ? R.mipmap.icon_waypoint_flight_click_atomlt : R.mipmap.icon_waypoint_flight_disconnect_atomlt), (Drawable) null, (Drawable) null);
        this.tvWaypoint.setAlpha(z ? 1.0f : 0.5f);
        this.tvFollowMe.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, getContext().getDrawable(z ? R.mipmap.icon_follow_me_click_atomlt : R.mipmap.icon_follow_me_disconnect_atomlt), (Drawable) null, (Drawable) null);
        ...
        this.startCircleFlight.setBackgroundColor(getContext().getColor(z ? R.color.colorSettingSelectBg : R.color.colorSettingUnSelectBg));
        this.startCircleFlight.setTextColor(getContext().getColor(z ? R.color.colorWhite : R.color.color_white_fifty_percent));
        this.atomLTIntelligentModeRight.setBackgroundColor(getContext().getColor(R.color.colorEightyPercent));
        boolean z2 = false;
    ...
    private void initCircleLimitUI() {
        ...
        spannableString.setSpan(new ForegroundColorSpan(getContext().getColor(R.color.color_gray)), 0, spannableString.length(), 17);
        this.tvRadiusTips.setText(getContext().getString(R.string.atom_lt_circling_flight_setting_circling_radius_title));
        ...
        spannableString2.setSpan(new ForegroundColorSpan(getContext().getColor(R.color.color_gray)), 0, spannableString2.length(), 17);
        this.tvSpeedTips.setText(getContext().getString(R.string.sys_basic_speed));
        ...
        this.radiusSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.ipotensic.kernel.controllers.AtomLTIntelligentModeController.6
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean z2) {
                if (z2) {
                    ...
                    DDLog.e(AtomLTIntelligentModeController.TAG, "radiusSeekBar onProgressChanged value = " + value);
        ...
        this.speedSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.ipotensic.kernel.controllers.AtomLTIntelligentModeController.7
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean z2) {
                if (z2) {
                    ...
                    DDLog.e(AtomLTIntelligentModeController.TAG, "speedSeekBar onProgressChanged value = " + value);
        ...
        this.leftCircleDirection.setImageResource(FlightRevData.get().getFlightRevSettingData().isClockwise() ? R.mipmap.icon_circle_direction_left_atomlt : R.mipmap.icon_circle_direction_left_click_atomlt);
        this.rightCircleDirection.setImageResource(FlightRevData.get().getFlightRevSettingData().isClockwise() ? R.mipmap.icon_circle_direction_right_click_atomlt : R.mipmap.icon_circle_direction_right_atomlt);
    }
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        if (FlightConfig.isAtomLT() || FlightConfig.is_Atom_SE_Series()) {
            int i = AnonymousClass8.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()];
            if (i != 1) {
                if (i != 2) {
                    return;
                }
    ...
    /* renamed from: com.ipotensic.kernel.controllers.AtomLTIntelligentModeController$8, reason: invalid class name */
