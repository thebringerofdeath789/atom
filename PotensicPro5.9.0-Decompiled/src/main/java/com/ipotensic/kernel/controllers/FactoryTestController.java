...
public class FactoryTestController extends BaseController implements CommonSwitchView.OnSwitchChangeListener {
    ...
    public void initView(View view) {
        this.viewFactoryTest = (CommonSwitchView) view.findViewById(R.id.view_factory_test);
        this.viewOfficeTest = (CommonSwitchView) view.findViewById(R.id.view_office_test);
        this.viewCameraTest = (CommonSwitchView) view.findViewById(R.id.view_camera_test);
        this.viewMaintainTest = (CommonSwitchView) view.findViewById(R.id.view_maintain_test);
        this.viewOpenModelTest = (CommonSwitchView) view.findViewById(R.id.view_open_model_test);
        this.viewOpenGpsTest = (CommonSwitchView) view.findViewById(R.id.view_open_gps_test);
        this.viewImuCal = (CommonSwitchView) view.findViewById(R.id.view_imu_cal);
        this.viewGpsLocation = (CommonSwitchView) view.findViewById(R.id.view_location_test);
        this.viewFpvTest = (CommonSwitchView) view.findViewById(R.id.view_fpv_test);
        ((CommonTitleView) view.findViewById(R.id.view_title)).setListener(new CommonTitleView.OnClickListener() { // from class: com.ipotensic.kernel.controllers.-$$Lambda$FactoryTestController$KD6tq7WNsYp6vNiNj7hGLyjT2gE
        ...
        switch (AnonymousClass1.$SwitchMap$com$ipotensic$baselib$enums$PackageType[PhoneConfig.PACK_TYPE.ordinal()]) {
            case 1:
    ...
    public void onCheckedChanged(View view, boolean z) {
        if (view.getId() == R.id.view_factory_test) {
            if (z) {
        ...
        if (view.getId() == R.id.view_office_test) {
            if (z) {
        ...
        if (view.getId() == R.id.view_camera_test) {
            if (z) {
        ...
        if (view.getId() == R.id.view_maintain_test) {
            if (z) {
        ...
        if (view.getId() == R.id.view_open_model_test) {
            if (z) {
        ...
        if (view.getId() == R.id.view_imu_cal) {
            if (z) {
                checkedChange(this.viewImuCal);
            }
            openImuCalTest(z);
        } else if (view.getId() == R.id.view_location_test) {
            if (z) {
                checkedChange(this.viewGpsLocation);
            }
            openGpsLocationTest(z);
        } else if (view.getId() == R.id.view_fpv_test) {
            if (z) {
    ...
    private void setTestView() {
        ...
        if (testGpsProductionController != null) {
            testGpsProductionController.setGpsTestType(PhoneConfig.PACK_TYPE == PackageType.TYPE_MODEL ? TestGpsProductionController.TestType.TYPE_MODEL : PhoneConfig.PACK_TYPE == PackageType.TYPE_GPS ? TestGpsProductionController.TestType.TYPE_TEST : TestGpsProductionController.TestType.TYPE_NONE);
        }
    ...
    /* renamed from: com.ipotensic.kernel.controllers.FactoryTestController$1, reason: invalid class name */
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        if (AnonymousClass1.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()] != 1) {
            return;
        }
        this.viewImuCal.check(false);
