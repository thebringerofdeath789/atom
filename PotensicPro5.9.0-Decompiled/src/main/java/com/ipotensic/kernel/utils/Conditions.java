...
public class Conditions {
    ...
    public static boolean cannotTakeOff() {
        ...
        return z || (flightRevFlightInfoData.getRemainedBattery() != -1 && flightRevFlightInfoData.getRemainedBattery() < 5);
    }
    ...
    /* renamed from: com.ipotensic.kernel.utils.Conditions$1, reason: invalid class name */
    ...
    public static VisionError checkConditionError(int i) {
        ...
        float tofHeight = geoTestData.isInit() ? geoTestData.getTofHeight() : 0.0f;
        ...
        if ((tofHeight > 0.0f && tofHeight < f3) || verticalDistance < f3) {
