...
public class SettingPairDroneFragment extends BaseKFragment<ViewLayoutPairDroneAgainBinding> implements BaseModelObservable.OnPropertyChangeListener {
    ...
    private final Handler handler = new Handler(Looper.getMainLooper()) { // from class: com.ipotensic.kernel.fragment.calibration.SettingPairDroneFragment.1
        ...
        public void handleMessage(Message message) {
            ...
            int i = message.arg1;
            ((ViewLayoutPairDroneAgainBinding) SettingPairDroneFragment.this.mBind).tvCountDown.setText(String.format(SettingPairDroneFragment.this.getString(R.string.exiting), Integer.valueOf(i)));
            if (i <= 0) {
    ...
    public int getLayoutId() {
        return R.layout.view_layout_pair_drone_again;
    }
    ...
    public void initData() {
        ...
        ((ViewLayoutPairDroneAgainBinding) this.mBind).tvCodeStep.setText(getString(FlightConfig.isAtomLT() ? R.string.atom_lt_frequency_pairing_mode_tips1 : R.string.mini_code_step_one));
        ((ViewLayoutPairDroneAgainBinding) this.mBind).tvCodeStepTwo.setText(getString(FlightConfig.isAtomLT() ? R.string.atom_lt_frequency_pairing_mode_tips2 : R.string.mini_code_step_two));
    }
    ...
    /* renamed from: com.ipotensic.kernel.fragment.calibration.SettingPairDroneFragment$2, reason: invalid class name */
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        DDLog.e("对频------结果: " + flightRevMiniPairData.isPairSuccess());
        if (flightRevMiniPairData.isPairSuccess()) {
            ...
            ((ViewLayoutPairDroneAgainBinding) this.mBind).tvCodeStep.setText(getString(R.string.repair_will_complete));
    ...
    public void resetUI() {
        ...
        ((ViewLayoutPairDroneAgainBinding) this.mBind).tvCodeStep.setText(getString(FlightConfig.isAtomLT() ? R.string.atom_lt_frequency_pairing_mode_tips1 : R.string.mini_code_step_one));
        ((ViewLayoutPairDroneAgainBinding) this.mBind).tvCodeStep.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.img_code_step_one, 0, 0, 0);
        ((ViewLayoutPairDroneAgainBinding) this.mBind).tvCodeStepTwo.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.img_code_step_two, 0, 0, 0);
