...
public final class ErrorTipsManager {
        ...
        this.handler = new Handler(Looper.getMainLooper(), new Handler.Callback() { // from class: com.ipotensic.kernel.manager.ErrorTipsManager$handler$1
            ...
            public final boolean handleMessage(Message msg) {
                ...
                if (msg.what == -1) {
                    ...
                    View childView = errorTipsManager.getChildView(errorTipsManager.getMContext(), msg.arg1);
    ...
    public final View getChildView(Context context, int id) {
    ...
    public final void enqueue(int msg) {
        synchronized (this) {
