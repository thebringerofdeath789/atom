...
public class HorizontalWheelView extends HorizontalScrollView {
    ...
    public void setItems(int i, List<String> list, int i2) {
        ...
        initData(i2);
        String str = TAG;
        DDLog.e(str, "parent width = " + i);
        DDLog.e(str, "item width = " + this.itemWidth);
    }
    ...
    public /* synthetic */ void lambda$init$2$HorizontalWheelView() {
        ...
        if (i - scrollX == 0) {
            ...
            if (i3 > i2 / 2) {
                post(new Runnable() { // from class: com.ipotensic.kernel.view.-$$Lambda$HorizontalWheelView$kj9F_1Kv0xpVcnhEbm7hmdRtIJI
                    @Override // java.lang.Runnable
                    public final void run() {
                        HorizontalWheelView.this.lambda$null$0$HorizontalWheelView(i3, i4);
                    }
                });
                return;
            } else {
                post(new Runnable() { // from class: com.ipotensic.kernel.view.-$$Lambda$HorizontalWheelView$COVtK91WWugiBawfbG7CLpRBcgk
                    @Override // java.lang.Runnable
                    public final void run() {
                        HorizontalWheelView.this.lambda$null$1$HorizontalWheelView(i3, i4);
                    }
                });
                return;
            }
    ...
    public /* synthetic */ void lambda$null$0$HorizontalWheelView(int i, int i2) {
    ...
    public /* synthetic */ void lambda$null$1$HorizontalWheelView(int i, int i2) {
