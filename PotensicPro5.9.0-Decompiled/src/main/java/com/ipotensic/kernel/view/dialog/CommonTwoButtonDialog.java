...
public final class CommonTwoButtonDialog extends CommonDialog {
    ...
    public void convertView(BaseDialogViewHolder holder, BaseDialog dialog) {
        ...
        if (str != null) {
            holder.setText(R.id.btn_cancel, str);
        }
        String str2 = this.confirmStr;
        if (str2 != null) {
            holder.setText(R.id.btn_confirm, str2);
        }
        holder.setOnClickListener(R.id.btn_confirm, new View.OnClickListener() { // from class: com.ipotensic.kernel.view.dialog.CommonTwoButtonDialog$convertView$3
        ...
        holder.setOnClickListener(R.id.btn_cancel, new View.OnClickListener() { // from class: com.ipotensic.kernel.view.dialog.CommonTwoButtonDialog$convertView$4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Function0 function0;
                boolean z;
