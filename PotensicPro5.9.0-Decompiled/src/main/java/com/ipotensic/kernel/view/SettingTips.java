...
public class SettingTips {
    ...
    public void tips(Activity activity, FlightRevStateData flightRevStateData) {
        ...
        if (this.newModeBeyondLimitDistance != flightRevStateData.isNewModeBeyondLimitDistance()) {
            this.newModeBeyondLimitDistance = flightRevStateData.isNewModeBeyondLimitDistance();
            this.text1 = activity.getResources().getString(R.string.setting_new_beyond_limit_distance);
        } else {
            this.text1 = null;
        }
        if (this.newModeBeyondLimitHeight != flightRevStateData.isNewModeBeyondLimitHeight()) {
            this.newModeBeyondLimitHeight = flightRevStateData.isNewModeBeyondLimitHeight();
            this.text2 = activity.getResources().getString(R.string.setting_new_beyond_limit_height);
        } else {
            this.text2 = null;
        }
        if (this.speedModeNewModeFail != flightRevStateData.isSpeedModeNewModeFail()) {
            this.speedModeNewModeFail = flightRevStateData.isSpeedModeNewModeFail();
            this.text3 = activity.getResources().getString(R.string.setting_new_speed_mode_fail);
        } else {
            this.text3 = null;
        }
        if (this.beyondLimitDistanceFail != flightRevStateData.isBeyondLimitDistanceFail()) {
            this.beyondLimitDistanceFail = flightRevStateData.isBeyondLimitDistanceFail();
            this.text4 = activity.getResources().getString(R.string.setting_beyond_limit_distance);
        } else {
            this.text4 = null;
        }
        if (this.beyondLimitHeightFail != flightRevStateData.isBeyondLimitHeightFail()) {
            this.beyondLimitHeightFail = flightRevStateData.isBeyondLimitHeightFail();
            this.text5 = activity.getResources().getString(R.string.setting_beyond_limit_height);
        } else {
            this.text5 = null;
        }
        if (this.heightLowFollowOpenFail != flightRevStateData.isHeightLowFollowOpenFail()) {
            this.heightLowFollowOpenFail = flightRevStateData.isHeightLowFollowOpenFail();
            this.text6 = activity.getResources().getString(R.string.setting_height_low_follow_fail);
        } else {
            this.text6 = null;
        }
