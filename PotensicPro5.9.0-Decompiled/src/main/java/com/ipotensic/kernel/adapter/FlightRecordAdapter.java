...
public class FlightRecordAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        if (i == 0) {
            return new HeadViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.view_item_flight_record_head, viewGroup, false));
        }
        if (i == 1) {
            return new BodyViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.view_item_flight_record_body, viewGroup, false));
        }
        return null;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int i) {
        if (viewHolder instanceof BodyViewHolder) {
            ...
            if (i % 2 == 0) {
                bodyViewHolder.linearLayout.setBackgroundResource(R.color.color_flight_point_record_bg);
            } else {
                bodyViewHolder.linearLayout.setBackgroundResource(R.color.color_bg_upgrade_dialog);
            }
    ...
    class BodyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public BodyViewHolder(View view) {
            super(view);
            this.tvFlightRecord = (TextView) view.findViewById(R.id.tv_item);
            this.linearLayout = (LinearLayout) view.findViewById(R.id.item_ll);
