...
public class ImageGridViewAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (this.supportType == CameraSupport.SupportType.TYPE_PHOTO_SIZE || this.supportType == CameraSupport.SupportType.TYPE_SPLIT_VIDEO) {
            inflate = this.layoutInflater.inflate(R.layout.view_layout_size_item1, (ViewGroup) null);
            textView = (TextView) inflate.findViewById(R.id.txt);
            textView.setTypeface(PhoneConfig.sourceHanSansCN);
        } else {
            inflate = this.layoutInflater.inflate(R.layout.view_layout_size_item2, (ViewGroup) null);
            textView = (TextView) inflate.findViewById(R.id.txt);
        ...
        inflate.findViewById(R.id.iv_bg_select).setVisibility(cameraSetBean.isSelect() ? 0 : 4);
