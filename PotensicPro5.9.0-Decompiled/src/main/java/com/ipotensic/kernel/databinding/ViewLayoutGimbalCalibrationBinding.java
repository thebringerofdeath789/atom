...
public abstract class ViewLayoutGimbalCalibrationBinding extends ViewDataBinding {
    ...
    public static ViewLayoutGimbalCalibrationBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z, Object obj) {
        return (ViewLayoutGimbalCalibrationBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.view_layout_gimbal_calibration, viewGroup, z, obj);
    }
    ...
    public static ViewLayoutGimbalCalibrationBinding inflate(LayoutInflater layoutInflater, Object obj) {
        return (ViewLayoutGimbalCalibrationBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.view_layout_gimbal_calibration, null, false, obj);
    }
    ...
    public static ViewLayoutGimbalCalibrationBinding bind(View view, Object obj) {
        return (ViewLayoutGimbalCalibrationBinding) bind(obj, view, R.layout.view_layout_gimbal_calibration);
    }
}
