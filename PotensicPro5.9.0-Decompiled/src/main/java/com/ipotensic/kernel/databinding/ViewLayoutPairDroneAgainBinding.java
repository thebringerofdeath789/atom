...
public abstract class ViewLayoutPairDroneAgainBinding extends ViewDataBinding {
    ...
    public static ViewLayoutPairDroneAgainBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z, Object obj) {
        return (ViewLayoutPairDroneAgainBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.view_layout_pair_drone_again, viewGroup, z, obj);
    }
    ...
    public static ViewLayoutPairDroneAgainBinding inflate(LayoutInflater layoutInflater, Object obj) {
        return (ViewLayoutPairDroneAgainBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.view_layout_pair_drone_again, null, false, obj);
    }
    ...
    public static ViewLayoutPairDroneAgainBinding bind(View view, Object obj) {
        return (ViewLayoutPairDroneAgainBinding) bind(obj, view, R.layout.view_layout_pair_drone_again);
    }
}
