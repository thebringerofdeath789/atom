...
public final class ViewLayoutSetting1Binding implements ViewBinding {
    ...
    public static ViewLayoutSetting1Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.view_layout_setting_1, viewGroup, false);
        if (z) {
    ...
    public static ViewLayoutSetting1Binding bind(View view) {
        ...
        if (findViewById4 != null) {
            ...
            if (imageView != null) {
                i = R.id.layout_fly_fence;
                LinearLayout linearLayout = (LinearLayout) view.findViewById(i);
                if (linearLayout != null) {
                    i = R.id.layout_return_height;
                    LinearLayout linearLayout2 = (LinearLayout) view.findViewById(i);
                    if (linearLayout2 != null) {
                        i = R.id.layout_speed_mode;
                        LinearLayout linearLayout3 = (LinearLayout) view.findViewById(i);
                        if (linearLayout3 != null && (findViewById = view.findViewById((i = R.id.line1))) != null && (findViewById2 = view.findViewById((i = R.id.line5))) != null && (findViewById3 = view.findViewById((i = R.id.line7))) != null) {
                            i = R.id.tv_controller_set;
                            ...
                            if (textView != null) {
                                ...
                                if (textView2 != null) {
                                    ...
                                    if (textView3 != null) {
                                        i = R.id.tv_fly_fence_title;
                                        TextView textView4 = (TextView) view.findViewById(i);
                                        if (textView4 != null) {
                                            i = R.id.tv_return_height_title;
                                            TextView textView5 = (TextView) view.findViewById(i);
                                            if (textView5 != null) {
                                                i = R.id.tv_speed_change;
