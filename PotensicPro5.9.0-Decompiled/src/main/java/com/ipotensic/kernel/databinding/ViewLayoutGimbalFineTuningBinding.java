...
public abstract class ViewLayoutGimbalFineTuningBinding extends ViewDataBinding {
    ...
    public static ViewLayoutGimbalFineTuningBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z, Object obj) {
        return (ViewLayoutGimbalFineTuningBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.view_layout_gimbal_fine_tuning, viewGroup, z, obj);
    }
    ...
    public static ViewLayoutGimbalFineTuningBinding inflate(LayoutInflater layoutInflater, Object obj) {
        return (ViewLayoutGimbalFineTuningBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.view_layout_gimbal_fine_tuning, null, false, obj);
    }
    ...
    public static ViewLayoutGimbalFineTuningBinding bind(View view, Object obj) {
        return (ViewLayoutGimbalFineTuningBinding) bind(obj, view, R.layout.view_layout_gimbal_fine_tuning);
    }
}
