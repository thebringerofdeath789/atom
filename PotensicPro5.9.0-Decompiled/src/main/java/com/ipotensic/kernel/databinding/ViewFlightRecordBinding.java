...
public final class ViewFlightRecordBinding implements ViewBinding {
    ...
    public static ViewFlightRecordBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.view_flight_record, viewGroup, false);
        if (z) {
    ...
    public static ViewFlightRecordBinding bind(View view) {
        ...
        View findViewById3;
        View findViewById4;
        int i = R.id.edt_speed;
        TextView textView = (TextView) view.findViewById(i);
        if (textView != null && (findViewById = view.findViewById((i = R.id.line1))) != null && (findViewById2 = view.findViewById((i = R.id.line2))) != null && (findViewById3 = view.findViewById((i = R.id.line3))) != null && (findViewById4 = view.findViewById((i = R.id.line4))) != null) {
            i = R.id.ll_distance;
