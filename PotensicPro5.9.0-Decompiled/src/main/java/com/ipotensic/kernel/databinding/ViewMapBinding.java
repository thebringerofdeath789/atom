...
public final class ViewMapBinding implements ViewBinding {
    ...
    private ViewMapBinding(ConstraintLayout constraintLayout, ImageButton imageButton, ImageButton imageButton2, ImageView imageView, ImageButton imageButton3, ImageButton imageButton4, ImageButton imageButton5, ImageButton imageButton6, ImageButton imageButton7, ImageButton imageButton8, ImageButton imageButton9, ImageButton imageButton10, ViewMapPositionBinding viewMapPositionBinding, ViewMapSetBinding viewMapSetBinding, ViewMapTypeBinding viewMapTypeBinding) {
        ...
        this.ivWaypointCancel = imageButton8;
        this.ivWaypointFly = imageButton9;
        this.ivWaypointStopFly = imageButton10;
                                    ...
                                    if (imageButton7 != null) {
                                        ...
                                        if (imageButton8 != null) {
                                            ...
                                            if (imageButton9 != null) {
                                                ...
                                                if (imageButton10 != null && (findViewById = view.findViewById((i = R.id.view_map_position))) != null) {
                                                    ...
                                                    if (findViewById2 != null) {
                                                        ...
                                                        if (findViewById3 != null) {
                                                            return new ViewMapBinding((ConstraintLayout) view, imageButton, imageButton2, imageView, imageButton3, imageButton4, imageButton5, imageButton6, imageButton7, imageButton8, imageButton9, imageButton10, bind, bind2, ViewMapTypeBinding.bind(findViewById3));
                                                        }
                                                    }
                                                }
                                            }
