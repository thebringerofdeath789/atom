...
public final class ViewGridLineBinding implements ViewBinding {
    ...
    public static ViewGridLineBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.view_grid_line, viewGroup, false);
        if (z) {
    ...
    public static ViewGridLineBinding bind(View view) {
        ...
        if (findViewById4 != null && (findViewById = view.findViewById((i = R.id.horizontal_line_2))) != null && (findViewById2 = view.findViewById((i = R.id.vertical_line_1))) != null && (findViewById3 = view.findViewById((i = R.id.vertical_line_2))) != null) {
