...
public final class ViewMapVideoControllerBinding implements ViewBinding {
    ...
    public static ViewMapVideoControllerBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.view_map_video_controller, viewGroup, false);
        if (z) {
                                                        ...
                                                        if (textView != null) {
                                                            ...
                                                            if (textView2 != null) {
                                                                ...
                                                                if (textView3 != null) {
                                                                    ...
                                                                    if (textView4 != null) {
                                                                        i = R.id.tv_system_acc;
                                                                        TextView textView5 = (TextView) view.findViewById(i);
                                                                        if (textView5 != null) {
                                                                            i = R.id.two_finger_scale_view;
                                                                            ...
                                                                            if (twoFingerScaleView != null) {
                                                                                ...
                                                                                if (roundRelativeLayout2 != null && (findViewById = view.findViewById((i = R.id.view_flight_record_details))) != null) {
                                                                                    ViewFlightRecordBinding bind = ViewFlightRecordBinding.bind(findViewById);
                                                                                    i = R.id.view_map_control;
