...
public final class ActivityKernelBinding implements ViewBinding {
    ...
    private ActivityKernelBinding(ConstraintLayout constraintLayout, View view, ViewLayoutBottomControllerBinding viewLayoutBottomControllerBinding, FrameLayout frameLayout, FrameLayout frameLayout2, GimbalScaleView gimbalScaleView, View view2, CaptureAnimImageView captureAnimImageView, ViewLayoutCenterTipsBinding viewLayoutCenterTipsBinding, ConstraintLayout constraintLayout2, ViewLayoutRightVisionControllerBinding viewLayoutRightVisionControllerBinding, ViewLayoutTopLeftTipsBinding viewLayoutTopLeftTipsBinding, ViewLayoutTopTipsBinding viewLayoutTopTipsBinding, ViewLayoutLeftControllerBinding viewLayoutLeftControllerBinding, ViewMapVideoControllerBinding viewMapVideoControllerBinding, ViewCameraParamTips1Binding viewCameraParamTips1Binding, View view3, ViewRightSlideControllerBinding viewRightSlideControllerBinding, ViewRockerTouchControllerBinding viewRockerTouchControllerBinding, ViewLayoutSecurityTipsControllerBinding viewLayoutSecurityTipsControllerBinding, ViewStub viewStub, ViewStub viewStub2, ViewStub viewStub3, ViewStub viewStub4, ViewStub viewStub5, ViewStub viewStub6, ViewLayoutSixImuCalibrationControllerBinding viewLayoutSixImuCalibrationControllerBinding, ViewLayoutFactoryTestBinding viewLayoutFactoryTestBinding, LinearLayout linearLayout, ViewLayoutTopControllerBinding viewLayoutTopControllerBinding, ViewControllerModeBinding viewControllerModeBinding, TextView textView, TextView textView2, ViewAtomltLeftIntelligentModeBinding viewAtomltLeftIntelligentModeBinding, CameraQuickSettingView cameraQuickSettingView, ViewLeftIntelligentModeBinding viewLeftIntelligentModeBinding, FrameLayout frameLayout3, ViewWarnBinding viewWarnBinding) {
        ...
        this.viewPhotoGuide = frameLayout3;
    ...
    public static ActivityKernelBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.activity_kernel, viewGroup, false);
        if (z) {
    ...
    public static ActivityKernelBinding bind(View view) {
        ...
        View findViewById8;
        View findViewById9;
        int i = R.id.base_small_view;
        View findViewById10 = view.findViewById(i);
        if (findViewById10 != null && (findViewById = view.findViewById((i = R.id.bottom_controller))) != null) {
            ViewLayoutBottomControllerBinding bind = ViewLayoutBottomControllerBinding.bind(findViewById);
            i = R.id.fl_main_setting;
            FrameLayout frameLayout = (FrameLayout) view.findViewById(i);
            if (frameLayout != null) {
                i = R.id.fl_setting_second_page;
                FrameLayout frameLayout2 = (FrameLayout) view.findViewById(i);
                if (frameLayout2 != null) {
                    i = R.id.gimbal_scale_view;
                    GimbalScaleView gimbalScaleView = (GimbalScaleView) view.findViewById(i);
                    if (gimbalScaleView != null && (findViewById2 = view.findViewById((i = R.id.guide_right))) != null) {
                        i = R.id.img_anim_capture;
                        CaptureAnimImageView captureAnimImageView = (CaptureAnimImageView) view.findViewById(i);
                        if (captureAnimImageView != null && (findViewById3 = view.findViewById((i = R.id.layout_center_tips))) != null) {
                            ViewLayoutCenterTipsBinding bind2 = ViewLayoutCenterTipsBinding.bind(findViewById3);
                            ConstraintLayout constraintLayout = (ConstraintLayout) view;
                            i = R.id.layout_right_controller;
                                    ...
                                    if (findViewById13 != null) {
                                        ...
                                        if (findViewById14 != null) {
                                            ...
                                            if (findViewById15 != null) {
                                                ...
                                                i = R.id.right_camera_param_view;
                                                ...
                                                if (findViewById16 != null) {
                                                    ...
                                                    i = R.id.right_controller_temp;
                                                    View findViewById17 = view.findViewById(i);
                                                    if (findViewById17 != null && (findViewById4 = view.findViewById((i = R.id.right_slide_controller))) != null) {
                                                        ViewRightSlideControllerBinding bind9 = ViewRightSlideControllerBinding.bind(findViewById4);
                                                        i = R.id.rocker_touch_controller;
                                                        ...
                                                        if (findViewById18 != null) {
                                                            ...
                                                            i = R.id.security_tips_controller;
                                                                                ...
                                                                                if (viewStub5 != null) {
                                                                                    ...
                                                                                    if (viewStub6 != null && (findViewById5 = view.findViewById((i = R.id.stub_six_imu))) != null) {
                                                                                        ...
                                                                                        if (findViewById20 != null) {
                                                                                            ...
                                                                                            if (linearLayout != null && (findViewById6 = view.findViewById((i = R.id.top_controller))) != null) {
                                                                                                ViewLayoutTopControllerBinding bind14 = ViewLayoutTopControllerBinding.bind(findViewById6);
                                                                                                i = R.id.top_controller_mode;
                                                                                                ...
                                                                                                if (findViewById21 != null) {
                                                                                                    ...
                                                                                                    i = R.id.tv_firmware_upgrade_tips;
                                                                                                    TextView textView = (TextView) view.findViewById(i);
                                                                                                    if (textView != null) {
                                                                                                        i = R.id.tv_select_target_tips;
                                                                                                        TextView textView2 = (TextView) view.findViewById(i);
                                                                                                        if (textView2 != null && (findViewById7 = view.findViewById((i = R.id.view_atomLT_intelligent_mode))) != null) {
                                                                                                            ViewAtomltLeftIntelligentModeBinding bind16 = ViewAtomltLeftIntelligentModeBinding.bind(findViewById7);
                                                                                                            i = R.id.view_camera_quick_setting;
                                                                                                            CameraQuickSettingView cameraQuickSettingView = (CameraQuickSettingView) view.findViewById(i);
                                                                                                            if (cameraQuickSettingView != null && (findViewById8 = view.findViewById((i = R.id.view_intelligent_mode))) != null) {
                                                                                                                ViewLeftIntelligentModeBinding bind17 = ViewLeftIntelligentModeBinding.bind(findViewById8);
                                                                                                                i = R.id.view_photo_guide;
                                                                                                                FrameLayout frameLayout3 = (FrameLayout) view.findViewById(i);
                                                                                                                if (frameLayout3 != null && (findViewById9 = view.findViewById((i = R.id.view_warn_controller))) != null) {
                                                                                                                    return new ActivityKernelBinding(constraintLayout, findViewById10, bind, frameLayout, frameLayout2, gimbalScaleView, findViewById2, captureAnimImageView, bind2, constraintLayout, bind3, bind4, bind5, bind6, bind7, bind8, findViewById17, bind9, bind10, bind11, viewStub, viewStub2, viewStub3, viewStub4, viewStub5, viewStub6, bind12, bind13, linearLayout, bind14, bind15, textView, textView2, bind16, cameraQuickSettingView, bind17, frameLayout3, ViewWarnBinding.bind(findViewById9));
                                                                                                                }
                                                                                                            }
                                                                                                        }
                                                                                                    }
