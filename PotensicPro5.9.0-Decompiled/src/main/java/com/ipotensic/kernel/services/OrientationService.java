...
public class OrientationService implements SensorEventListener {
    ...
    private Handler handler = new Handler(Looper.getMainLooper()) { // from class: com.ipotensic.kernel.services.OrientationService.1
        ...
        public void handleMessage(Message message) {
            ...
            int i = message.what;
            if (i != 0) {
                if (i == 1 && OrientationService.this.gravity != null && OrientationService.this.geomagnetic != null && SensorManager.getRotationMatrix(OrientationService.this.r, null, OrientationService.this.gravity, OrientationService.this.geomagnetic)) {
                    SensorManager.getOrientation(OrientationService.this.r, OrientationService.this.values);
                    DDLog.e("map", "values[0]: " + OrientationService.this.values[0]);
                    OrientationService.this.orientationX = (float) Math.toDegrees(OrientationService.this.values[0]);
                    DDLog.e("map", "values[1]: " + OrientationService.this.orientationX);
                    OrientationService.this.orientationX += screenRotationOnPhone;
            ...
            if (System.currentTimeMillis() - OrientationService.this.lastRecordTime > Constant.DELAY_MILLIS) {
                ...
                DDLog.e("Map orientationService orientation = " + OrientationService.this.orientationX + ",screenRotationOnPhone = " + screenRotationOnPhone);
            }
        }
    };
    ...
    public int getScreenRotationOnPhone(Context context) {
        try {
            ...
            DDLog.e("OrientationService.getScreenRotationOnPhone:" + e.getMessage());
            return 0;
        }
    }
