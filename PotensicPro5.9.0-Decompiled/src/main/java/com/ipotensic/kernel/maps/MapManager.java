...
public class MapManager implements View.OnClickListener, MapInfoListener, FlightRecordAdapter.OnItemClickListener {
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.iv_waypoint_stop_fly) {
            ...
            new GeneralDialog(context3, context3.getString(R.string.dialog_quit_cur_mode), this.context.getString(R.string.dialog_quit_cur_mode_describe), (String) null, (String) null, false, 2, new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.kernel.maps.MapManager.3
                @Override // com.ipotensic.kernel.view.dialog.GeneralDialog.ClickConfirmListener
                public void confirm() {
                    if (FlightRevData.get().getFlightRevStateData().isPointFly()) {
