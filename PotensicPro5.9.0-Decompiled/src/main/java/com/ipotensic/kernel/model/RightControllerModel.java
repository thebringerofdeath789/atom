...
public class RightControllerModel {
    ...
    /* renamed from: com.ipotensic.kernel.model.RightControllerModel$36, reason: invalid class name */
    ...
    /* renamed from: com.ipotensic.kernel.model.RightControllerModel$21, reason: invalid class name */
    class AnonymousClass21 extends ScaleClickListener {
        ...
        public /* synthetic */ void lambda$click$1$RightControllerModel$21() {
            ...
            PhoneConfig.mainHandler.postDelayed(new Runnable() { // from class: com.ipotensic.kernel.model.-$$Lambda$RightControllerModel$21$ARIGo1arMWAaf65O8Jreo1HKk5U
                @Override // java.lang.Runnable
                public final void run() {
                    RightControllerModel.AnonymousClass21.this.lambda$null$0$RightControllerModel$21();
                }
            }, 200L);
        }

        public /* synthetic */ void lambda$null$0$RightControllerModel$21() {
            try {
    ...
    public void cancelSelectTarget(OnSuccessListener onSuccessListener) {
        ...
        if (trackTarget == null || !trackTarget.isSelected() || this.trackTarget.getBboxes().size() < 1) {
            ...
            TrackTarget.Box m22clone = this.trackTarget.getBboxes().get(0).m22clone();
            m22clone.setBbox_id(-1);
            m22clone.setClass_id(-1);
            CameraCtrlPresenter.getInstance().selectTarget(m22clone);
