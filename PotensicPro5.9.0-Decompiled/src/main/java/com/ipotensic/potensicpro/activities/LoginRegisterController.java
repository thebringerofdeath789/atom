...
public class LoginRegisterController extends BaseController implements IRegisterView, ILoginView {
    ...
    public LoginRegisterController(AppCompatActivity appCompatActivity, ViewStub viewStub) {
        ...
        this.onKeyboardStatusChangeListener = new KeyboardHelper.OnKeyboardStatusChangeListener() { // from class: com.ipotensic.potensicpro.activities.LoginRegisterController.6
            ...
            public void onKeyboardPop(int i) {
                ...
                LoginRegisterController.this.tvLogo.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, LoginRegisterController.this.getContext().getResources().getDrawable(R.mipmap.img_logo_login_white), (Drawable) null, (Drawable) null);
                LoginRegisterController.this.tvLogo.setTextColor(LoginRegisterController.this.getContext().getResources().getColor(R.color.white));
            }
            ...
            public void onKeyboardClose(int i) {
                ...
                LoginRegisterController.this.tvLogo.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, LoginRegisterController.this.getContext().getResources().getDrawable(R.mipmap.img_logo_login), (Drawable) null, (Drawable) null);
                LoginRegisterController.this.tvLogo.setTextColor(LoginRegisterController.this.getContext().getResources().getColor(R.color.color_login_blue));
            }
        };
    }
    ...
    public void initView(View view) {
        this.tvChooseCountry = (TextView) view.findViewById(R.id.tv_choose_country);
        this.btnRegister = (Button) view.findViewById(R.id.btn_register);
        this.edtEmail = (EditText) view.findViewById(R.id.edit_register_username);
        this.edtPw = (EditText) view.findViewById(R.id.edit_register_password);
        this.tvEmailErrorTips = (TextView) view.findViewById(R.id.tv_email_error_tips);
        this.tvPasswordErrorTips = (TextView) view.findViewById(R.id.tv_password_error_tips);
    ...
    class MyTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            ...
            if (!FormatUtil.isEmail(LoginRegisterController.this.email) || !FormatUtil.passwordLength(LoginRegisterController.this.password)) {
                LoginRegisterController.this.btnRegister.setBackgroundResource(R.mipmap.img_btn_login_commit);
            } else {
                LoginRegisterController.this.btnRegister.setBackgroundResource(R.mipmap.img_btn_login_commit_press);
            }
        }
    }

    private void setOnClickListener(View view) {
        view.findViewById(R.id.tv_login).setOnClickListener(new ScaleClickListener() { // from class: com.ipotensic.potensicpro.activities.LoginRegisterController.7
        ...
        textView.setText(Html.fromHtml(getContext().getString(R.string.terms_and_agreements)));
    ...
    public void register() {
        if (this.countryName == null) {
            ToastUtil.toast(getContext(), getContext().getString(R.string.toast_choose_the_country));
            return;
        }
    ...
    public void onRegisterSuccess() {
        registerSuccess(getContext().getString(R.string.toast_register_successfully));
    }
    ...
    public void onEmailAlreadyUsed() {
        ...
        ToastUtil.toast(getContext(), getContext().getString(R.string.toast_mailbox_has_been_used));
        this.listener.toLoginPage();
    }
    ...
    public void onEmailNotExist() {
        ...
        ToastUtil.toast(getContext(), getContext().getString(R.string.toast_mailbox_does_not_exist));
    }

    @Override // com.logan.user.view.IRegisterView
    public void onRegisterError(String str) {
        registerFailed(getContext().getString(R.string.toast_registration_error));
    }
    ...
    private void registerFailed(String str) {
        ...
        new GeneralDialog((Context) getContext(), getContext().getResources().getString(R.string.dialog_failure), str, R.mipmap.img_dialog_failure, false, new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.potensicpro.activities.LoginRegisterController.11
