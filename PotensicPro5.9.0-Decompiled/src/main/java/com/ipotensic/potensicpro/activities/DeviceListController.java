...
public class DeviceListController extends BaseController implements View.OnClickListener {
    ...
    public void initData() {
        ...
        int i = R.mipmap.img_bg_p5_selected;
        int i2 = R.mipmap.img_bg_mini_se_selected;
        ...
        if (lastFlight == null) {
            ...
            int i4 = R.mipmap.img_bg_self_selected;
            ...
            if (FlightConfig.is_Atom_SE_Series()) {
                i2 = R.mipmap.img_bg_mini_se_normal;
            }
            list2.add(new DeviceInfo(FlightConfig.TYPE_ATOM_SE, string2, i2));
            List<DeviceInfo> list3 = this.list;
            String string3 = getContext().getString(R.string.title_wifi_connection);
            if (FlightConfig.isP5()) {
                i = R.mipmap.img_bg_p5_normal;
            }
            list3.add(new DeviceInfo(FlightConfig.TYPE_DREAMER_P5, string3, i));
            ...
            List<DeviceInfo> list4 = this.list;
            String string4 = getContext().getString(R.string.title_wifi_connection);
            if (FlightConfig.isP1Self()) {
                i4 = R.mipmap.img_bg_self_normal;
            }
            list4.add(new DeviceInfo(FlightConfig.TYPE_DREAMER_4K, string4, i4));
        }
