...
public class MainDeviceController extends BaseController implements View.OnClickListener, AOAEngine.IEngineCallback, OnGuideChangedListener, OnLocationChangedListener {
    ...
    public MainDeviceController(AppCompatActivity appCompatActivity, View view) {
        ...
        this.animRun = new Runnable() { // from class: com.ipotensic.potensicpro.activities.MainDeviceController.18
    ...
    public void initView(View view) {
        ...
        this.guideModelSelect = view.findViewById(R.id.guide_model_select);
        this.tvChoose = (TextView) view.findViewById(R.id.tv_choose);
        this.llTop = (LinearLayout) view.findViewById(R.id.ll_top);
        this.btnEnterDevice = (TextView) view.findViewById(R.id.btn_enter_device);
        this.bgEnterDevice = view.findViewById(R.id.view_enter_bg);
        ...
        this.groupAtom = (Group) view.findViewById(R.id.gp_atom);
        this.tvAcademy = (TextView) view.findViewById(R.id.tv_academy);
        this.tvFlightRecordAtom = (TextView) view.findViewById(R.id.tv_flight_record_atom);
        this.tvAircraftLogAtom = (TextView) view.findViewById(R.id.tv_aircraft_log_atom);
        this.tvCheckUpgrade = (TextView) view.findViewById(R.id.tv_check_upgrade);
    ...
    public /* synthetic */ void lambda$initView$0$MainDeviceController(State state) {
        ...
        setConnectUI(z);
        this.btnEnterDevice.setBackgroundResource(z ? R.drawable.bg_device_enter_select : R.drawable.bg_device_enter_no_select);
    }
    ...
    public void onEvent(EventID eventID, Event event) {
        ...
        int i = AnonymousClass19.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()];
        if (i == 1) {
        ...
        if (i != 2) {
            ...
            DDLog.e("对频失败");
            MiniPairFailDialog miniPairFailDialog2 = new MiniPairFailDialog(getContext(), R.layout.view_dialog_repair_main, new MiniPairFailDialog.OnClickListener() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$MainDeviceController$cUcR06aJRZRWTJJZogvCuhZ2Rls
        ...
        DDLog.e("对频状态" + flightRevConnectData.isMiniPairing());
    ...
    /* renamed from: com.ipotensic.potensicpro.activities.MainDeviceController$19, reason: invalid class name */
    ...
    private void showItemsGuide() {
        this.handler.postDelayed(new Runnable() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$MainDeviceController$4d6xWux6vRInnmicXwDYeg48dB8
            @Override // java.lang.Runnable
            public final void run() {
                MainDeviceController.this.lambda$showItemsGuide$9$MainDeviceController();
            }
        }, 400L);
    }

    public /* synthetic */ void lambda$showItemsGuide$9$MainDeviceController() {
        Builder onGuideChangedListener = NewbieGuide.with(getContext()).setOnGuideChangedListener(this);
        if (FlightConfig.is_Atom_Series()) {
            onGuideChangedListener.addGuidePage(getDefaultGuidePage().addHighLight(this.tvAcademy, new RelativeGuide(R.layout.guide_view_main_top_left, GravityCompat.START, 0, UnitUtil.dp2px(32), 0, 0, 0)).setOnLayoutInflatedListener(new OnLayoutInflatedListener() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$MainDeviceController$NGVT7-AnP8OkF7R2iKdkO5rVHa0
                @Override // com.ipotensic.baselib.guide.listener.OnLayoutInflatedListener
                public final void onLayoutInflated(View view, Controller controller) {
                    ((TextView) view.findViewById(R.id.tv_view)).setText(R.string.guide_homepage_academy_tips);
                }
            }).setShowCanClick(false, true, false)).addGuidePage(getDefaultGuidePage().addHighLight(this.tvFlightRecordAtom, new RelativeGuide(R.layout.guide_view_main_top_left, GravityCompat.START, 0, UnitUtil.dp2px(32), 0, 0, 0)).setOnLayoutInflatedListener(new OnLayoutInflatedListener() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$MainDeviceController$-s3omVLIVHx6K4EgkRfLNEdKves
                @Override // com.ipotensic.baselib.guide.listener.OnLayoutInflatedListener
                public final void onLayoutInflated(View view, Controller controller) {
                    ((TextView) view.findViewById(R.id.tv_view)).setText(R.string.guide_homepage_flight_record_tips);
                }
            }).setShowCanClick(true, true, false)).addGuidePage(getDefaultGuidePage().addHighLight(this.tvAircraftLogAtom, new RelativeGuide(R.layout.guide_view_main_top_left, GravityCompat.START, 0, UnitUtil.dp2px(32), 0, 0, 0)).setOnLayoutInflatedListener(new OnLayoutInflatedListener() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$MainDeviceController$nKgL0edgzhqvvxhrr8F1uBCFxUY
                @Override // com.ipotensic.baselib.guide.listener.OnLayoutInflatedListener
                public final void onLayoutInflated(View view, Controller controller) {
            ...
            onGuideChangedListener.addGuidePage(getDefaultGuidePage().addHighLight(this.tvVideoTeach, new RelativeGuide(R.layout.guide_view_main_top, GravityCompat.START, 0, UnitUtil.dp2px(20), 0, 0, 0)).setOnLayoutInflatedListener(new OnLayoutInflatedListener() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$MainDeviceController$sJyhVW_IdfhUngjXjPYU3aRUBn0
                @Override // com.ipotensic.baselib.guide.listener.OnLayoutInflatedListener
                public final void onLayoutInflated(View view, Controller controller) {
                    MainDeviceController.this.lambda$null$7$MainDeviceController(view, controller);
                }
            }).setShowCanClick(false, true, false)).addGuidePage(getDefaultGuidePage().addHighLight(this.tvInstructions, new RelativeGuide(R.layout.guide_view_main_top, GravityCompat.START, 0, UnitUtil.dp2px(20), 0, 0, 0)).setOnLayoutInflatedListener(new OnLayoutInflatedListener() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$MainDeviceController$x5sDdzAg0PrjQFS4lKW1jI65CGs
                @Override // com.ipotensic.baselib.guide.listener.OnLayoutInflatedListener
                public final void onLayoutInflated(View view, Controller controller) {
                    MainDeviceController.this.lambda$null$8$MainDeviceController(view, controller);
                }
            }).setShowCanClick(true, true, false));
        }
    ...
    public /* synthetic */ void lambda$null$7$MainDeviceController(View view, Controller controller) {
        ((TextView) view.findViewById(R.id.tv_view)).setText(getContext().getResources().getString(R.string.guide_drop_down_menu1));
    }

    public /* synthetic */ void lambda$null$8$MainDeviceController(View view, Controller controller) {
        ((TextView) view.findViewById(R.id.tv_view)).setText(getContext().getResources().getString(R.string.guide_drop_down_menu2));
    }

    private void showConnectGuide() {
        this.handler.postDelayed(new Runnable() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$MainDeviceController$zROmiahxZ9IObmAs5Z7jo80SFs0
            @Override // java.lang.Runnable
            public final void run() {
                MainDeviceController.this.lambda$showConnectGuide$12$MainDeviceController();
            }
        }, 400L);
    }

    public /* synthetic */ void lambda$showConnectGuide$12$MainDeviceController() {
        NewbieGuide.with(getContext()).setOnGuideChangedListener(this).addGuidePage(getDefaultGuidePage().addHighLight(this.tvDeviceState, new RelativeGuide(R.layout.guide_view_main_left, 5), UnitUtil.dip2px(8.0f), UnitUtil.dip2px(8.0f)).setOnLayoutInflatedListener(new OnLayoutInflatedListener() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$MainDeviceController$LjMwdpaHXgQjPBHe7D2FUmtRx4M
            @Override // com.ipotensic.baselib.guide.listener.OnLayoutInflatedListener
            public final void onLayoutInflated(View view, Controller controller) {
                MainDeviceController.this.lambda$null$10$MainDeviceController(view, controller);
            }
        })).addGuidePage(getDefaultGuidePage().addHighLight(this.tvDeviceState, new RelativeGuide(R.layout.guide_view_main_left, 5), UnitUtil.dip2px(8.0f), UnitUtil.dip2px(8.0f)).setOnLayoutInflatedListener(new OnLayoutInflatedListener() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$MainDeviceController$4xF3-NeMKoCp6a0u_PpjaotVd0I
            @Override // com.ipotensic.baselib.guide.listener.OnLayoutInflatedListener
            public final void onLayoutInflated(View view, Controller controller) {
                MainDeviceController.this.lambda$null$11$MainDeviceController(view, controller);
            }
        })).show();
    }

    public /* synthetic */ void lambda$null$10$MainDeviceController(View view, Controller controller) {
        this.tvDeviceState.setGuideStep1();
    }

    public /* synthetic */ void lambda$null$11$MainDeviceController(View view, Controller controller) {
        ((TextView) view.findViewById(R.id.tv_view)).setText(getContext().getResources().getString(R.string.guide_main_left2));
        this.tvDeviceState.setGuideStep2();
    }

    private void showEnterGuide() {
        NewbieGuide.with(getContext()).setOnGuideChangedListener(this).addGuidePage(getDefaultGuidePage().addHighLight(this.bgEnterDevice, new RelativeGuide(R.layout.guide_view_main_bottom, 48, 0, 0, 0, 0, 0)).setOnLayoutInflatedListener(new OnLayoutInflatedListener() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$MainDeviceController$aRCvyk9gI7VtjTWSCEOZAdZkJRg
            @Override // com.ipotensic.baselib.guide.listener.OnLayoutInflatedListener
            public final void onLayoutInflated(View view, Controller controller) {
                MainDeviceController.this.lambda$showEnterGuide$13$MainDeviceController(view, controller);
            }
        })).show();
    }

    public /* synthetic */ void lambda$showEnterGuide$13$MainDeviceController(View view, Controller controller) {
        ((TextView) view.findViewById(R.id.tv_view)).setText(R.string.guide_homepage_enter_flight_interface_tips);
        this.bgEnterDevice.setVisibility(0);
    }

    private GuidePage getDefaultGuidePage() {
        return GuidePage.newInstance().setEnterAnimation(AnimationUtil.enterAnimation()).setExitAnimation(AnimationUtil.exitAnimation()).setEverywhereCancelable(true).setBackgroundColor(ContextCompat.getColor(getContext(), R.color.colorFiftyPercent));
    }
    ...
    public void openGuide() {
        if (SPHelper.getInstance().getFirstEnterMain()) {
            ...
            openGuideDialog.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$MainDeviceController$r7J6ySV2Hg1MsBKKRb7LsFx3esA
                @Override // android.content.DialogInterface.OnDismissListener
                public final void onDismiss(DialogInterface dialogInterface) {
                    MainDeviceController.this.lambda$openGuide$14$MainDeviceController(dialogInterface);
                }
            });
    ...
    public /* synthetic */ void lambda$openGuide$14$MainDeviceController(DialogInterface dialogInterface) {
        startGuide();
    }
    ...
    public void changeModelBg() {
        ...
        DDLog.e("升级模式", FlightConfig.curFlight + "");
        setFlightRes();
        controlMenu();
    }
    ...
    public void showUpgradeButton(boolean z) {
        DDLog.e(OutputKeys.VERSION, "isNewVersion: " + z);
        TextView textView = this.tvCheckUpgrade;
        if (textView != null) {
            textView.setVisibility(z ? 0 : 8);
            this.tvCheckUpgrade.setText(getContext().getString(R.string.upgrade_check));
    ...
    private void setOnClickListener(View view) {
        view.findViewById(R.id.iv_logo).setOnClickListener(new ScaleClickListener() { // from class: com.ipotensic.potensicpro.activities.MainDeviceController.3
        ...
        this.tvDeviceState.setCheckBtnClickListener(new AnonymousClass5());
        int i = 1000;
        view.findViewById(R.id.tv_video_teach).setOnClickListener(new ScaleClickListener(i) { // from class: com.ipotensic.potensicpro.activities.MainDeviceController.6
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view2) {
        ...
        view.findViewById(R.id.tv_instructions).setOnClickListener(new ScaleClickListener(i) { // from class: com.ipotensic.potensicpro.activities.MainDeviceController.7
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view2) {
                if (MainDeviceController.this.isGuideShow()) {
                    return;
        ...
        view.findViewById(R.id.tv_flight_record).setOnClickListener(new ScaleClickListener(i) { // from class: com.ipotensic.potensicpro.activities.MainDeviceController.8
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view2) {
                if (MainDeviceController.this.isGuideShow()) {
                    return;
        ...
        view.findViewById(R.id.tv_aircraft_log_atom).setOnClickListener(new ScaleClickListener(i) { // from class: com.ipotensic.potensicpro.activities.MainDeviceController.9
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view2) {
                MainDeviceController.this.startAircraftLogActivity();
            }
        });
        view.findViewById(R.id.tv_flight_log).setOnClickListener(new ScaleClickListener(i) { // from class: com.ipotensic.potensicpro.activities.MainDeviceController.10
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view2) {
                MainDeviceController.this.startAircraftLogActivity();
            }
        });
        view.findViewById(R.id.tv_flight_record_atom).setOnClickListener(new ScaleClickListener(i) { // from class: com.ipotensic.potensicpro.activities.MainDeviceController.11
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view2) {
                if (MainDeviceController.this.isGuideShow()) {
                    return;
        ...
        this.tvAcademy.setOnClickListener(new ScaleClickListener(i) { // from class: com.ipotensic.potensicpro.activities.MainDeviceController.12
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view2) {
                if (MainDeviceController.this.isGuideShow()) {
                    return;
                }
                String str = "http://appserver.depstech.com/index.php/webapp/app/index?product=Atom&language=english&curLanguage=" + LanguageHelper.getLanguageType(MainDeviceController.this.getContext()) + "&clienttype=1";
                MainDeviceController mainDeviceController = MainDeviceController.this;
                mainDeviceController.startWebActivity(str, mainDeviceController.getContext().getString(R.string.guide_homepage_academy_title));
            }
        });
        this.tvFlightRecordAtom.setOnClickListener(new ScaleClickListener(i) { // from class: com.ipotensic.potensicpro.activities.MainDeviceController.13
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view2) {
                if (MainDeviceController.this.isGuideShow()) {
                    return;
        ...
        view.findViewById(R.id.tv_check_upgrade).setOnClickListener(new ScaleClickListener() { // from class: com.ipotensic.potensicpro.activities.MainDeviceController.14
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view2) {
        ...
        this.btnEnterDevice.setOnClickListener(new ScaleClickListener() { // from class: com.ipotensic.potensicpro.activities.MainDeviceController.15
            @Override // com.ipotensic.baselib.listener.ScaleClickListener
            public void click(View view2) {
    ...
    /* renamed from: com.ipotensic.potensicpro.activities.MainDeviceController$5, reason: invalid class name */
        ...
        public void click(View view) {
            MainDeviceController.this.checkPermission(new SimpleResultListener() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$MainDeviceController$5$lfB0mHcBA6vjJOkMifJQHM7QF10
                ...
                public final void onResult(Object obj) {
                    MainDeviceController.AnonymousClass5.this.lambda$click$0$MainDeviceController$5((Boolean) obj);
                }
            });
        }
    ...
    /* renamed from: com.ipotensic.potensicpro.activities.MainDeviceController$16, reason: invalid class name */
    class AnonymousClass16 implements SimpleResultListener<Boolean> {
        ...
        public void onResult(Boolean bool) {
            if (bool.booleanValue()) {
                PhoneConfig.threadPool.execute(new Runnable() { // from class: com.ipotensic.potensicpro.activities.MainDeviceController.16.1
                    @Override // java.lang.Runnable
                    public void run() {
                        LocalFileManager.getInstance().initExternalDir();
                        LocalFileManager.getInstance().initMediaDir();
        ...
        /* renamed from: com.ipotensic.potensicpro.activities.MainDeviceController$16$2, reason: invalid class name */
        class AnonymousClass2 implements OnCloseListener {
            ...
            public void onClosed() {
                MainDeviceController.this.getContext().runOnUiThread(new Runnable() { // from class: com.ipotensic.potensicpro.activities.MainDeviceController.16.2.1
                    @Override // java.lang.Runnable
                    public void run() {
                        ActivityHelper.getInstance().makeActivityOnlyOne(KernelActivity.class, new SimpleResultListener<Boolean>() { // from class: com.ipotensic.potensicpro.activities.MainDeviceController.16.2.1.1
                            @Override // com.ipotensic.baselib.listener.SimpleResultListener
                            public void onResult(Boolean bool) {
    ...
    public void startKernelActivity() {
        hideMenu();
        checkPermission(new AnonymousClass16());
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_menu /* 2131296414 */:
                ...
                break;
            case R.id.btn_menu_close /* 2131296415 */:
            case R.id.iv_close_atom /* 2131296737 */:
            case R.id.view_blank /* 2131297841 */:
                if (!isGuideShow()) {
    ...
    private void controlMenuView(final boolean z) {
        ...
        Animation.AnimationListener animationListener = new Animation.AnimationListener() { // from class: com.ipotensic.potensicpro.activities.MainDeviceController.17
    ...
    */
    ...
    public void toChooseFlightType() {
        ...
        getContext().overridePendingTransition(R.anim.trans_in_top, R.anim.alpha_out_top);
    }
