...
public class FindMyDroneActivity extends BaseActivity implements View.OnClickListener, EventDispatcher.OnEventListener, OnLocationChangedListener, OnNetworkChangeListener {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.binding = (ActivityFindMyDroneBinding) DataBindingUtil.setContentView(this, R.layout.activity_find_my_drone);
    ...
    private void setToolBar() {
        ...
        toolbar.findViewById(R.id.iv_search).setOnClickListener(new ScaleClickListener() { // from class: com.ipotensic.potensicpro.activities.FindMyDroneActivity.1
    ...
    private void initView() {
        ...
        ImageView imageView = (ImageView) findViewById(R.id.iv_map_lock);
        this.ivMapLock = imageView;
        imageView.setOnClickListener(this);
        findViewById(R.id.iv_my_position).setOnClickListener(this);
        findViewById(R.id.iv_fly_position).setOnClickListener(this);
        this.viewMapType = findViewById(R.id.view_map_type);
        ImageButton imageButton = (ImageButton) findViewById(R.id.btn_map_show);
        this.btnMapShow = imageButton;
        imageButton.setOnClickListener(this);
        ImageView imageView2 = (ImageView) findViewById(R.id.iv_map_set_hide);
        ...
        this.btnMapSatellite = (ImageButton) findViewById(R.id.iv_map_satellite);
        this.binding.btnStartBeep.setOnClickListener(this);
        initStartBeep();
        this.NA = getString(R.string.test_data);
        ImageButton imageButton2 = (ImageButton) findViewById(R.id.iv_map_standard);
        this.ivStandardMode = imageButton2;
        imageButton2.setOnClickListener(this);
        ImageButton imageButton3 = (ImageButton) findViewById(R.id.iv_map_satellite);
        this.ivSatelliteMode = imageButton3;
        imageButton3.setOnClickListener(this);
        ImageButton imageButton4 = (ImageButton) findViewById(R.id.iv_map_night);
    ...
    public void initMapStyle(Style style) {
        ...
        this.model.getClass();
        style2.addImage("marker-image-device", BitmapUtils.getDrawableFromRes(this, R.mipmap.mapbox_marker_icon_my_position));
        Style style3 = this.style;
        this.model.getClass();
        style3.addImage("marker_image_plane", BitmapUtils.getDrawableFromRes(this, R.mipmap.mapbox_marker_icon_plane_pos));
        Style style4 = this.style;
        this.model.getClass();
        style4.addImage("marker_image_plane_unconnect", BitmapUtils.getDrawableFromRes(this, R.mipmap.mapbox_marker_icon_plane_unconnect));
        Style style5 = this.style;
        this.model.getClass();
        style5.addImage("marker-text-plane", BitmapUtils.getDrawableFromRes(this, R.mipmap.mapbox_marker_icon_bg_text_new));
        Style style6 = this.style;
        this.model.getClass();
        style6.addImage("marker_image_home", BitmapUtils.getDrawableFromRes(this, R.mipmap.mapbox_marker_icon_home_position));
        Style style7 = this.style;
        this.model.getClass();
        style7.addImage("marker-text-distance", BitmapUtils.getDrawableFromRes(this, R.mipmap.map_text_distance));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_map_show /* 2131296410 */:
                this.viewMapSet.setVisibility(8);
                this.ivMapSetHide.setVisibility(0);
                break;
            case R.id.btn_start_beep /* 2131296446 */:
                onClickStartBeep();
                break;
            case R.id.iv_back /* 2131296719 */:
                finish();
                break;
            case R.id.iv_fly_position /* 2131296757 */:
                showFlyStartLocation();
                this.viewMapPosition.setVisibility(8);
                break;
            case R.id.iv_map_lock /* 2131296793 */:
                boolean z = !this.isStartRotate;
                this.isStartRotate = z;
                this.ivMapLock.setImageResource(z ? R.mipmap.icon_compass_nor : R.mipmap.icon_map_lock);
            ...
            case R.id.iv_map_night /* 2131296795 */:
                setMapType(Style.TRAFFIC_NIGHT);
                this.viewMapType.setVisibility(8);
                break;
            case R.id.iv_map_position /* 2131296797 */:
                ...
                this.ivMapSetHide.setVisibility(0);
                break;
            case R.id.iv_map_satellite /* 2131296799 */:
                setMapType(Style.SATELLITE);
                this.viewMapType.setVisibility(8);
                break;
            case R.id.iv_map_set_hide /* 2131296800 */:
                this.viewMapSet.setVisibility(0);
                this.ivMapSetHide.setVisibility(8);
                this.viewMapPosition.setVisibility(8);
                this.viewMapType.setVisibility(8);
                break;
            case R.id.iv_map_standard /* 2131296801 */:
            ...
            case R.id.iv_map_type /* 2131296802 */:
                ...
                this.viewMapSet.setVisibility(8);
                this.ivMapSetHide.setVisibility(0);
                this.ivStandardMode.setBackground(this.curStyle.equals(Style.MAPBOX_STREETS) ? getDrawable(R.mipmap.icon_map_style_select) : null);
                this.ivSatelliteMode.setBackground(this.curStyle.equals(Style.SATELLITE) ? getDrawable(R.mipmap.icon_map_style_select) : null);
                this.ivStandardNightMode.setBackground(this.curStyle.equals(Style.TRAFFIC_NIGHT) ? getDrawable(R.mipmap.icon_map_style_select) : null);
                break;
            case R.id.iv_my_position /* 2131296807 */:
    ...
    private void startRotate() {
        ...
        if (imageView != null) {
            imageView.setRotation(this.model.deviceRotate.getValue().floatValue());
        }
    }
    ...
    public void showFlyStartLocation() {
        DDLog.e(TAG, "找飞机_showFlyStartLocation");
    ...
    public void showMyLocation() {
        DDLog.e("找飞机_定位到手机位置curLat：" + this.model.curLat.getValue() + ", curLng: " + this.model.curLng.getValue() + ", isStyleLoaded = " + this.model.isStyleLoaded.getValue());
    ...
    public void onBDLocationChanged(double d, double d2, float f) {
        DDLog.e("找飞机_我的位置实时定位lat：" + d + ", lng: " + d2 + ", isStyleLoaded = " + this.model.isStyleLoaded.getValue());
    ...
    private void homeLocation(double d, double d2) {
        DDLog.e("找飞机_home点位置定位lat: " + d + ", lng: " + d2);
    ...
    public void flyAlwaysLocation(double d, double d2) {
        MapboxMap mapboxMap;
        DDLog.e("找飞机_飞机实时定位lat:" + d + ", lng: " + d2);
    ...
    private void setGpsAndElectricity(int i, int i2) {
        ...
        if (i < 6) {
            ...
            this.tvGps.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, getResources().getDrawable(R.mipmap.icon_gps_weak), (Drawable) null, (Drawable) null);
        } else {
            this.tvGps.setTextColor(getResources().getColor(R.color.colorWhite));
            this.tvGps.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, getResources().getDrawable(R.mipmap.icon_gps_enable), (Drawable) null, (Drawable) null);
        }
    ...
    public void onEvent(EventID eventID, Event event) {
        Drawable drawable;
        String str = TAG;
        DDLog.d(str, "onEvent id " + eventID);
        if (this.binding.mapView.isDestroyed()) {
        }
        switch (AnonymousClass7.$SwitchMap$com$ipotensic$baselib$dispatcher$EventID[eventID.ordinal()]) {
            case 1:
                setWifiStrength(((WifiSignalData) event.obj).getWifiRssiRange());
                break;
            case 2:
                boolean booleanValue = ((Boolean) event.obj).booleanValue();
                DDLog.e("找飞机", "连接状态：" + booleanValue);
                ...
                if (booleanValue) {
                    ...
                    if (FlightRevData.get().getFlightRevStateData().isUnLock()) {
                        drawable = getResources().getDrawable(R.mipmap.map_button_beep_disable);
                    } else {
                        drawable = getResources().getDrawable(R.mipmap.map_button_beep);
                    }
                    ...
                    this.binding.btnStartBeep.setBackground(getResources().getDrawable(R.mipmap.map_button_beep_disable));
            ...
            case 3:
                ...
                DDLog.e("经纬度:" + flightRevFlightInfoData.getLat() + "," + flightRevFlightInfoData.getLng());
                ...
                if (flightRevFlightInfoData.getLat() == 0.0d && flightRevFlightInfoData.getLng() == 0.0d) {
                    ...
                    if (this.model.startGps.getValue().booleanValue()) {
                        DDLog.e(str, "restart and refresh homeLocation");
            ...
            case 4:
                ...
                DDLog.e(str, "FLIGHT_RECEIVE_HOME_POINT lat =" + flightRevHomePointData.getLat() + ", lng = " + flightRevHomePointData.getLng());
            ...
            case 8:
                if (FlightConfig.isConnectFlight() && FlightRevData.get().getFlightRevStateData().isUnLock()) {
                    ...
                    if (this.model.setStartBeep.getValue().booleanValue()) {
                        ...
                        this.binding.tvStartBeep.setText(R.string.btn_start_beep);
                        if (!CommonUtil.hasNewVersion(BuildConfig.VERSION_NAME, FlightRevData.get().getFlightRevVersionData().getFlightControlVersion())) {
                            ToastUtil.toast(this, getString(R.string.toast_unlock_auto_stop_beep));
                        }
                ...
                if (FlightConfig.isConnectFlight() && !FlightRevData.get().getFlightRevStateData().isUnLock()) {
                    if (FlightRevData.get().getFlightRevStateData().isEscBeep()) {
                        this.binding.tvStartBeep.setText(R.string.btn_close_beep);
                        this.binding.btnStartBeep.setBackground(getResources().getDrawable(R.mipmap.map_button_beep_new));
                        ...
                        this.binding.tvStartBeep.setText(R.string.btn_start_beep);
                        this.binding.btnStartBeep.setBackground(getResources().getDrawable(R.mipmap.map_button_beep));
    ...
    /* renamed from: com.ipotensic.potensicpro.activities.FindMyDroneActivity$7, reason: invalid class name */
    ...
    private void onClickStartBeep() {
        if (FlightConfig.isConnectFlight() && FlightRevData.get().getFlightRevStateData().isUnLock()) {
            DDLog.w(TAG, "onClickStartBeep isConnect and unLock");
            this.binding.btnStartBeep.setBackground(getResources().getDrawable(R.mipmap.map_button_beep_disable));
            ToastUtil.toast(this, getString(R.string.toast_unlock_to_start_beep));
            return;
        }
        if (FlightConfig.isConnectFlight() && !FlightRevData.get().getFlightRevStateData().isUnLock()) {
            String str = TAG;
            DDLog.w(str, "onClickStartBeep isConnect and lock");
            if (this.model.setStartBeep.getValue().booleanValue()) {
                if (FlightRevData.get().getFlightRevStateData().isEscBeep()) {
            ...
            DDLog.w(str, "发送飞控电调数据:" + ParseUtil.byteToHexString(FlightSendData.get().getSendGeneralData().getBytes()));
            return;
        }
        DDLog.w(TAG, "onClickStartBeep case unConnect");
        this.binding.btnStartBeep.setBackground(getResources().getDrawable(R.mipmap.map_button_beep_disable));
        ToastUtil.toast(this, getString(R.string.toast_not_connect_to_start_beep));
    }

    private void showUnlockDialog() {
        if (FlightConfig.isConnectFlight()) {
            if (this.unLockDialog == null) {
                this.unLockDialog = new GeneralDialog((Context) this, false, getString(R.string.find_my_drone_fail_to_unlock_title), getString(R.string.find_my_drone_fail_to_unlock_tips), getString(R.string.i_get_it), (GeneralDialog.ClickConfirmListener) new GeneralDialog.ClickConfirmListener() { // from class: com.ipotensic.potensicpro.activities.-$$Lambda$FindMyDroneActivity$79ZDAKKGAU8h5Cck4XSxuEClPPw
