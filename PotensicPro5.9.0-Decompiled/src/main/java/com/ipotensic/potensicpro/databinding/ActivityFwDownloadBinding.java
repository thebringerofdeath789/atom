...
public final class ActivityFwDownloadBinding implements ViewBinding {
    ...
    public static ActivityFwDownloadBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.activity_fw_download, viewGroup, false);
        if (z) {
    ...
    public static ActivityFwDownloadBinding bind(View view) {
        int i = R.id.btn_start_download;
        Button button = (Button) view.findViewById(R.id.btn_start_download);
        if (button != null) {
            i = R.id.iv_upgrade_reminder;
            ImageView imageView = (ImageView) view.findViewById(R.id.iv_upgrade_reminder);
            if (imageView != null) {
                i = R.id.progress_bar;
                ...
                if (progressBar != null) {
                    ...
                    if (findViewById != null) {
                        ...
                        TextView textView = (TextView) view.findViewById(R.id.tv_download_tips);
                        if (textView != null) {
                            i = R.id.tv_progress;
