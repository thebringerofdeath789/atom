...
public final class ActivityCompanyContactBinding implements ViewBinding {
    ...
    public static ActivityCompanyContactBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.activity_company_contact, viewGroup, false);
        if (z) {
    ...
    public static ActivityCompanyContactBinding bind(View view) {
        ...
        if (cardView != null) {
            ...
            if (imageView != null) {
                i = R.id.iv_pass_word;
                ImageView imageView2 = (ImageView) view.findViewById(R.id.iv_pass_word);
                if (imageView2 != null) {
                    i = R.id.line;
                        ...
                        if (textView != null) {
                            ...
                            if (textView2 != null) {
                                ...
                                if (textView3 != null) {
                                    ...
                                    TextView textView4 = (TextView) view.findViewById(R.id.tv_website_link);
                                    if (textView4 != null) {
