...
public final class ViewItemPhotoBinding implements ViewBinding {
    ...
    public static ViewItemPhotoBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.view_item_photo, viewGroup, false);
        if (z) {
    ...
    public static ViewItemPhotoBinding bind(View view) {
        ...
        if (imageButton != null) {
            i = R.id.btn_select_photo;
            ImageButton imageButton2 = (ImageButton) view.findViewById(R.id.btn_select_photo);
            if (imageButton2 != null) {
                i = R.id.icon_image;
                RoundImageView roundImageView = (RoundImageView) view.findViewById(R.id.icon_image);
                if (roundImageView != null) {
                    i = R.id.iv_video_view;
                    ImageView imageView = (ImageView) view.findViewById(R.id.iv_video_view);
                    if (imageView != null) {
