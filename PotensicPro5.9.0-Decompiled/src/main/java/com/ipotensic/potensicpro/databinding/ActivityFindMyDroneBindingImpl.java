...
public class ActivityFindMyDroneBindingImpl extends ActivityFindMyDroneBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.tv_code_title, 6);
        sparseIntArray.put(R.id.iv_search, 7);
        sparseIntArray.put(R.id.map_view, 8);
        sparseIntArray.put(R.id.scaleView, 9);
        sparseIntArray.put(R.id.tv_start_beep, 10);
        sparseIntArray.put(R.id.img_speaker_beep, 11);
    }
