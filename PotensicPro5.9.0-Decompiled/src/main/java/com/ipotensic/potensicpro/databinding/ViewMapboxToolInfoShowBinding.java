...
public final class ViewMapboxToolInfoShowBinding implements ViewBinding {
    ...
    public static ViewMapboxToolInfoShowBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.view_mapbox_tool_info_show, viewGroup, false);
        if (z) {
    ...
    public static ViewMapboxToolInfoShowBinding bind(View view) {
        int i = R.id.btn_map_show;
        ImageButton imageButton = (ImageButton) view.findViewById(R.id.btn_map_show);
        if (imageButton != null) {
            i = R.id.iv_signal_hd;
            ImageView imageView = (ImageView) view.findViewById(R.id.iv_signal_hd);
            if (imageView != null) {
                i = R.id.ll_hd;
