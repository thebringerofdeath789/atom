            ...
            */
            public void run() {
                ...
                L68:
                    ...
                    com.ipotensic.baselib.DDLog.e(r2)     // Catch: java.lang.Throwable -> L8c
                    if (r4 == 0) goto L87
                    r4.close()     // Catch: java.lang.Exception -> L8b
                L87:
                    java.lang.Thread.sleep(r0)     // Catch: java.lang.Exception -> L8b
                ...
                L9c:
                    throw r2
                */
                throw new UnsupportedOperationException("Method not decompiled: com.ipotensic.potensicpro.utils.CrashHandler.AnonymousClass1.run():void");
            }
        }).start();
    }
