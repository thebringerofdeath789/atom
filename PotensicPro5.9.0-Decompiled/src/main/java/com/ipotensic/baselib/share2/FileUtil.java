...
public class FileUtil {
    ...
    public static Uri getFileUri(Context context, String str, File file) {
        Uri uri = null;
        if (context == null) {
            DDLog.e(TAG, "getFileUri current activity is null.");
            return null;
        }
        if (file == null || !file.exists()) {
            DDLog.e(TAG, "getFileUri file is null or not exists.");
            return null;
        }
        if (!PermissionUtil.hasStoragePermission(context)) {
            DDLog.e(TAG, "getFileUri miss WRITE_EXTERNAL_STORAGE permission.");
            return null;
        }
    ...
    public static String getFileRealPath(Context context, Uri uri) {
        Uri contentUri;
        if (context == null) {
            DDLog.e(TAG, "getFileRealPath current activity is null.");
            return null;
        }
        if (uri == null) {
            DDLog.e(TAG, "getFileRealPath uri is null.");
            return null;
        }
