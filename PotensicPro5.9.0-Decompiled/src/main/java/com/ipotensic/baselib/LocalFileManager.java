...
public class LocalFileManager {
    ...
    private String MAIN_DIR = PhoneConfig.applicationContext.getExternalFilesDir(null) + File.separator + "PotensicPro";
    private String DCIM_DIR = Environment.getExternalStorageDirectory() + File.separator + "DCIM";
    private String MEDIA_DIR = this.DCIM_DIR + File.separator + "PotensicPro";
