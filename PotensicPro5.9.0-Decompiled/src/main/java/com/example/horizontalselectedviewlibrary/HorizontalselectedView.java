...
public class HorizontalselectedView extends View {
    ...
    private void initAttrs(AttributeSet attributeSet) {
        ...
        this.selectedTextSize = obtainStyledAttributes.getFloat(R.styleable.HorizontalselectedView_HorizontalselectedViewSelectedTextSize, 50.0f);
        this.selectedColor = obtainStyledAttributes.getColor(R.styleable.HorizontalselectedView_HorizontalselectedViewSelectedTextColor, this.context.getResources().getColor(android.R.color.black));
        this.textSize = obtainStyledAttributes.getFloat(R.styleable.HorizontalselectedView_HorizontalselectedViewTextSize, 40.0f);
        this.textColor = obtainStyledAttributes.getColor(R.styleable.HorizontalselectedView_HorizontalselectedViewTextColor, this.context.getResources().getColor(android.R.color.darker_gray));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(this.strings.get(this.n), ((getWidth() / 2) - (width / 2)) + this.anOffset, (getHeight() / 2) + (this.centerTextHeight / 2), this.selectedPaint);
