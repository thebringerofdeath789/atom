    ...
    */
    ...
    public void write(List<String> list) {
        ...
        while (i4 < size) {
            ...
            if (i4 == 0) {
                i = i3 + 1;
                this.buf[i3] = PropertyUtils.INDEXED_DELIM;
            } else {
                i = i3 + 1;
                this.buf[i3] = ',';
            }
        ...
        this.buf[i3] = PropertyUtils.INDEXED_DELIM2;
        this.count = i3 + 1;
    }
    ...
    public void writeFieldValue(char c, String str, String str2) {
        if (this.quoteFieldNames) {
            ...
            if (isEnabled(SerializerFeature.BrowserCompatible)) {
                write(c);
                writeStringWithDoubleQuote(str, NameUtil.COLON);
                writeStringWithDoubleQuote(str2, (char) 0);
                return;
            }
    ...
    */
    ...
    protected void writeStringWithSingleQuote(String str) {
        ...
        if (i == 1) {
            ...
            char[] cArr3 = this.buf;
            cArr3[i7] = ICSVParser.DEFAULT_ESCAPE_CHARACTER;
            ...
            char[] cArr5 = this.buf;
            cArr5[i7] = ICSVParser.DEFAULT_ESCAPE_CHARACTER;
            ...
            for (int i13 = i11 - 2; i13 >= i5; i13--) {
                ...
                if (c3 <= '\r' || c3 == '\\' || c3 == '\'' || (c3 == '/' && isEnabled(SerializerFeature.WriteSlashAsSpecial))) {
                    ...
                    char[] cArr7 = this.buf;
                    cArr7[i13] = ICSVParser.DEFAULT_ESCAPE_CHARACTER;
    ...
    protected void writeStringWithSingleQuote(char[] cArr) {
        ...
        if (i == 1) {
            ...
            char[] cArr4 = this.buf;
            cArr4[i7] = ICSVParser.DEFAULT_ESCAPE_CHARACTER;
            ...
            char[] cArr6 = this.buf;
            cArr6[i7] = ICSVParser.DEFAULT_ESCAPE_CHARACTER;
            ...
            for (int i13 = i11 - 2; i13 >= i5; i13--) {
                ...
                if (c4 <= '\r' || c4 == '\\' || c4 == '\'' || (c4 == '/' && isEnabled(SerializerFeature.WriteSlashAsSpecial))) {
                    ...
                    char[] cArr8 = this.buf;
                    cArr8[i13] = ICSVParser.DEFAULT_ESCAPE_CHARACTER;
        ...
        while (i10 < i9) {
            ...
            if (c < bArr.length && bArr[c] != 0) {
                if (!z2) {
                    ...
                    char[] cArr5 = this.buf;
                    cArr5[i8] = '\'';
                    cArr5[i11] = ICSVParser.DEFAULT_ESCAPE_CHARACTER;
                    int i12 = i11 + 1;
                    ...
                    char[] cArr7 = this.buf;
                    cArr7[i10] = ICSVParser.DEFAULT_ESCAPE_CHARACTER;
