...
public abstract class JSON implements JSONStreamAware, JSONAware {
    ...
    private static void config(Properties properties) {
        ...
        if (BooleanUtils.TRUE.equals(properties.getProperty("parser.features.NonStringKeyAsString"))) {
            DEFAULT_PARSER_FEATURE |= Feature.NonStringKeyAsString.getMask();
        }
        if (BooleanUtils.TRUE.equals(properties.getProperty("parser.features.ErrorOnEnumNotMatch"))) {
