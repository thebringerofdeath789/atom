...
public class DialogKeyboardBindingImpl extends DialogKeyboardBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.keyboard_view, 1);
        sparseIntArray.put(R.id.keyboard_chooser, 2);
        sparseIntArray.put(R.id.tv_number, 3);
        sparseIntArray.put(R.id.tv_symbol, 4);
        sparseIntArray.put(R.id.tv_letter, 5);
    }
