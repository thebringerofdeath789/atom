...
public class VerticalDividerItemDecoration extends FlexibleDividerDecoration {
    ...
    public static class Builder extends FlexibleDividerDecoration.Builder<Builder> {
        ...
        public Builder(Context context) {
            super(context);
            this.mMarginProvider = new MarginProvider() { // from class: com.yqritc.recyclerviewflexibledivider.VerticalDividerItemDecoration.Builder.1
        ...
        public Builder margin(final int i, final int i2) {
            return marginProvider(new MarginProvider() { // from class: com.yqritc.recyclerviewflexibledivider.VerticalDividerItemDecoration.Builder.2
                @Override // com.yqritc.recyclerviewflexibledivider.VerticalDividerItemDecoration.MarginProvider
