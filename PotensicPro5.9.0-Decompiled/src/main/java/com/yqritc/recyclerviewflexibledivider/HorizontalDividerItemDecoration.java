...
public class HorizontalDividerItemDecoration extends FlexibleDividerDecoration {
    ...
    public static class Builder extends FlexibleDividerDecoration.Builder<Builder> {
        ...
        public Builder(Context context) {
            super(context);
            this.mMarginProvider = new MarginProvider() { // from class: com.yqritc.recyclerviewflexibledivider.HorizontalDividerItemDecoration.Builder.1
        ...
        public Builder margin(final int i, final int i2) {
            return marginProvider(new MarginProvider() { // from class: com.yqritc.recyclerviewflexibledivider.HorizontalDividerItemDecoration.Builder.2
                @Override // com.yqritc.recyclerviewflexibledivider.HorizontalDividerItemDecoration.MarginProvider
