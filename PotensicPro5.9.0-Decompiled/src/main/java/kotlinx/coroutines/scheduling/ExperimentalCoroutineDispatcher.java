...
public class ExperimentalCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public void mo1371dispatch(CoroutineContext context, Runnable block) {
        ...
        try {
            ...
            DefaultExecutor.INSTANCE.mo1371dispatch(context, block);
        }
    }
    ...
    public String toString() {
        return super.toString() + "[scheduler = " + this.coroutineScheduler + PropertyUtils.INDEXED_DELIM2;
    }
    ...
    public final synchronized void usePrivateScheduler$kotlinx_coroutines_core() {
        this.coroutineScheduler.shutdown(Constant.DELAY_MILLIS);
        this.coroutineScheduler = createScheduler();
    }
