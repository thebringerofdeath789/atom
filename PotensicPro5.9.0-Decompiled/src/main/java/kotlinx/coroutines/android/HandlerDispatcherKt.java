...
public final class HandlerDispatcherKt {
    ...
    public static final HandlerDispatcher from(Handler receiver$0, String str) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return new HandlerContext(receiver$0, str);
    }

    public static final Handler asHandler(Looper receiver$0, boolean z) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
    ...
    static {
        ...
        try {
            ...
            m51constructorimpl = Result.m51constructorimpl(new HandlerContext(asHandler(mainLooper, true), "Main"));
        } catch (Throwable th) {
        ...
        Main = (HandlerDispatcher) m51constructorimpl;
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1371dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$special$$inlined$Runnable$1
