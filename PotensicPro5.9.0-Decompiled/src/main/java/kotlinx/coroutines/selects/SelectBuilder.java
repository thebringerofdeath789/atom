...
public interface SelectBuilder<R> {
    ...
    public static final class DefaultImpls {
        ...
        public static <R, P, Q> void invoke(SelectBuilder<? super R> selectBuilder, SelectClause2<? super P, ? extends Q> receiver$0, Function2<? super Q, ? super Continuation<? super R>, ? extends Object> block) {
            Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
            Intrinsics.checkParameterIsNotNull(block, "block");
            selectBuilder.invoke(receiver$0, null, block);
        }
    }
}
