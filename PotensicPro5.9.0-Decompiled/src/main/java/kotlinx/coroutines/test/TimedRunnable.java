...
final class TimedRunnable implements Comparable<TimedRunnable>, Runnable, ThreadSafeHeapNode {
    ...
    public String toString() {
        return "TimedRunnable(time=" + this.time + ", run=" + this.run + PropertyUtils.MAPPED_DELIM2;
    }
}
