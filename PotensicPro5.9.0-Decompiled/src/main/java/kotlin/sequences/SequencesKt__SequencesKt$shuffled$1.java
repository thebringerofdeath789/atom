...
@DebugMetadata(c = "kotlin.sequences.SequencesKt__SequencesKt$shuffled$1", f = "Sequences.kt", i = {0, 0, 0, 0, 0}, l = {145}, m = "invokeSuspend", n = {"$this$sequence", "buffer", Complex.SUPPORTED_SUFFIX, DirectionsCriteria.DESTINATION_LAST, "value"}, s = {"L$0", "L$1", "I$0", "L$2", "L$3"})
