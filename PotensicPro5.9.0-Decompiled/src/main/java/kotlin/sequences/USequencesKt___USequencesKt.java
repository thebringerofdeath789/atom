...
class USequencesKt___USequencesKt {
    public static final int sumOfUInt(Sequence<UInt> sum) {
        ...
        int i = 0;
        while (it.hasNext()) {
            i = UInt.m137constructorimpl(i + it.next().getData());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Sequence<ULong> sum) {
        ...
        long j = 0;
        while (it.hasNext()) {
            j = ULong.m207constructorimpl(j + it.next().getData());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Sequence<UByte> sum) {
        ...
        int i = 0;
        while (it.hasNext()) {
            i = UInt.m137constructorimpl(i + UInt.m137constructorimpl(it.next().getData() & 255));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Sequence<UShort> sum) {
        ...
        int i = 0;
        while (it.hasNext()) {
            i = UInt.m137constructorimpl(i + UInt.m137constructorimpl(it.next().getData() & 65535));
        }
        return i;
    }
}
