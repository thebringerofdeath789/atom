...
public class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final CharSequence replaceRange(CharSequence replaceRange, int i, int i2, CharSequence replacement) {
        ...
        Intrinsics.checkNotNullExpressionValue(sb.append(replaceRange, 0, i), "this.append(value, startIndex, endIndex)");
        sb.append(replacement);
        Intrinsics.checkNotNullExpressionValue(sb.append(replaceRange, i2, replaceRange.length()), "this.append(value, startIndex, endIndex)");
        return sb;
    }
    ...
    public static final CharSequence removeRange(CharSequence removeRange, int i, int i2) {
        ...
        Intrinsics.checkNotNullExpressionValue(sb.append(removeRange, 0, i), "this.append(value, startIndex, endIndex)");
        Intrinsics.checkNotNullExpressionValue(sb.append(removeRange, i2, removeRange.length()), "this.append(value, startIndex, endIndex)");
        return sb;
    }
