...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1217getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m207constructorimpl = ((int) ULong.m207constructorimpl(j ^ ULong.m207constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m207constructorimpl2 = (m207constructorimpl + ((int) ULong.m207constructorimpl(j2 ^ ULong.m207constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return m207constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append(ULong.m244toStringimpl(this.first)).append("..").append(ULong.m244toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append(ULong.m244toStringimpl(this.first)).append(" downTo ").append(ULong.m244toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1240fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
