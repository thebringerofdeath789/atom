...
public final class UByteArray implements Collection<UByte>, KMappedMarker {
    ...
    public boolean equals(Object other) {
        return m116equalsimpl(this.storage, other);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UByte) {
            return m126contains7apg3OU(((UByte) obj).getData());
        }
        return false;
    }
    ...
    public static final byte m118getw2LRezQ(byte[] bArr, int i) {
        return UByte.m69constructorimpl(bArr[i]);
    }
    ...
    public static UByteIterator m122iteratorimpl(byte[] bArr) {
    ...
    public static boolean m115containsAllimpl(byte[] bArr, Collection<UByte> elements) {
