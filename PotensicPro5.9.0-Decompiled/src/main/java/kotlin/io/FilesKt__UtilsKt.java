...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    */
    ...
    public static final File resolve(File resolve, File relative) {
        ...
        String str = file;
        return ((str.length() == 0) || StringsKt.endsWith$default((CharSequence) str, File.separatorChar, false, 2, (Object) null)) ? new File(file + relative) : new File(file + File.separatorChar + relative);
    }
