...
public class MediaSessionCompat {
    ...
    interface MediaSessionImpl {
        ...
        void setPlaybackState(MediaSessionManager.RemoteUserInfo remoteUserInfo, PlaybackStateCompat playbackStateCompat);
    ...
    public void setPlaybackState(MediaSessionManager.RemoteUserInfo remoteUserInfo, PlaybackStateCompat playbackStateCompat) {
        if (remoteUserInfo == null) {
            return;
        }
        this.mImpl.setPlaybackState(remoteUserInfo, playbackStateCompat);
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        public void setPlaybackState(MediaSessionManager.RemoteUserInfo remoteUserInfo, PlaybackStateCompat playbackStateCompat) {
            ...
            for (int beginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                if (((MediaSessionManager.RemoteUserInfo) this.mControllerCallbacks.getBroadcastCookie(beginBroadcast)).equals(remoteUserInfo)) {
                    try {
        ...
        public MediaSessionManager.RemoteUserInfo getCurrentControllerInfo() {
            synchronized (this.mLock) {
                ...
                return messageHandler.getRemoteUserInfo();
            }
        }
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (MediaSessionImplBase.this.mDestroyed) {
                    ...
                    MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new MediaSessionManager.RemoteUserInfo(MediaSessionImplBase.this.getCallingPackage(), getCallingPid(), getCallingUid()));
                }
            }
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public void setPlaybackState(MediaSessionManager.RemoteUserInfo remoteUserInfo, PlaybackStateCompat playbackStateCompat) {
            this.mPlaybackState = playbackStateCompat;
            for (int beginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                if (((MediaSessionManager.RemoteUserInfo) this.mExtraControllerCallbacks.getBroadcastCookie(beginBroadcast)).equals(remoteUserInfo)) {
                    try {
                        this.mExtraControllerCallbacks.getBroadcastItem(beginBroadcast).onPlaybackStateChanged(playbackStateCompat);
                    } catch (RemoteException unused) {
                    }
        ...
        class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new MediaSessionManager.RemoteUserInfo(MediaSessionImplApi21.this.getCallingPackage(), getCallingPid(), getCallingUid()));
            }
    ...
    static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        public final MediaSessionManager.RemoteUserInfo getCurrentControllerInfo() {
            MediaSessionManager.RemoteUserInfo currentControllerInfo = ((MediaSession) this.mSessionObj).getCurrentControllerInfo();
