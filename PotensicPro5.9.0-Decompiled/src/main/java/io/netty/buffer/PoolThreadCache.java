...
final class PoolThreadCache {
    ...
    PoolThreadCache(PoolArena<byte[]> poolArena, PoolArena<ByteBuffer> poolArena2, int i, int i2, int i3, int i4, int i5, boolean z) {
        if (i4 < 0) {
        ...
        if (z) {
            ...
            this.deathWatchThread = currentThread;
    ...
    boolean add(PoolArena<?> poolArena, PoolChunk poolChunk, long j, int i, PoolArena.SizeClass sizeClass) {
