...
final class Bzip2HuffmanStageDecoder {
    ...
    Bzip2HuffmanStageDecoder(Bzip2BitReader bzip2BitReader, int i, int i2) {
        ...
        this.codeSymbols = (int[][]) Array.newInstance((Class<?>) int.class, i, JCameraView.BUTTON_STATE_ONLY_RECORDER);
        this.tableCodeLengths = (byte[][]) Array.newInstance((Class<?>) byte.class, i, JCameraView.BUTTON_STATE_ONLY_RECORDER);
    }
