...
public final class RtspHeaderNames {
    ...
    public static final AsciiString ALLOW = AsciiString.cached(com.google.android.exoplayer2.source.rtsp.RtspHeaders.ALLOW);
    public static final AsciiString AUTHORIZATION = HttpHeaderNames.AUTHORIZATION;
    public static final AsciiString BANDWIDTH = AsciiString.cached(com.google.android.exoplayer2.source.rtsp.RtspHeaders.BANDWIDTH);
    public static final AsciiString BLOCKSIZE = AsciiString.cached(com.google.android.exoplayer2.source.rtsp.RtspHeaders.BLOCKSIZE);
    ...
    public static final AsciiString CSEQ = AsciiString.cached(com.google.android.exoplayer2.source.rtsp.RtspHeaders.CSEQ);
    ...
    public static final AsciiString PROXY_REQUIRE = AsciiString.cached(com.google.android.exoplayer2.source.rtsp.RtspHeaders.PROXY_REQUIRE);
    ...
    public static final AsciiString RTP_INFO = AsciiString.cached(com.google.android.exoplayer2.source.rtsp.RtspHeaders.RTP_INFO);
    public static final AsciiString SCALE = AsciiString.cached(com.google.android.exoplayer2.source.rtsp.RtspHeaders.SCALE);
    public static final AsciiString SESSION = AsciiString.cached(com.google.android.exoplayer2.source.rtsp.RtspHeaders.SESSION);
    ...
    public static final AsciiString TIMESTAMP = AsciiString.cached(com.google.android.exoplayer2.source.rtsp.RtspHeaders.TIMESTAMP);
