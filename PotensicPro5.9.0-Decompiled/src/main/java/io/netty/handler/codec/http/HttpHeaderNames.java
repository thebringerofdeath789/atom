...
public final class HttpHeaderNames {
    public static final AsciiString ACCEPT = AsciiString.cached(RtspHeaders.ACCEPT);
    ...
    public static final AsciiString ALLOW = AsciiString.cached(RtspHeaders.ALLOW);
    public static final AsciiString AUTHORIZATION = AsciiString.cached(RtspHeaders.AUTHORIZATION);
    public static final AsciiString CACHE_CONTROL = AsciiString.cached(RtspHeaders.CACHE_CONTROL);
    public static final AsciiString CONNECTION = AsciiString.cached(RtspHeaders.CONNECTION);
    public static final AsciiString CONTENT_BASE = AsciiString.cached(RtspHeaders.CONTENT_BASE);
    public static final AsciiString CONTENT_ENCODING = AsciiString.cached(RtspHeaders.CONTENT_ENCODING);
    public static final AsciiString CONTENT_LANGUAGE = AsciiString.cached(RtspHeaders.CONTENT_LANGUAGE);
    public static final AsciiString CONTENT_LENGTH = AsciiString.cached(RtspHeaders.CONTENT_LENGTH);
    public static final AsciiString CONTENT_LOCATION = AsciiString.cached(RtspHeaders.CONTENT_LOCATION);
    ...
    public static final AsciiString CONTENT_TYPE = AsciiString.cached(RtspHeaders.CONTENT_TYPE);
    ...
    public static final AsciiString EXPIRES = AsciiString.cached(RtspHeaders.EXPIRES);
    ...
    public static final AsciiString PROXY_AUTHENTICATE = AsciiString.cached(RtspHeaders.PROXY_AUTHENTICATE);
    ...
    public static final AsciiString USER_AGENT = AsciiString.cached(RtspHeaders.USER_AGENT);
    public static final AsciiString VARY = AsciiString.cached("vary");
    public static final AsciiString VIA = AsciiString.cached(RtspHeaders.VIA);
    ...
    public static final AsciiString WWW_AUTHENTICATE = AsciiString.cached(RtspHeaders.WWW_AUTHENTICATE);
