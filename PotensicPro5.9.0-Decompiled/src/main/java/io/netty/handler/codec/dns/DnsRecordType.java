...
public class DnsRecordType implements Comparable<DnsRecordType> {
    ...
    static {
        ...
        SIG = dnsRecordType10;
        DnsRecordType dnsRecordType11 = new DnsRecordType(25, Config.KEY);
        KEY = dnsRecordType11;
        ...
        SPF = dnsRecordType32;
        DnsRecordType dnsRecordType33 = new DnsRecordType(TelnetCommand.GA, "TKEY");
        ...
        DnsRecordType dnsRecordType36 = new DnsRecordType(TelnetCommand.WONT, "AXFR");
        ...
        TA = dnsRecordType39;
        DnsRecordType dnsRecordType40 = new DnsRecordType(CodePageUtil.CP_WINDOWS_1252_BIFF23, "DLV");
        DLV = dnsRecordType40;
        BY_NAME = new HashMap();
        ...
        for (int i = 0; i < 40; i++) {
            ...
            sb.append(dnsRecordType41.name()).append(PropertyUtils.MAPPED_DELIM).append(dnsRecordType41.intValue()).append("), ");
        }
    ...
    public String toString() {
        ...
        String str2 = this.name + PropertyUtils.MAPPED_DELIM + intValue() + PropertyUtils.MAPPED_DELIM2;
        this.text = str2;
        return str2;
    }
}
