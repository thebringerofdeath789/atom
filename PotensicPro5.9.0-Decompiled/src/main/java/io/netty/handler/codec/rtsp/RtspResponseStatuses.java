...
public final class RtspResponseStatuses {
    ...
    public static final HttpResponseStatus MOVED_TEMPORARILY = new HttpResponseStatus(UserConstants.REQUEST_CODE_DOWNLOAD_PDF_FILE, "Moved Temporarily");
    ...
    public static final HttpResponseStatus RTSP_VERSION_NOT_SUPPORTED = new HttpResponseStatus(BDLocation.TypeServerCheckKeyError, "RTSP Version not supported");
