...
public class LineBasedFrameDecoder extends ByteToMessageDecoder {
    ...
    private void fail(ChannelHandlerContext channelHandlerContext, String str) {
        channelHandlerContext.fireExceptionCaught((Throwable) new TooLongFrameException("frame length (" + str + ") exceeds the allowed maximum (" + this.maxLength + PropertyUtils.MAPPED_DELIM2));
    }
