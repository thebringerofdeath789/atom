...
public class GlobalChannelTrafficShapingHandler extends AbstractTrafficShapingHandler {
        ...
        if (calculateSize > 0) {
            ...
            if (perChannel != null) {
                ...
                if (this.readDeviationActive) {
                    ...
                    r2 = computeBalancedWait(r2, j2, readTimeToWait2);
                } else {
                    r2 = readTimeToWait2;
                }
            }
        ...
        if (calculateSize > 0) {
            ...
            if (perChannel != null) {
                ...
                if (this.writeDeviationActive) {
                    ...
                    r0 = computeBalancedWait(r0, j < r0 ? r0 : j, writeTimeToWait2);
                } else {
                    r0 = writeTimeToWait2;
                }
            }
    ...
    public String toString() {
        return new StringBuilder(NNTPReply.SEND_ARTICLE_TO_POST).append(super.toString()).append(" Write Channel Limit: ").append(this.writeChannelLimit).append(" Read Channel Limit: ").append(this.readChannelLimit).toString();
    }
}
